...
## Corpus Check
- 813 files · ~870,943 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18984 nodes · 29887 edges · 1638 communities (1272 shown, 366 thin omitted)
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 7972 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f9db1ccf`
...
## Communities (1638 total, 366 thin omitted)
...
Cohesion: 0.04
Nodes (101): TestDeprecatedHandler_NoSunset(), TestDeprecatedHandler_WithSunsetDate(), DeprecatedHandler(), TestDeprecatedHandler_WithoutSunset(), TestDeprecatedHandler_WithSunset(), handleLogin(), NewRequest(), auditKey (+93 more)
...
Cohesion: 0.05
Nodes (56): BehavioralDescriptor, FeatureDimension, FitnessDimension, Bucket(), Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid(), NewMAPElitesPopulation() (+48 more)
...
Cohesion: 0.05
Nodes (59): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+51 more)
...
Cohesion: 0.05
Nodes (45): TestPromoteRunToAgentScope(), ResolvePipelineAgent(), TestResolvePipelineAgent_Aliases(), RunDeps, RunOptions, RunResult, TreeResolver, TestEngineBlackboardAppendTool() (+37 more)
...
Cohesion: 0.06
Nodes (62): ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction(), buildChainActionFn() (+54 more)
...
Cohesion: 0.06
Nodes (44): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree(), agentTemplateYAML, TestResolveTreeID_FusionAliases(), HermesObsidianOptimizerTree() (+36 more)
...
Cohesion: 0.08
Nodes (51): TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_PruningOnNodeExplosion(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune(), TestTranspositionTable_Load_CorruptedFile(), TestTranspositionTable_Load_ExistingFile() (+43 more)
...
Cohesion: 0.07
Nodes (39): perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTreeV2_WithRealTree(), TestMetricsTracker_BestFitnessTracking() (+31 more)
...
Cohesion: 0.1
Nodes (43): Duration(), TestDuration(), TestNewPopulation_Evolution(), TestPopulation_Diversity(), DefaultTree(), TestPopulation_StatsAccessors(), jaccardSimilarity(), NewExperienceBank() (+35 more)
...
Cohesion: 0.06
Nodes (37): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+29 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (35): min(), handleAnalyze(), brokenTool, execLLMCall(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section() (+27 more)
...
Cohesion: 0.09
Nodes (34): TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), LogsDir() (+26 more)
...
Cohesion: 0.09
Nodes (23): BlockConfig, ApplyDiffMutation(), DefaultBlockConfig(), findBlockForNode(), NewMetaPromptEvolver(), NewMutationContext(), TestApplyDiffMutation(), TestBlockConfig_FilterMutations() (+15 more)
...
Cohesion: 0.09
Nodes (33): JobsDir(), RegistryDir(), SchedulerJobsFile(), TestRemoveAgentJobs(), TestApplySchedule_PersistsRegistryAndJobs(), TestDeleteRegisteredAgent(), TestScheduler_SyncFromRegistry_UpdatesChangedSchedule(), ApplySchedule() (+25 more)

### Community 72 - "Community 72"
Cohesion: 0.1
Nodes (33): distributedDispatch, appendDispatchErr(), driveDistributedDispatch(), main(), parseNodes(), run(), multiNodeReport, TestMultiNode_ProbeFailsOnEmptyNodeURL() (+25 more)
...
Cohesion: 0.07
Nodes (35): Binaries, code:go (type Counter struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }) (+27 more)
...
Cohesion: 0.12
Nodes (31): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad() (+23 more)
...
Cohesion: 0.08
Nodes (14): GardenerRecommendTool, GardenerRunCycleTool, GardenerStatusTool, main(), truncateStr(), fanoutHandler, InitLogExport(), logExportTarget() (+6 more)
...
Cohesion: 0.14
Nodes (30): proposeAutomation(), goalError(), goalFactory(), goalTreeSlug(), personaStyleHints(), registerGoalTools(), userGoalStore(), seedCompileReflection() (+22 more)
...
Cohesion: 0.07
Nodes (13): CreateAgentTool, EvolveTool, FitnessTool, GetReflectionsTool, TestToolNames_And_Descriptions(), NewCreateAgentTool(), NewFitnessTool(), NewGetTreeTool() (+5 more)
...
Cohesion: 0.1
Nodes (20): reflectOnOutcomeAction(), TestReflectOnOutcomeAction_NilLLM(), TestReflectOnOutcomeAction_WithMockLLM(), TestStore_CountFailures_MixedRecords(), TestStore_CountFailures_NoFailures(), TestStore_LoadAll_WithSubdirs(), TestStore_NewStore_MkdirAllError(), TestStore_RecentFailures_Ordering() (+12 more)

### Community 124 - "Community 124"
Cohesion: 0.12
Nodes (24): LoadPipeline(), RunPipeline(), RunPipelineWithID(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), registerMCPTools(), injectSelectorProbeTree(), seedSelectorProbeStats() (+16 more)
...
Cohesion: 0.12
Nodes (13): BTOptimizer, collectSelectors(), extractCondition(), findMainSelector(), TestExtractCondition(), TestFindMainSelector(), isDefaultPath(), pathEntropy() (+5 more)
...
Cohesion: 0.08
Nodes (25): applyDotEnvFiles(), applyDotEnvToConfig(), LoadDotEnv(), parseBool(), stripInlineComment(), TestLoadDotEnv_Basic(), TestLoadDotEnv_CommentsAndBlanks(), TestLoadDotEnv_EmptyFile() (+17 more)
...
Cohesion: 0.13
Nodes (20): getHomeDir(), init(), main(), handlePipelineRun(), handlePipelines(), newPipelineRunner(), newRunID(), resolveTree() (+12 more)
...
Cohesion: 0.11
Nodes (17): TestEvolveTree_WithRealTree(), TestEvolveTreeV2_BloatGuard(), TestStore_CountFailures_MixedRecords(), TestStore_CountFailures_NoFailures(), TestStore_LoadAll_WithSubdirs(), TestStore_NewStore_MkdirAllError(), TestStore_RecentFailures_Ordering(), TestStore_Save_RenameCleanup() (+9 more)
...
Cohesion: 0.19
Nodes (20): saveRecordWithDelay(), TestCreateAgentTool_Call_NilFactory(), TestEvolveTool_Call_NotEnoughFailures(), TestEvolveTool_Call_NoTree(), TestEvolveTool_Call_Success(), TestFitnessTool_Call(), TestFitnessTool_Call_NoData(), TestGetReflectionsTool_Call_NoRecords() (+12 more)
...
Cohesion: 0.12
Nodes (15): tracingMiddleware(), ContextWithTraceParentHeader(), Endpoint(), InitFromEnv(), NewOTelTracer(), parseOTLPEndpoint(), ParseOTLPTarget(), newRecordingTracer() (+7 more)
...
Cohesion: 0.15
Nodes (21): TestBTOptimizer_New(), conditionOverlap(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), TestSplitCamelCase(), NewBTOptimizer(), NewDTAnalyzer() (+13 more)
...
Cohesion: 0.16
Nodes (15): cleanupAppliedSuperpowersWorktree(), cleanupSuperpowersWorktree(), createSuperpowersWorktree(), superpowersWorktreeBranches(), TestCleanupAppliedSuperpowersWorktreeNoOpsOnDryRun(), TestCleanupAppliedSuperpowersWorktreeRemovesWorktreeAndMergedBranch(), TestSweepStaleSuperpowersWorktreesFallsBackToPruneAndRemoveAll(), TestSweepStaleSuperpowersWorktreesRemovesOnlyStaleUnkeptDirs() (+7 more)
...
Cohesion: 0.15
Nodes (18): mcpDeps, addFailureContext(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), islandArchivePath(), maxTreeDepth(), newProductionPopulation() (+10 more)
...
Cohesion: 0.16
Nodes (12): TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), resolveUserTree(), TestWireSelectorReorderIsOptIn(), wireSelectorReorder() (+4 more)
...
Cohesion: 0.15
Nodes (16): applyEnvOverrides(), Load(), LoadFile(), LoadFileWithDotEnv(), TestLoadFile_Basic(), TestLoadFile_BooleanExplicitFalse(), TestLoadFile_EmptyFile(), TestLoadFile_EnvOverridesFile() (+8 more)
...
- **Why does `Append()` connect `Community 10` to `Community 2`, `Community 3`, `Community 4`, `Community 9`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 52`, `Community 54`, `Community 55`, `Community 57`, `Community 58`, `Community 59`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 75`, `Community 76`, `Community 77`, `Community 80`, `Community 83`, `Community 86`, `Community 87`, `Community 88`, `Community 92`, `Community 96`, `Community 98`, `Community 101`, `Community 107`, `Community 109`, `Community 110`, `Community 111`, `Community 117`, `Community 121`, `Community 124`, `Community 125`, `Community 126`, `Community 638`, `Community 640`, `Community 127`, `Community 130`, `Community 131`, `Community 134`, `Community 646`, `Community 136`, `Community 140`, `Community 145`, `Community 149`, `Community 150`, `Community 662`, `Community 667`, `Community 158`, `Community 159`, `Community 670`, `Community 674`, `Community 162`, `Community 164`, `Community 165`, `Community 166`, `Community 167`, `Community 173`, `Community 174`, `Community 175`, `Community 176`, `Community 689`, `Community 177`, `Community 694`, `Community 182`, `Community 696`, `Community 697`, `Community 185`, `Community 187`, `Community 186`, `Community 190`, `Community 705`, `Community 193`, `Community 198`, `Community 199`, `Community 200`, `Community 201`, `Community 202`, `Community 203`, `Community 205`, `Community 211`, `Community 727`, `Community 216`, `Community 737`, `Community 328`, `Community 332`, `Community 337`, `Community 343`, `Community 346`, `Community 348`, `Community 349`, `Community 350`, `Community 351`, `Community 360`, `Community 361`, `Community 366`, `Community 367`, `Community 886`, `Community 890`, `Community 484`, `Community 485`, `Community 492`, `Community 495`, `Community 496`, `Community 503`, `Community 504`, `Community 509`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 51` to `Community 0`, `Community 129`, `Community 132`, `Community 519`, `Community 7`, `Community 11`, `Community 15`, `Community 145`, `Community 150`, `Community 151`, `Community 664`, `Community 25`, `Community 28`, `Community 33`, `Community 37`, `Community 39`, `Community 43`, `Community 172`, `Community 44`, `Community 174`, `Community 171`, `Community 187`, `Community 71`, `Community 333`, `Community 208`, `Community 339`, `Community 93`, `Community 96`, `Community 356`, `Community 487`, `Community 360`, `Community 106`, `Community 366`, `Community 505`, `Community 123`, `Community 124`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `sleep()` connect `Community 135` to `Community 4`, `Community 132`, `Community 11`, `Community 142`, `Community 15`, `Community 145`, `Community 153`, `Community 25`, `Community 28`, `Community 34`, `Community 39`, `Community 64`, `Community 210`, `Community 85`, `Community 89`, `Community 92`, `Community 93`, `Community 733`, `Community 97`, `Community 356`, `Community 106`, `Community 107`, `Community 114`?**
