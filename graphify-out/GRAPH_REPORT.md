# Graph Report - superpowers-20260713T002811-10851188-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-13)

## Corpus Check
- 828 files · ~914,721 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20061 nodes · 31203 edges · 1692 communities (1337 shown, 355 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8163 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `33c450d5`
...
3. `NewRequest()` - 120 edges
4. `NewKnowledgeGraph()` - 119 edges
5. `BuildTree()` - 111 edges
6. `newDefaultConfig()` - 100 edges
7. `registerMCPTools()` - 100 edges
8. `sleep()` - 95 edges
9. `main()` - 74 edges
...
## Communities (1692 total, 355 thin omitted)
...
Cohesion: 0.04
Nodes (99): main(), TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails(), TestRunTask_Success(), reflectOnOutcomeAction(), TestReflectOnOutcomeAction_NilLLM(), TestReflectOnOutcomeAction_WithMockLLM(), TestNewTranspositionTable_MkdirError() (+91 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (125): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+117 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (125): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+117 more)
...
Cohesion: 0.04
Nodes (86): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit() (+78 more)
...
Cohesion: 0.04
Nodes (62): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+54 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (74): DefaultLLM(), RealLLM(), TestDetectPath_FromCurrentPath(), TestDetectPath_FromVisitedPaths(), TestDetectPath_KeywordFallback(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), EvaluateBFCLV3() (+66 more)
...
Cohesion: 0.05
Nodes (55): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), resolveTree(), agentTemplateYAML, TestResolveTreeID_FusionAliases(), HermesSelfEvolutionTree(), HermesObsidianOptimizerTree(), KanbanAutoPilotTree() (+47 more)
...
Cohesion: 0.05
Nodes (44): AgentMetrics, AgentStats, BuildIdentity, Counter, Gauge, HealthResponse, Histogram, HistogramSnap (+36 more)
...
Cohesion: 0.06
Nodes (49): DefaultRetryPolicy(), GetErrorContext(), NewErrorContext(), TestCircuitBreaker_RecordFailure_BackwardCompat(), TestErrorContext_Concurrent(), TestErrorContext_Error(), TestErrorContext_Error_Minimal(), TestErrorContext_Integration_RetryPolicy() (+41 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (60): TestConsoleTracer_ExporterReceivesCompletedSpan(), fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest() (+52 more)
...
Cohesion: 0.07
Nodes (52): TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents(), TestBuildFromArchetype(), TestConnect_Duplicate(), TestConnect_MissingNodes() (+44 more)

### Community 34 - "Community 34"
Cohesion: 0.07
Nodes (53): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection() (+45 more)
...
Cohesion: 0.05
Nodes (56): TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailureWithCategory(), TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip() (+48 more)
...
Cohesion: 0.05
Nodes (34): GateResult, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree(), SnapshotTree() (+26 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (45): ArraySchema(), IntSchema(), ObjectSchema(), findResponse(), NewRouteIndex(), ResponseValidator(), TestDashboardRoutes_AllIndexable(), TestNewRouteIndex() (+37 more)
...
Cohesion: 0.04
Nodes (55): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+47 more)
...
Cohesion: 0.09
Nodes (34): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewGraphifyTool_Structure(), TestRealToolFactory_DiscoveryAndFailClosed() (+26 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (45): TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure(), TestNewGoTestTool_Structure(), TestNewGoVetTool_Structure(), TestNewShellExecTool_Structure(), TestNewWebSearchTool_Structure(), TestRealTool_NameAndDescription() (+37 more)

### Community 49 - "Community 49"
Cohesion: 0.08
Nodes (34): Config, diffSecretField(), Duration(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry() (+26 more)
...
Cohesion: 0.09
Nodes (38): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir(), MemoryDir() (+30 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (37): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype() (+29 more)
...
Cohesion: 0.07
Nodes (27): biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), TestBiasCandidatesWithExperience_NilOrEmptyBankKeepsOrder(), TestCloneTreeForGardener_Basic() (+19 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (36): copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), DefaultRebuildTargets(), NewRebuildBackoff(), RebuildBinaries(), resolveGoBinary(), TestRebuildBinaries() (+28 more)

### Community 62 - "Community 62"
Cohesion: 0.07
Nodes (34): TestNewReinforcementLearner(), TestQTableSelectUpdateBestAction(), TestQTableStateBucketsAndDepth(), TestReinforcementLearnerLearnAndSuggest(), NewQTable(), NewReinforcementLearner(), TestExpertKnowledge_SeedSpecialistsCarryProvenance(), TestPopulationEvolve_CrisisIntervention() (+26 more)
...
Cohesion: 0.07
Nodes (26): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogin() (+18 more)

### Community 65 - "Community 65"
Cohesion: 0.08
Nodes (32): TestOutcomeErrorDetail(), FeedbackFile(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath() (+24 more)
...
Cohesion: 0.09
Nodes (36): ClearGoapFusionStateHashes(), init(), registerSuperpowersDebugActions(), superpowersDebugPhase(), superpowersDebugPhaseAction(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict() (+28 more)

### Community 79 - "Community 79"
Cohesion: 0.07
Nodes (24): TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), resolveUserTree(), TestWireSelectorReorderIsOptIn(), wireSelectorReorder() (+16 more)
...
Cohesion: 0.1
Nodes (23): AuctionDelegate(), cardWithURL(), newAuctionTransport(), newDeadlineProbeTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoCandidatesFallsBack(), TestAuctionDelegate_NoEligibleBidsFallsBack() (+15 more)
...
Cohesion: 0.13
Nodes (32): gatherFailureReviewBody(), gatherReviewContext(), loadLastReviewedSHA(), nextNlmQuotaReset(), nlmQuotaExhausted(), nlmQuotaExhaustedUntil(), runClaudeCodeReviewResearch(), runGoapGit() (+24 more)
...
Cohesion: 0.09
Nodes (28): resolverReachableExtraDomainTrees(), singleTaskSuite(), tasksForTree(), TestAgentMonitor(), TestAllDomainTreeConditionsHaveDescriptions(), TestAllDomainTreeNodesHaveDescriptions(), TestAllDomainTrees(), TestAllDomainTreeSelectorsHaveDescriptions() (+20 more)
...
Cohesion: 0.09
Nodes (29): Binaries, code:go (type Counter struct { ... }), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }) (+21 more)

### Community 131 - "Community 131"
Cohesion: 0.11
Nodes (23): main(), BTStudioCompany(), TestClient_AnalyzeComplexity_FallbackOnError(), TestClient_Generate_ConnectionRefused(), TestClient_GeneratePlan_FallbackOnError(), TestClient_Reflect_FallbackOnError(), TestDeepSeekClient_AnalyzeComplexity(), TestDeepSeekClient_Generate_APIError() (+15 more)
...
Cohesion: 0.07
Nodes (22): ErrorCategory, ApplyJitter(), DecorrelatedJitter(), EqualJitter(), ExecuteWithPolicy(), FullJitter(), sleepWithContext(), TestApplyJitter_AllStrategiesDeterministicRange() (+14 more)
...
Cohesion: 0.1
Nodes (19): init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init(), init(), init(), registerSuperpowersConditions(), TestRegisterCondition_DuplicatePanics() (+11 more)
...
Cohesion: 0.13
Nodes (23): TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing() (+15 more)
...
Cohesion: 0.18
Nodes (5): TestExtractKeywords(), TestTruncateTask(), Factory, extractKeywords(), truncateTask()
...
Cohesion: 0.18
Nodes (22): islandTestPopulation(), islandTestTree(), TestIslandModel_AddGetAndSingleIslandMigration(), TestIslandModel_DiversityEdgeCases(), TestIslandModel_DiversityStatsAndSummary(), TestIslandModel_EvolveAllEvaluatesPopulations(), TestIslandModel_LoadCapEvictionIncrementsEvictedIndividuals(), TestIslandModel_LoadCapsDiskOnlyIslandWholesaleAdoption() (+14 more)
...
Cohesion: 0.16
Nodes (18): TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), countTreeNodes(), TestSuperpowersPipelineSimulation(), TestHumanApprovalGate_AutoApprove(), TestHumanApprovalGate_ManualApprove() (+10 more)
...
Cohesion: 0.11
Nodes (20): defaultGoapReviewDeps(), init(), claudeBackoffWindow(), TestClaudeBackoffWindow_EnvOverride(), ClaudeRunner, CommandResult, CommandRunner, execClaudeRunner (+12 more)
...
Cohesion: 0.08
Nodes (16): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, DeadLetterEntry, executorFailureState, ExecutorHealthDetail, JobState (+8 more)
...
Cohesion: 0.12
Nodes (22): Analysis, Contradiction, CoveragePoint, TestJudge_ParsesStructuredJSON(), TestSynthesize_UsesAnalysisAndResponses(), TestToolLoop_StopsAtMaxToolCalls(), ModelCaller, Response (+14 more)
...
Cohesion: 0.12
Nodes (16): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), Outcome, Record, FilterByTreeName() (+8 more)
...
Cohesion: 0.16
Nodes (16): NewACPClient(), TestACPClientGenerateReturnsErrorWhenSessionMissing(), TestACPClientGenerateTalksToACPServer(), TestACPClientGenerateTalksToHermesACP(), TestACPHelperProcess(), TestNewProviderCreatesACPClient(), TestStartScanJSONLines_ReaderPanicRecoveredOnScanErr(), writeJSON() (+8 more)
...
Cohesion: 0.15
Nodes (13): AutoRebuildEnabled(), defaultDriftHead(), DriftStatus(), DriftWatchOnce(), scrubGitEnv(), StartDriftWatcher(), TestDriftStatus(), TestDriftWatchOnce() (+5 more)
...
Cohesion: 0.16
Nodes (8): OpenAICompatClient, OpenAICompatConfig, openAICompatMessage, openAICompatRequest, openAICompatResponse, checkRateLimit(), ParseRetryAfter(), TestParseRetryAfter()
...
Cohesion: 0.14
Nodes (6): agentNameInterceptor, agentNameKey, BTAgentExecutor, Server, parseAnnouncement(), SetTreeResolver()
...
Cohesion: 0.26
Nodes (12): BuiltinToolBench(), EvaluateToolBench(), formatAvailableAPIs(), TestToolBench_APISelection(), TestToolBench_EmptyEntries(), TestToolBench_EvaluateWithCodeReviewTree(), TestToolBench_IndividualEntries(), ToolBenchAPI (+4 more)
...
Cohesion: 0.16
Nodes (8): fakeCaller, fakeTool, TestJudge_RejectsInvalidJSON(), TestRunPanel_FailsWhenAllModelsFail(), TestRunPanel_PreservesPerModelErrors(), TestRunPanel_RunsModelsConcurrently(), panelSystemPrompt(), RunPanel()
...
Cohesion: 0.2
Nodes (9): ApplyHITLPolicy(), WorkflowApprovalTaskID(), WorkflowApprovalWait(), stepContext(), HITLConfig, Policy, ApplyConfig(), GetPolicy() (+1 more)
...
Cohesion: 0.36
Nodes (9): NewAuctioneer(), newFakeTransport(), TestAuctioneer_AttributesBidToAnnouncedCandidate(), TestAuctioneer_CollectsValidBids(), TestAuctioneer_DropsInvalidAndForeignBids(), TestAuctioneer_FansOutToAllCandidates(), TestAuctioneer_RejectsInvalidAnnouncement(), TestAuctioneer_SkipsErroringAndEmptyCandidates() (+1 more)
...
Cohesion: 0.22
Nodes (9): TestCreateAgentTool_Call_NilFactory(), TestReflectTool_Call_NoLLM(), TestRunTaskTool_Call(), TestToolNames_And_Descriptions(), NewCreateAgentTool(), NewFitnessTool(), NewGetTreeTool(), NewReflectTool() (+1 more)
...
Cohesion: 0.39
Nodes (6): TestMetricsTracker_CyclesForTree(), TestMetricsTracker_RecordAndSummary(), TestMetricsTracker_SaveAggregatesCrisisAndLastRun(), TestRegistry_Count(), TestRegistry_List_AllDomains(), TestRegistry_SaveAndReload()
...
## Knowledge Gaps
- **6486 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6481 more)
...
- **Why does `Append()` connect `Community 16` to `Community 0`, `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 520`, `Community 10`, `Community 523`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 527`, `Community 17`, `Community 528`, `Community 530`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 539`, `Community 28`, `Community 29`, `Community 542`, `Community 27`, `Community 34`, `Community 35`, `Community 36`, `Community 38`, `Community 551`, `Community 39`, `Community 41`, `Community 44`, `Community 45`, `Community 558`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 46`, `Community 52`, `Community 559`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 66`, `Community 67`, `Community 68`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 76`, `Community 77`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 96`, `Community 98`, `Community 106`, `Community 108`, `Community 109`, `Community 112`, `Community 115`, `Community 117`, `Community 118`, `Community 120`, `Community 123`, `Community 124`, `Community 127`, `Community 128`, `Community 136`, `Community 138`, `Community 139`, `Community 147`, `Community 148`, `Community 149`, `Community 153`, `Community 154`, `Community 155`, `Community 158`, `Community 161`, `Community 166`, `Community 169`, `Community 170`, `Community 171`, `Community 172`, `Community 177`, `Community 179`, `Community 694`, `Community 695`, `Community 697`, `Community 185`, `Community 189`, `Community 190`, `Community 193`, `Community 194`, `Community 199`, `Community 201`, `Community 202`, `Community 203`, `Community 716`, `Community 205`, `Community 207`, `Community 720`, `Community 208`, `Community 214`, `Community 215`, `Community 740`, `Community 743`, `Community 745`, `Community 747`, `Community 748`, `Community 561`, `Community 788`, `Community 344`, `Community 347`, `Community 348`, `Community 350`, `Community 359`, `Community 360`, `Community 361`, `Community 365`, `Community 366`, `Community 367`, `Community 376`, `Community 377`, `Community 378`, `Community 387`, `Community 388`, `Community 389`, `Community 391`, `Community 393`, `Community 948`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 65` to `Community 0`, `Community 1`, `Community 388`, `Community 6`, `Community 17`, `Community 536`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 157`, `Community 32`, `Community 34`, `Community 35`, `Community 37`, `Community 550`, `Community 43`, `Community 45`, `Community 173`, `Community 47`, `Community 49`, `Community 52`, `Community 54`, `Community 57`, `Community 61`, `Community 191`, `Community 66`, `Community 194`, `Community 198`, `Community 712`, `Community 208`, `Community 345`, `Community 91`, `Community 349`, `Community 100`, `Community 363`, `Community 118`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 61` to `Community 129`, `Community 131`, `Community 10`, `Community 22`, `Community 151`, `Community 536`, `Community 25`, `Community 155`, `Community 28`, `Community 157`, `Community 158`, `Community 37`, `Community 550`, `Community 40`, `Community 41`, `Community 47`, `Community 52`, `Community 55`, `Community 57`, `Community 64`, `Community 66`, `Community 194`, `Community 74`, `Community 349`, `Community 98`, `Community 100`, `Community 364`, `Community 113`, `Community 114`, `Community 118`, `Community 121`?**
...
- **Are the 119 inferred relationships involving `NewRequest()` (e.g. with `TestHITLHandlers_PendingApproveReject()` and `WorkflowApprovalWait()`) actually correct?**
  _`NewRequest()` has 119 INFERRED edges - model-reasoned connections that need verification._