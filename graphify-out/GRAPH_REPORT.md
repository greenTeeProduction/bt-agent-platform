# Graph Report - superpowers-20260715T122536-d423f5f5-goap-fusion-loop-runner-blackboard-conte  (2026-07-15)

## Corpus Check
- 866 files · ~1,029,587 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22821 nodes · 34702 edges · 1866 communities (1501 shown, 365 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8722 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `33117a53`
...
5. `registerMCPTools()` - 117 edges
6. `BuildTree()` - 111 edges
7. `arc42 Section 9 — Architecture Decisions` - 111 edges
...
## Communities (1866 total, 365 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (164): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+156 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (164): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+156 more)
...
Cohesion: 0.03
Nodes (105): ApplyJitter(), ClassifyError(), contextDeadlineExceeded(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), FullJitter(), GetCategory() (+97 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (91): expandChainStateTemplates(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM(), TestChainAction_Agent_NoTools() (+83 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (91): main(), main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview() (+83 more)
...
Cohesion: 0.02
Nodes (111): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+103 more)
...
Cohesion: 0.04
Nodes (90): truncateGoap(), saveGoapFusionStateHashes(), TestRunScheduledGoapFusionLoop_RunawayBackstopIsHalfOpen(), arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), newLoopBB() (+82 more)
...
Cohesion: 0.05
Nodes (81): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+73 more)
...
Cohesion: 0.04
Nodes (85): DefaultPanicHandler(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext() (+77 more)
...
Cohesion: 0.06
Nodes (64): Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle(), ComposePreset(), ComposePresetWithTools(), ComposeTaskTreeAgentic() (+56 more)
...
Cohesion: 0.04
Nodes (54): agentExecuteResult(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleAnalyze(), handleDLQReplay() (+46 more)
...
Cohesion: 0.05
Nodes (59): handleFellows(), NewMockLLM(), NewDefaultCompany(), CompanyOrchestrator, EngineerTree(), MarketingTree(), SalesTree(), StartupTrees() (+51 more)
...
Cohesion: 0.06
Nodes (70): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree() (+62 more)
...
Cohesion: 0.04
Nodes (62): DefaultMock(), assertNoExecutePlanStubs(), resolverReachableExtraDomainTrees(), singleTaskSuite(), tasksForTree(), TestAgentMonitor(), TestAllDomainTreeConditionsHaveDescriptions(), TestAllDomainTreeNodesHaveDescriptions() (+54 more)
...
Cohesion: 0.07
Nodes (60): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure(), TestNewGoVetTool_Structure() (+52 more)
...
Cohesion: 0.15
Nodes (52): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+44 more)

### Community 42 - "Community 42"
Cohesion: 0.07
Nodes (30): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports(), RunContext (+22 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (56): ChainConfig, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), buildMapReduceFallback(), buildToolList(), execAgent() (+48 more)

### Community 44 - "Community 44"
Cohesion: 0.1
Nodes (51): DefaultLLM(), RealLLM(), BuiltinBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic(), TestBFCLV3_MultiTurn_Composite(), TestSWEVerified_Evaluation() (+43 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (51): TestNewReinforcementLearner(), NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation() (+43 more)
...
Cohesion: 0.06
Nodes (41): min(), brokenTool, ChainKind, BuildChainAction(), buildChainActionFn(), execLLMCall(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic() (+33 more)
...
Cohesion: 0.07
Nodes (41): TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir() (+33 more)
...
Cohesion: 0.06
Nodes (33): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait() (+25 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (28): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), wireSelectorOrdering(), GardenerDeactivateAllTool, GardenerRecommendTool (+20 more)
...
Cohesion: 0.06
Nodes (33): ActionFunc, ActionProvider, init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), ConditionFunc, ConditionProvider, init() (+25 more)
...
Cohesion: 0.12
Nodes (23): AgentExecutor, NewRedisPriorityQueue(), NewRedisPriorityQueueFromClient(), NewRedisQueue(), NewRedisQueueFromClient(), redisID(), testRedisAddr(), testRedisClient() (+15 more)

### Community 72 - "Community 72"
Cohesion: 0.08
Nodes (40): biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), crisisMetricsGardener(), crisisV2Config() (+32 more)
...
Cohesion: 0.1
Nodes (31): TestGardenerRollbackTool_CallRestoresSnapshot(), GateResult, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree() (+23 more)
...
Cohesion: 0.06
Nodes (28): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, baseNodeCount(), CollectAgentSLOs() (+20 more)
...
Cohesion: 0.11
Nodes (34): NewWorkflow(), TestApproval_Fields(), TestApproveTask(), TestExecuteSprint(), TestExecuteSprint_ApprovedToCompleted(), TestExecuteSprint_NoApprovedTasks(), TestExecuteSprint_SetsGoal(), TestGetApprovedTasks() (+26 more)
...
Cohesion: 0.09
Nodes (30): goapFusionNoopPatchStreak(), defaultNlmGrillAuthGuard(), nlmGrillAnswerer(), nlmGrillUnavailable(), parseNumberedAnswers(), runGrillAuthGuardAction(), TestGoapFusionNoopPatchStreak_DurableAcrossCronTicks(), TestGoapFusionNoopPatchStreak_IncrementsOnNoopResetsOnChange() (+22 more)
...
Cohesion: 0.08
Nodes (21): AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce(), TestDriftWatchOnce_SkipsRestartWhenJobStartedMidRebuild(), TestRunJob_KicksOnCycleIdleWhenQueueEmpty() (+13 more)
...
Cohesion: 0.13
Nodes (29): growthFitness(), FitnessDimension, MultiIndividual, cappedIndividuals(), clampScore(), countActions(), countConditions(), NewMultiFitness() (+21 more)
...
Cohesion: 0.14
Nodes (23): TestRunOnce_EmitsRunRootSpan(), TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeTracer, mockOllamaServer(), newTestClient(), TestClient_AnalyzeComplexity() (+15 more)

### Community 148 - "Community 148"
Cohesion: 0.13
Nodes (21): CaptureAuditEvent(), NewAuditBuffer(), SetGlobalAuditBuffer(), TestAuditBuffer_Capacity(), TestAuditBuffer_EmptyBuffer(), TestAuditBuffer_PushAndCount(), TestAuditBuffer_RecentNegative(), TestAuditBuffer_RecentOrder() (+13 more)
...
Cohesion: 0.14
Nodes (19): AgentMetrics, AgentStats, BuildIdentity, HealthResponse, LabeledGauge, formatPromLabels(), GetAgentMetrics(), labeledSnapshotToMap() (+11 more)
...
Cohesion: 0.11
Nodes (15): tracingMiddleware(), ContextWithTraceParentHeader(), Endpoint(), InitFromEnv(), parseOTLPEndpoint(), ParseOTLPTarget(), newRecordingTracer(), TestContextWithTraceParentHeader() (+7 more)
...
Cohesion: 0.22
Nodes (23): TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest(), TestTracingMiddleware_StatusCodes(), TestTracingMiddleware_WroteHeaderGuard() (+15 more)
...
Cohesion: 0.12
Nodes (9): builtinBlocks(), DelegateBlock(), EvolveOnFailureBlock(), HITLEscalateBlock(), HumanGateBlock(), HITLTieredBlock(), MemoryLoadBlock(), MemoryWriteBlock() (+1 more)

### Community 408 - "Community 408"
Cohesion: 0.24
Nodes (14): TemplatesDir(), NewRunDeps(), cmdCreate(), cmdDelete(), cmdInstallTemplates(), cmdList(), cmdLogs(), cmdRun() (+6 more)
...
Cohesion: 0.24
Nodes (13): isGoapInfraCycleFailure(), refundGoapMilestoneAttemptForInfraFailure(), refundProbeHeadMilestone(), seedRefundProgram(), TestIsGoapInfraCycleFailure(), TestIsGoapInfraCycleFailure_OwnCodeGateFailureCharges(), TestPrioritizeGoapGoals_StampsChargedMilestone(), TestRefundGoapMilestoneAttempt_HeadRefFallbackAndNoop() (+5 more)
...
Cohesion: 0.24
Nodes (13): NewAnalyzer(), TestAnalyzer_EmptyResponse_Error(), TestAnalyzer_NoStrategyPath_Error(), TestAnalyzer_ParsesTreeSpec(), TestFactory_CreateFromContent(), TestFactory_CreateFromFile(), TestFactory_CreateFromSkillDir_MdPath(), TestGenerator_BuildsCorrectTree() (+5 more)
...
Cohesion: 0.22
Nodes (7): handleSecurityAudit(), CountEvents(), GlobalAuditBuffer(), AuditBuffer, AuditBufferJSON, AuditEvent, AuditEventCounts
...
Cohesion: 0.18
Nodes (11): code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), code:go (type AgentCard struct { Name, Description, URL string }), Package: a2a, Package: eval, Package: log (+3 more)
...
Cohesion: 0.2
Nodes (3): TestFactory_RejectsInvalidGeneratedTreeBeforePersisting(), TestGenerator_CompilesSkillActionsToChainActions(), regressionMockLLM
...
Cohesion: 0.22
Nodes (9): code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), Package: langagent, Package: reflection, Package: validate (+1 more)
...
## Knowledge Gaps
- **8129 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8124 more)
...
- **Why does `Append()` connect `Community 23` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 27`, `Community 30`, `Community 31`, `Community 33`, `Community 34`, `Community 36`, `Community 38`, `Community 39`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 56`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 66`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 1100`, `Community 77`, `Community 76`, `Community 79`, `Community 80`, `Community 1105`, `Community 82`, `Community 83`, `Community 84`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 606`, `Community 608`, `Community 610`, `Community 99`, `Community 101`, `Community 614`, `Community 103`, `Community 102`, `Community 105`, `Community 616`, `Community 111`, `Community 112`, `Community 113`, `Community 630`, `Community 118`, `Community 119`, `Community 123`, `Community 126`, `Community 127`, `Community 128`, `Community 129`, `Community 132`, `Community 134`, `Community 140`, `Community 141`, `Community 145`, `Community 156`, `Community 158`, `Community 162`, `Community 164`, `Community 175`, `Community 177`, `Community 178`, `Community 179`, `Community 184`, `Community 185`, `Community 192`, `Community 193`, `Community 196`, `Community 199`, `Community 205`, `Community 206`, `Community 208`, `Community 212`, `Community 215`, `Community 219`, `Community 220`, `Community 221`, `Community 805`, `Community 806`, `Community 812`, `Community 828`, `Community 830`, `Community 837`, `Community 857`, `Community 864`, `Community 866`, `Community 877`, `Community 880`, `Community 386`, `Community 391`, `Community 392`, `Community 395`, `Community 396`, `Community 397`, `Community 403`, `Community 404`, `Community 405`, `Community 407`, `Community 408`, `Community 409`, `Community 416`, `Community 419`, `Community 420`, `Community 423`, `Community 424`, `Community 429`, `Community 430`, `Community 432`, `Community 436`, `Community 437`, `Community 438`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 55` to `Community 898`, `Community 3`, `Community 4`, `Community 5`, `Community 394`, `Community 140`, `Community 17`, `Community 18`, `Community 24`, `Community 25`, `Community 155`, `Community 31`, `Community 32`, `Community 415`, `Community 37`, `Community 38`, `Community 40`, `Community 41`, `Community 42`, `Community 169`, `Community 174`, `Community 176`, `Community 52`, `Community 58`, `Community 61`, `Community 192`, `Community 833`, `Community 71`, `Community 73`, `Community 202`, `Community 207`, `Community 212`, `Community 98`, `Community 112`, `Community 120`, `Community 124`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 24` to `Community 128`, `Community 129`, `Community 4`, `Community 389`, `Community 138`, `Community 18`, `Community 22`, `Community 23`, `Community 408`, `Community 25`, `Community 158`, `Community 160`, `Community 32`, `Community 40`, `Community 41`, `Community 42`, `Community 44`, `Community 45`, `Community 51`, `Community 1204`, `Community 53`, `Community 52`, `Community 55`, `Community 61`, `Community 64`, `Community 66`, `Community 67`, `Community 73`, `Community 207`, `Community 210`, `Community 86`, `Community 88`, `Community 221`, `Community 102`, `Community 123`, `Community 127`?**
