# Graph Report - superpowers-20260712T205433-8d421b65-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-12)

## Corpus Check
- 824 files · ~902,655 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19663 nodes · 30728 edges · 1667 communities (1302 shown, 365 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8101 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6980018d`
...
## Communities (1667 total, 365 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (108): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+100 more)
...
Cohesion: 0.02
Nodes (119): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+111 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (119): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+111 more)
...
Cohesion: 0.04
Nodes (88): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+80 more)
...
Cohesion: 0.04
Nodes (67): AutoRebuildEnabled(), StartDriftWatcher(), WorkflowsDir(), DashboardRebuildTargets(), DefaultRebuildTargets(), TestRunOnce_EmitsRunRootSpan(), NewRunDeps(), logA2AServeError() (+59 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (70): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+62 more)
...
Cohesion: 0.04
Nodes (81): auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext(), AuditMiddleware() (+73 more)
...
Cohesion: 0.07
Nodes (59): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+51 more)
...
Cohesion: 0.06
Nodes (42): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), parseChainConfig(), TestChainAction_ParseConfig(), readPostconditions() (+34 more)
...
Cohesion: 0.13
Nodes (51): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Research(), TestTree_Research() (+43 more)
...
Cohesion: 0.06
Nodes (29): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports(), TestValidateQualitySpec_BlockedPattern() (+21 more)
...
Cohesion: 0.08
Nodes (45): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), Duration(), TestDuration(), NewExperienceBank() (+37 more)
...
Cohesion: 0.04
Nodes (47): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+39 more)
...
Cohesion: 0.07
Nodes (31): TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeSpan, fakeTracer, mockOllamaServer(), newTestClient(), TestClient_AnalyzeComplexity() (+23 more)

### Community 58 - "Community 58"
Cohesion: 0.11
Nodes (35): TestRunSuiteIsSandboxed(), defaultNlmGrillAuthGuard(), runGrillAuthGuardAction(), TestRunGrillAuthGuardAction_PreservesBlackboardResultAndOutcome(), TestRunGrillAuthGuardAction_SuccessReturnsNilAndPreservesBlackboard(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload() (+27 more)
...
Cohesion: 0.08
Nodes (26): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, Histogram, LabeledCounter, LabeledGauge (+18 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (38): Outcome, Record, FilterByTreeName(), biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener() (+30 more)

### Community 63 - "Community 63"
Cohesion: 0.1
Nodes (37): CompressionMiddleware(), isCompressibleContentType(), gzipDecompress(), TestCompressionMiddleware_AlreadyCompressed(), TestCompressionMiddleware_BinaryContentType(), TestCompressionMiddleware_EmptyBody(), TestCompressionMiddleware_GzipRequest(), TestCompressionMiddleware_HTMLContentType() (+29 more)
...
Cohesion: 0.07
Nodes (32): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype() (+24 more)
...
Cohesion: 0.06
Nodes (20): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, Gardener, baseNodeCount() (+12 more)
...
Cohesion: 0.09
Nodes (28): TestTeslaDeepResearch(), TestTeslaQuickResearch(), TestClient_AnalyzeComplexity_FallbackOnError(), TestClient_Generate_ConnectionRefused(), TestClient_GeneratePlan_FallbackOnError(), TestClient_Reflect_FallbackOnError(), TestDeepSeekClient_AnalyzeComplexity(), TestDeepSeekClient_Generate_APIError() (+20 more)
...
Cohesion: 0.08
Nodes (17): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAlertRules(), handleLogin(), handleLogout(), handleMetricsLive(), handleOpenAPI() (+9 more)
...
Cohesion: 0.09
Nodes (25): FeedbackFile(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath(), hostURLOf(), newLocalAgentExecutor() (+17 more)
...
Cohesion: 0.12
Nodes (23): TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestHumanApprovalGate_AutoApprove(), TestHumanApprovalGate_ManualApprove(), TestHumanApprovalGate_PostPhase(), BuildAndValidate() (+15 more)
...
Cohesion: 0.09
Nodes (17): defaultDriftHead(), DriftStatus(), DriftWatchOnce(), scrubGitEnv(), TestDriftStatus(), TestDriftWatchOnce(), TestDriftWatchOnce_RespectsBackoffGuard(), DriftResult (+9 more)

### Community 133 - "Community 133"
Cohesion: 0.1
Nodes (18): exportMemoryCategory(), exportPreviousRuns(), TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir() (+10 more)
...
Cohesion: 0.16
Nodes (6): TestExtractKeywords(), Factory, extractKeywords(), extractSubtree(), jsonCloneNode(), truncateTask()
...
Cohesion: 0.16
Nodes (20): computeHMAC(), DefaultWebhookSecrets(), NewWebhookPublisher(), TestComputeHMAC(), TestComputeHMAC_Deterministic(), TestComputeHMAC_DifferentKeys(), TestDefaultWebhookSecrets(), TestNewWebhookPublisher() (+12 more)
...
Cohesion: 0.13
Nodes (19): extractTaskID(), init(), nlmAuthNeedsRefresh(), nlmAuthUnhealthy(), registerNotebookLMActions(), writeString(), recentImplementedGoals(), superpowersPlanAlreadyImplemented() (+11 more)
...
Cohesion: 0.18
Nodes (11): NewACPClient(), sameJSONID(), scanJSONLines(), TestACPClientGenerateReturnsErrorWhenSessionMissing(), TestACPClientGenerateTalksToACPServer(), TestACPClientGenerateTalksToHermesACP(), TestACPHelperProcess(), writeJSON() (+3 more)

### Community 193 - "Community 193"
Cohesion: 0.15
Nodes (13): TestNewProviderCreatesACPClient(), NewFallbackLLM(), TestFallbackLLM_GenerateReturnsAllFailures(), TestFallbackLLM_GenerateUsesNextModelAfterPrimaryFailure(), TestNewProvider_BuildsFallbackChainFromConfiguredModels(), fallbackSpec, buildProvider(), isKnownProvider() (+5 more)
...
Cohesion: 0.13
Nodes (16): agentNameInterceptor, agentNameKey, TestEligibleBidders(), TestEligibleBidders_NoRequiredTagsMatchesAll(), BTAgentExecutor, BuildCardRegistry(), cardCoversTags(), ConvertToAgentCard() (+8 more)
...
Cohesion: 0.18
Nodes (13): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_Existing(), TestAutoCreateTree_New(), TestDetermineCategory(), AutoCreateTree(), AutoCreateTreeWith(), containsAnyStr(), determineCategory() (+5 more)
...
Cohesion: 0.23
Nodes (12): BuildIdentityFromBuildInfo(), exposedBuildIdentity(), ReadBuildIdentity(), SetBuildIdentity(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered(), TestBlockDurationHistogramSeriesRendered(), TestBuildIdentityFromBuildInfo() (+4 more)
...
## Knowledge Gaps
- **6244 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6239 more)
...
- **Why does `Append()` connect `Community 5` to `Community 0`, `Community 1`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 519`, `Community 11`, `Community 12`, `Community 13`, `Community 526`, `Community 15`, `Community 14`, `Community 17`, `Community 18`, `Community 19`, `Community 16`, `Community 21`, `Community 24`, `Community 536`, `Community 27`, `Community 31`, `Community 34`, `Community 36`, `Community 37`, `Community 39`, `Community 43`, `Community 44`, `Community 45`, `Community 48`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 66`, `Community 67`, `Community 69`, `Community 70`, `Community 72`, `Community 73`, `Community 74`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 86`, `Community 91`, `Community 95`, `Community 96`, `Community 103`, `Community 104`, `Community 105`, `Community 107`, `Community 110`, `Community 112`, `Community 113`, `Community 114`, `Community 118`, `Community 122`, `Community 125`, `Community 128`, `Community 130`, `Community 131`, `Community 133`, `Community 134`, `Community 135`, `Community 136`, `Community 137`, `Community 139`, `Community 143`, `Community 144`, `Community 147`, `Community 148`, `Community 151`, `Community 665`, `Community 155`, `Community 668`, `Community 157`, `Community 158`, `Community 669`, `Community 168`, `Community 170`, `Community 171`, `Community 172`, `Community 684`, `Community 176`, `Community 179`, `Community 691`, `Community 181`, `Community 693`, `Community 180`, `Community 182`, `Community 191`, `Community 192`, `Community 193`, `Community 198`, `Community 712`, `Community 713`, `Community 202`, `Community 203`, `Community 201`, `Community 205`, `Community 715`, `Community 200`, `Community 213`, `Community 214`, `Community 215`, `Community 216`, `Community 736`, `Community 340`, `Community 344`, `Community 345`, `Community 351`, `Community 353`, `Community 355`, `Community 356`, `Community 361`, `Community 364`, `Community 369`, `Community 371`, `Community 379`, `Community 909`, `Community 911`, `Community 499`, `Community 501`, `Community 504`, `Community 508`, `Community 509`?**
  _High betweenness centrality (0.141) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 36` to `Community 0`, `Community 1024`, `Community 1`, `Community 131`, `Community 5`, `Community 133`, `Community 9`, `Community 11`, `Community 15`, `Community 154`, `Community 30`, `Community 31`, `Community 159`, `Community 32`, `Community 37`, `Community 51`, `Community 180`, `Community 54`, `Community 954`, `Community 61`, `Community 69`, `Community 200`, `Community 206`, `Community 207`, `Community 208`, `Community 80`, `Community 216`, `Community 91`, `Community 354`, `Community 104`, `Community 363`, `Community 108`, `Community 114`, `Community 118`, `Community 124`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 11` to `Community 0`, `Community 1`, `Community 517`, `Community 6`, `Community 133`, `Community 12`, `Community 16`, `Community 19`, `Community 153`, `Community 157`, `Community 30`, `Community 31`, `Community 36`, `Community 39`, `Community 44`, `Community 686`, `Community 47`, `Community 49`, `Community 51`, `Community 193`, `Community 197`, `Community 207`, `Community 103`, `Community 108`, `Community 109`, `Community 366`, `Community 118`, `Community 123`?**
