# Graph Report - superpowers-20260712T234910-83eaaa9a-goap-fusion-loop-runner-blackboard-conte  (2026-07-13)

## Corpus Check
- 828 files · ~913,089 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19998 nodes · 31131 edges · 1677 communities (1312 shown, 365 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8158 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1dfcb910`
...
- `TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesRunsWritable()` --calls--> `References`  [INFERRED]
  internal/engine/superpowers_runtime_contract_test.go → docs/adr/ADR-008-composable-blocks.md
...
## Communities (1677 total, 365 thin omitted)
...
Cohesion: 0.02
Nodes (124): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+116 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (124): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+116 more)
...
Cohesion: 0.03
Nodes (97): min(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), handleAnalyze(), brokenTool, ChainConfig, ChainKind (+89 more)
...
Cohesion: 0.04
Nodes (85): main(), main(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+77 more)
...
Cohesion: 0.04
Nodes (76): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), TestComposeAndExpand(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle() (+68 more)
...
Cohesion: 0.04
Nodes (87): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+79 more)
...
Cohesion: 0.03
Nodes (28): AgentMetric, Alert, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts() (+20 more)
...
Cohesion: 0.04
Nodes (54): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+46 more)
...
Cohesion: 0.06
Nodes (32): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), countTreeNodes(), TestSuperpowersPipelineSimulation(), TestHumanApprovalGate_AutoApprove() (+24 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (30): Outcome, Record, FilterByTreeName(), Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped() (+22 more)
...
Cohesion: 0.1
Nodes (45): TestSaveTo_PersistsCorrectly(), TestTreeRoundTrip(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_PruningOnNodeExplosion(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune() (+37 more)
...
Cohesion: 0.06
Nodes (35): TestNewReinforcementLearner(), TestEvolveWithExperience_ResurrectsExtinctSpecialist(), TestQTableSelectUpdateBestAction(), TestQTableStateBucketsAndDepth(), TestReinforcementLearnerLearnAndSuggest(), NewQTable(), NewReinforcementLearner(), TestExpertKnowledge_SeedSpecialistsCarryProvenance() (+27 more)
...
Cohesion: 0.09
Nodes (20): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_New(), TestDetermineCategory(), TestExtractKeywords(), TestTruncateTask(), Factory, AutoCreateTree(), AutoCreateTreeWith() (+12 more)
...
Cohesion: 0.12
Nodes (36): recentImplementedGoals(), TestRecentImplementedGoalsReadsStore(), deriveNotebookLMResearchQuery(), isBoilerplateResearchTopic(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery() (+28 more)
...
Cohesion: 0.12
Nodes (36): Duration(), TestNewPopulation_Evolution(), TestPopulation_Diversity(), TestPopulation_StatsAccessors(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve() (+28 more)

### Community 84 - "Community 84"
Cohesion: 0.08
Nodes (31): Block, ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category, ComposeSpec (+23 more)
...
Cohesion: 0.08
Nodes (29): AntiPattern, countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New() (+21 more)
...
Cohesion: 0.11
Nodes (16): BTOptimizer, collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestSplitCamelCase(), isDefaultPath(), pathEntropy() (+8 more)
...
Cohesion: 0.13
Nodes (14): extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), collectNodeNames(), Crossover(), ExperienceRetrievalHits(), hashTree() (+6 more)
...
Cohesion: 0.16
Nodes (27): CompressionMiddleware(), gzipDecompress(), TestCompressionMiddleware_AlreadyCompressed(), TestCompressionMiddleware_BinaryContentType(), TestCompressionMiddleware_EmptyBody(), TestCompressionMiddleware_GzipRequest(), TestCompressionMiddleware_HTMLContentType(), TestCompressionMiddleware_LargeJSONResponse() (+19 more)
...
Cohesion: 0.14
Nodes (20): collectSelectorNames(), SelectorStatsFile(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing() (+12 more)
...
Cohesion: 0.11
Nodes (19): main(), captureExporter, ExportedEvent, ExportedSpan, ConfigureOTLPFromEnv(), firstNonEmpty(), NewOTLPHTTPExporter(), otlpTracePayload() (+11 more)
...
Cohesion: 0.12
Nodes (16): copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), defaultRebuildMaterialize(), DefaultRebuildTargets(), NewRebuildBackoff(), RebuildBinaries(), resolveGoBinary() (+8 more)
...
Cohesion: 0.16
Nodes (19): TestBTOptimizer_New(), TestDTAnalyzer_New(), TestExtractCondition(), TestFindMainSelector(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), NewBTOptimizer() (+11 more)
...
Cohesion: 0.18
Nodes (17): NewEvolvedAgent(), TestConfig_AllFields(), TestCreateAgentTool_Call_NilFactory(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_StructFields(), TestNewEvolvedAgent_AllToolsRegistered(), TestNewEvolvedAgent_MinimalConfig() (+9 more)
...
Cohesion: 0.11
Nodes (10): builtinBlocks(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), HumanGateBlock(), HumanReviewBlock(), HITLTieredBlock() (+2 more)
...
Cohesion: 0.21
Nodes (11): NewMockLLM(), NewThinkTank(), TestFullAnalysis_MultipleTopics(), TestNewThinkTank(), TestOrchestrator_Debate(), TestOrchestrator_EmptyTopic(), TestOrchestrator_FullAnalysis(), TestOrchestrator_PeerReview() (+3 more)
...
Cohesion: 0.14
Nodes (13): TestAutoCreateTree_Existing(), TestConnect_GlobalGraph(), TestDiscover_GlobalGraphVariety(), TestKnowledgeGraph_GlobalConsistency(), TestListByCategory_All(), TestListByCategory_NonExistent(), TestNewFactory(), TestQuery_ByAction() (+5 more)
...
## Knowledge Gaps
- **6446 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6441 more)
...
- **Why does `Append()` connect `Community 16` to `Community 0`, `Community 513`, `Community 514`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 517`, `Community 9`, `Community 10`, `Community 13`, `Community 14`, `Community 15`, `Community 528`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 534`, `Community 24`, `Community 537`, `Community 27`, `Community 28`, `Community 539`, `Community 29`, `Community 30`, `Community 34`, `Community 35`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 42`, `Community 43`, `Community 44`, `Community 46`, `Community 48`, `Community 49`, `Community 50`, `Community 53`, `Community 54`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 69`, `Community 72`, `Community 75`, `Community 77`, `Community 78`, `Community 81`, `Community 82`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 92`, `Community 95`, `Community 97`, `Community 99`, `Community 100`, `Community 104`, `Community 106`, `Community 110`, `Community 113`, `Community 116`, `Community 117`, `Community 118`, `Community 122`, `Community 123`, `Community 125`, `Community 126`, `Community 128`, `Community 131`, `Community 133`, `Community 135`, `Community 137`, `Community 139`, `Community 141`, `Community 143`, `Community 145`, `Community 151`, `Community 153`, `Community 154`, `Community 157`, `Community 159`, `Community 675`, `Community 167`, `Community 169`, `Community 170`, `Community 171`, `Community 172`, `Community 176`, `Community 178`, `Community 179`, `Community 694`, `Community 182`, `Community 695`, `Community 699`, `Community 189`, `Community 191`, `Community 193`, `Community 195`, `Community 197`, `Community 200`, `Community 201`, `Community 714`, `Community 202`, `Community 718`, `Community 212`, `Community 213`, `Community 739`, `Community 763`, `Community 344`, `Community 345`, `Community 347`, `Community 348`, `Community 352`, `Community 355`, `Community 356`, `Community 357`, `Community 367`, `Community 369`, `Community 375`, `Community 378`, `Community 380`, `Community 509`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 38` to `Community 0`, `Community 5`, `Community 8`, `Community 1032`, `Community 10`, `Community 15`, `Community 16`, `Community 155`, `Community 28`, `Community 158`, `Community 33`, `Community 48`, `Community 54`, `Community 55`, `Community 57`, `Community 186`, `Community 58`, `Community 61`, `Community 63`, `Community 67`, `Community 963`, `Community 73`, `Community 204`, `Community 205`, `Community 82`, `Community 83`, `Community 341`, `Community 89`, `Community 95`, `Community 740`, `Community 110`, `Community 113`, `Community 116`, `Community 123`, `Community 381`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 73` to `Community 0`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 13`, `Community 20`, `Community 28`, `Community 29`, `Community 160`, `Community 37`, `Community 38`, `Community 39`, `Community 167`, `Community 42`, `Community 45`, `Community 687`, `Community 177`, `Community 52`, `Community 54`, `Community 55`, `Community 57`, `Community 58`, `Community 67`, `Community 205`, `Community 83`, `Community 342`, `Community 91`, `Community 94`, `Community 95`, `Community 358`, `Community 359`, `Community 105`, `Community 113`, `Community 375`, `Community 507`?**
