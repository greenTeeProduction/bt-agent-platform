# Graph Report - superpowers-20260714T021521-daa90a50-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-14)

## Corpus Check
- 844 files · ~971,494 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21649 nodes · 33122 edges · 1784 communities (1433 shown, 351 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8409 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6e948f81`
...
1. `Append()` - 392 edges
2. `NewRequest()` - 134 edges
3. `DefaultTree()` - 133 edges
4. `NewKnowledgeGraph()` - 124 edges
5. `BuildTree()` - 111 edges
6. `registerMCPTools()` - 104 edges
7. `newDefaultConfig()` - 100 edges
8. `sleep()` - 95 edges
9. `arc42 Section 9 — Architecture Decisions` - 93 edges
10. `main()` - 78 edges
...
## Communities (1784 total, 351 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (149): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+141 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (149): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+141 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (106): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+98 more)
...
Cohesion: 0.03
Nodes (84): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+76 more)
...
Cohesion: 0.04
Nodes (90): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit() (+82 more)
...
Cohesion: 0.05
Nodes (79): TestBlackboard_AllFields(), TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails(), TestRunTask_Success(), TestIntegration_ReflectionAndPersistence(), reflectOnOutcomeAction(), TestReflectOnOutcomeAction_NilLLM(), TestReflectOnOutcomeAction_WithMockLLM() (+71 more)
...
Cohesion: 0.02
Nodes (93): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+85 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (66): docgenState, allSections(), buildSectionMap(), contains(), fileHash(), hashSectionSources(), isSectionDone(), main() (+58 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (78): auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext(), AuditMiddleware() (+70 more)
...
Cohesion: 0.04
Nodes (42): Outcome, Record, FilterByTreeName(), Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped() (+34 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (58): DefaultRetryPolicy(), GetCategory(), GetErrorContext(), NewCategorizedError(), NewErrorContext(), TestCategorizedError_Error(), TestCategorizedError_NilError(), TestCategorizedError_Unwrap() (+50 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (68): TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure(), TestNewGoTestTool_Structure() (+60 more)
...
Cohesion: 0.06
Nodes (62): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+54 more)
...
Cohesion: 0.03
Nodes (10): emptyDecomposeMockLLM, flakyDecomposeMockLLM, flakyRefineMockLLM, flakySubtaskMockLLM, incompleteSynthMockLLM, largeSubtaskMockLLM, nudgeRecoveryMockLLM, promptRecordingMockLLM (+2 more)
...
Cohesion: 0.06
Nodes (60): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection() (+52 more)
...
Cohesion: 0.06
Nodes (49): ArraySchema(), BoolSchema(), IntSchema(), ObjectSchema(), TestConvenienceSchemaConstructors(), findResponse(), NewRouteIndex(), ResponseValidator() (+41 more)
...
Cohesion: 0.05
Nodes (57): TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailure_BackwardCompat(), TestCircuitBreaker_RecordFailureWithCategory(), TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory() (+49 more)
...
Cohesion: 0.07
Nodes (50): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), TestIsGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation() (+42 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (42): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, scriptedClaudeRunner, scriptedSuperpowersRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo() (+34 more)
...
Cohesion: 0.05
Nodes (21): AgentMetric, Alert, AlertReport, MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON(), evaluateGlobalAlerts() (+13 more)
...
Cohesion: 0.09
Nodes (31): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestRealToolFactory_DiscoveryAndFailClosed(), realTool (+23 more)

### Community 48 - "Community 48"
Cohesion: 0.1
Nodes (45): Duration(), TestDuration(), TestNewPopulation_Evolution(), TestPopulation_Diversity(), DefaultTree(), TestPopulation_StatsAccessors(), jaccardSimilarity(), NewExperienceBank() (+37 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (42): countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New() (+34 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (39): ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure(), TestValidateOutputQualityRejectsRefusals() (+31 more)
...
Cohesion: 0.16
Nodes (42): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Research(), TestTree_Research() (+34 more)
...
Cohesion: 0.06
Nodes (30): AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce(), TestAutoRestartEnabled(), TestDriftWatchOnceRestartHandoff() (+22 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (32): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait() (+24 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (34): TestOutcomeErrorDetail(), FeedbackFile(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath() (+26 more)
...
Cohesion: 0.1
Nodes (23): AgentRunner, Checkpoint, TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports(), RunContext, ScheduledJob, Scheduler, applyJobSchedule() (+15 more)
...
Cohesion: 0.06
Nodes (31): CategorizedError, ErrorContext, ClassifyError(), contextDeadlineExceeded(), isAuthError(), isLLMError(), isNetworkError(), isRateLimitError() (+23 more)
...
Cohesion: 0.11
Nodes (38): buildClaudeReviewPrompt(), defaultGoapReviewDeps(), gatherFailureReviewBody(), gatherReviewContext(), init(), loadLastReviewedSHA(), nextNlmQuotaReset(), nlmQuotaExhausted() (+30 more)
...
Cohesion: 0.08
Nodes (38): biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), crisisMetricsGardener(), crisisV2Config() (+30 more)
...
Cohesion: 0.1
Nodes (28): NewHistory(), TestHistory_AllStats(), TestHistory_Cleanup(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestRunJob_WarnsOnDeployDriftAtCycleComplete(), TestRunJob_WebhookIncludesBuildRevision(), NewScheduler() (+20 more)
...
Cohesion: 0.1
Nodes (24): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, LabeledGauge, exposedBuildIdentity(), formatPromLabels() (+16 more)

### Community 113 - "Community 113"
Cohesion: 0.13
Nodes (23): DiversityMetrics, EvolutionParameters, FitnessMetrics, BuildPopulationState(), BuildPopulationStateWithGrid(), clamp01(), clampMutationRate(), DefaultPhaseRanges() (+15 more)
...
Cohesion: 0.1
Nodes (26): NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad(), TestScheduler_NoJobStore_NilSafe(), TestScheduler_PersistenceOnSchedule(), TestScheduler_RestoreJobsOnStartup() (+18 more)
...
Cohesion: 0.14
Nodes (25): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), LogsDir(), MemoryDir(), RegistryDir() (+17 more)
...
Cohesion: 0.14
Nodes (25): agentNameInterceptor, agentNameKey, ScoreAnnouncement(), BTAgentExecutor, cardResponder, parseAnnouncement(), RespondToAnnouncement(), SetTreeResolver() (+17 more)

### Community 130 - "Community 130"
Cohesion: 0.09
Nodes (17): ChangeCallback, ConfigWatcher, TestActionForName_BulkCoverage(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), DefaultPanicHandler(), Recover(), SafeGo() (+9 more)
...
Cohesion: 0.11
Nodes (23): min(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), handleAnalyze(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState() (+15 more)
...
Cohesion: 0.1
Nodes (17): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), wireSelectorOrdering(), GardenerRecommendTool, GardenerRunCycleTool (+9 more)
...
Cohesion: 0.11
Nodes (21): extractTaskID(), init(), nlmAuthNeedsRefresh(), nlmAuthUnhealthy(), registerNotebookLMActions(), writeString(), recentImplementedGoals(), superpowersPlanAlreadyImplemented() (+13 more)
...
Cohesion: 0.1
Nodes (14): main(), ApplyHITLPolicy(), NewPageAgent(), TestAgentLLMGeneration(), TestAgentMockFallback(), TestBubbleRecommendation(), NewHandler(), TestHandleBookmark() (+6 more)
...
Cohesion: 0.1
Nodes (15): handleFellows(), mockLLM, DefaultFellows(), NewThinkTank(), TestDefaultFellows(), TestFellowConfidence(), TestFullAnalysis_MultipleTopics(), TestNewThinkTank() (+7 more)
...
Cohesion: 0.13
Nodes (24): TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), degeneratePopulation(), runWithoutPanic(), TestEvolve_DegeneratePopulations(), TestEvolveWithExperience_DegeneratePopulations(), TestMemeticEvolve_DegeneratePopulations(), NewLocalSearcher() (+16 more)
...
Cohesion: 0.12
Nodes (8): FitnessFunc, collectNodeNames(), randomNodeName(), firstNodeNameByType(), maxInt(), MCTSMetrics, MCTSMutator, MCTSNode

### Community 162 - "Community 162"
Cohesion: 0.16
Nodes (23): BehavioralDescriptor, FeatureDimension, Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid(), NewMAPElitesPopulation(), countCondsActs(), diagonalSpecimen() (+15 more)

### Community 163 - "Community 163"
Cohesion: 0.08
Nodes (14): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, ConcurrencyLimiter, DeadLetterEntry, executorFailureState, ExecutorHealthDetail (+6 more)
...
Cohesion: 0.13
Nodes (24): goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionPreflightWired(), goapFusionRepeatedHashBypassed(), init() (+16 more)
...
Cohesion: 0.13
Nodes (13): NewNSGAIIPopulation(), NewNSGAIISorter(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic(), TestNSGAII_FastNonDominatedSort() (+5 more)
...
Cohesion: 0.1
Nodes (16): init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init(), init(), init(), registerSuperpowersConditions(), TestRegisterCondition_DuplicatePanics() (+8 more)
...
Cohesion: 0.19
Nodes (7): hasExecutionPathFirst(), hasUnboundedRetry(), MetaValidationDecision, MetaValidationIssue, MetaValidationReport, MetaValidator, MetaValidatorConfig

### Community 186 - "Community 186"
Cohesion: 0.13
Nodes (17): TestMatchBlockPattern(), AntiPattern, DesignPattern, BlockIDFromRef(), containsStr(), coreHeuristics(), hasNodeMatching(), hasNodeType() (+9 more)

### Community 187 - "Community 187"
Cohesion: 0.18
Nodes (21): FitnessDimension, MultiIndividual, clampScore(), countActions(), countConditions(), NewMultiFitness(), NewParetoFront(), NewParetoPopulation() (+13 more)
...
Cohesion: 0.15
Nodes (14): TestRunOnceFlushesSelectorTelemetry(), TestSelectorStatsFileSanitizesTreeID(), GoalArchetype, GoalFactory, clamp01(), containsAny(), DetectArchetype(), extractJSONObject() (+6 more)

### Community 192 - "Community 192"
Cohesion: 0.13
Nodes (13): NewDocPlanner(), fakeBlackboard, NewBlackboardBridge(), TestAgentFailurePathsAndSummary(), TestBlackboardBridgeHandlesNilChainStateAndFailure(), TestBlackboardBridgeSyncAndPlanSuccess(), TestBuildGoalFromTaskMultipleKeywordsAndTruncation(), TestDocPlannerAlreadyCompleteReturnsEmptyPlan() (+5 more)
...
Cohesion: 0.12
Nodes (12): exportMemoryCategory(), exportPreviousRuns(), ResolvePipelineAgent(), RunDeps, applyOutcomeRefinement(), isHealthyOutcome(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome() (+4 more)
...
Cohesion: 0.17
Nodes (15): GateResult, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree(), SnapshotTree() (+7 more)

### Community 202 - "Community 202"
Cohesion: 0.19
Nodes (18): containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest(), TestRunTask_KnowledgeGap_RoutesToKnowledgePath() (+10 more)
...
Cohesion: 0.15
Nodes (17): TestBTOptimizer_New(), collectSelectors(), conditionOverlap(), findMainSelector(), TestFindMainSelector(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths() (+9 more)

### Community 221 - "Community 221"
Cohesion: 0.18
Nodes (15): apiFetch(), getCookie(), Alert, cbIcon(), createAgent(), deleteAgent(), loadAgents(), runAgent() (+7 more)
...
Cohesion: 0.15
Nodes (11): handleWorkflowApprove(), handleWorkflowPending(), handleWorkflowReject(), TestCurrentWorkflow_GuardedByMutex(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation(), TestHandleWorkflowApprovalEndpoints(), TestHandleWorkflowApproveReject_UpdatesTaskStore() (+3 more)
...
Cohesion: 0.27
Nodes (14): baselineCmd(), baselinePath(), checkCmd(), main(), printUsage(), resetCmd(), showCmd(), NewBaselineStore() (+6 more)
...
Cohesion: 0.2
Nodes (10): injectPersonaContext(), mineUserPatterns(), personaEmbedder(), personaError(), recordPersonaInteraction(), registerPersonaTools(), Interaction, NewLog() (+2 more)
...
Cohesion: 0.29
Nodes (13): TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeTracer, mockOllamaServer(), newTestClient(), TestClient_AnalyzeComplexity(), TestClient_Generate() (+5 more)

### Community 567 - "Community 567"
Cohesion: 0.17
Nodes (11): TestRunOnce_EmitsRunRootSpan(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), TestEndToEndOTLPExport(), Tracer (+3 more)
...
Cohesion: 0.27
Nodes (9): TestBuildIdentityStampedRevisionFallback(), BuildIdentityFromBuildInfo(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered(), TestBlockDurationHistogramSeriesRendered(), TestBuildIdentityFromBuildInfo(), TestKGAnalyticsGaugesRenderedAndUpdated(), TestNodeDurationHistogramSeriesRendered() (+1 more)
...
Cohesion: 0.36
Nodes (8): Capability, Edge, blendedSelectionFitness(), coldStartConfidence(), coldStartWeightedFitness(), structuralGate(), Relation, TreeMeta
...
Cohesion: 0.27
Nodes (8): HTTPMethod, collectViolations(), fieldPath(), pathOrRoot(), routeKey(), ResponseValidatorConfig, RouteIndex, SchemaViolation
...
Cohesion: 0.2
Nodes (10): code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), Package: goap, Package: langagent, Package: reflection (+2 more)
...
Cohesion: 0.46
Nodes (7): cellFitnesses(), insertPersistNiche(), newPersistElite(), TestMAPElitesGridLoad_MissingFileColdStart(), TestMAPElitesGridSave_EvictsWeakestNichesFirst(), TestMAPElitesGridSaveLoad_CrossDomainMergeNeverExceedsCap(), TestMAPElitesGridSaveLoad_ZeroCapKeepsAllCells()
...
Cohesion: 0.29
Nodes (7): TestCreateAgentTool_Call_NilFactory(), TestRunTaskTool_Call(), TestToolNames_And_Descriptions(), NewCreateAgentTool(), NewFitnessTool(), NewGetTreeTool(), NewRunTaskTool()
...
Cohesion: 0.4
Nodes (3): extractCycleFacts(), TestExtractCycleFacts(), truncateForLog()
...
## Knowledge Gaps
- **7471 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7466 more)
...
- **Why does `Append()` connect `Community 44` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 1036`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 33`, `Community 37`, `Community 40`, `Community 41`, `Community 43`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 573`, `Community 61`, `Community 62`, `Community 63`, `Community 577`, `Community 578`, `Community 65`, `Community 68`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 76`, `Community 77`, `Community 590`, `Community 78`, `Community 80`, `Community 81`, `Community 83`, `Community 84`, `Community 598`, `Community 87`, `Community 88`, `Community 90`, `Community 603`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 91`, `Community 98`, `Community 100`, `Community 101`, `Community 102`, `Community 104`, `Community 112`, `Community 113`, `Community 116`, `Community 117`, `Community 118`, `Community 121`, `Community 124`, `Community 128`, `Community 130`, `Community 132`, `Community 133`, `Community 134`, `Community 135`, `Community 139`, `Community 141`, `Community 142`, `Community 145`, `Community 147`, `Community 149`, `Community 158`, `Community 160`, `Community 161`, `Community 162`, `Community 164`, `Community 166`, `Community 171`, `Community 177`, `Community 179`, `Community 185`, `Community 186`, `Community 187`, `Community 188`, `Community 189`, `Community 190`, `Community 192`, `Community 195`, `Community 197`, `Community 200`, `Community 203`, `Community 206`, `Community 209`, `Community 210`, `Community 216`, `Community 218`, `Community 219`, `Community 220`, `Community 763`, `Community 765`, `Community 766`, `Community 784`, `Community 788`, `Community 795`, `Community 809`, `Community 810`, `Community 813`, `Community 816`, `Community 849`, `Community 862`, `Community 371`, `Community 375`, `Community 377`, `Community 386`, `Community 389`, `Community 390`, `Community 391`, `Community 392`, `Community 393`, `Community 400`, `Community 403`, `Community 411`, `Community 413`, `Community 414`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 30` to `Community 4`, `Community 764`, `Community 6`, `Community 133`, `Community 11`, `Community 12`, `Community 16`, `Community 147`, `Community 22`, `Community 150`, `Community 151`, `Community 416`, `Community 162`, `Community 171`, `Community 44`, `Community 46`, `Community 48`, `Community 49`, `Community 52`, `Community 181`, `Community 53`, `Community 1077`, `Community 56`, `Community 58`, `Community 59`, `Community 572`, `Community 61`, `Community 187`, `Community 64`, `Community 211`, `Community 102`, `Community 112`, `Community 117`, `Community 1145`, `Community 124`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 56` to `Community 129`, `Community 130`, `Community 4`, `Community 388`, `Community 6`, `Community 10`, `Community 12`, `Community 141`, `Community 14`, `Community 781`, `Community 20`, `Community 22`, `Community 30`, `Community 37`, `Community 38`, `Community 39`, `Community 46`, `Community 47`, `Community 48`, `Community 181`, `Community 54`, `Community 55`, `Community 61`, `Community 63`, `Community 197`, `Community 585`, `Community 202`, `Community 78`, `Community 79`, `Community 89`, `Community 107`, `Community 112`, `Community 117`, `Community 124`, `Community 383`?**
