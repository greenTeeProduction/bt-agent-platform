# Graph Report - superpowers-20260717T120613-cc81bd8d-goap-fusion-loop-runner-blackboard-conte  (2026-07-17)

## Corpus Check
- 895 files · ~1,139,193 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25657 nodes · 38343 edges · 2020 communities (1668 shown, 352 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9223 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `012e9553`
...
3. `9. Architecture Decisions` - 151 edges
...
## Communities (2020 total, 352 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (198): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+190 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (198): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+190 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (144): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+136 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (107): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+99 more)
...
Cohesion: 0.03
Nodes (117): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+109 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (105): CategorizedError, ErrorContext, ApplyJitter(), ClassifyError(), contextDeadlineExceeded(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter() (+97 more)
...
Cohesion: 0.03
Nodes (116): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+108 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (113): ListToolProfileBlocks(), mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation() (+105 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (89): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Block, TestComposeAndExpand(), Category, Compose(), ComposeFromRefs() (+81 more)
...
Cohesion: 0.06
Nodes (94): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42DocsyncTree(), TestArc42DocsyncTreeRegistered(), TestArc42DocsyncTreeShape(), Arc42SeederTree(), Arc42Trees(), assembleDoc() (+86 more)
...
Cohesion: 0.03
Nodes (38): AgentMetric, AlertReport, Catalog, extractYAMLField(), inferTree(), splitTags(), CatalogEntry, History (+30 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (89): arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), collapseToSingleLine(), completeGoapProgramMilestone() (+81 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (76): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+68 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (89): handleLogin(), handleLogout(), DefaultPanicHandler(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter (+81 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (89): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+81 more)
...
Cohesion: 0.05
Nodes (80): Duration(), countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New() (+72 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (80): DefaultLLM(), RealLLM(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic(), TestBFCLV3_MultiTurn_Composite() (+72 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (77): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+69 more)
...
Cohesion: 0.05
Nodes (66): perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree() (+58 more)
...
Cohesion: 0.06
Nodes (71): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), defaultNlmGrillAuthGuard() (+63 more)
...
Cohesion: 0.05
Nodes (54): main(), BTStudioCompany(), requireOllamaFinanceTest(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis(), TestTeslaMarket(), TestTeslaModel() (+46 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (53): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+45 more)
...
Cohesion: 0.05
Nodes (54): TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir() (+46 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (66): TestBuildChainActionFn_LlmCallNilLLM(), TestBuildChainActionFn_UnknownChainType(), TestComputeSubtreeMetrics_MixedChildren(), TestComputeSubtreeMetrics_NilInput(), TestComputeSubtreeMetrics_UpdatesMaxValues(), TestComputeTreeMetrics_MaxRetriesAndTimeout(), TestComputeTreeMetrics_NestedChildren(), TestComputeTreeMetrics_ParallelWidth() (+58 more)

### Community 37 - "Community 37"
Cohesion: 0.07
Nodes (55): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+47 more)
...
Cohesion: 0.05
Nodes (36): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, cloneMetadataForGardener(), extractDomain() (+28 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (37): main(), main(), attachLogHandler(), buildBaseHandler(), buildLogger(), Debug(), envLogLevel(), Error() (+29 more)
...
Cohesion: 0.05
Nodes (34): newAgentExecutor(), agentExecuteResult(), getDashCBStore(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules() (+26 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (45): Blackboard, ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+37 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (44): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), parseChainConfig(), TestChainAction_ParseConfig(), readPostconditions(), BuildCircuitBreaker() (+36 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (48): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField() (+40 more)
...
Cohesion: 0.06
Nodes (38): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_CachesWithinTTLAndExpires(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), IsKnownChainKind(), TestIsKnownChainKind(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree() (+30 more)
...
Cohesion: 0.08
Nodes (39): init(), registerFinanceActions(), init(), registerGoDevActions(), init(), registerResearchActions(), init(), registerStockfishActions() (+31 more)
...
Cohesion: 0.08
Nodes (38): TestRunOnceFlushesSelectorTelemetry(), TestSelectorStatsFileSanitizesTreeID(), CompilePlanToTree(), compileStep(), encodePairs(), encodePairsReadable(), executableNode(), outcomeSelector() (+30 more)

### Community 63 - "Community 63"
Cohesion: 0.17
Nodes (42): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Finance(), TestRouting_Research(), TestTree_Research() (+34 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (37): RegistryDir(), SchedulerJobsFile(), ResolvePipelineAgent(), TestRemoveAgentJobs(), TestResolvePipelineAgent_Aliases(), TestApplySchedule_PersistsRegistryAndJobs(), TestDeleteRegisteredAgent(), ApplySchedule() (+29 more)
...
Cohesion: 0.09
Nodes (34): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, applySuperpowersRunToMainRepo(), assertNoForcedMasterWrite(), bareTestRun(), TestApplySuperpowersRunBareRepoDetachedHeadDoesNotRebase() (+26 more)
...
Cohesion: 0.06
Nodes (33): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM() (+25 more)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (39): TestPromoteSubtree(), init(), ApplyBlockMutations(), blockIDFromOp(), collectNames(), evolutionApplyAddAfter(), evolutionApplyAddBefore(), extractSubtree() (+31 more)
...
Cohesion: 0.09
Nodes (24): min(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section(), TestGenerateTemplateOutput_TruncatedCache(), TestGenerateTemplateOutput_Arc42Section(), TestGenerateTemplateOutput_Arc42TitleNoNewline() (+16 more)
...
Cohesion: 0.08
Nodes (23): TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree(), TestWireSelectorReorderIsOptIn() (+15 more)

### Community 90 - "Community 90"
Cohesion: 0.09
Nodes (39): biasCandidatesWithExperience(), cloneTreeForGardener(), serializeTreeForGardener(), crisisMetricsGardener(), crisisV2Config(), experienceRecordingGardener(), experienceReuseCount(), routerChildNames() (+31 more)
...
Cohesion: 0.12
Nodes (17): extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), containsCrisisReason(), Crossover(), ExperienceRetrievalHits(), hashTree() (+9 more)

### Community 95 - "Community 95"
Cohesion: 0.1
Nodes (26): GateResult, TestQualityGateFloorOn100Scale(), ListRevisions(), loadSnapshotIndex(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass() (+18 more)
...
Cohesion: 0.09
Nodes (22): AuctionDelegate(), NewPersistentAuctioneer(), cardWithURL(), newAuctionTransport(), newDeadlineProbeTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoCandidatesFallsBack() (+14 more)
...
Cohesion: 0.09
Nodes (29): handleScalability(), ConcurrencyLimiterStats, QueueStats, NewConcurrencyLimiter(), NewWorkerPool(), TestConcurrencyLimiter_AcquireRelease(), TestConcurrencyLimiter_Available(), TestConcurrencyLimiter_MultipleReleaseNoUnderflow() (+21 more)
...
Cohesion: 0.08
Nodes (35): fakeTracer, AlwaysSample(), hashTraceID(), NeverSample(), NewRatioSampler(), TestAlwaysSample(), TestConsoleTracer_ChildSpansNotSampled(), TestConsoleTracer_Concurrent() (+27 more)

### Community 105 - "Community 105"
Cohesion: 0.08
Nodes (22): auctionAnnouncement(), auctionCandidates(), betterBid(), candidateContext(), candidateOverride(), cardURL(), stateFloat(), stateString() (+14 more)
...
Cohesion: 0.07
Nodes (23): TestRunOnce_EmitsRunRootSpan(), alwaysSampler, Attr, neverSampler, noopSpan, noopTracer, Sampler, Span (+15 more)
...
Cohesion: 0.13
Nodes (33): TestSchemaToMap_Format(), NewOpenAPIGenerator(), NewRoute(), schemaToMap(), mapKeys(), TestDashboardRoutes_AllRoutesBuildWithoutPanic(), TestDashboardRoutes_AuthConsistency(), TestDashboardRoutes_GeneratesValidSpec() (+25 more)

### Community 117 - "Community 117"
Cohesion: 0.12
Nodes (30): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionNoopPatchStreak(), goapFusionRepeatedHashBypassed(), goapFusionStateHashes() (+22 more)
...
Cohesion: 0.11
Nodes (30): growthFitness(), FitnessDimension, TestNSGAII_Evolve_Basic(), MultiIndividual, clampScore(), countActions(), countConditions(), materializeMutationOp() (+22 more)
...
Cohesion: 0.11
Nodes (29): getHomeDir(), init(), main(), versionRequested(), finishProbe(), headerEquals(), headerPresent(), probeCSRFCookie() (+21 more)

### Community 127 - "Community 127"
Cohesion: 0.08
Nodes (19): agentNameInterceptor, agentNameKey, TestEligibleBidders(), TestEligibleBidders_NoRequiredTagsMatchesAll(), BTAgentExecutor, BuildCardRegistry(), cardCoversTags(), ConvertToAgentCard() (+11 more)
...
Cohesion: 0.16
Nodes (29): deriveNotebookLMResearchQuery(), isBoilerplateResearchTopic(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery(), nlmIsResearchImport(), nlmIsResearchStart() (+21 more)
...
Cohesion: 0.08
Nodes (30): Binaries, code:go (type Counter struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), code:go (type AgentCard struct { Name, Description, URL string }) (+22 more)
...
Cohesion: 0.15
Nodes (29): TestRouteBuilder_Build(), ArraySchema(), BoolSchema(), IntSchema(), ObjectSchema(), StringSchema(), TestConvenienceSchemaConstructors(), TestOpenAPIGenerator_Parameters() (+21 more)
...
Cohesion: 0.11
Nodes (23): claudeBackoffWindow(), TestClaudeBackoffWindow_EnvOverride(), ClaudeRunner, CommandResult, CommandRunner, execClaudeRunner, execCommandRunner, claudeBackoffWindow() (+15 more)

### Community 146 - "Community 146"
Cohesion: 0.12
Nodes (14): NewNSGAIIPopulation(), NewNSGAIISorter(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_FastNonDominatedSort(), TestNSGAII_FrontRank() (+6 more)
...
Cohesion: 0.11
Nodes (18): TestInjectPersonaContextHoldsBBMu(), injectPersonaContext(), injectPersonaContextLocked(), mineUserPatterns(), personaEmbedder(), personaError(), recordPersonaInteraction(), registerPersonaTools() (+10 more)
...
Cohesion: 0.17
Nodes (23): buildGrillRound1Query(), buildClaudeReviewPrompt(), arc42GoalsPromptBlock(), arc42ResearchTopics(), loadArc42QualityGoals(), TestArc42GoalsPromptBlockContainsEveryGoal(), TestArc42GoalsPromptBlockEmptyWhenDocMissing(), TestArc42ResearchTopicsAnchoredToGoals() (+15 more)
...
Cohesion: 0.09
Nodes (17): init(), modal, num, renderTab(), state, TAB_KEYS, renderCompany(), renderDoormate() (+9 more)
...
Cohesion: 0.21
Nodes (22): ScoreAnnouncement(), SetTreeResolver(), bidArtifact(), drainExecute(), eventKinds(), executorForAgent(), skillCard(), terminalState() (+14 more)
...
Cohesion: 0.12
Nodes (21): fakeGrillClaude, grillAnswerers, grillQuestion, grillResult, designBodyHash(), grillRoundHeading(), openCriticalDigest(), parseGrillQuestions() (+13 more)
...
Cohesion: 0.21
Nodes (18): NewAuctioneer(), TestAuctioneer_RunAuction_AppliesDefaultDispatchDeadline(), TestAuctioneer_RunAuction_BoundsWinnerDispatchWithAnnouncementDeadline(), TestCollectBids_SurvivesPanickingCandidate(), bidJSON(), newFakeTransport(), TestAuctionDelegate_WinnerCircuitBreakerSurvivesAcrossCallsAndRestarts(), TestAuctioneer_AttributesBidToAnnouncedCandidate() (+10 more)
...
Cohesion: 0.15
Nodes (18): docgenState, allSections(), buildSectionMap(), contains(), fileHash(), hashSectionSources(), isSectionDone(), main() (+10 more)

### Community 198 - "Community 198"
Cohesion: 0.14
Nodes (15): encodeJSON(), HandleHITL(), HandleHITLPending(), TestHITLHandlers_PendingApproveReject(), writeHITLResult(), Request, Status, TestApprove_FromEscalated() (+7 more)
...
Cohesion: 0.16
Nodes (19): TestBTOptimizer_New(), TestDTAnalyzer_New(), TestExtractCondition(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), NewBTOptimizer(), NewDTAnalyzer() (+11 more)
...
Cohesion: 0.26
Nodes (20): TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest(), TestTracingMiddleware_StatusCodes(), TestTracingMiddleware_WroteHeaderGuard() (+12 more)

### Community 210 - "Community 210"
Cohesion: 0.17
Nodes (15): NotebookLMTree(), findChildByName(), hasNode(), TestNotebookLMResearchPathUsesDeterministicToolsAndAntiFabricationGuard(), TestNotebookLMTreeIncludesIdempotencyStateActions(), TestNotebookLMTreeIsZeroLLM(), TestNotebookLMTreeRoutesResearchBeforeIngestAndQuery(), TestNotebookLMTreeUsesDeterministicEvidenceGateBeforeSuccess() (+7 more)
...
Cohesion: 0.16
Nodes (5): Manager, newScopedStore(), isPersistentScope(), safeFilename(), scopeFile

### Community 214 - "Community 214"
Cohesion: 0.17
Nodes (17): nlmGrillAnswerer(), nlmGrillUnavailable(), parseNumberedAnswers(), TestNlmGrillAnswerer_AuthGuardFailureIsUnavailable(), TestNlmGrillAnswerer_EmptyOutputIsUnavailable(), TestNlmGrillAnswerer_NoAnswerMarkersIsUnavailable(), TestNlmGrillAnswerer_QuotaErrorIsUnavailable(), TestNlmGrillAnswerer_ValidOutputReturnsMap() (+9 more)

### Community 215 - "Community 215"
Cohesion: 0.12
Nodes (10): requireBuildIdentityWiring(), TestDaemonLogsBuildIdentityAtStartup(), TestDLQReplayOutcomeError_HealthyNonSuccessNotFailing(), TestDLQReplayScanSurvivesPanicAcrossTicks(), TestGardenerLogsBuildIdentityAtStartup(), TestSchedulerAttempt_RateLimitCarryoverRecordedAsDeferred(), TestSchedulerAttempt_SuccessAndFailureUnchanged(), TestValidateDomainRegistry_FlagsInvalidTree() (+2 more)
...
Cohesion: 0.14
Nodes (14): DefaultBlockConfig(), NewMetaPromptEvolver(), NewMutationContext(), TestBlockConfig_FilterMutations(), TestBlockConfig_IsMutable(), TestCrisisDetector_LastDiversity(), TestDefaultBlockConfig(), TestExpert_MatchPattern() (+6 more)

### Community 218 - "Community 218"
Cohesion: 0.16
Nodes (15): apiFetch(), getCookie(), initDoormateTab(), loadProfile(), ratePage(), renderBubbles(), renderGeneratedPage(), renderProfileTags() (+7 more)
...
Cohesion: 0.2
Nodes (14): TemplatesDir(), TestPathHelpers(), cmdCreate(), cmdDelete(), cmdInstallTemplates(), cmdList(), cmdLogs(), cmdRun() (+6 more)
...
Cohesion: 0.14
Nodes (12): TestCreateAgentTool_Call_NilFactory(), TestReflectTool_Call_NoLLM(), TestReflectTool_Call_WithLLM(), TestToolNames_And_Descriptions(), GetReflectionsTool, RunTaskTool, NewCreateAgentTool(), NewFitnessTool() (+4 more)

### Community 427 - "Community 427"
Cohesion: 0.18
Nodes (13): NewEvolvedAgent(), TestConfig_AllFields(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestNewEvolvedAgent_AllToolsRegistered(), TestNewEvolvedAgent_MinimalConfig() (+5 more)
...
Cohesion: 0.22
Nodes (16): TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing() (+8 more)
...
Cohesion: 0.18
Nodes (14): handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus() (+6 more)
...
Cohesion: 0.19
Nodes (6): NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), TracedLLM
...
Cohesion: 0.33
Nodes (14): autofixScriptRunner, autofixScriptStep, autofixVerifyRun(), TestChangedPackagesLintFixCommandInsertsFixFlag(), TestVerifyLintFixMaxAttemptsZeroDisablesClaude(), TestVerifySuperpowersRunAutofixesLintOnlyFailure(), TestVerifySuperpowersRunClaudeRepairStillFailsIsFinal(), TestVerifySuperpowersRunClaudeRepairsUnfixableLint() (+6 more)
...
Cohesion: 0.15
Nodes (15): TestCheckConfidence_ConditionExists(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter() (+7 more)
...
Cohesion: 0.24
Nodes (8): NewFallbackLLM(), TestFallbackLLM_CircuitBreakerSkipsPersistentlyFailingModel(), TestFallbackLLM_GenerateAllPanicReturnsAggregatedError(), TestFallbackLLM_GenerateRecoversPanicAndTriesNextModel(), TestFallbackLLM_GenerateReturnsAllFailures(), TestFallbackLLM_GenerateUsesNextModelAfterPrimaryFailure(), TestNewProvider_BuildsFallbackChainFromConfiguredModels(), stubLLM

### Community 475 - "Community 475"
Cohesion: 0.31
Nodes (11): cardSignatureValid(), SignAgentCard(), TestSignAgentCard(), TestSignAgentCard_Deterministic(), TestSignAgentCard_DifferentCards(), TestSignAgentCard_NilCard(), TestVerifyAgentCard_AfterModification(), TestVerifyAgentCard_EmptySignature() (+3 more)
...
Cohesion: 0.33
Nodes (4): normalizeKey(), truncateSummary(), loadScopeFile(), scopedStore
...
Cohesion: 0.17
Nodes (11): ADR-008: Composable Behavior-Tree Building Blocks, Consequences, Context, Decision, References, Status, PrependGoapFusionPreflight(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesLoopRunner() (+3 more)
...
Cohesion: 0.27
Nodes (10): Alert, Alert, cbIcon(), createAgent(), deleteAgent(), loadAgents(), renderAgents(), runAgent() (+2 more)
...
Cohesion: 0.36
Nodes (8): TestNewProviderCreatesACPClient(), fallbackSpec, buildProvider(), isKnownProvider(), NewProvider(), parseFallbackModels(), primaryModel(), splitACPArgs()

### Community 974 - "Community 974"
Cohesion: 0.44
Nodes (7): TestValidate_OutputSchemaError(), floatPtr(), intPtr(), TestAgentDefinition_Validate_MissingFields(), TestAgentDefinition_Validate_Valid(), TestSchemaValidation(), TestValidateOutput()
...
Cohesion: 0.33
Nodes (8): init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), TestParseSplitOutput(), validateDesignAction(), validateDesignHeadings(), splitDesignDocument(), TestSplitDesignDocument()
...
Cohesion: 0.25
Nodes (8): code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), Package: llm, Package: monitoring, Package: startup, Package: thinktank
...
## Knowledge Gaps
- **9847 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+9842 more)
...
- **Why does `Append()` connect `Community 15` to `Community 1024`, `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 14`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 32`, `Community 34`, `Community 36`, `Community 39`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 61`, `Community 63`, `Community 64`, `Community 66`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 81`, `Community 82`, `Community 84`, `Community 85`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 96`, `Community 97`, `Community 99`, `Community 100`, `Community 104`, `Community 108`, `Community 110`, `Community 113`, `Community 116`, `Community 119`, `Community 120`, `Community 126`, `Community 127`, `Community 129`, `Community 130`, `Community 132`, `Community 136`, `Community 137`, `Community 138`, `Community 139`, `Community 141`, `Community 143`, `Community 146`, `Community 149`, `Community 157`, `Community 159`, `Community 160`, `Community 162`, `Community 164`, `Community 166`, `Community 167`, `Community 682`, `Community 170`, `Community 173`, `Community 175`, `Community 687`, `Community 690`, `Community 179`, `Community 180`, `Community 187`, `Community 700`, `Community 701`, `Community 191`, `Community 194`, `Community 197`, `Community 199`, `Community 711`, `Community 712`, `Community 715`, `Community 204`, `Community 205`, `Community 203`, `Community 210`, `Community 211`, `Community 213`, `Community 216`, `Community 220`, `Community 221`, `Community 224`, `Community 226`, `Community 227`, `Community 932`, `Community 430`, `Community 431`, `Community 432`, `Community 946`, `Community 948`, `Community 953`, `Community 446`, `Community 448`, `Community 451`, `Community 452`, `Community 453`, `Community 454`, `Community 971`, `Community 972`, `Community 973`, `Community 462`, `Community 466`, `Community 467`, `Community 979`, `Community 469`, `Community 982`, `Community 983`, `Community 477`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 35` to `Community 3`, `Community 4`, `Community 1028`, `Community 6`, `Community 10`, `Community 11`, `Community 13`, `Community 17`, `Community 20`, `Community 21`, `Community 30`, `Community 37`, `Community 39`, `Community 44`, `Community 685`, `Community 429`, `Community 47`, `Community 176`, `Community 179`, `Community 949`, `Community 182`, `Community 58`, `Community 444`, `Community 61`, `Community 191`, `Community 64`, `Community 65`, `Community 453`, `Community 198`, `Community 973`, `Community 209`, `Community 215`, `Community 222`, `Community 101`, `Community 107`, `Community 118`, `Community 119`, `Community 121`, `Community 124`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 126` to `Community 128`, `Community 4`, `Community 134`, `Community 11`, `Community 17`, `Community 18`, `Community 20`, `Community 153`, `Community 29`, `Community 159`, `Community 33`, `Community 37`, `Community 44`, `Community 685`, `Community 48`, `Community 176`, `Community 179`, `Community 180`, `Community 947`, `Community 53`, `Community 59`, `Community 444`, `Community 61`, `Community 191`, `Community 453`, `Community 198`, `Community 77`, `Community 80`, `Community 209`, `Community 211`, `Community 97`, `Community 101`, `Community 102`?**
