# Graph Report - superpowers-20260716T093022-6d4a1975-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-16)

## Corpus Check
- 891 files · ~1,082,324 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23907 nodes · 36224 edges · 1899 communities (1530 shown, 369 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 9018 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f00cb99d`
...
6. `arc42 Section 9 — Architecture Decisions` - 128 edges
...
## Communities (1899 total, 369 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (178): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+170 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (178): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+170 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (112): buildMapReduceFallback(), execMapReduce(), expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer() (+104 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (116): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation() (+108 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (128): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+120 more)
...
Cohesion: 0.06
Nodes (92): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle() (+84 more)
...
Cohesion: 0.03
Nodes (93): TestDriftWatchOnce_SkipsRestartWhenJobStartedMidRebuild(), TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), TestStartDriftWatcher_KickTriggersImmediateCheck(), StartDriftWatcher(), TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile() (+85 more)
...
Cohesion: 0.03
Nodes (75): Server, OpenAPIGenerator, Append(), mockTTOrch, brokenTool, ChainConfig, ChainKind, availableToolNames() (+67 more)
...
Cohesion: 0.04
Nodes (90): NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), alwaysSampler, Attr, captureExporter (+82 more)
...
Cohesion: 0.04
Nodes (88): handleLogin(), DefaultPanicHandler(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey (+80 more)
...
Cohesion: 0.03
Nodes (74): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+66 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (68): NewCatalog(), TestCatalog_Export(), TestCatalog_ListInstalled(), TestCatalog_ListTemplates(), TestCatalog_Search(), TestCatalog_SkillToAgent(), TestInferTree(), FileJobStore (+60 more)
...
Cohesion: 0.05
Nodes (71): currentSuperpowersForEachTask(), TestNoNewGapsOrImplDegraded_IsFallbackEligibleGuard(), init(), banditChildKey(), banditLockFor(), banditStatsDir(), banditStatsPath(), banditUCB1Order() (+63 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (79): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), claudeBackoffActive() (+71 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (67): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileWriteTool_Structure(), TestNewWebSearchTool_Structure() (+59 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (72): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_New(), TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents(), TestBuildFromArchetype() (+64 more)
...
Cohesion: 0.05
Nodes (56): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+48 more)
...
Cohesion: 0.06
Nodes (64): echoTaskLeaf, islandArchivePath(), newProductionPopulation(), qtableArchivePath(), registerMCPTools(), assertExpertArchiveFedFromRun(), injectSelectorProbeTree(), seedSelectorProbeStats() (+56 more)
...
Cohesion: 0.05
Nodes (40): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+32 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (49): DashboardRebuildTargets(), DefaultRebuildTargets(), main(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID() (+41 more)
...
Cohesion: 0.06
Nodes (54): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), TestIsGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation() (+46 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (22): TestCheckConfidence_ConditionExists(), extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), containsCrisisReason(), Crossover(), ExperienceRetrievalHits() (+14 more)

### Community 49 - "Community 49"
Cohesion: 0.09
Nodes (55): NewAgent(), NewDocPlanner(), TestAutomationActions_ReachTaskAutomated(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory() (+47 more)
...
Cohesion: 0.05
Nodes (33): agentExecuteResult(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay() (+25 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (34): References, Collect(), indexOf(), GoapFusionPreflightNode(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedDelegatesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedMaterializesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionGatesClaudeImplementation(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionNotebookGuardsNonFatal() (+26 more)

### Community 58 - "Community 58"
Cohesion: 0.08
Nodes (49): buildDeterministicDesign(), buildSuperpowersFinishReport(), defaultNlmGrillAuthGuard(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), registerSuperpowersProductionActions(), runGrillAuthGuardAction() (+41 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (49): growthFitness(), FitnessDimension, TestPopulationEvolve_ResurrectsExtinctSpecialist(), TestPopulationHealthSnapshot_DiversityCollapseRun(), NewNSGAIIPopulation(), NewNSGAIISorter(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists() (+41 more)
...
Cohesion: 0.05
Nodes (32): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired(), wireSelectorOrdering(), GardenerDeactivateAllTool (+24 more)
...
Cohesion: 0.07
Nodes (27): min(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section(), TestGenerateTemplateOutput_TruncatedCache(), TestGenerateTemplateOutput_Arc42Section(), TestGenerateTemplateOutput_Arc42TitleNoNewline() (+19 more)
...
Cohesion: 0.06
Nodes (30): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus() (+22 more)
...
Cohesion: 0.1
Nodes (35): arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), extractGoapProgram(), persistGoapProgram(), runExecutedMilestone(), TestExtractGoapProgramParsesMilestones() (+27 more)
...
Cohesion: 0.12
Nodes (37): defaultGoapReviewDeps(), gatherFailureReviewBody(), gatherReviewContext(), init(), loadLastReviewedSHA(), nextNlmQuotaReset(), nlmQuotaExhausted(), nlmQuotaExhaustedUntil() (+29 more)
...
Cohesion: 0.07
Nodes (29): TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree(), TestWireSelectorReorderIsOptIn() (+21 more)
...
Cohesion: 0.15
Nodes (37): NewConfigWatcher(), TestConfigWatcher_BackwardCompatibleNoDotEnv(), TestConfigWatcher_ConfigChangeWithDotEnv(), TestConfigWatcher_DotEnvChangeDoesNotTriggerOnNoChange(), TestConfigWatcher_DotEnvFileDisappears(), TestConfigWatcher_DotEnvHotReload(), TestConfigWatcher_DotEnvPriorityChain(), TestConfigWatcher_FileAppears() (+29 more)
...
Cohesion: 0.08
Nodes (19): TestRunOnce_EmitsRunRootSpan(), tracingMiddleware(), fanoutHandler, traceContextHandler, ContextWithTraceParentHeader(), Endpoint(), InitFromEnv(), NewOTelTracer() (+11 more)
...
Cohesion: 0.1
Nodes (34): TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter(), TestMutation_AddBefore() (+26 more)
...
Cohesion: 0.08
Nodes (24): agentNameFromBB(), init(), registerDelegateNodes(), init(), init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init() (+16 more)
...
Cohesion: 0.09
Nodes (27): applyDotEnvFiles(), applyDotEnvToConfig(), applyEnvOverrides(), Load(), LoadFile(), LoadFileWithDotEnv(), mergeFileConfig(), parseBool() (+19 more)
...
Cohesion: 0.1
Nodes (22): TestNewReinforcementLearner(), TestQTableSelectUpdateBestAction(), TestQTableStateBucketsAndDepth(), TestReinforcementLearnerLearnAndSuggest(), NewQTable(), NewReinforcementLearner(), TestExpertKnowledge_ObservesLearnedPatternFromQLearning(), TestExpertKnowledge_SeedSpecialistsCarryProvenance() (+14 more)
...
Cohesion: 0.16
Nodes (21): NewMockLLM(), NewDefaultCompany(), clamp(), safeDiv(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary() (+13 more)
...
Cohesion: 0.15
Nodes (20): NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing(), TestLocalSearch_TabuSearch(), TestSelectorOptimizer_ApplyOrdering(), TestSelectorOptimizer_ConcurrentMergeSumsCounts() (+12 more)
...
Cohesion: 0.16
Nodes (16): convertGoapChildren(), FromGoapNode(), GOAPDevOpsTree(), GOAPPlanningTree(), GOAPResearchTree(), Blackboard, BlackboardBridge, BTNodeType (+8 more)
...
Cohesion: 0.27
Nodes (22): swapErrorHandlerRunner(), TestRequestErrorHandlerProposal_RespectsCallerContext(), TestRequestErrorHandlerProposal_StampsLedgerOnEveryOutcome(), ehTestHandlerNode(), ehTestProposalJSON(), runHandler(), TestClaudeErrorHandler_BuildSwitchAndValidation(), TestClaudeErrorHandler_CapReachedSkipsClaude() (+14 more)
...
Cohesion: 0.11
Nodes (9): recordSchedulerAttempt(), requireBuildIdentityWiring(), TestDaemonLogsBuildIdentityAtStartup(), TestDLQReplayScanSurvivesPanicAcrossTicks(), TestGardenerLogsBuildIdentityAtStartup(), TestSchedulerAttempt_RateLimitCarryoverRecordedAsDeferred(), TestSchedulerAttempt_SuccessAndFailureUnchanged(), TestSchedulerAttempt_HealthyNoCodeOutcomesAreDeferredTerminal() (+1 more)

### Community 201 - "Community 201"
Cohesion: 0.12
Nodes (19): envBool(), hasExplicitField(), TestEnvBool(), marshalConfig(), TestDiff_DifferentValues(), TestDiff_EmptyConfigs(), TestEnvBool_DefaultValue(), TestEnvBool_MixedCase() (+11 more)
...
Cohesion: 0.17
Nodes (15): NewEvolvedAgent(), TestConfig_AllFields(), TestCreateAgentTool_Call_NilFactory(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestMockModel_SatisfiesInterface() (+7 more)
...
Cohesion: 0.12
Nodes (10): A2AHandoffBlock(), builtinBlocks(), DelegateBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HumanGateBlock(), HumanReviewBlock(), MemoryLoadBlock() (+2 more)
...
Cohesion: 0.17
Nodes (9): GetReflectionsTool, TestCreateAgentTool_Call_NilFactory(), TestToolNames_And_Descriptions(), NewCreateAgentTool(), NewFitnessTool(), NewGetTreeTool(), NewRunTaskTool(), truncateStr() (+1 more)
...
Cohesion: 0.17
Nodes (12): TestValidate_BanditSelectorRequiresUniqueName(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestValidate_MemoryNodesDuplicateNames(), TestValidate_MemoryNodesRequireUniqueNames(), containsLeafChildrenMsg(), TestValidateTree_LeafTypesRejectChildren(), TestValidateNode_SequenceSkip() (+4 more)
...
Cohesion: 0.2
Nodes (10): code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), Package: log, Package: persistence, Package: util (+2 more)
...
## Knowledge Gaps
- **8738 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8733 more)
...
- **Why does `Append()` connect `Community 11` to `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 23`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 30`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 45`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 54`, `Community 56`, `Community 59`, `Community 60`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 67`, `Community 70`, `Community 71`, `Community 73`, `Community 74`, `Community 76`, `Community 78`, `Community 81`, `Community 83`, `Community 84`, `Community 86`, `Community 88`, `Community 89`, `Community 91`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 98`, `Community 99`, `Community 101`, `Community 105`, `Community 111`, `Community 624`, `Community 1136`, `Community 626`, `Community 115`, `Community 1140`, `Community 625`, `Community 1141`, `Community 631`, `Community 122`, `Community 123`, `Community 637`, `Community 126`, `Community 127`, `Community 129`, `Community 130`, `Community 134`, `Community 136`, `Community 649`, `Community 138`, `Community 650`, `Community 652`, `Community 141`, `Community 654`, `Community 142`, `Community 146`, `Community 147`, `Community 151`, `Community 152`, `Community 156`, `Community 158`, `Community 161`, `Community 163`, `Community 165`, `Community 167`, `Community 170`, `Community 184`, `Community 190`, `Community 191`, `Community 196`, `Community 199`, `Community 202`, `Community 205`, `Community 206`, `Community 208`, `Community 216`, `Community 1241`, `Community 217`, `Community 218`, `Community 840`, `Community 844`, `Community 845`, `Community 846`, `Community 866`, `Community 867`, `Community 868`, `Community 889`, `Community 892`, `Community 893`, `Community 907`, `Community 397`, `Community 401`, `Community 402`, `Community 403`, `Community 404`, `Community 413`, `Community 414`, `Community 415`, `Community 416`, `Community 928`, `Community 425`, `Community 426`, `Community 427`, `Community 429`, `Community 435`, `Community 436`, `Community 439`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 9` to `Community 128`, `Community 2`, `Community 7`, `Community 13`, `Community 15`, `Community 19`, `Community 20`, `Community 23`, `Community 24`, `Community 922`, `Community 28`, `Community 29`, `Community 30`, `Community 33`, `Community 37`, `Community 38`, `Community 44`, `Community 46`, `Community 51`, `Community 54`, `Community 62`, `Community 69`, `Community 200`, `Community 202`, `Community 211`, `Community 87`, `Community 859`, `Community 97`, `Community 108`, `Community 115`, `Community 120`, `Community 121`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 33` to `Community 130`, `Community 2`, `Community 134`, `Community 7`, `Community 9`, `Community 11`, `Community 141`, `Community 15`, `Community 144`, `Community 17`, `Community 145`, `Community 19`, `Community 18`, `Community 656`, `Community 407`, `Community 152`, `Community 24`, `Community 159`, `Community 164`, `Community 37`, `Community 36`, `Community 48`, `Community 177`, `Community 51`, `Community 54`, `Community 59`, `Community 64`, `Community 67`, `Community 72`, `Community 73`, `Community 74`, `Community 211`, `Community 1251`, `Community 109`, `Community 121`?**
