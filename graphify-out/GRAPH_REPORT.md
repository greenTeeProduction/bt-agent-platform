# Graph Report - superpowers-20260709T160740-37e65686-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-09)

## Corpus Check
- 787 files · ~823,456 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17896 nodes · 28452 edges · 1553 communities (1192 shown, 361 thin omitted)
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 7724 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c6e41929`
...
## Communities (1553 total, 361 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (130): main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+122 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (123): main(), TestCheckConfidence_ConditionExists(), TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord() (+115 more)
...
Cohesion: 0.03
Nodes (80): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+72 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (85): TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir() (+77 more)
...
Cohesion: 0.02
Nodes (94): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+86 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (94): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+86 more)
...
Cohesion: 0.05
Nodes (44): handleSprintExecute(), main(), handlePipelineRun(), handlePipelines(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep() (+36 more)
...
Cohesion: 0.06
Nodes (45): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree(), agentTemplateYAML, TestResolveTreeID_FusionAliases(), HermesObsidianOptimizerTree() (+37 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (48): NewCatalog(), TestCatalog_Export(), TestCatalog_ListInstalled(), TestCatalog_ListTemplates(), TestCatalog_Search(), TestCatalog_SkillToAgent(), TestInferTree(), FileJobStore (+40 more)
...
Cohesion: 0.05
Nodes (39): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, init(), init(), TestRegisterCondition_DuplicatePanics(), Engine (+31 more)
...
Cohesion: 0.06
Nodes (46): TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoTestTool_Structure(), TestNewGraphifyTool_Structure(), TestNewShellExecTool_Structure(), TestNewWebSearchTool_Structure(), TestRealTool_NameAndDescription(), TestToolStub_NameDescription() (+38 more)
...
Cohesion: 0.06
Nodes (27): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleAnalyze(), handleDLQReplay() (+19 more)
...
Cohesion: 0.05
Nodes (16): alwaysSampler, Attr, consoleSpan, ConsoleTracer, neverSampler, noopSpan, noopTracer, RatioSampler (+8 more)
...
Cohesion: 0.08
Nodes (23): TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), resolveUserTree(), TestDaemonConfiguresGoalPlanBrainstorm(), GoalPlanBrainstormWired() (+15 more)
...
Cohesion: 0.08
Nodes (8): Capability, DecisionTrace, Edge, KnowledgeGraph, Relation, TraceStep, TraceStore, TreeMeta
...
Cohesion: 0.16
Nodes (28): TestSearchForBTPatternsQueriesArc42AnchoredResearch(), deriveNotebookLMResearchQuery(), isBoilerplateResearchTopic(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery(), nlmIsResearchImport() (+20 more)
...
Cohesion: 0.1
Nodes (22): exportMemoryCategory(), exportPreviousRuns(), min(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic() (+14 more)
...
Cohesion: 0.07
Nodes (28): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+20 more)
...
Cohesion: 0.16
Nodes (25): addFusionNewCount(), addFusionNewItems(), btFusionPatternQuestion(), btFusionResearchFindings(), fusionMarkdown(), fusionNewCount(), fusionTitle(), init() (+17 more)
...
Cohesion: 0.13
Nodes (22): countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New(), TestNewPopulation_Evolution() (+14 more)
...
Cohesion: 0.16
Nodes (6): envDefault(), main(), run(), AgentExecutor, RedisPriorityQueue, RedisQueue
...
Cohesion: 0.11
Nodes (17): DefaultBlockConfig(), NewMetaPromptEvolver(), NewMutationContext(), TestBlockConfig_FilterMutations(), TestBlockConfig_IsMutable(), TestCrisisDetector_LastDiversity(), TestDefaultBlockConfig(), TestFindBlockForNode() (+9 more)
...
Cohesion: 0.18
Nodes (11): code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), Package: evaluator, Package: gardener (+3 more)
...
## Knowledge Gaps
- **5226 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+5221 more)
...
- **Why does `Append()` connect `Community 34` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 22`, `Community 24`, `Community 25`, `Community 28`, `Community 29`, `Community 31`, `Community 33`, `Community 35`, `Community 38`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 49`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 57`, `Community 58`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 65`, `Community 67`, `Community 69`, `Community 70`, `Community 583`, `Community 584`, `Community 582`, `Community 74`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 86`, `Community 87`, `Community 600`, `Community 604`, `Community 93`, `Community 95`, `Community 96`, `Community 97`, `Community 99`, `Community 100`, `Community 105`, `Community 110`, `Community 111`, `Community 624`, `Community 626`, `Community 627`, `Community 115`, `Community 117`, `Community 628`, `Community 629`, `Community 121`, `Community 125`, `Community 128`, `Community 129`, `Community 644`, `Community 133`, `Community 649`, `Community 650`, `Community 140`, `Community 143`, `Community 144`, `Community 146`, `Community 147`, `Community 148`, `Community 151`, `Community 666`, `Community 154`, `Community 157`, `Community 158`, `Community 160`, `Community 162`, `Community 166`, `Community 167`, `Community 168`, `Community 172`, `Community 174`, `Community 175`, `Community 176`, `Community 178`, `Community 182`, `Community 183`, `Community 184`, `Community 185`, `Community 190`, `Community 191`, `Community 192`, `Community 195`, `Community 196`, `Community 204`, `Community 206`, `Community 208`, `Community 794`, `Community 797`, `Community 307`, `Community 308`, `Community 318`, `Community 319`, `Community 320`, `Community 321`, `Community 322`, `Community 835`, `Community 323`, `Community 331`, `Community 340`, `Community 341`, `Community 342`, `Community 71`, `Community 441`, `Community 442`, `Community 444`, `Community 446`, `Community 448`, `Community 459`, `Community 460`, `Community 462`, `Community 471`, `Community 478`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 6` to `Community 0`, `Community 1`, `Community 128`, `Community 5`, `Community 142`, `Community 17`, `Community 18`, `Community 19`, `Community 29`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 38`, `Community 169`, `Community 42`, `Community 171`, `Community 44`, `Community 173`, `Community 172`, `Community 51`, `Community 56`, `Community 195`, `Community 455`, `Community 328`, `Community 601`, `Community 123`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 17` to `Community 130`, `Community 6`, `Community 7`, `Community 140`, `Community 19`, `Community 23`, `Community 157`, `Community 33`, `Community 162`, `Community 38`, `Community 169`, `Community 41`, `Community 172`, `Community 173`, `Community 53`, `Community 181`, `Community 55`, `Community 56`, `Community 63`, `Community 196`, `Community 455`, `Community 84`, `Community 86`, `Community 599`, `Community 103`, `Community 104`, `Community 112`, `Community 116`?**
