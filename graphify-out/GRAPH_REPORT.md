# Graph Report - superpowers-20260713T170859-1d2ca422-goap-fusion-loop-runner-blackboard-conte  (2026-07-13)

## Corpus Check
- 842 files · ~949,393 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21080 nodes · 32444 edges · 1728 communities (1375 shown, 353 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8325 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `846a33c7`
...
4. `NewKnowledgeGraph()` - 121 edges
5. `BuildTree()` - 111 edges
6. `registerMCPTools()` - 102 edges
7. `newDefaultConfig()` - 100 edges
8. `sleep()` - 95 edges
9. `main()` - 77 edges
10. `arc42 Section 9 — Architecture Decisions` - 76 edges
...
## Communities (1728 total, 353 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (140): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+132 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (140): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+132 more)
...
Cohesion: 0.04
Nodes (88): perTreeStats(), setupGardener(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree(), TestMetricsTracker_BestFitnessTracking() (+80 more)
...
Cohesion: 0.04
Nodes (68): main(), BTStudioCompany(), TestTeslaDeepResearch(), TestTeslaQuickResearch(), requireOllamaFinanceTest(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis() (+60 more)
...
Cohesion: 0.04
Nodes (81): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), buildChainActionFn() (+73 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (50): GateResult, Outcome, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree() (+42 more)
...
Cohesion: 0.04
Nodes (66): TestBTEvolveBottlenecksPersistsEvolvedWinnerTree(), TestBTEvolveGeneticPersistsEvolvedWinnerTree(), TestBTEvolveSelectionPressurePersistsEvolvedWinnerTree(), main(), init(), registerGoDevActions(), TestBlackboard_AllFields(), containsAnyStr() (+58 more)
...
Cohesion: 0.05
Nodes (59): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposePreset(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), TestComposePreset_Agentic() (+51 more)
...
Cohesion: 0.06
Nodes (69): truncateGoap(), arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), completeGoapProgramMilestone(), extractGoapProgram() (+61 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (60): TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath(), TestDiscardWorktree_RemovesWorktreeAndDeletesBranch(), TestPushBranchAndCreatePR_InvokesGitPushAndGhPr(), withSwappedSuperpowersRunners(), TestRunSuperpowersRuntime_NonRateLimitFailureSetsImplDegraded() (+52 more)
...
Cohesion: 0.03
Nodes (76): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+68 more)

### Community 27 - "Community 27"
Cohesion: 0.11
Nodes (62): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+54 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (71): TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestComputeSubtreeMetrics_MixedChildren(), TestComputeSubtreeMetrics_NilInput(), TestComputeSubtreeMetrics_UpdatesMaxValues(), TestComputeTreeMetrics_MaxRetriesAndTimeout() (+63 more)
...
Cohesion: 0.04
Nodes (12): Server, OpenAPIGenerator, Append(), mockTTOrch, Workflow, EventBus, ValidateEdge(), SerializableNode (+4 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (56): LoadPipeline(), RunPipeline(), RunPipelineWithID(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), checkLLMHealth() (+48 more)
...
Cohesion: 0.07
Nodes (46): NewAgent(), NewDocPlanner(), TestAutomationActions_ReachTaskAutomated(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory() (+38 more)
...
Cohesion: 0.08
Nodes (52): satisfactionRecords(), TestEvaluateTree_EmptyRecordsSatisfactionUnknown(), TestEvaluateTree_FeedbackShiftsComposite(), TestEvaluateTree_NoFeedbackLeavesCompositeUnchanged(), countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New() (+44 more)
...
Cohesion: 0.05
Nodes (37): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), pipelineMockLLM, ApplyHITLPolicy(), countTreeNodes() (+29 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (42): agentNameFromBB(), init(), registerDelegateNodes(), init(), init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), dataFileMetrics() (+34 more)
...
Cohesion: 0.06
Nodes (47): DefaultMock(), TestRunSuiteIsSandboxed(), findNode(), resolverReachableExtraDomainTrees(), singleTaskSuite(), tasksForTree(), TestAgentMonitor(), TestAllDomainTreeConditionsHaveDescriptions() (+39 more)
...
Cohesion: 0.06
Nodes (27): handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogout(), handleMetricsLive() (+19 more)
...
Cohesion: 0.07
Nodes (35): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), BuildChainAction(), parseChainConfig(), TestChainAction_ParseConfig(), readPostconditions() (+27 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (7): flakyDecomposeMockLLM, flakyRefineMockLLM, flakySubtaskMockLLM, incompleteSynthMockLLM, nudgeRecoveryMockLLM, summaryWindowMockLLM, windowingMockLLM
...
Cohesion: 0.08
Nodes (24): handleSprintExecute(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep() (+16 more)
...
Cohesion: 0.09
Nodes (37): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad() (+29 more)
...
Cohesion: 0.11
Nodes (32): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionNoopPatchStreak(), goapFusionPreflightWired() (+24 more)
...
Cohesion: 0.1
Nodes (24): min(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), handleAnalyze(), execLLMCall(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic() (+16 more)
...
Cohesion: 0.09
Nodes (28): Binaries, code:go (type Counter struct { ... }), code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }) (+20 more)
...
Cohesion: 0.14
Nodes (16): Embedding, EmbeddingClient, CosineSimilarity(), TestBuildIndex_PanicRecovered(), TestCosineSimilarity_BothZero(), TestCosineSimilarity_DifferentLengths(), TestCosineSimilarity_Empty(), TestCosineSimilarity_Identical() (+8 more)
...
Cohesion: 0.13
Nodes (21): handleAgentsList(), AgentHistoryEntry, AgentInfo, agentStatus(), ListAgents(), ListAgentsWithCB(), listRegistryAgents(), loadCircuitBreakers() (+13 more)
...
Cohesion: 0.16
Nodes (16): ApplyParameters(), cholesky(), collectParams(), invertCholesky(), itoa(), multiplyCholesky(), navigateToPath(), parseInt() (+8 more)
...
Cohesion: 0.2
Nodes (17): TestSelectorOptimizer_New(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb() (+9 more)
...
Cohesion: 0.14
Nodes (12): TestCreateAgentTool_Call_NilFactory(), TestReflectTool_Call_NoLLM(), TestRunTaskTool_Call(), TestToolNames_And_Descriptions(), GetReflectionsTool, RunTaskTool, NewCreateAgentTool(), NewFitnessTool() (+4 more)
...
Cohesion: 0.23
Nodes (11): ExtractParameters(), NewCMAESOptimizer(), TestApplyParameters(), TestCMAESOptimizer_Convergence(), TestCMAESOptimizer_SimpleSphere(), TestExtractParameters(), TestExtractParameters_StructFields(), TestExtractParameters_TimeoutDedupe() (+3 more)
...
Cohesion: 0.14
Nodes (3): CreateAgentTool, FitnessTool, ReflectTool
...
Cohesion: 0.22
Nodes (9): code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), Package: log, Package: persistence, Package: reflection, Package: validate (+1 more)
...
Cohesion: 0.25
Nodes (8): TestStripHTML_Attributes(), TestStripHTML_Basic(), TestStripHTML_EmptyString(), TestStripHTML_NestedTags(), TestStripHTML_NoTags(), stripHTML(), TestStripHTML_MultipleTags(), TestStripHTML_TrimsWhitespace()
...
## Knowledge Gaps
- **7103 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7098 more)
...
- **Why does `Append()` connect `Community 41` to `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 24`, `Community 28`, `Community 540`, `Community 30`, `Community 543`, `Community 33`, `Community 35`, `Community 36`, `Community 37`, `Community 547`, `Community 39`, `Community 42`, `Community 44`, `Community 46`, `Community 47`, `Community 49`, `Community 50`, `Community 52`, `Community 565`, `Community 53`, `Community 567`, `Community 55`, `Community 568`, `Community 58`, `Community 60`, `Community 62`, `Community 65`, `Community 66`, `Community 67`, `Community 71`, `Community 72`, `Community 73`, `Community 75`, `Community 77`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 97`, `Community 101`, `Community 102`, `Community 105`, `Community 114`, `Community 115`, `Community 120`, `Community 121`, `Community 124`, `Community 125`, `Community 126`, `Community 127`, `Community 129`, `Community 130`, `Community 131`, `Community 134`, `Community 135`, `Community 138`, `Community 139`, `Community 141`, `Community 143`, `Community 148`, `Community 150`, `Community 151`, `Community 152`, `Community 153`, `Community 157`, `Community 163`, `Community 166`, `Community 167`, `Community 170`, `Community 171`, `Community 173`, `Community 175`, `Community 179`, `Community 180`, `Community 181`, `Community 186`, `Community 188`, `Community 189`, `Community 194`, `Community 197`, `Community 201`, `Community 205`, `Community 208`, `Community 723`, `Community 724`, `Community 725`, `Community 726`, `Community 729`, `Community 744`, `Community 746`, `Community 747`, `Community 767`, `Community 768`, `Community 773`, `Community 812`, `Community 814`, `Community 356`, `Community 357`, `Community 359`, `Community 360`, `Community 361`, `Community 369`, `Community 371`, `Community 372`, `Community 374`, `Community 375`, `Community 382`, `Community 386`, `Community 391`, `Community 392`, `Community 393`, `Community 981`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 70` to `Community 130`, `Community 3`, `Community 9`, `Community 10`, `Community 15`, `Community 18`, `Community 20`, `Community 149`, `Community 22`, `Community 25`, `Community 794`, `Community 27`, `Community 157`, `Community 42`, `Community 170`, `Community 44`, `Community 45`, `Community 48`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 55`, `Community 59`, `Community 63`, `Community 192`, `Community 65`, `Community 68`, `Community 199`, `Community 72`, `Community 100`, `Community 358`, `Community 742`, `Community 110`, `Community 370`, `Community 118`, `Community 380`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 42` to `Community 14`, `Community 15`, `Community 144`, `Community 17`, `Community 20`, `Community 22`, `Community 25`, `Community 27`, `Community 35`, `Community 166`, `Community 41`, `Community 44`, `Community 558`, `Community 175`, `Community 48`, `Community 174`, `Community 65`, `Community 66`, `Community 67`, `Community 69`, `Community 70`, `Community 198`, `Community 200`, `Community 199`, `Community 73`, `Community 72`, `Community 209`, `Community 210`, `Community 89`, `Community 92`, `Community 115`, `Community 118`, `Community 1017`, `Community 127`?**
