# Graph Report - superpowers-20260717T203819-cc81bd8d-goap-fusion-loop-runner-blackboard-conte  (2026-07-17)

## Corpus Check
- 911 files · ~1,178,086 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26249 nodes · 39162 edges · 2039 communities (1687 shown, 352 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9401 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `17f7693a`
...
1. `Append()` - 392 edges
2. `9. Architecture Decisions` - 157 edges
...
- `Roles()` --calls--> `TestRoles()`  [INFERRED]
  /home/nico/go-bt-evolve/internal/startup/roles.go → internal/startup/startup_test.go
...
## Communities (2039 total, 352 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (205): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+197 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (205): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+197 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (150): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+142 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (118): TestComputeAnalytics_BottleneckCarriesStructuredFailure(), TestComputeAnalytics_Bottlenecks(), TestComputeAnalytics_BottleneckWithoutTraceHasEmptyFailure(), TestComputeAnalytics_BottleneckWithTrace(), TestComputeAnalytics_Centrality(), TestComputeAnalytics_CoverageGapsUseExpectedDomains(), TestComputeAnalytics_EmptyGraph(), TestComputeAnalytics_ExtendedEdges() (+110 more)
...
Cohesion: 0.03
Nodes (115): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+107 more)
...
Cohesion: 0.03
Nodes (116): mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu() (+108 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (114): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+106 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (95): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Block, TestComposeAndExpand(), Category, Compose(), ComposeFromRefs() (+87 more)
...
Cohesion: 0.04
Nodes (75): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+67 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (76): ApplyJitter(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), FullJitter(), GetCategory(), GetErrorContext(), NewCategorizedError() (+68 more)
...
Cohesion: 0.05
Nodes (72): TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), perTreeStats(), setupGardener(), TestEvolveTree_BloatGuard() (+64 more)
...
Cohesion: 0.05
Nodes (81): TestScoreChild_GoalAlignmentBranch(), TestScoreChild_NilChainState(), TestScoreChildren_BasicRanking(), okCommand, panicCommand, ParallelMode, intSliceFromInterface(), BuildReactiveParallel() (+73 more)
...
Cohesion: 0.04
Nodes (49): newAgentExecutor(), agentExecuteResult(), dashboardLocalAgentResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute() (+41 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (70): countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestNewPopulation_Evolution() (+62 more)
...
Cohesion: 0.04
Nodes (50): TestOutcomeErrorDetail(), FeedbackFile(), applyOutcomeRefinement(), IsHealthyOutcome(), OutcomeErrorDetail(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome(), RunOptions (+42 more)

### Community 35 - "Community 35"
Cohesion: 0.07
Nodes (66): DefaultLLM(), RealLLM(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), EvaluateBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic() (+58 more)
...
Cohesion: 0.04
Nodes (47): CategorizedError, ErrorCategory, ErrorContext, ClassifyError(), contextDeadlineExceeded(), ExecuteWithPolicy(), isAuthError(), isLLMError() (+39 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (61): buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), registerSuperpowersProductionActions(), titleSuperpowersVerb(), autofixScriptRunner (+53 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (31): FilterByTreeName(), Config, TestBaseNodeCount(), TestGetRetryCount(), TestIsNodeWrapped(), CycleMetrics, treePriorityRank(), Gardener (+23 more)
...
Cohesion: 0.04
Nodes (44): ActionFunc, ActionProvider, init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), ConditionFunc, ConditionProvider, init() (+36 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (43): HTTPMethod, collectViolations(), fieldPath(), findResponse(), NewRouteIndex(), pathOrRoot(), ResponseValidator(), routeKey() (+35 more)

### Community 53 - "Community 53"
Cohesion: 0.07
Nodes (48): deregisterLiveRun(), EnqueueLiveMutation(), ListLiveRuns(), LiveMutationJournal(), registerLiveRun(), TestBuildNodeCapture(), TestLiveRunEnqueueAndDrain(), TestLiveRunOpCap() (+40 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (44): handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus() (+36 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (47): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves(), NewFileJobStore() (+39 more)

### Community 56 - "Community 56"
Cohesion: 0.13
Nodes (49): TestDomainTree_Registration(), TestFullTreeIntegration_RunsAllTreesWithRealLLM(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research() (+41 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (49): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), saveNlmQuotaExhausted(), TestIsGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals() (+41 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (40): TestPromoteRunToAgentScope(), TestSeedMemoryToBlackboard_HistoryOffloaded(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), Entry, Limits (+32 more)
...
Cohesion: 0.08
Nodes (33): References, Collect(), indexOf(), GoapFusionPreflightNode(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionGatesClaudeImplementation(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionNotebookGuardsNonFatal(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesCircuitBreaker(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesCircuitPolicy() (+25 more)
...
Cohesion: 0.07
Nodes (41): TestDriftWatchOnce_SkipsRestartWhenJobStartedMidRebuild(), TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir() (+33 more)
...
Cohesion: 0.09
Nodes (36): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+28 more)
...
Cohesion: 0.07
Nodes (46): biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask(), serializeTreeForGardener(), crisisMetricsGardener() (+38 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (26): TestRunOnce_EmitsRunRootSpan(), TestRunJob_WebhookSpanJoinsRunTrace(), tracingMiddleware(), fanoutHandler, traceContextHandler, NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass() (+18 more)
...
Cohesion: 0.12
Nodes (45): TestRouteBuilder_Build(), ArraySchema(), BoolSchema(), IntSchema(), NewOpenAPIGenerator(), NewRoute(), ObjectSchema(), StringSchema() (+37 more)

### Community 79 - "Community 79"
Cohesion: 0.07
Nodes (28): UsersDir(), TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree() (+20 more)

### Community 80 - "Community 80"
Cohesion: 0.08
Nodes (37): TestClient_AnalyzeComplexity_FallbackOnError(), TestClient_AnalyzeComplexity_High(), TestClient_Generate_ConnectionRefused(), TestClient_GeneratePlan_FallbackOnError(), TestClient_Reflect_FallbackOnError(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), TestDeepSeekClient_AnalyzeComplexity() (+29 more)
...
Cohesion: 0.09
Nodes (39): TestCheckConfidence_ConditionExists(), TestEvaluateTree_StructuralQualityRewardsUsefulContentMutations(), TestIterativeDeepening_TTHits(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes() (+31 more)
...
Cohesion: 0.09
Nodes (27): activateAutomation(), automationAgentName(), considerAutomation(), finalizeAutomationApproval(), proposeAutomation(), registerAutomationTools(), suggestSchedule(), newAutopilotDeps() (+19 more)
...
Cohesion: 0.06
Nodes (18): runDLQReplayScanOnce(), TestDLQReplayScanSurvivesPanicAcrossTicks(), TestActionForName_BulkCoverage(), TestSuperpowersTaskVerifyRed_NoTestsFailsWithoutPanic(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), DefaultPanicHandler(), Recover() (+10 more)
...
Cohesion: 0.09
Nodes (30): ctxAwareBlockingRunner, TestErrorHandlerSignature_ClassifiedWithoutLastErrorIsStable(), buildErrorHandlerPrompt(), errorHandlerCooldown(), errorHandlerEnabled(), errorHandlerMaxNodes(), errorHandlerNodeDepth(), errorHandlerSignatureFromBB() (+22 more)
...
Cohesion: 0.1
Nodes (31): registerA2ANodes(), TestDelegateToA2A_FnNotConfigured(), TestDelegateToA2A_FnReturnsError(), TestDelegateToA2A_MissingTaskEmptyChainState(), TestDelegateToA2A_MissingURL(), TestDelegateToA2A_RateLimitCarryoverPropagates(), TestDelegateToA2A_Success(), TestDelegateToA2A_UsesTaskFromChainState() (+23 more)
...
Cohesion: 0.08
Nodes (30): Embedding, EmbeddingClient, CosineSimilarity(), TestBuildIndex_PanicRecovered(), TestCosineSimilarity_BothZero(), TestCosineSimilarity_DifferentLengths(), TestCosineSimilarity_Empty(), TestCosineSimilarity_Identical() (+22 more)
...
Cohesion: 0.13
Nodes (30): agentNameInterceptor, agentNameKey, ScoreAnnouncement(), BTAgentExecutor, cardResponder, failureEventMessage(), parseAnnouncement(), RespondToAnnouncement() (+22 more)
...
Cohesion: 0.12
Nodes (33): growthFitness(), makeTestTree(), NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic() (+25 more)
...
Cohesion: 0.08
Nodes (13): Server, main(), NewPageAgent(), TestAgentLLMGeneration(), TestAgentMockFallback(), TestBubbleRecommendation(), NewHandler(), TestHandleBookmark() (+5 more)

### Community 120 - "Community 120"
Cohesion: 0.1
Nodes (30): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), truncateGoap(), markGoapFusionImplDegraded(), TestFusionAnalysis_RateLimitCarryoverNotConflatedAsDegradation(), arc42GuidelineFor() (+22 more)
...
Cohesion: 0.08
Nodes (27): stringContains(), TestBuildGoapStepPrompt(), buildGoapStepPrompt(), TestAction_ExecuteGoapStep_AccumulatesAndSynthesizes(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions() (+19 more)

### Community 133 - "Community 133"
Cohesion: 0.09
Nodes (23): BuildBudget(), budgetCmd, BuildCachedCondition(), BuildInverter(), BuildRepeater(), BuildRunner(), BuildSucceeder(), BuildMonitor() (+15 more)
...
Cohesion: 0.1
Nodes (24): min(), minInt(), TestExportPreviousRuns(), handleAnalyze(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic() (+16 more)
...
Cohesion: 0.09
Nodes (19): BuildTaskFromInputs(), ParseInputParams(), TestBuildTaskFromInputs(), TestParseInputParams(), TestValidateInputs_Default(), TestValidateInputs_File(), TestValidateInputs_JSON(), TestValidateInputs_Required() (+11 more)
...
Cohesion: 0.11
Nodes (13): FitnessDimension, MultiFitness, MultiIndividual, cappedIndividuals(), clampScore(), countActions(), countConditions(), materializeMutationOp() (+5 more)
...
Cohesion: 0.14
Nodes (25): NewMockLLM(), NewDefaultCompany(), clamp(), safeDiv(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary() (+17 more)

### Community 154 - "Community 154"
Cohesion: 0.11
Nodes (24): collectSelectorNames(), SelectorStatsFile(), TestLocalSearcher_New(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb() (+16 more)

### Community 155 - "Community 155"
Cohesion: 0.1
Nodes (13): DeepSeekClient, DeepSeekConfig, deepseekMsg, deepseekRequest, deepseekResponse, OpenAICompatClient, OpenAICompatConfig, openAICompatMessage (+5 more)

### Community 156 - "Community 156"
Cohesion: 0.13
Nodes (28): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionNoopPatchStreak(), goapFusionPreflightWired() (+20 more)
...
Cohesion: 0.09
Nodes (25): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), IsKnownChainKind(), parseChainConfig(), TestChainAction_ParseConfig(), TestIsKnownChainKind(), TestValidateTree_NestedChildren() (+17 more)
...
Cohesion: 0.1
Nodes (20): TestMatchBlockPattern(), AntiPattern, DesignPattern, TestExpert_MatchPattern(), BlockIDFromRef(), containsStr(), coreHeuristics(), hasNodeMatching() (+12 more)
...
Cohesion: 0.09
Nodes (27): Binaries, code:go (type Counter struct { ... }), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }) (+19 more)
...
Cohesion: 0.11
Nodes (23): TestRunPipelineWithID_RecordsAgentMetrics(), handleSprintExecute(), syncWorkflowTaskStatus(), hermesOutcome(), isAuctionShapedTask(), NewAgentExecutor(), PickTreeForTask(), ResolveAgentName() (+15 more)
...
Cohesion: 0.13
Nodes (21): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired(), NewMetaValidator(), hasMetaIssue() (+13 more)
...
Cohesion: 0.16
Nodes (10): hasNodeType(), MaxDepth(), hasAnySetupTools(), hasExecutionPathFirst(), hasUnboundedRetry(), MetaValidationDecision, MetaValidationIssue, MetaValidationReport (+2 more)
...
Cohesion: 0.15
Nodes (20): TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestHumanApprovalGate_AutoApprove(), TestHumanApprovalGate_ManualApprove(), TestHumanApprovalGate_PostPhase(), TestBuildInverter() (+12 more)
...
Cohesion: 0.13
Nodes (15): mineUserPatterns(), personaEmbedder(), personaError(), recordPersonaInteraction(), registerPersonaTools(), NewHabitMiner(), Interaction, NewLog() (+7 more)
...
Cohesion: 0.16
Nodes (20): GateResult, ListRevisions(), loadSnapshotIndex(), RestoreTree(), RestoreTreeRevision(), saveSnapshotIndex(), snapshotIndexPath(), snapshotRevisionPath() (+12 more)
...
Cohesion: 0.13
Nodes (9): TestHandleSprintExecute_UpdatesCurrentWorkflow(), Task, NewTaskStore(), priorityRank(), TestNewTaskStore_PanicsOnCorruptFile(), TestTaskStore_ApprovedOrdersByPriorityThenSprint(), TestTaskStore_ApproveRejectAuditPersistsAcrossSaveLoad(), TestTaskStore_SaveAtomicWriteLeavesOriginalIntactOnFailure() (+1 more)
...
Cohesion: 0.12
Nodes (16): DefaultBlockConfig(), NewMetaPromptEvolver(), NewMutationContext(), TestBlockConfig_FilterMutations(), TestBlockConfig_IsMutable(), TestCrisisDetector_LastDiversity(), TestDefaultBlockConfig(), TestFindBlockForNode() (+8 more)
...
Cohesion: 0.23
Nodes (13): goapFusionStateHashes(), loadGoapFusionStateHashes(), saveGoapFusionStateHashes(), TestGoapFusionStateHashes_DurableAcrossCronTicks(), TestGoapFusionStateHashes_HistoryCappedOnDisk(), TestPublishGoapFusionStateHash_ActiveWorkStillAccumulates(), TestPublishGoapFusionStateHash_IdleDoesNotAccumulate(), TestPublishGoapFusionStateHash_ResultReflectsDurableDepth() (+5 more)
...
Cohesion: 0.13
Nodes (15): code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), Package: api (+7 more)
...
Cohesion: 0.38
Nodes (10): isGoapInfraCycleFailure(), refundProbeHeadMilestone(), seedRefundProgram(), TestIsGoapInfraCycleFailure(), TestIsGoapInfraCycleFailure_OwnCodeGateFailureCharges(), TestPrioritizeGoapGoals_StampsChargedMilestone(), TestRefundGoapMilestoneAttempt_HeadRefFallbackAndNoop(), TestRefundGoapMilestoneAttempt_UnblocksJustBlockedMilestone() (+2 more)
...
Cohesion: 0.18
Nodes (11): code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), Package: evaluator, Package: gardener (+3 more)
...
Cohesion: 0.4
Nodes (4): TestHasNodeNamed(), hasNodeNamed(), TestRegistry_PersistedTreeOverridesBuiltin(), treeHasNodeNamed()
...
## Knowledge Gaps
- **10166 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+10161 more)
...
- **Why does `Append()` connect `Community 13` to `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 32`, `Community 35`, `Community 36`, `Community 38`, `Community 41`, `Community 42`, `Community 43`, `Community 45`, `Community 46`, `Community 49`, `Community 51`, `Community 52`, `Community 54`, `Community 56`, `Community 57`, `Community 59`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 71`, `Community 73`, `Community 74`, `Community 76`, `Community 77`, `Community 78`, `Community 81`, `Community 82`, `Community 85`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 94`, `Community 99`, `Community 100`, `Community 104`, `Community 105`, `Community 108`, `Community 109`, `Community 115`, `Community 118`, `Community 119`, `Community 121`, `Community 125`, `Community 126`, `Community 127`, `Community 130`, `Community 131`, `Community 133`, `Community 136`, `Community 139`, `Community 140`, `Community 141`, `Community 142`, `Community 143`, `Community 144`, `Community 145`, `Community 150`, `Community 157`, `Community 158`, `Community 161`, `Community 162`, `Community 163`, `Community 166`, `Community 168`, `Community 685`, `Community 687`, `Community 176`, `Community 688`, `Community 178`, `Community 175`, `Community 692`, `Community 181`, `Community 183`, `Community 184`, `Community 185`, `Community 191`, `Community 196`, `Community 200`, `Community 201`, `Community 713`, `Community 714`, `Community 204`, `Community 205`, `Community 718`, `Community 206`, `Community 208`, `Community 717`, `Community 212`, `Community 216`, `Community 217`, `Community 218`, `Community 222`, `Community 224`, `Community 226`, `Community 227`, `Community 229`, `Community 935`, `Community 936`, `Community 438`, `Community 951`, `Community 440`, `Community 441`, `Community 442`, `Community 960`, `Community 450`, `Community 451`, `Community 963`, `Community 453`, `Community 981`, `Community 982`, `Community 983`, `Community 471`, `Community 984`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 34` to `Community 3`, `Community 4`, `Community 134`, `Community 135`, `Community 8`, `Community 1033`, `Community 10`, `Community 14`, `Community 17`, `Community 18`, `Community 19`, `Community 22`, `Community 28`, `Community 30`, `Community 42`, `Community 684`, `Community 44`, `Community 54`, `Community 55`, `Community 953`, `Community 187`, `Community 63`, `Community 67`, `Community 452`, `Community 68`, `Community 71`, `Community 72`, `Community 200`, `Community 75`, `Community 206`, `Community 79`, `Community 87`, `Community 216`, `Community 96`, `Community 101`, `Community 102`, `Community 1004`, `Community 112`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 8` to `Community 3`, `Community 4`, `Community 9`, `Community 10`, `Community 140`, `Community 13`, `Community 14`, `Community 143`, `Community 145`, `Community 153`, `Community 154`, `Community 28`, `Community 160`, `Community 161`, `Community 34`, `Community 437`, `Community 54`, `Community 53`, `Community 56`, `Community 192`, `Community 67`, `Community 196`, `Community 68`, `Community 71`, `Community 203`, `Community 83`, `Community 89`, `Community 92`, `Community 95`, `Community 96`, `Community 109`, `Community 1392`, `Community 115`, `Community 126`?**
