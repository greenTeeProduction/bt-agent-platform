# Graph Report - superpowers-20260713T161837-10851188-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-13)

## Corpus Check
- 844 files · ~948,177 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21020 nodes · 32380 edges · 1728 communities (1370 shown, 358 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8323 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ec6a953`
...
8. `sleep()` - 95 edges
9. `main()` - 77 edges
10. `arc42 Section 9 — Architecture Decisions` - 75 edges
...
## Communities (1728 total, 358 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (139): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+131 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (139): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+131 more)
...
Cohesion: 0.04
Nodes (65): containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest(), TestRunTask_CacheHit() (+57 more)
...
Cohesion: 0.04
Nodes (76): auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext(), AuditMiddleware() (+68 more)
...
Cohesion: 0.05
Nodes (70): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), buildChainActionFn() (+62 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (75): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+67 more)
...
Cohesion: 0.06
Nodes (56): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir(), MemoryDir() (+48 more)
...
Cohesion: 0.05
Nodes (22): Server, AgentMetric, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts() (+14 more)
...
Cohesion: 0.1
Nodes (56): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Finance(), TestRouting_Research(), TestTree_Research() (+48 more)
...
Cohesion: 0.05
Nodes (32): handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogin(), handleLogout() (+24 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (43): applyScriptRunner, cleanApplyScriptRunner, fakeClaude, fakeCommitRunner, hookFailureClass, TestVerifyNotebookLMEvidenceAcceptsRealNotebookPayload(), TestVerifyNotebookLMEvidenceRejectsEmptyOrUngroundedSuccess(), TestVerifyNotebookLMEvidenceRejectsFabricatedOutput() (+35 more)
...
Cohesion: 0.06
Nodes (35): TestNewQTable(), TestNewReinforcementLearner(), TestQTableSelectUpdateBestAction(), TestQTableStateBucketsAndDepth(), TestReinforcementLearnerLearnAndSuggest(), NewQTable(), NewReinforcementLearner(), TestExpertKnowledge_SeedSpecialistsCarryProvenance() (+27 more)
...
Cohesion: 0.09
Nodes (42): TestSideEffectClassOfSubtree_DeepChild(), TestSideEffectClassOfSubtree_MultipleChildren(), TestSideEffectClassOfSubtree_NoSideEffect(), TestSideEffectClassOfSubtree_RootHasClass(), TestWalkValidate_DepthLimitExceeded(), TestWalkValidate_DestroySideEffectNoGate(), TestWalkValidate_ExternalSideEffectNoGate(), TestWalkValidate_HumanApprovalGateSetsFlag() (+34 more)

### Community 65 - "Community 65"
Cohesion: 0.08
Nodes (23): handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus() (+15 more)
...
Cohesion: 0.12
Nodes (34): Duration(), TestDuration(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes() (+26 more)
...
Cohesion: 0.12
Nodes (30): TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull(), TestBrainstormRejectedWhenFilesNotGoPath(), TestBrainstormRejectedWhenMalformedOrProse(), TestBrainstormRejectedWhenNotDeeper(), TestBrainstormRejectedWhenRunOmitsShort(), withBrainstorm(), brainstormExpandPlan() (+22 more)
...
Cohesion: 0.16
Nodes (27): init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled(), TestBanditSelector_DisabledMatchesSelectorSemantics(), TestBanditSelector_DisabledRunningChildRestartsAtZero() (+19 more)
...
Cohesion: 0.08
Nodes (31): TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestBuildChainActionFn_LlmCallNilLLM(), TestBuildChainActionFn_UnknownChainType(), TestComputeSubtreeMetrics_MixedChildren(), TestComputeSubtreeMetrics_NilInput() (+23 more)
...
Cohesion: 0.11
Nodes (6): AgentExecutor, PageAgent, RedisPriorityQueue, RedisQueue, RemoteExecutor, RemoteExecutorConfig
...
Cohesion: 0.1
Nodes (26): countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New() (+18 more)
...
Cohesion: 0.11
Nodes (13): main(), main(), fanoutHandler, InitLogExport(), logExportTarget(), newTraceContextHandler(), TestInitLogExport_Idempotent(), TestLogExportTarget() (+5 more)
...
Cohesion: 0.08
Nodes (23): TestDeprecatedHandler_NoSunset(), TestDeprecatedHandler_WithSunsetDate(), TestDeprecatedHandlerFunc(), TestNumberSchema(), DeprecationHeader, DeprecatedHandler(), DeprecatedHandlerFunc(), httpStatusText() (+15 more)
...
Cohesion: 0.18
Nodes (18): NewDefaultCompany(), CompanyState, Decision, QuarterResult, companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary() (+10 more)
...
Cohesion: 0.15
Nodes (13): DefaultBlockConfig(), NewMetaPromptEvolver(), NewMutationContext(), TestBlockConfig_FilterMutations(), TestBlockConfig_IsMutable(), TestCrisisDetector_LastDiversity(), TestDefaultBlockConfig(), TestFindBlockForNode() (+5 more)
...
Cohesion: 0.2
Nodes (6): isSelectorFallback(), mergeSelectorStatsMaps(), persistSelectorStats(), readSelectorStatsFile(), recordSelectorOutcomeInto(), SelectorOptimizer
...
Cohesion: 0.18
Nodes (11): code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), Package: gardener, Package: goap, Package: langagent (+3 more)
...
Cohesion: 0.2
Nodes (10): code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), Package: a2a, Package: log, Package: persistence (+2 more)
...
## Knowledge Gaps
- **7063 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7058 more)
...
- **Why does `Append()` connect `Community 36` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 22`, `Community 24`, `Community 27`, `Community 28`, `Community 540`, `Community 29`, `Community 31`, `Community 32`, `Community 33`, `Community 542`, `Community 35`, `Community 34`, `Community 39`, `Community 40`, `Community 41`, `Community 43`, `Community 557`, `Community 46`, `Community 47`, `Community 48`, `Community 51`, `Community 52`, `Community 565`, `Community 53`, `Community 54`, `Community 55`, `Community 57`, `Community 58`, `Community 569`, `Community 60`, `Community 59`, `Community 62`, `Community 63`, `Community 64`, `Community 571`, `Community 572`, `Community 67`, `Community 65`, `Community 69`, `Community 70`, `Community 72`, `Community 73`, `Community 74`, `Community 76`, `Community 78`, `Community 80`, `Community 82`, `Community 83`, `Community 84`, `Community 86`, `Community 87`, `Community 88`, `Community 90`, `Community 91`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 98`, `Community 105`, `Community 106`, `Community 108`, `Community 118`, `Community 120`, `Community 122`, `Community 123`, `Community 125`, `Community 128`, `Community 131`, `Community 132`, `Community 133`, `Community 136`, `Community 137`, `Community 139`, `Community 140`, `Community 144`, `Community 148`, `Community 150`, `Community 156`, `Community 158`, `Community 162`, `Community 164`, `Community 171`, `Community 172`, `Community 173`, `Community 183`, `Community 188`, `Community 189`, `Community 193`, `Community 194`, `Community 195`, `Community 197`, `Community 198`, `Community 200`, `Community 202`, `Community 203`, `Community 205`, `Community 721`, `Community 722`, `Community 723`, `Community 724`, `Community 213`, `Community 214`, `Community 216`, `Community 219`, `Community 746`, `Community 747`, `Community 748`, `Community 750`, `Community 763`, `Community 764`, `Community 766`, `Community 768`, `Community 811`, `Community 360`, `Community 364`, `Community 370`, `Community 372`, `Community 373`, `Community 375`, `Community 376`, `Community 382`, `Community 383`, `Community 384`, `Community 385`, `Community 393`, `Community 396`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 68` to `Community 2`, `Community 3`, `Community 132`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 143`, `Community 16`, `Community 155`, `Community 31`, `Community 32`, `Community 162`, `Community 163`, `Community 165`, `Community 40`, `Community 42`, `Community 43`, `Community 47`, `Community 50`, `Community 564`, `Community 181`, `Community 60`, `Community 61`, `Community 65`, `Community 197`, `Community 201`, `Community 77`, `Community 79`, `Community 92`, `Community 739`, `Community 104`, `Community 107`, `Community 108`, `Community 374`, `Community 122`, `Community 124`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 40` to `Community 2`, `Community 131`, `Community 134`, `Community 7`, `Community 8`, `Community 9`, `Community 15`, `Community 149`, `Community 160`, `Community 32`, `Community 36`, `Community 165`, `Community 164`, `Community 41`, `Community 44`, `Community 47`, `Community 182`, `Community 183`, `Community 60`, `Community 189`, `Community 190`, `Community 62`, `Community 1086`, `Community 65`, `Community 66`, `Community 68`, `Community 72`, `Community 202`, `Community 206`, `Community 207`, `Community 87`, `Community 120`, `Community 1018`, `Community 124`, `Community 125`?**
