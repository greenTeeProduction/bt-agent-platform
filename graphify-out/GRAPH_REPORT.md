# Graph Report - superpowers-20260712T032055-83eaaa9a-goap-fusion-loop-runner-blackboard-conte  (2026-07-12)

## Corpus Check
- 815 files · ~888,172 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19374 nodes · 30369 edges · 1628 communities (1274 shown, 354 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8041 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e25327a`
...
## Communities (1628 total, 354 thin omitted)
...
Cohesion: 0.02
Nodes (115): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+107 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (115): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+107 more)
...
Cohesion: 0.04
Nodes (92): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit() (+84 more)
...
Cohesion: 0.06
Nodes (70): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation() (+62 more)
...
Cohesion: 0.04
Nodes (66): DefaultRetryPolicy(), GetCategory(), GetErrorContext(), NewCategorizedError(), NewErrorContext(), TestCategorizedError_Error(), TestCategorizedError_NilError(), TestCategorizedError_Unwrap() (+58 more)
...
Cohesion: 0.04
Nodes (51): NewRunDeps(), handleSprintExecute(), main(), handlePipelineRun(), handlePipelines(), newPipelineRunner(), newRunID(), resolveTree() (+43 more)
...
Cohesion: 0.06
Nodes (53): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree(), agentTemplateYAML, TestResolveTreeID_FusionAliases(), HermesObsidianOptimizerTree() (+45 more)
...
Cohesion: 0.07
Nodes (57): AgentExecutor, registerSetupActions(), TestNewFileWriteTool_Structure(), TestNewGoTestTool_Structure(), TestNewWebSearchTool_Structure(), realTool, goModuleRoot(), newCalculatorTool() (+49 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (20): AgentMetric, AlertReport, MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON(), evaluateGlobalAlerts(), evaluateHTTPAlerts() (+12 more)
...
Cohesion: 0.06
Nodes (45): HTTPMethod, collectViolations(), fieldPath(), findResponse(), NewRouteIndex(), pathOrRoot(), ResponseValidator(), routeKey() (+37 more)
...
Cohesion: 0.06
Nodes (52): TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailure_BackwardCompat(), TestCircuitBreaker_RecordFailureWithCategory(), TestIntegration_CircuitBreakerAndDLQ(), Backoff(), NewCircuitBreaker(), NewConcurrencyLimiter() (+44 more)

### Community 40 - "Community 40"
Cohesion: 0.12
Nodes (47): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Research(), TestTree_Research() (+39 more)

### Community 41 - "Community 41"
Cohesion: 0.07
Nodes (49): captureExporter, NewOTLPHTTPExporter(), TestConfigureOTLPFromEnv(), TestConfigureOTLPFromEnv_DisabledWithoutEndpoint(), TestConsoleTracer_ExporterErrorDoesNotBreakEnd(), TestConsoleTracer_ExporterReceivesCompletedSpan(), TestOTLPHTTPExporter_Non2xx(), TestOTLPHTTPExporter_PostsOTLPJSON() (+41 more)
...
Cohesion: 0.07
Nodes (30): TestMatchBlockPattern(), AntiPattern, TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), DesignPattern, TestExpert_MatchPattern(), BlockIDFromRef(), containsStr() (+22 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (23): TestNewQTable(), TestNewReinforcementLearner(), extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), containsCrisisReason(), Crossover() (+15 more)
...
Cohesion: 0.1
Nodes (45): Duration(), TestDuration(), countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New(), TestNewPopulation_Evolution() (+37 more)
...
Cohesion: 0.08
Nodes (45): LoadPipeline(), RunPipeline(), RunPipelineWithID(), mcpDeps, addFailureContext(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree() (+37 more)
...
Cohesion: 0.13
Nodes (43): TestRouteBuilder_Build(), ArraySchema(), BoolSchema(), IntSchema(), NewOpenAPIGenerator(), NewRoute(), ObjectSchema(), StringSchema() (+35 more)
...
Cohesion: 0.05
Nodes (42): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+34 more)
...
Cohesion: 0.09
Nodes (29): TestOutcomeErrorDetail(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath(), hostURLOf() (+21 more)
...
Cohesion: 0.07
Nodes (22): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, TestHasChildNamed_DeepNested(), TestHasChildNamed_Found() (+14 more)
...
Cohesion: 0.08
Nodes (18): tracingMiddleware(), fanoutHandler, traceContextHandler, ContextWithTraceParentHeader(), Endpoint(), InitFromEnv(), parseOTLPEndpoint(), ParseOTLPTarget() (+10 more)
...
Cohesion: 0.1
Nodes (25): TestCheckConfidence_ConditionExists(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter() (+17 more)
...
Cohesion: 0.1
Nodes (27): ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Compose(), ComposeFromRefs(), ComposeTaskTree() (+19 more)
...
Cohesion: 0.11
Nodes (24): TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), ApplyHITLPolicy(), countTreeNodes(), TestSuperpowersPipelineSimulation(), TestHumanApprovalGate_AutoApprove() (+16 more)
...
Cohesion: 0.1
Nodes (21): Block, Category, composeOrderedWithMiddle(), ComposePreset(), ComposePresetWithTools(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), PipelineWithToolsProfile() (+13 more)
...
Cohesion: 0.12
Nodes (22): collectSelectorNames(), SelectorStatsFile(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain() (+14 more)
...
Cohesion: 0.16
Nodes (21): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionPreflightWired(), goapFusionRepeatedHashBypassed() (+13 more)
...
Cohesion: 0.13
Nodes (16): appendMissingRealTools(), inferToolsForTask(), init(), uniqueStrings(), TestAgentWithRealToolsBlocksFinalAnswerWithoutToolUse(), TestAgentWithRealToolsRejectsFinalAnswerWithoutToolUse(), TestDataPipelineTree_NoSourceReportsBlockedNotFabricated(), TestDataPipelineTree_UsesObservedFileMetrics() (+8 more)
...
Cohesion: 0.2
Nodes (8): handleSecurityAudit(), CountEvents(), GlobalAuditBuffer(), TestCountEvents_NoBuffer(), AuditBuffer, AuditBufferJSON, AuditEvent, AuditEventCounts
...
Cohesion: 0.23
Nodes (10): GateResult, RestoreTree(), SnapshotTree(), TestQualityGateConsecutiveFails(), TestQualityGateDisabledWithZeroThreshold(), TestQualityGateReset(), TestQualityGateResetFailCount(), TestQualityGateValidate() (+2 more)
...
Cohesion: 0.17
Nodes (12): code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), Package: evaluator, Package: gardener (+4 more)
...
## Knowledge Gaps
- **6080 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6075 more)
...
- **Why does `Append()` connect `Community 29` to `Community 512`, `Community 513`, `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 9`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 24`, `Community 26`, `Community 27`, `Community 28`, `Community 30`, `Community 33`, `Community 34`, `Community 37`, `Community 38`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 50`, `Community 51`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 67`, `Community 69`, `Community 70`, `Community 73`, `Community 75`, `Community 76`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 84`, `Community 85`, `Community 88`, `Community 89`, `Community 91`, `Community 93`, `Community 94`, `Community 97`, `Community 98`, `Community 99`, `Community 100`, `Community 102`, `Community 105`, `Community 112`, `Community 113`, `Community 118`, `Community 119`, `Community 122`, `Community 123`, `Community 125`, `Community 639`, `Community 127`, `Community 130`, `Community 131`, `Community 133`, `Community 134`, `Community 647`, `Community 645`, `Community 137`, `Community 140`, `Community 141`, `Community 144`, `Community 145`, `Community 146`, `Community 659`, `Community 660`, `Community 663`, `Community 155`, `Community 668`, `Community 156`, `Community 159`, `Community 671`, `Community 161`, `Community 163`, `Community 165`, `Community 167`, `Community 168`, `Community 169`, `Community 686`, `Community 177`, `Community 178`, `Community 691`, `Community 182`, `Community 695`, `Community 184`, `Community 697`, `Community 699`, `Community 700`, `Community 190`, `Community 194`, `Community 707`, `Community 195`, `Community 196`, `Community 198`, `Community 197`, `Community 200`, `Community 208`, `Community 210`, `Community 214`, `Community 215`, `Community 216`, `Community 332`, `Community 333`, `Community 335`, `Community 344`, `Community 345`, `Community 350`, `Community 351`, `Community 353`, `Community 355`, `Community 361`, `Community 364`, `Community 876`, `Community 366`, `Community 882`, `Community 485`, `Community 500`?**
  _High betweenness centrality (0.143) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 87` to `Community 0`, `Community 516`, `Community 7`, `Community 139`, `Community 140`, `Community 13`, `Community 16`, `Community 19`, `Community 20`, `Community 21`, `Community 664`, `Community 27`, `Community 28`, `Community 162`, `Community 39`, `Community 42`, `Community 49`, `Community 51`, `Community 179`, `Community 53`, `Community 62`, `Community 68`, `Community 74`, `Community 75`, `Community 203`, `Community 352`, `Community 96`, `Community 105`, `Community 113`, `Community 121`, `Community 122`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 19` to `Community 128`, `Community 516`, `Community 135`, `Community 11`, `Community 13`, `Community 141`, `Community 142`, `Community 150`, `Community 25`, `Community 27`, `Community 28`, `Community 159`, `Community 33`, `Community 39`, `Community 54`, `Community 57`, `Community 58`, `Community 62`, `Community 68`, `Community 198`, `Community 96`, `Community 97`, `Community 120`, `Community 121`?**
