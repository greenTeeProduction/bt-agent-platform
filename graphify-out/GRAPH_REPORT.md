# Graph Report - superpowers-20260715T035616-9a21d49e-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-15)

## Corpus Check
- 852 files · ~994,182 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22246 nodes · 33951 edges · 1813 communities (1467 shown, 346 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8579 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cc9964a5`
...
5. `registerMCPTools()` - 112 edges
6. `BuildTree()` - 111 edges
7. `newDefaultConfig()` - 100 edges
8. `arc42 Section 9 — Architecture Decisions` - 99 edges
9. `sleep()` - 95 edges
10. `main()` - 78 edges
...
## Communities (1813 total, 346 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (157): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+149 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (157): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+149 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (117): TestCheckConfidence_ConditionExists(), TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch() (+109 more)
...
Cohesion: 0.03
Nodes (65): AutoRebuildEnabled(), StartDriftWatcher(), DashboardRebuildTargets(), DefaultRebuildTargets(), NewRebuildBackoff(), main(), tracingMiddleware(), handlePipelineRun() (+57 more)
...
Cohesion: 0.04
Nodes (88): perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree() (+80 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (77): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), TestComposeAndExpand(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle() (+69 more)
...
Cohesion: 0.02
Nodes (99): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+91 more)
...
Cohesion: 0.08
Nodes (79): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+71 more)
...
Cohesion: 0.06
Nodes (67): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes() (+59 more)
...
Cohesion: 0.06
Nodes (62): satisfactionRecords(), TestEvaluateTree_EmptyRecordsSatisfactionUnknown(), TestEvaluateTree_FeedbackShiftsComposite(), TestEvaluateTree_NoFeedbackLeavesCompositeUnchanged(), countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New() (+54 more)
...
Cohesion: 0.06
Nodes (57): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), nlmQuotaExhausted(), nlmQuotaExhaustedUntil(), TestIsGoapNotebookLMQuotaError(), TestNlmQuotaState_EmptyAndGarbageNotExhausted() (+49 more)
...
Cohesion: 0.07
Nodes (40): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestAgentWithRealToolsBlocksFinalAnswerWithoutToolUse(), TestAgentWithRealToolsRejectsFinalAnswerWithoutToolUse() (+32 more)
...
Cohesion: 0.05
Nodes (44): TestOutcomeErrorDetail(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath(), hostURLOf() (+36 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (44): Blackboard, ChildTick, childTickLog, init(), TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern() (+36 more)
...
Cohesion: 0.05
Nodes (28): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, Gardener, baseNodeCount() (+20 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (52): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestValidate_MemoryNodesDuplicateNames(), TestValidate_MemoryNodesRequireUniqueNames(), TestSuperpowersWorkflowTree_BuildsAndValidates() (+44 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (29): TestRunOnce_EmitsRunRootSpan(), TestRunJob_WebhookSpanJoinsRunTrace(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), alwaysSampler (+21 more)
...
Cohesion: 0.05
Nodes (53): TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestNewGoTestTool_Structure(), TestNewWebSearchTool_Structure(), TestStripHTML_Attributes(), TestStripHTML_Basic() (+45 more)
...
Cohesion: 0.05
Nodes (37): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, init(), init(), registerSuperpowersConditions(), Engine (+29 more)
...
Cohesion: 0.09
Nodes (29): FitnessDimension, MultiFitness, MultiIndividual, cappedIndividuals(), clampScore(), countActions(), countConditions(), NewMultiFitness() (+21 more)
...
Cohesion: 0.06
Nodes (25): AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce(), TestAutoRestartEnabled(), TestDriftWatchOnceRestartHandoff(), scrubGitEnv() (+17 more)
...
Cohesion: 0.07
Nodes (26): BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), parseChainConfig(), TestChainAction_ParseConfig(), BuildInverter(), BuildRepeater(), BuildRunner() (+18 more)
...
Cohesion: 0.1
Nodes (25): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+17 more)
...
Cohesion: 0.09
Nodes (27): Block, ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), Category, ComposeSpec, ApplyBlockMutations() (+19 more)
...
Cohesion: 0.13
Nodes (25): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestRunJob_WarnsOnDeployDriftAtCycleComplete(), TestRunJob_WebhookIncludesBuildRevision(), NewScheduler(), decodeRunCount(), TestHistory_FileCreated() (+17 more)
...
Cohesion: 0.15
Nodes (25): NewDefaultCompany(), CEOTree(), CTOTree(), PMTree(), Roles(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint() (+17 more)
...
Cohesion: 0.12
Nodes (23): collectSelectorNames(), SelectorStatsFile(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing() (+15 more)
...
Cohesion: 0.17
Nodes (20): saveRecordWithDelay(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolveTool_Call_NotEnoughFailures(), TestEvolveTool_Call_NoTree(), TestEvolveTool_Call_Success(), TestFitnessTool_Call(), TestFitnessTool_Call_NoData(), TestGetReflectionsTool_Call_NoRecords() (+12 more)
...
Cohesion: 0.11
Nodes (15): ResolvePipelineAgent(), TestValidateQualitySpec_BlockedPattern(), TestValidateQualitySpec_MinLength(), TestValidateQualitySpec_NilSpecUsesHeuristic(), TestValidateQualitySpec_RequiredSections(), ValidateQualitySpec(), RunDeps, applyOutcomeRefinement() (+7 more)

### Community 163 - "Community 163"
Cohesion: 0.17
Nodes (9): MaxDepth(), hasAnySetupTools(), hasExecutionPathFirst(), hasUnboundedRetry(), MetaValidationDecision, MetaValidationIssue, MetaValidationReport, MetaValidator (+1 more)
...
Cohesion: 0.12
Nodes (21): isKnownActionName(), isKnownConditionName(), TestBuildNode_AbortOnEvent(), TestBuildNode_PlannerNode(), TestBuildNode_ReactiveParallel(), TestBuildNode_UtilitySelector(), TestIsKnownActionName_BuiltinOnly(), TestIsKnownActionName_Empty() (+13 more)
...
Cohesion: 0.11
Nodes (14): AgentMetrics, AgentStats, BuildIdentity, HealthResponse, Histogram, bucketForStatus(), GetAgentMetrics(), init() (+6 more)
...
Cohesion: 0.28
Nodes (15): saveRecordWithDelay(), TestEvolveTool_Call_NotEnoughFailures(), TestEvolveTool_Call_NoTree(), TestEvolveTool_Call_Success(), TestFitnessTool_Call(), TestFitnessTool_Call_NoData(), TestGetReflectionsTool_Call_NoRecords(), TestGetReflectionsTool_Call_Truncation() (+7 more)
...
Cohesion: 0.27
Nodes (9): NewACPClient(), countCrashInvocations(), TestACPClientCircuitBreakerShortCircuitsRepeatedSubprocessFailures(), TestACPClientGenerateReturnsErrorWhenSessionMissing(), TestACPClientGenerateTalksToACPServer(), TestACPClientGenerateTalksToHermesACP(), TestACPHelperProcess(), writeJSON() (+1 more)
...
Cohesion: 0.24
Nodes (10): collectSelectors(), conditionOverlap(), findMainSelector(), TestFindMainSelector(), splitCamelCase(), wordSet(), DTImprovementReport, DTSelectorStats (+2 more)
...
Cohesion: 0.2
Nodes (10): code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), Package: goap, Package: langagent, Package: reflection (+2 more)
...
Cohesion: 0.22
Nodes (9): TestCreateAgentTool_Call_NilFactory(), TestReflectTool_Call_NoLLM(), TestReflectTool_Call_WithLLM(), TestRunTaskTool_Call(), TestToolNames_And_Descriptions(), NewCreateAgentTool(), NewGetTreeTool(), NewReflectTool() (+1 more)

### Community 839 - "Community 839"
Cohesion: 0.28
Nodes (8): TestBTOptimizer_New(), TestExtractCondition(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), TestSplitCamelCase(), NewBTOptimizer(), TestPathHitRatio()
...
## Knowledge Gaps
- **7807 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7802 more)
...
- **Why does `Append()` connect `Community 56` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 15`, `Community 16`, `Community 17`, `Community 20`, `Community 22`, `Community 23`, `Community 27`, `Community 29`, `Community 31`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 40`, `Community 42`, `Community 1067`, `Community 43`, `Community 45`, `Community 46`, `Community 47`, `Community 1072`, `Community 49`, `Community 50`, `Community 51`, `Community 48`, `Community 53`, `Community 54`, `Community 55`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 576`, `Community 579`, `Community 68`, `Community 581`, `Community 70`, `Community 69`, `Community 72`, `Community 584`, `Community 75`, `Community 76`, `Community 77`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 597`, `Community 85`, `Community 86`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 611`, `Community 612`, `Community 100`, `Community 104`, `Community 105`, `Community 108`, `Community 109`, `Community 110`, `Community 111`, `Community 112`, `Community 113`, `Community 116`, `Community 117`, `Community 118`, `Community 121`, `Community 123`, `Community 126`, `Community 128`, `Community 130`, `Community 131`, `Community 137`, `Community 143`, `Community 149`, `Community 152`, `Community 154`, `Community 155`, `Community 156`, `Community 157`, `Community 159`, `Community 162`, `Community 163`, `Community 176`, `Community 177`, `Community 178`, `Community 185`, `Community 186`, `Community 187`, `Community 190`, `Community 191`, `Community 193`, `Community 194`, `Community 199`, `Community 200`, `Community 203`, `Community 206`, `Community 207`, `Community 208`, `Community 210`, `Community 214`, `Community 215`, `Community 777`, `Community 782`, `Community 784`, `Community 786`, `Community 787`, `Community 788`, `Community 811`, `Community 813`, `Community 814`, `Community 815`, `Community 816`, `Community 817`, `Community 831`, `Community 832`, `Community 836`, `Community 838`, `Community 873`, `Community 375`, `Community 376`, `Community 378`, `Community 390`, `Community 392`, `Community 393`, `Community 394`, `Community 400`, `Community 406`, `Community 407`, `Community 414`, `Community 415`, `Community 416`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 27` to `Community 2`, `Community 131`, `Community 4`, `Community 389`, `Community 134`, `Community 8`, `Community 136`, `Community 139`, `Community 12`, `Community 1166`, `Community 783`, `Community 16`, `Community 18`, `Community 149`, `Community 153`, `Community 26`, `Community 32`, `Community 45`, `Community 47`, `Community 48`, `Community 175`, `Community 56`, `Community 60`, `Community 61`, `Community 63`, `Community 65`, `Community 68`, `Community 204`, `Community 91`, `Community 94`, `Community 104`, `Community 105`, `Community 111`, `Community 117`, `Community 118`, `Community 381`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 45` to `Community 3`, `Community 4`, `Community 8`, `Community 12`, `Community 17`, `Community 18`, `Community 23`, `Community 24`, `Community 26`, `Community 27`, `Community 32`, `Community 34`, `Community 804`, `Community 42`, `Community 43`, `Community 44`, `Community 186`, `Community 60`, `Community 832`, `Community 66`, `Community 835`, `Community 67`, `Community 74`, `Community 204`, `Community 205`, `Community 91`, `Community 96`, `Community 104`, `Community 111`, `Community 380`, `Community 124`, `Community 127`?**
