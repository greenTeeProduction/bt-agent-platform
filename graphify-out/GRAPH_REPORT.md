# Graph Report - superpowers-20260713T133014-1d2ca422-goap-fusion-loop-runner-blackboard-conte  (2026-07-13)

## Corpus Check
- 839 files · ~944,070 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20775 nodes · 32119 edges · 1743 communities (1373 shown, 370 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8310 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f11675b0`
...
## Communities (1743 total, 370 thin omitted)
...
Cohesion: 0.01
Nodes (135): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+127 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (135): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+127 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (110): main(), main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview() (+102 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (102): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+94 more)
...
Cohesion: 0.04
Nodes (90): truncateGoap(), arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), collapseToSingleLine() (+82 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (69): AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce(), TestAutoRestartEnabled(), TestDriftWatchOnceRestartHandoff() (+61 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (40): History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), mockTTOrch, Workflow (+32 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (88): handleLogout(), DefaultPanicHandler(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey (+80 more)
...
Cohesion: 0.05
Nodes (74): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileWriteTool_Structure(), TestNewGoTestTool_Structure() (+66 more)
...
Cohesion: 0.05
Nodes (62): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), TestComposePreset_Agentic(), TestComposeTaskTreeAgentic_WithStrategyMiddle(), TestComposeTaskTreeFull() (+54 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (75): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+67 more)
...
Cohesion: 0.03
Nodes (53): Outcome, Record, FilterByTreeName(), Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped() (+45 more)
...
Cohesion: 0.03
Nodes (71): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+63 more)
...
Cohesion: 0.07
Nodes (62): Duration(), TestDuration(), TestCheckConfidence_ConditionExists(), TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), satisfactionRecords(), TestEvaluateTree_EmptyRecordsSatisfactionUnknown() (+54 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (36): cacheResultAction(), execLLMCallAction(), execRefineAction(), generatePlanAction(), knowledgeQueryAction(), NewEngine(), RegisterProviders(), TestCacheFlow_KnowledgeToCache() (+28 more)
...
Cohesion: 0.05
Nodes (37): TestRunOnce_EmitsRunRootSpan(), tracingMiddleware(), main(), attachLogHandler(), buildBaseHandler(), buildLogger(), envLogLevel(), Error() (+29 more)
...
Cohesion: 0.06
Nodes (57): TestNewReinforcementLearner(), NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation() (+49 more)
...
Cohesion: 0.05
Nodes (53): DefaultMock(), TestRunSuiteIsSandboxed(), resolverReachableExtraDomainTrees(), singleTaskSuite(), tasksForTree(), TestAgentMonitor(), TestAllDomainTreeConditionsHaveDescriptions(), TestAllDomainTreeNodesHaveDescriptions() (+45 more)
...
Cohesion: 0.07
Nodes (52): mcpDeps, addFailureContext(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection(), islandArchivePath(), mapElitesArchivePath() (+44 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (35): TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeSpan, fakeTracer, mockOllamaServer(), newTestClient(), TestClient_AnalyzeComplexity() (+27 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (32): AgentMetrics, AgentStats, BuildIdentity, Counter, Gauge, HealthResponse, Histogram, HistogramSnap (+24 more)
...
Cohesion: 0.06
Nodes (36): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM() (+28 more)
...
Cohesion: 0.1
Nodes (36): loadSuperpowersPlanState(), saveSuperpowersPlanState(), buildDeterministicImplementationPlan(), defaultNlmGrillAuthGuard(), nlmGrillAnswerer(), nlmGrillUnavailable(), parseNumberedAnswers(), runGrillAuthGuardAction() (+28 more)

### Community 82 - "Community 82"
Cohesion: 0.09
Nodes (26): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), countTreeNodes(), TestSuperpowersPipelineSimulation(), TestHumanApprovalGate_AutoApprove() (+18 more)
...
Cohesion: 0.08
Nodes (32): TestBuildPlannerNode_ChainStateGoals(), TestReadGoals_ChainStateFallback(), TestReadGoals_Preconditions(), GoalDefinition, GOAPAction, GOAPGoal, Plan, boolConditions() (+24 more)
...
Cohesion: 0.09
Nodes (28): Block, Category, Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle(), ComposePreset() (+20 more)
...
Cohesion: 0.1
Nodes (30): TestBTOptimizer_New(), collectSelectors(), conditionOverlap(), findMainSelector(), TestExtractCondition(), TestFindMainSelector(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras() (+22 more)
...
Cohesion: 0.13
Nodes (24): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir(), MemoryDir() (+16 more)

### Community 122 - "Community 122"
Cohesion: 0.11
Nodes (24): collectSelectorNames(), SelectorStatsFile(), TestSelectorOptimizer_New(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb() (+16 more)
...
Cohesion: 0.09
Nodes (10): getHomeDir(), handleAlertRules(), handleMetricsLive(), handleOpenAPI(), handleScalability(), handleSwagger(), handleTrees(), init() (+2 more)
...
Cohesion: 0.12
Nodes (23): Analysis, Contradiction, CoveragePoint, TestJudge_ParsesStructuredJSON(), TestJudge_RejectsInvalidJSON(), TestSynthesize_UsesAnalysisAndResponses(), TestToolLoop_StopsAtMaxToolCalls(), ModelCaller (+15 more)
...
Cohesion: 0.13
Nodes (20): Analyzer, extractJSON(), NewAnalyzer(), truncate(), TestAnalyzer_EmptyResponse_Error(), TestAnalyzer_NoStrategyPath_Error(), TestAnalyzer_ParsesTreeSpec(), TestExtractJSON() (+12 more)
...
Cohesion: 0.12
Nodes (12): ResolvePipelineAgent(), TestRemoveAgentJobs(), TestResolvePipelineAgent_Aliases(), RunDeps, applyOutcomeRefinement(), isHealthyOutcome(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome() (+4 more)

### Community 195 - "Community 195"
Cohesion: 0.13
Nodes (15): FileJobStore, JobStore, NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad(), TestScheduler_NoJobStore_NilSafe() (+7 more)
...
Cohesion: 0.25
Nodes (5): acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), cappedCells()
...
Cohesion: 0.18
Nodes (9): handleAgentCreate(), handleAgentDelete(), handleDLQReplay(), handleLogin(), handleSession(), handleTaskApprove(), handleTaskReject(), TestHandleDLQReplay_RequeuesInsteadOfDropping() (+1 more)
...
Cohesion: 0.22
Nodes (11): NewACPClient(), countCrashInvocations(), TestACPClientCircuitBreakerShortCircuitsRepeatedSubprocessFailures(), TestACPClientGenerateReturnsErrorWhenSessionMissing(), TestACPClientGenerateTalksToACPServer(), TestACPClientGenerateTalksToHermesACP(), TestACPHelperProcess(), TestNewProviderCreatesACPClient() (+3 more)
...
Cohesion: 0.18
Nodes (7): fakeCaller, fakeTool, TestRunPanel_FailsWhenAllModelsFail(), TestRunPanel_PreservesPerModelErrors(), TestRunPanel_RunsModelsConcurrently(), panelSystemPrompt(), RunPanel()
...
Cohesion: 0.33
Nodes (11): cmdCreate(), cmdDelete(), cmdList(), cmdLogs(), cmdRun(), cmdTemplates(), cmdTest(), main() (+3 more)
...
Cohesion: 0.31
Nodes (8): handleAgentExecute(), handleAgentRun(), handleSprintExecute(), handleTaskCreate(), DefaultAgentTask(), NewAgentExecutor(), PickTreeForTask(), ResolveAgentName()

### Community 768 - "Community 768"
Cohesion: 0.36
Nodes (8): TestNewProvider_BuildsFallbackChainFromConfiguredModels(), fallbackSpec, buildProvider(), isKnownProvider(), NewProvider(), parseFallbackModels(), primaryModel(), splitACPArgs()
...
## Knowledge Gaps
- **6903 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6898 more)
...
- **Why does `Append()` connect `Community 9` to `Community 0`, `Community 3`, `Community 4`, `Community 6`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 534`, `Community 22`, `Community 25`, `Community 538`, `Community 539`, `Community 28`, `Community 537`, `Community 31`, `Community 33`, `Community 36`, `Community 37`, `Community 552`, `Community 41`, `Community 554`, `Community 44`, `Community 557`, `Community 46`, `Community 45`, `Community 48`, `Community 49`, `Community 50`, `Community 558`, `Community 51`, `Community 563`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 569`, `Community 59`, `Community 60`, `Community 62`, `Community 574`, `Community 64`, `Community 65`, `Community 66`, `Community 63`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 83`, `Community 84`, `Community 85`, `Community 87`, `Community 95`, `Community 98`, `Community 100`, `Community 101`, `Community 104`, `Community 105`, `Community 106`, `Community 111`, `Community 113`, `Community 117`, `Community 118`, `Community 119`, `Community 121`, `Community 130`, `Community 135`, `Community 136`, `Community 142`, `Community 144`, `Community 147`, `Community 148`, `Community 150`, `Community 151`, `Community 156`, `Community 162`, `Community 165`, `Community 166`, `Community 167`, `Community 171`, `Community 172`, `Community 180`, `Community 183`, `Community 185`, `Community 186`, `Community 187`, `Community 190`, `Community 192`, `Community 193`, `Community 196`, `Community 197`, `Community 198`, `Community 199`, `Community 202`, `Community 203`, `Community 205`, `Community 720`, `Community 209`, `Community 210`, `Community 723`, `Community 721`, `Community 215`, `Community 216`, `Community 217`, `Community 736`, `Community 738`, `Community 748`, `Community 749`, `Community 752`, `Community 768`, `Community 769`, `Community 773`, `Community 774`, `Community 775`, `Community 796`, `Community 817`, `Community 825`, `Community 354`, `Community 355`, `Community 361`, `Community 363`, `Community 365`, `Community 368`, `Community 369`, `Community 370`, `Community 380`, `Community 381`, `Community 383`, `Community 388`, `Community 389`, `Community 392`, `Community 393`, `Community 394`, `Community 992`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 8` to `Community 768`, `Community 0`, `Community 3`, `Community 389`, `Community 12`, `Community 143`, `Community 16`, `Community 21`, `Community 22`, `Community 23`, `Community 155`, `Community 29`, `Community 31`, `Community 32`, `Community 37`, `Community 38`, `Community 39`, `Community 42`, `Community 44`, `Community 51`, `Community 63`, `Community 195`, `Community 201`, `Community 720`, `Community 82`, `Community 89`, `Community 737`, `Community 103`, `Community 364`, `Community 121`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 44` to `Community 0`, `Community 1026`, `Community 131`, `Community 8`, `Community 9`, `Community 15`, `Community 16`, `Community 146`, `Community 790`, `Community 23`, `Community 156`, `Community 29`, `Community 36`, `Community 39`, `Community 46`, `Community 175`, `Community 182`, `Community 183`, `Community 59`, `Community 62`, `Community 63`, `Community 65`, `Community 1090`, `Community 200`, `Community 201`, `Community 77`, `Community 83`, `Community 95`, `Community 100`, `Community 103`, `Community 105`, `Community 121`, `Community 122`?**
