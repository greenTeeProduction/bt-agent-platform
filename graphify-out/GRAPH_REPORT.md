# Graph Report - superpowers-20260717T043100-cc81bd8d-goap-fusion-loop-runner-blackboard-conte  (2026-07-17)

## Corpus Check
- 894 files · ~1,124,181 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25056 nodes · 37653 edges · 2006 communities (1636 shown, 370 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9151 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `615fc4b7`
...
3. `NewKnowledgeGraph()` - 141 edges
4. `registerMCPTools()` - 141 edges
5. `9. Architecture Decisions` - 139 edges
...
## Communities (2006 total, 370 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (188): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+180 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (188): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+180 more)
...
Cohesion: 0.03
Nodes (115): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+107 more)
...
Cohesion: 0.04
Nodes (90): truncateGoap(), arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), completeGoapProgramMilestone() (+82 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (76): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle(), ComposePreset() (+68 more)
...
Cohesion: 0.05
Nodes (88): clearSuperpowersPlanState(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), markGoapFusionImplDegraded() (+80 more)
...
Cohesion: 0.04
Nodes (85): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+77 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (69): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestNewFileReadTool_Structure() (+61 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (33): AgentMetric, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON() (+25 more)
...
Cohesion: 0.05
Nodes (79): Duration(), TestDuration(), countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+71 more)
...
Cohesion: 0.07
Nodes (75): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+67 more)
...
Cohesion: 0.06
Nodes (39): DiversityMetrics, EvolutionParameters, extractTreeType(), TestExtractTreeType(), FitnessMetrics, Individual, cloneTree(), collectNodeNames() (+31 more)
...
Cohesion: 0.05
Nodes (49): containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest(), TestRunTask_CacheHit() (+41 more)
...
Cohesion: 0.06
Nodes (62): echoTaskLeaf, islandArchivePath(), newProductionPopulation(), registerMCPTools(), assertExpertArchiveFedFromRun(), injectSelectorProbeTree(), seedSelectorProbeStats(), TestBTDelegateToTreeHoldsBBMu() (+54 more)
...
Cohesion: 0.06
Nodes (52): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, applySuperpowersRunToMainRepo(), assertNoForcedMasterWrite(), bareTestRun(), TestApplySuperpowersRunBareRepoDetachedHeadDoesNotRebase() (+44 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (51): ConnPool, NewConnPool(), NewSharedConnPool(), TestAgentRouter_PooledExecutors_LeastConnections(), TestAgentRouter_WithSharedPool(), TestConnPool_Close(), TestConnPool_CloseIdleConnections(), TestConnPool_CustomConfig() (+43 more)
...
Cohesion: 0.05
Nodes (47): main(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep() (+39 more)
...
Cohesion: 0.09
Nodes (60): TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree(), TestRunCycle_MetricsSave(), biasCandidatesWithExperience(), DefaultEvolveV2Config() (+52 more)
...
Cohesion: 0.08
Nodes (53): buildGrillRound1Query(), buildClaudeReviewPrompt(), TestBuildClaudeReviewPrompt_ContractMarkers(), isGoapNotebookLMFailure(), arc42GoalsPromptBlock(), arc42ResearchTopics(), loadArc42QualityGoals(), TestArc42GoalsPromptBlockContainsEveryGoal() (+45 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (41): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), BuildCircuitBreaker(), BuildInverter(), BuildRepeater() (+33 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (35): apiKey, KeyHash(), NewKeyRing(), NewKeyRotationScheduler(), sha256Hex(), TestExpireKey_NotFound(), TestExpireKey_Success(), TestExpiringKeys_EmptyRing() (+27 more)
...
Cohesion: 0.06
Nodes (29): exportMemoryCategory(), exportPreviousRuns(), min(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic() (+21 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (49): loadSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), saveSuperpowersPlanState(), TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles() (+41 more)
...
Cohesion: 0.07
Nodes (36): BehavioralDescriptor, FeatureDimension, Bucket(), cappedCells(), Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid(), NewMAPElitesPopulation() (+28 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (37): TestOutcomeErrorDetail(), FeedbackFile(), OutcomeErrorDetail(), TestLocalAgentResultNilResultAndSuccessPathsUnchanged(), TestLocalAgentResultPreservesOutcomeOnError(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards() (+29 more)
...
Cohesion: 0.05
Nodes (24): eventDataString(), newRoutineThrottle(), routineThrottle, throttleEntry, WebhookPublisher, runDLQReplayScanOnce(), TestDLQReplayScanSurvivesPanicAcrossTicks(), TestRunFullPipeline_NilSynthesis_NoPanic() (+16 more)
...
Cohesion: 0.07
Nodes (39): NewCatalog(), TestCatalog_Export(), TestCatalog_ListInstalled(), TestCatalog_ListTemplates(), TestCatalog_Search(), TestCatalog_SkillToAgent(), TestInferTree(), NewHistory() (+31 more)
...
Cohesion: 0.08
Nodes (44): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField(), extractNotebookLMAnswer() (+36 more)

### Community 63 - "Community 63"
Cohesion: 0.11
Nodes (39): TestRunSuiteIsSandboxed(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled(), TestBanditSelector_DisabledMatchesSelectorSemantics() (+31 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (26): TestDefaultRebuildTargets_PinsFullListIncludingMCPBinary(), buildStampLdflags(), copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), DefaultRebuildTargets(), NewRebuildBackoff(), RebuildBinaries() (+18 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (29): TestPromoteRunToAgentScope(), RunDeps, TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), Entry, Limits (+21 more)
...
Cohesion: 0.07
Nodes (35): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), Category, ComposeSpec (+27 more)
...
Cohesion: 0.07
Nodes (25): agentExecuteResult(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay() (+17 more)
...
Cohesion: 0.07
Nodes (22): TestCheckConfidence_ConditionExists(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter() (+14 more)
...
Cohesion: 0.07
Nodes (28): Blackboard, ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+20 more)
...
Cohesion: 0.06
Nodes (16): alwaysSampler, Attr, ConsoleTracer, neverSampler, noopSpan, noopTracer, RatioSampler, Sampler (+8 more)
...
Cohesion: 0.14
Nodes (36): TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestRouteBuilder_Build(), TestRouteBuilder_SunsetDate(), NewOpenAPIGenerator(), NewRoute() (+28 more)
...
Cohesion: 0.1
Nodes (33): agentNameFromBB(), init(), registerDelegateNodes(), NewMemoryStore(), storeForTest(), TestContextBlock_EmptyStoreReturnsEmpty(), TestContextBlock_IncludesFactsPitfallsPatterns(), TestContextBlock_SkipsNonHighPriorityItems() (+25 more)
...
Cohesion: 0.14
Nodes (32): recordUserFeedback(), registerFeedbackTools(), newFeedbackDeps(), TestBTFeedbackRegistered(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), TestRecordUserFeedback_FeedsSatisfactionAndFlags(), TestRecordUserFeedback_RejectsBadInput(), TestRecordUserFeedback_TrimsUserAndTreeID() (+24 more)
...
Cohesion: 0.11
Nodes (29): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir(), MemoryDir() (+21 more)
...
Cohesion: 0.07
Nodes (23): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, TestHasChildNamed_DeepNested(), TestHasChildNamed_Found() (+15 more)
...
Cohesion: 0.17
Nodes (24): AllSLOMetrics(), GetSLOMetrics(), TestAllSLOMetrics(), DefaultValidationGateConfig(), TestValidationGate_EvidenceForOtherTreeOnly_FailsClosed(), TestValidationGate_FileEvidence_AggregatesAcrossAgents(), TestValidationGate_FileEvidence_LowSuccessRate_Rejects(), TestValidationGate_FileEvidence_Passes() (+16 more)
...
Cohesion: 0.12
Nodes (10): Gardener, BuildMutationPrompt(), DefaultResearchHints(), NewModelEnsemble(), EnsembleConfig, EnsembleStats, EvolutionContext, ModelEnsemble (+2 more)
...
Cohesion: 0.1
Nodes (24): mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection(), expertArchivePath() (+16 more)
...
Cohesion: 0.08
Nodes (17): perTreeStats(), setupGardener(), TestMetricsTracker_BestFitnessTracking(), TestMetricsTracker_ImprovementRate(), TestMetricsTracker_LastFitnessTracking(), TestMetricsTracker_RecordAndCyclesForTree(), TestMetricsTracker_SaveAndLoadRoundTrip(), TestMetricsTracker_SaveNewDir() (+9 more)
...
Cohesion: 0.16
Nodes (16): degeneratePopulation(), runWithoutPanic(), TestEvolve_DegeneratePopulations(), TestEvolveWithExperience_DegeneratePopulations(), TestMemeticEvolve_DegeneratePopulations(), TestLocalSearchMutableParamsAndTabu(), randomMutation(), extractMutableParams() (+8 more)
...
Cohesion: 0.18
Nodes (21): NewDefaultCompany(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary(), testLLM(), checkTreeBasics(), TestCEOTree_Structure() (+13 more)
...
Cohesion: 0.11
Nodes (18): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestValidate_MemoryNodesDuplicateNames(), TestValidate_MemoryNodesRequireUniqueNames(), TestSuperpowersWorkflowTree_BuildsAndValidates() (+10 more)
...
Cohesion: 0.17
Nodes (18): blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu(), TestBTBlocksComposeSaveHoldsServerLock(), TestBTHITLComposeTaskSaveHoldsBBMu(), TestBTHITLComposeTaskSaveHoldsServerLock() (+10 more)

### Community 217 - "Community 217"
Cohesion: 0.18
Nodes (17): TestBTOptimizer_New(), TestExtractCondition(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), NewBTOptimizer(), NewDTAnalyzer(), pathStat() (+9 more)
...
Cohesion: 0.13
Nodes (16): applyOutcomeRefinement(), IsHealthyOutcome(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome(), RunOptions, RunResult, newCatchupFixture(), TestCycleBreakerSuccess_HealthyOutcomesDoNotTripBreaker() (+8 more)
...
Cohesion: 0.1
Nodes (17): TestValidate_CBCooldownSecs_TooHigh(), TestValidate_CBCooldownSecs_TooLow(), TestValidate_CBThreshold_TooHigh(), TestValidate_CBThreshold_TooLow(), TestValidate_DLQMaxEntries_TooHigh(), TestValidate_DLQMaxEntries_TooLow(), TestValidate_RetryBaseDelayMs_TooHigh(), TestValidate_RetryBaseDelayMs_TooLow() (+9 more)
...
Cohesion: 0.19
Nodes (14): fakeClaude, fakeCommitRunner, TestVerifyNotebookLMEvidenceAcceptsRealNotebookPayload(), TestVerifyNotebookLMEvidenceRejectsEmptyOrUngroundedSuccess(), TestVerifyNotebookLMEvidenceRejectsFabricatedOutput(), verifyNotebookLMEvidenceAction(), fail(), newAutofixRun() (+6 more)
...
Cohesion: 0.12
Nodes (12): BaselineStore, BenchmarkResult, NewBaselineStore(), pctChange(), TestBaselineStore_EmptyFile(), TestBaselineStore_InvalidJSON(), TestBaselineStore_SaveLoad(), TestBaselineStore_UpdateBaseline() (+4 more)

### Community 424 - "Community 424"
Cohesion: 0.16
Nodes (6): enforceIslandCap(), mergeIslandPopulation(), islandArchive, IslandModel, IslandStats, materializeMutationOp()
...
Cohesion: 0.16
Nodes (10): CompanyOrchestrator, EngineerTree(), MarketingTree(), SalesTree(), clamp(), safeDiv(), TestClamp(), TestNilClamp_NoPanic() (+2 more)
...
Cohesion: 0.12
Nodes (16): cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask(), serializeTreeForGardener(), TestCloneTreeForGardener_Basic(), TestCloneTreeForGardener_DoubleNested() (+8 more)
...
Cohesion: 0.18
Nodes (11): code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), Package: factory, Package: llm (+3 more)
...
Cohesion: 0.27
Nodes (4): DeepSeekClient, checkRateLimit(), ParseRetryAfter(), TestParseRetryAfter()
...
Cohesion: 0.29
Nodes (7): wireSelectorOrdering(), routerChildNames(), seedSelectorStats(), selectorOrderingTree(), TestGardenerRollbackTool_CallRestoresSnapshot(), TestGardenerRunCycleTool_CallAppliesLearnedSelectorOrdering(), TestWireSelectorOrdering_EnablesLearnedOrderingPass()
...
Cohesion: 0.31
Nodes (5): TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait(), stepContext(), GetPolicy()
...
Cohesion: 0.22
Nodes (9): code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), Package: api, Package: benchmark, Package: knowledge, Package: persona (+1 more)
...
## Knowledge Gaps
- **9445 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+9440 more)
...
- **Why does `Append()` connect `Community 19` to `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 27`, `Community 30`, `Community 33`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 42`, `Community 43`, `Community 45`, `Community 47`, `Community 48`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 56`, `Community 58`, `Community 59`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 67`, `Community 68`, `Community 70`, `Community 71`, `Community 73`, `Community 75`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 100`, `Community 102`, `Community 103`, `Community 110`, `Community 111`, `Community 113`, `Community 120`, `Community 121`, `Community 126`, `Community 127`, `Community 128`, `Community 130`, `Community 133`, `Community 140`, `Community 141`, `Community 143`, `Community 655`, `Community 147`, `Community 148`, `Community 151`, `Community 665`, `Community 674`, `Community 163`, `Community 164`, `Community 169`, `Community 170`, `Community 171`, `Community 176`, `Community 690`, `Community 178`, `Community 183`, `Community 189`, `Community 190`, `Community 192`, `Community 196`, `Community 197`, `Community 198`, `Community 199`, `Community 1224`, `Community 202`, `Community 203`, `Community 206`, `Community 209`, `Community 210`, `Community 211`, `Community 213`, `Community 215`, `Community 224`, `Community 228`, `Community 229`, `Community 1254`, `Community 326`, `Community 849`, `Community 883`, `Community 894`, `Community 908`, `Community 911`, `Community 424`, `Community 937`, `Community 938`, `Community 427`, `Community 428`, `Community 425`, `Community 436`, `Community 437`, `Community 950`, `Community 439`, `Community 440`, `Community 441`, `Community 442`, `Community 444`, `Community 961`, `Community 962`, `Community 452`, `Community 965`, `Community 455`, `Community 458`, `Community 462`, `Community 1000`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 55` to `Community 2`, `Community 131`, `Community 6`, `Community 13`, `Community 14`, `Community 145`, `Community 18`, `Community 913`, `Community 21`, `Community 22`, `Community 25`, `Community 28`, `Community 31`, `Community 33`, `Community 419`, `Community 38`, `Community 40`, `Community 44`, `Community 949`, `Community 53`, `Community 183`, `Community 57`, `Community 58`, `Community 60`, `Community 188`, `Community 64`, `Community 961`, `Community 201`, `Community 82`, `Community 83`, `Community 216`, `Community 987`, `Community 100`, `Community 104`, `Community 111`, `Community 115`, `Community 118`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 40` to `Community 132`, `Community 136`, `Community 10`, `Community 16`, `Community 18`, `Community 148`, `Community 22`, `Community 921`, `Community 25`, `Community 28`, `Community 32`, `Community 161`, `Community 949`, `Community 56`, `Community 58`, `Community 61`, `Community 64`, `Community 74`, `Community 75`, `Community 215`, `Community 223`, `Community 99`, `Community 104`, `Community 106`, `Community 111`, `Community 115`, `Community 118`, `Community 892`?**
...
- **Are the 139 inferred relationships involving `NewKnowledgeGraph()` (e.g. with `TestComputeAnalytics_EmptyGraph()` and `TestComputeAnalytics_Centrality()`) actually correct?**
  _`NewKnowledgeGraph()` has 139 INFERRED edges - model-reasoned connections that need verification._