# Graph Report - superpowers-20260713T024721-1d2ca422-goap-fusion-loop-runner-blackboard-conte  (2026-07-13)

## Corpus Check
- 828 files · ~921,436 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20252 nodes · 31420 edges · 1706 communities (1341 shown, 365 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8185 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7c880701`
...
## Communities (1706 total, 365 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (128): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+120 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (128): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+120 more)
...
Cohesion: 0.04
Nodes (86): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+78 more)
...
Cohesion: 0.03
Nodes (21): Server, History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), mockTTOrch (+13 more)
...
Cohesion: 0.04
Nodes (84): perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree() (+76 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (79): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+71 more)
...
Cohesion: 0.04
Nodes (94): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+86 more)
...
Cohesion: 0.05
Nodes (65): DefaultRetryPolicy(), GetCategory(), GetErrorContext(), NewCategorizedError(), NewErrorContext(), TestCategorizedError_Error(), TestCategorizedError_NilError(), TestCategorizedError_Unwrap() (+57 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (77): TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, NewAgentRouter(), NewDeadLetterQueue(), NewLocalExecutor(), NewRouterFromEndpoints(), TestAgentRouter_AllExecutorsFail(), TestAgentRouter_EmptyHealth() (+69 more)
...
Cohesion: 0.05
Nodes (76): auditKey, bearerPrincipalKey, IPFilterMode, requestIDKey, AuditContext(), AuditMiddleware(), BearerAuthMiddleware(), BearerPrincipal() (+68 more)
...
Cohesion: 0.07
Nodes (71): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), buildClaudeReviewPrompt() (+63 more)
...
Cohesion: 0.05
Nodes (36): FilterByTreeName(), Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, TestHasChildNamed_DeepNested() (+28 more)
...
Cohesion: 0.07
Nodes (53): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_New(), TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents(), TestBuildFromArchetype() (+45 more)

### Community 36 - "Community 36"
Cohesion: 0.07
Nodes (54): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection() (+46 more)

### Community 37 - "Community 37"
Cohesion: 0.03
Nodes (61): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+53 more)
...
Cohesion: 0.09
Nodes (51): main(), TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_PruningOnNodeExplosion(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune() (+43 more)
...
Cohesion: 0.06
Nodes (35): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), ApplyHITLPolicy(), countTreeNodes(), TestSuperpowersPipelineSimulation() (+27 more)
...
Cohesion: 0.06
Nodes (28): handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogin(), handleLogout() (+20 more)
...
Cohesion: 0.07
Nodes (31): AgentMetrics, AgentStats, BuildIdentity, Counter, Gauge, HealthResponse, LabeledCounter, LabeledGauge (+23 more)
...
Cohesion: 0.09
Nodes (24): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports(), RunContext (+16 more)

### Community 59 - "Community 59"
Cohesion: 0.1
Nodes (40): Duration(), TestDuration(), TestNewPopulation_Evolution(), TestPopulation_Diversity(), TestPopulation_StatsAccessors(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation() (+32 more)
...
Cohesion: 0.12
Nodes (33): TestRunSuiteIsSandboxed(), TestNoNewGapsOrImplDegraded_IsFallbackEligibleGuard(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled() (+25 more)
...
Cohesion: 0.11
Nodes (36): ParallelMode, intSliceFromInterface(), BuildReactiveParallel(), childPanicHandler(), forkBlackboard(), intSliceFromInterface(), runReactiveParallel(), evaluateGuardCondition() (+28 more)

### Community 83 - "Community 83"
Cohesion: 0.08
Nodes (26): TestRunOnce_EmitsRunRootSpan(), tracingMiddleware(), TestNestedActionSpansParentCorrectly(), TestPanickingActionRestoresTraceContextAndEndsSpan(), TestRegisteredActionEmitsSpan(), TestRegisteredConditionEmitsSpan(), withRecordingGlobalTracer(), NewTracedLLM() (+18 more)

### Community 84 - "Community 84"
Cohesion: 0.07
Nodes (22): reflectOnOutcomeAction(), TestReflectOnOutcomeAction_NilLLM(), TestReflectOnOutcomeAction_WithMockLLM(), TestStore_CountFailures_MixedRecords(), TestStore_CountFailures_NoFailures(), TestStore_LoadAll_WithSubdirs(), TestStore_NewStore_MkdirAllError(), TestStore_RecentFailures_Ordering() (+14 more)
...
Cohesion: 0.08
Nodes (21): TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), resolveUserTree(), TestWireSelectorReorderIsOptIn(), wireSelectorReorder() (+13 more)
...
Cohesion: 0.12
Nodes (27): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir(), MemoryDir() (+19 more)
...
Cohesion: 0.12
Nodes (26): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestRunJob_WarnsOnDeployDriftAtCycleComplete(), TestRunJob_WebhookIncludesBuildRevision(), NewScheduler(), decodeRunCount(), TestHistory_FileCreated() (+18 more)
...
Cohesion: 0.08
Nodes (20): agentNameFromBB(), init(), registerDelegateNodes(), init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), agentStopReason(), init() (+12 more)
...
Cohesion: 0.08
Nodes (19): alwaysSampler, Attr, neverSampler, noopSpan, noopTracer, Sampler, Span, SpanContext (+11 more)
...
Cohesion: 0.12
Nodes (25): TestOutcomeErrorDetail(), FeedbackFile(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath() (+17 more)
...
Cohesion: 0.09
Nodes (16): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), GardenerRecommendTool, GardenerRunCycleTool, GardenerStatusTool (+8 more)
...
Cohesion: 0.11
Nodes (18): ErrorRecorder, NewOpenAICompatClient(), TestOpenAICompat_ErrorResponse(), TestOpenAICompat_GenerateWithModel_SendsChatCompletion(), OpenAICompatConfig, openAICompatMessage, openAICompatRequest, openAICompatResponse (+10 more)
...
Cohesion: 0.1
Nodes (20): main(), captureExporter, ExportedEvent, ExportedSpan, ConfigureOTLPFromEnv(), firstNonEmpty(), NewOTLPHTTPExporter(), otlpTracePayload() (+12 more)

### Community 150 - "Community 150"
Cohesion: 0.11
Nodes (19): WebhookPublisher, runDLQReplayScanOnce(), TestDLQReplayScanSurvivesPanicAcrossTicks(), TestActionForName_BulkCoverage(), TestSuperpowersTaskVerifyRed_NoTestsFailsWithoutPanic(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), DefaultPanicHandler() (+11 more)

### Community 151 - "Community 151"
Cohesion: 0.12
Nodes (13): AuctionDelegate(), cardWithURL(), newAuctionTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoCandidatesFallsBack(), TestAuctionDelegate_NoEligibleBidsFallsBack(), TestAuctionDelegate_RequiredTagsFilterCandidates() (+5 more)
...
Cohesion: 0.11
Nodes (16): TestRunTask_KnowledgeGap_RoutesToKnowledgePath(), TestStore_CountFailures_MixedRecords(), TestStore_CountFailures_NoFailures(), TestStore_LoadAll_WithSubdirs(), TestStore_NewStore_MkdirAllError(), TestStore_RecentFailures_Ordering(), TestStore_Save_RenameCleanup(), TestStore_Save_WriteError() (+8 more)
...
Cohesion: 0.2
Nodes (23): NewGoalQueue(), NewGoalQueueFrom(), names(), names2(), TestGoalIsSatisfied(), TestGoalQueueAddAndSelect(), TestGoalQueueAddReplace(), TestGoalQueueAll() (+15 more)

### Community 158 - "Community 158"
Cohesion: 0.11
Nodes (7): automationAgentName(), ApprovalPolicy, TestSanitizeUserID(), Profile, SanitizeUserID(), Store, Workspace
...
Cohesion: 0.11
Nodes (16): BuildTaskFromInputs(), ParseInputParams(), TestBuildTaskFromInputs(), TestParseInputParams(), TestValidateInputs_Default(), TestValidateInputs_File(), TestValidateInputs_JSON(), TestValidateInputs_Required() (+8 more)
...
Cohesion: 0.16
Nodes (16): handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus() (+8 more)
...
Cohesion: 0.16
Nodes (14): NewFallbackLLM(), TestFallbackLLM_GenerateAllPanicReturnsAggregatedError(), TestFallbackLLM_GenerateRecoversPanicAndTriesNextModel(), TestFallbackLLM_GenerateReturnsAllFailures(), TestFallbackLLM_GenerateUsesNextModelAfterPrimaryFailure(), TestNewProvider_BuildsFallbackChainFromConfiguredModels(), fallbackSpec, buildProvider() (+6 more)
...
Cohesion: 0.19
Nodes (18): TestSelectorOptimizer_KillerChild(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing(), TestLocalSearch_TabuSearch() (+10 more)
...
Cohesion: 0.16
Nodes (10): copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), DefaultRebuildTargets(), NewRebuildBackoff(), RebuildBinaries(), resolveGoBinary(), TestRebuildBinaries() (+2 more)
...
Cohesion: 0.12
Nodes (9): builtinBlocks(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), PlanBlock(), QualityGateBlock() (+1 more)
...
Cohesion: 0.24
Nodes (12): recordUserFeedback(), registerFeedbackTools(), newFeedbackDeps(), TestBTFeedbackRegistered(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), TestRecordUserFeedback_FeedsSatisfactionAndFlags(), TestRecordUserFeedback_RejectsBadInput(), TestRecordUserFeedback_TrimsUserAndTreeID() (+4 more)
...
Cohesion: 0.25
Nodes (12): allDigits(), consecutiveFailures(), diagnoseFailureMode(), getLatestTimestamp(), groupByTreeName(), inferAgentName(), init(), registerBTManagerActions() (+4 more)
...
Cohesion: 0.15
Nodes (8): TestConfig_AllFields(), TestCreateAgentTool_Call_NilFactory(), TestEvolvedAgent_Run_Error(), TestMockModel_SatisfiesInterface(), TestNewEvolvedAgent_MinimalConfig(), TestNewEvolvedAgent_NilBlackboard(), mockModelCorrect, mockModelError
...
Cohesion: 0.27
Nodes (8): Histogram, RecordTask(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered(), TestBlockDurationHistogramSeriesRendered(), TestKGAnalyticsGaugesRenderedAndUpdated(), TestNodeDurationHistogramSeriesRendered(), TestPrometheusBuildInfoGaugeRenderedAndReplaced()
...
Cohesion: 0.18
Nodes (11): code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), Package: log, Package: persistence (+3 more)
...
Cohesion: 0.27
Nodes (8): NewEvolvedAgent(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestNewEvolvedAgent_AllToolsRegistered(), newConfig(), TestNewEvolvedAgent(), mockModel
...
## Knowledge Gaps
- **6610 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6605 more)
...
- **Why does `Append()` connect `Community 6` to `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 524`, `Community 13`, `Community 525`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 533`, `Community 536`, `Community 24`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 540`, `Community 32`, `Community 547`, `Community 548`, `Community 549`, `Community 38`, `Community 36`, `Community 552`, `Community 40`, `Community 41`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 57`, `Community 58`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 66`, `Community 67`, `Community 69`, `Community 71`, `Community 72`, `Community 74`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 85`, `Community 86`, `Community 87`, `Community 89`, `Community 90`, `Community 91`, `Community 93`, `Community 94`, `Community 99`, `Community 100`, `Community 101`, `Community 107`, `Community 108`, `Community 109`, `Community 115`, `Community 116`, `Community 117`, `Community 118`, `Community 121`, `Community 122`, `Community 125`, `Community 126`, `Community 127`, `Community 133`, `Community 134`, `Community 136`, `Community 137`, `Community 146`, `Community 149`, `Community 152`, `Community 153`, `Community 161`, `Community 164`, `Community 167`, `Community 173`, `Community 174`, `Community 175`, `Community 176`, `Community 179`, `Community 180`, `Community 695`, `Community 697`, `Community 698`, `Community 185`, `Community 700`, `Community 190`, `Community 191`, `Community 195`, `Community 196`, `Community 198`, `Community 199`, `Community 206`, `Community 722`, `Community 211`, `Community 723`, `Community 743`, `Community 744`, `Community 747`, `Community 749`, `Community 759`, `Community 769`, `Community 787`, `Community 349`, `Community 350`, `Community 351`, `Community 352`, `Community 358`, `Community 363`, `Community 365`, `Community 366`, `Community 368`, `Community 369`, `Community 370`, `Community 379`, `Community 385`, `Community 387`, `Community 388`, `Community 390`, `Community 950`, `Community 952`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 36` to `Community 129`, `Community 2`, `Community 771`, `Community 6`, `Community 392`, `Community 9`, `Community 140`, `Community 13`, `Community 12`, `Community 21`, `Community 27`, `Community 159`, `Community 1055`, `Community 35`, `Community 164`, `Community 40`, `Community 179`, `Community 52`, `Community 54`, `Community 55`, `Community 185`, `Community 58`, `Community 57`, `Community 59`, `Community 67`, `Community 200`, `Community 202`, `Community 75`, `Community 74`, `Community 345`, `Community 993`, `Community 107`, `Community 108`, `Community 109`, `Community 367`, `Community 113`, `Community 115`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 129` to `Community 2`, `Community 131`, `Community 4`, `Community 12`, `Community 140`, `Community 143`, `Community 16`, `Community 17`, `Community 149`, `Community 150`, `Community 154`, `Community 27`, `Community 29`, `Community 163`, `Community 36`, `Community 38`, `Community 40`, `Community 169`, `Community 555`, `Community 43`, `Community 48`, `Community 55`, `Community 185`, `Community 58`, `Community 59`, `Community 191`, `Community 715`, `Community 83`, `Community 84`, `Community 346`, `Community 347`, `Community 359`, `Community 362`, `Community 107`, `Community 108`, `Community 113`, `Community 114`?**
...
- **Are the 122 inferred relationships involving `NewRequest()` (e.g. with `TestHITLHandlers_PendingApproveReject()` and `WorkflowApprovalWait()`) actually correct?**
  _`NewRequest()` has 122 INFERRED edges - model-reasoned connections that need verification._