...
## Corpus Check
- 333 files · ~393,240 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5725 nodes · 10723 edges · 279 communities (246 shown, 33 thin omitted)
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 3488 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9e660cef`
...
## Communities (279 total, 33 thin omitted)
...
Cohesion: 0.05
Nodes (60): AgentDefinition, ContentType, Schema, MustParseAgentDefinition(), numberIn(), numberValue(), ParseAgentDefinition(), stringIn() (+52 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (59): main(), main(), DefaultCascadeConfig(), NewTranspositionTable(), perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard() (+51 more)
...
Cohesion: 0.04
Nodes (33): stringContains(), TestBuildGoapStepPrompt(), execRefineAction(), NewEngine(), RegisterProviders(), TestAction_ExecuteGoapStep_PastEnd(), TestAction_GoapFallback(), TestAction_PlanGoapActions_EmptyActions() (+25 more)
...
Cohesion: 0.08
Nodes (40): DeepeningResult, makeRecords(), TestCloneTree_Independent(), TestEvaluateTree_AllFailures(), TestEvaluateTree_EmptyRecords(), TestEvaluateTree_GoDevVsDefault(), TestEvaluateTree_Mixed(), TestEvaluateTree_NodeCountPenalty() (+32 more)
...
Cohesion: 0.09
Nodes (34): ArraySchema(), IntSchema(), ObjectSchema(), ResponseValidator(), TestResponseValidator_DriftLogging(), TestResponseValidator_Enforcement_DisabledByDefault(), TestResponseValidator_Enforcement_EnforcesOnViolation(), TestResponseValidator_Enforcement_ErrorBodyIsValidJSON() (+26 more)

### Community 25 - "Community 25"
Cohesion: 0.11
Nodes (41): TestBlackboard_AllFields(), TestTree_SerializeRoundtrip(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+33 more)
...
Cohesion: 0.07
Nodes (36): applyDotEnvFiles(), applyDotEnvToConfig(), applyEnvOverrides(), envBool(), hasExplicitField(), Load(), LoadDotEnv(), LoadFile() (+28 more)
...
Cohesion: 0.09
Nodes (24): DefaultRetryPolicy(), NewCategorizedError(), TestCategorizedError_Error(), TestCategorizedError_NilError(), TestCategorizedError_Unwrap(), TestClassifyError_CategorizedChain(), TestRetryPolicy_CategorizedError_NotRetryable(), TestRetryPolicy_CategorizedError_Retryable() (+16 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (36): Binaries, code:go (type Counter struct { ... }), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {) (+28 more)
...
Cohesion: 0.09
Nodes (27): AntiPattern, countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestNewPopulation_Evolution() (+19 more)
...
Cohesion: 0.09
Nodes (22): BenchEvalFunc, countConditionsActions(), maxTreeDepthEval(), NewCascadeEvaluator(), StructuralQuickEval(), buildDeepTree(), buildOptimalTree(), itoaTest() (+14 more)

### Community 55 - "Community 55"
Cohesion: 0.09
Nodes (29): DefaultLLM(), TestBuiltinSWELite_CoverageAndUniqueness(), TestMax1(), benchmarkPlanTree(), TestBuiltinBFCLSuitesHaveStableShape(), TestGAIABuiltinAndEvaluation(), BFCLEntry, BFCLEvalResult (+21 more)
...
Cohesion: 0.08
Nodes (24): init(), ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, TestRegisterAction_And_GetAction(), TestRegisterCondition_And_GetCondition() (+16 more)
...
Cohesion: 0.1
Nodes (27): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AnnotateMetrics(), BootstrapCI(), containsStr(), DevOpsSuite() (+19 more)
...
Cohesion: 0.19
Nodes (24): handleTreeStructure(), TestIntegration_AllTreesExecute(), runTeslaTree(), TestTeslaEarnings(), TestTeslaMarket(), TestTeslaModel(), TestTeslaPitchAgent(), TestTeslaValuation() (+16 more)
...
Cohesion: 0.12
Nodes (20): collectNames(), contains(), TestBuildTree_Minimal(), TestBuildTree_UnknownType(), TestOutcome_EmptyTaskFails(), TestOutcome_Success(), TestRouting_CodeReview(), TestRouting_Finance() (+12 more)

### Community 85 - "Community 85"
Cohesion: 0.14
Nodes (21): TestApplyMutations_Batch(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter(), TestMutation_AddBefore(), TestMutation_AddFallback(), TestMutation_IncreaseRetries(), TestMutation_PruneNode() (+13 more)
...
Cohesion: 0.11
Nodes (19): DeprecationHeader, BoolSchema(), DeprecatedHandler(), DeprecatedHandlerFunc(), NumberSchema(), TestConvenienceSchemaConstructors(), TestDeprecatedHandler_WithoutSunset(), TestDeprecatedHandler_WithSunset() (+11 more)
...
Cohesion: 0.12
Nodes (14): main(), IPFilter, RateLimiter, NewRateLimiter(), RateLimitMiddleware(), SanitizeMiddleware(), sanitizeString(), TestRateLimiter_Basic() (+6 more)
...
Cohesion: 0.18
Nodes (16): NewEvolvedAgent(), TestConfig_AllFields(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestNewEvolvedAgent_AllToolsRegistered(), TestNewEvolvedAgent_MinimalConfig() (+8 more)
...
Cohesion: 0.12
Nodes (18): handleLogin(), handleLogout(), auditKey, bearerPrincipalKey, IPFilterMode, requestIDKey, AuditContext(), AuditMiddleware() (+10 more)

### Community 120 - "Community 120"
Cohesion: 0.15
Nodes (9): TestPlanMultiple(), TestValidatePlan(), TestValidatePlanNilEmptyAndFinalStateFailure(), Planner, PlanMultiple(), ValidatePlan(), plannerNode, plannerNodeHeap (+1 more)
...
Cohesion: 0.18
Nodes (6): TestCheckConfidence_ConditionExists(), max(), randomMutation(), LocalSearcher, ApplyMutations(), Population

### Community 130 - "Community 130"
Cohesion: 0.13
Nodes (11): main(), BTStudioCompany(), main(), min(), TestTeslaFullAnalysis(), main(), main(), TestDefaultConfig() (+3 more)
...
Cohesion: 0.2
Nodes (8): Individual, cloneTree(), collectNodeNames(), Crossover(), maxTreeDepth(), randomNodeName(), QTable, ReinforcementLearner
...
Cohesion: 0.33
Nodes (5): TestIntegration_AllChainTypes(), TestIntegration_MutationOperators(), TestIntegration_PanicRecovery(), TestIntegration_QualityGatesFullFlow(), TestIntegration_ReflectionAndPersistence()
...
Cohesion: 0.5
Nodes (4): TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), validateNode(), ValidateTree()
...
- **Why does `BuildTree()` connect `Community 11` to `Community 130`, `Community 2`, `Community 262`, `Community 7`, `Community 140`, `Community 16`, `Community 146`, `Community 150`, `Community 25`, `Community 28`, `Community 34`, `Community 167`, `Community 179`, `Community 55`, `Community 61`, `Community 190`, `Community 63`, `Community 66`, `Community 194`, `Community 72`, `Community 201`, `Community 84`, `Community 88`, `Community 89`, `Community 230`, `Community 108`, `Community 114`?**
  _High betweenness centrality (0.219) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 113` to `Community 130`, `Community 5`, `Community 262`, `Community 9`, `Community 14`, `Community 24`, `Community 27`, `Community 158`, `Community 35`, `Community 38`, `Community 51`, `Community 181`, `Community 60`, `Community 189`, `Community 67`, `Community 96`, `Community 97`, `Community 100`, `Community 112`, `Community 127`?**
  _High betweenness centrality (0.185) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 179` to `Community 128`, `Community 3`, `Community 262`, `Community 9`, `Community 11`, `Community 16`, `Community 18`, `Community 19`, `Community 25`, `Community 155`, `Community 28`, `Community 158`, `Community 32`, `Community 47`, `Community 181`, `Community 59`, `Community 201`, `Community 100`, `Community 110`, `Community 114`, `Community 127`?**
