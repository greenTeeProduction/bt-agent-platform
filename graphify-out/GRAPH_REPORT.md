# Graph Report - superpowers-20260716T004023-c1dd1087-goap-fusion-loop-runner-blackboard-conte  (2026-07-16)

## Corpus Check
- 877 files · ~1,058,444 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23498 nodes · 35551 edges · 1886 communities (1515 shown, 371 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8836 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `635691c2`
...
5. `registerMCPTools()` - 129 edges
6. `arc42 Section 9 — Architecture Decisions` - 124 edges
...
## Communities (1886 total, 371 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (174): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+166 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (174): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+166 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (142): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+134 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (115): expandChainStateTemplates(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM(), TestChainAction_Agent_NoTools() (+107 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (118): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+110 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (124): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+116 more)
...
Cohesion: 0.04
Nodes (98): TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), perTreeStats(), setupGardener(), TestEvolveTree_BloatGuard() (+90 more)
...
Cohesion: 0.04
Nodes (82): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle(), ComposePreset() (+74 more)
...
Cohesion: 0.05
Nodes (80): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), TestIsGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation() (+72 more)
...
Cohesion: 0.05
Nodes (84): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes() (+76 more)
...
Cohesion: 0.06
Nodes (66): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoTestTool_Structure() (+58 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (28): Server, AgentMetric, Alert, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts() (+20 more)
...
Cohesion: 0.05
Nodes (57): main(), main(), SetAsDefault(), TestBlackboard_AllFields(), TestTree_SerializeRoundtrip(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior() (+49 more)
...
Cohesion: 0.06
Nodes (68): buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), defaultNlmGrillAuthGuard(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), registerSuperpowersProductionActions() (+60 more)
...
Cohesion: 0.13
Nodes (57): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+49 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (49): attachLogHandler(), buildBaseHandler(), buildLogger(), Debug(), envLogLevel(), Error(), Init(), L() (+41 more)
...
Cohesion: 0.06
Nodes (59): ChainConfig, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), buildMapReduceFallback(), buildToolList(), execAgent() (+51 more)
...
Cohesion: 0.07
Nodes (48): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+40 more)

### Community 43 - "Community 43"
Cohesion: 0.07
Nodes (55): TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), collapseToSingleLine(), completeGoapProgramMilestone(), extractGoapResearchGoals(), fallbackGoapGoal(), goapFusionNotebookLMGoalsFromGaps(), goapResearchGapLines() (+47 more)
...
Cohesion: 0.05
Nodes (36): agentExecuteResult(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay() (+28 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (47): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), newGrillLoopTestRun() (+39 more)

### Community 47 - "Community 47"
Cohesion: 0.08
Nodes (21): extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), collectNodeNames(), containsCrisisReason(), Crossover(), ExperienceRetrievalHits() (+13 more)

### Community 48 - "Community 48"
Cohesion: 0.11
Nodes (45): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+37 more)

### Community 49 - "Community 49"
Cohesion: 0.08
Nodes (46): Config, EvolvedAgent, buildEvolvedPrompt(), NewEvolvedAgent(), toolDescriptions(), toolNames(), saveRecordWithDelay(), TestBuildEvolvedPrompt() (+38 more)
...
Cohesion: 0.06
Nodes (42): min(), brokenTool, ChainKind, BuildChainAction(), buildChainActionFn(), execLLMCall(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic() (+34 more)
...
Cohesion: 0.06
Nodes (29): TestRunOnce_EmitsRunRootSpan(), fanoutHandler, logExportTarget(), newTraceContextHandler(), TestInitLogExport_Idempotent(), TestLogExportTarget(), TestTraceContextHandler_InjectsTraceIDs(), traceContextHandler (+21 more)
...
Cohesion: 0.08
Nodes (46): Duration(), TestDuration(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes() (+38 more)
...
Cohesion: 0.11
Nodes (36): TestRunSuiteIsSandboxed(), TestNoNewGapsOrImplDegraded_IsFallbackEligibleGuard(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled() (+28 more)
...
Cohesion: 0.07
Nodes (37): countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New() (+29 more)
...
Cohesion: 0.06
Nodes (16): TestActionForName_BulkCoverage(), TestSuperpowersTaskVerifyRed_NoTestsFailsWithoutPanic(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), DefaultPanicHandler(), Recover(), SafeGo(), TestRecover_CatchesPanic() (+8 more)

### Community 99 - "Community 99"
Cohesion: 0.07
Nodes (22): exportMemoryCategory(), exportPreviousRuns(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), ResolvePipelineAgent(), TestValidateQualitySpec_BlockedPattern(), TestValidateQualitySpec_MinLength() (+14 more)
...
Cohesion: 0.08
Nodes (28): Block, TestComposeAndExpand(), Category, ComposeSpec, TestExpand_BlockMetadata(), Expand(), expandNode(), HasSubTreeRefs() (+20 more)
...
Cohesion: 0.09
Nodes (24): RegistryDir(), SchedulerJobsFile(), TestRemoveAgentJobs(), TestResolvePipelineAgent_Aliases(), TestApplySchedule_PersistsRegistryAndJobs(), TestDeleteRegisteredAgent(), TestScheduler_SyncFromRegistry_UpdatesChangedSchedule(), ApplySchedule() (+16 more)
...
Cohesion: 0.15
Nodes (17): ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), ApplyBlockMutations(), blockIDFromOp(), collectNames() (+9 more)
...
Cohesion: 0.18
Nodes (15): apiFetch(), getCookie(), cbIcon(), createAgent(), deleteAgent(), loadAgents(), renderAgents(), runAgent() (+7 more)
...
Cohesion: 0.19
Nodes (15): NewEvolvedAgent(), TestConfig_AllFields(), TestCreateAgentTool_Call_NilFactory(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestNewEvolvedAgent_AllToolsRegistered() (+7 more)
...
Cohesion: 0.17
Nodes (9): TestRunTaskTool_Call(), TestToolNames_And_Descriptions(), GetReflectionsTool, RunTaskTool, NewCreateAgentTool(), NewFitnessTool(), NewGetTreeTool(), NewRunTaskTool() (+1 more)
...
Cohesion: 0.31
Nodes (10): fakeClaude, fakeCommitRunner, fail(), newAutofixRun(), newFakeCommitRunner(), TestClassifyHookFailure(), TestCommitAutoFix_ClaudeFixesTest(), TestCommitAutoFix_DeterministicGofmt() (+2 more)
...
Cohesion: 0.33
Nodes (9): autofixScriptRunner, autofixScriptStep, autofixVerifyRun(), TestChangedPackagesLintFixCommandInsertsFixFlag(), TestVerifySuperpowersRunAutofixesLintOnlyFailure(), TestVerifySuperpowersRunDoesNotAutofixNonLintFailures(), TestVerifySuperpowersRunLintAutofixFailureIsFinal(), verificationTrail() (+1 more)
...
## Knowledge Gaps
- **8536 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8531 more)
...
- **Why does `Append()` connect `Community 21` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 28`, `Community 30`, `Community 32`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 40`, `Community 44`, `Community 45`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 63`, `Community 64`, `Community 66`, `Community 68`, `Community 69`, `Community 70`, `Community 72`, `Community 74`, `Community 76`, `Community 78`, `Community 79`, `Community 80`, `Community 82`, `Community 83`, `Community 85`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 92`, `Community 93`, `Community 607`, `Community 96`, `Community 97`, `Community 609`, `Community 99`, `Community 100`, `Community 101`, `Community 103`, `Community 104`, `Community 105`, `Community 106`, `Community 109`, `Community 625`, `Community 626`, `Community 115`, `Community 116`, `Community 119`, `Community 633`, `Community 122`, `Community 126`, `Community 641`, `Community 129`, `Community 643`, `Community 132`, `Community 130`, `Community 646`, `Community 1159`, `Community 135`, `Community 138`, `Community 139`, `Community 140`, `Community 141`, `Community 147`, `Community 148`, `Community 149`, `Community 159`, `Community 161`, `Community 165`, `Community 166`, `Community 169`, `Community 176`, `Community 178`, `Community 188`, `Community 190`, `Community 192`, `Community 196`, `Community 197`, `Community 198`, `Community 200`, `Community 203`, `Community 205`, `Community 206`, `Community 211`, `Community 212`, `Community 827`, `Community 836`, `Community 848`, `Community 868`, `Community 869`, `Community 872`, `Community 873`, `Community 880`, `Community 886`, `Community 391`, `Community 392`, `Community 393`, `Community 401`, `Community 914`, `Community 410`, `Community 411`, `Community 415`, `Community 416`, `Community 418`, `Community 425`, `Community 429`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 94` to `Community 128`, `Community 130`, `Community 3`, `Community 4`, `Community 389`, `Community 6`, `Community 11`, `Community 908`, `Community 14`, `Community 15`, `Community 17`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 31`, `Community 34`, `Community 41`, `Community 42`, `Community 177`, `Community 51`, `Community 59`, `Community 189`, `Community 190`, `Community 61`, `Community 65`, `Community 66`, `Community 67`, `Community 196`, `Community 201`, `Community 207`, `Community 82`, `Community 84`, `Community 853`, `Community 95`, `Community 98`, `Community 872`, `Community 111`, `Community 119`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 17` to `Community 130`, `Community 3`, `Community 4`, `Community 11`, `Community 396`, `Community 18`, `Community 21`, `Community 150`, `Community 24`, `Community 31`, `Community 32`, `Community 164`, `Community 42`, `Community 47`, `Community 48`, `Community 51`, `Community 54`, `Community 185`, `Community 59`, `Community 193`, `Community 66`, `Community 68`, `Community 69`, `Community 75`, `Community 76`, `Community 78`, `Community 207`, `Community 79`, `Community 82`, `Community 1235`, `Community 212`, `Community 94`, `Community 96`, `Community 100`, `Community 106`, `Community 113`, `Community 119`, `Community 122`?**
