# Graph Report - superpowers-20260715T093310-d423f5f5-goap-fusion-loop-runner-blackboard-conte  (2026-07-15)

## Corpus Check
- 858 files · ~1,017,404 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22646 nodes · 34447 edges · 1839 communities (1477 shown, 362 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8661 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8f1235fa`
...
## Communities (1839 total, 362 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (162): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+154 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (162): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+154 more)
...
Cohesion: 0.02
Nodes (36): Server, AgentMetric, AlertReport, Catalog, extractYAMLField(), inferTree(), splitTags(), CatalogEntry (+28 more)
...
Cohesion: 0.04
Nodes (78): alwaysSampler, Attr, fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe() (+70 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (79): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), buildChainActionFn() (+71 more)
...
Cohesion: 0.04
Nodes (82): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+74 more)
...
Cohesion: 0.04
Nodes (69): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), Entry, NewHandle(), Limits (+61 more)
...
Cohesion: 0.05
Nodes (42): TestCheckConfidence_ConditionExists(), TestNewPopulation_Evolution(), TestPopulation_Diversity(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes() (+34 more)
...
Cohesion: 0.05
Nodes (71): LoadPipeline(), RunPipeline(), RunPipelineWithID(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext() (+63 more)
...
Cohesion: 0.06
Nodes (57): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), nlmQuotaExhausted(), nlmQuotaExhaustedUntil(), TestNlmQuotaState_EmptyAndGarbageNotExhausted(), TestNlmQuotaState_ExpiredWindowNotExhausted(), extractConversationID() (+49 more)
...
Cohesion: 0.05
Nodes (49): TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath(), TestDiscardWorktree_RemovesWorktreeAndDeletesBranch(), TestPushBranchAndCreatePR_InvokesGitPushAndGhPr(), withSwappedSuperpowersRunners(), newGrillLoopTestRun() (+41 more)

### Community 42 - "Community 42"
Cohesion: 0.11
Nodes (46): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Finance(), TestRouting_Research() (+38 more)
...
Cohesion: 0.06
Nodes (32): ApplyParameters(), cholesky(), collectParams(), ExtractParameters(), invertCholesky(), itoa(), multiplyCholesky(), navigateToPath() (+24 more)
...
Cohesion: 0.09
Nodes (39): ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree(), resolveTreeForUser(), TestResolveTreeID_FusionAliases(), HermesObsidianOptimizerTree() (+31 more)
...
Cohesion: 0.08
Nodes (49): Duration(), TestDuration(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes() (+41 more)
...
Cohesion: 0.07
Nodes (33): AgentMetrics, AgentStats, BuildIdentity, HealthResponse, Histogram, LabeledCounter, LabeledGauge, LabeledHistogram (+25 more)
...
Cohesion: 0.08
Nodes (39): TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), LogsDir() (+31 more)

### Community 65 - "Community 65"
Cohesion: 0.1
Nodes (41): isGoapNotebookLMFailure(), extractTaskID(), init(), nlmAuthNeedsRefresh(), nlmAuthUnhealthy(), registerNotebookLMActions(), writeString(), deriveNotebookLMResearchQuery() (+33 more)
...
Cohesion: 0.06
Nodes (34): BuildBudget(), budgetCmd, BuildCachedCondition(), BuildChainAction(), parseChainConfig(), TestChainAction_ParseConfig(), BuildCircuitBreaker(), BuildInverter() (+26 more)
...
Cohesion: 0.09
Nodes (33): ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Compose(), ComposeFromRefs(), ComposeTaskTree() (+25 more)
...
Cohesion: 0.08
Nodes (29): FileJobStore, JobStore, NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad(), TestScheduler_NoJobStore_NilSafe() (+21 more)
...
Cohesion: 0.08
Nodes (33): Binaries, code:go (type Counter struct { ... }), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {) (+25 more)
...
Cohesion: 0.09
Nodes (29): init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), TestParseSplitOutput(), validateDesignAction(), validateDesignHeadings(), fakeGrillClaude, grillAnswerers (+21 more)
...
Cohesion: 0.12
Nodes (29): BehavioralDescriptor, FeatureDimension, Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid(), NewMAPElitesPopulation(), cellFitnesses(), insertPersistNiche() (+21 more)
...
Cohesion: 0.13
Nodes (12): FitnessDimension, MultiFitness, MultiIndividual, cappedIndividuals(), clampScore(), countActions(), countConditions(), StructuralMultiFitness() (+4 more)
...
Cohesion: 0.12
Nodes (16): NewRunDeps(), TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree() (+8 more)
...
Cohesion: 0.11
Nodes (18): TestComposeAndExpand(), TestExpand_BlockMetadata(), Expand(), expandNode(), HasSubTreeRefs(), init(), annotateBlockSource(), traceBlockOp() (+10 more)

### Community 180 - "Community 180"
Cohesion: 0.11
Nodes (17): Block, Category, composeOrderedWithMiddle(), ComposePreset(), ComposePresetWithTools(), PipelineWithToolsProfile(), profileOrDefault(), sliceContains() (+9 more)
...
Cohesion: 0.18
Nodes (18): TestBTOptimizer_New(), TestDTAnalyzer_New(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), NewBTOptimizer(), NewDTAnalyzer(), pathStat() (+10 more)
...
Cohesion: 0.19
Nodes (12): handleSprintExecute(), handleTaskCreate(), syncWorkflowTaskStatus(), TestHandleSprintExecute_UpdatesCurrentWorkflow(), isAuctionShapedTask(), PickTreeForTask(), ResolveAgentName(), TestPickTreeForTask_AuctionRoutingBeatsKnowledgeGraph() (+4 more)
...
Cohesion: 0.29
Nodes (10): TestLocalSearcher_New(), TestLocalSearchMutableParamsAndTabu(), extractMutableParams(), getFloatMeta(), NewLocalSearcher(), setFloatMeta(), toFloat64(), LocalSearchStrategy (+2 more)
...
Cohesion: 0.17
Nodes (12): code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), Package: a2a, Package: log (+4 more)
...
## Knowledge Gaps
- **8047 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8042 more)
...
- **Why does `Append()` connect `Community 6` to `Community 513`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 9`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 26`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 38`, `Community 42`, `Community 43`, `Community 46`, `Community 47`, `Community 49`, `Community 50`, `Community 51`, `Community 54`, `Community 55`, `Community 59`, `Community 60`, `Community 1085`, `Community 1086`, `Community 61`, `Community 63`, `Community 65`, `Community 62`, `Community 67`, `Community 68`, `Community 70`, `Community 71`, `Community 72`, `Community 585`, `Community 74`, `Community 586`, `Community 75`, `Community 588`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 593`, `Community 82`, `Community 83`, `Community 85`, `Community 595`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 603`, `Community 93`, `Community 92`, `Community 95`, `Community 96`, `Community 97`, `Community 98`, `Community 613`, `Community 101`, `Community 616`, `Community 104`, `Community 106`, `Community 107`, `Community 618`, `Community 110`, `Community 116`, `Community 122`, `Community 123`, `Community 125`, `Community 128`, `Community 136`, `Community 137`, `Community 140`, `Community 143`, `Community 147`, `Community 148`, `Community 160`, `Community 161`, `Community 162`, `Community 169`, `Community 170`, `Community 173`, `Community 176`, `Community 177`, `Community 179`, `Community 180`, `Community 181`, `Community 182`, `Community 183`, `Community 187`, `Community 188`, `Community 189`, `Community 193`, `Community 196`, `Community 199`, `Community 203`, `Community 205`, `Community 213`, `Community 214`, `Community 216`, `Community 794`, `Community 800`, `Community 801`, `Community 803`, `Community 820`, `Community 821`, `Community 822`, `Community 826`, `Community 827`, `Community 839`, `Community 841`, `Community 843`, `Community 847`, `Community 385`, `Community 386`, `Community 387`, `Community 393`, `Community 396`, `Community 405`, `Community 407`, `Community 408`, `Community 411`, `Community 416`, `Community 418`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 64` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 134`, `Community 13`, `Community 15`, `Community 20`, `Community 24`, `Community 25`, `Community 155`, `Community 32`, `Community 39`, `Community 40`, `Community 46`, `Community 817`, `Community 52`, `Community 181`, `Community 54`, `Community 55`, `Community 56`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 69`, `Community 197`, `Community 203`, `Community 77`, `Community 206`, `Community 89`, `Community 217`, `Community 105`, `Community 882`, `Community 126`, `Community 383`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 24` to `Community 513`, `Community 2`, `Community 130`, `Community 3`, `Community 6`, `Community 138`, `Community 142`, `Community 17`, `Community 22`, `Community 407`, `Community 25`, `Community 164`, `Community 40`, `Community 42`, `Community 43`, `Community 173`, `Community 47`, `Community 54`, `Community 55`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 64`, `Community 66`, `Community 70`, `Community 206`, `Community 207`, `Community 82`, `Community 85`, `Community 89`, `Community 102`, `Community 106`, `Community 123`, `Community 382`?**
