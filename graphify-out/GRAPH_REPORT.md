...
## Corpus Check
- 338 files · ~402,361 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5812 nodes · 10890 edges · 279 communities (247 shown, 32 thin omitted)
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 3562 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a2a1e00d`
...
## Communities (279 total, 32 thin omitted)
...
Cohesion: 0.04
Nodes (40): stringContains(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_PlanGoapActions_NoPlanFound(), execRefineAction(), generatePlanAction(), NewEngine(), reflectOnOutcomeAction(), RegisterProviders() (+32 more)
...
Cohesion: 0.08
Nodes (44): main(), DeepeningResult, makeRecords(), TestCloneTree_Independent(), TestEvaluateTree_AllFailures(), TestEvaluateTree_EmptyRecords(), TestEvaluateTree_GoDevVsDefault(), TestEvaluateTree_Mixed() (+36 more)
...
Cohesion: 0.07
Nodes (32): HTTPMethod, collectViolations(), fieldPath(), findResponse(), NewRouteIndex(), pathOrRoot(), ResponseValidator(), routeKey() (+24 more)
...
Cohesion: 0.1
Nodes (28): DefaultTree(), extractTreeType(), jaccardSimilarity(), NewExperienceBank(), parseFloat(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), TestAddFromMutation_MultipleTreeTypes() (+20 more)
...
Cohesion: 0.09
Nodes (36): cloneTreeForGardener(), DefaultEvolveV2Config(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), TestCloneTreeForGardener_Basic(), TestCloneTreeForGardener_DoubleNested(), TestCloneTreeForGardener_Nil() (+28 more)
...
Cohesion: 0.1
Nodes (35): TestConsoleTracer_ExporterReceivesCompletedSpan(), AlwaysSample(), NeverSample(), NewRatioSampler(), SpanFromContext(), StringAttr(), TestAlwaysSample(), TestConsoleTracer_BasicSpan() (+27 more)

### Community 36 - "Community 36"
Cohesion: 0.1
Nodes (23): BTOptimizer, TestBTOptimizer_New(), collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), isDefaultPath(), NewBTOptimizer() (+15 more)
...
Cohesion: 0.05
Nodes (36): Binaries, code:go (type Counter struct { ... }), code:go (type Suite struct {), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }) (+28 more)

### Community 39 - "Community 39"
Cohesion: 0.13
Nodes (35): NewOpenAPIGenerator(), NewRoute(), schemaToMap(), StringSchema(), mapKeys(), TestDashboardRoutes_AllHaveOperationIDs(), TestDashboardRoutes_AllRoutesBuildWithoutPanic(), TestDashboardRoutes_AuthConsistency() (+27 more)
...
Cohesion: 0.08
Nodes (31): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AnnotateMetrics(), BootstrapCI(), cloneTree(), CodeReviewSuite() (+23 more)

### Community 54 - "Community 54"
Cohesion: 0.14
Nodes (31): cohensD(), fishersExact(), GoDevSuite(), minF(), QuickValidate(), RunABTest(), ScoreMutation(), mathAbs() (+23 more)
...
Cohesion: 0.11
Nodes (30): ArraySchema(), BoolSchema(), IntSchema(), NumberSchema(), ObjectSchema(), TestConvenienceSchemaConstructors(), TestOpenAPIGenerator_Parameters(), TestOpenAPIGenerator_RequestBody() (+22 more)
...
Cohesion: 0.14
Nodes (24): MultiNodeProbeConfig, MultiNodeProbeReport, NodeProbeStatus, appendErr(), executeProbeTask(), getJSON(), ProbeMultiNodeDashboard(), probeNode() (+16 more)
...
Cohesion: 0.13
Nodes (7): NewRedisPriorityQueue(), NewRedisQueue(), redisID(), RedisPriorityQueue, RedisQueue, RemoteExecutor, RemoteExecutorConfig

### Community 86 - "Community 86"
Cohesion: 0.13
Nodes (18): AntiPattern, TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_RecommendMutations(), DesignPattern, TestExpert_MatchPattern(), containsStr(), coreHeuristics(), hasNodeMatching() (+10 more)
...
Cohesion: 0.13
Nodes (16): countTreeNodes(), TestDTAnalyzer_New(), TestExpertKnowledge_New(), TestExpertKnowledge_ValidateArchetype(), TestNewPopulation_Evolution(), TestNewQTable(), TestNewReinforcementLearner(), TestPopulation_Diversity() (+8 more)
...
Cohesion: 0.17
Nodes (10): TestCrossover_Single(), Individual, cloneTree(), collectNodeNames(), Crossover(), hashTree(), max(), randomMutation() (+2 more)
...
Cohesion: 0.24
Nodes (15): DefaultMock(), TestMockLLM_GenerateWithTimeout(), singleTaskSuite(), tasksForTree(), TestAgentMonitor(), TestAllDomainTrees(), TestCodeReviewTree(), TestCrashInvestigator() (+7 more)
...
Cohesion: 0.3
Nodes (14): TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest(), TestTracingMiddleware_StatusCodes(), TestTracingMiddleware_WroteHeaderGuard() (+6 more)
...
Cohesion: 0.14
Nodes (8): addChatMsg(), agentNames, sendChat(), apiFetch(), loadEvolutionData(), renderEvolution(), renderThinkTank(), runThinkTank()
...
Cohesion: 0.21
Nodes (10): TestActionForName_BulkCoverage(), Recover(), SafeGo(), TestRecover_CatchesPanic(), TestRecover_NoPanic(), TestRecover_ReturnsErrorWithContext(), TestSafeGo_HandlerPanicIsRecovered(), TestSafeGo_NormalExecution() (+2 more)
...
- **Why does `main()` connect `Community 180` to `Community 4`, `Community 260`, `Community 136`, `Community 139`, `Community 11`, `Community 16`, `Community 18`, `Community 147`, `Community 20`, `Community 21`, `Community 25`, `Community 155`, `Community 27`, `Community 159`, `Community 32`, `Community 33`, `Community 41`, `Community 48`, `Community 185`, `Community 64`, `Community 205`, `Community 103`, `Community 120`, `Community 125`?**
  _High betweenness centrality (0.224) - this node is a cross-community bridge._
- **Why does `BuildTree()` connect `Community 11` to `Community 0`, `Community 2`, `Community 260`, `Community 135`, `Community 10`, `Community 12`, `Community 16`, `Community 20`, `Community 150`, `Community 153`, `Community 27`, `Community 31`, `Community 167`, `Community 180`, `Community 53`, `Community 62`, `Community 191`, `Community 192`, `Community 205`, `Community 83`, `Community 87`, `Community 88`, `Community 94`, `Community 223`, `Community 106`, `Community 123`, `Community 125`?**
  _High betweenness centrality (0.189) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 65` to `Community 260`, `Community 4`, `Community 5`, `Community 135`, `Community 147`, `Community 22`, `Community 26`, `Community 159`, `Community 37`, `Community 40`, `Community 51`, `Community 185`, `Community 61`, `Community 64`, `Community 193`, `Community 95`, `Community 96`, `Community 97`, `Community 103`, `Community 237`, `Community 124`?**
