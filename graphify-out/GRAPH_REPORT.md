# Graph Report - superpowers-20260716T145839-6d4a1975-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-16)

## Corpus Check
- 896 files · ~1,093,402 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24247 nodes · 36640 edges · 1918 communities (1565 shown, 353 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 9077 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `25ba40ec`
...
6. `arc42 Section 9 — Architecture Decisions` - 134 edges
...
## Communities (1918 total, 353 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (183): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+175 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (183): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+175 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (112): ErrorCategory, ApplyJitter(), ClassifyError(), contextDeadlineExceeded(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), ExecuteWithPolicy() (+104 more)
...
Cohesion: 0.01
Nodes (134): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+126 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (84): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy() (+76 more)
...
Cohesion: 0.03
Nodes (82): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+74 more)
...
Cohesion: 0.05
Nodes (78): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup() (+70 more)
...
Cohesion: 0.05
Nodes (65): TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), perTreeStats(), setupGardener(), TestEvolveTree_BloatGuard() (+57 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (49): findChildByName(), TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords() (+41 more)
...
Cohesion: 0.05
Nodes (70): captureExporter, NewOTLPHTTPExporter(), TestConfigureOTLPFromEnv(), TestConfigureOTLPFromEnv_DisabledWithoutEndpoint(), TestConsoleTracer_ExporterErrorDoesNotBreakEnd(), TestConsoleTracer_ExporterReceivesCompletedSpan(), TestOTLPHTTPExporter_Non2xx(), TestOTLPHTTPExporter_PostsOTLPJSON() (+62 more)
...
Cohesion: 0.06
Nodes (67): blockOnHeldBBMu(), echoTaskLeaf, islandArchivePath(), persistEvolvedWinner(), registerMCPTools(), assertExpertArchiveFedFromRun(), injectSelectorProbeTree(), seedSelectorProbeStats() (+59 more)
...
Cohesion: 0.05
Nodes (52): containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest(), TestRunTask_CacheHit() (+44 more)
...
Cohesion: 0.07
Nodes (63): Duration(), TestDuration(), TestNewPopulation_Evolution(), TestNewReinforcementLearner(), TestPopulation_Diversity(), DefaultTree(), TestPopulation_StatsAccessors(), NewExperienceBank() (+55 more)
...
Cohesion: 0.05
Nodes (51): TestDriftWatchOnce_SkipsRestartWhenJobStartedMidRebuild(), TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir() (+43 more)
...
Cohesion: 0.05
Nodes (38): TestRunOnce_EmitsRunRootSpan(), TestRunJob_WebhookSpanJoinsRunTrace(), TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeSpan, fakeTracer, mockOllamaServer() (+30 more)
...
Cohesion: 0.06
Nodes (42): AutoRebuildEnabled(), WorkflowsDir(), DashboardRebuildTargets(), DefaultRebuildTargets(), main(), handlePipelineRun(), handlePipelines(), handlePipelineStatus() (+34 more)
...
Cohesion: 0.13
Nodes (43): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Research(), TestTree_Research() (+35 more)

### Community 52 - "Community 52"
Cohesion: 0.1
Nodes (50): NewAgent(), NewDocPlanner(), TestAutomationActions_ReachTaskAutomated(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory() (+42 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (41): NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation(), TestCrisisDetector_DetectPopulation_DiversityCollapse() (+33 more)
...
Cohesion: 0.06
Nodes (17): History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), GardenerRunCycleTool, mockTTOrch (+9 more)
...
Cohesion: 0.07
Nodes (43): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), JobStore, TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves() (+35 more)
...
Cohesion: 0.06
Nodes (36): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+28 more)
...
Cohesion: 0.08
Nodes (44): biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask(), serializeTreeForGardener(), crisisMetricsGardener() (+36 more)
...
Cohesion: 0.08
Nodes (17): FilterByTreeName(), TestBaseNodeCount(), Gardener, baseNodeCount(), BuildMutationPrompt(), DefaultResearchHints(), NewModelEnsemble(), EnsembleConfig (+9 more)
...
Cohesion: 0.09
Nodes (19): BTOptimizer, collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestExtractCondition(), TestFindMainSelector(), TestSplitCamelCase() (+11 more)
...
Cohesion: 0.1
Nodes (21): parseChainConfig(), TestChainAction_ParseConfig(), asFloat(), compiledGoapActionFor(), compiledGoapConditionFor(), goapValuesEqual(), goapWorldStateFrom(), isCompiledGoapAction() (+13 more)

### Community 118 - "Community 118"
Cohesion: 0.08
Nodes (28): stringContains(), TestBuildGoapStepPrompt(), buildGoapStepPrompt(), getStepResults(), TestAction_ExecuteGoapStep_AccumulatesAndSynthesizes(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal() (+20 more)
...
Cohesion: 0.14
Nodes (22): registerGoapNodes(), convertGoapChildren(), FromGoapNode(), GOAPDevOpsTree(), GOAPPlanningTree(), GOAPResearchTree(), Blackboard, BlackboardBridge (+14 more)
...
Cohesion: 0.1
Nodes (17): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRestartEnabled(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce(), TestStartDriftWatcher_KickTriggersImmediateCheck() (+9 more)
...
Cohesion: 0.13
Nodes (14): defaultDriftHead(), scrubGitEnv(), buildStampLdflags(), copyFile(), defaultRebuildBuild(), defaultRebuildMaterialize(), NewRebuildBackoff(), RebuildBinaries() (+6 more)
...
Cohesion: 0.14
Nodes (19): TestPromoteSubtree(), init(), ApplyBlockMutations(), blockIDFromOp(), collectNames(), evolutionApplyAddAfter(), evolutionApplyAddBefore(), extractSubtree() (+11 more)
...
Cohesion: 0.11
Nodes (8): GardenerDeactivateAllTool, GardenerRecommendTool, GardenerRollbackTool, GardenerStatusTool, main(), newGardenerRunCycleTool(), truncateStr(), versionRequested()
...
Cohesion: 0.19
Nodes (15): TemplatesDir(), TestPathHelpers(), cmdCreate(), cmdDelete(), cmdInstallTemplates(), cmdList(), cmdLogs(), cmdRun() (+7 more)
...
Cohesion: 0.15
Nodes (13): DefaultBlockConfig(), NewMetaPromptEvolver(), NewMutationContext(), TestApplyDiffMutation(), TestBlockConfig_FilterMutations(), TestBlockConfig_IsMutable(), TestCrisisDetector_LastDiversity(), TestDefaultBlockConfig() (+5 more)
...
Cohesion: 0.29
Nodes (10): NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic(), TestNSGAII_FrontRank(), TestNSGAIIPopulation_Load_MergeKeepsFitterCopy() (+2 more)
...
## Knowledge Gaps
- **8940 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8935 more)
...
- **Why does `Append()` connect `Community 56` to `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 31`, `Community 32`, `Community 34`, `Community 35`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 43`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 51`, `Community 52`, `Community 53`, `Community 55`, `Community 57`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 66`, `Community 67`, `Community 68`, `Community 71`, `Community 72`, `Community 74`, `Community 75`, `Community 76`, `Community 79`, `Community 82`, `Community 86`, `Community 87`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 100`, `Community 103`, `Community 104`, `Community 108`, `Community 112`, `Community 116`, `Community 117`, `Community 119`, `Community 120`, `Community 122`, `Community 126`, `Community 127`, `Community 135`, `Community 648`, `Community 136`, `Community 650`, `Community 138`, `Community 139`, `Community 653`, `Community 141`, `Community 649`, `Community 651`, `Community 654`, `Community 149`, `Community 150`, `Community 151`, `Community 1177`, `Community 160`, `Community 162`, `Community 163`, `Community 164`, `Community 676`, `Community 165`, `Community 166`, `Community 173`, `Community 174`, `Community 175`, `Community 182`, `Community 190`, `Community 193`, `Community 198`, `Community 199`, `Community 200`, `Community 201`, `Community 203`, `Community 204`, `Community 205`, `Community 206`, `Community 208`, `Community 210`, `Community 211`, `Community 212`, `Community 215`, `Community 216`, `Community 217`, `Community 218`, `Community 221`, `Community 226`, `Community 227`, `Community 229`, `Community 870`, `Community 875`, `Community 877`, `Community 878`, `Community 879`, `Community 891`, `Community 897`, `Community 903`, `Community 904`, `Community 922`, `Community 925`, `Community 413`, `Community 927`, `Community 928`, `Community 418`, `Community 420`, `Community 428`, `Community 431`, `Community 441`, `Community 443`, `Community 445`, `Community 453`, `Community 455`, `Community 456`, `Community 971`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 59` to `Community 2`, `Community 5`, `Community 10`, `Community 16`, `Community 18`, `Community 660`, `Community 152`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 31`, `Community 35`, `Community 39`, `Community 43`, `Community 44`, `Community 48`, `Community 179`, `Community 57`, `Community 58`, `Community 186`, `Community 444`, `Community 959`, `Community 63`, `Community 65`, `Community 196`, `Community 70`, `Community 208`, `Community 85`, `Community 88`, `Community 870`, `Community 111`, `Community 114`, `Community 123`, `Community 892`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 48` to `Community 130`, `Community 5`, `Community 901`, `Community 12`, `Community 143`, `Community 18`, `Community 146`, `Community 660`, `Community 149`, `Community 152`, `Community 25`, `Community 26`, `Community 33`, `Community 167`, `Community 47`, `Community 55`, `Community 57`, `Community 444`, `Community 196`, `Community 79`, `Community 83`, `Community 211`, `Community 212`, `Community 98`, `Community 100`, `Community 870`, `Community 111`, `Community 114`, `Community 122`, `Community 124`?**
