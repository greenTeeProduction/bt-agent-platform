# Graph Report - superpowers-20260713T052138-1d2ca422-goap-fusion-loop-runner-blackboard-conte  (2026-07-13)

## Corpus Check
- 830 files · ~925,065 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20381 nodes · 31574 edges · 1702 communities (1346 shown, 356 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8210 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `06b69825`
...
## Communities (1702 total, 356 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (108): main(), main(), main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild() (+100 more)
...
Cohesion: 0.02
Nodes (130): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+122 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (130): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+122 more)
...
Cohesion: 0.03
Nodes (29): Server, AgentMetric, Alert, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts() (+21 more)
...
Cohesion: 0.03
Nodes (78): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+70 more)
...
Cohesion: 0.05
Nodes (84): TestEndpointsFromCardsSingleNodeYieldsNoPeers(), TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip() (+76 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (79): DefaultPanicHandler(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext() (+71 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (76): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure() (+68 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (79): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), gatherFailureReviewBody() (+71 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (57): Outcome, Record, FilterByTreeName(), Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped() (+49 more)
...
Cohesion: 0.05
Nodes (63): TestNewReinforcementLearner(), NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation() (+55 more)
...
Cohesion: 0.05
Nodes (43): TestPromoteRunToAgentScope(), RunDeps, RunOptions, RunResult, TreeResolver, TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall() (+35 more)
...
Cohesion: 0.03
Nodes (63): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+55 more)

### Community 35 - "Community 35"
Cohesion: 0.08
Nodes (54): clearSuperpowersPlanState(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), markGoapFusionImplDegraded() (+46 more)
...
Cohesion: 0.05
Nodes (34): tracingMiddleware(), attachLogHandler(), buildBaseHandler(), buildLogger(), Debug(), envLogLevel(), Error(), Init() (+26 more)
...
Cohesion: 0.05
Nodes (38): AutoRebuildEnabled(), StartDriftWatcher(), TestOutcomeErrorDetail(), copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), DefaultRebuildTargets(), NewRebuildBackoff() (+30 more)
...
Cohesion: 0.07
Nodes (54): ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction(), buildChainActionFn() (+46 more)
...
Cohesion: 0.06
Nodes (42): min(), handleAnalyze(), brokenTool, generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section(), TestGenerateTemplateOutput_TruncatedCache() (+34 more)
...
Cohesion: 0.07
Nodes (31): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, Histogram, LabeledCounter, LabeledGauge (+23 more)

### Community 55 - "Community 55"
Cohesion: 0.1
Nodes (26): envDefault(), main(), run(), AgentExecutor, NewRedisPriorityQueue(), NewRedisPriorityQueueFromClient(), NewRedisQueue(), NewRedisQueueFromClient() (+18 more)
...
Cohesion: 0.06
Nodes (22): runDLQReplayScanOnce(), TestDLQReplayScanSurvivesPanicAcrossTicks(), handleSprintExecute(), TestActionForName_BulkCoverage(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), degeneratePopulation(), runWithoutPanic() (+14 more)
...
Cohesion: 0.06
Nodes (23): References, goapFusionImplementationGateWired(), goapFusionPreflightWired(), PrependGoapFusionImplementationGate(), PrependGoapFusionPreflight(), spliceGoapFusionStateHashProducer(), WireGoapFusionLoopTree(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedDelegatesOnBareRepo() (+15 more)
...
Cohesion: 0.09
Nodes (35): ClearGoapFusionStateHashes(), init(), registerSuperpowersDebugActions(), superpowersDebugPhase(), superpowersDebugPhaseAction(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict() (+27 more)
...
Cohesion: 0.05
Nodes (30): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, DeadLetterEntry, TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailureWithCategory() (+22 more)
...
Cohesion: 0.08
Nodes (16): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAlertRules(), handleLogin(), handleLogout(), handleOpenAPI(), handleScalability() (+8 more)
...
Cohesion: 0.1
Nodes (25): NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad(), TestScheduler_NoJobStore_NilSafe(), TestScheduler_PersistenceOnSchedule(), TestScheduler_RestoreJobsOnStartup() (+17 more)
...
Cohesion: 0.07
Nodes (21): alwaysSampler, Attr, neverSampler, noopSpan, noopTracer, Sampler, Span, SpanContext (+13 more)
...
Cohesion: 0.14
Nodes (12): extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), containsCrisisReason(), Crossover(), ExperienceRetrievalHits(), hashTree() (+4 more)
...
Cohesion: 0.08
Nodes (15): A2AHandoffBlock(), builtinBlocks(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HumanGateBlock(), HumanReviewBlock() (+7 more)
...
Cohesion: 0.12
Nodes (22): TestTeslaDeepResearch(), TestTeslaQuickResearch(), TestClient_AnalyzeComplexity_FallbackOnError(), TestClient_Generate_ConnectionRefused(), TestClient_GeneratePlan_FallbackOnError(), TestClient_Reflect_FallbackOnError(), TestDeepSeekClient_AnalyzeComplexity(), TestDeepSeekClient_Generate_APIError() (+14 more)
...
Cohesion: 0.16
Nodes (24): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestRunJob_WarnsOnDeployDriftAtCycleComplete(), TestRunJob_WebhookIncludesBuildRevision(), NewScheduler(), decodeRunCount(), TestHistory_FileCreated() (+16 more)
...
Cohesion: 0.1
Nodes (17): agentNameFromBB(), init(), registerDelegateNodes(), init(), init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init() (+9 more)
...
Cohesion: 0.14
Nodes (21): Analyzer, extractJSON(), NewAnalyzer(), truncate(), NewAgentFactory(), TestAnalyzer_EmptyResponse_Error(), TestAnalyzer_NoStrategyPath_Error(), TestAnalyzer_ParsesTreeSpec() (+13 more)
...
Cohesion: 0.12
Nodes (19): defaultGoapReviewDeps(), init(), claudeBackoffWindow(), TestClaudeBackoffWindow_EnvOverride(), ClaudeRunner, CommandResult, CommandRunner, execClaudeRunner (+11 more)
...
Cohesion: 0.17
Nodes (11): defaultDriftHead(), DriftStatus(), DriftWatchOnce(), scrubGitEnv(), TestDriftStatus(), TestDriftWatchOnce(), TestDriftWatchOnce_RespectsBackoffGuard(), TestDriftWatchOnce_SkipsRebuildWhileJobInFlight() (+3 more)
...
Cohesion: 0.24
Nodes (8): ExportedEvent, ExportedSpan, firstNonEmpty(), otlpTracePayload(), parseOTLPHeaders(), stableHexID(), OTLPHTTPExporter, SpanExporter
...
Cohesion: 0.25
Nodes (8): handleAgentExecute(), handleAgentRun(), handleTaskCreate(), DefaultAgentTask(), TestDefaultAgentTask(), NewAgentExecutor(), PickTreeForTask(), ResolveAgentName()

### Community 744 - "Community 744"
Cohesion: 0.25
Nodes (6): agentNameInterceptor, agentNameKey, BTAgentExecutor, NewServer(), parseAnnouncement(), SetTreeResolver()
...
Cohesion: 0.36
Nodes (8): BuildIdentityFromBuildInfo(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered(), TestBlockDurationHistogramSeriesRendered(), TestBuildIdentityFromBuildInfo(), TestKGAnalyticsGaugesRenderedAndUpdated(), TestNodeDurationHistogramSeriesRendered(), TestPrometheusBuildInfoGaugeRenderedAndReplaced()
...
Cohesion: 0.7
Nodes (5): FeedbackFile(), buildSchedulerConfig(), feedbackSnapshotPath(), TestDaemonSchedulerConfigWiresFeedbackPath(), TestDaemonWiresFeedbackPersistencePath()
...
## Knowledge Gaps
- **6690 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6685 more)
...
- **Why does `Append()` connect `Community 7` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 526`, `Community 15`, `Community 16`, `Community 14`, `Community 18`, `Community 19`, `Community 20`, `Community 533`, `Community 22`, `Community 24`, `Community 536`, `Community 26`, `Community 27`, `Community 28`, `Community 539`, `Community 31`, `Community 33`, `Community 546`, `Community 36`, `Community 38`, `Community 42`, `Community 43`, `Community 44`, `Community 556`, `Community 558`, `Community 46`, `Community 47`, `Community 561`, `Community 50`, `Community 51`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 59`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 68`, `Community 70`, `Community 71`, `Community 73`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 81`, `Community 82`, `Community 83`, `Community 85`, `Community 86`, `Community 87`, `Community 89`, `Community 94`, `Community 100`, `Community 104`, `Community 107`, `Community 108`, `Community 109`, `Community 110`, `Community 111`, `Community 112`, `Community 113`, `Community 117`, `Community 120`, `Community 121`, `Community 124`, `Community 126`, `Community 130`, `Community 131`, `Community 132`, `Community 133`, `Community 135`, `Community 136`, `Community 139`, `Community 149`, `Community 150`, `Community 154`, `Community 156`, `Community 157`, `Community 163`, `Community 172`, `Community 174`, `Community 175`, `Community 176`, `Community 179`, `Community 183`, `Community 184`, `Community 187`, `Community 188`, `Community 704`, `Community 193`, `Community 194`, `Community 195`, `Community 196`, `Community 199`, `Community 200`, `Community 203`, `Community 721`, `Community 723`, `Community 212`, `Community 214`, `Community 215`, `Community 727`, `Community 726`, `Community 743`, `Community 748`, `Community 749`, `Community 793`, `Community 347`, `Community 349`, `Community 350`, `Community 351`, `Community 352`, `Community 360`, `Community 364`, `Community 365`, `Community 366`, `Community 367`, `Community 368`, `Community 377`, `Community 378`, `Community 379`, `Community 382`, `Community 387`, `Community 389`, `Community 394`, `Community 395`, `Community 949`, `Community 950`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 36` to `Community 1`, `Community 132`, `Community 4`, `Community 390`, `Community 7`, `Community 10`, `Community 12`, `Community 13`, `Community 21`, `Community 22`, `Community 153`, `Community 26`, `Community 538`, `Community 1051`, `Community 38`, `Community 41`, `Community 170`, `Community 46`, `Community 50`, `Community 54`, `Community 183`, `Community 182`, `Community 59`, `Community 63`, `Community 65`, `Community 196`, `Community 202`, `Community 204`, `Community 81`, `Community 984`, `Community 104`, `Community 110`, `Community 112`, `Community 115`, `Community 761`, `Community 120`, `Community 121`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 41` to `Community 0`, `Community 1`, `Community 4`, `Community 139`, `Community 13`, `Community 14`, `Community 148`, `Community 21`, `Community 20`, `Community 26`, `Community 27`, `Community 33`, `Community 162`, `Community 163`, `Community 36`, `Community 37`, `Community 170`, `Community 173`, `Community 49`, `Community 54`, `Community 55`, `Community 57`, `Community 58`, `Community 187`, `Community 59`, `Community 63`, `Community 717`, `Community 989`, `Community 95`, `Community 744`, `Community 362`, `Community 110`, `Community 115`, `Community 120`?**
