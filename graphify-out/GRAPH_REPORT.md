# Graph Report - superpowers-20260717T081022-cc81bd8d-goap-fusion-loop-runner-blackboard-conte  (2026-07-17)

## Corpus Check
- 895 files · ~1,130,566 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25297 nodes · 37929 edges · 1986 communities (1641 shown, 345 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9181 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1fe8ed57`
...
4. `9. Architecture Decisions` - 144 edges
...
## Communities (1986 total, 345 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (192): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+184 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (192): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+184 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (114): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), TestStore_CountFailures_MixedRecords(), TestStore_CountFailures_NoFailures(), TestStore_LoadAll_WithSubdirs(), TestStore_NewStore_MkdirAllError() (+106 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (137): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+129 more)
...
Cohesion: 0.03
Nodes (79): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+71 more)
...
Cohesion: 0.04
Nodes (77): docgenState, allSections(), buildSectionMap(), contains(), fileHash(), hashSectionSources(), isSectionDone(), main() (+69 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (87): Duration(), TestTranspositionTable_SaveLoadRoundTrip(), TestTranspositionTable_Store_EvictionPreservesLowestAmongSurvivors(), TestTranspositionTable_Store_EvictsLowestValueDeterministically(), TestTranspositionTable_Store_EvictsLowestValueRepeated(), TestTranspositionTable_StoreProbeMiss(), TestTranspositionTable_StoreProbeRoundTrip(), countTreeNodes() (+79 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (95): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+87 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (86): arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), completeGoapProgramMilestone(), extractGoapProgram() (+78 more)
...
Cohesion: 0.04
Nodes (82): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+74 more)
...
Cohesion: 0.05
Nodes (69): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), composeOrderedWithMiddle(), ComposePreset(), ComposePresetWithTools(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ListToolProfileBlocks() (+61 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (58): stringContains(), TestBuildGoapStepPrompt(), buildGoapStepPrompt(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), TestAction_ReflectGoapOutcome_NoResultsFallsBack(), TestBuildGoapStepPrompt_CapsLongPriorResult(), TestBuildGoapStepPrompt_IncludesPriorResults() (+50 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (80): mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu() (+72 more)
...
Cohesion: 0.06
Nodes (71): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure() (+63 more)
...
Cohesion: 0.04
Nodes (44): findChildByName(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords(), TestContainsAnyLower_NoKeywords(), TestContainsAnyLower_NoMatch(), TestContainsAnyLower_Substring() (+36 more)
...
Cohesion: 0.08
Nodes (59): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+51 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (64): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewManager(), claudeBackoffActive(), clearClaudeBackoffState() (+56 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (53): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), Entry, NewHandle(), Limits (+45 more)
...
Cohesion: 0.07
Nodes (56): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+48 more)
...
Cohesion: 0.04
Nodes (52): Blackboard, ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+44 more)
...
Cohesion: 0.05
Nodes (39): newAgentExecutor(), agentExecuteResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun() (+31 more)
...
Cohesion: 0.05
Nodes (46): TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), FileJobStore, JobStore, TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves() (+38 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (55): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField() (+47 more)
...
Cohesion: 0.05
Nodes (40): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait() (+32 more)
...
Cohesion: 0.06
Nodes (44): NewCatalog(), TestCatalog_Export(), TestCatalog_ListInstalled(), TestCatalog_ListTemplates(), TestCatalog_Search(), TestCatalog_SkillToAgent(), TestInferTree(), NewHistory() (+36 more)

### Community 51 - "Community 51"
Cohesion: 0.08
Nodes (52): clearSuperpowersPlanState(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), defaultNlmGrillAuthGuard(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit() (+44 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (45): TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), LogsDir() (+37 more)
...
Cohesion: 0.07
Nodes (45): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo(), assertNoForcedMasterWrite(), bareTestRun() (+37 more)
...
Cohesion: 0.08
Nodes (36): NewAuctioneer(), cardWithURL(), newAuctionTransport(), newDeadlineProbeTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoEligibleBidsFallsBack(), TestAuctionDelegate_RequiredTagsFilterCandidates() (+28 more)
...
Cohesion: 0.06
Nodes (42): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+34 more)
...
Cohesion: 0.06
Nodes (14): History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), mockTTOrch, EventBus (+6 more)
...
Cohesion: 0.1
Nodes (39): NewEvolvedAgent(), saveRecordWithDelay(), TestConfig_AllFields(), TestCreateAgentTool_Call_NilFactory(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields() (+31 more)
...
Cohesion: 0.07
Nodes (36): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+28 more)
...
Cohesion: 0.07
Nodes (38): EvolveTool, TestCheckConfidence_ConditionExists(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure() (+30 more)
...
Cohesion: 0.06
Nodes (28): NewRunDeps(), TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree() (+20 more)

### Community 71 - "Community 71"
Cohesion: 0.05
Nodes (33): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, TestHasChildNamed_DeepNested(), TestHasChildNamed_Found() (+25 more)
...
Cohesion: 0.06
Nodes (35): ActionFunc, ActionProvider, TestArc42DocsyncNodesRegistered(), ConditionFunc, ConditionProvider, Engine, TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh() (+27 more)
...
Cohesion: 0.09
Nodes (25): min(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section(), TestGenerateTemplateOutput_TruncatedCache(), TestGenerateTemplateOutput_Arc42Section(), TestGenerateTemplateOutput_Arc42TitleNoNewline() (+17 more)
...
Cohesion: 0.12
Nodes (35): init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled(), TestBanditSelector_DisabledMatchesSelectorSemantics(), TestBanditSelector_DisabledRunningChildRestartsAtZero() (+27 more)

### Community 80 - "Community 80"
Cohesion: 0.09
Nodes (41): TestConsoleTracer_ExporterReceivesCompletedSpan(), fakeTracer, AlwaysSample(), hashTraceID(), NeverSample(), NewRatioSampler(), StringAttr(), TestAlwaysSample() (+33 more)

### Community 81 - "Community 81"
Cohesion: 0.11
Nodes (38): defaultGoapReviewDeps(), gatherFailureReviewBody(), gatherReviewContext(), init(), loadLastReviewedSHA(), nextNlmQuotaReset(), nlmQuotaExhausted(), nlmQuotaExhaustedUntil() (+30 more)
...
Cohesion: 0.07
Nodes (25): handleAnalyze(), handleSprintExecute(), handleWorkflowRunFullPipeline(), syncWorkflowTaskStatus(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation(), TestHandleSprintExecute_UpdatesCurrentWorkflow(), TestHandleWorkflowRunFullPipeline_PersistsWorkflowAndTasks() (+17 more)
...
Cohesion: 0.07
Nodes (23): tracingMiddleware(), fanoutHandler, logExportTarget(), newTraceContextHandler(), TestInitLogExport_Idempotent(), TestLogExportTarget(), TestTraceContextHandler_InjectsTraceIDs(), traceContextHandler (+15 more)
...
Cohesion: 0.13
Nodes (32): TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions(), TestAction_PlanGoapActions_JSONActionsInvalidEntry(), TestAction_PlanGoapActions_NoPlanFound(), TestAction_PlanGoapActions_WithGoapConfig(), TestAction_PlanGoapActions_WorldStateFromTask(), TestAction_PlanGoapActions_WrongActionsType() (+24 more)

### Community 102 - "Community 102"
Cohesion: 0.08
Nodes (25): auctionAnnouncement(), auctionCandidates(), AuctionDelegate(), betterBid(), candidateContext(), candidateOverride(), cardURL(), NewPersistentAuctioneer() (+17 more)
...
Cohesion: 0.09
Nodes (27): TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath(), TestDiscardWorktree_RemovesWorktreeAndDeletesBranch(), TestPushBranchAndCreatePR_InvokesGitPushAndGhPr(), withSwappedSuperpowersRunners(), TestRunSuperpowersRuntime_NonRateLimitFailureSetsImplDegraded() (+19 more)

### Community 119 - "Community 119"
Cohesion: 0.1
Nodes (31): TestBTOptimizer_New(), collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestExtractCondition(), TestFindMainSelector(), TestMergeOverlappingPaths_MergeNode() (+23 more)
...
Cohesion: 0.1
Nodes (11): acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), enforceIslandCap(), mergeIslandPopulation(), islandArchive, IslandModel (+3 more)
...
Cohesion: 0.08
Nodes (33): Binaries, code:go (type Counter struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }) (+25 more)
...
Cohesion: 0.11
Nodes (19): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, LabeledGauge, formatPromLabels(), labeledSnapshotToMap() (+11 more)
...
Cohesion: 0.16
Nodes (25): NewMockLLM(), NewDefaultCompany(), EngineerTree(), MarketingTree(), SalesTree(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint() (+17 more)

### Community 168 - "Community 168"
Cohesion: 0.13
Nodes (21): collectSelectorNames(), SelectorStatsFile(), TestSelectorOptimizer_New(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb() (+13 more)

### Community 169 - "Community 169"
Cohesion: 0.13
Nodes (20): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired(), wireSelectorOrdering(), routerChildNames() (+12 more)
...
Cohesion: 0.1
Nodes (22): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), IsKnownChainKind(), TestIsKnownChainKind(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), containsLeafChildrenMsg() (+14 more)
...
Cohesion: 0.08
Nodes (14): alwaysSampler, Attr, neverSampler, noopSpan, noopTracer, Sampler, Span, SpanContext (+6 more)
...
Cohesion: 0.1
Nodes (6): FitnessTool, GetReflectionsTool, GetTreeTool, ReflectTool, RunTaskTool, truncateStr()
...
Cohesion: 0.12
Nodes (13): FallbackLLM, NamedLLM, TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailure_BackwardCompat(), TestCircuitBreaker_RecordFailureWithCategory(), TestIntegration_CircuitBreakerAndDLQ(), NewCircuitBreaker() (+5 more)
...
Cohesion: 0.19
Nodes (4): BTOptimizer, isDefaultPath(), DTAnalyzer, isSelectorFallback()
...
Cohesion: 0.17
Nodes (9): attachLogHandler(), buildBaseHandler(), buildLogger(), envLogLevel(), Error(), Init(), L(), TestSetAsDefaultFollowsHandlerRebuild() (+1 more)
...
Cohesion: 0.18
Nodes (14): TestBuildIdentityStampedRevisionFallback(), BuildIdentityFromBuildInfo(), exposedBuildIdentity(), InstallBuildIdentity(), ReadBuildIdentity(), SetBuildIdentity(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered() (+6 more)
...
Cohesion: 0.2
Nodes (11): TestRunOnce_EmitsRunRootSpan(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), Tracer, GetGlobalTracer() (+3 more)
...
Cohesion: 0.18
Nodes (11): code:go (type Tool struct { ... }), code:go (type AgentCard struct { Name, Description, URL string }), code:go (type PlatformEvalResult struct { ... }), code:go (type BaselineStore struct { ... }), code:go (type WorkflowReport struct { ... }), code:go (type AgentInfo struct { Name, Status, Schedule string; Succe), Package: a2a, Package: benchreg (+3 more)
...
## Knowledge Gaps
- **9606 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+9601 more)
...
- **Why does `Append()` connect `Community 62` to `Community 2`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 40`, `Community 41`, `Community 44`, `Community 45`, `Community 46`, `Community 49`, `Community 53`, `Community 54`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 67`, `Community 68`, `Community 69`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 75`, `Community 77`, `Community 80`, `Community 82`, `Community 83`, `Community 85`, `Community 86`, `Community 89`, `Community 91`, `Community 92`, `Community 93`, `Community 95`, `Community 96`, `Community 97`, `Community 99`, `Community 100`, `Community 103`, `Community 104`, `Community 106`, `Community 107`, `Community 110`, `Community 111`, `Community 117`, `Community 119`, `Community 123`, `Community 124`, `Community 130`, `Community 132`, `Community 133`, `Community 135`, `Community 136`, `Community 138`, `Community 139`, `Community 140`, `Community 145`, `Community 146`, `Community 147`, `Community 148`, `Community 150`, `Community 151`, `Community 157`, `Community 159`, `Community 674`, `Community 163`, `Community 164`, `Community 685`, `Community 174`, `Community 687`, `Community 176`, `Community 177`, `Community 175`, `Community 179`, `Community 180`, `Community 178`, `Community 182`, `Community 700`, `Community 189`, `Community 701`, `Community 1215`, `Community 188`, `Community 190`, `Community 703`, `Community 705`, `Community 199`, `Community 204`, `Community 206`, `Community 208`, `Community 209`, `Community 214`, `Community 215`, `Community 217`, `Community 218`, `Community 219`, `Community 225`, `Community 226`, `Community 231`, `Community 233`, `Community 234`, `Community 235`, `Community 236`, `Community 237`, `Community 1340`, `Community 904`, `Community 905`, `Community 909`, `Community 925`, `Community 430`, `Community 431`, `Community 433`, `Community 435`, `Community 436`, `Community 950`, `Community 438`, `Community 952`, `Community 446`, `Community 448`, `Community 449`, `Community 459`, `Community 461`, `Community 469`, `Community 470`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 21` to `Community 130`, `Community 132`, `Community 10`, `Community 11`, `Community 139`, `Community 13`, `Community 143`, `Community 16`, `Community 146`, `Community 147`, `Community 19`, `Community 22`, `Community 155`, `Community 28`, `Community 32`, `Community 160`, `Community 167`, `Community 168`, `Community 45`, `Community 50`, `Community 52`, `Community 437`, `Community 54`, `Community 1335`, `Community 438`, `Community 62`, `Community 63`, `Community 67`, `Community 196`, `Community 68`, `Community 75`, `Community 76`, `Community 461`, `Community 77`, `Community 89`, `Community 98`, `Community 123`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 52` to `Community 130`, `Community 2`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 142`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 32`, `Community 37`, `Community 38`, `Community 41`, `Community 45`, `Community 47`, `Community 48`, `Community 432`, `Community 50`, `Community 945`, `Community 53`, `Community 54`, `Community 438`, `Community 444`, `Community 63`, `Community 192`, `Community 66`, `Community 196`, `Community 460`, `Community 208`, `Community 87`, `Community 985`, `Community 114`, `Community 125`?**
