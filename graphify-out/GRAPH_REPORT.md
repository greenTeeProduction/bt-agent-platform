...
## Corpus Check
- 343 files · ~408,037 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5924 nodes · 11086 edges · 300 communities (258 shown, 42 thin omitted)
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 3648 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2c9585db`
...
2. `sleep()` - 84 edges
3. `NewKnowledgeGraph()` - 77 edges
4. `DefaultTree()` - 77 edges
5. `newDefaultConfig()` - 67 edges
6. `GoDeveloperTree()` - 57 edges
7. `NewGoal()` - 55 edges
8. `condTest()` - 52 edges
...
Cohesion: 0.06
Nodes (109): TestBTPG_QualityMetrics_AllDomainTrees(), TestBFCL_AllDomainTrees_Accuracy(), handleTreeStructure(), AlertRouterTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality() (+101 more)
...
Cohesion: 0.03
Nodes (49): stringContains(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_PlanGoapActions_WrongActionsType(), cacheCheckAction(), cacheResultAction(), execLLMCallAction(), execRefineAction(), generatePlanAction() (+41 more)
...
Cohesion: 0.04
Nodes (41): findChildByName(), TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_WithLLM(), TestBuildGoapStepPrompt(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords() (+33 more)
...
Cohesion: 0.07
Nodes (57): ParallelMode, BuildReactiveParallel(), intSliceFromInterface(), runReactiveParallel(), ScoringCriteria, BuildUtilitySelector(), DefaultScoringCriteria(), evaluateGuardCondition() (+49 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (42): NewDefaultCompany(), CompanyOrchestrator, CompanyState, Decision, EngineerTree(), MarketingTree(), SalesTree(), StartupTrees() (+34 more)
...
Cohesion: 0.08
Nodes (42): DeepeningResult, makeRecords(), TestCloneTree_Independent(), TestEvaluateTree_AllFailures(), TestEvaluateTree_EmptyRecords(), TestEvaluateTree_GoDevVsDefault(), TestEvaluateTree_Mixed(), TestEvaluateTree_NodeCountPenalty() (+34 more)
...
Cohesion: 0.09
Nodes (38): ArraySchema(), BoolSchema(), IntSchema(), NumberSchema(), ObjectSchema(), TestConvenienceSchemaConstructors(), ResponseValidator(), TestResponseValidator_DriftLogging() (+30 more)

### Community 23 - "Community 23"
Cohesion: 0.08
Nodes (33): resolveTree(), TestIntegration_AllKanbanTrees(), HermesObsidianOptimizerTree(), KanbanAutoPilotTree(), KanbanBoardMonitorTree(), KanbanQATree(), KanbanRefinerTree(), KanbanTaskCreatorTree() (+25 more)

### Community 24 - "Community 24"
Cohesion: 0.08
Nodes (29): NewTranspositionTable(), perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree() (+21 more)
...
Cohesion: 0.11
Nodes (40): cohensD(), DefaultMock(), fishersExact(), GoDevSuite(), minF(), QuickValidate(), RunABTest(), ScoreMutation() (+32 more)
...
Cohesion: 0.05
Nodes (36): Binaries, code:go (type Counter struct { ... }), code:go (type Tracer interface {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {) (+28 more)
...
Cohesion: 0.09
Nodes (27): applyDotEnvFiles(), applyDotEnvToConfig(), applyEnvOverrides(), envBool(), hasExplicitField(), Load(), LoadDotEnv(), LoadFileWithDotEnv() (+19 more)
...
Cohesion: 0.14
Nodes (28): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+20 more)

### Community 57 - "Community 57"
Cohesion: 0.15
Nodes (28): ChainConfig, ChainKind, BuildChainAction(), buildChainActionFn(), buildToolList(), execAgent(), execConversation(), execLLMCall() (+20 more)
...
Cohesion: 0.1
Nodes (9): TestCheckConfidence_ConditionExists(), FitnessFunc, maxInt(), MCTSMetrics, MCTSMutator, MCTSNode, ApplyMutations(), EvolvedAgent (+1 more)
...
Cohesion: 0.21
Nodes (27): NewOpenAPIGenerator(), NewRoute(), StringSchema(), mapKeys(), TestOpenAPIGenerator_AuthFlag(), TestOpenAPIGenerator_Deprecated(), TestOpenAPIGenerator_DeprecatedRouteHeaders(), TestOpenAPIGenerator_DeprecatedWithoutSunset_NoHeaders() (+19 more)
...
Cohesion: 0.09
Nodes (22): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, TestRegisterAction_And_GetAction(), TestRegisterCondition_And_GetCondition(), TestValidateOutputAction_TooShort() (+14 more)
...
Cohesion: 0.12
Nodes (21): init(), main(), main(), main(), main(), Debug(), Error(), Info() (+13 more)

### Community 72 - "Community 72"
Cohesion: 0.13
Nodes (25): NewAgentCircuitBreaker(), NewAgentCircuitBreakerStore(), TestAgentCircuitBreaker_Allow_Closed(), TestAgentCircuitBreaker_Allow_HalfOpen_SecondCall(), TestAgentCircuitBreaker_Allow_Open_Expired(), TestAgentCircuitBreaker_Allow_Open_NotExpired(), TestAgentCircuitBreaker_FailureCount(), TestAgentCircuitBreaker_RecordFailure_FromHalfOpen() (+17 more)
...
Cohesion: 0.14
Nodes (22): benchmarkSuccessTree(), TestBFCLV3LoadErrorsAndEmptyEvaluation(), TestBFCLV3LoadFlattenAndEvaluate(), TestBuiltinBFCLV3StableShape(), TestIsToolMatchVariants(), TestLoadBFCLSuiteAndEvaluate(), TestLoadBFCLSuiteErrors(), BuiltinBFCLV3() (+14 more)
...
Cohesion: 0.1
Nodes (24): TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestBuildChainActionFn_LlmCallNilLLM(), TestBuildChainActionFn_UnknownChainType(), TestComputeTreeMetrics_MaxRetriesAndTimeout(), TestComputeTreeMetrics_NestedChildren() (+16 more)
...
Cohesion: 0.16
Nodes (21): BehavioralDescriptor, FeatureDimension, Bucket(), Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid(), NewMAPElitesPopulation(), countCondsActs() (+13 more)
...
Cohesion: 0.13
Nodes (17): AntiPattern, TestExpertKnowledge_DetectAntiPatterns(), DesignPattern, TestExpert_MatchPattern(), containsStr(), coreHeuristics(), hasNodeMatching(), hasNodeType() (+9 more)
...
Cohesion: 0.11
Nodes (20): TestMax1(), benchmarkPlanTree(), TestBuiltinBFCLSuitesHaveStableShape(), TestGAIABuiltinAndEvaluation(), BFCLEntry, BFCLEvalResult, BFCLFunction, BFCLMetrics (+12 more)
...
Cohesion: 0.12
Nodes (17): countTreeNodes(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New(), TestNewPopulation_Evolution(), TestNewQTable(), TestNewReinforcementLearner() (+9 more)
...
Cohesion: 0.16
Nodes (8): AgentCircuitBreaker, AgentCircuitBreakerStore, reportAgentOutcome(), TestReportAgentOutcome_NilStore(), TestValidateAgentRun_Allowed(), TestValidateAgentRun_Blocked(), TestValidateAgentRun_NilStore(), validateAgentRun()
...
Cohesion: 0.18
Nodes (14): main(), min(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis(), TestTeslaMarket(), TestTeslaModel(), TestTeslaPitchAgent() (+6 more)

### Community 125 - "Community 125"
Cohesion: 0.16
Nodes (11): Blackboard, parseChainConfig(), TestChainAction_ParseConfig(), toolStub, BuildAndValidate(), buildNode(), containsAny(), RunTask() (+3 more)
...
Cohesion: 0.19
Nodes (9): BlockConfig, ApplyDiffMutation(), findBlockForNode(), TestFindBlockForNode(), DiffMutation, EvolveBlock, MutationContext, MutationTemplate (+1 more)
...
Cohesion: 0.19
Nodes (3): Scheduler, estimateQuality(), parseTimeout()
...
Cohesion: 0.18
Nodes (12): TestSelectorOptimizer_New(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), NewSelectorOptimizer(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing(), TestLocalSearch_TabuSearch() (+4 more)
...
Cohesion: 0.19
Nodes (11): TestActionForName_BulkCoverage(), Recover(), SafeGo(), TestRecover_CatchesPanic(), TestRecover_NoPanic(), TestRecover_ReturnsErrorWithContext(), TestSafeGo_HandlerPanicIsRecovered(), TestSafeGo_NormalExecution() (+3 more)
...
Cohesion: 0.27
Nodes (9): AgentRunner, Checkpoint, RunContext, ScheduledJob, matches(), nextCronTime(), parseCronField(), parseSchedule() (+1 more)

### Community 200 - "Community 200"
Cohesion: 0.24
Nodes (5): envDefault(), main(), run(), RemoteExecutor, RemoteExecutorConfig
...
Cohesion: 0.36
Nodes (8): NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad(), TestScheduler_NoJobStore_NilSafe(), TestScheduler_PersistenceOnSchedule(), TestScheduler_RestoreJobsOnStartup()
...
Cohesion: 0.33
Nodes (6): TestComputeSubtreeMetrics_MixedChildren(), TestComputeSubtreeMetrics_NilInput(), TestComputeSubtreeMetrics_UpdatesMaxValues(), TestComputeSubtreeMetrics_EmptyChildren(), TestComputeSubtreeMetrics_SingleChild(), computeSubtreeMetrics()
...
## Knowledge Gaps
- **562 isolated node(s):** `TauBenchEntry`, `TauBenchAction`, `TauBenchTool`, `TauBenchParam`, `TauBenchMetrics` (+557 more)
...
- **Why does `main()` connect `Community 71` to `Community 5`, `Community 11`, `Community 18`, `Community 20`, `Community 23`, `Community 30`, `Community 160`, `Community 41`, `Community 52`, `Community 55`, `Community 56`, `Community 58`, `Community 197`, `Community 72`, `Community 214`, `Community 215`, `Community 101`, `Community 108`, `Community 237`, `Community 119`, `Community 120`?**
  _High betweenness centrality (0.217) - this node is a cross-community bridge._
- **Why does `BuildTree()` connect `Community 11` to `Community 0`, `Community 9`, `Community 12`, `Community 13`, `Community 18`, `Community 275`, `Community 23`, `Community 153`, `Community 49`, `Community 53`, `Community 56`, `Community 193`, `Community 194`, `Community 195`, `Community 71`, `Community 203`, `Community 81`, `Community 84`, `Community 215`, `Community 96`, `Community 97`, `Community 107`, `Community 245`, `Community 247`, `Community 121`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.176) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 71` to `Community 5`, `Community 6`, `Community 145`, `Community 22`, `Community 27`, `Community 155`, `Community 160`, `Community 32`, `Community 62`, `Community 64`, `Community 196`, `Community 83`, `Community 89`, `Community 98`, `Community 99`, `Community 100`, `Community 101`, `Community 119`, `Community 124`?**
...
- **Are the 76 inferred relationships involving `NewKnowledgeGraph()` (e.g. with `TestComputeAnalytics_EmptyGraph()` and `TestComputeAnalytics_Centrality()`) actually correct?**
  _`NewKnowledgeGraph()` has 76 INFERRED edges - model-reasoned connections that need verification._
