# Graph Report - superpowers-20260705T172813-47363a52-goap-fusion-loop-runner-blackboard-conte  (2026-07-05)

## Corpus Check
- 737 files · ~758,566 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16507 nodes · 26305 edges · 1490 communities (1125 shown, 365 thin omitted)
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 7269 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0391e36b`
...
## Communities (1490 total, 365 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (94): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+86 more)
...
Cohesion: 0.03
Nodes (84): buildMapReduceFallback(), execMapReduce(), expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), recordChainHistory(), renderChainHistory() (+76 more)
...
Cohesion: 0.05
Nodes (69): BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir() (+61 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (72): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure() (+64 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (79): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+71 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (79): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+71 more)
...
Cohesion: 0.05
Nodes (49): getHomeDir(), handleSprintExecute(), init(), main(), handlePipelineRun(), handlePipelines(), newPipelineRunner(), newRunID() (+41 more)
...
Cohesion: 0.06
Nodes (55): NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation(), TestCrisisDetector_DetectPopulation_DiversityCollapse() (+47 more)
...
Cohesion: 0.05
Nodes (31): buildGardenerConfig(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), GardenerRecommendTool, GardenerRunCycleTool, GardenerStatusTool, main(), truncateStr() (+23 more)
...
Cohesion: 0.05
Nodes (38): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, init(), init(), init(), registerSuperpowersConditions() (+30 more)
...
Cohesion: 0.06
Nodes (43): TestBuiltinSWELite_CoverageAndUniqueness(), TestDetectPath_FromCurrentPath(), TestDetectPath_FromVisitedPaths(), TestDetectPath_KeywordFallback(), TestMax1(), benchmarkPlanTree(), benchmarkSuccessTree(), TestBFCLV3LoadErrorsAndEmptyEvaluation() (+35 more)

### Community 50 - "Community 50"
Cohesion: 0.09
Nodes (42): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewManager(), buildClaudeReviewPrompt(), defaultGoapReviewDeps() (+34 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (45): Binaries, code:go (type Counter struct { ... }), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type KnowledgeGraph struct { ... }), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {) (+37 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (30): exportMemoryCategory(), exportPreviousRuns(), min(), minInt(), TestExportPreviousRuns(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState() (+22 more)
...
Cohesion: 0.1
Nodes (42): cloneTree(), CodeReviewSuite(), cohensD(), DefaultMock(), fishersExact(), GoDevSuite(), minF(), QuickValidate() (+34 more)
...
Cohesion: 0.07
Nodes (32): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype() (+24 more)
...
Cohesion: 0.07
Nodes (24): handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleAnalyze(), handleDLQReplay(), handleLogin() (+16 more)
...
Cohesion: 0.07
Nodes (21): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, Gardener, baseNodeCount() (+13 more)
...
Cohesion: 0.17
Nodes (33): DefaultLLM(), RealLLM(), BuiltinBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic(), TestBFCLV3_MultiTurn_Composite(), TestDetectPath_DataPipelineKeywordFallback() (+25 more)
...
Cohesion: 0.16
Nodes (29): TestEvaluateTree_SingleRecord(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune(), makeRecords(), TestCloneTree_Independent(), TestEvaluateTree_AllFailures(), TestEvaluateTree_EmptyRecords(), TestEvaluateTree_GoDevVsDefault() (+21 more)
...
Cohesion: 0.13
Nodes (23): TestLocalSearcher_New(), TestSelectorOptimizer_New(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), TestLocalSearchMutableParamsAndTabu(), extractMutableParams(), getFloatMeta(), NewLocalSearcher() (+15 more)
...
Cohesion: 0.14
Nodes (23): TestPromoteRunToAgentScope(), TestSeedMemoryToBlackboard_HistoryOffloaded(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), NewHandle(), DefaultManager() (+15 more)
...
Cohesion: 0.14
Nodes (25): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionNoopPatchStreak(), goapFusionPreflightWired() (+17 more)
...
Cohesion: 0.17
Nodes (22): TestHasNode_DeepMatch(), TestHasNode_EmptyChildren(), TestHasNode_NoMatch(), TestHasNode_RootMatch(), DeepeningResult, FitnessScore, MutationCandidate, chainHasTool() (+14 more)
...
Cohesion: 0.14
Nodes (14): TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_PruningOnNodeExplosion(), TestIterativeDeepening_TTHitDuringSearch(), TestIterativeDeepening_PrunesExplodingTrees(), TestIterativeDeepening_Depth1_Applies(), TestIterativeDeepening_ScoreImprovement(), TestIterativeDeepening_TTHitViaMakeKey(), TestTranspositionTable_Save_EvictionThenSave() (+6 more)
...
Cohesion: 0.14
Nodes (14): NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), captureExporter, NewOTLPHTTPExporter(), TestConfigureOTLPFromEnv() (+6 more)
...
Cohesion: 0.19
Nodes (17): NewExperienceBank(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), TestAddFromMutation_MultipleTreeTypes(), TestAddFromMutation_NoChange(), TestAddFromMutation_NoLLM(), TestAddFromMutation_RejectsRegression(), TestConcurrentAccess() (+9 more)
...
Cohesion: 0.26
Nodes (12): NewAnalyzer(), TestAnalyzer_EmptyResponse_Error(), TestAnalyzer_NoStrategyPath_Error(), TestAnalyzer_ParsesTreeSpec(), TestFactory_CreateFromContent(), TestFactory_CreateFromFile(), TestFactory_CreateFromSkillDir_MdPath(), TestGenerator_BuildsCorrectTree() (+4 more)
...
## Knowledge Gaps
- **4599 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+4594 more)
...
- **Why does `Append()` connect `Community 20` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 13`, `Community 14`, `Community 526`, `Community 527`, `Community 17`, `Community 18`, `Community 19`, `Community 533`, `Community 22`, `Community 535`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 545`, `Community 546`, `Community 34`, `Community 36`, `Community 35`, `Community 38`, `Community 37`, `Community 41`, `Community 554`, `Community 42`, `Community 44`, `Community 45`, `Community 46`, `Community 560`, `Community 49`, `Community 48`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 570`, `Community 571`, `Community 58`, `Community 61`, `Community 574`, `Community 62`, `Community 59`, `Community 63`, `Community 66`, `Community 580`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 592`, `Community 593`, `Community 81`, `Community 83`, `Community 84`, `Community 85`, `Community 88`, `Community 89`, `Community 601`, `Community 91`, `Community 92`, `Community 100`, `Community 103`, `Community 105`, `Community 106`, `Community 617`, `Community 110`, `Community 112`, `Community 113`, `Community 115`, `Community 116`, `Community 118`, `Community 119`, `Community 121`, `Community 124`, `Community 126`, `Community 133`, `Community 134`, `Community 135`, `Community 136`, `Community 137`, `Community 139`, `Community 143`, `Community 144`, `Community 146`, `Community 148`, `Community 149`, `Community 154`, `Community 155`, `Community 156`, `Community 157`, `Community 160`, `Community 161`, `Community 163`, `Community 164`, `Community 165`, `Community 166`, `Community 167`, `Community 168`, `Community 172`, `Community 175`, `Community 176`, `Community 178`, `Community 179`, `Community 181`, `Community 182`, `Community 187`, `Community 188`, `Community 190`, `Community 193`, `Community 203`, `Community 760`, `Community 283`, `Community 288`, `Community 289`, `Community 291`, `Community 297`, `Community 305`, `Community 309`, `Community 310`, `Community 316`, `Community 828`, `Community 320`, `Community 410`, `Community 411`, `Community 414`, `Community 416`, `Community 421`, `Community 426`, `Community 437`, `Community 438`, `Community 440`, `Community 443`?**
  _High betweenness centrality (0.157) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 19` to `Community 7`, `Community 137`, `Community 138`, `Community 16`, `Community 145`, `Community 146`, `Community 152`, `Community 27`, `Community 161`, `Community 35`, `Community 36`, `Community 296`, `Community 427`, `Community 43`, `Community 45`, `Community 174`, `Community 47`, `Community 311`, `Community 57`, `Community 63`, `Community 86`, `Community 728`, `Community 91`, `Community 93`, `Community 99`, `Community 106`, `Community 109`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 7` to `Community 0`, `Community 3`, `Community 132`, `Community 138`, `Community 19`, `Community 149`, `Community 26`, `Community 27`, `Community 28`, `Community 30`, `Community 159`, `Community 161`, `Community 34`, `Community 35`, `Community 36`, `Community 548`, `Community 38`, `Community 39`, `Community 296`, `Community 170`, `Community 427`, `Community 174`, `Community 187`, `Community 316`, `Community 82`, `Community 86`, `Community 110`?**
