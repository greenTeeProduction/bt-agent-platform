# Graph Report - superpowers-20260717T155746-cc81bd8d-goap-fusion-loop-runner-blackboard-conte  (2026-07-17)

## Corpus Check
- 895 files · ~1,144,949 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25899 nodes · 38622 edges · 2024 communities (1680 shown, 344 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9250 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a5278ae0`
...
1. `Append()` - 392 edges
2. `9. Architecture Decisions` - 155 edges
...
## Communities (2024 total, 344 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (202): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+194 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (202): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+194 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (148): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+140 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (73): AgentMetric, Alert, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts() (+65 more)
...
Cohesion: 0.03
Nodes (104): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+96 more)
...
Cohesion: 0.04
Nodes (91): TestRunOnce_EmitsRunRootSpan(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), alwaysSampler, Attr (+83 more)
...
Cohesion: 0.03
Nodes (59): AutoRebuildEnabled(), StartDriftWatcher(), NewRebuildBackoff(), main(), tracingMiddleware(), GardenerDeactivateAllTool, GardenerRecommendTool, GardenerRollbackTool (+51 more)
...
Cohesion: 0.04
Nodes (84): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), buildChainActionFn() (+76 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (70): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle(), ComposePreset() (+62 more)
...
Cohesion: 0.05
Nodes (68): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestNewFileWriteTool_Structure(), TestNewGoTestTool_Structure() (+60 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (78): blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu(), TestBTBlocksComposeSaveHoldsServerLock(), TestBTHITLComposeTaskSaveHoldsBBMu(), TestBTHITLComposeTaskSaveHoldsServerLock() (+70 more)
...
Cohesion: 0.05
Nodes (66): TestComputeAnalytics_BottleneckCarriesStructuredFailure(), TestComputeAnalytics_Bottlenecks(), TestComputeAnalytics_BottleneckWithoutTraceHasEmptyFailure(), TestComputeAnalytics_BottleneckWithTrace(), TestComputeAnalytics_Centrality(), TestComputeAnalytics_CoverageGapsUseExpectedDomains(), TestComputeAnalytics_EmptyGraph(), TestComputeAnalytics_ExtendedEdges() (+58 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (50): newAgentExecutor(), agentExecuteResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun() (+42 more)
...
Cohesion: 0.04
Nodes (53): TestOutcomeErrorDetail(), FeedbackFile(), RunDeps, applyOutcomeRefinement(), IsHealthyOutcome(), OutcomeErrorDetail(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome() (+45 more)
...
Cohesion: 0.05
Nodes (71): newTreeFactory(), IsKnownChainKind(), TestIsKnownChainKind(), TestBuildChainActionFn_LlmCallNilLLM(), TestBuildChainActionFn_UnknownChainType(), TestComputeSubtreeMetrics_MixedChildren(), TestComputeSubtreeMetrics_NilInput(), TestComputeSubtreeMetrics_UpdatesMaxValues() (+63 more)
...
Cohesion: 0.07
Nodes (64): buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), defaultNlmGrillAuthGuard(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), registerSuperpowersProductionActions() (+56 more)
...
Cohesion: 0.05
Nodes (35): Warn(), Outcome, Record, FilterByTreeName(), Config, TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped() (+27 more)
...
Cohesion: 0.06
Nodes (61): biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask(), serializeTreeForGardener(), crisisMetricsGardener() (+53 more)
...
Cohesion: 0.07
Nodes (50): NewAgent(), NewDocPlanner(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory(), TestAgentNoPlan() (+42 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (57): main(), TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_PruningOnNodeExplosion(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune() (+49 more)
...
Cohesion: 0.06
Nodes (54): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField(), extractNotebookLMAnswer() (+46 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (46): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), BuildChainAction(), parseChainConfig(), TestChainAction_ParseConfig(), readPostconditions() (+38 more)
...
Cohesion: 0.09
Nodes (55): claudeBackoffWindow(), chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget() (+47 more)
...
Cohesion: 0.07
Nodes (37): References, Collect(), indexOf(), GoapFusionPreflightNode(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedDelegatesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedMaterializesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionCircuitPolicyVerdictFoldsNoopStreak(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionGatesClaudeImplementation() (+29 more)

### Community 58 - "Community 58"
Cohesion: 0.08
Nodes (57): TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestNumberSchema(), TestRouteBuilder_Build(), TestRouteBuilder_SunsetDate(), TestSchemaToMap_Format() (+49 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (44): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+36 more)
...
Cohesion: 0.07
Nodes (41): init(), registerFinanceActions(), init(), registerGoDevActions(), init(), registerResearchActions(), init(), registerStockfishActions() (+33 more)
...
Cohesion: 0.08
Nodes (38): EvolvedAgent, EvolveTool, TestCheckConfidence_ConditionExists(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes() (+30 more)
...
Cohesion: 0.05
Nodes (24): A2AHandoffBlock(), builtinBlocks(), TestBuiltinBlocks_Count(), TestBuiltinBlocks_UniqueNonEmptyIDs(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock() (+16 more)
...
Cohesion: 0.09
Nodes (28): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, Histogram, LabeledCounter, LabeledGauge (+20 more)

### Community 81 - "Community 81"
Cohesion: 0.1
Nodes (40): NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes(), TestAddFromMutation_NoChange(), TestAddFromMutation_NoLLM() (+32 more)
...
Cohesion: 0.07
Nodes (35): countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New() (+27 more)
...
Cohesion: 0.1
Nodes (31): TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), TestStartDriftWatcher_KickTriggersImmediateCheck(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir() (+23 more)
...
Cohesion: 0.08
Nodes (32): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_CachesWithinTTLAndExpires(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), asFloat(), compiledGoapActionFor() (+24 more)
...
Cohesion: 0.11
Nodes (28): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestRunJob_WarnsOnDeployDriftAtCycleComplete(), TestRunJob_WebhookIncludesBuildRevision(), TestRunJobStampsFailureOutcomeWhenRetryExhaustionLeavesItEmpty(), NewScheduler(), decodeRunCount() (+20 more)
...
Cohesion: 0.11
Nodes (27): init(), registerSuperpowersDebugActions(), superpowersDebugPhase(), superpowersDebugPhaseAction(), init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), newGrillLoopTestRun() (+19 more)
...
Cohesion: 0.13
Nodes (28): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionNoopPatchStreak(), goapFusionRepeatedHashBypassed(), goapFusionStateHashes() (+20 more)

### Community 127 - "Community 127"
Cohesion: 0.09
Nodes (22): TestMatchBlockPattern(), AntiPattern, DesignPattern, TestExpert_MatchPattern(), BlockIDFromRef(), containsStr(), coreHeuristics(), hasNodeMatching() (+14 more)
...
Cohesion: 0.08
Nodes (31): Binaries, code:go (type Counter struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), code:go (type AgentCard struct { Name, Description, URL string }) (+23 more)
...
Cohesion: 0.09
Nodes (20): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce() (+12 more)
...
Cohesion: 0.12
Nodes (16): TestDefaultRebuildTargets_PinsFullListIncludingMCPBinary(), buildStampLdflags(), copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), DefaultRebuildTargets(), RebuildBinaries(), resolveGoBinary() (+8 more)
...
Cohesion: 0.15
Nodes (19): apiFetch(), getCookie(), Alert, cbIcon(), createAgent(), deleteAgent(), loadAgents(), populateTreeDropdown() (+11 more)
...
Cohesion: 0.14
Nodes (15): TestRunPipelineWithID_RecordsAgentMetrics(), handleTaskCreate(), isAuctionShapedTask(), PickTreeForTask(), ResolveAgentName(), TestPickTreeForTask_AuctionRoutingBeatsKnowledgeGraph(), TestPickTreeForTask_ConsultsKnowledgeGraphOverStaticSwitch(), TestPickTreeForTask_FallsBackToStaticSwitchWhenGraphUnconfident() (+7 more)
...
Cohesion: 0.26
Nodes (14): TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestHumanApprovalGate_AutoApprove(), TestHumanApprovalGate_ManualApprove(), TestHumanApprovalGate_PostPhase(), BuildAndValidate() (+6 more)
...
Cohesion: 0.21
Nodes (3): DashboardRoutes(), TestDashboardRoutes_SwaggerRoute(), RouteBuilder

### Community 453 - "Community 453"
Cohesion: 0.1
Nodes (4): CreateAgentTool, FitnessTool, GetTreeTool, ReflectTool
...
Cohesion: 0.17
Nodes (9): ApplyHITLPolicy(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait(), HITLConfig, Policy, ApplyConfig(), GetPolicy() (+1 more)
...
Cohesion: 0.23
Nodes (11): TestBuildIdentityStampedRevisionFallback(), BuildIdentityFromBuildInfo(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered(), TestBlockDurationHistogramSeriesRendered(), TestBuildIdentityFromBuildInfo(), TestKGAnalyticsGaugesRenderedAndUpdated(), TestNodeDurationHistogramSeriesRendered() (+3 more)
...
Cohesion: 0.31
Nodes (8): consumerChainPrompts(), TestNotebookLMConsumerTreeDoesNotWatchRetiredGlobOrOwnOutput(), TestNotebookLMConsumerTreeWatchesCurrentResearchNaming(), CEOTree(), CTOTree(), PMTree(), Roles(), TestRoles()
...
Cohesion: 0.2
Nodes (10): code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), Package: langagent, Package: log, Package: reflection (+2 more)
...
## Knowledge Gaps
- **10007 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+10002 more)
...
- **Why does `Append()` connect `Community 3` to `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 13`, `Community 14`, `Community 15`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 32`, `Community 33`, `Community 34`, `Community 36`, `Community 39`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 48`, `Community 49`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 80`, `Community 83`, `Community 84`, `Community 85`, `Community 87`, `Community 88`, `Community 90`, `Community 92`, `Community 94`, `Community 95`, `Community 96`, `Community 98`, `Community 99`, `Community 100`, `Community 101`, `Community 107`, `Community 111`, `Community 114`, `Community 116`, `Community 118`, `Community 119`, `Community 123`, `Community 124`, `Community 127`, `Community 131`, `Community 136`, `Community 139`, `Community 143`, `Community 144`, `Community 146`, `Community 151`, `Community 674`, `Community 163`, `Community 677`, `Community 678`, `Community 167`, `Community 168`, `Community 165`, `Community 171`, `Community 683`, `Community 176`, `Community 178`, `Community 691`, `Community 697`, `Community 188`, `Community 190`, `Community 704`, `Community 194`, `Community 195`, `Community 707`, `Community 198`, `Community 199`, `Community 200`, `Community 203`, `Community 207`, `Community 208`, `Community 211`, `Community 212`, `Community 213`, `Community 217`, `Community 218`, `Community 220`, `Community 221`, `Community 1294`, `Community 916`, `Community 929`, `Community 427`, `Community 429`, `Community 430`, `Community 431`, `Community 950`, `Community 951`, `Community 442`, `Community 956`, `Community 452`, `Community 454`, `Community 457`, `Community 458`, `Community 459`, `Community 460`, `Community 972`, `Community 974`, `Community 981`, `Community 1001`, `Community 1018`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 31` to `Community 3`, `Community 4`, `Community 133`, `Community 5`, `Community 10`, `Community 13`, `Community 15`, `Community 16`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 40`, `Community 425`, `Community 42`, `Community 428`, `Community 430`, `Community 945`, `Community 690`, `Community 50`, `Community 51`, `Community 55`, `Community 443`, `Community 187`, `Community 66`, `Community 68`, `Community 69`, `Community 200`, `Community 80`, `Community 465`, `Community 81`, `Community 214`, `Community 92`, `Community 97`, `Community 106`, `Community 115`, `Community 1019`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 24` to `Community 3`, `Community 4`, `Community 141`, `Community 16`, `Community 19`, `Community 149`, `Community 21`, `Community 27`, `Community 156`, `Community 31`, `Community 34`, `Community 164`, `Community 40`, `Community 430`, `Community 432`, `Community 50`, `Community 55`, `Community 444`, `Community 61`, `Community 66`, `Community 68`, `Community 197`, `Community 198`, `Community 72`, `Community 73`, `Community 74`, `Community 80`, `Community 213`, `Community 214`, `Community 85`, `Community 90`, `Community 92`, `Community 93`, `Community 1383`, `Community 107`, `Community 118`, `Community 119`, `Community 123`, `Community 127`?**
