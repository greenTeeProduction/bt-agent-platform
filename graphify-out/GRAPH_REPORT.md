# Graph Report - superpowers-20260715T145536-9a21d49e-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-15)

## Corpus Check
- 867 files · ~1,034,809 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22946 nodes · 34846 edges · 1862 communities (1502 shown, 360 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8736 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b2a318ae`
...
5. `registerMCPTools()` - 120 edges
6. `arc42 Section 9 — Architecture Decisions` - 114 edges
...
## Communities (1862 total, 360 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (166): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+158 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (166): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+158 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (116): main(), main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview() (+108 more)
...
Cohesion: 0.05
Nodes (107): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+99 more)
...
Cohesion: 0.04
Nodes (105): TestDeprecatedHandler_NoSunset(), TestDeprecatedHandler_WithSunsetDate(), DeprecatedHandler(), TestDeprecatedHandler_WithoutSunset(), TestDeprecatedHandler_WithSunset(), handleLogin(), NewRequest(), DefaultPanicHandler() (+97 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (114): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+106 more)
...
Cohesion: 0.05
Nodes (89): setGoapState(), arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), collapseToSingleLine() (+81 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (93): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+85 more)
...
Cohesion: 0.04
Nodes (74): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+66 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (76): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes() (+68 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (68): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+60 more)
...
Cohesion: 0.04
Nodes (28): Server, AgentMetric, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts() (+20 more)
...
Cohesion: 0.04
Nodes (44): Config, TestBaseNodeCount(), TestGetRetryCount(), TestIsNodeWrapped(), CycleMetrics, cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain() (+36 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (40): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports(), RunContext (+32 more)
...
Cohesion: 0.07
Nodes (48): Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree() (+40 more)
...
Cohesion: 0.07
Nodes (57): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+49 more)

### Community 38 - "Community 38"
Cohesion: 0.07
Nodes (60): Duration(), TestTranspositionTable_SaveLoadRoundTrip(), TestTranspositionTable_Store_EvictionPreservesLowestAmongSurvivors(), TestTranspositionTable_Store_EvictsLowestValueDeterministically(), TestTranspositionTable_Store_EvictsLowestValueRepeated(), TestTranspositionTable_StoreProbeMiss(), TestTranspositionTable_StoreProbeRoundTrip(), TestNewPopulation_Evolution() (+52 more)
...
Cohesion: 0.05
Nodes (41): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait() (+33 more)

### Community 44 - "Community 44"
Cohesion: 0.09
Nodes (55): DefaultLLM(), RealLLM(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), EvaluateBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic() (+47 more)
...
Cohesion: 0.05
Nodes (46): Block, TestComposeAndExpand(), Category, composeOrderedWithMiddle(), ComposePreset(), ComposePresetWithTools(), ComposeTaskTreeAgentic(), ListToolProfileBlocks() (+38 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (53): TestNewReinforcementLearner(), NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation() (+45 more)
...
Cohesion: 0.18
Nodes (47): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+39 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (35): BTOptimizer, TestBTOptimizer_New(), collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestExtractCondition(), TestFindMainSelector() (+27 more)

### Community 55 - "Community 55"
Cohesion: 0.08
Nodes (43): TestNumberSchema(), ArraySchema(), BoolSchema(), IntSchema(), NumberSchema(), ObjectSchema(), TestConvenienceSchemaConstructors(), findResponse() (+35 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (30): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, Histogram, HistogramSnap, LabeledCounter (+22 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (34): TestOutcomeErrorDetail(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath(), hostURLOf() (+26 more)
...
Cohesion: 0.07
Nodes (38): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo(), bareTestRun(), TestApplySuperpowersRunBareRepoRefusedFastForwardParksPendingPatch() (+30 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (27): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), wireSelectorOrdering(), GardenerDeactivateAllTool, GardenerRecommendTool (+19 more)
...
Cohesion: 0.08
Nodes (41): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves(), NewFileJobStore() (+33 more)
...
Cohesion: 0.09
Nodes (41): growthFitness(), FitnessDimension, makeTestTree(), NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance() (+33 more)
...
Cohesion: 0.07
Nodes (25): TestRunOnce_EmitsRunRootSpan(), tracingMiddleware(), fanoutHandler, traceContextHandler, NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent() (+17 more)
...
Cohesion: 0.07
Nodes (31): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+23 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (33): JobsDir(), SchedulerJobsFile(), TestRemoveAgentJobs(), TestApplySchedule_PersistsRegistryAndJobs(), TestDeleteRegisteredAgent(), TestScheduler_SyncFromRegistry_UpdatesChangedSchedule(), ApplySchedule(), DeleteRegisteredAgent() (+25 more)
...
Cohesion: 0.09
Nodes (36): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionPreflightWired(), goapFusionRepeatedHashBypassed() (+28 more)
...
Cohesion: 0.09
Nodes (31): isolateGoapProgramStore(), init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), newGrillLoopTestRun(), TestGrillDesign_ApprovedWhenNoOpenCriticals(), TestGrillDesign_NeedsWorkWithFeedbackWhenCriticalsOpen(), TestGrillDesign_NoProgressBreakerFailsAfterTwoStaleRounds() (+23 more)

### Community 91 - "Community 91"
Cohesion: 0.1
Nodes (35): mockOrch, NewWorkflow(), TestApproval_Fields(), TestApproveTask(), TestExecuteSprint(), TestExecuteSprint_ApprovedToCompleted(), TestExecuteSprint_NoApprovedTasks(), TestExecuteSprint_SetsGoal() (+27 more)
...
Cohesion: 0.09
Nodes (18): AuctionDelegate(), NewPersistentAuctioneer(), cardWithURL(), newAuctionTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoCandidatesFallsBack(), TestAuctionDelegate_NoEligibleBidsFallsBack() (+10 more)
...
Cohesion: 0.08
Nodes (32): Binaries, code:go (type Counter struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }) (+24 more)
...
Cohesion: 0.12
Nodes (21): ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), init(), ApplyBlockMutations(), collectNames(), evolutionApplyAddAfter() (+13 more)
...
Cohesion: 0.11
Nodes (15): handleAnalyze(), handleWorkflowApprove(), handleWorkflowPending(), handleWorkflowReject(), TestCurrentWorkflow_GuardedByMutex(), TestDashboardAPIRoutesHaveOpenAPICoverage(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation() (+7 more)
...
Cohesion: 0.15
Nodes (17): TestGardenerRollbackTool_CallRestoresSnapshot(), GateResult, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree() (+9 more)
...
Cohesion: 0.12
Nodes (16): init(), modal, num, renderTab(), state, TAB_KEYS, renderCompany(), pollLiveData() (+8 more)
...
Cohesion: 0.1
Nodes (12): A2AHandoffBlock(), builtinBlocks(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), MemoryLoadBlock(), MemoryWriteBlock() (+4 more)
...
Cohesion: 0.13
Nodes (13): main(), ApplyHITLPolicy(), NewPageAgent(), TestAgentLLMGeneration(), TestAgentMockFallback(), TestBubbleRecommendation(), NewHandler(), TestHandleBookmark() (+5 more)
...
Cohesion: 0.12
Nodes (13): init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init(), init(), init(), registerSuperpowersConditions(), TestRegisterCondition_And_GetCondition() (+5 more)
...
Cohesion: 0.22
Nodes (11): TestLocalSearcher_New(), TestLocalSearchMutableParamsAndTabu(), extractMutableParams(), getFloatMeta(), NewLocalSearcher(), setFloatMeta(), toFloat64(), LocalSearcher (+3 more)
...
Cohesion: 0.12
Nodes (15): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestSuperpowersWorkflowTree_BuildsAndValidates(), containsLeafChildrenMsg(), TestRunTask_BackstopsEmptyResultOnNonSuccess() (+7 more)
...
Cohesion: 0.29
Nodes (15): NewMockLLM(), NewDefaultCompany(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary(), testLLM(), TestNewDefaultCompany_Values() (+7 more)
...
Cohesion: 0.2
Nodes (11): TestAgentWithRealToolsBlocksFinalAnswerWithoutToolUse(), TestAgentWithRealToolsRejectsFinalAnswerWithoutToolUse(), TestDataPipelineTree_NoSourceReportsBlockedNotFabricated(), TestDataPipelineTree_UsesObservedFileMetrics(), TestNotebookLMTree_PreGateDiscoversRealToolset(), TestRealToolFactory_DiscoveryAndFailClosed(), TestSetupDefaultToolsRegistersRealTools(), allRealToolNames() (+3 more)
...
Cohesion: 0.18
Nodes (11): code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), code:go (type AgentCard struct { Name, Description, URL string }), Package: a2a, Package: log (+3 more)
...
Cohesion: 0.36
Nodes (6): newCatchupFixture(), TestReconcileWithRegistry_EmptyRegistryPreservesJobs(), TestSchedule_PreservesCrashRecoveryImmediateRun(), TestSchedule_PreservesMissedNextRunForCatchUp(), TestSchedule_RecomputesNextRunOnScheduleChange(), testError

### Community 887 - "Community 887"
Cohesion: 0.36
Nodes (6): InitLogExport(), logExportTarget(), newTraceContextHandler(), TestInitLogExport_Idempotent(), TestLogExportTarget(), TestTraceContextHandler_InjectsTraceIDs()
...
## Knowledge Gaps
- **8210 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8205 more)
...
- **Why does `Append()` connect `Community 21` to `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 40`, `Community 41`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 50`, `Community 51`, `Community 54`, `Community 56`, `Community 58`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 65`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 76`, `Community 77`, `Community 1105`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 91`, `Community 93`, `Community 94`, `Community 95`, `Community 608`, `Community 97`, `Community 609`, `Community 99`, `Community 607`, `Community 611`, `Community 103`, `Community 616`, `Community 617`, `Community 615`, `Community 107`, `Community 110`, `Community 624`, `Community 115`, `Community 116`, `Community 120`, `Community 123`, `Community 636`, `Community 124`, `Community 126`, `Community 127`, `Community 131`, `Community 135`, `Community 136`, `Community 137`, `Community 139`, `Community 147`, `Community 157`, `Community 158`, `Community 160`, `Community 162`, `Community 164`, `Community 170`, `Community 171`, `Community 172`, `Community 173`, `Community 178`, `Community 179`, `Community 1205`, `Community 181`, `Community 183`, `Community 185`, `Community 190`, `Community 194`, `Community 199`, `Community 201`, `Community 205`, `Community 207`, `Community 212`, `Community 213`, `Community 215`, `Community 218`, `Community 814`, `Community 819`, `Community 821`, `Community 836`, `Community 840`, `Community 862`, `Community 865`, `Community 385`, `Community 386`, `Community 390`, `Community 393`, `Community 394`, `Community 395`, `Community 396`, `Community 402`, `Community 403`, `Community 404`, `Community 406`, `Community 408`, `Community 409`, `Community 416`, `Community 419`, `Community 420`, `Community 422`, `Community 425`, `Community 426`, `Community 427`, `Community 431`, `Community 435`, `Community 436`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 18` to `Community 3`, `Community 6`, `Community 135`, `Community 398`, `Community 143`, `Community 146`, `Community 21`, `Community 22`, `Community 410`, `Community 26`, `Community 31`, `Community 38`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 1204`, `Community 53`, `Community 56`, `Community 57`, `Community 188`, `Community 61`, `Community 63`, `Community 64`, `Community 67`, `Community 70`, `Community 71`, `Community 72`, `Community 208`, `Community 209`, `Community 211`, `Community 212`, `Community 100`, `Community 110`, `Community 115`, `Community 119`, `Community 127`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 57` to `Community 2`, `Community 130`, `Community 5`, `Community 6`, `Community 392`, `Community 904`, `Community 14`, `Community 15`, `Community 18`, `Community 19`, `Community 22`, `Community 26`, `Community 31`, `Community 417`, `Community 33`, `Community 38`, `Community 41`, `Community 42`, `Community 43`, `Community 48`, `Community 53`, `Community 62`, `Community 190`, `Community 66`, `Community 196`, `Community 837`, `Community 71`, `Community 72`, `Community 202`, `Community 209`, `Community 213`, `Community 102`, `Community 104`, `Community 887`, `Community 115`, `Community 119`?**
