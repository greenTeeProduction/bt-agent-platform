# Graph Report - superpowers-20260715T183421-d423f5f5-goap-fusion-loop-runner-blackboard-conte  (2026-07-15)

## Corpus Check
- 872 files · ~1,045,247 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23219 nodes · 35195 edges · 1863 communities (1509 shown, 354 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8782 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `70654ca2`
...
6. `arc42 Section 9 — Architecture Decisions` - 118 edges
...
## Communities (1863 total, 354 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (170): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+162 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (170): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+162 more)
...
Cohesion: 0.04
Nodes (113): CompressionMiddleware(), gzipDecompress(), TestCompressionMiddleware_AlreadyCompressed(), TestCompressionMiddleware_BinaryContentType(), TestCompressionMiddleware_EmptyBody(), TestCompressionMiddleware_GzipRequest(), TestCompressionMiddleware_HTMLContentType(), TestCompressionMiddleware_LargeJSONResponse() (+105 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (118): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+110 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (84): main(), main(), TestBlackboard_AllFields(), TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails(), TestRunTask_Success(), TestIntegration_ReflectionAndPersistence(), reflectOnOutcomeAction() (+76 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (100): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), truncateGoap(), markGoapFusionImplDegraded(), TestFusionAnalysis_RateLimitCarryoverNotConflatedAsDegradation(), arc42SeedTargetGoal() (+92 more)
...
Cohesion: 0.07
Nodes (90): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+82 more)
...
Cohesion: 0.05
Nodes (73): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle() (+65 more)
...
Cohesion: 0.05
Nodes (81): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+73 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (55): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, Provider, actionStatusString(), cacheCheckAction() (+47 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (85): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+77 more)
...
Cohesion: 0.03
Nodes (58): containsAnyStr(), findChildByName(), TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput() (+50 more)
...
Cohesion: 0.06
Nodes (73): clearSuperpowersPlanState(), ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionNoopPatchStreak(), goapFusionRepeatedHashBypassed() (+65 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (74): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree() (+66 more)
...
Cohesion: 0.07
Nodes (59): fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest(), TestTracingMiddleware_StatusCodes() (+51 more)
...
Cohesion: 0.06
Nodes (35): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, Histogram, HistogramSnap, LabeledCounter (+27 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (45): isolateGoapProgramStore(), TestPrioritizeGoapGoals_AffirmativeBlockerProducesEngineTestGoal(), TestPrioritizeGoapGoals_NoImportCycleFalseGoalFromResearchGap(), init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), newGrillLoopTestRun(), TestGrillDesign_ApprovedWhenNoOpenCriticals() (+37 more)
...
Cohesion: 0.05
Nodes (32): TestRunOnce_EmitsRunRootSpan(), TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeSpan, fakeTracer, mockOllamaServer(), newTestClient() (+24 more)
...
Cohesion: 0.13
Nodes (40): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+32 more)
...
Cohesion: 0.08
Nodes (46): gitOutput(), TestNoCommittedRootBinaries(), isGoapNotebookLMFailure(), extractTaskID(), init(), nlmAuthNeedsRefresh(), nlmAuthUnhealthy(), registerNotebookLMActions() (+38 more)
...
Cohesion: 0.06
Nodes (40): RegistryDir(), SchedulerJobsFile(), TestRemoveAgentJobs(), TestApplySchedule_PersistsRegistryAndJobs(), TestDeleteRegisteredAgent(), TestScheduler_SyncFromRegistry_UpdatesChangedSchedule(), ApplySchedule(), newCatchupFixture() (+32 more)
...
Cohesion: 0.08
Nodes (37): NewDefaultCompany(), CompanyOrchestrator, EngineerTree(), MarketingTree(), SalesTree(), StartupTrees(), clamp(), safeDiv() (+29 more)

### Community 63 - "Community 63"
Cohesion: 0.08
Nodes (41): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField(), extractNotebookLMAnswer() (+33 more)

### Community 64 - "Community 64"
Cohesion: 0.12
Nodes (37): TestRunSuiteIsSandboxed(), TestNoNewGapsOrImplDegraded_IsFallbackEligibleGuard(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled() (+29 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (20): FilterByTreeName(), biasCandidatesWithExperience(), Gardener, baseNodeCount(), recordsForEntry(), TestRecordsForEntry_CollidingUsersFilterByRecordUser(), TestRecordsForEntry_PersonalTreesUseStrictFiltering(), BuildMutationPrompt() (+12 more)
...
Cohesion: 0.08
Nodes (39): cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), crisisMetricsGardener(), crisisV2Config(), experienceRecordingGardener() (+31 more)
...
Cohesion: 0.09
Nodes (27): NewCatalog(), TestCatalog_Export(), TestCatalog_ListInstalled(), TestCatalog_ListTemplates(), TestCatalog_Search(), TestCatalog_SkillToAgent(), TestInferTree(), TestCatalog_EmptyTemplates() (+19 more)
...
Cohesion: 0.12
Nodes (32): buildDeterministicImplementationPlan(), TestRunSuperpowersRuntime_NonRateLimitFailureSetsImplDegraded(), superpowersPlanAlreadyImplemented(), TestSuperpowersPlanAlreadyImplementedRequiresAllTasks(), TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull(), TestBrainstormRejectedWhenFilesNotGoPath(), TestBrainstormRejectedWhenMalformedOrProse() (+24 more)
...
Cohesion: 0.09
Nodes (24): CleanupOldLogs(), NewRotatingWriter(), TestCleanupOldLogs(), TestCleanupOldLogs_NoBackups(), TestNewRotatingWriter_AppendToExisting(), TestNewRotatingWriter_CreatesFile(), TestRotatingWriter_Close(), TestRotatingWriter_MaxBackups() (+16 more)
...
Cohesion: 0.1
Nodes (35): TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestRouteBuilder_SunsetDate(), TestSchemaToMap_Format(), NewOpenAPIGenerator(), NewRoute() (+27 more)

### Community 104 - "Community 104"
Cohesion: 0.11
Nodes (36): TestNumberSchema(), TestRouteBuilder_Build(), ArraySchema(), BoolSchema(), IntSchema(), NumberSchema(), ObjectSchema(), StringSchema() (+28 more)

### Community 105 - "Community 105"
Cohesion: 0.09
Nodes (32): isKnownActionName(), isKnownConditionName(), TestBuildNode_AbortOnEvent(), TestBuildNode_PlannerNode(), TestBuildNode_ReactiveParallel(), TestBuildNode_UtilitySelector(), TestIsKnownActionName_BuiltinOnly(), TestIsKnownActionName_Empty() (+24 more)
...
Cohesion: 0.07
Nodes (17): ContentItem, InputSchema, sanitizeArg(), Message, Property, RPCError, Server, ToolDef (+9 more)
...
Cohesion: 0.1
Nodes (31): DashboardRebuildTargets(), DefaultRebuildTargets(), main(), versionRequested(), ApplyHITLPolicy(), ApplyConfig(), finishProbe(), headerEquals() (+23 more)
...
Cohesion: 0.07
Nodes (23): Config, TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, CollectAgentSLOs(), getRetryCount(), hasNodeNamed() (+15 more)

### Community 119 - "Community 119"
Cohesion: 0.11
Nodes (31): TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter(), TestMutation_AddBefore(), TestMutation_AddFallback(), TestMutation_IncreaseRetries(), TestMutation_PruneNode() (+23 more)
...
Cohesion: 0.1
Nodes (30): loadSuperpowersPlanState(), saveSuperpowersPlanState(), defaultNlmGrillAuthGuard(), nlmGrillAnswerer(), nlmGrillUnavailable(), parseNumberedAnswers(), runGrillAuthGuardAction(), TestNlmGrillAnswerer_AuthGuardFailureIsUnavailable() (+22 more)
...
Cohesion: 0.12
Nodes (23): handleFellows(), NewMockLLM(), DebateTurn, Fellow, DefaultFellows(), NewThinkTank(), Report, ResearchFinding (+15 more)
...
Cohesion: 0.07
Nodes (22): init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init(), init(), init(), registerSuperpowersConditions(), TestRegisterCondition_And_GetCondition() (+14 more)
...
Cohesion: 0.1
Nodes (21): AntiPattern, DesignPattern, BlockIDFromRef(), containsStr(), coreHeuristics(), hasNodeMatching(), hasNodeType(), knownAntiPatterns() (+13 more)
...
Cohesion: 0.11
Nodes (10): acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), enforceIslandCap(), mergeIslandPopulation(), islandArchive, IslandModel (+2 more)
...
Cohesion: 0.16
Nodes (21): DiversityMetrics, EvolutionParameters, FitnessMetrics, BuildPopulationStateWithGrid(), clamp01(), clampMutationRate(), DefaultPhaseRanges(), NewLLMSupervisor() (+13 more)
...
Cohesion: 0.1
Nodes (16): handleWorkflowApprove(), handleWorkflowPending(), handleWorkflowReject(), handleWorkflowRunFullPipeline(), TestCurrentWorkflow_GuardedByMutex(), TestDashboardAPIRoutesHaveOpenAPICoverage(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation() (+8 more)
...
Cohesion: 0.13
Nodes (20): min(), handleAnalyze(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section(), TestGenerateTemplateOutput_TruncatedCache(), TestGenerateTemplateOutput_Arc42Section() (+12 more)
...
Cohesion: 0.15
Nodes (17): handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus() (+9 more)
...
Cohesion: 0.11
Nodes (10): builtinBlocks(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLTieredBlock(), PlanBlock(), QualityGateBlock() (+2 more)
...
Cohesion: 0.2
Nodes (12): handleSprintExecute(), syncWorkflowTaskStatus(), TestHandleSprintExecute_UpdatesCurrentWorkflow(), isAuctionShapedTask(), NewAgentExecutor(), PickTreeForTask(), ResolveAgentName(), TestPickTreeForTask_AuctionRoutingBeatsKnowledgeGraph() (+4 more)
...
Cohesion: 0.2
Nodes (5): DLQEscalateBlock(), FitnessProbeBlock(), TestFitnessProbeAction(), TestMatchBlockPattern(), TestPushToDLQAction()
...
## Knowledge Gaps
- **8372 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8367 more)
...
- **Why does `Append()` connect `Community 13` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 9`, `Community 10`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 27`, `Community 29`, `Community 32`, `Community 33`, `Community 34`, `Community 37`, `Community 39`, `Community 41`, `Community 45`, `Community 46`, `Community 48`, `Community 49`, `Community 52`, `Community 53`, `Community 54`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 70`, `Community 71`, `Community 73`, `Community 76`, `Community 78`, `Community 80`, `Community 81`, `Community 82`, `Community 84`, `Community 85`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 97`, `Community 610`, `Community 98`, `Community 101`, `Community 613`, `Community 103`, `Community 618`, `Community 107`, `Community 112`, `Community 113`, `Community 116`, `Community 117`, `Community 118`, `Community 119`, `Community 632`, `Community 634`, `Community 124`, `Community 126`, `Community 127`, `Community 640`, `Community 128`, `Community 131`, `Community 134`, `Community 135`, `Community 138`, `Community 139`, `Community 141`, `Community 142`, `Community 143`, `Community 144`, `Community 151`, `Community 154`, `Community 164`, `Community 165`, `Community 167`, `Community 168`, `Community 169`, `Community 177`, `Community 178`, `Community 179`, `Community 184`, `Community 185`, `Community 186`, `Community 187`, `Community 193`, `Community 195`, `Community 1220`, `Community 196`, `Community 198`, `Community 203`, `Community 205`, `Community 211`, `Community 212`, `Community 216`, `Community 217`, `Community 219`, `Community 220`, `Community 221`, `Community 821`, `Community 824`, `Community 825`, `Community 844`, `Community 845`, `Community 850`, `Community 863`, `Community 866`, `Community 868`, `Community 873`, `Community 889`, `Community 906`, `Community 396`, `Community 397`, `Community 399`, `Community 400`, `Community 407`, `Community 410`, `Community 411`, `Community 412`, `Community 414`, `Community 415`, `Community 423`, `Community 424`, `Community 431`, `Community 432`, `Community 434`, `Community 435`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 24` to `Community 128`, `Community 2`, `Community 3`, `Community 133`, `Community 138`, `Community 11`, `Community 13`, `Community 14`, `Community 142`, `Community 143`, `Community 401`, `Community 19`, `Community 147`, `Community 403`, `Community 26`, `Community 31`, `Community 166`, `Community 45`, `Community 46`, `Community 48`, `Community 177`, `Community 51`, `Community 54`, `Community 57`, `Community 59`, `Community 1213`, `Community 62`, `Community 196`, `Community 69`, `Community 70`, `Community 75`, `Community 209`, `Community 220`, `Community 93`, `Community 117`, `Community 127`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 51` to `Community 129`, `Community 3`, `Community 133`, `Community 902`, `Community 6`, `Community 137`, `Community 11`, `Community 14`, `Community 15`, `Community 398`, `Community 16`, `Community 20`, `Community 24`, `Community 25`, `Community 26`, `Community 31`, `Community 32`, `Community 33`, `Community 38`, `Community 39`, `Community 40`, `Community 42`, `Community 43`, `Community 46`, `Community 48`, `Community 184`, `Community 59`, `Community 196`, `Community 68`, `Community 838`, `Community 209`, `Community 83`, `Community 222`, `Community 99`, `Community 109`, `Community 110`, `Community 116`?**
