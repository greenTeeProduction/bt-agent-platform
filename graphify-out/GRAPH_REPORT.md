# Graph Report - superpowers-20260717T050620-cc81bd8d-goap-fusion-loop-runner-blackboard-conte  (2026-07-17)

## Corpus Check
- 894 files · ~1,126,038 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25117 nodes · 37722 edges · 1997 communities (1636 shown, 361 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9158 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `68d6072f`
...
3. `NewKnowledgeGraph()` - 142 edges
4. `registerMCPTools()` - 141 edges
5. `9. Architecture Decisions` - 141 edges
...
## Communities (1997 total, 361 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (189): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+181 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (189): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+181 more)
...
Cohesion: 0.03
Nodes (106): ErrorCategory, ApplyJitter(), ClassifyError(), contextDeadlineExceeded(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), ExecuteWithPolicy() (+98 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (97): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+89 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (107): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+99 more)
...
Cohesion: 0.05
Nodes (92): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation() (+84 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (65): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, Provider, actionStatusString(), cacheCheckAction() (+57 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (102): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+94 more)
...
Cohesion: 0.04
Nodes (77): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestNewFileReadTool_Structure() (+69 more)
...
Cohesion: 0.04
Nodes (74): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle(), ComposePreset() (+66 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (72): docgenState, allSections(), buildSectionMap(), contains(), fileHash(), hashSectionSources(), isSectionDone(), main() (+64 more)
...
Cohesion: 0.03
Nodes (30): AgentMetric, Alert, AlertReport, Catalog, extractYAMLField(), inferTree(), splitTags(), CatalogEntry (+22 more)
...
Cohesion: 0.05
Nodes (82): Duration(), TestDuration(), TestTranspositionTable_SaveLoadRoundTrip(), TestTranspositionTable_Store_EvictionPreservesLowestAmongSurvivors(), TestTranspositionTable_Store_EvictsLowestValueDeterministically(), TestTranspositionTable_Store_EvictsLowestValueRepeated(), TestTranspositionTable_StoreProbeMiss(), TestTranspositionTable_StoreProbeRoundTrip() (+74 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (82): IsKnownChainKind(), parseChainConfig(), TestChainAction_ParseConfig(), TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestIsKnownChainKind() (+74 more)
...
Cohesion: 0.06
Nodes (41): DiversityMetrics, EvolutionParameters, extractTreeType(), TestExtractTreeType(), FitnessMetrics, Individual, cloneTree(), collectNodeNames() (+33 more)
...
Cohesion: 0.07
Nodes (71): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), TestNlmQuotaState_PersistsAcrossRuns() (+63 more)
...
Cohesion: 0.06
Nodes (68): blockOnHeldBBMu(), echoTaskLeaf, islandArchivePath(), persistEvolvedWinner(), registerMCPTools(), assertExpertArchiveFedFromRun(), injectSelectorProbeTree(), seedSelectorProbeStats() (+60 more)
...
Cohesion: 0.04
Nodes (24): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, ConcurrencyLimiter, DeadLetterEntry, DeadLetterQueue, executorFailureState (+16 more)
...
Cohesion: 0.06
Nodes (64): captureExporter, TestConfigureOTLPFromEnv(), TestConfigureOTLPFromEnv_DisabledWithoutEndpoint(), TestConsoleTracer_ExporterErrorDoesNotBreakEnd(), TestConsoleTracer_ExporterReceivesCompletedSpan(), fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods() (+56 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (38): tracingMiddleware(), main(), main(), attachLogHandler(), buildBaseHandler(), buildLogger(), Debug(), envLogLevel() (+30 more)
...
Cohesion: 0.11
Nodes (53): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Finance(), TestRouting_Research() (+45 more)

### Community 45 - "Community 45"
Cohesion: 0.08
Nodes (49): NewAgent(), NewDocPlanner(), TestAutomationActions_ReachTaskAutomated(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory() (+41 more)
...
Cohesion: 0.07
Nodes (43): growthFitness(), FitnessDimension, NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic() (+35 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (41): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus() (+33 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (53): TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), collapseToSingleLine(), completeGoapProgramMilestone(), extractGoapResearchGoals(), fallbackGoapGoal(), goapFusionNotebookLMGoalsFromGaps(), goapResearchGapLines() (+45 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (40): TestPromoteRunToAgentScope(), RunDeps, TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), Entry, Limits (+32 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (50): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), saveNlmQuotaExhausted(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField() (+42 more)

### Community 53 - "Community 53"
Cohesion: 0.08
Nodes (37): AuctionDelegate(), NewAuctioneer(), cardWithURL(), newAuctionTransport(), newDeadlineProbeTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoCandidatesFallsBack() (+29 more)

### Community 54 - "Community 54"
Cohesion: 0.09
Nodes (50): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+42 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (39): TestOutcomeErrorDetail(), applyOutcomeRefinement(), IsHealthyOutcome(), OutcomeErrorDetail(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome(), RunOptions, RunResult (+31 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (32): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports(), TestValidateQualitySpec_BlockedPattern() (+24 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (38): HTTPMethod, collectViolations(), fieldPath(), findResponse(), NewRouteIndex(), pathOrRoot(), ResponseValidator(), routeKey() (+30 more)
...
Cohesion: 0.07
Nodes (34): AllSLOMetrics(), GetSLOMetrics(), contains(), stringsContains(), TestAllSLOMetrics(), TestGetSLOMetrics_SameInstance(), TestSLOMetrics_Summary(), LoadSLOEvidence() (+26 more)
...
Cohesion: 0.07
Nodes (29): TestMatchBlockPattern(), AntiPattern, DesignPattern, BlockIDFromRef(), containsStr(), coreHeuristics(), hasNodeMatching(), hasNodeType() (+21 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (35): GateResult, ListRevisions(), loadSnapshotIndex(), RestoreTree(), RestoreTreeRevision(), saveSnapshotIndex(), snapshotIndexPath(), snapshotRevisionPath() (+27 more)
...
Cohesion: 0.06
Nodes (35): TestRunOnce_EmitsRunRootSpan(), TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeTracer, mockOllamaServer(), newTestClient(), TestClient_AnalyzeComplexity() (+27 more)
...
Cohesion: 0.13
Nodes (36): defaultNlmGrillAuthGuard(), runGrillAuthGuardAction(), TestRunGrillAuthGuardAction_PreservesBlackboardResultAndOutcome(), TestRunGrillAuthGuardAction_SuccessReturnsNilAndPreservesBlackboard(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce() (+28 more)
...
Cohesion: 0.05
Nodes (23): A2AHandoffBlock(), builtinBlocks(), TestBuiltinBlocks_Count(), TestBuiltinBlocks_UniqueNonEmptyIDs(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock() (+15 more)
...
Cohesion: 0.09
Nodes (41): TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestRouteBuilder_SunsetDate(), TestSchemaToMap_Format(), NewOpenAPIGenerator(), NewRoute() (+33 more)
...
Cohesion: 0.1
Nodes (34): arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), extractGoapProgram(), runExecutedMilestone(), TestExtractGoapProgramParsesMilestones(), buildUntestedFilesProgramSpec() (+26 more)
...
Cohesion: 0.06
Nodes (19): runDLQReplayScanOnce(), TestDLQReplayScanSurvivesPanicAcrossTicks(), TestRunFullPipeline_NilSynthesis_NoPanic(), TestActionForName_BulkCoverage(), TestSuperpowersTaskVerifyRed_NoTestsFailsWithoutPanic(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), DefaultPanicHandler() (+11 more)
...
Cohesion: 0.08
Nodes (30): TraceParent, traceParentSpan, ContextWithTraceParent(), ExtractTraceParentFromRequest(), ExtractTraceStateFromRequest(), GenerateSpanID(), GenerateTraceID(), GenerateTraceParent() (+22 more)
...
Cohesion: 0.11
Nodes (35): buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), registerSuperpowersProductionActions(), titleSuperpowersVerb(), discardSuperpowersWorktree() (+27 more)

### Community 92 - "Community 92"
Cohesion: 0.08
Nodes (28): TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves(), NewFileJobStore(), NewReadOnlyJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath() (+20 more)

### Community 93 - "Community 93"
Cohesion: 0.09
Nodes (31): collectSelectorNames(), SelectorStatsFile(), TestLocalSearcher_New(), TestSelectorOptimizer_New(), TestSelectorOptimizer_KillerChild(), degeneratePopulation(), runWithoutPanic(), TestEvolve_DegeneratePopulations() (+23 more)
...
Cohesion: 0.1
Nodes (36): mockOrch, NewWorkflow(), TestApproval_Fields(), TestApproveTask(), TestExecuteSprint(), TestExecuteSprint_ApprovedToCompleted(), TestExecuteSprint_NoApprovedTasks(), TestExecuteSprint_SetsGoal() (+28 more)

### Community 98 - "Community 98"
Cohesion: 0.07
Nodes (22): agentExecuteResult(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAlertRules(), handleDLQReplay(), handleMetricsLive() (+14 more)
...
Cohesion: 0.12
Nodes (34): defaultGoapReviewDeps(), gatherFailureReviewBody(), gatherReviewContext(), init(), isGoapNotebookLMQuotaError(), loadLastReviewedSHA(), nextNlmQuotaReset(), nlmQuotaExhausted() (+26 more)
...
Cohesion: 0.07
Nodes (36): Binaries, code:go (type Counter struct { ... }), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }) (+28 more)
...
Cohesion: 0.1
Nodes (30): registerA2ANodes(), TestDelegateToA2A_FnNotConfigured(), TestDelegateToA2A_FnReturnsError(), TestDelegateToA2A_MissingTaskEmptyChainState(), TestDelegateToA2A_MissingURL(), TestDelegateToA2A_Success(), TestDelegateToA2A_UsesTaskFromChainState(), TestHasA2ATarget_EmptyURL() (+22 more)
...
Cohesion: 0.12
Nodes (32): CompressionMiddleware(), gzipDecompress(), TestCompressionMiddleware_AlreadyCompressed(), TestCompressionMiddleware_BinaryContentType(), TestCompressionMiddleware_EmptyBody(), TestCompressionMiddleware_GzipRequest(), TestCompressionMiddleware_HTMLContentType(), TestCompressionMiddleware_LargeJSONResponse() (+24 more)

### Community 114 - "Community 114"
Cohesion: 0.11
Nodes (29): TestEligibleBidders(), TestEligibleBidders_NoRequiredTagsMatchesAll(), BuildCardRegistry(), cardCoversTags(), ConvertToAgentCard(), EligibleBidders(), TestBuildCardRegistry(), TestConvertToAgentCard_Basic() (+21 more)
...
Cohesion: 0.14
Nodes (27): agentNameInterceptor, agentNameKey, ScoreAnnouncement(), BTAgentExecutor, cardResponder, NewServer(), parseAnnouncement(), RespondToAnnouncement() (+19 more)

### Community 121 - "Community 121"
Cohesion: 0.08
Nodes (19): TestDeprecatedHandlerFunc(), TestNumberSchema(), DeprecationHeader, DashboardRoutes(), DeprecatedHandlerFunc(), httpStatusText(), NumberSchema(), TestDeprecatedHandlerFunc_WithSunset() (+11 more)

### Community 122 - "Community 122"
Cohesion: 0.09
Nodes (24): exportMemoryCategory(), exportPreviousRuns(), min(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic() (+16 more)
...
Cohesion: 0.13
Nodes (27): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestRunJob_WarnsOnDeployDriftAtCycleComplete(), TestRunJob_WebhookIncludesBuildRevision(), TestRunJobStampsFailureOutcomeWhenRetryExhaustionLeavesItEmpty(), NewScheduler(), TestScheduler_ReconcileWithRegistry_CreatesMissingYamlScheduledJob() (+19 more)
...
Cohesion: 0.11
Nodes (10): acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), cappedCells(), cappedIndividuals(), mergeSelectorStatsMaps(), persistSelectorStats() (+2 more)
...
Cohesion: 0.16
Nodes (28): isGoapNotebookLMFailure(), TestGoapFusionNotebookLMFailureDetection(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery(), nlmIsResearchImport(), nlmIsResearchStart() (+20 more)
...
Cohesion: 0.14
Nodes (22): convertGoapChildren(), FromGoapNode(), GOAPDevOpsTree(), GOAPPlanningTree(), GOAPResearchTree(), Blackboard, BlackboardBridge, BTNodeType (+14 more)
...
Cohesion: 0.17
Nodes (27): TestRouteBuilder_Build(), ArraySchema(), BoolSchema(), IntSchema(), ObjectSchema(), StringSchema(), TestConvenienceSchemaConstructors(), TestOpenAPIGenerator_Generate() (+19 more)
...
Cohesion: 0.13
Nodes (25): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionPreflightWired(), goapFusionRepeatedHashBypassed() (+17 more)
...
Cohesion: 0.16
Nodes (19): isClaudeRateLimit(), fakeClaude, fakeCommitRunner, hookFailureClass, applyDeterministicCommitFixes(), buildCommitFixPrompt(), classifyHookFailure(), commitFixMaxAttempts() (+11 more)

### Community 171 - "Community 171"
Cohesion: 0.16
Nodes (21): applyScriptRunner, cleanApplyScriptRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo(), blockingMainRepoDirtySummary(), captureSuperpowersWorktreePatch(), commitAppliedSuperpowersRun(), ffRebaseMaxAttempts() (+13 more)
...
Cohesion: 0.13
Nodes (19): Warn(), biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask(), serializeTreeForGardener() (+11 more)
...
Cohesion: 0.22
Nodes (22): NewGoalQueue(), names(), names2(), TestGoalIsSatisfied(), TestGoalQueueAddAndSelect(), TestGoalQueueAddReplace(), TestGoalQueueAll(), TestGoalQueueAllSatisfied() (+14 more)
...
Cohesion: 0.15
Nodes (17): handleFellows(), handleWorkflowRunFullPipeline(), TestHandleWorkflowRunFullPipeline_PersistsWorkflowAndTasks(), NewMockLLM(), DefaultFellows(), NewThinkTank(), TestDefaultFellows(), TestFellowConfidence() (+9 more)
...
Cohesion: 0.14
Nodes (20): nlmGrillAnswerer(), nlmGrillUnavailable(), parseNumberedAnswers(), TestNlmGrillAnswerer_AuthGuardFailureIsUnavailable(), TestNlmGrillAnswerer_EmptyOutputIsUnavailable(), TestNlmGrillAnswerer_NoAnswerMarkersIsUnavailable(), TestNlmGrillAnswerer_QuotaErrorIsUnavailable(), TestNlmGrillAnswerer_ValidOutputReturnsMap() (+12 more)
...
Cohesion: 0.14
Nodes (17): BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir() (+9 more)
...
Cohesion: 0.14
Nodes (16): UsersDir(), TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree() (+8 more)
...
Cohesion: 0.17
Nodes (19): NewDefaultCompany(), CompanyState, Decision, QuarterResult, companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary() (+11 more)

### Community 197 - "Community 197"
Cohesion: 0.18
Nodes (17): TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestHumanApprovalGate_AutoApprove(), TestHumanApprovalGate_ManualApprove(), TestHumanApprovalGate_PostPhase(), BuildAndValidate() (+9 more)
...
Cohesion: 0.2
Nodes (17): bareApplyScriptRunner, assertNoForcedMasterWrite(), bareTestRun(), TestApplySuperpowersRunBareRepoDetachedHeadDoesNotRebase(), TestApplySuperpowersRunBareRepoFfRebaseAttemptsBounded(), TestApplySuperpowersRunBareRepoRebaseConflictAbortsAndParks(), TestApplySuperpowersRunBareRepoRebaseSucceedsButReverifyFails(), TestApplySuperpowersRunBareRepoRefusedFastForwardParksPendingPatch() (+9 more)

### Community 200 - "Community 200"
Cohesion: 0.1
Nodes (6): FitnessTool, GetReflectionsTool, GetTreeTool, truncateStr(), ReflectTool, RunTaskTool
...
Cohesion: 0.15
Nodes (18): TestPromoteSubtree(), init(), ApplyBlockMutations(), blockIDFromOp(), collectNames(), evolutionApplyAddAfter(), evolutionApplyAddBefore(), extractSubtree() (+10 more)
...
Cohesion: 0.18
Nodes (18): NewEvolvedAgent(), TestConfig_AllFields(), TestCreateAgentTool_Call_NilFactory(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestNewEvolvedAgent_AllToolsRegistered() (+10 more)

### Community 209 - "Community 209"
Cohesion: 0.12
Nodes (14): TestExpertKnowledge_SeedSpecialistsCarryProvenance(), TestPopulationEvolve_ResurrectsExtinctSpecialist(), TestPopulationHealthSnapshot_DiversityCollapseRun(), TestMemeticEvolve_ResurrectsExtinctSpecialist(), TestNSGAIIPopulation_Evolve_ResurrectsExtinctSpecialist(), appendResurrectedTag(), firstSpecialistType(), itoa() (+6 more)
...
Cohesion: 0.27
Nodes (18): autofixScriptRunner, autofixScriptStep, TestChangedPackagesLintCommandMirrorsHookGate(), changedPackagesLintCommand(), changedPackagesLintFixCommand(), VerifySuperpowersRunRuntime(), autofixVerifyRun(), TestChangedPackagesLintFixCommandInsertsFixFlag() (+10 more)

### Community 215 - "Community 215"
Cohesion: 0.13
Nodes (16): TestDriftWatchOnce_SkipsRestartWhenJobStartedMidRebuild(), TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), TestStartDriftWatcher_KickTriggersImmediateCheck(), RegistryDir(), newCatchupFixture(), TestCycleBreakerSuccess_HealthyOutcomesDoNotTripBreaker(), TestCycleBreakerSuccessTreatsRateLimitCarryoverAsHealthy() (+8 more)
...
Cohesion: 0.12
Nodes (12): handleAnalyze(), handleTrees(), handleWorkflowApprove(), handleWorkflowPending(), handleWorkflowReject(), TestCurrentWorkflow_GuardedByMutex(), TestDashboardAPIRoutesHaveOpenAPICoverage(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses() (+4 more)
...
Cohesion: 0.17
Nodes (15): CollectBlockIDs(), FitnessRanking(), RecordTaskBlockFitness(), ScoreFromBlackboard(), TestRecordTaskBlockFitness(), BlockFitnessRanking(), BlockFitnessSnapshot(), BlockMetricsSnapshot() (+7 more)
...
Cohesion: 0.16
Nodes (15): handleAgentRun(), handleSprintExecute(), syncWorkflowTaskStatus(), TestHandleSprintExecute_UpdatesCurrentWorkflow(), DefaultAgentTask(), TestDefaultAgentTask(), isAuctionShapedTask(), NewAgentExecutor() (+7 more)
...
Cohesion: 0.11
Nodes (17): arc42 Docs Consolidation & Per-Section Sync Nodes — Implementation Plan, Canonical section layout (used by merge tasks, Go manifest, and drift script — keep all three in lockstep), code:bash (grep -F '## 10.1 Quality Tree' docs/arc42/10-quality.md && g), code:bash (# ----- 5. arc42 section files validation -----), code:bash (bash scripts/check-doc-drift.sh; echo "exit=$?"), code:bash (grep -c 'RegisterAction(' internal/engine/*.go | awk -F: '{s), code:bash (grep -c '^| Q[0-9] | \*\*' docs/arc42/01-introduction-goals.), code:bash (for f in 02-constraints 03-context-scope 04-solution-strateg) (+9 more)
...
Cohesion: 0.2
Nodes (15): EngineerTree(), MarketingTree(), SalesTree(), StartupTrees(), CEOTree(), CTOTree(), PMTree(), Roles() (+7 more)
...
Cohesion: 0.16
Nodes (13): ExportedEvent, ExportedSpan, ConfigureOTLPFromEnv(), firstNonEmpty(), NewOTLPHTTPExporter(), otlpTracePayload(), parseOTLPHeaders(), stableHexID() (+5 more)

### Community 450 - "Community 450"
Cohesion: 0.15
Nodes (10): TestCreateAgentTool_Call_NilFactory(), TestRunTaskTool_Call(), TestToolNames_And_Descriptions(), GetReflectionsTool, RunTaskTool, NewCreateAgentTool(), NewFitnessTool(), NewGetTreeTool() (+2 more)

### Community 451 - "Community 451"
Cohesion: 0.16
Nodes (13): Block, TestComposeAndExpand(), Category, ComposeSpec, TestExpand_BlockMetadata(), Expand(), expandNode(), HasSubTreeRefs() (+5 more)
...
Cohesion: 0.21
Nodes (11): TestCurrentSuperpowersRunRefusesFinishedRun(), currentSuperpowersRun(), newSuperpowersRunID(), superpowersPlanAttemptSaturated(), superpowersPlanAttemptSaturatedInDir(), superpowersTaskHashSuffix(), TestSafeSlug(), TestSuperpowersPlanAttemptSaturatedInDir() (+3 more)
...
Cohesion: 0.2
Nodes (7): CompanyOrchestrator, clamp(), safeDiv(), TestClamp(), TestNilClamp_NoPanic(), TestNilSafeDiv_NoPanic(), TestSafeDiv()

### Community 669 - "Community 669"
Cohesion: 0.24
Nodes (11): mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu(), TestBTBlocksComposeSaveHoldsServerLock() (+3 more)
...
Cohesion: 0.21
Nodes (9): fakeSuperpowersReviewRunner, fixedDiffRunner, buildSuperpowersReviewPrompt(), parseSuperpowersReviewVerdict(), superpowersTaskReview(), TestParseSuperpowersReviewVerdict(), TestSuperpowersTaskGreenAction_InjectsReviewFeedbackWhenPresent(), TestSuperpowersTaskGreenAction_NoFeedback_PromptUnchanged() (+1 more)
...
Cohesion: 0.3
Nodes (10): banditChildKey(), banditLockFor(), banditStatsDir(), banditStatsPath(), banditUCB1Order(), BuildBanditSelector(), recordBanditOutcome(), saveBanditStats() (+2 more)
...
Cohesion: 0.2
Nodes (5): DLQEscalateBlock(), FitnessProbeBlock(), TestAuditLogAction(), TestFitnessProbeAction(), TestPushToDLQAction()
...
Cohesion: 0.2
Nodes (10): code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), Package: factory, Package: knowledge, Package: llm (+2 more)
...
Cohesion: 0.36
Nodes (8): Alert, cbIcon(), createAgent(), deleteAgent(), loadAgents(), runAgent(), toggleAgentBlackboard(), viewAgentBlackboard()
...
Cohesion: 0.22
Nodes (9): code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), Package: evaluator, Package: gardener, Package: goap (+1 more)
...
Cohesion: 0.29
Nodes (7): code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), Package: api, Package: benchmark, Package: persona, Package: tracing
...
## Knowledge Gaps
- **9486 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+9481 more)
...
- **Why does `Append()` connect `Community 19` to `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 30`, `Community 32`, `Community 35`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 43`, `Community 44`, `Community 45`, `Community 47`, `Community 48`, `Community 52`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 73`, `Community 74`, `Community 75`, `Community 76`, `Community 78`, `Community 81`, `Community 82`, `Community 84`, `Community 85`, `Community 86`, `Community 90`, `Community 92`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 100`, `Community 102`, `Community 103`, `Community 106`, `Community 108`, `Community 114`, `Community 121`, `Community 122`, `Community 123`, `Community 125`, `Community 126`, `Community 128`, `Community 133`, `Community 135`, `Community 137`, `Community 139`, `Community 141`, `Community 147`, `Community 148`, `Community 152`, `Community 668`, `Community 160`, `Community 163`, `Community 164`, `Community 165`, `Community 167`, `Community 680`, `Community 172`, `Community 173`, `Community 174`, `Community 687`, `Community 688`, `Community 692`, `Community 185`, `Community 1212`, `Community 1214`, `Community 200`, `Community 201`, `Community 203`, `Community 204`, `Community 205`, `Community 206`, `Community 207`, `Community 208`, `Community 209`, `Community 217`, `Community 222`, `Community 224`, `Community 225`, `Community 898`, `Community 899`, `Community 914`, `Community 915`, `Community 921`, `Community 418`, `Community 420`, `Community 422`, `Community 423`, `Community 424`, `Community 425`, `Community 944`, `Community 945`, `Community 438`, `Community 441`, `Community 442`, `Community 449`, `Community 451`, `Community 454`, `Community 455`, `Community 967`, `Community 456`, `Community 457`, `Community 459`, `Community 466`, `Community 467`, `Community 468`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 55` to `Community 5`, `Community 6`, `Community 14`, `Community 15`, `Community 16`, `Community 915`, `Community 20`, `Community 21`, `Community 917`, `Community 26`, `Community 29`, `Community 30`, `Community 34`, `Community 420`, `Community 37`, `Community 38`, `Community 426`, `Community 173`, `Community 46`, `Community 49`, `Community 946`, `Community 54`, `Community 59`, `Community 191`, `Community 193`, `Community 66`, `Community 67`, `Community 449`, `Community 197`, `Community 83`, `Community 215`, `Community 987`, `Community 219`, `Community 92`, `Community 113`, `Community 120`, `Community 127`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 49` to `Community 130`, `Community 901`, `Community 134`, `Community 13`, `Community 14`, `Community 17`, `Community 20`, `Community 923`, `Community 29`, `Community 414`, `Community 158`, `Community 420`, `Community 37`, `Community 38`, `Community 36`, `Community 173`, `Community 946`, `Community 54`, `Community 57`, `Community 58`, `Community 449`, `Community 76`, `Community 215`, `Community 98`, `Community 106`, `Community 111`, `Community 113`, `Community 121`, `Community 125`?**
...
- **Are the 140 inferred relationships involving `NewKnowledgeGraph()` (e.g. with `TestComputeAnalytics_EmptyGraph()` and `TestComputeAnalytics_Centrality()`) actually correct?**
  _`NewKnowledgeGraph()` has 140 INFERRED edges - model-reasoned connections that need verification._