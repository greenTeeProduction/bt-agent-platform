# Graph Report - superpowers-20260716T060244-c1dd1087-goap-fusion-loop-runner-blackboard-conte  (2026-07-16)

## Corpus Check
- 891 files · ~1,081,241 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23840 nodes · 36135 edges · 1909 communities (1553 shown, 356 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8998 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c4b854d3`
...
1. `Append()` - 392 edges
2. `DefaultTree()` - 151 edges
3. `NewRequest()` - 135 edges
4. `NewKnowledgeGraph()` - 133 edges
5. `registerMCPTools()` - 133 edges
6. `arc42 Section 9 — Architecture Decisions` - 127 edges
7. `BuildTree()` - 111 edges
8. `newDefaultConfig()` - 100 edges
9. `sleep()` - 95 edges
10. `main()` - 80 edges
...
## Communities (1909 total, 356 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (177): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+169 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (177): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+169 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (101): expandChainStateTemplates(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM(), TestChainAction_Agent_NoTools() (+93 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (127): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+119 more)
...
Cohesion: 0.04
Nodes (93): saveGoapFusionStateHashes(), TestRunScheduledGoapFusionLoop_RunawayBackstopIsHalfOpen(), arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), newLoopBB(), TestClearGoapFusionStateHashes() (+85 more)
...
Cohesion: 0.06
Nodes (90): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+82 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (75): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewGoTestTool_Structure() (+67 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (76): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), Category, Compose() (+68 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (88): TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails(), TestRunTask_KnowledgeGap_RoutesToKnowledgePath(), TestRunTask_Success(), reflectOnOutcomeAction(), TestReflectOnOutcomeAction_NilLLM(), TestReflectOnOutcomeAction_WithMockLLM(), NewTranspositionTable() (+80 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (83): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+75 more)
...
Cohesion: 0.05
Nodes (81): echoTaskLeaf, mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection() (+73 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (64): OpenAPIGenerator, Append(), mockTTOrch, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay() (+56 more)
...
Cohesion: 0.05
Nodes (60): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree() (+52 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (64): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+56 more)
...
Cohesion: 0.05
Nodes (64): TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents(), TestBuildFromArchetype(), TestConnect_Duplicate(), TestConnect_GlobalGraph() (+56 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (53): main(), BTStudioCompany(), requireOllamaFinanceTest(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis(), TestTeslaMarket(), TestTeslaModel() (+45 more)
...
Cohesion: 0.07
Nodes (68): DefaultLLM(), RealLLM(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic(), TestBFCLV3_MultiTurn_Composite() (+60 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (40): findChildByName(), TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords() (+32 more)
...
Cohesion: 0.06
Nodes (54): AgentDefinition, ContentType, TestMustParseAgentDefinition_PanicsOnInvalid(), TestMustParseAgentDefinition_Valid(), TestNumberIn_InvalidNumberString(), TestNumberIn_Matching(), TestNumberIn_NotFound(), TestNumberValue_Float64() (+46 more)
...
Cohesion: 0.14
Nodes (53): TestBTPG_QualityMetrics_AllDomainTrees(), agentTemplateYAML, AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality() (+45 more)

### Community 39 - "Community 39"
Cohesion: 0.08
Nodes (57): TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_PruningOnNodeExplosion(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune(), makeRecords() (+49 more)
...
Cohesion: 0.05
Nodes (31): agentExecuteResult(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay() (+23 more)
...
Cohesion: 0.07
Nodes (40): TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir() (+32 more)
...
Cohesion: 0.08
Nodes (41): IntSchema(), ObjectSchema(), NewRouteIndex(), ResponseValidator(), TestDashboardRoutes_AllIndexable(), TestNewRouteIndex(), TestNewRouteIndex_Empty(), TestResponseValidator_DriftLogging() (+33 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (38): min(), brokenTool, generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section(), TestGenerateTemplateOutput_TruncatedCache(), TestBuildChainAction_ReturnsNonNil() (+30 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (39): BuildBudget(), budgetCmd, BuildCachedCondition(), BuildChainAction(), parseChainConfig(), TestChainAction_ParseConfig(), BuildCircuitBreaker(), BuildInverter() (+31 more)
...
Cohesion: 0.06
Nodes (41): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+33 more)

### Community 58 - "Community 58"
Cohesion: 0.1
Nodes (46): TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestRouteBuilder_Build(), TestRouteBuilder_SunsetDate(), TestSchemaToMap_Format(), ArraySchema() (+38 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (32): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, scriptedClaudeRunner, scriptedSuperpowersRunner, applySuperpowersRunToMainRepo(), bareTestRun() (+24 more)
...
Cohesion: 0.06
Nodes (30): BuildTaskFromInputs(), ParseInputParams(), TestBuildTaskFromInputs(), TestParseInputParams(), TestValidateInputs_Default(), TestValidateInputs_File(), TestValidateInputs_JSON(), TestValidateInputs_Required() (+22 more)
...
Cohesion: 0.06
Nodes (32): Blackboard, ChildTick, childTickLog, init(), TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern() (+24 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (31): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), asFloat(), compiledGoapActionFor(), compiledGoapConditionFor() (+23 more)

### Community 65 - "Community 65"
Cohesion: 0.13
Nodes (35): TestNoNewGapsOrImplDegraded_IsFallbackEligibleGuard(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled(), TestBanditSelector_DisabledMatchesSelectorSemantics() (+27 more)
...
Cohesion: 0.1
Nodes (33): NewMockLLM(), NewDefaultCompany(), CompanyOrchestrator, EngineerTree(), MarketingTree(), SalesTree(), StartupTrees(), clamp() (+25 more)

### Community 70 - "Community 70"
Cohesion: 0.07
Nodes (23): main(), main(), attachLogHandler(), buildBaseHandler(), buildLogger(), envLogLevel(), Error(), Init() (+15 more)
...
Cohesion: 0.1
Nodes (17): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_Existing(), TestAutoCreateTree_New(), TestDetermineCategory(), TestExtractKeywords(), TestTruncateTask(), Factory, AutoCreateTree() (+9 more)
...
Cohesion: 0.07
Nodes (32): TestNewReinforcementLearner(), TestEvolveWithExperience_ResurrectsExtinctSpecialist(), TestQTableSelectUpdateBestAction(), TestQTableStateBucketsAndDepth(), TestReinforcementLearnerLearnAndSuggest(), NewQTable(), NewReinforcementLearner(), TestExpertKnowledge_ObservesLearnedPatternFromQLearning() (+24 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (30): CategorizedError, ErrorContext, ClassifyError(), contextDeadlineExceeded(), isAuthError(), isLLMError(), isNetworkError(), isRateLimitError() (+22 more)

### Community 79 - "Community 79"
Cohesion: 0.11
Nodes (39): ParallelMode, intSliceFromInterface(), BuildReactiveParallel(), childPanicHandler(), forkBlackboard(), intSliceFromInterface(), runReactiveParallel(), evaluateGuardCondition() (+31 more)
...
Cohesion: 0.08
Nodes (15): jaccardSimilarity(), TestJaccardSimilarity(), TestTokenize(), tokenize(), ExperienceBank, ExperienceEntry, acquireExperienceLock(), TestAcquireExperienceLockMissingDir() (+7 more)

### Community 83 - "Community 83"
Cohesion: 0.12
Nodes (39): Duration(), TestPopulation_StatsAccessors(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes() (+31 more)
...
Cohesion: 0.09
Nodes (36): TestCheckConfidence_ConditionExists(), TestIntegration_MutationOperators(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure() (+28 more)
...
Cohesion: 0.07
Nodes (14): Capability, Edge, templateRunCount(), templateSelectionWeight(), templateStructuralFitness(), evolvedFitness(), blendedSelectionFitness(), coldStartConfidence() (+6 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (34): findNode(), resolverReachableExtraDomainTrees(), singleTaskSuite(), tasksForTree(), TestAgentMonitor(), TestAllDomainTreeConditionsHaveDescriptions(), TestAllDomainTreeNodesHaveDescriptions(), TestAllDomainTrees() (+26 more)
...
Cohesion: 0.13
Nodes (15): extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), collectNodeNames(), containsCrisisReason(), Crossover(), ExperienceRetrievalHits() (+7 more)
...
Cohesion: 0.11
Nodes (31): BehavioralDescriptor, FeatureDimension, Bucket(), Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid(), NewMAPElitesPopulation(), cellFitnesses() (+23 more)
...
Cohesion: 0.07
Nodes (20): perTreeStats(), TestHasNodeNamed(), TestMetricsTracker_BestFitnessTracking(), TestMetricsTracker_ImprovementRate(), TestMetricsTracker_LastFitnessTracking(), TestMetricsTracker_RecordAndCyclesForTree(), TestMetricsTracker_SaveAndLoadRoundTrip(), TestMetricsTracker_SaveNewDir() (+12 more)

### Community 122 - "Community 122"
Cohesion: 0.07
Nodes (24): Config, TestGetRetryCount(), TestIsNodeWrapped(), CycleMetrics, TestHasChildNamed_DeepNested(), TestHasChildNamed_Found(), TestHasChildNamed_NoChildren(), TestHasChildNamed_NotFound() (+16 more)
...
Cohesion: 0.09
Nodes (29): TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), RegistryDir(), newCatchupFixture(), TestReconcileWithRegistry_EmptyRegistryPreservesJobs(), TestSchedule_PreservesCrashRecoveryImmediateRun(), TestSchedule_PreservesMissedNextRunForCatchUp(), TestSchedule_RecomputesNextRunOnScheduleChange() (+21 more)

### Community 129 - "Community 129"
Cohesion: 0.13
Nodes (28): TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull(), TestBrainstormRejectedWhenFilesNotGoPath(), TestBrainstormRejectedWhenMalformedOrProse(), TestBrainstormRejectedWhenNotDeeper(), TestBrainstormRejectedWhenRunOmitsShort(), withBrainstorm(), brainstormExpandPlan() (+20 more)
...
Cohesion: 0.08
Nodes (21): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus() (+13 more)

### Community 136 - "Community 136"
Cohesion: 0.08
Nodes (31): Binaries, code:go (type Counter struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }) (+23 more)
...
Cohesion: 0.1
Nodes (23): gitOutput(), TestNoCommittedRootBinaries(), extractTaskID(), init(), nlmAuthNeedsRefresh(), nlmAuthUnhealthy(), registerNotebookLMActions(), writeString() (+15 more)
...
Cohesion: 0.11
Nodes (28): DashboardRebuildTargets(), DefaultRebuildTargets(), main(), finishProbe(), headerEquals(), headerPresent(), probeCSRFCookie(), ProbeDashboard() (+20 more)
...
Cohesion: 0.1
Nodes (19): TestMatchBlockPattern(), AntiPattern, DesignPattern, BlockIDFromRef(), containsStr(), coreHeuristics(), hasNodeType(), knownAntiPatterns() (+11 more)
...
Cohesion: 0.13
Nodes (17): NewACPClient(), sameJSONID(), scanJSONLines(), startScanJSONLines(), countCrashInvocations(), TestACPClientCircuitBreakerShortCircuitsRepeatedSubprocessFailures(), TestACPClientGenerateReturnsErrorWhenSessionMissing(), TestACPClientGenerateTalksToACPServer() (+9 more)
...
Cohesion: 0.12
Nodes (25): goapFusionNoopPatchStreak(), defaultNlmGrillAuthGuard(), nlmGrillAnswerer(), nlmGrillUnavailable(), parseNumberedAnswers(), runGrillAuthGuardAction(), TestGoapFusionNoopPatchStreak_DurableAcrossCronTicks(), TestGoapFusionNoopPatchStreak_IncrementsOnNoopResetsOnChange() (+17 more)

### Community 162 - "Community 162"
Cohesion: 0.11
Nodes (21): handleAnalyze(), handleSprintExecute(), handleWorkflowRunFullPipeline(), syncWorkflowTaskStatus(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation(), TestHandleSprintExecute_UpdatesCurrentWorkflow(), TestHandleWorkflowRunFullPipeline_PersistsWorkflowAndTasks() (+13 more)
...
Cohesion: 0.13
Nodes (23): init(), registerGoDevActions(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+15 more)
...
Cohesion: 0.1
Nodes (23): collectDiscoverIDs(), TestDiscover_RegisterNotStarvedBySlowEmbeddingCall(), TestDiscoverRelated_Bidirectional(), TestDiscoverRelated_ConnectedFrom(), TestDiscoverRelated_ConnectedTo(), TestDiscoverRelated_Deduplicates(), TestDiscoverRelated_EmptyGraph(), TestDiscoverRelated_NonExistentTree() (+15 more)
...
Cohesion: 0.2
Nodes (22): assertInvalidContains(), buildDeepTree(), TestBuildTree_InvalidTreeReturnsFailureCommand(), TestValidateTree_CycleDeep(), TestValidateTree_CycleDetected(), TestValidateTree_NoCycle(), TestVerifierFull_AlwaysSucceedRejectsChildren(), TestVerifierFull_BackwardCompat() (+14 more)
...
Cohesion: 0.14
Nodes (9): TestNumberSchema(), BoolSchema(), DashboardRoutes(), NumberSchema(), TestConvenienceSchemaConstructors(), TestDashboardRoutes_AllHaveOperationIDs(), TestDashboardRoutes_OperationIDUniqueness(), TestRouteBuilder_FluentAPI() (+1 more)
...
Cohesion: 0.15
Nodes (17): TestDetectPath_FromCurrentPath(), TestDetectPath_FromVisitedPaths(), TestDetectPath_KeywordFallback(), TestDetectPath_DataPipelineKeywordFallback(), TestDetectPath_SecurityKeywordFallback(), detectPath(), BuiltinToolBench(), EvaluateToolBench() (+9 more)
...
Cohesion: 0.3
Nodes (20): swapErrorHandlerRunner(), TestRequestErrorHandlerProposal_RespectsCallerContext(), TestRequestErrorHandlerProposal_StampsLedgerOnEveryOutcome(), ehTestHandlerNode(), ehTestProposalJSON(), runHandler(), TestClaudeErrorHandler_BuildSwitchAndValidation(), TestClaudeErrorHandler_CapReachedSkipsClaude() (+12 more)

### Community 219 - "Community 219"
Cohesion: 0.13
Nodes (17): NewOpenAICompatClient(), TestOpenAICompat_ErrorResponse(), TestOpenAICompat_GenerateWithModel_SendsChatCompletion(), OpenAICompatConfig, openAICompatMessage, openAICompatRequest, openAICompatResponse, rateLimitedServer() (+9 more)
...
Cohesion: 0.14
Nodes (12): buildStampLdflags(), copyFile(), defaultRebuildBuild(), defaultRebuildMaterialize(), NewRebuildBackoff(), RebuildBinaries(), resolveGoBinary(), TestBuildStampLdflagsInRepo() (+4 more)
...
Cohesion: 0.12
Nodes (16): TestDeprecatedHandlerFunc(), DeprecationHeader, DeprecatedHandlerFunc(), httpStatusText(), TestDeprecatedHandlerFunc_WithSunset(), TestHTTPStatusText(), toAnySlice(), OpenAPIComponents (+8 more)
...
Cohesion: 0.22
Nodes (13): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired(), NewMetaValidator(), hasMetaIssue() (+5 more)
...
Cohesion: 0.26
Nodes (13): TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestHumanApprovalGate_AutoApprove(), TestHumanApprovalGate_ManualApprove(), TestHumanApprovalGate_PostPhase(), BuildAndValidate() (+5 more)
...
Cohesion: 0.12
Nodes (16): 5.0 Composable building blocks (`internal/blocks`), 5.1 Whitebox Overall System, 5.2 Level 2: Core Engine Whitebox, 5.3 Level 2: Evolution Engine Whitebox, 5.4 Level 2: Dashboard Whitebox, 5.5 Level 3: Chain Types Detail, 5.6 Planned Building Blocks — Personalized Self-Evolving Agents (ADR-010), arc42 Section 5 — Building Block View (+8 more)
...
Cohesion: 0.13
Nodes (15): cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), TestCloneTreeForGardener_Basic(), TestCloneTreeForGardener_DoubleNested(), TestCloneTreeForGardener_Nil() (+7 more)
...
Cohesion: 0.18
Nodes (11): DiskInfo, GardenerMetrics, MemInfo, Metrics, collectSystem(), loadGardenerMetrics(), TestLoadGardenerMetricsParsesAggregateDocument(), TestLoadGardenerMetricsParsesRollbacks() (+3 more)
...
Cohesion: 0.14
Nodes (13): code:text (docs/superpowers/runs/<run-id>/), code:go (sel("Phase1_Design",), code:markdown (### Task N: Title), code:go (func SuperpowersPipelineTree() *evolution.SerializableNode {), code:yaml (name: superpowers-prod-runner), Current Stub Surface To Replace, Done Definition, Production Acceptance Criteria (+5 more)
...
Cohesion: 0.17
Nodes (11): 7.1 Infrastructure Level 1, 7.2.1 Process Tree, 7.2.2 Storage Layout, 7.2.3 Network Topology, 7.2 Infrastructure Level 2, arc42 Section 7 — Deployment View, code:block1 (systemd --user), code:block2 (~/.go-bt-evolve/) (+3 more)
...
Cohesion: 0.18
Nodes (10): 8.1 Behavior Tree Execution Model, 8.2 ChainAction Nodes, 8.3 MCP Protocol Layer, 8.4 File-Based Persistence, 8.5 Evolution Pipeline, 8.6 Error Resiliency, 8.7 Quality Gates, 8.8 Tool Protocol (+2 more)
...
Cohesion: 0.2
Nodes (9): 6.1 Task Execution Scenario, 6.2 Evolution Cycle, 6.3 Sprint Execution, 6.4 Error Recovery, arc42 Section 6 — Runtime View, code:block1 (Hermes Agent                    bt-agent (MCP)              ), code:block2 (Gardener                       bt-evaluator (MCP)           ), code:block3 (Browser                         bt-dashboard (:9800)        ) (+1 more)
...
Cohesion: 0.22
Nodes (3): NewTrackRecord(), TrackRecord, TrackRecordRun
...
Cohesion: 0.29
Nodes (6): 1.1 Requirements Overview, 1.1a Target Vision — Personalized Self-Evolving Agents (Roadmap), 1.2 Quality Goals (Top 3), 1.2 Quality Goals (Top 4), 1.3 Stakeholders, arc42 Section 1 — Introduction and Goals
...
Cohesion: 0.4
Nodes (4): 10.1 Quality Tree, 10.2 Quality Scenarios, arc42 Section 10 — Quality Requirements, code:block1 (go-bt-evolve)

### Community 1210 - "Community 1210"
Cohesion: 0.4
Nodes (4): arc42 Section 2 — Architecture Constraints, Conventions, Organizational Constraints, Technical Constraints
...
Cohesion: 0.83
Nodes (3): addUniqueError(), sideEffectClass(), walkValidate()
...
Cohesion: 0.5
Nodes (3): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact()
...
Cohesion: 0.5
Nodes (3): arc42 Section 4 — Solution Strategy, Key Technology Decisions, Quality Goals → Solution Approaches

### Community 1280 - "Community 1280"
Cohesion: 0.5
Nodes (3): arc42 Section 11 — Risks and Technical Debt, Known Technical Debt, Prioritized Risk Table
...
## Knowledge Gaps
- **8698 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8693 more)
...
- **Why does `Append()` connect `Community 18` to `Community 2`, `Community 5`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 27`, `Community 28`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 37`, `Community 39`, `Community 41`, `Community 43`, `Community 45`, `Community 46`, `Community 47`, `Community 51`, `Community 52`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 61`, `Community 62`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 75`, `Community 77`, `Community 79`, `Community 81`, `Community 82`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 90`, `Community 91`, `Community 93`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 100`, `Community 102`, `Community 106`, `Community 109`, `Community 111`, `Community 122`, `Community 123`, `Community 125`, `Community 126`, `Community 128`, `Community 130`, `Community 645`, `Community 646`, `Community 647`, `Community 133`, `Community 138`, `Community 1163`, `Community 140`, `Community 141`, `Community 139`, `Community 1167`, `Community 144`, `Community 148`, `Community 664`, `Community 154`, `Community 155`, `Community 156`, `Community 671`, `Community 672`, `Community 674`, `Community 162`, `Community 676`, `Community 165`, `Community 166`, `Community 171`, `Community 172`, `Community 174`, `Community 181`, `Community 182`, `Community 187`, `Community 188`, `Community 194`, `Community 195`, `Community 196`, `Community 199`, `Community 200`, `Community 205`, `Community 206`, `Community 207`, `Community 209`, `Community 213`, `Community 214`, `Community 220`, `Community 225`, `Community 226`, `Community 231`, `Community 232`, `Community 1261`, `Community 1266`, `Community 862`, `Community 863`, `Community 864`, `Community 868`, `Community 884`, `Community 885`, `Community 886`, `Community 905`, `Community 907`, `Community 909`, `Community 412`, `Community 925`, `Community 414`, `Community 417`, `Community 418`, `Community 426`, `Community 432`, `Community 434`, `Community 436`, `Community 437`, `Community 953`, `Community 448`, `Community 449`, `Community 450`, `Community 451`, `Community 455`, `Community 456`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 50` to `Community 128`, `Community 2`, `Community 135`, `Community 650`, `Community 10`, `Community 140`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 20`, `Community 22`, `Community 24`, `Community 152`, `Community 411`, `Community 31`, `Community 164`, `Community 37`, `Community 420`, `Community 38`, `Community 39`, `Community 40`, `Community 42`, `Community 943`, `Community 48`, `Community 433`, `Community 435`, `Community 56`, `Community 187`, `Community 60`, `Community 195`, `Community 70`, `Community 72`, `Community 83`, `Community 221`, `Community 227`, `Community 101`, `Community 880`, `Community 114`, `Community 119`, `Community 124`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 17` to `Community 2`, `Community 133`, `Community 139`, `Community 908`, `Community 11`, `Community 18`, `Community 20`, `Community 150`, `Community 24`, `Community 154`, `Community 28`, `Community 413`, `Community 31`, `Community 163`, `Community 37`, `Community 38`, `Community 39`, `Community 42`, `Community 43`, `Community 48`, `Community 50`, `Community 54`, `Community 56`, `Community 67`, `Community 68`, `Community 69`, `Community 451`, `Community 72`, `Community 73`, `Community 76`, `Community 77`, `Community 83`, `Community 91`, `Community 221`, `Community 223`, `Community 225`, `Community 106`, `Community 111`, `Community 1263`, `Community 124`?**
...
- **Are the 150 inferred relationships involving `DefaultTree()` (e.g. with `TestFullTreeIntegration_RunsAllTreesWithRealLLM()` and `TestDomainTree_Registration()`) actually correct?**
  _`DefaultTree()` has 150 INFERRED edges - model-reasoned connections that need verification._
- **Are the 134 inferred relationships involving `NewRequest()` (e.g. with `TestHITLHandlers_PendingApproveReject()` and `WorkflowApprovalWait()`) actually correct?**
  _`NewRequest()` has 134 INFERRED edges - model-reasoned connections that need verification._