# Graph Report - superpowers-20260718T073947-7dfaeb70-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-18)

## Corpus Check
- 916 files · ~1,194,403 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26883 nodes · 39916 edges · 2093 communities (1742 shown, 351 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9496 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cdc3d6f9`
...
## Communities (2093 total, 351 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (215): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+207 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (215): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+207 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (160): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+152 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (115): main(), TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch() (+107 more)
...
Cohesion: 0.03
Nodes (98): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Block, TestComposeAndExpand(), Category, Compose(), ComposeFromRefs(), ComposeTaskTree() (+90 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (92): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+84 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (18): agentTestMockLLM, chainMockLLM, countedErrorMockLLM, emptyDecomposeMockLLM, errorMockLLM, flakyDecomposeMockLLM, flakyOnceMockLLM, flakyRefineMockLLM (+10 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (110): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+102 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (106): TestDeprecatedHandler_NoSunset(), TestDeprecatedHandler_WithSunsetDate(), DeprecatedHandler(), TestDeprecatedHandler_WithoutSunset(), TestDeprecatedHandler_WithSunset(), handleLogin(), handleLogout(), NewRequest() (+98 more)
...
Cohesion: 0.04
Nodes (87): echoTaskLeaf, mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection() (+79 more)
...
Cohesion: 0.04
Nodes (70): main(), BTStudioCompany(), requireOllamaFinanceTest(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis(), TestTeslaMarket(), TestTeslaModel() (+62 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (83): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewManager(), TestManager_Limits(), defaultGoapReviewDeps() (+75 more)
...
Cohesion: 0.04
Nodes (60): newAgentExecutor(), agentExecuteResult(), dashboardLocalAgentResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute() (+52 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (82): TestScoreChild_GoalAlignmentBranch(), TestScoreChild_NilChainState(), TestScoreChildren_BasicRanking(), okCommand, panicCommand, ParallelMode, intSliceFromInterface(), BuildReactiveParallel() (+74 more)
...
Cohesion: 0.05
Nodes (39): DiversityMetrics, EvolutionParameters, extractTreeType(), TestExtractTreeType(), FitnessMetrics, Individual, cloneTree(), containsCrisisReason() (+31 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (71): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+63 more)
...
Cohesion: 0.06
Nodes (66): main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+58 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (56): exportMemoryCategory(), exportPreviousRuns(), TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir() (+48 more)
...
Cohesion: 0.07
Nodes (58): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+50 more)
...
Cohesion: 0.04
Nodes (20): Server, History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), mockTTOrch (+12 more)
...
Cohesion: 0.05
Nodes (45): GateResult, TestQualityGateFloorOn100Scale(), ListRevisions(), loadSnapshotIndex(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass() (+37 more)
...
Cohesion: 0.05
Nodes (40): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), ApplyHITLPolicy(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID() (+32 more)
...
Cohesion: 0.05
Nodes (38): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype() (+30 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (21): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, ConcurrencyLimiter, DeadLetterEntry, DeadLetterQueue, executorFailureState (+13 more)
...
Cohesion: 0.06
Nodes (44): growthFitness(), FitnessDimension, NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic() (+36 more)
...
Cohesion: 0.07
Nodes (47): handleFellows(), NewMockLLM(), NewDefaultCompany(), CompanyState, Decision, QuarterResult, companySummary(), TestCompanySimulation_Quarter() (+39 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (45): NewCatalog(), TestCatalog_Export(), TestCatalog_ListInstalled(), TestCatalog_ListTemplates(), TestCatalog_Search(), TestCatalog_SkillToAgent(), TestInferTree(), NewHistory() (+37 more)
...
Cohesion: 0.07
Nodes (39): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), Entry, NewHandle(), Limits (+31 more)
...
Cohesion: 0.07
Nodes (39): ActionFunc, ActionRegistry, NewAgent(), AgentCallbacks, AgentRun, AgentState, assertError(), TestAgentActionFails() (+31 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (50): biasCandidatesWithExperience(), serializeTreeForGardener(), crisisMetricsGardener(), crisisV2Config(), experienceRecordingGardener(), experienceReuseCount(), knowledgeRecordingGardener(), metaValidatorWiringGardener() (+42 more)
...
Cohesion: 0.08
Nodes (36): Config, diffSecretField(), Duration(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry() (+28 more)
...
Cohesion: 0.06
Nodes (41): TestNewPopulation_Evolution(), TestNewQTable(), TestNewReinforcementLearner(), TestPopulation_StatsAccessors(), TestEvolveWithExperience_NilBankStillEvolves(), TestQTableSelectUpdateBestAction(), TestQTableStateBucketsAndDepth(), TestReinforcementLearnerLearnAndSuggest() (+33 more)
...
Cohesion: 0.09
Nodes (45): gitOutput(), TestNoCommittedRootBinaries(), isGoapNotebookLMFailure(), extractTaskID(), init(), nlmAuthNeedsRefresh(), nlmAuthUnhealthy(), registerNotebookLMActions() (+37 more)

### Community 69 - "Community 69"
Cohesion: 0.07
Nodes (36): perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTreeV2_WithRealTree(), TestMetricsTracker_BestFitnessTracking(), TestMetricsTracker_ImprovementRate(), TestMetricsTracker_LastFitnessTracking(), TestMetricsTracker_RecordAndCyclesForTree() (+28 more)
...
Cohesion: 0.07
Nodes (31): HTTPMethod, collectViolations(), fieldPath(), findResponse(), NewRouteIndex(), pathOrRoot(), ResponseValidator(), routeKey() (+23 more)
...
Cohesion: 0.08
Nodes (40): TestDaemonConfiguresGoalPlanBrainstorm(), superpowersPlanAlreadyImplemented(), TestSuperpowersPlanAlreadyImplementedRequiresAllTasks(), TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull(), TestBrainstormRejectedWhenFilesNotGoPath(), TestBrainstormRejectedWhenMalformedOrProse(), TestBrainstormRejectedWhenNotDeeper() (+32 more)
...
Cohesion: 0.11
Nodes (35): agentNameInterceptor, agentNameKey, ScoreAnnouncement(), BTAgentExecutor, cardResponder, rpcRequest, rpcResponse, failureEventMessage() (+27 more)
...
Cohesion: 0.07
Nodes (32): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), markGoapFusionImplDegraded(), TestFusionAnalysis_RateLimitCarryoverNotConflatedAsDegradation(), TestCurrentSuperpowersRunRefusesFinishedRun(), resolveGraphifyBin() (+24 more)
...
Cohesion: 0.1
Nodes (35): loadSuperpowersPlanState(), saveSuperpowersPlanState(), buildDeterministicImplementationPlan(), defaultNlmGrillAuthGuard(), nlmGrillAnswerer(), nlmGrillUnavailable(), parseNumberedAnswers(), runGrillAuthGuardAction() (+27 more)
...
Cohesion: 0.1
Nodes (31): TestEligibleBidders(), TestEligibleBidders_NoRequiredTagsMatchesAll(), BuildCardRegistry(), cardCoversTags(), ConvertToAgentCard(), EligibleBidders(), TestBuildCardRegistry(), TestConvertToAgentCard_Basic() (+23 more)

### Community 109 - "Community 109"
Cohesion: 0.11
Nodes (33): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionNoopPatchStreak(), goapFusionRepeatedHashBypassed(), goapFusionStateHashes() (+25 more)
...
Cohesion: 0.11
Nodes (31): bbError(), bbManager(), parseBBScope(), registerBlackboardTools(), invokeBB(), newBBServer(), TestBBManagerRequiresAgentRunner(), TestBTBBDeleteMissingKeyErrors() (+23 more)

### Community 113 - "Community 113"
Cohesion: 0.09
Nodes (29): collectSelectorNames(), SelectorStatsFile(), TestSelectorOptimizer_New(), degeneratePopulation(), runWithoutPanic(), TestEvolve_DegeneratePopulations(), TestEvolveWithExperience_DegeneratePopulations(), TestMemeticEvolve_DegeneratePopulations() (+21 more)
...
Cohesion: 0.09
Nodes (21): TestPromoteSubtree(), init(), ApplyBlockMutations(), blockIDFromOp(), collectNames(), evolutionApplyAddAfter(), evolutionApplyAddBefore(), extractSubtree() (+13 more)
...
Cohesion: 0.1
Nodes (22): cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask(), TestCloneTreeForGardener_Basic(), TestCloneTreeForGardener_DoubleNested(), TestCloneTreeForGardener_Nil() (+14 more)
...
Cohesion: 0.11
Nodes (17): BTOptimizer, collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestFindMainSelector(), TestSplitCamelCase(), isDefaultPath() (+9 more)
...
Cohesion: 0.13
Nodes (32): TestRouteBuilder_Build(), ArraySchema(), BoolSchema(), IntSchema(), ObjectSchema(), StringSchema(), TestConvenienceSchemaConstructors(), TestOpenAPIGenerator_Parameters() (+24 more)
...
Cohesion: 0.07
Nodes (20): alwaysSampler, Attr, neverSampler, noopSpan, noopTracer, Sampler, Span, SpanContext (+12 more)
...
Cohesion: 0.12
Nodes (26): mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu() (+18 more)
...
Cohesion: 0.13
Nodes (24): registerA2ANodes(), TestDelegateToA2A_FnNotConfigured(), TestDelegateToA2A_FnReturnsError(), TestDelegateToA2A_MissingTaskEmptyChainState(), TestDelegateToA2A_MissingURL(), TestDelegateToA2A_RateLimitCarryoverPropagates(), TestDelegateToA2A_Success(), TestDelegateToA2A_UsesTaskFromChainState() (+16 more)

### Community 149 - "Community 149"
Cohesion: 0.12
Nodes (20): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, LabeledGauge, exposedBuildIdentity(), formatPromLabels() (+12 more)
...
Cohesion: 0.11
Nodes (21): TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath(), TestDiscardWorktree_RemovesWorktreeAndDeletesBranch(), TestPushBranchAndCreatePR_InvokesGitPushAndGhPr(), withSwappedSuperpowersRunners(), debugTestClaude (+13 more)

### Community 156 - "Community 156"
Cohesion: 0.13
Nodes (24): buildRunActivitySummary(), fencedItems(), isFactLine(), joinCapped(), salientOutputLines(), TestBuildRunActivitySummaryCapsLongFencedLists(), TestBuildRunActivitySummaryEmptyEverything(), TestBuildRunActivitySummaryFailureLeadsWithReason() (+16 more)

### Community 157 - "Community 157"
Cohesion: 0.11
Nodes (22): min(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section() (+14 more)
...
Cohesion: 0.12
Nodes (19): Embedding, EmbeddingClient, CosineSimilarity(), TestBuildIndex_PanicRecovered(), TestCosineSimilarity_BothZero(), TestCosineSimilarity_DifferentLengths(), TestCosineSimilarity_Empty(), TestCosineSimilarity_Identical() (+11 more)

### Community 176 - "Community 176"
Cohesion: 0.14
Nodes (20): TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), automationApproved(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree() (+12 more)
...
Cohesion: 0.08
Nodes (7): CreateAgentTool, EvolveTool, GetReflectionsTool, GetTreeTool, truncateStr(), ReflectTool, RunTaskTool
...
Cohesion: 0.24
Nodes (24): TestClaudeErrorHandler_DoesNotClobberExistingCategory(), swapErrorHandlerRunner(), TestRequestErrorHandlerProposal_RespectsCallerContext(), TestRequestErrorHandlerProposal_StampsLedgerOnEveryOutcome(), ehTestHandlerNode(), ehTestProposalJSON(), init(), runHandler() (+16 more)
...
Cohesion: 0.13
Nodes (18): NewEvolvedAgent(), TestConfig_AllFields(), TestCreateAgentTool_Call_NilFactory(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestMockModel_SatisfiesInterface() (+10 more)
...
Cohesion: 0.11
Nodes (14): TestCreateAgentTool_Call_NilFactory(), TestReflectTool_Call_NoLLM(), TestReflectTool_Call_WithLLM(), TestRunTaskTool_Call(), TestToolNames_And_Descriptions(), GetReflectionsTool, GetTreeTool, RunTaskTool (+6 more)
...
Cohesion: 0.12
Nodes (19): TestRunPipelineWithID_RecordsAgentMetrics(), hermesOutcome(), isAuctionShapedTask(), PickTreeForTask(), TestHermesOutcome(), TestPickTreeForTask_AuctionRoutingBeatsKnowledgeGraph(), TestPickTreeForTask_ConsultsKnowledgeGraphOverStaticSwitch(), TestPickTreeForTask_FallsBackToStaticSwitchWhenGraphUnconfident() (+11 more)
...
Cohesion: 0.17
Nodes (18): TestBTOptimizer_New(), TestDTAnalyzer_New(), TestExtractCondition(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), NewBTOptimizer(), NewDTAnalyzer() (+10 more)

### Community 217 - "Community 217"
Cohesion: 0.17
Nodes (17): Alert, apiFetch(), esc(), getCookie(), Alert, cbIcon(), createAgent(), deleteAgent() (+9 more)

### Community 218 - "Community 218"
Cohesion: 0.18
Nodes (15): TemplatesDir(), TestPathHelpers(), NewRunDeps(), cmdCreate(), cmdDelete(), cmdInstallTemplates(), cmdList(), cmdLogs() (+7 more)
...
Cohesion: 0.13
Nodes (13): TestGetEmbedding_EmptyEmbeddingOn200IsError(), FallbackLLM, TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailure_BackwardCompat(), TestCircuitBreaker_RecordFailureWithCategory(), TestIntegration_CircuitBreakerAndDLQ(), NewCircuitBreaker() (+5 more)
...
Cohesion: 0.16
Nodes (11): attachLogHandler(), buildBaseHandler(), buildLogger(), Debug(), envLogLevel(), Error(), Init(), L() (+3 more)
...
Cohesion: 0.14
Nodes (9): buildScorecard(), RunPlatformEval(), treeForSuite(), truncateForReport(), EvalMockLLM, PlatformEvalResult, PlatformScorecard, SuiteEvalResult (+1 more)
...
Cohesion: 0.27
Nodes (13): cardSignatureValid(), SignAgentCard(), TestAuctionCandidates_RejectsTamperedCardSignature(), TestHandleGlobalAgentCard_ResponseIsSigned(), TestSignAgentCard(), TestSignAgentCard_Deterministic(), TestSignAgentCard_DifferentCards(), TestSignAgentCard_NilCard() (+5 more)
...
Cohesion: 0.19
Nodes (14): TestBuildIdentityStampedRevisionFallback(), BuildIdentityFromBuildInfo(), InstallBuildIdentity(), ReadBuildIdentity(), SetBuildIdentity(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered(), TestBlockDurationHistogramSeriesRendered() (+6 more)
...
Cohesion: 0.18
Nodes (11): code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), Package: factory, Package: knowledge, Package: llm (+3 more)
...
Cohesion: 0.31
Nodes (8): TestRunOnce_EmitsRunRootSpan(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), NewOTelTracer(), GlobalTracer()
...
Cohesion: 0.25
Nodes (8): code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), Package: api, Package: benchmark, Package: persona, Package: tracing
...
Cohesion: 0.4
Nodes (5): TestSideEffectClassOfSubtree_DeepChild(), TestSideEffectClassOfSubtree_MultipleChildren(), TestSideEffectClassOfSubtree_NoSideEffect(), TestSideEffectClassOfSubtree_RootHasClass(), sideEffectClassOfSubtree()
...
Cohesion: 0.83
Nodes (3): newWiringFixture(), TestEvolveTree_PerTreeDisabledFailsClosed(), TestEvolveTreeV2_PerTreeDisabledFailsClosed()
...
## Knowledge Gaps
- **10568 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+10563 more)
...
- **Why does `Append()` connect `Community 34` to `Community 3`, `Community 1029`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 5`, `Community 11`, `Community 13`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 26`, `Community 27`, `Community 29`, `Community 30`, `Community 35`, `Community 36`, `Community 40`, `Community 45`, `Community 46`, `Community 47`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 1082`, `Community 61`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 82`, `Community 84`, `Community 85`, `Community 87`, `Community 91`, `Community 92`, `Community 93`, `Community 95`, `Community 97`, `Community 100`, `Community 101`, `Community 102`, `Community 104`, `Community 106`, `Community 107`, `Community 108`, `Community 111`, `Community 112`, `Community 114`, `Community 119`, `Community 123`, `Community 125`, `Community 128`, `Community 131`, `Community 132`, `Community 133`, `Community 134`, `Community 136`, `Community 139`, `Community 141`, `Community 142`, `Community 146`, `Community 147`, `Community 149`, `Community 151`, `Community 153`, `Community 158`, `Community 159`, `Community 163`, `Community 170`, `Community 174`, `Community 180`, `Community 181`, `Community 182`, `Community 183`, `Community 190`, `Community 193`, `Community 197`, `Community 202`, `Community 204`, `Community 205`, `Community 210`, `Community 723`, `Community 722`, `Community 215`, `Community 728`, `Community 729`, `Community 218`, `Community 221`, `Community 224`, `Community 225`, `Community 226`, `Community 233`, `Community 235`, `Community 748`, `Community 752`, `Community 753`, `Community 759`, `Community 1317`, `Community 451`, `Community 455`, `Community 456`, `Community 460`, `Community 462`, `Community 463`, `Community 983`, `Community 984`, `Community 985`, `Community 987`, `Community 475`, `Community 486`, `Community 488`, `Community 1008`, `Community 497`, `Community 498`, `Community 1009`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 27` to `Community 3`, `Community 5`, `Community 6`, `Community 12`, `Community 13`, `Community 141`, `Community 16`, `Community 145`, `Community 18`, `Community 23`, `Community 24`, `Community 26`, `Community 1053`, `Community 31`, `Community 160`, `Community 39`, `Community 1064`, `Community 40`, `Community 42`, `Community 53`, `Community 184`, `Community 63`, `Community 64`, `Community 191`, `Community 67`, `Community 71`, `Community 457`, `Community 460`, `Community 461`, `Community 206`, `Community 205`, `Community 212`, `Community 90`, `Community 93`, `Community 222`, `Community 482`, `Community 103`, `Community 232`, `Community 231`, `Community 490`, `Community 1004`, `Community 121`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 13` to `Community 3`, `Community 5`, `Community 6`, `Community 12`, `Community 15`, `Community 145`, `Community 149`, `Community 22`, `Community 150`, `Community 151`, `Community 27`, `Community 157`, `Community 31`, `Community 1440`, `Community 34`, `Community 38`, `Community 167`, `Community 41`, `Community 46`, `Community 49`, `Community 52`, `Community 53`, `Community 63`, `Community 191`, `Community 66`, `Community 67`, `Community 70`, `Community 71`, `Community 74`, `Community 460`, `Community 80`, `Community 85`, `Community 86`, `Community 218`, `Community 222`, `Community 97`, `Community 112`, `Community 113`?**
