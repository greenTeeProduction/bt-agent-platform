# Graph Report - superpowers-20260713T192112-10851188-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-13)

## Corpus Check
- 845 files · ~956,412 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21268 nodes · 32664 edges · 1736 communities (1386 shown, 350 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8347 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `df5f6050`
...
6. `registerMCPTools()` - 103 edges
7. `newDefaultConfig()` - 100 edges
8. `sleep()` - 95 edges
9. `arc42 Section 9 — Architecture Decisions` - 82 edges
10. `main()` - 78 edges
...
## Communities (1736 total, 350 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (143): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+135 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (143): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+135 more)
...
Cohesion: 0.02
Nodes (75): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM() (+67 more)
...
Cohesion: 0.04
Nodes (74): perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree() (+66 more)
...
Cohesion: 0.05
Nodes (56): OpenAPIGenerator, Append(), mockTTOrch, Workflow, ChainConfig, ChainKind, availableToolNames(), bbRunID() (+48 more)
...
Cohesion: 0.05
Nodes (62): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, fakeClaude, fakeCommitRunner, hookFailureClass, TestVerifyNotebookLMEvidenceAcceptsRealNotebookPayload() (+54 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (71): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), truncateGoap(), buildDeterministicDesign(), buildSuperpowersFinishReport() (+63 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (82): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+74 more)
...
Cohesion: 0.07
Nodes (59): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), TestNlmQuotaState_PersistsAcrossRuns() (+51 more)
...
Cohesion: 0.07
Nodes (46): ArraySchema(), IntSchema(), ObjectSchema(), findResponse(), NewRouteIndex(), ResponseValidator(), TestDashboardRoutes_AllIndexable(), TestNewRouteIndex() (+38 more)

### Community 38 - "Community 38"
Cohesion: 0.07
Nodes (58): TestConsoleTracer_ExporterReceivesCompletedSpan(), fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest() (+50 more)
...
Cohesion: 0.05
Nodes (28): handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogout(), handleMetricsLive() (+20 more)
...
Cohesion: 0.06
Nodes (33): AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce(), TestAutoRestartEnabled(), TestDriftWatchOnceRestartHandoff() (+25 more)

### Community 51 - "Community 51"
Cohesion: 0.08
Nodes (44): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), saveNlmQuotaExhausted(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField() (+36 more)
...
Cohesion: 0.06
Nodes (28): handleSprintExecute(), main(), GardenerRecommendTool, GardenerRunCycleTool, GardenerStatusTool, main(), newGardenerRunCycleTool(), truncateStr() (+20 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (37): init(), registerGoDevActions(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+29 more)
...
Cohesion: 0.09
Nodes (37): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir(), MemoryDir() (+29 more)
...
Cohesion: 0.11
Nodes (38): Duration(), TestDuration(), jaccardSimilarity(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry() (+30 more)
...
Cohesion: 0.08
Nodes (22): cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), TestCloneTreeForGardener_Basic(), TestCloneTreeForGardener_DoubleNested(), TestCloneTreeForGardener_Nil(), TestCloneTreeForGardener_NilMetadata() (+14 more)
...
Cohesion: 0.13
Nodes (36): NewEvolvedAgent(), saveRecordWithDelay(), TestConfig_AllFields(), TestCreateAgentTool_Call_NilFactory(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields() (+28 more)
...
Cohesion: 0.07
Nodes (31): Block, TestComposeAndExpand(), Category, ComposeSpec, TestExpand_BlockMetadata(), Expand(), expandNode(), HasSubTreeRefs() (+23 more)
...
Cohesion: 0.09
Nodes (34): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionPreflightWired(), goapFusionRepeatedHashBypassed() (+26 more)
...
Cohesion: 0.09
Nodes (29): Binaries, code:go (type Counter struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), code:go (type AgentCard struct { Name, Description, URL string }) (+21 more)
...
Cohesion: 0.12
Nodes (23): ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), ApplyBlockMutations(), collectNames(), evolutionApplyAddAfter() (+15 more)
...
Cohesion: 0.23
Nodes (11): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), wireSelectorOrdering(), routerChildNames(), seedSelectorStats() (+3 more)
...
Cohesion: 0.17
Nodes (12): code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), Package: evaluator, Package: gardener (+4 more)
...
Cohesion: 0.22
Nodes (4): ErrorCategory, sleepWithContext(), TestErrorCategory_String(), RetryPolicy
...
## Knowledge Gaps
- **7226 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7221 more)
...
- **Why does `Append()` connect `Community 18` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 24`, `Community 25`, `Community 28`, `Community 29`, `Community 31`, `Community 34`, `Community 547`, `Community 38`, `Community 39`, `Community 40`, `Community 551`, `Community 42`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 560`, `Community 49`, `Community 48`, `Community 51`, `Community 52`, `Community 53`, `Community 55`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 575`, `Community 63`, `Community 65`, `Community 66`, `Community 577`, `Community 580`, `Community 69`, `Community 70`, `Community 576`, `Community 72`, `Community 73`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 99`, `Community 104`, `Community 108`, `Community 109`, `Community 110`, `Community 112`, `Community 118`, `Community 122`, `Community 124`, `Community 126`, `Community 130`, `Community 133`, `Community 138`, `Community 141`, `Community 143`, `Community 145`, `Community 147`, `Community 150`, `Community 152`, `Community 156`, `Community 160`, `Community 161`, `Community 163`, `Community 165`, `Community 167`, `Community 172`, `Community 184`, `Community 185`, `Community 186`, `Community 187`, `Community 188`, `Community 195`, `Community 202`, `Community 203`, `Community 204`, `Community 206`, `Community 208`, `Community 211`, `Community 214`, `Community 218`, `Community 221`, `Community 735`, `Community 736`, `Community 737`, `Community 739`, `Community 755`, `Community 758`, `Community 762`, `Community 763`, `Community 781`, `Community 783`, `Community 784`, `Community 798`, `Community 819`, `Community 366`, `Community 369`, `Community 370`, `Community 371`, `Community 375`, `Community 376`, `Community 377`, `Community 378`, `Community 380`, `Community 388`, `Community 389`, `Community 391`, `Community 393`, `Community 397`, `Community 400`, `Community 402`, `Community 992`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 116` to `Community 2`, `Community 3`, `Community 4`, `Community 390`, `Community 137`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 23`, `Community 34`, `Community 35`, `Community 38`, `Community 40`, `Community 49`, `Community 50`, `Community 53`, `Community 182`, `Community 54`, `Community 56`, `Community 57`, `Community 185`, `Community 193`, `Community 195`, `Community 68`, `Community 199`, `Community 71`, `Community 73`, `Community 72`, `Community 203`, `Community 209`, `Community 98`, `Community 100`, `Community 754`, `Community 119`, `Community 379`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 34` to `Community 2`, `Community 3`, `Community 136`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 149`, `Community 23`, `Community 164`, `Community 39`, `Community 170`, `Community 48`, `Community 49`, `Community 52`, `Community 53`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 62`, `Community 64`, `Community 65`, `Community 194`, `Community 1091`, `Community 72`, `Community 208`, `Community 209`, `Community 210`, `Community 88`, `Community 95`, `Community 116`, `Community 119`, `Community 124`, `Community 1022`?**
