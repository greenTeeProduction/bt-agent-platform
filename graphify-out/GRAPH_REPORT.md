# Graph Report - superpowers-20260715T152324-d423f5f5-goap-fusion-loop-runner-blackboard-conte  (2026-07-15)

## Corpus Check
- 867 files · ~1,035,964 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23003 nodes · 34904 edges · 1853 communities (1501 shown, 352 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8737 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e5939a9`
...
6. `arc42 Section 9 — Architecture Decisions` - 115 edges
...
## Communities (1853 total, 352 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (167): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+159 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (167): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+159 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (103): TestComputeAnalytics_BottleneckCarriesStructuredFailure(), TestComputeAnalytics_Bottlenecks(), TestComputeAnalytics_BottleneckWithoutTraceHasEmptyFailure(), TestComputeAnalytics_BottleneckWithTrace(), TestComputeAnalytics_Centrality(), TestComputeAnalytics_CoverageGapsUseExpectedDomains(), TestComputeAnalytics_EmptyGraph(), TestComputeAnalytics_ExtendedEdges() (+95 more)
...
Cohesion: 0.03
Nodes (107): ApplyJitter(), ClassifyError(), contextDeadlineExceeded(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), ExecuteWithPolicy(), FullJitter() (+99 more)
...
Cohesion: 0.02
Nodes (115): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+107 more)
...
Cohesion: 0.04
Nodes (92): truncateGoap(), arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), collapseToSingleLine() (+84 more)
...
Cohesion: 0.05
Nodes (87): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), perTreeStats(), setupGardener(), TestBaseNodeCount(), TestBenchmarkMockIntegration() (+79 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (81): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewManager(), defaultGoapReviewDeps(), gatherFailureReviewBody() (+73 more)
...
Cohesion: 0.03
Nodes (53): findChildByName(), TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM(), TestBuildGoapStepPrompt(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput() (+45 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (77): LoadPipeline(), RunPipeline(), RunPipelineWithID(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner() (+69 more)
...
Cohesion: 0.04
Nodes (50): agentExecuteResult(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleAnalyze(), handleDLQReplay() (+42 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (68): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+60 more)
...
Cohesion: 0.04
Nodes (59): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), Category, Compose() (+51 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (68): cloneTree(), CodeReviewSuite(), cohensD(), DefaultMock(), fishersExact(), GoDevSuite(), minF(), QuickValidate() (+60 more)
...
Cohesion: 0.05
Nodes (55): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, fakeClaude, fakeCommitRunner, hookFailureClass, applySuperpowersRunFromBareRepo() (+47 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (46): Warn(), Outcome, Record, FilterByTreeName(), Config, TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped() (+38 more)
...
Cohesion: 0.07
Nodes (47): ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree(), resolveTreeForUser(), agentTemplateYAML, TestResolveTreeID_FusionAliases(), HermesSelfEvolutionTree(), HermesObsidianOptimizerTree() (+39 more)
...
Cohesion: 0.08
Nodes (48): stringContains(), TestAction_ExecuteGoapStep_AccumulatesAndSynthesizes(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), TestAction_PlanGoapActions_JSONActionsInvalidEntry() (+40 more)
...
Cohesion: 0.11
Nodes (47): DefaultLLM(), RealLLM(), BuiltinBFCLV3(), EvaluateBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic(), TestBFCLV3_MultiTurn_Composite() (+39 more)
...
Cohesion: 0.06
Nodes (30): TestStartDriftWatcher_KickTriggersImmediateCheck(), StartDriftWatcher(), buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), wireSelectorOrdering() (+22 more)
...
Cohesion: 0.07
Nodes (42): FileJobStore, NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), JobStore, TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess() (+34 more)
...
Cohesion: 0.06
Nodes (35): TestOutcomeErrorDetail(), FeedbackFile(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath() (+27 more)
...
Cohesion: 0.07
Nodes (26): handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus() (+18 more)
...
Cohesion: 0.07
Nodes (29): AgentMetrics, AgentStats, BuildIdentity, Counter, HealthResponse, Histogram, LabeledCounter, LabeledGauge (+21 more)
...
Cohesion: 0.07
Nodes (39): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+31 more)
...
Cohesion: 0.09
Nodes (42): growthFitness(), FitnessDimension, makeTestTree(), NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance() (+34 more)
...
Cohesion: 0.06
Nodes (38): countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New() (+30 more)
...
Cohesion: 0.08
Nodes (29): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), Entry, NewHandle(), Limits (+21 more)
...
Cohesion: 0.09
Nodes (35): agentNameFromBB(), init(), registerDelegateNodes(), exportMemoryCategory(), exportPreviousRuns(), NewMemoryStore(), storeForTest(), TestContextBlock_EmptyStoreReturnsEmpty() (+27 more)
...
Cohesion: 0.11
Nodes (29): TestDriftWatchOnce_SkipsRestartWhenJobStartedMidRebuild(), TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir() (+21 more)
...
Cohesion: 0.16
Nodes (21): TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeTracer, mockOllamaServer(), newTestClient(), TestClient_AnalyzeComplexity(), TestClient_Generate() (+13 more)
...
Cohesion: 0.12
Nodes (14): TestAgentWithRealToolsBlocksFinalAnswerWithoutToolUse(), TestAgentWithRealToolsRejectsFinalAnswerWithoutToolUse(), TestDataPipelineTree_NoSourceReportsBlockedNotFabricated(), TestDataPipelineTree_UsesObservedFileMetrics(), TestEnsureTaskToolsCreatesRequestedTools(), TestExecuteAgentTool_NeverSimulatesMissingTool(), TestNotebookLMTree_PreGateDiscoversRealToolset(), TestRealToolFactory_DiscoveryAndFailClosed() (+6 more)
...
Cohesion: 0.24
Nodes (15): TestSelectorOptimizer_New(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing(), TestLocalSearch_TabuSearch() (+7 more)
...
Cohesion: 0.27
Nodes (14): NewDefaultCompany(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary(), testLLM(), TestNewDefaultCompany_Values(), TestRunQuarter_MetricsValid() (+6 more)
...
Cohesion: 0.14
Nodes (9): ErrorCategory, sleepWithContext(), TestErrorCategory_String(), Backoff(), RetryWithBackoff(), TestBackoff(), TestRetryWithBackoff_Exhausted(), TestRetryWithBackoff_Success() (+1 more)
...
Cohesion: 0.21
Nodes (12): deepSearchGardener(), deepSearchV2Config(), TestEvolveTreeV2_DeepSearchMetrics_PopulatedWhenTTConfigured(), TestEvolveTreeV2_DeepSearchMetrics_ZeroWithoutTranspositionTable(), TestMetricsTracker_CyclesForTree(), TestMetricsTracker_RecordAndSummary(), TestMetricsTracker_SaveAggregatesCrisisAndLastRun(), TestMetricsTracker_SaveIncludesDashboardAggregateFields() (+4 more)
...
Cohesion: 0.18
Nodes (11): code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), Package: factory, Package: knowledge (+3 more)
...
Cohesion: 0.27
Nodes (8): newCatchupFixture(), TestCycleBreakerSuccess_HealthyOutcomesDoNotTripBreaker(), TestReconcileWithRegistry_EmptyRegistryPreservesJobs(), TestSchedule_PreservesCrashRecoveryImmediateRun(), TestSchedule_PreservesMissedNextRunForCatchUp(), TestSchedule_RecomputesNextRunOnScheduleChange(), cycleBreakerSuccess(), testError
...
## Knowledge Gaps
- **8250 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8245 more)
...
- **Why does `Append()` connect `Community 23` to `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 24`, `Community 25`, `Community 26`, `Community 30`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 55`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 69`, `Community 70`, `Community 71`, `Community 73`, `Community 74`, `Community 75`, `Community 77`, `Community 79`, `Community 80`, `Community 1103`, `Community 83`, `Community 1107`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 84`, `Community 90`, `Community 92`, `Community 93`, `Community 94`, `Community 96`, `Community 609`, `Community 97`, `Community 611`, `Community 612`, `Community 100`, `Community 615`, `Community 616`, `Community 103`, `Community 104`, `Community 105`, `Community 111`, `Community 112`, `Community 115`, `Community 120`, `Community 633`, `Community 122`, `Community 634`, `Community 124`, `Community 125`, `Community 127`, `Community 128`, `Community 130`, `Community 136`, `Community 139`, `Community 143`, `Community 146`, `Community 151`, `Community 154`, `Community 162`, `Community 163`, `Community 166`, `Community 168`, `Community 170`, `Community 177`, `Community 181`, `Community 182`, `Community 187`, `Community 188`, `Community 189`, `Community 196`, `Community 198`, `Community 200`, `Community 203`, `Community 205`, `Community 207`, `Community 212`, `Community 213`, `Community 214`, `Community 218`, `Community 222`, `Community 811`, `Community 819`, `Community 830`, `Community 831`, `Community 858`, `Community 859`, `Community 865`, `Community 392`, `Community 397`, `Community 398`, `Community 399`, `Community 400`, `Community 406`, `Community 407`, `Community 409`, `Community 410`, `Community 412`, `Community 419`, `Community 420`, `Community 421`, `Community 422`, `Community 424`, `Community 433`, `Community 435`, `Community 439`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 15` to `Community 130`, `Community 2`, `Community 3`, `Community 142`, `Community 143`, `Community 402`, `Community 148`, `Community 23`, `Community 24`, `Community 413`, `Community 30`, `Community 164`, `Community 36`, `Community 426`, `Community 48`, `Community 50`, `Community 53`, `Community 56`, `Community 57`, `Community 60`, `Community 62`, `Community 65`, `Community 193`, `Community 68`, `Community 70`, `Community 71`, `Community 200`, `Community 73`, `Community 76`, `Community 77`, `Community 80`, `Community 211`, `Community 85`, `Community 96`, `Community 105`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 56` to `Community 2`, `Community 3`, `Community 4`, `Community 133`, `Community 391`, `Community 394`, `Community 13`, `Community 15`, `Community 144`, `Community 21`, `Community 28`, `Community 30`, `Community 33`, `Community 36`, `Community 423`, `Community 167`, `Community 40`, `Community 42`, `Community 43`, `Community 48`, `Community 52`, `Community 53`, `Community 54`, `Community 60`, `Community 188`, `Community 833`, `Community 199`, `Community 205`, `Community 80`, `Community 210`, `Community 211`, `Community 85`, `Community 99`, `Community 102`, `Community 105`, `Community 108`, `Community 110`, `Community 895`?**
