# Graph Report - superpowers-20260716T235814-6d4a1975-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-17)

## Corpus Check
- 892 files · ~1,117,550 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24834 nodes · 37366 edges · 1970 communities (1618 shown, 352 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9137 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fd0746db`
...
3. `registerMCPTools()` - 141 edges
4. `NewKnowledgeGraph()` - 138 edges
5. `NewRequest()` - 136 edges
6. `9. Architecture Decisions` - 136 edges
...
## Communities (1970 total, 352 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (185): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+177 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (185): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+177 more)
...
Cohesion: 0.02
Nodes (129): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+121 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (92): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Block, TestComposeAndExpand(), Category, Compose(), ComposeFromRefs() (+84 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (98): TestStore_CountFailures_MixedRecords(), TestStore_CountFailures_NoFailures(), TestStore_LoadAll_WithSubdirs(), TestStore_NewStore_MkdirAllError(), TestStore_RecentFailures_Ordering(), TestStore_Save_RenameCleanup(), TestStore_Save_WriteError(), NewStore() (+90 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (101): truncateGoap(), init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), TestParseSplitOutput(), validateDesignAction(), validateDesignHeadings(), arc42SeedTargetGoal() (+93 more)
...
Cohesion: 0.04
Nodes (104): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+96 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (77): AutoRebuildEnabled(), attemptOutcomeError(), endpointsFromCards(), experienceBankDir(), hostURLOf(), init(), logA2AServeError(), main() (+69 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (15): agentTestMockLLM, chainMockLLM, countedErrorMockLLM, emptyDecomposeMockLLM, errorMockLLM, flakyDecomposeMockLLM, flakyRefineMockLLM, flakySubtaskMockLLM (+7 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (99): TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailure_BackwardCompat(), TestCircuitBreaker_RecordFailureWithCategory(), TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts() (+91 more)
...
Cohesion: 0.04
Nodes (76): docgenState, allSections(), buildSectionMap(), contains(), fileHash(), hashSectionSources(), isSectionDone(), main() (+68 more)
...
Cohesion: 0.04
Nodes (84): auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext(), AuditMiddleware() (+76 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (67): AgentExecutor, registerSetupActions(), TestArc42SectionsAgainstRealRepoDocs(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure(), TestNewGoTestTool_Structure(), TestNewGoVetTool_Structure() (+59 more)
...
Cohesion: 0.04
Nodes (32): AgentMetric, AlertReport, Catalog, extractYAMLField(), inferTree(), splitTags(), CatalogEntry, History (+24 more)
...
Cohesion: 0.05
Nodes (72): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+64 more)
...
Cohesion: 0.05
Nodes (67): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_Existing(), TestAutoCreateTree_New(), TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents() (+59 more)
...
Cohesion: 0.06
Nodes (65): echoTaskLeaf, islandArchivePath(), newProductionPopulation(), qtableArchivePath(), registerMCPTools(), assertExpertArchiveFedFromRun(), injectSelectorProbeTree(), seedSelectorProbeStats() (+57 more)
...
Cohesion: 0.06
Nodes (50): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, scriptedClaudeRunner, scriptedSuperpowersRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo() (+42 more)
...
Cohesion: 0.05
Nodes (44): Warn(), Outcome, Record, FilterByTreeName(), Config, TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped() (+36 more)
...
Cohesion: 0.05
Nodes (45): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), parseChainConfig(), TestChainAction_ParseConfig(), readPostconditions() (+37 more)
...
Cohesion: 0.08
Nodes (52): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+44 more)

### Community 47 - "Community 47"
Cohesion: 0.08
Nodes (51): autofixScriptRunner, autofixScriptStep, TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull(), TestBrainstormRejectedWhenFilesNotGoPath(), TestBrainstormRejectedWhenMalformedOrProse(), TestBrainstormRejectedWhenNotDeeper(), TestBrainstormRejectedWhenRunOmitsShort() (+43 more)
...
Cohesion: 0.08
Nodes (52): buildGrillRound1Query(), buildClaudeReviewPrompt(), TestBuildClaudeReviewPrompt_ContractMarkers(), arc42GoalsPromptBlock(), arc42ResearchTopics(), loadArc42QualityGoals(), TestArc42GoalsPromptBlockContainsEveryGoal(), TestArc42GoalsPromptBlockEmptyWhenDocMissing() (+44 more)
...
Cohesion: 0.05
Nodes (38): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce() (+30 more)
...
Cohesion: 0.07
Nodes (48): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), TestIsGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation() (+40 more)
...
Cohesion: 0.07
Nodes (41): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+33 more)
...
Cohesion: 0.08
Nodes (40): NewAgent(), NewDocPlanner(), fakeBlackboard, assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory() (+32 more)
...
Cohesion: 0.08
Nodes (41): ArraySchema(), IntSchema(), ObjectSchema(), NewRouteIndex(), ResponseValidator(), TestDashboardRoutes_AllIndexable(), TestNewRouteIndex(), TestNewRouteIndex_Empty() (+33 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (30): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait() (+22 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (34): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, init(), Engine, TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh() (+26 more)
...
Cohesion: 0.1
Nodes (42): Duration(), TestDuration(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes() (+34 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (28): agentExecuteResult(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay() (+20 more)

### Community 70 - "Community 70"
Cohesion: 0.07
Nodes (38): countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New(), TestNewPopulation_Evolution() (+30 more)
...
Cohesion: 0.06
Nodes (31): Blackboard, ChildTick, childTickLog, init(), TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern() (+23 more)
...
Cohesion: 0.12
Nodes (32): TestRunSuiteIsSandboxed(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled(), TestBanditSelector_DisabledMatchesSelectorSemantics() (+24 more)

### Community 78 - "Community 78"
Cohesion: 0.08
Nodes (25): UsersDir(), TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree() (+17 more)
...
Cohesion: 0.11
Nodes (16): TestDetermineCategory(), TestExtractKeywords(), Factory, AutoCreateTree(), AutoCreateTreeWith(), containsAnyStr(), determineCategory(), extractKeywords() (+8 more)
...
Cohesion: 0.07
Nodes (25): TestAnalyzeImprovementGaps_NoFabricatedEngineTestBlocker(), Analyzer, extractJSON(), NewAnalyzer(), truncate(), TestFactory_RejectsInvalidGeneratedTreeBeforePersisting(), TestGenerator_CompilesSkillActionsToChainActions(), TestAnalyzer_EmptyResponse_Error() (+17 more)
...
Cohesion: 0.13
Nodes (17): extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), collectNodeNames(), containsCrisisReason(), Crossover(), ExperienceRetrievalHits() (+9 more)
...
Cohesion: 0.15
Nodes (32): recordUserFeedback(), registerFeedbackTools(), newFeedbackDeps(), TestBTFeedbackRegistered(), TestRecordUserFeedback_FeedsSatisfactionAndFlags(), TestRecordUserFeedback_RejectsBadInput(), TestRecordUserFeedback_TrimsUserAndTreeID(), TestSeedCompileReflection_WritesOnceAndOverwrites() (+24 more)
...
Cohesion: 0.08
Nodes (32): ClassifyError(), contextDeadlineExceeded(), isAuthError(), isLLMError(), isNetworkError(), isRateLimitError(), isResourceError(), isTimeoutError() (+24 more)

### Community 105 - "Community 105"
Cohesion: 0.09
Nodes (29): init(), registerSuperpowersDebugActions(), superpowersDebugPhase(), superpowersDebugPhaseAction(), newGrillLoopTestRun(), TestGrillDesign_ApprovedWhenNoOpenCriticals(), TestGrillDesign_NeedsWorkWithFeedbackWhenCriticalsOpen(), TestGrillDesign_NoProgressBreakerFailsAfterTwoStaleRounds() (+21 more)
...
Cohesion: 0.09
Nodes (29): TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection() (+21 more)
...
Cohesion: 0.09
Nodes (25): TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), TestStartDriftWatcher_KickTriggersImmediateCheck(), JobsDir(), RegistryDir(), SchedulerJobsFile(), TestRemoveAgentJobs(), TestResolvePipelineAgent_Aliases() (+17 more)
...
Cohesion: 0.1
Nodes (20): IsKnownChainKind(), TestIsKnownChainKind(), asFloat(), compiledGoapActionFor(), compiledGoapConditionFor(), goapValuesEqual(), goapWorldStateFrom(), isCompiledGoapAction() (+12 more)
...
Cohesion: 0.12
Nodes (21): AgentMetrics, AgentStats, BuildIdentity, HealthResponse, LabeledGauge, exposedBuildIdentity(), formatPromLabels(), GetAgentMetrics() (+13 more)

### Community 142 - "Community 142"
Cohesion: 0.07
Nodes (16): A2AHandoffBlock(), builtinBlocks(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), HumanGateBlock() (+8 more)

### Community 143 - "Community 143"
Cohesion: 0.13
Nodes (24): GateResult, TestQualityGateFloorOn100Scale(), ListRevisions(), loadSnapshotIndex(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass() (+16 more)
...
Cohesion: 0.11
Nodes (28): fakeTracer, AlwaysSample(), hashTraceID(), NeverSample(), NewRatioSampler(), TestAlwaysSample(), TestConsoleTracer_ChildSpansNotSampled(), TestConsoleTracer_NilWriter() (+20 more)
...
Cohesion: 0.1
Nodes (20): FileJobStore, JobStore, TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves(), NewFileJobStore(), NewReadOnlyJobStore() (+12 more)

### Community 153 - "Community 153"
Cohesion: 0.15
Nodes (25): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestRunJob_WarnsOnDeployDriftAtCycleComplete(), TestRunJob_WebhookIncludesBuildRevision(), TestRunJobStampsFailureOutcomeWhenRetryExhaustionLeavesItEmpty(), NewScheduler(), decodeRunCount() (+17 more)
...
Cohesion: 0.16
Nodes (27): TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest(), TestTracingMiddleware_StatusCodes(), TestTracingMiddleware_WroteHeaderGuard() (+19 more)
...
Cohesion: 0.08
Nodes (7): EvolveTool, FitnessTool, GetReflectionsTool, GetTreeTool, truncateStr(), ReflectTool, RunTaskTool
...
Cohesion: 0.16
Nodes (21): activateAutomation(), automationAgentName(), considerAutomation(), finalizeAutomationApproval(), proposeAutomation(), registerAutomationTools(), suggestSchedule(), newAutopilotDeps() (+13 more)
...
Cohesion: 0.1
Nodes (14): TestOutcomeErrorDetail(), ResolvePipelineAgent(), RunDeps, applyOutcomeRefinement(), IsHealthyOutcome(), OutcomeErrorDetail(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome() (+6 more)
...
Cohesion: 0.14
Nodes (18): BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), LogsDir(), MemoryDir() (+10 more)

### Community 195 - "Community 195"
Cohesion: 0.2
Nodes (19): saveRecordWithDelay(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolveTool_Call_NotEnoughFailures(), TestEvolveTool_Call_NoTree(), TestEvolveTool_Call_Success(), TestFitnessTool_Call(), TestFitnessTool_Call_NoData(), TestGetReflectionsTool_Call_NoRecords() (+11 more)

### Community 196 - "Community 196"
Cohesion: 0.14
Nodes (20): Alert, apiFetch(), getCookie(), Alert, cbIcon(), createAgent(), deleteAgent(), loadAgents() (+12 more)
...
Cohesion: 0.13
Nodes (18): dataFileMetrics(), extractExistingDataPath(), init(), inspectDataSource(), registerDomainActions(), TestAgentWithRealToolsBlocksFinalAnswerWithoutToolUse(), TestAgentWithRealToolsRejectsFinalAnswerWithoutToolUse(), TestDataPipelineTree_NoSourceReportsBlockedNotFabricated() (+10 more)

### Community 211 - "Community 211"
Cohesion: 0.14
Nodes (14): ErrorRecorder, NewOpenAICompatClient(), TestOpenAICompat_ErrorResponse(), TestOpenAICompat_GenerateWithModel_SendsChatCompletion(), rateLimitedServer(), TestDeepSeek_429ReturnsRateLimitError(), TestErrorRecorder_PrefersRateLimitError(), TestErrorRecorder_RecordsLastError() (+6 more)
...
Cohesion: 0.22
Nodes (17): NewMockLLM(), NewDefaultCompany(), CompanyState, Decision, QuarterResult, companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint() (+9 more)
...
Cohesion: 0.13
Nodes (18): TestFloatField_Exists(), TestFloatField_IntConversion(), TestFloatField_Missing_UsesDefault(), TestFloatField_WrongType_UsesDefault(), TestPlanStepsToStrings(), TestPlanStepsToStrings_Empty(), TestStringField_Exists(), TestStringField_Missing() (+10 more)
...
Cohesion: 0.24
Nodes (16): TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeTracer, mockOllamaServer(), newTestClient(), TestClient_AnalyzeComplexity(), TestClient_Generate() (+8 more)
...
Cohesion: 0.27
Nodes (13): cardSignatureValid(), SignAgentCard(), TestConvertToAgentCard_AttachesSignature(), TestHandleGlobalAgentCard_ResponseIsSigned(), TestSignAgentCard(), TestSignAgentCard_Deterministic(), TestSignAgentCard_DifferentCards(), TestSignAgentCard_NilCard() (+5 more)
...
Cohesion: 0.19
Nodes (12): TestRunOnce_EmitsRunRootSpan(), TestNestedActionSpansParentCorrectly(), TestPanickingActionRestoresTraceContextAndEndsSpan(), TestRegisteredActionEmitsSpan(), TestRegisteredConditionEmitsSpan(), withRecordingGlobalTracer(), NewTracedLLM(), NewTracedLLMWithParent() (+4 more)
...
Cohesion: 0.24
Nodes (7): NewFallbackLLM(), TestFallbackLLM_GenerateAllPanicReturnsAggregatedError(), TestFallbackLLM_GenerateRecoversPanicAndTriesNextModel(), TestFallbackLLM_GenerateReturnsAllFailures(), TestFallbackLLM_GenerateUsesNextModelAfterPrimaryFailure(), TestNewProvider_BuildsFallbackChainFromConfiguredModels(), stubLLM
...
Cohesion: 0.19
Nodes (11): NewEvolvedAgent(), TestConfig_AllFields(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_StructFields(), TestNewEvolvedAgent_AllToolsRegistered(), TestNewEvolvedAgent_MinimalConfig(), TestNewEvolvedAgent_NilBlackboard() (+3 more)
...
Cohesion: 0.14
Nodes (13): code:text (docs/superpowers/runs/<run-id>/), code:markdown (### Task N: Title), code:go (evolution.SerializableNode{), code:yaml (name: superpowers-prod-runner), code:go (// Deprecated: use ExecuteSuperpowersTaskBatch.), Current Stub Surface To Replace, Done Definition, Migration / Cleanup Notes (+5 more)
...
Cohesion: 0.22
Nodes (11): TestBuildIdentityStampedRevisionFallback(), BuildIdentityFromBuildInfo(), SetBuildIdentity(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered(), TestBlockDurationHistogramSeriesRendered(), TestBuildIdentityFromBuildInfo(), TestKGAnalyticsGaugesRenderedAndUpdated() (+3 more)

### Community 679 - "Community 679"
Cohesion: 0.26
Nodes (12): TestPromoteSubtree(), ApplyBlockMutations(), collectNames(), evolutionApplyAddAfter(), evolutionApplyAddBefore(), extractSubtree(), pickInsertOp(), PromoteSubtree() (+4 more)
...
Cohesion: 0.21
Nodes (9): captureExporter, NewOTLPHTTPExporter(), TestConfigureOTLPFromEnv(), TestConfigureOTLPFromEnv_DisabledWithoutEndpoint(), TestConsoleTracer_ExporterErrorDoesNotBreakEnd(), TestConsoleTracer_ExporterReceivesCompletedSpan(), TestOTLPHTTPExporter_Non2xx(), TestOTLPHTTPExporter_PostsOTLPJSON() (+1 more)
...
Cohesion: 0.2
Nodes (10): code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), Package: factory, Package: llm, Package: monitoring (+2 more)
...
Cohesion: 0.39
Nodes (5): HabitMiner, cosine(), jaccard(), sortedByCount(), RecurringPattern
...
Cohesion: 0.32
Nodes (7): CollectBlockIDs(), FitnessRanking(), RecordTaskBlockFitness(), ScoreFromBlackboard(), TestRecordTaskBlockFitness(), BlockFitnessRanking(), BlockFitnessSnapshot()
...
Cohesion: 0.33
Nodes (6): hasToolEdge(), TestFeedbackFlush_ForceOnShutdown(), TestFeedbackFlush_ThrottlesWrites(), TestLoadFeedback_MissingFileNoError(), TestSaveLoadFeedback_RecentRunsRoundTrip(), TestSaveLoadFeedback_RoundTrip()
...
Cohesion: 0.33
Nodes (5): init(), RegisterBlockMutations(), RegisterBlockRandomMutator(), tryApplyBlockMutations(), tryBlockRandomMutation()
...
Cohesion: 0.4
Nodes (4): RecordSelectorChildOutcomes(), TestRecordSelectorChildOutcomes_SkipsEmptyAndMalformed(), TestRecordSelectorChildOutcomes_WritesAndAccumulates(), SelectorChildOutcome
...
## Knowledge Gaps
- **9325 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+9320 more)
...
- **Why does `Append()` connect `Community 21` to `Community 2`, `Community 4`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 29`, `Community 30`, `Community 31`, `Community 33`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 40`, `Community 41`, `Community 44`, `Community 50`, `Community 53`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 66`, `Community 70`, `Community 74`, `Community 76`, `Community 77`, `Community 80`, `Community 81`, `Community 83`, `Community 85`, `Community 86`, `Community 87`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 96`, `Community 97`, `Community 98`, `Community 103`, `Community 108`, `Community 110`, `Community 115`, `Community 116`, `Community 121`, `Community 122`, `Community 123`, `Community 125`, `Community 127`, `Community 129`, `Community 130`, `Community 131`, `Community 133`, `Community 136`, `Community 138`, `Community 139`, `Community 652`, `Community 141`, `Community 142`, `Community 144`, `Community 146`, `Community 660`, `Community 662`, `Community 665`, `Community 155`, `Community 156`, `Community 158`, `Community 163`, `Community 679`, `Community 168`, `Community 169`, `Community 173`, `Community 686`, `Community 687`, `Community 176`, `Community 689`, `Community 690`, `Community 174`, `Community 180`, `Community 693`, `Community 695`, `Community 184`, `Community 199`, `Community 202`, `Community 203`, `Community 208`, `Community 210`, `Community 212`, `Community 214`, `Community 216`, `Community 217`, `Community 220`, `Community 221`, `Community 222`, `Community 228`, `Community 229`, `Community 233`, `Community 234`, `Community 890`, `Community 893`, `Community 911`, `Community 912`, `Community 420`, `Community 421`, `Community 935`, `Community 936`, `Community 423`, `Community 938`, `Community 433`, `Community 437`, `Community 438`, `Community 439`, `Community 447`, `Community 961`, `Community 451`, `Community 452`, `Community 454`, `Community 455`, `Community 463`, `Community 981`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 12` to `Community 2`, `Community 4`, `Community 6`, `Community 7`, `Community 907`, `Community 14`, `Community 15`, `Community 16`, `Community 19`, `Community 24`, `Community 153`, `Community 152`, `Community 27`, `Community 25`, `Community 31`, `Community 163`, `Community 37`, `Community 41`, `Community 45`, `Community 177`, `Community 51`, `Community 183`, `Community 57`, `Community 58`, `Community 188`, `Community 65`, `Community 194`, `Community 68`, `Community 75`, `Community 78`, `Community 976`, `Community 99`, `Community 114`, `Community 119`, `Community 122`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 31` to `Community 2`, `Community 4`, `Community 133`, `Community 6`, `Community 136`, `Community 138`, `Community 12`, `Community 141`, `Community 15`, `Community 17`, `Community 146`, `Community 149`, `Community 21`, `Community 27`, `Community 165`, `Community 422`, `Community 1318`, `Community 424`, `Community 41`, `Community 177`, `Community 50`, `Community 57`, `Community 191`, `Community 448`, `Community 194`, `Community 70`, `Community 71`, `Community 205`, `Community 80`, `Community 90`, `Community 93`, `Community 225`, `Community 101`, `Community 110`, `Community 120`, `Community 122`, `Community 127`?**
...
- **Are the 117 inferred relationships involving `registerMCPTools()` (e.g. with `TestBTEvolveGeneticRoutesThroughExperienceBank()` and `main()`) actually correct?**
  _`registerMCPTools()` has 117 INFERRED edges - model-reasoned connections that need verification._