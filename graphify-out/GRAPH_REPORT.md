# Graph Report - superpowers-20260717T095519-51bce651-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-17)

## Corpus Check
- 895 files · ~1,134,669 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25477 nodes · 38135 edges · 2003 communities (1647 shown, 356 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9203 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a5d390c1`
...
3. `9. Architecture Decisions` - 148 edges
...
## Communities (2003 total, 356 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (195): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+187 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (195): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+187 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (116): TestComputeAnalytics_BottleneckCarriesStructuredFailure(), TestComputeAnalytics_Bottlenecks(), TestComputeAnalytics_BottleneckWithoutTraceHasEmptyFailure(), TestComputeAnalytics_BottleneckWithTrace(), TestComputeAnalytics_Centrality(), TestComputeAnalytics_CoverageGapsUseExpectedDomains(), TestComputeAnalytics_EmptyGraph(), TestComputeAnalytics_ExtendedEdges() (+108 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (141): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+133 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (114): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+106 more)
...
Cohesion: 0.02
Nodes (100): expandChainStateTemplates(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM(), TestChainAction_Agent_NoTools() (+92 more)
...
Cohesion: 0.03
Nodes (96): main(), wireSelectorOrdering(), main(), main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior() (+88 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (112): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+104 more)
...
Cohesion: 0.05
Nodes (87): DefaultLLM(), RealLLM(), TestDetectPath_FromCurrentPath(), TestDetectPath_FromVisitedPaths(), TestDetectPath_KeywordFallback(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), EvaluateBFCLV3() (+79 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (61): TestRunPipelineWithID_RecordsAgentMetrics(), newAgentExecutor(), agentExecuteResult(), getDashCBStore(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun() (+53 more)
...
Cohesion: 0.04
Nodes (71): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), Category, Compose() (+63 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (15): Server, History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), mockTTOrch (+7 more)
...
Cohesion: 0.06
Nodes (62): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestNewFileWriteTool_Structure(), TestNewGoTestTool_Structure() (+54 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (74): dataFileMetrics(), extractExistingDataPath(), init(), inspectDataSource(), registerDomainActions(), ChainConfig, availableToolNames(), bbRunID() (+66 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (70): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), defaultNlmGrillAuthGuard(), ensureSuperpowersForEachTaskSetup() (+62 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (57): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree(), resolveTreeForUser(), agentTemplateYAML (+49 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (46): findChildByName(), TestCheckConfidence_ConditionExists(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords(), TestContainsAnyLower_NoKeywords(), TestContainsAnyLower_NoMatch() (+38 more)
...
Cohesion: 0.05
Nodes (68): TestBuildChainActionFn_LlmCallNilLLM(), TestBuildChainActionFn_UnknownChainType(), TestComputeSubtreeMetrics_MixedChildren(), TestComputeSubtreeMetrics_NilInput(), TestComputeSubtreeMetrics_UpdatesMaxValues(), TestComputeTreeMetrics_MaxRetriesAndTimeout(), TestComputeTreeMetrics_NestedChildren(), TestComputeTreeMetrics_ParallelWidth() (+60 more)
...
Cohesion: 0.05
Nodes (41): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+33 more)
...
Cohesion: 0.06
Nodes (47): growthFitness(), FitnessDimension, makeTestTree(), NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance() (+39 more)
...
Cohesion: 0.06
Nodes (58): TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), biasCandidatesWithExperience(), cloneTreeForGardener(), serializeTreeForGardener() (+50 more)

### Community 48 - "Community 48"
Cohesion: 0.11
Nodes (55): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Research(), TestTree_Research() (+47 more)
...
Cohesion: 0.06
Nodes (39): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait() (+31 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (41): TestOutcomeErrorDetail(), IsHealthyOutcome(), OutcomeErrorDetail(), TestLocalAgentResultNilResultAndSuccessPathsUnchanged(), TestLocalAgentResultPreservesOutcomeOnError(), attemptOutcomeError(), buildSchedulerConfig(), dlqReplayOutcomeError() (+33 more)
...
Cohesion: 0.06
Nodes (45): min(), brokenTool, ChainKind, BuildChainAction(), buildChainActionFn(), execLLMCall(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic() (+37 more)
...
Cohesion: 0.08
Nodes (26): Capability, TestDetermineCategory(), TestExtractKeywords(), TestTruncateTask(), Edge, Factory, AutoCreateTree(), AutoCreateTreeWith() (+18 more)
...
Cohesion: 0.05
Nodes (41): ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure(), TestValidateOutputQualityRejectsRefusals() (+33 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (31): AgentMetrics, AgentStats, BuildIdentity, Counter, Gauge, HealthResponse, Histogram, LabeledCounter (+23 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (31): TestBuildPlannerNode_ChainStateGoals(), GoalDefinition, GOAPAction, GOAPGoal, Plan, boolConditions(), BuildPlannerNode(), floatFromMap() (+23 more)

### Community 66 - "Community 66"
Cohesion: 0.07
Nodes (35): BehavioralDescriptor, FeatureDimension, TestMAPElitesPopulation_EvolveMAPElites_ObservesLearnedPatternViaExpertKnowledge(), Bucket(), cappedCells(), Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid() (+27 more)
...
Cohesion: 0.08
Nodes (36): TestCompiledPlanTree_ValidatesAndRuns(), NewAgent(), TestAutomationActions_ReachTaskAutomated(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory() (+28 more)
...
Cohesion: 0.1
Nodes (40): TestPopulation_StatsAccessors(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes(), TestAddFromMutation_NoChange() (+32 more)
...
Cohesion: 0.07
Nodes (37): TestBuiltinSWELite_CoverageAndUniqueness(), TestMax1(), benchmarkPlanTree(), benchmarkSuccessTree(), TestBFCLV3LoadErrorsAndEmptyEvaluation(), TestBFCLV3LoadFlattenAndEvaluate(), TestBuiltinBFCLSuitesHaveStableShape(), TestBuiltinBFCLV3StableShape() (+29 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (15): WebhookPublisher, TestActionForName_BulkCoverage(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), Recover(), SafeGo(), TestRecover_CatchesPanic(), TestRecover_NoPanic() (+7 more)
...
Cohesion: 0.07
Nodes (27): currentSuperpowersForEachTask(), BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), BuildCircuitBreaker(), BuildInverter(), BuildRepeater(), BuildRunner() (+19 more)

### Community 94 - "Community 94"
Cohesion: 0.09
Nodes (18): cloneMetadataForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask(), TestExtractDomain(), TestHashTreeForGardener(), treePriorityRank(), EvolveV2Config (+10 more)
...
Cohesion: 0.13
Nodes (32): isGoapNotebookLMFailure(), deriveNotebookLMResearchQuery(), isBoilerplateResearchTopic(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery(), nlmIsResearchImport() (+24 more)
...
Cohesion: 0.12
Nodes (31): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionPreflightWired(), goapFusionRepeatedHashBypassed() (+23 more)

### Community 116 - "Community 116"
Cohesion: 0.1
Nodes (27): Blackboard, ApplyParameters(), cholesky(), collectParams(), ExtractParameters(), invertCholesky(), itoa(), multiplyCholesky() (+19 more)

### Community 117 - "Community 117"
Cohesion: 0.12
Nodes (28): BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), LogsDir(), MemoryDir() (+20 more)
...
Cohesion: 0.17
Nodes (24): islandTestPopulation(), islandTestTree(), TestIslandModel_AddGetAndSingleIslandMigration(), TestIslandModel_DiversityEdgeCases(), TestIslandModel_DiversityStatsAndSummary(), TestIslandModel_EvolveAllEvaluatesPopulations(), TestIslandModel_LoadCapEvictionIncrementsEvictedIndividuals(), TestIslandModel_LoadCapsDiskOnlyIslandWholesaleAdoption() (+16 more)
...
Cohesion: 0.1
Nodes (22): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), IsKnownChainKind(), parseChainConfig(), TestIsKnownChainKind(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree() (+14 more)
...
Cohesion: 0.15
Nodes (19): Alert, apiFetch(), getCookie(), Alert, cbIcon(), createAgent(), deleteAgent(), loadAgents() (+11 more)
...
Cohesion: 0.15
Nodes (20): handleAgentsList(), AgentHistoryEntry, AgentInfo, agentStatus(), CreateAgent(), DefaultAgentTask(), ListAgents(), ListAgentsWithCB() (+12 more)

### Community 208 - "Community 208"
Cohesion: 0.17
Nodes (18): TestSelectorOptimizer_New(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), TestMemeticEvolve_ResurrectsExtinctSpecialist(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain() (+10 more)
...
Cohesion: 0.2
Nodes (16): TestBTOptimizer_New(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), NewBTOptimizer(), NewDTAnalyzer(), pathStat(), TestBTOptimizer_ReorderSelectors() (+8 more)
...
Cohesion: 0.14
Nodes (9): A2AHandoffBlock(), builtinBlocks(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), HumanGateBlock(), HITLTieredBlock(), MemoryLoadBlock() (+1 more)
...
Cohesion: 0.18
Nodes (11): code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), Package: goap, Package: langagent (+3 more)
...
Cohesion: 0.22
Nodes (9): code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), Package: a2a, Package: log, Package: persistence, Package: tools (+1 more)
...
Cohesion: 0.27
Nodes (6): code:bash (git rm docs/arc42/go-bt-evolve-arc42.md docs/arc42/09-test-s), code:bash (grep -rn 'docs/adr' README.md docs/*.md | grep -v 'docs/plan), code:bash (grep -c 'RegisterAction(' internal/engine/*.go | awk -F: '{s), code:bash (grep -c '^| Q[0-9] | \*\*' docs/arc42/01-introduction-goals.), Task 2: Merge §1 (Introduction and Goals), Task 9: Deletions + cross-doc reference updates
...
## Knowledge Gaps
- **9727 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+9722 more)
...
- **Why does `Append()` connect `Community 23` to `Community 4`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 30`, `Community 31`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 39`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 47`, `Community 48`, `Community 51`, `Community 54`, `Community 55`, `Community 56`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 72`, `Community 74`, `Community 77`, `Community 79`, `Community 81`, `Community 83`, `Community 84`, `Community 87`, `Community 89`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 99`, `Community 100`, `Community 101`, `Community 104`, `Community 107`, `Community 108`, `Community 111`, `Community 113`, `Community 116`, `Community 117`, `Community 120`, `Community 122`, `Community 123`, `Community 124`, `Community 130`, `Community 131`, `Community 133`, `Community 139`, `Community 144`, `Community 146`, `Community 147`, `Community 668`, `Community 156`, `Community 671`, `Community 672`, `Community 161`, `Community 167`, `Community 168`, `Community 682`, `Community 170`, `Community 172`, `Community 686`, `Community 175`, `Community 176`, `Community 177`, `Community 693`, `Community 695`, `Community 186`, `Community 193`, `Community 1221`, `Community 198`, `Community 199`, `Community 205`, `Community 206`, `Community 207`, `Community 214`, `Community 216`, `Community 217`, `Community 221`, `Community 223`, `Community 898`, `Community 907`, `Community 908`, `Community 912`, `Community 928`, `Community 929`, `Community 423`, `Community 425`, `Community 427`, `Community 429`, `Community 437`, `Community 439`, `Community 952`, `Community 953`, `Community 442`, `Community 440`, `Community 957`, `Community 448`, `Community 452`, `Community 454`, `Community 455`, `Community 456`, `Community 460`, `Community 461`, `Community 464`, `Community 465`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 120` to `Community 2`, `Community 132`, `Community 135`, `Community 8`, `Community 139`, `Community 141`, `Community 15`, `Community 19`, `Community 20`, `Community 21`, `Community 27`, `Community 160`, `Community 164`, `Community 37`, `Community 36`, `Community 40`, `Community 429`, `Community 178`, `Community 52`, `Community 182`, `Community 54`, `Community 64`, `Community 68`, `Community 198`, `Community 79`, `Community 214`, `Community 224`, `Community 101`, `Community 102`, `Community 109`, `Community 117`, `Community 127`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 10` to `Community 129`, `Community 2`, `Community 4`, `Community 6`, `Community 8`, `Community 16`, `Community 18`, `Community 22`, `Community 23`, `Community 24`, `Community 155`, `Community 30`, `Community 159`, `Community 39`, `Community 40`, `Community 41`, `Community 428`, `Community 429`, `Community 48`, `Community 53`, `Community 56`, `Community 57`, `Community 186`, `Community 60`, `Community 1343`, `Community 64`, `Community 66`, `Community 67`, `Community 68`, `Community 71`, `Community 73`, `Community 76`, `Community 208`, `Community 213`, `Community 89`, `Community 222`, `Community 96`, `Community 116`, `Community 117`?**
