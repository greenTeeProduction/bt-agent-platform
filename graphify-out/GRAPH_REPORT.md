# Graph Report - superpowers-20260713T111545-1d2ca422-goap-fusion-loop-runner-blackboard-conte  (2026-07-13)

## Corpus Check
- 839 files · ~939,205 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20639 nodes · 31928 edges · 1719 communities (1364 shown, 355 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8261 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8f4af502`
...
1. `Append()` - 392 edges
2. `DefaultTree()` - 132 edges
3. `NewRequest()` - 125 edges
...
## Communities (1719 total, 355 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (133): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+125 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (133): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+125 more)
...
Cohesion: 0.03
Nodes (100): absDiff(), cloneTree(), CodeReviewSuite(), cohensD(), DefaultMock(), fishersExact(), GoDevSuite(), minF() (+92 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (90): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+82 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (77): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+69 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (83): main(), main(), main(), SetAsDefault(), TestBlackboard_AllFields(), TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails(), TestRunTask_Success() (+75 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (67): stringContains(), TestBuildGoapStepPrompt(), buildGoapStepPrompt(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter() (+59 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (59): containsAnyStr(), findChildByName(), TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput() (+51 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (79): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+71 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (77): DefaultPanicHandler(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext() (+69 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (76): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+68 more)
...
Cohesion: 0.07
Nodes (72): DefaultLLM(), RealLLM(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), EvaluateBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic() (+64 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (70): arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), collapseToSingleLine(), completeGoapProgramMilestone() (+62 more)
...
Cohesion: 0.06
Nodes (65): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewGoBuildTool_Structure(), TestNewGoVetTool_Structure() (+57 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (53): Config, TestBaseNodeCount(), TestGetRetryCount(), TestIsNodeWrapped(), CycleMetrics, biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener() (+45 more)
...
Cohesion: 0.06
Nodes (49): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree(), agentTemplateYAML, TestResolveTreeID_FusionAliases(), HermesSelfEvolutionTree() (+41 more)

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (60): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+52 more)
...
Cohesion: 0.03
Nodes (68): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+60 more)
...
Cohesion: 0.07
Nodes (61): TestCheckConfidence_ConditionExists(), TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune(), makeRecords() (+53 more)
...
Cohesion: 0.14
Nodes (54): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+46 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (10): Server, OpenAPIGenerator, Append(), mockTTOrch, Workflow, Store, Config, DefaultConfig() (+2 more)
...
Cohesion: 0.07
Nodes (55): LoadPipeline(), RunPipeline(), RunPipelineWithID(), mcpDeps, addFailureContext(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree() (+47 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (58): TestEndpointsFromCardsSingleNodeYieldsNoPeers(), TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, NewAgentRouter(), NewLocalExecutor(), NewRouterFromEndpoints(), TestAgentRouter_AllExecutorsFail(), TestAgentRouter_EmptyHealth() (+50 more)
...
Cohesion: 0.05
Nodes (42): Blackboard, ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+34 more)
...
Cohesion: 0.06
Nodes (27): handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus() (+19 more)
...
Cohesion: 0.06
Nodes (34): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, Histogram, LabeledCounter, LabeledGauge (+26 more)
...
Cohesion: 0.06
Nodes (50): TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailure_BackwardCompat(), TestCircuitBreaker_RecordFailureWithCategory(), TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory() (+42 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (37): ActionFunc, ActionProvider, init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), ConditionFunc, ConditionProvider, init() (+29 more)
...
Cohesion: 0.06
Nodes (30): Analyzer, extractJSON(), NewAnalyzer(), truncate(), TestFactory_RejectsInvalidGeneratedTreeBeforePersisting(), TestGenerator_CompilesSkillActionsToChainActions(), TestAnalyzer_EmptyResponse_Error(), TestAnalyzer_NoStrategyPath_Error() (+22 more)
...
Cohesion: 0.06
Nodes (26): handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogin(), handleLogout() (+18 more)

### Community 57 - "Community 57"
Cohesion: 0.1
Nodes (42): extractTaskID(), init(), nlmAuthNeedsRefresh(), nlmAuthUnhealthy(), registerNotebookLMActions(), writeString(), superpowersPlanAlreadyImplemented(), deriveNotebookLMResearchQuery() (+34 more)

### Community 58 - "Community 58"
Cohesion: 0.05
Nodes (25): A2AHandoffBlock(), builtinBlocks(), TestBuiltinBlocks_Count(), TestBuiltinBlocks_UniqueNonEmptyIDs(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock() (+17 more)
...
Cohesion: 0.07
Nodes (37): ABDelta, ABTest, AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI(), containsStr() (+29 more)

### Community 61 - "Community 61"
Cohesion: 0.08
Nodes (28): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait() (+20 more)
...
Cohesion: 0.07
Nodes (32): TestOutcomeErrorDetail(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath(), hostURLOf() (+24 more)
...
Cohesion: 0.09
Nodes (33): TestPlanStepsToStrings(), TestPlanStepsToStrings_Empty(), TestWorldStateFromMap(), getStepResults(), planStepsToStrings(), registerGoapNodes(), TestAction_ExecuteGoapStep_AccumulatesAndSynthesizes(), worldStateFromMap() (+25 more)
...
Cohesion: 0.09
Nodes (15): envDefault(), main(), run(), AgentExecutor, PageAgent, init(), registerSuperpowersDebugActions(), superpowersDebugPhase() (+7 more)
...
Cohesion: 0.08
Nodes (30): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+22 more)

### Community 88 - "Community 88"
Cohesion: 0.07
Nodes (26): AutoRebuildEnabled(), defaultDriftHead(), DriftStatus(), DriftWatchOnce(), scrubGitEnv(), StartDriftWatcher(), TestDriftStatus(), TestDriftWatchOnce() (+18 more)

### Community 89 - "Community 89"
Cohesion: 0.08
Nodes (23): GateResult, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree(), SnapshotTree() (+15 more)

### Community 90 - "Community 90"
Cohesion: 0.1
Nodes (29): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), TestRunJob_WarnsOnDeployDriftAtCycleComplete(), TestRunJob_WebhookIncludesBuildRevision() (+21 more)
...
Cohesion: 0.13
Nodes (33): Duration(), TestDuration(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes() (+25 more)
...
Cohesion: 0.11
Nodes (30): TestMultiNode_ProbeFailsOnEmptyNodeURL(), TestMultiNode_ProbeFailsOnLessThanTwoNodes(), TestMultiNode_ScalabilityStatusRouterReporting(), TestMultiNodeExecutionPipeline(), MultiNodeProbeConfig, MultiNodeProbeReport, NodeProbeStatus, panicOnHostRoundTripper (+22 more)

### Community 103 - "Community 103"
Cohesion: 0.09
Nodes (20): TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), resolveUserTree(), TestWireSelectorReorderIsOptIn(), wireSelectorReorder() (+12 more)
...
Cohesion: 0.08
Nodes (28): TestNewReinforcementLearner(), TestQTableSelectUpdateBestAction(), TestQTableStateBucketsAndDepth(), TestReinforcementLearnerLearnAndSuggest(), NewQTable(), NewReinforcementLearner(), TestPopulationEvolve_CrisisIntervention(), TestPopulationEvolve_RecordsCrisisReasons() (+20 more)
...
Cohesion: 0.09
Nodes (26): FileJobStore, JobStore, NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad(), TestScheduler_NoJobStore_NilSafe() (+18 more)
...
Cohesion: 0.11
Nodes (25): collectSelectorNames(), SelectorStatsFile(), TestSelectorOptimizer_New(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain() (+17 more)
...
Cohesion: 0.13
Nodes (26): cmdImpact(), impactedTestsForSource(), normalizeImpactSource(), TestImpactedTestsForSource_AbsoluteSourceUnderRoot(), TestNormalizeImpactSource_AbsoluteUnderRoot(), TestNormalizeImpactSource_RejectsOutsideRoot(), writeImpactCLIFixture(), goFileInfo (+18 more)

### Community 135 - "Community 135"
Cohesion: 0.13
Nodes (24): BTAgentClient, treeSkillName(), treeTags(), interpretSendResult(), NewBTAgentClient(), safetyGetMessageText(), TestInterpretSendResult_HonestlyReportsFailureStates(), TestA2AServer_HandleAgentEndpoint_EmptyName() (+16 more)

### Community 136 - "Community 136"
Cohesion: 0.11
Nodes (17): AuctionDelegate(), cardWithURL(), newAuctionTransport(), newDeadlineProbeTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoCandidatesFallsBack(), TestAuctionDelegate_NoEligibleBidsFallsBack() (+9 more)
...
Cohesion: 0.09
Nodes (29): Binaries, code:go (type Counter struct { ... }), code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type PlatformEvalResult struct { ... }) (+21 more)
...
Cohesion: 0.13
Nodes (27): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionNoopPatchStreak(), goapFusionPreflightWired() (+19 more)
...
Cohesion: 0.14
Nodes (21): ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Compose(), ComposeFromRefs(), ComposeTaskTree() (+13 more)
...
Cohesion: 0.19
Nodes (20): NewAuctioneer(), TestAuctioneer_RunAuction_AppliesDefaultDispatchDeadline(), TestAuctioneer_RunAuction_BoundsWinnerDispatchWithAnnouncementDeadline(), TestAuctioneer_RunAuction_DispatchesToWinnerAndReturnsResult(), TestAuctioneer_RunAuction_NoEligibleBidsDispatchesNothing(), TestAuctioneer_RunAuction_RejectsEmptyDescription(), TestCollectBids_SurvivesPanickingCandidate(), bidJSON() (+12 more)
...
Cohesion: 0.15
Nodes (19): buildUntestedFilesProgramSpec(), fetchAcceptableGoapProgram(), goapFusionSeedSection(), TestArc42SeederToleratesDroppedMilestone(), TestFetchAcceptableProgram_RetriesOnceWithFeedback(), TestGoapFusionSeedSection(), TestReportFusionCycleIncludesSeedAndDegradedSections(), TestSeedNextProgram_DeterministicCoverageFallback() (+11 more)
...
Cohesion: 0.17
Nodes (14): errTest, errToString(), NewHealthMonitor(), TestHealthMonitorDegradationError(), TestHealthMonitorNilSafety(), TestHealthMonitorProbe(), TestHealthMonitorProbeFailure(), TestHealthMonitorProbeUnreachable() (+6 more)
...
Cohesion: 0.22
Nodes (19): ScoreAnnouncement(), cardResponder, RespondToAnnouncement(), bidArtifact(), drainExecute(), eventKinds(), executorForAgent(), skillCard() (+11 more)

### Community 202 - "Community 202"
Cohesion: 0.13
Nodes (15): agentNameInterceptor, agentNameKey, TestEligibleBidders(), TestEligibleBidders_NoRequiredTagsMatchesAll(), BTAgentExecutor, BuildCardRegistry(), cardCoversTags(), ConvertToAgentCard() (+7 more)
...
Cohesion: 0.32
Nodes (17): NewRedisPriorityQueueFromClient(), NewRedisQueueFromClient(), testRedisAddr(), testRedisClient(), TestRedisPriorityQueue_DefaultKey(), TestRedisPriorityQueue_DequeueOrder(), TestRedisPriorityQueue_Empty(), TestRedisPriorityQueue_IDIsUnique() (+9 more)
...
Cohesion: 0.21
Nodes (12): composeOrderedWithMiddle(), ComposePreset(), ComposePresetWithTools(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), PipelineWithToolsProfile(), profileOrDefault(), sliceContains() (+4 more)
...
Cohesion: 0.19
Nodes (10): TestNewFileWriteTool_Structure(), TestNewGoTestTool_Structure(), TestNewShellExecTool_Structure(), TestNewWebSearchTool_Structure(), TestRealTool_Call(), TestRealTool_NameAndDescription(), TestToolStub_CallReturnsEmpty(), TestToolStub_CallReturnsError() (+2 more)
...
Cohesion: 0.17
Nodes (9): Block, Category, ComposeSpec, blockIDFromOp(), TestComposePreset_AgenticDev(), TestMemoryWriteRoundTrip(), TestPipelineWithToolsProfile(), TestToolsDev_SetsDevTools() (+1 more)
...
Cohesion: 0.18
Nodes (6): DLQEscalateBlock(), FitnessProbeBlock(), TestFitnessProbeAction(), TestPushToDLQAction(), TestRecordTaskBlockFitness(), BlockFitnessSnapshot()
...
Cohesion: 0.36
Nodes (6): ListToolProfileBlocks(), mcpErr(), registerBlockTools(), resolveStrategyTree(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation()
...
Cohesion: 0.43
Nodes (6): impactTests(), registerImpactTools(), TestBTImpactTestsRegistered(), TestImpactTests_RejectsMissingSource(), TestImpactTests_ReturnsImpactedTestsForSource(), writeImpactMCPFixture()
...
Cohesion: 0.25
Nodes (8): code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), code:go (type AgentCard struct { Name, Description, URL string }), Package: a2a, Package: persistence, Package: tools, Package: util
...
## Knowledge Gaps
- **6822 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6817 more)
...
- **Why does `Append()` connect `Community 36` to `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 537`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 538`, `Community 32`, `Community 540`, `Community 544`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 46`, `Community 47`, `Community 48`, `Community 1071`, `Community 562`, `Community 51`, `Community 53`, `Community 54`, `Community 55`, `Community 566`, `Community 56`, `Community 57`, `Community 59`, `Community 60`, `Community 58`, `Community 62`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 69`, `Community 70`, `Community 71`, `Community 73`, `Community 74`, `Community 75`, `Community 76`, `Community 78`, `Community 79`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 91`, `Community 92`, `Community 93`, `Community 96`, `Community 100`, `Community 102`, `Community 105`, `Community 107`, `Community 109`, `Community 114`, `Community 115`, `Community 117`, `Community 119`, `Community 120`, `Community 122`, `Community 123`, `Community 124`, `Community 126`, `Community 128`, `Community 130`, `Community 133`, `Community 135`, `Community 137`, `Community 141`, `Community 145`, `Community 152`, `Community 154`, `Community 155`, `Community 156`, `Community 157`, `Community 158`, `Community 160`, `Community 170`, `Community 174`, `Community 178`, `Community 179`, `Community 180`, `Community 187`, `Community 188`, `Community 190`, `Community 706`, `Community 197`, `Community 200`, `Community 204`, `Community 717`, `Community 206`, `Community 207`, `Community 208`, `Community 209`, `Community 212`, `Community 728`, `Community 729`, `Community 730`, `Community 731`, `Community 219`, `Community 222`, `Community 224`, `Community 743`, `Community 756`, `Community 757`, `Community 764`, `Community 776`, `Community 779`, `Community 790`, `Community 365`, `Community 366`, `Community 371`, `Community 372`, `Community 374`, `Community 375`, `Community 376`, `Community 377`, `Community 382`, `Community 383`, `Community 384`, `Community 385`, `Community 394`, `Community 395`, `Community 396`, `Community 401`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 39` to `Community 131`, `Community 133`, `Community 6`, `Community 782`, `Community 15`, `Community 17`, `Community 146`, `Community 23`, `Community 24`, `Community 794`, `Community 30`, `Community 35`, `Community 36`, `Community 170`, `Community 171`, `Community 46`, `Community 48`, `Community 53`, `Community 183`, `Community 59`, `Community 190`, `Community 63`, `Community 66`, `Community 197`, `Community 206`, `Community 214`, `Community 215`, `Community 87`, `Community 107`, `Community 109`, `Community 114`, `Community 115`, `Community 1012`, `Community 118`, `Community 120`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 63` to `Community 6`, `Community 7`, `Community 135`, `Community 9`, `Community 17`, `Community 23`, `Community 28`, `Community 30`, `Community 32`, `Community 35`, `Community 164`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 46`, `Community 175`, `Community 48`, `Community 174`, `Community 50`, `Community 53`, `Community 183`, `Community 185`, `Community 61`, `Community 196`, `Community 207`, `Community 79`, `Community 88`, `Community 90`, `Community 736`, `Community 99`, `Community 101`, `Community 109`, `Community 115`, `Community 118`, `Community 123`?**
...
- **Are the 131 inferred relationships involving `DefaultTree()` (e.g. with `TestFullTreeIntegration_RunsAllTreesWithRealLLM()` and `TestDomainTree_Registration()`) actually correct?**
  _`DefaultTree()` has 131 INFERRED edges - model-reasoned connections that need verification._
- **Are the 124 inferred relationships involving `NewRequest()` (e.g. with `TestHITLHandlers_PendingApproveReject()` and `WorkflowApprovalWait()`) actually correct?**
  _`NewRequest()` has 124 INFERRED edges - model-reasoned connections that need verification._