# Graph Report - superpowers-20260717T134746-cc81bd8d-goap-fusion-loop-runner-blackboard-conte  (2026-07-17)

## Corpus Check
- 895 files · ~1,141,402 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25718 nodes · 38424 edges · 2039 communities (1684 shown, 355 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9238 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ff0a16f`
...
3. `9. Architecture Decisions` - 152 edges
4. `NewKnowledgeGraph()` - 146 edges
5. `registerMCPTools()` - 143 edges
6. `NewRequest()` - 140 edges
...
Cohesion: 0.02
Nodes (96): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+88 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (100): ApplyJitter(), ClassifyError(), contextDeadlineExceeded(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), FullJitter(), GetCategory() (+92 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (33): AgentMetric, AlertReport, Catalog, extractYAMLField(), inferTree(), splitTags(), CatalogEntry, History (+25 more)
...
Cohesion: 0.05
Nodes (94): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation() (+86 more)
...
Cohesion: 0.06
Nodes (96): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+88 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (101): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+93 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (93): init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), TestParseSplitOutput(), validateDesignAction(), validateDesignHeadings(), arc42SeedTargetGoal(), buildArc42SeedPrompt() (+85 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (96): handleLogout(), DefaultPanicHandler(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey (+88 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (89): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42DocsyncTree(), TestArc42DocsyncTreeRegistered(), TestArc42DocsyncTreeShape(), Arc42SeederTree(), Arc42Trees(), assembleDoc() (+81 more)
...
Cohesion: 0.05
Nodes (89): TestEndpointsFromCardsSingleNodeYieldsNoPeers(), TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip() (+81 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (76): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+68 more)
...
Cohesion: 0.06
Nodes (73): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+65 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (60): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull() (+52 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (65): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+57 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (58): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+50 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (76): TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestBuildChainActionFn_LlmCallNilLLM(), TestBuildChainActionFn_UnknownChainType(), TestComputeSubtreeMetrics_MixedChildren(), TestComputeSubtreeMetrics_NilInput() (+68 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (69): captureExporter, NewOTLPHTTPExporter(), TestConfigureOTLPFromEnv(), TestConfigureOTLPFromEnv_DisabledWithoutEndpoint(), TestConsoleTracer_ExporterErrorDoesNotBreakEnd(), TestConsoleTracer_ExporterReceivesCompletedSpan(), TestOTLPHTTPExporter_Non2xx(), TestOTLPHTTPExporter_PostsOTLPJSON() (+61 more)
...
Cohesion: 0.05
Nodes (70): blockOnHeldBBMu(), echoTaskLeaf, islandArchivePath(), persistEvolvedWinner(), qtableArchivePath(), registerMCPTools(), assertExpertArchiveFedFromRun(), injectSelectorProbeTree() (+62 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (66): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_New(), TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents(), TestBuildFromArchetype() (+58 more)
...
Cohesion: 0.04
Nodes (41): findChildByName(), TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords() (+33 more)
...
Cohesion: 0.04
Nodes (53): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+45 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (45): TestOutcomeErrorDetail(), RunDeps, applyOutcomeRefinement(), IsHealthyOutcome(), OutcomeErrorDetail(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome(), RunOptions (+37 more)

### Community 36 - "Community 36"
Cohesion: 0.07
Nodes (53): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+45 more)
...
Cohesion: 0.06
Nodes (58): Tool, AllTools(), DevTools(), DiskUsage(), FileRead(), HTTPGet(), MemoryUsage(), MonitorTools() (+50 more)
...
Cohesion: 0.05
Nodes (38): newAgentExecutor(), agentExecuteResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun() (+30 more)
...
Cohesion: 0.05
Nodes (53): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+45 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (24): extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), collectNodeNames(), containsCrisisReason(), Crossover(), ExperienceRetrievalHits() (+16 more)

### Community 45 - "Community 45"
Cohesion: 0.08
Nodes (56): registerSetupActions(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoTestTool_Structure(), TestNewWebSearchTool_Structure(), goModuleRoot(), newCalculatorTool(), newDiskUsageTool() (+48 more)
...
Cohesion: 0.07
Nodes (48): ArraySchema(), BoolSchema(), IntSchema(), ObjectSchema(), TestConvenienceSchemaConstructors(), findResponse(), NewRouteIndex(), ResponseValidator() (+40 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (47): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo(), assertNoForcedMasterWrite(), bareTestRun() (+39 more)

### Community 49 - "Community 49"
Cohesion: 0.13
Nodes (49): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Finance(), TestRouting_Research(), TestTree_Research() (+41 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (39): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), BuildInverter(), BuildRepeater(), BuildRunner() (+31 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (29): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports(), RunContext (+21 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (37): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus() (+29 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (43): ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure(), TestValidateOutputQualityRejectsRefusals() (+35 more)
...
Cohesion: 0.08
Nodes (47): AgentBus, AgentEvent, InitAgentBus(), PublishHealthAlert(), PublishServiceDown(), TestAgentBus_AllSubscribersReceiveAll(), TestAgentBus_CloseSubscriberChannelsClosed(), TestAgentBus_ConcurrentPublish() (+39 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (47): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField() (+39 more)
...
Cohesion: 0.06
Nodes (39): StartDriftWatcher(), main(), main(), main(), ApplyHITLPolicy(), attachLogHandler(), buildBaseHandler(), buildLogger() (+31 more)
...
Cohesion: 0.07
Nodes (40): agentNameFromBB(), init(), registerDelegateNodes(), NewMemoryStore(), priorityWeight(), summarizeOutput(), storeForTest(), TestContextBlock_EmptyStoreReturnsEmpty() (+32 more)

### Community 61 - "Community 61"
Cohesion: 0.1
Nodes (49): TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune(), makeRecords(), TestCloneTree_Independent() (+41 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (36): ActionFunc, ActionProvider, init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), ConditionFunc, ConditionProvider, init() (+28 more)

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (47): Approval, mockOrch, newTaskNonce(), NewWorkflow(), sortTasks(), TestApproval_Fields(), TestApproveTask(), TestExecuteSprint() (+39 more)

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (29): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired(), wireSelectorOrdering(), GardenerDeactivateAllTool (+21 more)

### Community 65 - "Community 65"
Cohesion: 0.08
Nodes (44): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves(), NewFileJobStore() (+36 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (40): TestDriftWatchOnce_SkipsRestartWhenJobStartedMidRebuild(), TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), TestStartDriftWatcher_KickTriggersImmediateCheck(), JobsDir(), RegistryDir(), SchedulerJobsFile(), ResolvePipelineAgent() (+32 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (43): NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation(), TestCrisisDetector_DetectPopulation_DiversityCollapse() (+35 more)

### Community 68 - "Community 68"
Cohesion: 0.08
Nodes (33): growthFitness(), FitnessDimension, MultiFitness, MultiIndividual, cappedIndividuals(), clampScore(), countActions(), countConditions() (+25 more)

### Community 69 - "Community 69"
Cohesion: 0.09
Nodes (34): BehavioralDescriptor, FeatureDimension, Bucket(), Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid(), NewMAPElitesPopulation(), cellFitnesses() (+26 more)
...
Cohesion: 0.06
Nodes (41): applyDotEnvFiles(), applyDotEnvToConfig(), applyEnvOverrides(), Load(), LoadDotEnv(), LoadFile(), LoadFileWithDotEnv(), parseBool() (+33 more)

### Community 72 - "Community 72"
Cohesion: 0.13
Nodes (35): TestRunSuiteIsSandboxed(), TestNoNewGapsOrImplDegraded_IsFallbackEligibleGuard(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled() (+27 more)
...
Cohesion: 0.07
Nodes (26): TestAnalyzeImprovementGaps_NoFabricatedEngineTestBlocker(), Analyzer, extractJSON(), NewAnalyzer(), truncate(), NewAgentFactory(), TestFactory_RejectsInvalidGeneratedTreeBeforePersisting(), TestGenerator_CompilesSkillActionsToChainActions() (+18 more)
...
Cohesion: 0.07
Nodes (28): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), Entry, Limits, DefaultManager() (+20 more)
...
Cohesion: 0.07
Nodes (31): Outcome, Record, FilterByTreeName(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask() (+23 more)

### Community 85 - "Community 85"
Cohesion: 0.11
Nodes (30): AllSLOMetrics(), GetSLOMetrics(), TestAllSLOMetrics(), LoadSLOEvidence(), SaveSLOMetrics(), TestLoadSLOEvidence_MissingFile(), TestSaveSLOMetrics_AtomicNoTmpLeftBehind(), TestSaveSLOMetrics_LoadSLOEvidence_Roundtrip() (+22 more)
...
Cohesion: 0.05
Nodes (22): A2AHandoffBlock(), builtinBlocks(), TestBuiltinBlocks_Count(), TestBuiltinBlocks_UniqueNonEmptyIDs(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock() (+14 more)

### Community 89 - "Community 89"
Cohesion: 0.08
Nodes (24): UsersDir(), TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree() (+16 more)

### Community 90 - "Community 90"
Cohesion: 0.11
Nodes (38): jaccardSimilarity(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes(), TestAddFromMutation_NoChange() (+30 more)
...
Cohesion: 0.09
Nodes (31): NewDefaultCompany(), CompanyOrchestrator, EngineerTree(), MarketingTree(), SalesTree(), clamp(), safeDiv(), companySummary() (+23 more)
...
Cohesion: 0.1
Nodes (34): TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull(), TestBrainstormRejectedWhenFilesNotGoPath(), TestBrainstormRejectedWhenMalformedOrProse(), TestBrainstormRejectedWhenNotDeeper(), TestBrainstormRejectedWhenRunOmitsShort(), withBrainstorm(), brainstormExpandPlan() (+26 more)
...
Cohesion: 0.08
Nodes (27): BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), LogsDir(), MemoryDir() (+19 more)
...
Cohesion: 0.06
Nodes (17): alwaysSampler, Attr, ConsoleTracer, neverSampler, noopSpan, noopTracer, RatioSampler, Sampler (+9 more)

### Community 103 - "Community 103"
Cohesion: 0.08
Nodes (23): auctionAnnouncement(), auctionCandidates(), betterBid(), candidateContext(), candidateOverride(), cardURL(), NewPersistentAuctioneer(), stateFloat() (+15 more)
...
Cohesion: 0.11
Nodes (7): ExperienceBank, acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), cappedCells(), TrackRecord
...
Cohesion: 0.1
Nodes (28): init(), registerSuperpowersDebugActions(), superpowersDebugPhase(), superpowersDebugPhaseAction(), newGrillLoopTestRun(), TestGrillDesign_ApprovedWhenNoOpenCriticals(), TestGrillDesign_NeedsWorkWithFeedbackWhenCriticalsOpen(), TestGrillDesign_NoProgressBreakerFailsAfterTwoStaleRounds() (+20 more)
...
Cohesion: 0.1
Nodes (24): TestRunOnce_EmitsRunRootSpan(), TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeSpan, fakeTracer, mockOllamaServer(), newTestClient() (+16 more)
...
Cohesion: 0.14
Nodes (28): agentNameInterceptor, agentNameKey, ScoreAnnouncement(), BTAgentExecutor, cardResponder, parseAnnouncement(), RespondToAnnouncement(), SetTreeResolver() (+20 more)

### Community 123 - "Community 123"
Cohesion: 0.1
Nodes (22): IsKnownChainKind(), parseChainConfig(), TestChainAction_ParseConfig(), TestIsKnownChainKind(), asFloat(), compiledGoapActionFor(), compiledGoapConditionFor(), goapValuesEqual() (+14 more)

### Community 124 - "Community 124"
Cohesion: 0.12
Nodes (13): containsStr(), hasNodeMatching(), hasNodeType(), MaxDepth(), ExpertKnowledge, hasAnySetupTools(), hasExecutionPathFirst(), hasUnboundedRetry() (+5 more)

### Community 125 - "Community 125"
Cohesion: 0.12
Nodes (26): TestCompiledPlanTree_ValidatesAndRuns(), convertGoapChildren(), FromGoapNode(), GOAPDevOpsTree(), GOAPPlanningTree(), GOAPResearchTree(), Blackboard, BlackboardBridge (+18 more)

### Community 126 - "Community 126"
Cohesion: 0.11
Nodes (32): AgentMetric, Alert, AlertReport, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON(), evaluateGlobalAlerts(), evaluateHTTPAlerts() (+24 more)
...
Cohesion: 0.14
Nodes (31): CompressionMiddleware(), gzipDecompress(), TestCompressionMiddleware_AlreadyCompressed(), TestCompressionMiddleware_BinaryContentType(), TestCompressionMiddleware_EmptyBody(), TestCompressionMiddleware_GzipRequest(), TestCompressionMiddleware_HTMLContentType(), TestCompressionMiddleware_LargeJSONResponse() (+23 more)
...
Cohesion: 0.11
Nodes (25): handleFellows(), handleWorkflowRunFullPipeline(), TestHandleWorkflowRunFullPipeline_PersistsWorkflowAndTasks(), NewMockLLM(), DebateTurn, Fellow, DefaultFellows(), NewThinkTank() (+17 more)
...
Cohesion: 0.07
Nodes (11): References, PrependGoapFusionPreflight(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedDelegatesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedMaterializesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionCircuitPolicyVerdictFoldsNoopStreak(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionLoopSharesCircuitBreakerVerdict(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionLoopSharesCircuitBreakerWindow(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesLoopRunner() (+3 more)
...
Cohesion: 0.12
Nodes (28): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionNoopPatchStreak(), goapFusionRepeatedHashBypassed(), init() (+20 more)

### Community 135 - "Community 135"
Cohesion: 0.1
Nodes (28): envDefault(), main(), run(), finishProbe(), headerEquals(), headerPresent(), probeCSRFCookie(), ProbeDashboard() (+20 more)

### Community 136 - "Community 136"
Cohesion: 0.08
Nodes (12): Server, NewPageAgent(), TestAgentLLMGeneration(), TestAgentMockFallback(), TestBubbleRecommendation(), NewHandler(), TestHandleBookmark(), TestHandleIntent() (+4 more)

### Community 137 - "Community 137"
Cohesion: 0.09
Nodes (26): TestClient_AnalyzeComplexity_FallbackOnError(), TestClient_Generate_ConnectionRefused(), TestClient_GeneratePlan_FallbackOnError(), TestClient_Reflect_FallbackOnError(), TestDeepSeekClient_AnalyzeComplexity(), TestDeepSeekClient_Generate_APIError(), TestDeepSeekClient_Generate_ConnectionRefused(), TestDeepSeekClient_Generate_EmptyChoices() (+18 more)
...
Cohesion: 0.09
Nodes (15): NewDocPlanner(), DocPlanner, DocPlannerWorldState, fakeBlackboard, TestAgentFailurePathsAndSummary(), TestBlackboardBridgeHandlesNilChainStateAndFailure(), TestBlackboardBridgeSyncAndPlanSuccess(), TestBuildGoalFromTaskMultipleKeywordsAndTruncation() (+7 more)
...
Cohesion: 0.16
Nodes (28): deriveNotebookLMResearchQuery(), isBoilerplateResearchTopic(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery(), nlmIsResearchImport(), nlmIsResearchStart() (+20 more)

### Community 146 - "Community 146"
Cohesion: 0.11
Nodes (15): AuctionDelegate(), cardWithURL(), newAuctionTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoCandidatesFallsBack(), TestAuctionDelegate_NoEligibleBidsFallsBack(), TestAuctionDelegate_RequiredTagsFilterCandidates() (+7 more)
...
Cohesion: 0.11
Nodes (15): NewNSGAIIPopulation(), NewNSGAIISorter(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic(), TestNSGAII_FastNonDominatedSort() (+7 more)
...
Cohesion: 0.1
Nodes (25): mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection(), expertArchivePath() (+17 more)
...
Cohesion: 0.13
Nodes (22): requireOllamaFinanceTest(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis(), TestTeslaMarket(), TestTeslaModel(), TestTeslaPitchAgent(), TestTeslaValuation() (+14 more)
...
Cohesion: 0.12
Nodes (19): main(), BTStudioCompany(), main(), min(), requireOllamaFinanceTest(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis() (+11 more)
...
Cohesion: 0.14
Nodes (17): fakeLLM, DefaultInitialState(), NewGoalFactory(), TestAutomationActions_ReachTaskAutomated(), TestGoalFactory_ArchetypeFallbackWhenLLMKeepsFailing(), TestGoalFactory_ArchetypeFallbackWithoutLLM(), TestGoalFactory_EmptyIntent(), TestGoalFactory_FromIntentLLM() (+9 more)
...
Cohesion: 0.16
Nodes (17): AgentMetrics, AgentStats, BuildIdentity, HealthResponse, LabeledGauge, formatPromLabels(), labeledSnapshotToMap(), labelString() (+9 more)
...
Cohesion: 0.14
Nodes (5): errToString(), TestStatusString(), HealthMonitor, HealthState, HealthStatus

### Community 188 - "Community 188"
Cohesion: 0.25
Nodes (23): TestClaudeErrorHandler_DoesNotClobberExistingCategory(), swapErrorHandlerRunner(), TestRequestErrorHandlerProposal_RespectsCallerContext(), TestRequestErrorHandlerProposal_StampsLedgerOnEveryOutcome(), ehTestHandlerNode(), ehTestProposalJSON(), runHandler(), TestClaudeErrorHandler_BuildSwitchAndValidation() (+15 more)
...
Cohesion: 0.09
Nodes (15): init(), modal, num, renderTab(), state, TAB_KEYS, renderAgents(), renderCompany() (+7 more)
...
Cohesion: 0.14
Nodes (21): defaultNlmGrillAuthGuard(), nlmGrillAnswerer(), nlmGrillUnavailable(), parseNumberedAnswers(), runGrillAuthGuardAction(), TestNlmGrillAnswerer_AuthGuardFailureIsUnavailable(), TestNlmGrillAnswerer_EmptyOutputIsUnavailable(), TestNlmGrillAnswerer_NoAnswerMarkersIsUnavailable() (+13 more)
...
Cohesion: 0.11
Nodes (7): Config, diffSecretField(), Duration(), TestDuration(), BuildCircuitBreaker(), BuildTimeout(), TestStoreSaveCompactsTerminalRecords()
...
Cohesion: 0.14
Nodes (16): TestInjectPersonaContextHoldsBBMu(), injectPersonaContext(), injectPersonaContextLocked(), mineUserPatterns(), personaEmbedder(), personaError(), recordPersonaInteraction(), registerPersonaTools() (+8 more)

### Community 206 - "Community 206"
Cohesion: 0.14
Nodes (19): NewACPClient(), countCrashInvocations(), TestACPClientCircuitBreakerShortCircuitsRepeatedSubprocessFailures(), TestACPClientGenerateCtx_StderrBufferRace(), TestACPClientGenerateReturnsErrorWhenSessionMissing(), TestACPClientGenerateTalksToACPServer(), TestACPClientGenerateTalksToHermesACP(), TestACPHelperProcess() (+11 more)

### Community 207 - "Community 207"
Cohesion: 0.19
Nodes (19): treeSkillName(), treeTags(), NewBTAgentClient(), TestA2AServer_HandleAgentEndpoint_EmptyName(), TestA2AServer_HandleAgentEndpoint_UnknownAgent(), TestA2AServer_HandleHealth_Direct(), TestA2AServer_HandleWellKnown(), TestA2AServer_Stop() (+11 more)
...
Cohesion: 0.1
Nodes (6): EvolveTool, FitnessTool, GetReflectionsTool, GetTreeTool, truncateStr(), RunTaskTool

### Community 210 - "Community 210"
Cohesion: 0.2
Nodes (17): DiversityMetrics, EvolutionParameters, FitnessMetrics, BuildPopulationStateWithGrid(), clamp01(), clampMutationRate(), DefaultPhaseRanges(), patternForState() (+9 more)

### Community 211 - "Community 211"
Cohesion: 0.12
Nodes (16): DefaultBlockConfig(), NewMetaPromptEvolver(), NewMutationContext(), TestBlockConfig_FilterMutations(), TestBlockConfig_IsMutable(), TestCrisisDetector_LastDiversity(), TestDefaultBlockConfig(), TestExpert_MatchPattern() (+8 more)
...
Cohesion: 0.13
Nodes (18): TestRunPipelineWithID_RecordsAgentMetrics(), handleSprintExecute(), syncWorkflowTaskStatus(), TestHandleSprintExecute_UpdatesCurrentWorkflow(), isAuctionShapedTask(), NewAgentExecutor(), PickTreeForTask(), ResolveAgentName() (+10 more)

### Community 215 - "Community 215"
Cohesion: 0.13
Nodes (19): isKnownActionName(), isKnownConditionName(), TestBuildNode_AbortOnEvent(), TestBuildNode_PlannerNode(), TestBuildNode_ReactiveParallel(), TestBuildNode_UtilitySelector(), TestIsKnownActionName_BuiltinOnly(), TestIsKnownActionName_Empty() (+11 more)
...
Cohesion: 0.12
Nodes (17): appendMissingRealTools(), inferToolsForTask(), init(), uniqueStrings(), TestAgentWithRealToolsBlocksFinalAnswerWithoutToolUse(), TestAgentWithRealToolsRejectsFinalAnswerWithoutToolUse(), TestDataPipelineTree_NoSourceReportsBlockedNotFabricated(), TestDataPipelineTree_UsesObservedFileMetrics() (+9 more)
...
Cohesion: 0.16
Nodes (13): ApprovalWaitResult, Pipeline, PipelineResult, Runner, Step, StepKind, StepResult, wfState (+5 more)

### Community 225 - "Community 225"
Cohesion: 0.21
Nodes (16): TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestHumanApprovalGate_AutoApprove(), TestHumanApprovalGate_ManualApprove(), TestHumanApprovalGate_PostPhase(), BuildAndValidate() (+8 more)
...
Cohesion: 0.18
Nodes (18): TestSelectorOptimizer_New(), TestSelectorOptimizer_ShouldPrune(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing(), TestLocalSearch_TabuSearch() (+10 more)
...
Cohesion: 0.18
Nodes (15): Alert, apiFetch(), getCookie(), cbIcon(), createAgent(), deleteAgent(), loadAgents(), runAgent() (+7 more)
...
Cohesion: 0.23
Nodes (15): TemplatesDir(), NewRunDeps(), cmdCreate(), cmdDelete(), cmdInstallTemplates(), cmdList(), cmdLogs(), cmdRun() (+7 more)
...
Cohesion: 0.11
Nodes (17): arc42 Docs Consolidation & Per-Section Sync Nodes — Implementation Plan, Canonical section layout (used by merge tasks, Go manifest, and drift script — keep all three in lockstep), code:bash (cd <repo-root>), code:bash (grep -F '## 10.1 Quality Tree' docs/arc42/10-quality.md && g), code:markdown (# arc42 Section Guidelines), code:bash (grep -c '^## Section [0-9]' docs/arc42/GUIDELINES.md   # exp), code:bash (git status --short          # expect: empty), code:bash (for f in 02-constraints 03-context-scope 04-solution-strateg) (+9 more)
...
Cohesion: 0.29
Nodes (12): cardSignatureValid(), SignAgentCard(), TestHandleGlobalAgentCard_ResponseIsSigned(), TestSignAgentCard(), TestSignAgentCard_Deterministic(), TestSignAgentCard_DifferentCards(), TestSignAgentCard_NilCard(), TestVerifyAgentCard_AfterModification() (+4 more)
...
Cohesion: 0.19
Nodes (3): Workflow, TestPrioritizeGoapGoals_AffirmativeBlockerProducesEngineTestGoal(), TestPrioritizeGoapGoals_NoImportCycleFalseGoalFromResearchGap()

### Community 466 - "Community 466"
Cohesion: 0.22
Nodes (4): blockIDFromOp(), Registry, cloneTree(), NewRegistry()
...
Cohesion: 0.22
Nodes (12): ListToolProfileBlocks(), mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu() (+4 more)
...
Cohesion: 0.18
Nodes (9): HTTPMethod, collectViolations(), fieldPath(), pathOrRoot(), routeKey(), responseCapture, ResponseValidatorConfig, RouteIndex (+1 more)

### Community 474 - "Community 474"
Cohesion: 0.22
Nodes (11): banditChildKey(), banditLockFor(), banditStatsDir(), banditStatsPath(), banditUCB1Order(), BuildBanditSelector(), recordBanditOutcome(), saveBanditStats() (+3 more)
...
Cohesion: 0.25
Nodes (11): escHTML(), formatDuration(), refreshTraces(), renderRecentSpans(), renderSpanTree(), renderTraceDetail(), renderTraceList(), renderTraces() (+3 more)
...
Cohesion: 0.14
Nodes (14): code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), code:go (type AgentCard struct { Name, Description, URL string }), code:go (type PlatformEvalResult struct { ... }), code:go (type BaselineStore struct { ... }), code:go (type WorkflowReport struct { ... }), code:go (type AgentInfo struct { Name, Status, Schedule string; Succe), Package: a2a (+6 more)
...
Cohesion: 0.14
Nodes (13): code:text (docs/superpowers/runs/<run-id>/), code:go (sel("Phase1_Design",), code:markdown (### Task N: Title), code:go (evolution.SerializableNode{), code:yaml (name: superpowers-prod-runner), Current Stub Surface To Replace, Done Definition, Production Acceptance Criteria (+5 more)
...
Cohesion: 0.22
Nodes (9): hasToolEdge(), TestFeedbackFlush_ForceOnShutdown(), TestFeedbackFlush_ThrottlesWrites(), TestLoadFeedback_MissingFileNoError(), TestLoadFeedback_ResurrectsUnregisteredEvolvedTree(), TestSaveLoadFeedback_EvolvedFromEdgeRoundTrip(), TestSaveLoadFeedback_EvolvedMetadataRoundTrip(), TestSaveLoadFeedback_RecentRunsRoundTrip() (+1 more)
...
Cohesion: 0.29
Nodes (5): TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait(), GetPolicy(), ApplyAutoApproveIfPolicy()

### Community 955 - "Community 955"
Cohesion: 0.51
Nodes (7): newThrottleTestServer(), taskCompleteEvent(), TestFailureAndDegradedOutcomesNeverThrottled(), TestRoutineNoChangeHeartbeatAfterQuietDay(), TestRoutineNoChangeNotificationsThrottledAfterBaseline(), TestThrottleStatePersistsAcrossPublisherRestarts(), throttleTestServer
...
Cohesion: 0.2
Nodes (10): code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), Package: log, Package: persistence, Package: reflection (+2 more)
...
Cohesion: 0.28
Nodes (8): CollectBlockIDs(), FitnessRanking(), RecordTaskBlockFitness(), ScoreFromBlackboard(), TestRecordTaskBlockFitness(), BlockFitnessRanking(), BlockFitnessSnapshot(), TestRecordBlockFitnessMetric_RateLimitCarryoverOutcome_UsesHealthyTier()
...
Cohesion: 0.22
Nodes (9): goapFusionImplementationGateWired(), goapFusionPreflightWired(), PrependGoapFusionImplementationGate(), spliceGoapFusionStateHashProducer(), WireGoapFusionLoopTree(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionGatesClaudeImplementation(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionWiresLoopTree(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionWiresLoopTreeIsIdempotent() (+1 more)
...
Cohesion: 0.29
Nodes (4): scriptedClaudeRunner, scriptedSuperpowersRunner, readFileForTest(), TestSuperpowersTaskExecutorRunsRedBeforeGreen()
...
Cohesion: 0.25
Nodes (8): code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), Package: evaluator, Package: gardener, Package: goap, Package: langagent
...
Cohesion: 0.6
Nodes (5): TestNestedActionSpansParentCorrectly(), TestPanickingActionRestoresTraceContextAndEndsSpan(), TestRegisteredActionEmitsSpan(), TestRegisteredConditionEmitsSpan(), withRecordingGlobalTracer()
...
## Knowledge Gaps
- **9887 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+9882 more)
...
- **Why does `Append()` connect `Community 7` to `Community 1027`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 12`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 27`, `Community 29`, `Community 33`, `Community 34`, `Community 37`, `Community 39`, `Community 41`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 49`, `Community 50`, `Community 51`, `Community 53`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 74`, `Community 75`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 90`, `Community 91`, `Community 92`, `Community 94`, `Community 95`, `Community 97`, `Community 100`, `Community 101`, `Community 102`, `Community 104`, `Community 105`, `Community 106`, `Community 109`, `Community 112`, `Community 115`, `Community 123`, `Community 124`, `Community 130`, `Community 131`, `Community 133`, `Community 135`, `Community 136`, `Community 139`, `Community 141`, `Community 143`, `Community 148`, `Community 149`, `Community 156`, `Community 167`, `Community 168`, `Community 172`, `Community 173`, `Community 685`, `Community 178`, `Community 179`, `Community 690`, `Community 181`, `Community 183`, `Community 199`, `Community 714`, `Community 715`, `Community 203`, `Community 206`, `Community 207`, `Community 208`, `Community 209`, `Community 210`, `Community 213`, `Community 214`, `Community 216`, `Community 220`, `Community 221`, `Community 223`, `Community 224`, `Community 229`, `Community 1255`, `Community 233`, `Community 234`, `Community 918`, `Community 928`, `Community 929`, `Community 944`, `Community 438`, `Community 951`, `Community 952`, `Community 439`, `Community 440`, `Community 455`, `Community 972`, `Community 973`, `Community 465`, `Community 977`, `Community 466`, `Community 979`, `Community 473`, `Community 475`, `Community 476`, `Community 478`, `Community 479`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 35` to `Community 128`, `Community 5`, `Community 6`, `Community 15`, `Community 17`, `Community 21`, `Community 23`, `Community 25`, `Community 27`, `Community 28`, `Community 36`, `Community 42`, `Community 45`, `Community 946`, `Community 51`, `Community 436`, `Community 52`, `Community 55`, `Community 184`, `Community 58`, `Community 60`, `Community 61`, `Community 65`, `Community 66`, `Community 451`, `Community 203`, `Community 76`, `Community 206`, `Community 85`, `Community 89`, `Community 90`, `Community 225`, `Community 121`, `Community 100`, `Community 111`, `Community 1017`, `Community 122`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 27` to `Community 130`, `Community 5`, `Community 7`, `Community 141`, `Community 15`, `Community 16`, `Community 148`, `Community 21`, `Community 150`, `Community 151`, `Community 28`, `Community 35`, `Community 36`, `Community 43`, `Community 44`, `Community 49`, `Community 51`, `Community 183`, `Community 184`, `Community 440`, `Community 58`, `Community 443`, `Community 60`, `Community 61`, `Community 189`, `Community 66`, `Community 68`, `Community 69`, `Community 73`, `Community 74`, `Community 201`, `Community 205`, `Community 471`, `Community 94`, `Community 99`, `Community 227`, `Community 101`, `Community 1379`, `Community 100`, `Community 234`?**
...
- **Are the 144 inferred relationships involving `NewKnowledgeGraph()` (e.g. with `TestComputeAnalytics_EmptyGraph()` and `TestComputeAnalytics_Centrality()`) actually correct?**
  _`NewKnowledgeGraph()` has 144 INFERRED edges - model-reasoned connections that need verification._