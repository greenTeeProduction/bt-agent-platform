# Graph Report - superpowers-20260717T112828-51bce651-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-17)

## Corpus Check
- 895 files · ~1,137,618 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25598 nodes · 38274 edges · 2019 communities (1665 shown, 354 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9217 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f1b8320f`
...
3. `9. Architecture Decisions` - 150 edges
4. `NewKnowledgeGraph()` - 146 edges
5. `registerMCPTools()` - 143 edges
6. `NewRequest()` - 139 edges
...
## Communities (2019 total, 354 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (197): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+189 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (197): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+189 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (113): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+105 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (143): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+135 more)
...
Cohesion: 0.04
Nodes (112): mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu() (+104 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (109): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+101 more)
...
Cohesion: 0.04
Nodes (76): Catalog, extractYAMLField(), inferTree(), splitTags(), CatalogEntry, OpenAPIGenerator, Append(), mockTTOrch (+68 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (96): handleLogin(), handleLogout(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey (+88 more)
...
Cohesion: 0.04
Nodes (75): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle(), ComposePreset() (+67 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (88): arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), collapseToSingleLine(), completeGoapProgramMilestone() (+80 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (89): DefaultLLM(), RealLLM(), TestDetectPath_FromCurrentPath(), TestDetectPath_FromVisitedPaths(), TestDetectPath_KeywordFallback(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), EvaluateBFCLV3() (+81 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (80): ApplyJitter(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), FullJitter(), GetCategory(), GetErrorContext(), NewCategorizedError() (+72 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (83): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+75 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (72): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard() (+64 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (68): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+60 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (81): TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, NewAgentRouter(), NewDeadLetterQueue(), NewLocalExecutor(), NewRouterFromEndpoints(), NewSchedulerState(), TestAgentRouter_AllExecutorsFail() (+73 more)
...
Cohesion: 0.04
Nodes (66): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+58 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (66): TestDriftWatchOnce_SkipsRestartWhenJobStartedMidRebuild(), TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir() (+58 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (61): AgentBus, AgentEvent, InitAgentBus(), PublishHealthAlert(), PublishServiceDown(), TestAgentBus_AllSubscribersReceiveAll(), TestAgentBus_CloseSubscriberChannelsClosed(), TestAgentBus_ConcurrentPublish() (+53 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (75): TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestComputeSubtreeMetrics_MixedChildren(), TestComputeSubtreeMetrics_NilInput(), TestComputeSubtreeMetrics_UpdatesMaxValues(), TestComputeTreeMetrics_MaxRetriesAndTimeout() (+67 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (68): captureExporter, NewOTLPHTTPExporter(), TestConfigureOTLPFromEnv(), TestConfigureOTLPFromEnv_DisabledWithoutEndpoint(), TestConsoleTracer_ExporterErrorDoesNotBreakEnd(), TestConsoleTracer_ExporterReceivesCompletedSpan(), TestOTLPHTTPExporter_Non2xx(), TestOTLPHTTPExporter_PostsOTLPJSON() (+60 more)
...
Cohesion: 0.07
Nodes (68): registerSuperpowersProductionActions(), autofixScriptRunner, autofixScriptStep, TestCurrentSuperpowersRunRefusesFinishedRun(), applySuperpowersRunFromBareRepo(), captureSuperpowersWorktreePatch(), commitAppliedSuperpowersRun(), discardSuperpowersWorktree() (+60 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (43): findChildByName(), TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords() (+35 more)
...
Cohesion: 0.05
Nodes (62): TestNewReinforcementLearner(), NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation() (+54 more)
...
Cohesion: 0.05
Nodes (39): Manager, newScopedStore(), normalizeKey(), truncateSummary(), isPersistentScope(), loadScopeFile(), safeFilename(), scopedStore (+31 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (49): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+41 more)
...
Cohesion: 0.07
Nodes (51): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+43 more)
...
Cohesion: 0.05
Nodes (45): TestOutcomeErrorDetail(), FeedbackFile(), IsHealthyOutcome(), OutcomeErrorDetail(), TestLocalAgentResultNilResultAndSuccessPathsUnchanged(), TestLocalAgentResultPreservesOutcomeOnError(), attemptOutcomeError(), buildSchedulerConfig() (+37 more)
...
Cohesion: 0.06
Nodes (45): main(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep() (+37 more)
...
Cohesion: 0.05
Nodes (46): min(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), brokenTool, ChainKind, BuildChainAction(), buildChainActionFn() (+38 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (42): growthFitness(), FitnessDimension, NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic() (+34 more)
...
Cohesion: 0.08
Nodes (50): TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune(), makeRecords(), TestCloneTree_Independent() (+42 more)
...
Cohesion: 0.07
Nodes (47): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField(), extractNotebookLMAnswer() (+39 more)
...
Cohesion: 0.06
Nodes (38): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), readPostconditions(), BuildCircuitBreaker(), BuildInverter() (+30 more)

### Community 58 - "Community 58"
Cohesion: 0.09
Nodes (19): extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), containsCrisisReason(), Crossover(), ExperienceRetrievalHits(), hashTree() (+11 more)

### Community 59 - "Community 59"
Cohesion: 0.13
Nodes (48): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+40 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (28): TestRunOnce_EmitsRunRootSpan(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), alwaysSampler, Attr (+20 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (38): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, scriptedClaudeRunner, scriptedSuperpowersRunner, applySuperpowersRunToMainRepo(), assertNoForcedMasterWrite() (+30 more)
...
Cohesion: 0.1
Nodes (46): TestCompiledPlanTree_ValidatesAndRuns(), NewAgent(), NewDocPlanner(), TestAutomationActions_ReachTaskAutomated(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState() (+38 more)
...
Cohesion: 0.07
Nodes (46): loadSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), saveSuperpowersPlanState(), buildDeterministicDesign(), buildDeterministicImplementationPlan() (+38 more)
...
Cohesion: 0.1
Nodes (43): Duration(), TestPopulation_StatsAccessors(), jaccardSimilarity(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry() (+35 more)
...
Cohesion: 0.07
Nodes (33): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+25 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (30): Blackboard, ChildTick, childTickLog, init(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure(), TestValidateOutputQualityRejectsRefusals() (+22 more)
...
Cohesion: 0.1
Nodes (32): NewMockLLM(), NewDefaultCompany(), CompanyOrchestrator, EngineerTree(), MarketingTree(), SalesTree(), clamp(), safeDiv() (+24 more)

### Community 78 - "Community 78"
Cohesion: 0.1
Nodes (17): TestAutoCreateTree_Existing(), TestDetermineCategory(), TestExtractKeywords(), Factory, AutoCreateTree(), AutoCreateTreeWith(), containsAnyStr(), determineCategory() (+9 more)
...
Cohesion: 0.09
Nodes (39): TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestRouteBuilder_SunsetDate(), TestSchemaToMap_Format(), NewOpenAPIGenerator(), NewRoute() (+31 more)
...
Cohesion: 0.07
Nodes (26): BuildTaskFromInputs(), ParseInputParams(), TestBuildTaskFromInputs(), TestParseInputParams(), TestValidateInputs_Default(), TestValidateInputs_File(), TestValidateInputs_JSON(), TestValidateInputs_Required() (+18 more)
...
Cohesion: 0.07
Nodes (28): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, TestVerifyNotebookLMEvidenceAcceptsRealNotebookPayload(), TestVerifyNotebookLMEvidenceRejectsEmptyOrUngroundedSuccess(), TestVerifyNotebookLMEvidenceRejectsFabricatedOutput() (+20 more)

### Community 95 - "Community 95"
Cohesion: 0.08
Nodes (33): TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestBuildPlannerNode_ChainStateGoals(), TestReadGoals_ChainStateFallback(), TestReadGoals_InvalidItemInList(), TestReadGoals_NonListMetadata(), GoalDefinition, GOAPAction (+25 more)

### Community 96 - "Community 96"
Cohesion: 0.14
Nodes (31): init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled(), TestBanditSelector_DisabledMatchesSelectorSemantics(), TestBanditSelector_DisabledRunningChildRestartsAtZero() (+23 more)
...
Cohesion: 0.1
Nodes (37): biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), serializeTreeForGardener(), crisisMetricsGardener(), crisisV2Config(), experienceRecordingGardener(), experienceReuseCount() (+29 more)
...
Cohesion: 0.11
Nodes (8): ExperienceBank, acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), cappedCells(), cappedIndividuals(), TrackRecord
...
Cohesion: 0.11
Nodes (32): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionNoopPatchStreak(), goapFusionRepeatedHashBypassed(), goapFusionStateHashes() (+24 more)
...
Cohesion: 0.07
Nodes (16): wireSelectorOrdering(), GardenerDeactivateAllTool, GardenerRecommendTool, GardenerRollbackTool, GardenerRunCycleTool, GardenerStatusTool, main(), newGardenerRunCycleTool() (+8 more)
...
Cohesion: 0.13
Nodes (33): TestRouteBuilder_Build(), ArraySchema(), BoolSchema(), IntSchema(), ObjectSchema(), StringSchema(), TestConvenienceSchemaConstructors(), TestOpenAPIGenerator_ErrorResponses() (+25 more)
...
Cohesion: 0.08
Nodes (22): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus() (+14 more)

### Community 127 - "Community 127"
Cohesion: 0.1
Nodes (18): BTOptimizer, collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestExtractCondition(), TestFindMainSelector(), TestSplitCamelCase() (+10 more)
...
Cohesion: 0.08
Nodes (32): Binaries, code:go (type Counter struct { ... }), code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }) (+24 more)
...
Cohesion: 0.07
Nodes (9): References, PrependGoapFusionPreflight(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedDelegatesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedMaterializesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionLoopSharesCircuitBreakerVerdict(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesLoopRunner(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesRunsWritable(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightPrependsToLoopSequence() (+1 more)
...
Cohesion: 0.11
Nodes (22): handleFellows(), DebateTurn, Fellow, DefaultFellows(), NewThinkTank(), Report, ResearchFinding, ReviewComment (+14 more)
...
Cohesion: 0.14
Nodes (27): buildGrillRound1Query(), buildClaudeReviewPrompt(), TestBuildClaudeReviewPrompt_ContractMarkers(), arc42GoalsPromptBlock(), arc42ResearchTopics(), loadArc42QualityGoals(), TestArc42GoalsPromptBlockContainsEveryGoal(), TestArc42GoalsPromptBlockEmptyWhenDocMissing() (+19 more)
...
Cohesion: 0.11
Nodes (14): AuctionDelegate(), cardWithURL(), newAuctionTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoCandidatesFallsBack(), TestAuctionDelegate_NoEligibleBidsFallsBack(), TestAuctionDelegate_RequiredTagsFilterCandidates() (+6 more)

### Community 146 - "Community 146"
Cohesion: 0.17
Nodes (26): isGoapNotebookLMFailure(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery(), nlmIsResearchImport(), nlmIsResearchStart(), nlmPacificDay() (+18 more)

### Community 147 - "Community 147"
Cohesion: 0.09
Nodes (25): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), IsKnownChainKind(), TestIsKnownChainKind(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestValidate_MemoryNodesDuplicateNames() (+17 more)

### Community 148 - "Community 148"
Cohesion: 0.16
Nodes (25): islandTestPopulation(), islandTestTree(), TestIslandModel_AddGetAndSingleIslandMigration(), TestIslandModel_DiversityEdgeCases(), TestIslandModel_DiversityStatsAndSummary(), TestIslandModel_EvolveAllEvaluatesPopulations(), TestIslandModel_LoadCapEvictionIncrementsEvictedIndividuals(), TestIslandModel_LoadCapsDiskOnlyIslandWholesaleAdoption() (+17 more)
...
Cohesion: 0.1
Nodes (20): agentNameFromBB(), init(), registerDelegateNodes(), init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init(), init() (+12 more)
...
Cohesion: 0.12
Nodes (9): FitnessFunc, collectNodeNames(), randomNodeName(), firstNodeNameByType(), firstOpName(), maxInt(), MCTSMetrics, MCTSMutator (+1 more)
...
Cohesion: 0.25
Nodes (24): TestNewGoal(), NewGoalQueue(), names(), names2(), TestGoalIsSatisfied(), TestGoalQueueAddAndSelect(), TestGoalQueueAddReplace(), TestGoalQueueAll() (+16 more)
...
Cohesion: 0.15
Nodes (21): init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), newGrillLoopTestRun(), TestGrillDesign_ApprovedWhenNoOpenCriticals(), TestGrillDesign_NeedsWorkWithFeedbackWhenCriticalsOpen(), TestGrillDesign_NoProgressBreakerFailsAfterTwoStaleRounds(), TestGrillDesign_RefusesRoundsBeyondBound() (+13 more)

### Community 170 - "Community 170"
Cohesion: 0.13
Nodes (16): extractDomain(), hashTreeForGardener(), lastFailureTask(), TestExtractDomain(), TestHashTreeForGardener(), treePriorityRank(), EvolveV2Config, Gardener (+8 more)
...
Cohesion: 0.08
Nodes (7): CreateAgentTool, EvolveTool, FitnessTool, GetReflectionsTool, truncateStr(), ReflectTool, RunTaskTool

### Community 173 - "Community 173"
Cohesion: 0.11
Nodes (13): IsRateLimitCarryover(), repeatChar(), TestHistoryQualityScore_UsesSpecWhenHigher(), TestIsRateLimitCarryover(), newCatchupFixture(), TestCycleBreakerSuccess_HealthyOutcomesDoNotTripBreaker(), TestCycleBreakerSuccessTreatsRateLimitCarryoverAsHealthy(), TestSchedule_PreservesCrashRecoveryImmediateRun() (+5 more)
...
Cohesion: 0.1
Nodes (8): Entry, Milestone, Program, ProgramStore, Store, Key(), normalize(), truncateRunes()

### Community 180 - "Community 180"
Cohesion: 0.14
Nodes (19): cleanupAppliedSuperpowersWorktree(), cleanupSuperpowersWorktree(), createSuperpowersWorktree(), isBareGitRepo(), planSuperpowersWorktree(), reapOrphanedSuperpowersBranches(), superpowersWorktreeBranches(), TestCleanupAppliedSuperpowersWorktreeNoOpsOnDryRun() (+11 more)
...
Cohesion: 0.12
Nodes (16): encodeJSON(), HandleHITL(), HandleHITLPending(), TestHITLHandlers_PendingApproveReject(), writeHITLResult(), Request, Status, TestStoreSaveCompactsTerminalRecords() (+8 more)
...
Cohesion: 0.17
Nodes (19): FusionDeliberationTree(), collectFusionNames(), findFusionNode(), TestFusionDeliberationTree_HasFusionAndDirectPaths(), TestFusionDeliberationTree_UsesFusionChainAction(), TestEvolveWithExperienceContext_QueryRetrievesAcrossTreeTypes(), NewAction(), NewAdapt() (+11 more)
...
Cohesion: 0.14
Nodes (15): TestRunOnceFlushesSelectorTelemetry(), TestSelectorStatsFileSanitizesTreeID(), GoalArchetype, GoalFactory, clamp01(), containsAny(), DefaultInitialState(), DetectArchetype() (+7 more)
...
Cohesion: 0.16
Nodes (20): buildRunActivitySummary(), fencedItems(), isFactLine(), joinCapped(), salientOutputLines(), TestBuildRunActivitySummaryCapsLongFencedLists(), TestBuildRunActivitySummaryEmptyEverything(), TestBuildRunActivitySummaryFailureLeadsWithReason() (+12 more)
...
Cohesion: 0.26
Nodes (22): TestClaudeErrorHandler_DoesNotClobberExistingCategory(), swapErrorHandlerRunner(), TestRequestErrorHandlerProposal_RespectsCallerContext(), TestRequestErrorHandlerProposal_StampsLedgerOnEveryOutcome(), ehTestHandlerNode(), ehTestProposalJSON(), init(), runHandler() (+14 more)
...
Cohesion: 0.1
Nodes (14): init(), modal, num, renderTab(), state, TAB_KEYS, renderCompany(), loadEvolutionData() (+6 more)
...
Cohesion: 0.13
Nodes (18): NewOpenAICompatClient(), TestOpenAICompat_ErrorResponse(), TestOpenAICompat_GenerateWithModel_RetryPolicyByStatusCode(), TestOpenAICompat_GenerateWithModel_SendsChatCompletion(), OpenAICompatConfig, openAICompatMessage, openAICompatRequest, openAICompatResponse (+10 more)

### Community 207 - "Community 207"
Cohesion: 0.13
Nodes (4): ApprovalPolicy, Profile, Store, Workspace
...
Cohesion: 0.16
Nodes (17): NewEvolvedAgent(), TestConfig_AllFields(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestMockModel_SatisfiesInterface(), TestNewEvolvedAgent_AllToolsRegistered() (+9 more)
...
Cohesion: 0.12
Nodes (14): AgentMetrics, AgentStats, BuildIdentity, HealthResponse, exposedBuildIdentity(), init(), InstallBuildIdentity(), NewHistogram() (+6 more)
...
Cohesion: 0.22
Nodes (19): saveRecordWithDelay(), TestCreateAgentTool_Call_NilFactory(), TestEvolveTool_Call_NotEnoughFailures(), TestEvolveTool_Call_NoTree(), TestEvolveTool_Call_Success(), TestFitnessTool_Call(), TestFitnessTool_Call_NoData(), TestGetReflectionsTool_Call_NoRecords() (+11 more)

### Community 220 - "Community 220"
Cohesion: 0.19
Nodes (17): TestBTOptimizer_New(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), NewBTOptimizer(), NewDTAnalyzer(), pathStat(), TestBTOptimizer_ReorderSelectors() (+9 more)

### Community 221 - "Community 221"
Cohesion: 0.17
Nodes (16): Alert, apiFetch(), getCookie(), Alert, cbIcon(), createAgent(), deleteAgent(), loadAgents() (+8 more)

### Community 222 - "Community 222"
Cohesion: 0.22
Nodes (17): activateAutomation(), automationAgentName(), considerAutomation(), finalizeAutomationApproval(), proposeAutomation(), registerAutomationTools(), suggestSchedule(), newAutopilotDeps() (+9 more)
...
Cohesion: 0.17
Nodes (16): gitOutput(), TestNoCommittedRootBinaries(), extractTaskID(), init(), nlmAuthNeedsRefresh(), nlmAuthUnhealthy(), registerNotebookLMActions(), writeString() (+8 more)
...
Cohesion: 0.2
Nodes (17): TestLocalSearcher_New(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb() (+9 more)

### Community 231 - "Community 231"
Cohesion: 0.17
Nodes (5): DeepSeekClient, OpenAICompatClient, checkRateLimit(), ParseRetryAfter(), TestParseRetryAfter()

### Community 232 - "Community 232"
Cohesion: 0.19
Nodes (15): toast(), approveHITL(), approveTask(), executeSprint(), pollSprintStatus(), refreshHITL(), refreshTasks(), rejectHITL() (+7 more)
...
Cohesion: 0.2
Nodes (14): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired(), NewMetaValidator(), hasMetaIssue() (+6 more)
...
Cohesion: 0.11
Nodes (17): arc42 Docs Consolidation & Per-Section Sync Nodes — Implementation Plan, Canonical section layout (used by merge tasks, Go manifest, and drift script — keep all three in lockstep), code:bash (grep -F '## 10.1 Quality Tree' docs/arc42/10-quality.md && g), code:bash (PATH=/usr/local/go/bin:$PATH make check-quick), code:bash (git add -A), code:bash (grep -c 'RegisterAction(' internal/engine/*.go | awk -F: '{s), code:bash (grep -c '^| Q[0-9] | \*\*' docs/arc42/01-introduction-goals.), code:bash (for f in 02-constraints 03-context-scope 04-solution-strateg) (+9 more)
...
Cohesion: 0.21
Nodes (13): extractWorldState(), hasWorldState(), NewCheckpointVerifier(), restoreState(), snapshotState(), TestCheckpointVerifier_DefaultMaxRetries(), TestCheckpointVerifier_ExhaustsRetriesReturnsFailure(), TestCheckpointVerifier_NilPostconditions() (+5 more)

### Community 450 - "Community 450"
Cohesion: 0.15
Nodes (14): Outcome, Record, FilterByTreeName(), NewRegistryWithUsers(), recordsForEntry(), TestBankFor_NoUserRootFallsBackToShared(), TestBankFor_PersonalTreesGetPerUserBank(), TestBankFor_TransientOpenErrorDoesNotPermanentlyCacheSharedBank() (+6 more)
...
Cohesion: 0.19
Nodes (11): injectPersonaContext(), injectPersonaContextLocked(), mineUserPatterns(), personaEmbedder(), personaError(), recordPersonaInteraction(), registerPersonaTools(), Interaction (+3 more)
...
Cohesion: 0.27
Nodes (13): asFloat(), compiledGoapActionFor(), compiledGoapConditionFor(), goapValuesEqual(), goapWorldStateFrom(), isCompiledGoapAction(), isCompiledGoapCondition(), parseGoapPairs() (+5 more)
...
Cohesion: 0.2
Nodes (9): NewHabitMiner(), minerInput(), TestHabitMiner_BelowThresholdYieldsNothing(), TestHabitMiner_DetectsRecurringPattern(), TestHabitMiner_EmbeddingFailureFallsBackToKeywords(), TestHabitMiner_UsesEmbeddingsWhenAvailable(), TestSanitizeUserID(), TestSanitizeUserID_AdversarialIDs() (+1 more)
...
Cohesion: 0.16
Nodes (10): init(), prepareTreeForBuild(), RegisterTreeExpander(), TestBuildAndValidate_SubTreeRefRequiresExpander(), TestPrepareTreeForBuild_NoRefs(), treeHasSubTreeRefs(), RegisterBlockMutations(), RegisterBlockRandomMutator() (+2 more)
...
Cohesion: 0.21
Nodes (10): handleAnalyze(), handleWorkflowRunFullPipeline(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation(), TestHandleWorkflowRunFullPipeline_PersistsWorkflowAndTasks(), NewTaskStore(), TestNewTaskStore_PanicsOnCorruptFile(), TestTaskStore_ApprovedOrdersByPriorityThenSprint() (+2 more)
...
Cohesion: 0.27
Nodes (10): LabeledGauge, PrometheusHandler(), RecordKGAnalytics(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered(), TestBlockDurationHistogramSeriesRendered(), TestKGAnalyticsGaugesRenderedAndUpdated(), TestNodeDurationHistogramSeriesRendered() (+2 more)
...
Cohesion: 0.21
Nodes (7): ChildTick, DecisionTrace, RecordSelectorOutcomes(), TestRecordSelectorOutcomes_AccumulatesAcrossTraces(), TestRecordSelectorOutcomes_UpdatesPersistedPerChildCounts(), TraceStep, TraceStore
...
Cohesion: 0.27
Nodes (8): PatternSignature(), TestPatternSignature(), HabitMiner, cosine(), jaccard(), keywordSet(), sortedByCount(), RecurringPattern
...
Cohesion: 0.27
Nodes (10): AgentMetric, AlertReport, MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON(), evaluateGlobalAlerts(), evaluateHTTPAlerts() (+2 more)
...
Cohesion: 0.36
Nodes (8): formatPromLabels(), labeledSnapshotToMap(), labelString(), MetricsJSON(), parseLabelKey(), sortStrings(), writeLabeledHistogram(), writePrometheusMetrics()
...
Cohesion: 0.29
Nodes (8): TestComposeAndExpand(), TestExpand_BlockMetadata(), Expand(), expandNode(), HasSubTreeRefs(), annotateBlockSource(), traceBlockOp(), TestComposeTaskTreeAgentic()
...
Cohesion: 0.2
Nodes (10): code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), Package: log, Package: persistence, Package: tools (+2 more)

### Community 958 - "Community 958"
Cohesion: 0.2
Nodes (10): code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), Package: gardener, Package: goap, Package: langagent (+2 more)

### Community 959 - "Community 959"
Cohesion: 0.2
Nodes (10): code:go (type AgentCard struct { Name, Description, URL string }), code:go (type PlatformEvalResult struct { ... }), code:go (type BaselineStore struct { ... }), code:go (type WorkflowReport struct { ... }), code:go (type AgentInfo struct { Name, Status, Schedule string; Succe), Package: a2a, Package: benchreg, Package: cicd (+2 more)
...
Cohesion: 0.29
Nodes (3): HistogramSnap, LabeledHistogram, labelKey()
...
Cohesion: 0.43
Nodes (5): NewGoalStore(), TestGoalStore_AddRemoveRoundtrip(), TestGoalStore_LoadEmpty(), TestGoalStore_Queue(), TestGoalStore_ValidatesInput()
...
Cohesion: 0.5
Nodes (3): TestBuildIdentityStampedRevisionFallback(), BuildIdentityFromBuildInfo(), TestBuildIdentityFromBuildInfo()
...
## Knowledge Gaps
- **9807 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+9802 more)
...
- **Why does `Append()` connect `Community 11` to `Community 2`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 14`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 32`, `Community 35`, `Community 37`, `Community 38`, `Community 41`, `Community 43`, `Community 45`, `Community 46`, `Community 48`, `Community 50`, `Community 52`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 62`, `Community 63`, `Community 64`, `Community 66`, `Community 68`, `Community 69`, `Community 71`, `Community 73`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 86`, `Community 88`, `Community 89`, `Community 90`, `Community 92`, `Community 94`, `Community 95`, `Community 97`, `Community 98`, `Community 99`, `Community 100`, `Community 102`, `Community 104`, `Community 105`, `Community 107`, `Community 115`, `Community 124`, `Community 127`, `Community 133`, `Community 136`, `Community 138`, `Community 140`, `Community 141`, `Community 144`, `Community 147`, `Community 149`, `Community 153`, `Community 156`, `Community 159`, `Community 161`, `Community 674`, `Community 162`, `Community 166`, `Community 679`, `Community 170`, `Community 171`, `Community 172`, `Community 173`, `Community 685`, `Community 174`, `Community 683`, `Community 175`, `Community 178`, `Community 181`, `Community 698`, `Community 189`, `Community 703`, `Community 709`, `Community 200`, `Community 203`, `Community 204`, `Community 205`, `Community 208`, `Community 209`, `Community 212`, `Community 213`, `Community 1238`, `Community 216`, `Community 225`, `Community 226`, `Community 227`, `Community 228`, `Community 911`, `Community 915`, `Community 918`, `Community 921`, `Community 935`, `Community 936`, `Community 937`, `Community 938`, `Community 946`, `Community 435`, `Community 434`, `Community 437`, `Community 436`, `Community 951`, `Community 446`, `Community 448`, `Community 450`, `Community 451`, `Community 968`, `Community 457`, `Community 969`, `Community 460`, `Community 972`, `Community 461`, `Community 462`, `Community 463`, `Community 466`, `Community 469`, `Community 473`, `Community 987`, `Community 1011`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 7` to `Community 2`, `Community 4`, `Community 136`, `Community 11`, `Community 140`, `Community 13`, `Community 14`, `Community 16`, `Community 148`, `Community 24`, `Community 32`, `Community 44`, `Community 46`, `Community 49`, `Community 50`, `Community 52`, `Community 438`, `Community 58`, `Community 59`, `Community 702`, `Community 66`, `Community 68`, `Community 197`, `Community 70`, `Community 71`, `Community 69`, `Community 77`, `Community 78`, `Community 464`, `Community 222`, `Community 1374`, `Community 97`, `Community 230`, `Community 103`, `Community 125`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 44` to `Community 130`, `Community 2`, `Community 4`, `Community 1028`, `Community 7`, `Community 13`, `Community 14`, `Community 17`, `Community 20`, `Community 21`, `Community 24`, `Community 25`, `Community 27`, `Community 36`, `Community 681`, `Community 940`, `Community 46`, `Community 47`, `Community 51`, `Community 52`, `Community 182`, `Community 185`, `Community 66`, `Community 67`, `Community 69`, `Community 200`, `Community 82`, `Community 85`, `Community 216`, `Community 222`, `Community 229`, `Community 112`, `Community 119`, `Community 125`, `Community 126`?**
