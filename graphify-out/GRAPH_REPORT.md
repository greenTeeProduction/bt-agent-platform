# Graph Report - superpowers-20260717T103638-cc81bd8d-goap-fusion-loop-runner-blackboard-conte  (2026-07-17)

## Corpus Check
- 896 files · ~1,136,822 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25541 nodes · 38212 edges · 2008 communities (1659 shown, 349 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9212 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `40e3aab5`
...
3. `9. Architecture Decisions` - 149 edges
4. `NewKnowledgeGraph()` - 145 edges
...
## Communities (2008 total, 349 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (196): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+188 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (196): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+188 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (125): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+117 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (142): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+134 more)
...
Cohesion: 0.02
Nodes (101): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+93 more)
...
Cohesion: 0.03
Nodes (72): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus() (+64 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (82): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Block, TestComposeAndExpand(), Category, Compose(), ComposeFromRefs(), ComposeTaskTree() (+74 more)
...
Cohesion: 0.04
Nodes (98): blockOnHeldServerLock(), echoTaskLeaf, TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes() (+90 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (91): AlertRouterTree(), Arc42DocsyncTree(), TestArc42DocsyncTreeRegistered(), TestArc42DocsyncTreeShape(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain() (+83 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (67): Outcome, Record, FilterByTreeName(), Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped() (+59 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (63): History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), mockTTOrch, Workflow (+55 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (95): handleLogout(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext() (+87 more)
...
Cohesion: 0.04
Nodes (76): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestNewFileWriteTool_Structure(), TestNewGoTestTool_Structure() (+68 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (88): DefaultLLM(), RealLLM(), TestDetectPath_FromCurrentPath(), TestDetectPath_FromVisitedPaths(), TestDetectPath_KeywordFallback(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), EvaluateBFCLV3() (+80 more)
...
Cohesion: 0.05
Nodes (82): Duration(), countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype() (+74 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (87): TestEndpointsFromCardsSingleNodeYieldsNoPeers(), biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip(), TestDeadLetterQueue_PreserveCategory() (+79 more)
...
Cohesion: 0.04
Nodes (79): IsKnownChainKind(), TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestIsKnownChainKind(), TestBuildChainActionFn_LlmCallNilLLM(), TestBuildChainActionFn_UnknownChainType() (+71 more)
...
Cohesion: 0.07
Nodes (65): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup() (+57 more)
...
Cohesion: 0.05
Nodes (45): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), init(), InitRegistry(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID() (+37 more)
...
Cohesion: 0.05
Nodes (36): NewACPClient(), sameJSONID(), scanJSONLines(), startScanJSONLines(), countCrashInvocations(), TestACPClientCircuitBreakerShortCircuitsRepeatedSubprocessFailures(), TestACPClientGenerateCtx_StderrBufferRace(), TestACPClientGenerateReturnsErrorWhenSessionMissing() (+28 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (29): execLLMCallAction(), execRefineAction(), generatePlanAction(), NewEngine(), RegisterProviders(), TestCondition_HasGoapGoal_ConfigureTask(), TestCondition_HasGoapGoal_EmptyTask(), TestCondition_HasGoapGoal_MultiStepTask() (+21 more)
...
Cohesion: 0.05
Nodes (36): newAgentExecutor(), agentExecuteResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun() (+28 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (50): TestDriftWatchOnce_SkipsRestartWhenJobStartedMidRebuild(), TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), TestStartDriftWatcher_KickTriggersImmediateCheck(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir() (+42 more)
...
Cohesion: 0.05
Nodes (36): FeedbackFile(), TestPathHelpers(), TestLocalAgentResultNilResultAndSuccessPathsUnchanged(), TestLocalAgentResultPreservesOutcomeOnError(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir() (+28 more)
...
Cohesion: 0.13
Nodes (42): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+34 more)
...
Cohesion: 0.05
Nodes (40): Blackboard, ChildTick, childTickLog, collectNames(), contains(), TestBuildTree_Minimal(), TestBuildTree_UnknownType(), TestOutcome_EmptyTaskFails() (+32 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (46): Approval, mockOrch, newTaskNonce(), NewWorkflow(), sortTasks(), TestApproval_Fields(), TestApproveTask(), TestExecuteSprint() (+38 more)
...
Cohesion: 0.08
Nodes (43): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves(), NewFileJobStore() (+35 more)

### Community 60 - "Community 60"
Cohesion: 0.07
Nodes (46): TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestScoreChild_GoalAlignmentBranch(), TestScoreChild_NilChainState(), TestScoreChildren_BasicRanking(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+38 more)
...
Cohesion: 0.09
Nodes (32): growthFitness(), FitnessDimension, MultiFitness, MultiIndividual, clampScore(), countActions(), countConditions(), materializeMutationOp() (+24 more)
...
Cohesion: 0.07
Nodes (27): ErrorRecorder, NewOpenAICompatClient(), TestOpenAICompat_ErrorResponse(), TestOpenAICompat_GenerateWithModel_RetryPolicyByStatusCode(), TestOpenAICompat_GenerateWithModel_SendsChatCompletion(), rateLimitedServer(), TestDeepSeek_429ReturnsRateLimitError(), TestErrorRecorder_PrefersRateLimitError() (+19 more)
...
Cohesion: 0.07
Nodes (23): tracingMiddleware(), fanoutHandler, InitLogExport(), logExportTarget(), newTraceContextHandler(), TestInitLogExport_Idempotent(), TestLogExportTarget(), TestTraceContextHandler_InjectsTraceIDs() (+15 more)
...
Cohesion: 0.08
Nodes (24): TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree(), TestWireSelectorReorderIsOptIn() (+16 more)
...
Cohesion: 0.08
Nodes (24): handleFellows(), main(), DebateTurn, Fellow, mockLLM, DefaultFellows(), NewThinkTank(), Report (+16 more)
...
Cohesion: 0.07
Nodes (26): BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), BuildCircuitBreaker(), BuildInverter(), BuildRepeater(), BuildRunner(), BuildSucceeder() (+18 more)
...
Cohesion: 0.09
Nodes (21): ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), ApplyBlockMutations(), blockIDFromOp(), collectNames() (+13 more)
...
Cohesion: 0.09
Nodes (23): attachLogHandler(), buildBaseHandler(), buildLogger(), Debug(), envLogLevel(), Error(), Init(), L() (+15 more)
...
Cohesion: 0.12
Nodes (27): TestGardenerRollbackTool_CallRestoresSnapshot(), GateResult, TestQualityGateFloorOn100Scale(), ListRevisions(), loadSnapshotIndex(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation() (+19 more)
...
Cohesion: 0.08
Nodes (32): Binaries, code:go (type Counter struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }) (+24 more)
...
Cohesion: 0.11
Nodes (21): TestRunOnce_EmitsRunRootSpan(), TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeSpan, fakeTracer, mockOllamaServer(), newTestClient() (+13 more)
...
Cohesion: 0.09
Nodes (22): agentNameFromBB(), init(), registerDelegateNodes(), init(), init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init() (+14 more)
...
Cohesion: 0.09
Nodes (19): TestOutcomeErrorDetail(), ResolvePipelineAgent(), TestValidateQualitySpec_BlockedPattern(), TestValidateQualitySpec_MinLength(), TestValidateQualitySpec_NilSpecUsesHeuristic(), TestValidateQualitySpec_RequiredSections(), ValidateQualitySpec(), RunDeps (+11 more)

### Community 145 - "Community 145"
Cohesion: 0.12
Nodes (19): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, LabeledGauge, exposedBuildIdentity(), formatPromLabels() (+11 more)

### Community 146 - "Community 146"
Cohesion: 0.13
Nodes (15): BTOptimizer, collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestFindMainSelector(), isDefaultPath(), pathEntropy() (+7 more)
...
Cohesion: 0.16
Nodes (20): fakeClaude, fakeCommitRunner, hookFailureClass, stageAndCommitSuperpowersRunInDir(), writeApplyCommitEvidence(), applyDeterministicCommitFixes(), buildCommitFixPrompt(), classifyHookFailure() (+12 more)
...
Cohesion: 0.14
Nodes (19): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired(), wireSelectorOrdering(), routerChildNames() (+11 more)
...
Cohesion: 0.24
Nodes (22): registerAutomationTools(), newFeedbackDeps(), goalError(), goalFactory(), personaStyleHints(), registerGoalTools(), invokeGoal(), TestBTGoalAdd_ExtractsAndPersistsGoal() (+14 more)
...
Cohesion: 0.12
Nodes (19): TestRunPipelineWithID_RecordsAgentMetrics(), handleSprintExecute(), handleTaskCreate(), syncWorkflowTaskStatus(), TestHandleSprintExecute_UpdatesCurrentWorkflow(), isAuctionShapedTask(), NewAgentExecutor(), PickTreeForTask() (+11 more)
...
Cohesion: 0.16
Nodes (19): TestBTOptimizer_New(), TestExtractCondition(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), TestSplitCamelCase(), NewBTOptimizer(), NewDTAnalyzer() (+11 more)
...
Cohesion: 0.1
Nodes (6): CreateAgentTool, FitnessTool, GetReflectionsTool, GetTreeTool, truncateStr(), RunTaskTool

### Community 203 - "Community 203"
Cohesion: 0.1
Nodes (6): CreateAgentTool, EvolveTool, GetReflectionsTool, ReflectTool, RunTaskTool, truncateStr()

### Community 204 - "Community 204"
Cohesion: 0.11
Nodes (15): BuildBudget(), budgetCmd, BuildMonitor(), TestBuildBudget_MaxTicks(), TestBuildInverter(), TestBuildMonitor_IncrementsCounter(), TestBuildParallel_AllMustSucceed(), TestBuildParallel_OneSuccess() (+7 more)
...
Cohesion: 0.1
Nodes (14): init(), modal, num, renderTab(), state, TAB_KEYS, renderAgents(), renderCompany() (+6 more)
...
Cohesion: 0.13
Nodes (9): captureExporter, NewOTLPHTTPExporter(), TestConfigureOTLPFromEnv(), TestConfigureOTLPFromEnv_DisabledWithoutEndpoint(), TestConsoleTracer_ExporterErrorDoesNotBreakEnd(), TestOTLPHTTPExporter_Non2xx(), TestOTLPHTTPExporter_PostsOTLPJSON(), TestEndToEndOTLPExport() (+1 more)
...
Cohesion: 0.23
Nodes (14): considerAutomation(), newAutopilotDeps(), seedRecurringTask(), TestBTAutomationProposeRegistered(), TestConsiderAutomation_ApprovalActivatesRejectionRemembers(), TestConsiderAutomation_AutoApproveAndCap(), TestConsiderAutomation_ProposesViaHITLOnce(), NewAutomationStore() (+6 more)

### Community 445 - "Community 445"
Cohesion: 0.24
Nodes (15): TestLocalSearcher_New(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing(), TestLocalSearch_TabuSearch() (+7 more)
...
Cohesion: 0.19
Nodes (13): deepSearchGardener(), deepSearchV2Config(), TestEvolveTreeV2_DeepSearchMetrics_PopulatedWhenTTConfigured(), TestEvolveTreeV2_DeepSearchMetrics_ZeroWithoutTranspositionTable(), TestMetricsTracker_CyclesForTree(), TestMetricsTracker_RecordAndSummary(), TestMetricsTracker_SaveAggregatesCrisisAndLastRun(), TestMetricsTracker_SaveAggregatesDeepSearchCoverage() (+5 more)
...
Cohesion: 0.19
Nodes (5): IsRateLimitCarryover(), repeatChar(), TestHistoryQualityScore_UsesSpecWhenHigher(), TestIsRateLimitCarryover(), AgentExecutor
...
Cohesion: 0.21
Nodes (12): TestBuildIdentityStampedRevisionFallback(), BuildIdentityFromBuildInfo(), SetBuildIdentity(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered(), TestBlockDurationHistogramSeriesRendered(), TestBuildIdentityFromBuildInfo(), TestKGAnalyticsGaugesRenderedAndUpdated() (+4 more)
...
Cohesion: 0.22
Nodes (10): assertNoExecutePlanStubs(), TestGoapFusionTreeHasResearchRouter(), containsNodeName(), minStr(), TestGoapFusion_DeterministicActions(), TestGoapFusion_FullTree_Direct(), TestGoapFusion_Structure(), GoapFusionTree() (+2 more)
...
Cohesion: 0.26
Nodes (11): NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic(), TestNSGAII_FrontRank(), TestNSGAIIPopulation_Evolve_ResurrectsExtinctSpecialist() (+3 more)
...
Cohesion: 0.25
Nodes (9): ExportedEvent, ExportedSpan, ConfigureOTLPFromEnv(), firstNonEmpty(), otlpTracePayload(), parseOTLPHeaders(), stableHexID(), OTLPHTTPExporter (+1 more)
...
Cohesion: 0.31
Nodes (8): recordUserFeedback(), registerFeedbackTools(), TestBTFeedbackRegistered(), TestRecordUserFeedback_FeedsSatisfactionAndFlags(), TestRecordUserFeedback_RejectsBadInput(), TestRecordUserFeedback_TrimsUserAndTreeID(), TestSeedCompileReflection_WritesOnceAndOverwrites(), FilterByTreeNameStrict()

### Community 946 - "Community 946"
Cohesion: 0.31
Nodes (9): Alert, Alert, cbIcon(), createAgent(), deleteAgent(), loadAgents(), runAgent(), toggleAgentBlackboard() (+1 more)
...
Cohesion: 0.2
Nodes (10): code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), Package: evaluator, Package: llm, Package: monitoring (+2 more)
...
Cohesion: 0.36
Nodes (8): activateAutomation(), automationAgentName(), finalizeAutomationApproval(), proposeAutomation(), suggestSchedule(), goalTreeSlug(), TestGoalTreeSlug(), seedCompileReflection()
...
Cohesion: 0.25
Nodes (8): code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), Package: gardener, Package: goap, Package: langagent, Package: reflection
...
## Knowledge Gaps
- **9767 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+9762 more)
...
- **Why does `Append()` connect `Community 18` to `Community 2`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 33`, `Community 34`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 43`, `Community 46`, `Community 47`, `Community 52`, `Community 53`, `Community 54`, `Community 56`, `Community 57`, `Community 58`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 69`, `Community 71`, `Community 72`, `Community 74`, `Community 75`, `Community 78`, `Community 80`, `Community 81`, `Community 84`, `Community 87`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 103`, `Community 107`, `Community 109`, `Community 110`, `Community 112`, `Community 114`, `Community 115`, `Community 119`, `Community 122`, `Community 130`, `Community 133`, `Community 135`, `Community 137`, `Community 143`, `Community 144`, `Community 145`, `Community 146`, `Community 149`, `Community 152`, `Community 156`, `Community 671`, `Community 674`, `Community 164`, `Community 165`, `Community 168`, `Community 171`, `Community 173`, `Community 174`, `Community 175`, `Community 689`, `Community 179`, `Community 180`, `Community 693`, `Community 698`, `Community 702`, `Community 197`, `Community 200`, `Community 202`, `Community 205`, `Community 209`, `Community 211`, `Community 1236`, `Community 214`, `Community 215`, `Community 219`, `Community 220`, `Community 222`, `Community 223`, `Community 914`, `Community 915`, `Community 916`, `Community 917`, `Community 424`, `Community 425`, `Community 938`, `Community 939`, `Community 426`, `Community 941`, `Community 427`, `Community 944`, `Community 436`, `Community 438`, `Community 439`, `Community 440`, `Community 441`, `Community 443`, `Community 961`, `Community 451`, `Community 452`, `Community 454`, `Community 455`, `Community 966`, `Community 968`, `Community 459`, `Community 460`, `Community 465`, `Community 1007`, `Community 1012`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 15` to `Community 133`, `Community 5`, `Community 6`, `Community 12`, `Community 13`, `Community 16`, `Community 145`, `Community 18`, `Community 149`, `Community 22`, `Community 150`, `Community 24`, `Community 166`, `Community 428`, `Community 47`, `Community 49`, `Community 945`, `Community 52`, `Community 692`, `Community 55`, `Community 444`, `Community 61`, `Community 445`, `Community 63`, `Community 190`, `Community 66`, `Community 196`, `Community 71`, `Community 459`, `Community 461`, `Community 1364`, `Community 216`, `Community 89`, `Community 93`, `Community 97`, `Community 114`, `Community 125`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 12` to `Community 129`, `Community 2`, `Community 5`, `Community 6`, `Community 137`, `Community 10`, `Community 13`, `Community 15`, `Community 144`, `Community 16`, `Community 916`, `Community 21`, `Community 24`, `Community 25`, `Community 27`, `Community 932`, `Community 37`, `Community 39`, `Community 43`, `Community 45`, `Community 47`, `Community 49`, `Community 59`, `Community 444`, `Community 61`, `Community 76`, `Community 83`, `Community 88`, `Community 102`, `Community 118`, `Community 119`, `Community 125`, `Community 1023`?**
...
- **Are the 143 inferred relationships involving `NewKnowledgeGraph()` (e.g. with `TestComputeAnalytics_EmptyGraph()` and `TestComputeAnalytics_Centrality()`) actually correct?**
  _`NewKnowledgeGraph()` has 143 INFERRED edges - model-reasoned connections that need verification._