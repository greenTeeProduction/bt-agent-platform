# Graph Report - superpowers-20260715T031353-d423f5f5-goap-fusion-loop-runner-blackboard-conte  (2026-07-15)

## Corpus Check
- 854 files · ~992,886 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22188 nodes · 33890 edges · 1805 communities (1446 shown, 359 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8577 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d5662375`
...
6. `registerMCPTools()` - 110 edges
7. `newDefaultConfig()` - 100 edges
8. `arc42 Section 9 — Architecture Decisions` - 98 edges
9. `sleep()` - 95 edges
10. `main()` - 78 edges
...
## Communities (1805 total, 359 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (156): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+148 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (156): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+148 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (98): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), Category (+90 more)
...
Cohesion: 0.03
Nodes (76): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+68 more)
...
Cohesion: 0.02
Nodes (98): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+90 more)
...
Cohesion: 0.05
Nodes (82): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+74 more)
...
Cohesion: 0.06
Nodes (79): main(), TestCheckConfidence_ConditionExists(), TestIntegration_AllChainTypes(), TestIntegration_EdgeCases(), TestIntegration_MutationOperators(), TestIntegration_PanicRecovery(), TestIntegration_QualityGatesFullFlow(), TestIntegration_ReflectionAndPersistence() (+71 more)
...
Cohesion: 0.04
Nodes (59): main(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+51 more)
...
Cohesion: 0.05
Nodes (68): LoadPipeline(), RunPipeline(), RunPipelineWithID(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext() (+60 more)
...
Cohesion: 0.04
Nodes (46): agentExecuteResult(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleAnalyze() (+38 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (46): AgentMetrics, AgentStats, BlockFitnessRanking(), TestBuildIdentityStampedRevisionFallback(), BuildIdentity, Counter, Gauge, HealthResponse (+38 more)
...
Cohesion: 0.04
Nodes (56): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype() (+48 more)
...
Cohesion: 0.06
Nodes (54): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField() (+46 more)

### Community 42 - "Community 42"
Cohesion: 0.07
Nodes (43): Config, Duration(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes() (+35 more)
...
Cohesion: 0.07
Nodes (46): perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree() (+38 more)
...
Cohesion: 0.07
Nodes (36): BTOptimizer, TestBTOptimizer_New(), TestDTAnalyzer_New(), collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestExtractCondition() (+28 more)
...
Cohesion: 0.06
Nodes (45): FileJobStore, JobStore, NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad(), TestScheduler_NoJobStore_NilSafe() (+37 more)
...
Cohesion: 0.05
Nodes (27): TestGardenerRollbackTool_CallRestoresSnapshot(), GateResult, RestoreTree(), SnapshotTree(), Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed() (+19 more)

### Community 61 - "Community 61"
Cohesion: 0.08
Nodes (39): TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir() (+31 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (30): FitnessDimension, TestNSGAII_Evolve_Basic(), MultiFitness, MultiIndividual, cappedIndividuals(), clampScore(), countActions(), countConditions() (+22 more)
...
Cohesion: 0.08
Nodes (15): jaccardSimilarity(), TestJaccardSimilarity(), TestTokenize(), tokenize(), ExperienceBank, ExperienceEntry, containsStr(), hasNodeType() (+7 more)
...
Cohesion: 0.07
Nodes (26): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), wireSelectorOrdering(), GardenerRecommendTool, GardenerRollbackTool (+18 more)
...
Cohesion: 0.11
Nodes (33): TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestRouteBuilder_SunsetDate(), NewOpenAPIGenerator(), NewRoute(), mapKeys() (+25 more)
...
Cohesion: 0.13
Nodes (25): TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), TestQualityGateConsecutiveFails(), TestQualityGateDisabledWithZeroThreshold(), TestQualityGateReset() (+17 more)
...
Cohesion: 0.08
Nodes (30): Binaries, code:go (type Counter struct { ... }), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }) (+22 more)
...
Cohesion: 0.08
Nodes (21): init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init(), init(), registerSuperpowersConditions(), TestRegisterCondition_And_GetCondition(), firstLine() (+13 more)

### Community 136 - "Community 136"
Cohesion: 0.08
Nodes (24): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM() (+16 more)
...
Cohesion: 0.09
Nodes (23): TestDeprecatedHandlerFunc(), TestNumberSchema(), TestSchemaToMap_Format(), DeprecationHeader, DeprecatedHandlerFunc(), httpStatusText(), NumberSchema(), schemaToMap() (+15 more)
...
Cohesion: 0.11
Nodes (17): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestSuperpowersWorkflowTree_BuildsAndValidates(), containsLeafChildrenMsg(), TestRunTask_BackstopsEmptyResultOnNonSuccess() (+9 more)
...
Cohesion: 0.25
Nodes (12): goapFusionStateHashes(), saveGoapFusionStateHashes(), TestGoapFusionStateHashes_DurableAcrossCronTicks(), TestGoapFusionStateHashes_HistoryCappedOnDisk(), TestPublishGoapFusionStateHash_ActiveWorkStillAccumulates(), TestPublishGoapFusionStateHash_IdleDoesNotAccumulate(), TestPublishGoapFusionStateHash_ResultReflectsDurableDepth(), TestRunScheduledGoapFusionLoop_RunawayBackstopIsHalfOpen() (+4 more)
...
Cohesion: 0.24
Nodes (10): NewACPClient(), countCrashInvocations(), TestACPClientCircuitBreakerShortCircuitsRepeatedSubprocessFailures(), TestACPClientGenerateReturnsErrorWhenSessionMissing(), TestACPClientGenerateTalksToACPServer(), TestACPClientGenerateTalksToHermesACP(), TestACPHelperProcess(), TestNewProviderCreatesACPClient() (+2 more)
...
Cohesion: 0.42
Nodes (9): TestLocalSearcher_New(), TestLocalSearchMutableParamsAndTabu(), extractMutableParams(), getFloatMeta(), NewLocalSearcher(), setFloatMeta(), toFloat64(), LocalSearchStrategy (+1 more)
...
Cohesion: 0.43
Nodes (7): fallbackSpec, buildProvider(), isKnownProvider(), NewProvider(), parseFallbackModels(), primaryModel(), splitACPArgs()
...
## Knowledge Gaps
- **7767 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7762 more)
...
- **Why does `Append()` connect `Community 47` to `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 13`, `Community 527`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 29`, `Community 30`, `Community 31`, `Community 1056`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 38`, `Community 39`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 49`, `Community 50`, `Community 53`, `Community 54`, `Community 55`, `Community 57`, `Community 59`, `Community 60`, `Community 62`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 71`, `Community 584`, `Community 73`, `Community 583`, `Community 72`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 86`, `Community 600`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 607`, `Community 606`, `Community 96`, `Community 103`, `Community 106`, `Community 111`, `Community 112`, `Community 114`, `Community 117`, `Community 122`, `Community 123`, `Community 124`, `Community 126`, `Community 127`, `Community 129`, `Community 135`, `Community 139`, `Community 141`, `Community 144`, `Community 145`, `Community 150`, `Community 153`, `Community 156`, `Community 158`, `Community 159`, `Community 160`, `Community 162`, `Community 164`, `Community 176`, `Community 177`, `Community 178`, `Community 185`, `Community 186`, `Community 188`, `Community 189`, `Community 192`, `Community 197`, `Community 198`, `Community 199`, `Community 200`, `Community 205`, `Community 212`, `Community 214`, `Community 215`, `Community 775`, `Community 776`, `Community 777`, `Community 789`, `Community 804`, `Community 805`, `Community 806`, `Community 819`, `Community 821`, `Community 823`, `Community 831`, `Community 838`, `Community 845`, `Community 857`, `Community 874`, `Community 378`, `Community 379`, `Community 380`, `Community 382`, `Community 392`, `Community 393`, `Community 394`, `Community 395`, `Community 400`, `Community 404`, `Community 410`, `Community 412`, `Community 417`, `Community 418`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 25` to `Community 2`, `Community 10`, `Community 13`, `Community 14`, `Community 141`, `Community 18`, `Community 147`, `Community 789`, `Community 26`, `Community 31`, `Community 161`, `Community 34`, `Community 46`, `Community 47`, `Community 174`, `Community 52`, `Community 53`, `Community 55`, `Community 59`, `Community 61`, `Community 62`, `Community 191`, `Community 192`, `Community 66`, `Community 70`, `Community 72`, `Community 203`, `Community 77`, `Community 207`, `Community 376`, `Community 101`, `Community 114`, `Community 380`, `Community 124`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 61` to `Community 129`, `Community 2`, `Community 3`, `Community 134`, `Community 391`, `Community 10`, `Community 14`, `Community 17`, `Community 18`, `Community 19`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 794`, `Community 31`, `Community 33`, `Community 39`, `Community 40`, `Community 42`, `Community 52`, `Community 53`, `Community 55`, `Community 185`, `Community 59`, `Community 63`, `Community 64`, `Community 194`, `Community 580`, `Community 838`, `Community 72`, `Community 203`, `Community 97`, `Community 104`, `Community 110`, `Community 381`?**
