# Graph Report - superpowers-20260717T230249-51bce651-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-17)

## Corpus Check
- 911 files · ~1,180,466 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26364 nodes · 39283 edges · 2052 communities (1700 shown, 352 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9407 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `648fb600`
...
1. `Append()` - 392 edges
2. `9. Architecture Decisions` - 159 edges
...
Cohesion: 0.03
Nodes (117): main(), TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch() (+109 more)
...
Cohesion: 0.02
Nodes (18): agentTestMockLLM, chainMockLLM, countedErrorMockLLM, emptyDecomposeMockLLM, errorMockLLM, flakyDecomposeMockLLM, flakyRefineMockLLM, flakySubtaskMockLLM (+10 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (111): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+103 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (88): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+80 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (99): perTreeStats(), setupGardener(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree(), TestMetricsTracker_BestFitnessTracking() (+91 more)
...
Cohesion: 0.03
Nodes (65): containsAnyStr(), findChildByName(), TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput() (+57 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (89): Duration(), TestCheckConfidence_ConditionExists(), TestEvaluateTree_StructuralQualityRewardsUsefulContentMutations(), countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New() (+81 more)
...
Cohesion: 0.05
Nodes (79): BehavioralDescriptor, growthFitness(), FeatureDimension, FitnessDimension, TestPopulationEvolve_ResurrectsExtinctSpecialist(), TestPopulationHealthSnapshot_DiversityCollapseRun(), Bucket(), Descriptor() (+71 more)
...
Cohesion: 0.05
Nodes (81): TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip(), TestDeadLetterQueue_PreserveCategory() (+73 more)
...
Cohesion: 0.05
Nodes (75): alwaysSampler, Attr, TestConsoleTracer_ExporterReceivesCompletedSpan(), fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200() (+67 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (67): BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir() (+59 more)
...
Cohesion: 0.05
Nodes (62): ApplyJitter(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), FullJitter(), GetErrorContext(), NewErrorContext(), TestApplyJitter_AllStrategiesDeterministicRange() (+54 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (56): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), ComposeTaskTreeAgentic() (+48 more)
...
Cohesion: 0.05
Nodes (23): AgentMetric, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON() (+15 more)
...
Cohesion: 0.04
Nodes (37): agentExecuteResult(), dashboardLocalAgentResult(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAlertRules(), handleDLQReplay(), handleLogin() (+29 more)
...
Cohesion: 0.04
Nodes (43): ActionFunc, ActionProvider, init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), docChangeContextFromBlackboard(), init(), registerArc42SyncNode() (+35 more)

### Community 50 - "Community 50"
Cohesion: 0.1
Nodes (49): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+41 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (47): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), JobStore, TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves() (+39 more)
...
Cohesion: 0.08
Nodes (47): Config, EvolvedAgent, buildEvolvedPrompt(), NewEvolvedAgent(), toolDescriptions(), toolNames(), saveRecordWithDelay(), TestBuildEvolvedPrompt() (+39 more)
...
Cohesion: 0.05
Nodes (38): TestBlackboard_AllFields(), TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails(), TestRunTask_Success(), TestIntegration_ReflectionAndPersistence(), reflectOnOutcomeAction(), TestReflectOnOutcomeAction_NilLLM(), TestReflectOnOutcomeAction_WithMockLLM() (+30 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (32): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), FileJobStore, TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports() (+24 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (51): buildGrillRound1Query(), isGoapNotebookLMFailure(), arc42GoalsPromptBlock(), arc42ResearchTopics(), loadArc42QualityGoals(), TestArc42GoalsPromptBlockContainsEveryGoal(), TestArc42GoalsPromptBlockEmptyWhenDocMissing(), TestArc42ResearchTopicsAnchoredToGoals() (+43 more)
...
Cohesion: 0.07
Nodes (46): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField(), extractNotebookLMAnswer() (+38 more)
...
Cohesion: 0.05
Nodes (27): TestOutcomeErrorDetail(), ResolvePipelineAgent(), RunDeps, applyOutcomeRefinement(), IsHealthyOutcome(), OutcomeErrorDetail(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome() (+19 more)
...
Cohesion: 0.08
Nodes (22): handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus() (+14 more)
...
Cohesion: 0.1
Nodes (36): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionNoopPatchStreak(), goapFusionPreflightWired() (+28 more)

### Community 93 - "Community 93"
Cohesion: 0.08
Nodes (32): TestTeslaDeepResearch(), TestTeslaQuickResearch(), TestClient_AnalyzeComplexity_FallbackOnError(), TestClient_Generate_ConnectionRefused(), TestClient_GeneratePlan_FallbackOnError(), TestClient_Reflect_FallbackOnError(), TestDeepSeekClient_AnalyzeComplexity(), TestDeepSeekClient_Generate_APIError() (+24 more)
...
Cohesion: 0.08
Nodes (20): attachLogHandler(), buildBaseHandler(), buildLogger(), Debug(), envLogLevel(), Error(), Init(), L() (+12 more)
...
Cohesion: 0.09
Nodes (30): newAgentExecutor(), getDashCBStore(), handleAgentExecute(), handleAgentRun(), handleAgentsList(), TestHandleAgentExecute_CircuitBreakerOpenReturns503(), TestHandleAgentExecute_SetsQualityScoreFromRunResult(), TestHandleAgentRun_CircuitBreakerOpenReturns503() (+22 more)
...
Cohesion: 0.1
Nodes (25): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), markGoapFusionImplDegraded(), TestFusionAnalysis_RateLimitCarryoverNotConflatedAsDegradation(), TestCurrentSuperpowersRunRefusesFinishedRun(), resolveGraphifyBin() (+17 more)
...
Cohesion: 0.13
Nodes (26): MultiNodeProbeConfig, MultiNodeProbeReport, NodeProbeStatus, panicOnHostRoundTripper, appendErr(), executeProbeTask(), getJSON(), ProbeMultiNodeDashboard() (+18 more)
...
Cohesion: 0.14
Nodes (29): NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation(), TestCrisisDetector_DetectPopulation_DiversityCollapse() (+21 more)
...
Cohesion: 0.1
Nodes (24): ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), init(), ApplyBlockMutations(), blockIDFromOp() (+16 more)
...
Cohesion: 0.09
Nodes (27): Binaries, code:go (type Counter struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }) (+19 more)
...
Cohesion: 0.1
Nodes (23): TestRunPipelineWithID_RecordsAgentMetrics(), handleSprintExecute(), handleTaskCreate(), syncWorkflowTaskStatus(), hermesOutcome(), isAuctionShapedTask(), PickTreeForTask(), ResolveAgentName() (+15 more)
...
Cohesion: 0.11
Nodes (12): handleAnalyze(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation(), TestHandleSprintExecute_UpdatesCurrentWorkflow(), Task, NewTaskStore(), priorityRank(), TestNewTaskStore_PanicsOnCorruptFile() (+4 more)
...
Cohesion: 0.15
Nodes (21): TestSelectorOptimizer_New(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), TestMemeticEvolve_ResurrectsExtinctSpecialist(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain() (+13 more)
...
Cohesion: 0.14
Nodes (18): min(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section(), TestGenerateTemplateOutput_TruncatedCache(), TestGenerateTemplateOutput_Arc42Section(), TestGenerateTemplateOutput_Arc42TitleNoNewline() (+10 more)
...
Cohesion: 0.2
Nodes (3): MAPElitesGrid, MAPElitesPopulation, materializeMutationOp()
...
Cohesion: 0.24
Nodes (12): mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveHoldsBBMu(), TestBTBlocksComposeSaveHoldsServerLock() (+4 more)
...
Cohesion: 0.17
Nodes (11): TestCreateAgentTool_Call_NilFactory(), TestReflectTool_Call_NoLLM(), TestReflectTool_Call_WithLLM(), TestRunTaskTool_Call(), TestToolNames_And_Descriptions(), CreateAgentTool, NewCreateAgentTool(), NewFitnessTool() (+3 more)
...
Cohesion: 0.14
Nodes (13): code:text (docs/superpowers/runs/<run-id>/), code:go (sel("Phase1_Design",), code:markdown (### Task N: Title), code:go (evolution.SerializableNode{), code:text (ApproveSuperpowersPRPush (HumanApprovalGate, side_effect_cla), Current Stub Surface To Replace, Done Definition, Production Acceptance Criteria (+5 more)
...
Cohesion: 0.73
Nodes (5): TestResolveTreeID_AppliesLearnedSelectorOrdering(), TestResolveTreeID_ColdSelectorKeepsAuthoredOrder(), TestResolveTreeID_PerTreeStatsFn(), triageSelectorTree(), writeSelectorStats()
...
## Knowledge Gaps
- **10246 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+10241 more)
...
- **Why does `Append()` connect `Community 42` to `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 35`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 45`, `Community 46`, `Community 47`, `Community 49`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 56`, `Community 59`, `Community 61`, `Community 62`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 70`, `Community 71`, `Community 72`, `Community 74`, `Community 75`, `Community 76`, `Community 80`, `Community 82`, `Community 83`, `Community 85`, `Community 87`, `Community 88`, `Community 89`, `Community 91`, `Community 94`, `Community 97`, `Community 99`, `Community 102`, `Community 105`, `Community 106`, `Community 108`, `Community 111`, `Community 113`, `Community 115`, `Community 117`, `Community 120`, `Community 123`, `Community 128`, `Community 130`, `Community 131`, `Community 132`, `Community 134`, `Community 138`, `Community 140`, `Community 141`, `Community 143`, `Community 147`, `Community 151`, `Community 152`, `Community 156`, `Community 161`, `Community 170`, `Community 173`, `Community 175`, `Community 176`, `Community 177`, `Community 180`, `Community 181`, `Community 182`, `Community 186`, `Community 188`, `Community 701`, `Community 702`, `Community 703`, `Community 704`, `Community 706`, `Community 195`, `Community 196`, `Community 707`, `Community 201`, `Community 205`, `Community 207`, `Community 208`, `Community 209`, `Community 211`, `Community 212`, `Community 726`, `Community 730`, `Community 219`, `Community 224`, `Community 225`, `Community 1395`, `Community 947`, `Community 948`, `Community 437`, `Community 439`, `Community 440`, `Community 441`, `Community 442`, `Community 454`, `Community 966`, `Community 456`, `Community 457`, `Community 970`, `Community 971`, `Community 972`, `Community 458`, `Community 464`, `Community 467`, `Community 468`, `Community 469`, `Community 470`, `Community 472`, `Community 480`, `Community 481`, `Community 482`, `Community 995`, `Community 996`, `Community 997`, `Community 1016`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 28` to `Community 129`, `Community 3`, `Community 1029`, `Community 136`, `Community 8`, `Community 11`, `Community 140`, `Community 14`, `Community 144`, `Community 19`, `Community 22`, `Community 1048`, `Community 25`, `Community 154`, `Community 24`, `Community 27`, `Community 31`, `Community 32`, `Community 38`, `Community 43`, `Community 45`, `Community 51`, `Community 438`, `Community 55`, `Community 56`, `Community 963`, `Community 195`, `Community 69`, `Community 70`, `Community 455`, `Community 73`, `Community 76`, `Community 208`, `Community 81`, `Community 96`, `Community 98`, `Community 101`, `Community 103`, `Community 122`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 11` to `Community 129`, `Community 3`, `Community 133`, `Community 8`, `Community 138`, `Community 14`, `Community 144`, `Community 19`, `Community 20`, `Community 23`, `Community 153`, `Community 28`, `Community 32`, `Community 38`, `Community 42`, `Community 171`, `Community 50`, `Community 56`, `Community 444`, `Community 64`, `Community 192`, `Community 197`, `Community 200`, `Community 76`, `Community 77`, `Community 78`, `Community 80`, `Community 465`, `Community 217`, `Community 99`, `Community 487`, `Community 1407`?**
