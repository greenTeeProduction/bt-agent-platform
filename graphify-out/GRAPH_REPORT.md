# Graph Report - superpowers-20260713T151919-1d2ca422-goap-fusion-loop-runner-blackboard-conte  (2026-07-13)

## Corpus Check
- 841 files · ~947,566 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20958 nodes · 32316 edges · 1729 communities (1368 shown, 361 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8321 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e79f851`
...
8. `sleep()` - 95 edges
9. `main()` - 77 edges
10. `arc42 Section 9 — Architecture Decisions` - 74 edges
...
## Communities (1729 total, 361 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (138): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+130 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (138): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+130 more)
...
Cohesion: 0.05
Nodes (92): main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+84 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (33): Server, AgentMetric, Alert, AlertReport, Catalog, extractYAMLField(), inferTree(), splitTags() (+25 more)
...
Cohesion: 0.04
Nodes (78): docgenState, allSections(), buildSectionMap(), contains(), fileHash(), hashSectionSources(), isSectionDone(), main() (+70 more)
...
Cohesion: 0.05
Nodes (71): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle(), ComposePreset() (+63 more)
...
Cohesion: 0.05
Nodes (76): buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), registerSuperpowersProductionActions(), titleSuperpowersVerb(), applyScriptRunner (+68 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (85): Duration(), TestDuration(), TestCheckConfidence_ConditionExists(), TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_PruningOnNodeExplosion(), TestIterativeDeepening_TTHitDuringSearch() (+77 more)
...
Cohesion: 0.04
Nodes (33): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, Gardener, baseNodeCount() (+25 more)
...
Cohesion: 0.03
Nodes (74): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+66 more)
...
Cohesion: 0.08
Nodes (61): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), buildClaudeReviewPrompt() (+53 more)
...
Cohesion: 0.09
Nodes (38): clearSuperpowersPlanState(), loadSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), saveSuperpowersPlanState(), buildDeterministicImplementationPlan() (+30 more)
...
Cohesion: 0.12
Nodes (34): recentImplementedGoals(), TestRecentImplementedGoalsReadsStore(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery(), nlmIsResearchImport(), nlmIsResearchStart() (+26 more)

### Community 84 - "Community 84"
Cohesion: 0.11
Nodes (30): isGoapInfraCycleFailure(), refundGoapMilestoneAttemptForInfraFailure(), refundProbeHeadMilestone(), seedRefundProgram(), TestIsGoapInfraCycleFailure(), TestIsGoapInfraCycleFailure_OwnCodeGateFailureCharges(), TestPrioritizeGoapGoals_StampsChargedMilestone(), TestRefundGoapMilestoneAttempt_HeadRefFallbackAndNoop() (+22 more)
...
Cohesion: 0.11
Nodes (32): TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter(), TestMutation_AddBefore(), TestMutation_AddFallback(), TestMutation_IncreaseRetries() (+24 more)
...
Cohesion: 0.06
Nodes (14): TestStore_CountFailures_MixedRecords(), TestStore_CountFailures_NoFailures(), TestStore_LoadAll_WithSubdirs(), TestStore_NewStore_MkdirAllError(), TestStore_RecentFailures_Ordering(), TestStore_Save_RenameCleanup(), TestStore_Save_WriteError(), TestStore_CountFailures_MixedRecords() (+6 more)
...
Cohesion: 0.08
Nodes (31): Binaries, code:go (type Counter struct { ... }), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {) (+23 more)
...
Cohesion: 0.13
Nodes (23): toast(), apiFetch(), getCookie(), cbIcon(), createAgent(), deleteAgent(), loadAgents(), runAgent() (+15 more)
...
Cohesion: 0.12
Nodes (12): TestNumberSchema(), ArraySchema(), BoolSchema(), DashboardRoutes(), NumberSchema(), TestConvenienceSchemaConstructors(), TestDashboardRoutes_AgentsExecuteHasRequestBody(), TestDashboardRoutes_AllHaveOperationIDs() (+4 more)
...
Cohesion: 0.17
Nodes (21): NewDefaultCompany(), clamp(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary(), testLLM(), checkTreeBasics() (+13 more)
...
Cohesion: 0.15
Nodes (15): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), NewRegistryWithUsers(), recordsForEntry(), TestBankFor_NoUserRootFallsBackToShared() (+7 more)
...
Cohesion: 0.12
Nodes (9): A2AHandoffBlock(), builtinBlocks(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), HumanReviewBlock() (+1 more)
...
Cohesion: 0.26
Nodes (4): OpenAICompatClient, checkRateLimit(), ParseRetryAfter(), TestParseRetryAfter()
...
## Knowledge Gaps
- **7023 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7018 more)
...
- **Why does `Append()` connect `Community 7` to `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 538`, `Community 27`, `Community 28`, `Community 542`, `Community 543`, `Community 32`, `Community 33`, `Community 36`, `Community 37`, `Community 40`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 48`, `Community 49`, `Community 562`, `Community 50`, `Community 561`, `Community 565`, `Community 53`, `Community 55`, `Community 560`, `Community 57`, `Community 58`, `Community 60`, `Community 61`, `Community 63`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 73`, `Community 76`, `Community 77`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 89`, `Community 91`, `Community 95`, `Community 98`, `Community 101`, `Community 107`, `Community 108`, `Community 110`, `Community 111`, `Community 112`, `Community 114`, `Community 116`, `Community 117`, `Community 123`, `Community 124`, `Community 125`, `Community 126`, `Community 127`, `Community 130`, `Community 133`, `Community 139`, `Community 140`, `Community 141`, `Community 143`, `Community 151`, `Community 155`, `Community 156`, `Community 160`, `Community 162`, `Community 164`, `Community 170`, `Community 171`, `Community 172`, `Community 178`, `Community 179`, `Community 185`, `Community 187`, `Community 191`, `Community 192`, `Community 196`, `Community 201`, `Community 202`, `Community 716`, `Community 718`, `Community 208`, `Community 210`, `Community 214`, `Community 217`, `Community 221`, `Community 738`, `Community 742`, `Community 743`, `Community 759`, `Community 761`, `Community 763`, `Community 768`, `Community 362`, `Community 363`, `Community 364`, `Community 365`, `Community 375`, `Community 376`, `Community 377`, `Community 378`, `Community 379`, `Community 380`, `Community 386`, `Community 387`, `Community 395`, `Community 397`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 59` to `Community 2`, `Community 3`, `Community 6`, `Community 9`, `Community 11`, `Community 16`, `Community 17`, `Community 19`, `Community 22`, `Community 153`, `Community 156`, `Community 32`, `Community 161`, `Community 35`, `Community 36`, `Community 167`, `Community 41`, `Community 45`, `Community 48`, `Community 52`, `Community 56`, `Community 186`, `Community 61`, `Community 195`, `Community 196`, `Community 205`, `Community 212`, `Community 85`, `Community 213`, `Community 732`, `Community 94`, `Community 99`, `Community 361`, `Community 111`, `Community 113`, `Community 373`, `Community 123`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 111` to `Community 128`, `Community 9`, `Community 13`, `Community 17`, `Community 19`, `Community 22`, `Community 152`, `Community 153`, `Community 156`, `Community 31`, `Community 32`, `Community 161`, `Community 160`, `Community 167`, `Community 50`, `Community 54`, `Community 57`, `Community 61`, `Community 195`, `Community 196`, `Community 70`, `Community 212`, `Community 213`, `Community 86`, `Community 215`, `Community 96`, `Community 99`, `Community 364`, `Community 118`, `Community 121`, `Community 123`?**
