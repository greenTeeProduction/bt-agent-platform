# Graph Report - superpowers-20260712T014928-8d421b65-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-12)

## Corpus Check
- 817 files · ~884,098 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19248 nodes · 30214 edges · 1643 communities (1279 shown, 364 thin omitted)
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 8024 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fb9a32e6`
...
## Communities (1643 total, 364 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (92): expandChainStateTemplates(), recordChainHistory(), renderChainHistory(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM() (+84 more)
...
Cohesion: 0.02
Nodes (113): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+105 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (113): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+105 more)
...
Cohesion: 0.03
Nodes (53): stringContains(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), TestAction_ReflectGoapOutcome_NoResultsFallsBack(), cacheCheckAction(), cacheResultAction(), execLLMCallAction(), execRefineAction() (+45 more)
...
Cohesion: 0.04
Nodes (59): docgenState, allSections(), buildSectionMap(), contains(), fileHash(), hashSectionSources(), isSectionDone(), main() (+51 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (76): TestScoreChild_GoalAlignmentBranch(), TestScoreChild_NilChainState(), TestScoreChildren_BasicRanking(), ParallelMode, intSliceFromInterface(), BuildReactiveParallel(), forkBlackboard(), intSliceFromInterface() (+68 more)
...
Cohesion: 0.06
Nodes (65): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit() (+57 more)
...
Cohesion: 0.05
Nodes (63): ChainConfig, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), buildMapReduceFallback(), buildToolList(), execAgent() (+55 more)
...
Cohesion: 0.06
Nodes (43): min(), handleAnalyze(), brokenTool, ChainKind, BuildChainAction(), buildChainActionFn(), execLLMCall(), generateTemplateOutput() (+35 more)
...
Cohesion: 0.07
Nodes (38): getHomeDir(), handleSprintExecute(), init(), main(), handlePipelineRun(), handlePipelines(), newPipelineRunner(), newRunID() (+30 more)
...
Cohesion: 0.07
Nodes (42): Block, TestPromoteSubtree(), Category, Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle() (+34 more)
...
Cohesion: 0.08
Nodes (36): ComposePreset(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree(), TestResolveTreeID_FusionAliases(), HermesObsidianOptimizerTree() (+28 more)
...
Cohesion: 0.08
Nodes (42): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection() (+34 more)
...
Cohesion: 0.1
Nodes (40): Duration(), TestDuration(), TestPopulation_StatsAccessors(), jaccardSimilarity(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve() (+32 more)
...
Cohesion: 0.09
Nodes (34): perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree() (+26 more)
...
Cohesion: 0.12
Nodes (34): TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions(), TestAction_PlanGoapActions_JSONActionsInvalidEntry(), TestAction_PlanGoapActions_NoPlanFound(), TestAction_PlanGoapActions_WithGoapConfig(), TestAction_PlanGoapActions_WorldStateFromTask(), TestAction_PlanGoapActions_WrongActionsType() (+26 more)
...
Cohesion: 0.08
Nodes (28): AgentMetrics, AgentStats, BuildIdentity, Counter, Gauge, HealthResponse, LabeledGauge, BuildIdentityFromBuildInfo() (+20 more)
...
Cohesion: 0.07
Nodes (23): handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogin(), handleLogout() (+15 more)

### Community 75 - "Community 75"
Cohesion: 0.05
Nodes (41): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+33 more)
...
Cohesion: 0.09
Nodes (25): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), countTreeNodes(), TestSuperpowersPipelineSimulation(), TestHumanApprovalGate_AutoApprove() (+17 more)
...
Cohesion: 0.07
Nodes (35): Binaries, code:go (type Counter struct { ... }), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }) (+27 more)
...
Cohesion: 0.11
Nodes (31): handleScalability(), TestHandleDLQReplay_RequeuesInsteadOfDropping(), TestHandleScalability_ReflectsInjectedQueueAndRouter(), TestPriorityQueue_PersistAndReloadViaInterface(), TestPriorityTaskQueue_DequeueEmpty(), TestPriorityTaskQueue_EnqueueDequeue(), TestPriorityTaskQueue_Peek(), TestPriorityTaskQueue_PeekEmpty() (+23 more)
...
Cohesion: 0.1
Nodes (20): TestRunTask_KnowledgeGap_RoutesToKnowledgePath(), reflectOnOutcomeAction(), TestReflectOnOutcomeAction_NilLLM(), TestReflectOnOutcomeAction_WithMockLLM(), TestStore_CountFailures_MixedRecords(), TestStore_CountFailures_NoFailures(), TestStore_LoadAll_WithSubdirs(), TestStore_NewStore_MkdirAllError() (+12 more)
...
Cohesion: 0.11
Nodes (17): TestEvolveTreeV2_BloatGuard(), TestEvolveTreeV2_NoRegressionGate(), TestStore_CountFailures_MixedRecords(), TestStore_CountFailures_NoFailures(), TestStore_LoadAll_WithSubdirs(), TestStore_NewStore_MkdirAllError(), TestStore_RecentFailures_Ordering(), TestStore_Save_RenameCleanup() (+9 more)
...
Cohesion: 0.13
Nodes (14): Outcome, Record, FilterByTreeName(), Gardener, recordsForEntry(), TestRecordsForEntry_PersonalTreesUseStrictFiltering(), BuildMutationPrompt(), DefaultResearchHints() (+6 more)
...
Cohesion: 0.13
Nodes (15): TestEvolveWithExperience_ResurrectsExtinctSpecialist(), TestExpertKnowledge_SeedSpecialistsCarryProvenance(), TestPopulationEvolve_CrisisIntervention(), TestPopulationEvolve_RecordsCrisisReasons(), TestPopulationEvolve_ResurrectsExtinctSpecialist(), TestPopulationHealthSnapshot_DiversityCollapseRun(), appendResurrectedTag(), firstSpecialistType() (+7 more)

### Community 189 - "Community 189"
Cohesion: 0.13
Nodes (20): TestBTOptimizer_New(), collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestExtractCondition(), TestFindMainSelector(), TestMergeOverlappingPaths_MergeNode() (+12 more)
...
Cohesion: 0.17
Nodes (11): Histogram, LabeledCounter, bucketForStatus(), MetricsMiddleware(), RecordTask(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered(), TestBlockDurationHistogramSeriesRendered() (+3 more)
...
Cohesion: 0.21
Nodes (4): mergeIslandPopulation(), islandArchive, IslandModel, IslandStats
...
Cohesion: 0.22
Nodes (9): code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), Package: evaluator, Package: gardener, Package: goap, Package: langagent (+1 more)
...
Cohesion: 0.36
Nodes (7): NewACPClient(), TestACPClientGenerateReturnsErrorWhenSessionMissing(), TestACPClientGenerateTalksToACPServer(), TestACPClientGenerateTalksToHermesACP(), TestACPHelperProcess(), TestNewProviderCreatesACPClient(), writeJSON()
...
Cohesion: 0.38
Nodes (3): DecisionTrace, TraceStep, TraceStore
...
## Knowledge Gaps
- **6001 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+5996 more)
...
- **Why does `Append()` connect `Community 15` to `Community 0`, `Community 514`, `Community 515`, `Community 4`, `Community 5`, `Community 6`, `Community 516`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 31`, `Community 32`, `Community 33`, `Community 36`, `Community 37`, `Community 39`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 58`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 67`, `Community 68`, `Community 70`, `Community 71`, `Community 74`, `Community 77`, `Community 78`, `Community 80`, `Community 81`, `Community 83`, `Community 84`, `Community 86`, `Community 89`, `Community 92`, `Community 93`, `Community 95`, `Community 97`, `Community 99`, `Community 100`, `Community 101`, `Community 103`, `Community 107`, `Community 116`, `Community 118`, `Community 120`, `Community 121`, `Community 122`, `Community 123`, `Community 636`, `Community 126`, `Community 129`, `Community 130`, `Community 132`, `Community 646`, `Community 137`, `Community 139`, `Community 141`, `Community 656`, `Community 658`, `Community 150`, `Community 151`, `Community 154`, `Community 155`, `Community 669`, `Community 159`, `Community 164`, `Community 169`, `Community 682`, `Community 170`, `Community 172`, `Community 171`, `Community 686`, `Community 173`, `Community 688`, `Community 177`, `Community 178`, `Community 180`, `Community 692`, `Community 182`, `Community 183`, `Community 184`, `Community 187`, `Community 188`, `Community 701`, `Community 189`, `Community 704`, `Community 193`, `Community 194`, `Community 708`, `Community 197`, `Community 198`, `Community 196`, `Community 715`, `Community 205`, `Community 208`, `Community 212`, `Community 213`, `Community 744`, `Community 331`, `Community 332`, `Community 333`, `Community 342`, `Community 346`, `Community 351`, `Community 353`, `Community 355`, `Community 359`, `Community 363`, `Community 369`, `Community 882`, `Community 484`, `Community 485`, `Community 500`, `Community 501`, `Community 502`, `Community 503`, `Community 509`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 73` to `Community 0`, `Community 133`, `Community 136`, `Community 138`, `Community 10`, `Community 12`, `Community 659`, `Community 19`, `Community 150`, `Community 26`, `Community 32`, `Community 34`, `Community 37`, `Community 39`, `Community 40`, `Community 169`, `Community 177`, `Community 50`, `Community 51`, `Community 54`, `Community 56`, `Community 57`, `Community 63`, `Community 197`, `Community 71`, `Community 199`, `Community 329`, `Community 88`, `Community 90`, `Community 353`, `Community 109`, `Community 118`, `Community 507`, `Community 123`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 39` to `Community 5`, `Community 10`, `Community 12`, `Community 140`, `Community 16`, `Community 148`, `Community 23`, `Community 26`, `Community 155`, `Community 164`, `Community 45`, `Community 177`, `Community 55`, `Community 63`, `Community 68`, `Community 198`, `Community 71`, `Community 73`, `Community 74`, `Community 88`, `Community 344`, `Community 99`, `Community 104`, `Community 109`, `Community 115`, `Community 507`, `Community 123`, `Community 125`?**
