# Graph Report - superpowers-20260716T035821-6d4a1975-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-16)

## Corpus Check
- 891 files · ~1,079,788 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23780 nodes · 36071 edges · 1883 communities (1542 shown, 341 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8997 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b965e5b`
...
6. `arc42 Section 9 — Architecture Decisions` - 126 edges
...
## Communities (1883 total, 341 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (176): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+168 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (176): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+168 more)
...
Cohesion: 0.02
Nodes (126): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+118 more)
...
Cohesion: 0.04
Nodes (86): TestRunOnce_EmitsRunRootSpan(), main(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), alwaysSampler (+78 more)
...
Cohesion: 0.05
Nodes (79): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+71 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (84): echoTaskLeaf, TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree() (+76 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (71): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), Category, composeOrderedWithMiddle() (+63 more)
...
Cohesion: 0.04
Nodes (56): agentExecuteResult(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleAnalyze() (+48 more)
...
Cohesion: 0.06
Nodes (68): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup() (+60 more)
...
Cohesion: 0.06
Nodes (48): DefaultRetryPolicy(), GetErrorContext(), NewErrorContext(), TestErrorContext_Concurrent(), TestErrorContext_Error(), TestErrorContext_Error_Minimal(), TestErrorContext_Integration_RetryPolicy(), TestErrorContext_Summary_Full() (+40 more)
...
Cohesion: 0.06
Nodes (36): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), FileJobStore, TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports() (+28 more)
...
Cohesion: 0.05
Nodes (32): Outcome, Record, FilterByTreeName(), Config, TestBaseNodeCount(), CycleMetrics, Gardener, baseNodeCount() (+24 more)

### Community 43 - "Community 43"
Cohesion: 0.07
Nodes (39): References, Collect(), indexOf(), GoapFusionPreflightNode(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedDelegatesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedMaterializesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionCircuitPolicyVerdictFoldsNoopStreak(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionGatesClaudeImplementation() (+31 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (50): Duration(), TestDuration(), BuildCircuitBreaker(), BuildTimeout(), TestStoreSaveCompactsTerminalRecords(), AggregatedTrace, buildAggregatedTrace(), NewTraceReader() (+42 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (52): TestNewReinforcementLearner(), NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation() (+44 more)
...
Cohesion: 0.06
Nodes (42): TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), JobStore, TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves(), NewFileJobStore() (+34 more)
...
Cohesion: 0.09
Nodes (52): countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New() (+44 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (45): IntSchema(), ObjectSchema(), findResponse(), NewRouteIndex(), ResponseValidator(), TestDashboardRoutes_AllIndexable(), TestNewRouteIndex(), TestNewRouteIndex_Empty() (+37 more)
...
Cohesion: 0.06
Nodes (35): TestRunTask_CacheHit(), TestRunTask_KnowledgeGap_RoutesToKnowledgePath(), reflectOnOutcomeAction(), TestReflectOnOutcomeAction_NilLLM(), TestReflectOnOutcomeAction_WithMockLLM(), TestStore_CountFailures_MixedRecords(), TestStore_CountFailures_NoFailures(), TestStore_LoadAll_WithSubdirs() (+27 more)
...
Cohesion: 0.06
Nodes (37): TestOutcomeErrorDetail(), FeedbackFile(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath() (+29 more)
...
Cohesion: 0.05
Nodes (36): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), parseChainConfig(), TestChainAction_ParseConfig(), BuildInverter() (+28 more)
...
Cohesion: 0.08
Nodes (34): growthFitness(), FitnessDimension, TestNSGAII_Evolve_Basic(), MultiFitness, MultiIndividual, cappedIndividuals(), clampScore(), countActions() (+26 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (42): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionNoopPatchStreak(), goapFusionPreflightWired() (+34 more)

### Community 63 - "Community 63"
Cohesion: 0.08
Nodes (42): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField(), extractNotebookLMAnswer() (+34 more)
...
Cohesion: 0.07
Nodes (30): AgentMetrics, AgentStats, BuildIdentity, Counter, Gauge, HealthResponse, LabeledGauge, LabeledHistogram (+22 more)

### Community 66 - "Community 66"
Cohesion: 0.07
Nodes (37): EvolvedAgent, EvolveTool, TestCheckConfidence_ConditionExists(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes() (+29 more)
...
Cohesion: 0.06
Nodes (16): WebhookPublisher, TestActionForName_BulkCoverage(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), DefaultPanicHandler(), Recover(), SafeGo(), TestRecover_CatchesPanic() (+8 more)

### Community 80 - "Community 80"
Cohesion: 0.07
Nodes (23): fanoutHandler, InitLogExport(), logExportTarget(), newTraceContextHandler(), TestInitLogExport_Idempotent(), TestLogExportTarget(), TestTraceContextHandler_InjectsTraceIDs(), traceContextHandler (+15 more)

### Community 81 - "Community 81"
Cohesion: 0.08
Nodes (33): ctxAwareBlockingRunner, buildErrorHandlerPrompt(), errorHandlerCooldown(), errorHandlerEnabled(), errorHandlerMaxNodes(), errorHandlerNodeDepth(), errorHandlerSignatureFromBB(), firstTickedLeaf() (+25 more)
...
Cohesion: 0.07
Nodes (26): exportMemoryCategory(), exportPreviousRuns(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), LogsDir() (+18 more)
...
Cohesion: 0.11
Nodes (17): BTOptimizer, collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestExtractCondition(), TestFindMainSelector(), isDefaultPath() (+9 more)
...
Cohesion: 0.1
Nodes (26): collectSelectorNames(), SelectorStatsFile(), TestSelectorOptimizer_New(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity() (+18 more)
...
Cohesion: 0.12
Nodes (30): handleScalability(), TestHandleScalability_ReflectsInjectedQueueAndRouter(), TestPriorityQueue_PersistAndReloadViaInterface(), TestPriorityTaskQueue_DequeueEmpty(), TestPriorityTaskQueue_EnqueueDequeue(), TestPriorityTaskQueue_Peek(), TestPriorityTaskQueue_PeekEmpty(), TestPriorityTaskQueue_PurgeViaInterface() (+22 more)
...
Cohesion: 0.11
Nodes (15): NewNSGAIIPopulation(), NewNSGAIISorter(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_FastNonDominatedSort(), TestNSGAII_FrontRank() (+7 more)
...
Cohesion: 0.09
Nodes (26): ClassifyError(), contextDeadlineExceeded(), isAuthError(), isLLMError(), isNetworkError(), isRateLimitError(), isResourceError(), isTimeoutError() (+18 more)
...
Cohesion: 0.16
Nodes (27): Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid(), NewMAPElitesPopulation(), cellFitnesses(), insertPersistNiche(), newPersistElite(), TestMAPElitesGridLoad_MissingFileColdStart() (+19 more)
...
Cohesion: 0.13
Nodes (5): goalEntry, goalHeap, GoalQueue, entryLess(), NewGoalQueueFrom()
...
Cohesion: 0.13
Nodes (24): init(), registerGoDevActions(), TestBlackboard_AllFields(), TestTree_SerializeRoundtrip(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild() (+16 more)
...
Cohesion: 0.12
Nodes (10): acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), mergeSelectorStatsMaps(), persistSelectorStats(), readSelectorStatsFile(), NewTrackRecord() (+2 more)
...
Cohesion: 0.1
Nodes (20): TestDeprecatedHandlerFunc(), TestNumberSchema(), DeprecationHeader, ArraySchema(), BoolSchema(), DeprecatedHandlerFunc(), httpStatusText(), NumberSchema() (+12 more)
...
Cohesion: 0.16
Nodes (15): ClaudeRunner, CommandResult, CommandRunner, execClaudeRunner, execCommandRunner, getenvDefault(), resolvedSuperpowersClaudeModel(), captureExecClaudeArgs() (+7 more)
...
Cohesion: 0.35
Nodes (18): swapErrorHandlerRunner(), ehTestHandlerNode(), ehTestProposalJSON(), runHandler(), TestClaudeErrorHandler_BuildSwitchAndValidation(), TestClaudeErrorHandler_CapReachedSkipsClaude(), TestClaudeErrorHandler_GraftedExtensionHandlesNextRunWithoutClaude(), TestClaudeErrorHandler_InvalidProposalRejected() (+10 more)
...
Cohesion: 0.2
Nodes (8): NewFallbackLLM(), TestFallbackLLM_GenerateAllPanicReturnsAggregatedError(), TestFallbackLLM_GenerateRecoversPanicAndTriesNextModel(), TestFallbackLLM_GenerateReturnsAllFailures(), TestFallbackLLM_GenerateUsesNextModelAfterPrimaryFailure(), TestNewProvider_BuildsFallbackChainFromConfiguredModels(), NamedLLM, stubLLM
...
Cohesion: 0.14
Nodes (14): code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), Package: evaluator (+6 more)
...
Cohesion: 0.18
Nodes (6): ErrorCategory, ExecuteWithPolicy(), sleepWithContext(), TestErrorCategory_String(), TestRetryPolicy_ExecuteWithPolicy(), RetryPolicy
...
## Knowledge Gaps
- **8658 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8653 more)
...
- **Why does `Append()` connect `Community 12` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 11`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 28`, `Community 30`, `Community 32`, `Community 34`, `Community 35`, `Community 39`, `Community 41`, `Community 42`, `Community 44`, `Community 45`, `Community 47`, `Community 51`, `Community 55`, `Community 56`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 69`, `Community 71`, `Community 73`, `Community 74`, `Community 75`, `Community 76`, `Community 78`, `Community 82`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 89`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 97`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 104`, `Community 109`, `Community 115`, `Community 119`, `Community 632`, `Community 121`, `Community 1146`, `Community 124`, `Community 637`, `Community 638`, `Community 127`, `Community 642`, `Community 131`, `Community 135`, `Community 136`, `Community 137`, `Community 138`, `Community 141`, `Community 143`, `Community 147`, `Community 148`, `Community 662`, `Community 663`, `Community 159`, `Community 161`, `Community 164`, `Community 165`, `Community 167`, `Community 170`, `Community 171`, `Community 172`, `Community 177`, `Community 178`, `Community 186`, `Community 188`, `Community 191`, `Community 192`, `Community 194`, `Community 196`, `Community 198`, `Community 199`, `Community 200`, `Community 206`, `Community 208`, `Community 212`, `Community 213`, `Community 218`, `Community 220`, `Community 222`, `Community 846`, `Community 855`, `Community 857`, `Community 875`, `Community 876`, `Community 880`, `Community 896`, `Community 917`, `Community 409`, `Community 411`, `Community 413`, `Community 930`, `Community 420`, `Community 422`, `Community 424`, `Community 431`, `Community 433`, `Community 436`, `Community 437`, `Community 438`, `Community 439`, `Community 440`, `Community 446`, `Community 449`, `Community 451`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 18` to `Community 130`, `Community 131`, `Community 4`, `Community 12`, `Community 15`, `Community 16`, `Community 143`, `Community 146`, `Community 19`, `Community 148`, `Community 24`, `Community 27`, `Community 156`, `Community 415`, `Community 33`, `Community 39`, `Community 173`, `Community 45`, `Community 47`, `Community 48`, `Community 49`, `Community 51`, `Community 55`, `Community 439`, `Community 57`, `Community 61`, `Community 65`, `Community 66`, `Community 70`, `Community 199`, `Community 71`, `Community 214`, `Community 89`, `Community 1242`, `Community 225`, `Community 101`, `Community 106`, `Community 115`, `Community 120`, `Community 126`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 57` to `Community 130`, `Community 4`, `Community 13`, `Community 142`, `Community 16`, `Community 17`, `Community 18`, `Community 22`, `Community 407`, `Community 24`, `Community 27`, `Community 412`, `Community 28`, `Community 33`, `Community 929`, `Community 34`, `Community 421`, `Community 39`, `Community 168`, `Community 40`, `Community 44`, `Community 47`, `Community 48`, `Community 49`, `Community 53`, `Community 187`, `Community 188`, `Community 65`, `Community 198`, `Community 72`, `Community 75`, `Community 79`, `Community 80`, `Community 212`, `Community 214`, `Community 89`, `Community 219`, `Community 868`, `Community 109`, `Community 120`, `Community 636`, `Community 125`?**
