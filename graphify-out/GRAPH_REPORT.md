# Graph Report - superpowers-20260715T162832-9a21d49e-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-15)

## Corpus Check
- 867 files · ~1,037,768 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23062 nodes · 34971 edges · 1848 communities (1496 shown, 352 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8745 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f6a8f1a6`
...
6. `arc42 Section 9 — Architecture Decisions` - 116 edges
...
## Communities (1848 total, 352 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (168): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+160 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (168): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+160 more)
...
Cohesion: 0.04
Nodes (87): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), Compose(), ComposeFromRefs() (+79 more)
...
Cohesion: 0.02
Nodes (116): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+108 more)
...
Cohesion: 0.03
Nodes (83): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+75 more)
...
Cohesion: 0.06
Nodes (94): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+86 more)
...
Cohesion: 0.04
Nodes (92): auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext(), AuditMiddleware() (+84 more)
...
Cohesion: 0.04
Nodes (75): docgenState, allSections(), buildSectionMap(), contains(), fileHash(), hashSectionSources(), isSectionDone(), main() (+67 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (81): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard() (+73 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (86): Duration(), TestDuration(), TestTranspositionTable_SaveLoadRoundTrip(), TestTranspositionTable_Store_EvictionPreservesLowestAmongSurvivors(), TestTranspositionTable_Store_EvictsLowestValueDeterministically(), TestTranspositionTable_Store_EvictsLowestValueRepeated(), TestTranspositionTable_StoreProbeMiss(), TestTranspositionTable_StoreProbeRoundTrip() (+78 more)
...
Cohesion: 0.07
Nodes (60): clearSuperpowersPlanState(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), registerSuperpowersProductionActions() (+52 more)
...
Cohesion: 0.07
Nodes (39): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestAgentWithRealToolsBlocksFinalAnswerWithoutToolUse(), TestAgentWithRealToolsRejectsFinalAnswerWithoutToolUse() (+31 more)
...
Cohesion: 0.05
Nodes (45): Approval, mockOrch, Workflow, newTaskNonce(), NewWorkflow(), sortTasks(), TestApproval_Fields(), TestApproveTask() (+37 more)
...
Cohesion: 0.05
Nodes (36): TestGardenerRollbackTool_CallRestoresSnapshot(), GateResult, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree() (+28 more)
...
Cohesion: 0.05
Nodes (31): biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), TestBiasCandidatesWithExperience_NilOrEmptyBankKeepsOrder(), TestCloneTreeForGardener_Basic() (+23 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (40): FileJobStore, JobStore, TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves(), NewFileJobStore(), NewReadOnlyJobStore() (+32 more)
...
Cohesion: 0.05
Nodes (54): TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewWebSearchTool_Structure(), TestStripHTML_Attributes() (+46 more)
...
Cohesion: 0.06
Nodes (32): AgentMetrics, AgentStats, BuildIdentity, Counter, Gauge, HealthResponse, Histogram, LabeledCounter (+24 more)
...
Cohesion: 0.06
Nodes (20): WebhookPublisher, runDLQReplayScanOnce(), TestDLQReplayScanSurvivesPanicAcrossTicks(), TestRunFullPipeline_NilSynthesis_NoPanic(), TestActionForName_BulkCoverage(), TestSuperpowersTaskVerifyRed_NoTestsFailsWithoutPanic(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent() (+12 more)
...
Cohesion: 0.08
Nodes (26): Block, Category, ComposeSpec, TestExpand_BlockMetadata(), Expand(), expandNode(), CollectBlockIDs(), FitnessRanking() (+18 more)
...
Cohesion: 0.18
Nodes (26): NewOpenAPIGenerator(), NewRoute(), mapKeys(), TestDashboardRoutes_AllRoutesBuildWithoutPanic(), TestDashboardRoutes_AuthConsistency(), TestDashboardRoutes_GeneratesValidSpec(), TestOpenAPIGenerator_AuthFlag(), TestOpenAPIGenerator_Deprecated() (+18 more)
...
Cohesion: 0.13
Nodes (20): min(), execLLMCall(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section(), TestGenerateTemplateOutput_TruncatedCache(), TestGenerateTemplateOutput_Arc42Section() (+12 more)
...
Cohesion: 0.13
Nodes (9): TestNumberSchema(), DashboardRoutes(), NumberSchema(), TestDashboardRoutes_AgentsExecuteHasRequestBody(), TestDashboardRoutes_AllHaveOperationIDs(), TestDashboardRoutes_Completeness(), TestDashboardRoutes_OperationIDUniqueness(), TestDashboardRoutes_SwaggerRoute() (+1 more)
...
Cohesion: 0.1
Nodes (12): A2AHandoffBlock(), builtinBlocks(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), HumanGateBlock(), HumanReviewBlock(), MemoryLoadBlock() (+4 more)
...
Cohesion: 0.18
Nodes (5): BTOptimizer, extractCondition(), isDefaultPath(), DTAnalyzer, isSelectorFallback()
...
Cohesion: 0.14
Nodes (12): init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init(), init(), registerSuperpowersConditions(), TestRegisterCondition_And_GetCondition(), registerAlertRouterNodes() (+4 more)
...
Cohesion: 0.21
Nodes (12): deepSearchGardener(), deepSearchV2Config(), TestEvolveTreeV2_DeepSearchMetrics_PopulatedWhenTTConfigured(), TestEvolveTreeV2_DeepSearchMetrics_ZeroWithoutTranspositionTable(), TestMetricsTracker_CyclesForTree(), TestMetricsTracker_RecordAndSummary(), TestMetricsTracker_SaveAggregatesCrisisAndLastRun(), TestMetricsTracker_SaveAggregatesDeepSearchCoverage() (+4 more)
...
Cohesion: 0.18
Nodes (13): collectSelectors(), conditionOverlap(), findMainSelector(), TestFindMainSelector(), TestSplitCamelCase(), pathEntropy(), splitCamelCase(), TestConditionOverlap() (+5 more)
...
Cohesion: 0.35
Nodes (10): NewDTAnalyzer(), pathStat(), TestBTOptimizer_ReorderSelectors(), TestDTAnalyzer_BestSplit(), TestDTAnalyzer_EmptyStatsNoOp(), TestDTAnalyzer_Entropy(), TestDTAnalyzer_Gini(), TestDTAnalyzer_InformationGain() (+2 more)
...
Cohesion: 0.32
Nodes (7): TestBTOptimizer_New(), TestExtractCondition(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), NewBTOptimizer(), TestPathHitRatio()
...
## Knowledge Gaps
- **8290 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8285 more)
...
- **Why does `Append()` connect `Community 5` to `Community 2`, `Community 3`, `Community 4`, `Community 8`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 29`, `Community 32`, `Community 33`, `Community 34`, `Community 36`, `Community 38`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 46`, `Community 49`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 61`, `Community 62`, `Community 65`, `Community 66`, `Community 67`, `Community 71`, `Community 73`, `Community 74`, `Community 76`, `Community 78`, `Community 1103`, `Community 80`, `Community 1104`, `Community 81`, `Community 83`, `Community 82`, `Community 84`, `Community 86`, `Community 87`, `Community 88`, `Community 89`, `Community 602`, `Community 90`, `Community 91`, `Community 93`, `Community 94`, `Community 607`, `Community 608`, `Community 95`, `Community 97`, `Community 99`, `Community 100`, `Community 96`, `Community 611`, `Community 617`, `Community 108`, `Community 109`, `Community 113`, `Community 115`, `Community 630`, `Community 119`, `Community 633`, `Community 123`, `Community 124`, `Community 125`, `Community 126`, `Community 127`, `Community 133`, `Community 135`, `Community 137`, `Community 139`, `Community 141`, `Community 143`, `Community 147`, `Community 149`, `Community 152`, `Community 156`, `Community 158`, `Community 164`, `Community 165`, `Community 168`, `Community 171`, `Community 172`, `Community 182`, `Community 183`, `Community 189`, `Community 190`, `Community 193`, `Community 196`, `Community 197`, `Community 200`, `Community 204`, `Community 205`, `Community 206`, `Community 207`, `Community 211`, `Community 212`, `Community 213`, `Community 809`, `Community 819`, `Community 839`, `Community 851`, `Community 854`, `Community 855`, `Community 859`, `Community 385`, `Community 390`, `Community 392`, `Community 393`, `Community 394`, `Community 401`, `Community 405`, `Community 406`, `Community 407`, `Community 408`, `Community 409`, `Community 415`, `Community 420`, `Community 421`, `Community 422`, `Community 423`, `Community 425`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 23` to `Community 4`, `Community 5`, `Community 8`, `Community 137`, `Community 10`, `Community 396`, `Community 141`, `Community 17`, `Community 19`, `Community 148`, `Community 405`, `Community 406`, `Community 25`, `Community 167`, `Community 43`, `Community 171`, `Community 50`, `Community 52`, `Community 55`, `Community 1208`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 66`, `Community 67`, `Community 71`, `Community 72`, `Community 208`, `Community 80`, `Community 605`, `Community 105`, `Community 119`, `Community 122`, `Community 127`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 60` to `Community 896`, `Community 131`, `Community 4`, `Community 3`, `Community 391`, `Community 8`, `Community 10`, `Community 15`, `Community 17`, `Community 20`, `Community 406`, `Community 23`, `Community 25`, `Community 27`, `Community 422`, `Community 38`, `Community 39`, `Community 43`, `Community 44`, `Community 46`, `Community 177`, `Community 50`, `Community 51`, `Community 55`, `Community 58`, `Community 59`, `Community 61`, `Community 190`, `Community 64`, `Community 194`, `Community 835`, `Community 68`, `Community 208`, `Community 102`, `Community 117`, `Community 123`?**
