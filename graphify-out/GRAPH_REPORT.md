# Graph Report - go-bt-evolve-arc42-research  (2026-07-08)

## Corpus Check
- 741 files · ~761,191 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16643 nodes · 26490 edges · 1484 communities (1127 shown, 357 thin omitted)
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 7297 edges (avg confidence: 0.8)
...
## Communities (1484 total, 357 thin omitted)
...
Cohesion: 0.05
Nodes (90): main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+82 more)
...
Cohesion: 0.04
Nodes (66): TestRunOnce_EmitsRunRootSpan(), NewRunDeps(), main(), main(), tracingMiddleware(), handlePipelineRun(), handlePipelines(), newPipelineRunner() (+58 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (70): ApplyJitter(), DefaultRetryPolicy(), EqualJitter(), FullJitter(), GetErrorContext(), NewCategorizedError(), NewErrorContext(), TestApplyJitter_AllStrategiesDeterministicRange() (+62 more)
...
Cohesion: 0.06
Nodes (77): DefaultLLM(), RealLLM(), TestDetectPath_FromCurrentPath(), TestDetectPath_FromVisitedPaths(), TestDetectPath_KeywordFallback(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), EvaluateBFCLV3() (+69 more)
...
Cohesion: 0.06
Nodes (72): TestCheckConfidence_ConditionExists(), TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_PruningOnNodeExplosion(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune() (+64 more)
...
Cohesion: 0.05
Nodes (64): brokenTool, ChainConfig, ChainKind, bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction(), buildChainActionFn() (+56 more)
...
Cohesion: 0.06
Nodes (66): captureExporter, NewOTLPHTTPExporter(), TestConfigureOTLPFromEnv(), TestConfigureOTLPFromEnv_DisabledWithoutEndpoint(), TestConsoleTracer_ExporterErrorDoesNotBreakEnd(), TestConsoleTracer_ExporterReceivesCompletedSpan(), TestOTLPHTTPExporter_Non2xx(), TestOTLPHTTPExporter_PostsOTLPJSON() (+58 more)
...
Cohesion: 0.07
Nodes (60): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileWriteTool_Structure(), TestNewGraphifyTool_Structure() (+52 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (51): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit() (+43 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (45): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposePreset(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), TestComposePreset_Agentic(), TestComposeTaskTreeAgentic_WithStrategyMiddle() (+37 more)
...
Cohesion: 0.04
Nodes (27): NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), alwaysSampler, Attr, consoleSpan (+19 more)
...
Cohesion: 0.19
Nodes (45): AlertRouterTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks(), section12Glossary(), section1IntroGoals() (+37 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (9): OpenAPIGenerator, Append(), mockTTOrch, EventBus, ValidateEdge(), SerializableNode, Config, DefaultConfig() (+1 more)
...
Cohesion: 0.04
Nodes (45): Binaries, code:go (type Counter struct { ... }), code:go (type Tracer interface {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type Evaluator struct { ... }) (+37 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (27): GateResult, RestoreTree(), SnapshotTree(), TestSnapshotAndRestoreTree(), Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed() (+19 more)
...
Cohesion: 0.09
Nodes (29): TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestHumanApprovalGate_AutoApprove(), TestHumanApprovalGate_ManualApprove(), TestHumanApprovalGate_PostPhase(), BuildMonitor() (+21 more)
...
Cohesion: 0.11
Nodes (26): buildGardenerConfig(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass() (+18 more)
...
Cohesion: 0.11
Nodes (24): Block, Category, Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle(), ComposePresetWithTools() (+16 more)
...
Cohesion: 0.15
Nodes (22): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), LogsDir(), MemoryDir(), RegistryDir() (+14 more)
...
Cohesion: 0.19
Nodes (14): FeedbackFile(), buildSchedulerConfig(), endpointsFromCards(), feedbackSnapshotPath(), hostURLOf(), init(), newLocalAgentExecutor(), noMCPMode() (+6 more)
...
- **Why does `Append()` connect `Community 39` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 14`, `Community 15`, `Community 17`, `Community 530`, `Community 18`, `Community 19`, `Community 21`, `Community 531`, `Community 23`, `Community 24`, `Community 25`, `Community 533`, `Community 27`, `Community 534`, `Community 532`, `Community 29`, `Community 31`, `Community 34`, `Community 35`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 557`, `Community 552`, `Community 47`, `Community 559`, `Community 49`, `Community 46`, `Community 45`, `Community 50`, `Community 558`, `Community 52`, `Community 55`, `Community 56`, `Community 57`, `Community 60`, `Community 61`, `Community 62`, `Community 572`, `Community 64`, `Community 577`, `Community 63`, `Community 67`, `Community 574`, `Community 68`, `Community 576`, `Community 65`, `Community 72`, `Community 70`, `Community 74`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 85`, `Community 86`, `Community 87`, `Community 600`, `Community 601`, `Community 93`, `Community 97`, `Community 99`, `Community 612`, `Community 101`, `Community 102`, `Community 105`, `Community 108`, `Community 111`, `Community 112`, `Community 113`, `Community 116`, `Community 117`, `Community 118`, `Community 121`, `Community 122`, `Community 126`, `Community 128`, `Community 130`, `Community 133`, `Community 135`, `Community 138`, `Community 139`, `Community 140`, `Community 141`, `Community 143`, `Community 144`, `Community 146`, `Community 147`, `Community 148`, `Community 149`, `Community 151`, `Community 153`, `Community 158`, `Community 159`, `Community 160`, `Community 162`, `Community 163`, `Community 164`, `Community 165`, `Community 169`, `Community 177`, `Community 178`, `Community 179`, `Community 182`, `Community 183`, `Community 184`, `Community 188`, `Community 189`, `Community 196`, `Community 198`, `Community 732`, `Community 283`, `Community 286`, `Community 296`, `Community 298`, `Community 299`, `Community 300`, `Community 302`, `Community 305`, `Community 307`, `Community 310`, `Community 319`, `Community 320`, `Community 321`, `Community 323`, `Community 409`, `Community 412`, `Community 415`, `Community 417`, `Community 419`, `Community 429`, `Community 430`, `Community 434`, `Community 435`, `Community 439`, `Community 442`?**
  _High betweenness centrality (0.158) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 7` to `Community 0`, `Community 4`, `Community 8`, `Community 139`, `Community 15`, `Community 19`, `Community 21`, `Community 23`, `Community 153`, `Community 25`, `Community 29`, `Community 31`, `Community 34`, `Community 547`, `Community 37`, `Community 297`, `Community 425`, `Community 171`, `Community 45`, `Community 305`, `Community 51`, `Community 71`, `Community 81`, `Community 82`, `Community 117`, `Community 119`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 7` to `Community 133`, `Community 6`, `Community 142`, `Community 145`, `Community 19`, `Community 20`, `Community 21`, `Community 149`, `Community 24`, `Community 29`, `Community 34`, `Community 168`, `Community 425`, `Community 171`, `Community 44`, `Community 56`, `Community 319`, `Community 64`, `Community 79`, `Community 82`, `Community 93`, `Community 94`, `Community 104`, `Community 106`?**
