# Graph Report - superpowers-20260713T145612-10851188-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-13)

## Corpus Check
- 840 files · ~945,664 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20895 nodes · 32249 edges · 1758 communities (1382 shown, 376 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8319 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `857d3386`
...
1. `Append()` - 392 edges
2. `DefaultTree()` - 133 edges
3. `NewRequest()` - 126 edges
4. `NewKnowledgeGraph()` - 120 edges
5. `BuildTree()` - 111 edges
6. `registerMCPTools()` - 102 edges
7. `newDefaultConfig()` - 100 edges
8. `sleep()` - 95 edges
9. `main()` - 77 edges
10. `arc42 Section 9 — Architecture Decisions` - 73 edges
...
## Communities (1758 total, 376 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (137): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+129 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (137): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+129 more)
...
Cohesion: 0.04
Nodes (80): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle(), ComposePreset() (+72 more)
...
Cohesion: 0.07
Nodes (85): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+77 more)
...
Cohesion: 0.05
Nodes (87): Duration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_PruningOnNodeExplosion(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune(), makeRecords() (+79 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (80): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+72 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (80): auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext(), AuditMiddleware() (+72 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (26): Server, AgentMetric, Alert, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts() (+18 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (83): TestEndpointsFromCardsSingleNodeYieldsNoPeers(), biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip(), TestDeadLetterQueue_PreserveCategory() (+75 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (74): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+66 more)
...
Cohesion: 0.07
Nodes (74): main(), TestBlackboard_AllFields(), TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails(), TestRunTask_Success(), TestIntegration_ReflectionAndPersistence(), reflectOnOutcomeAction(), TestReflectOnOutcomeAction_NilLLM() (+66 more)
...
Cohesion: 0.06
Nodes (66): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+58 more)
...
Cohesion: 0.03
Nodes (73): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+65 more)
...
Cohesion: 0.07
Nodes (61): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), saveNlmQuotaExhausted() (+53 more)
...
Cohesion: 0.06
Nodes (56): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection() (+48 more)
...
Cohesion: 0.06
Nodes (36): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype() (+28 more)

### Community 37 - "Community 37"
Cohesion: 0.12
Nodes (50): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+42 more)
...
Cohesion: 0.05
Nodes (37): GateResult, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree(), SnapshotTree() (+29 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (49): AgentBus, AgentEvent, InitAgentBus(), PublishHealthAlert(), PublishServiceDown(), TestAgentBus_AllSubscribersReceiveAll(), TestAgentBus_CloseSubscriberChannelsClosed(), TestAgentBus_ConcurrentPublish() (+41 more)
...
Cohesion: 0.05
Nodes (37): Blackboard, ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+29 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (37): bareApplyScriptRunner, bareSyncRunner, bareTestRun(), TestApplySuperpowersRunBareRepoRefusedFastForwardParksPendingPatch(), TestApplySuperpowersRunBareRepoVerifiesCommitsInWorktreeThenFastForwardsMaster(), TestSyncSuperpowersRepoBareRepoFastForwardsMasterViaFetch(), TestSyncSuperpowersRepoBareRepoFetchesOriginTipBare(), TestSyncSuperpowersRepoBareRepoSurfacesFetchFailure() (+29 more)
...
Cohesion: 0.07
Nodes (38): NewCatalog(), TestCatalog_Export(), TestCatalog_ListInstalled(), TestCatalog_ListTemplates(), TestCatalog_Search(), TestCatalog_SkillToAgent(), TestInferTree(), NewHistory() (+30 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (25): handleSprintExecute(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep() (+17 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (42): Approval, mockOrch, NewWorkflow(), sortTasks(), TestApproval_Fields(), TestApproveTask(), TestExecuteSprint(), TestExecuteSprint_ApprovedToCompleted() (+34 more)

### Community 53 - "Community 53"
Cohesion: 0.07
Nodes (31): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), ApplyHITLPolicy(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID() (+23 more)
...
Cohesion: 0.08
Nodes (36): TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir() (+28 more)
...
Cohesion: 0.07
Nodes (23): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAlertRules(), handleAnalyze(), handleDLQReplay(), handleLogin(), handleLogout() (+15 more)
...
Cohesion: 0.1
Nodes (25): FitnessDimension, TestNSGAIIPopulation_Evolve_ResurrectsExtinctSpecialist(), MultiFitness, MultiIndividual, clampScore(), countActions(), countConditions(), NewMultiFitness() (+17 more)
...
Cohesion: 0.07
Nodes (28): BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), parseChainConfig(), TestChainAction_ParseConfig(), BuildCircuitBreaker(), BuildInverter(), BuildRepeater() (+20 more)
...
Cohesion: 0.12
Nodes (35): defaultGoapReviewDeps(), gatherFailureReviewBody(), gatherReviewContext(), init(), isGoapNotebookLMQuotaError(), loadLastReviewedSHA(), nextNlmQuotaReset(), nlmQuotaExhausted() (+27 more)
...
Cohesion: 0.07
Nodes (34): applyDotEnvFiles(), applyDotEnvToConfig(), applyEnvOverrides(), Load(), LoadDotEnv(), LoadFile(), LoadFileWithDotEnv(), parseBool() (+26 more)

### Community 83 - "Community 83"
Cohesion: 0.08
Nodes (24): auctionAnnouncement(), auctionCandidates(), AuctionDelegate(), betterBid(), candidateContext(), candidateOverride(), cardURL(), NewPersistentAuctioneer() (+16 more)
...
Cohesion: 0.09
Nodes (27): FileJobStore, JobStore, NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad(), TestScheduler_NoJobStore_NilSafe() (+19 more)
...
Cohesion: 0.07
Nodes (35): Binaries, code:go (type Counter struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }) (+27 more)
...
Cohesion: 0.12
Nodes (30): TestChangedPackagesLintCommandMirrorsHookGate(), TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull(), TestBrainstormRejectedWhenFilesNotGoPath(), TestBrainstormRejectedWhenMalformedOrProse(), TestBrainstormRejectedWhenNotDeeper(), TestBrainstormRejectedWhenRunOmitsShort(), withBrainstorm() (+22 more)

### Community 100 - "Community 100"
Cohesion: 0.08
Nodes (26): TestNewReinforcementLearner(), TestQTableSelectUpdateBestAction(), TestQTableStateBucketsAndDepth(), TestReinforcementLearnerLearnAndSuggest(), NewQTable(), NewReinforcementLearner(), TestExpertKnowledge_SeedSpecialistsCarryProvenance(), TestPopulationEvolve_CrisisIntervention() (+18 more)
...
Cohesion: 0.09
Nodes (10): Capability, Edge, evolvedFitness(), blendedSelectionFitness(), coldStartConfidence(), coldStartWeightedFitness(), structuralGate(), KnowledgeGraph (+2 more)
...
Cohesion: 0.09
Nodes (16): cardWithURL(), newAuctionTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoEligibleBidsFallsBack(), TestAuctionDelegate_RequiredTagsFilterCandidates(), TestAuctioneer_RunAuction_AppliesDefaultDispatchDeadline(), TestAuctioneer_RunAuction_BoundsWinnerDispatchWithAnnouncementDeadline() (+8 more)
...
Cohesion: 0.1
Nodes (21): UsersDir(), NewRunDeps(), TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser() (+13 more)
...
Cohesion: 0.14
Nodes (24): agentNameInterceptor, agentNameKey, ScoreAnnouncement(), BTAgentExecutor, cardResponder, parseAnnouncement(), RespondToAnnouncement(), SetTreeResolver() (+16 more)
...
Cohesion: 0.08
Nodes (17): perTreeStats(), TestBenchmarkMockIntegration(), TestMetricsTracker_BestFitnessTracking(), TestMetricsTracker_ImprovementRate(), TestMetricsTracker_LastFitnessTracking(), TestMetricsTracker_RecordAndCyclesForTree(), TestMetricsTracker_SaveAndLoadRoundTrip(), TestMetricsTracker_SaveNewDir() (+9 more)
...
Cohesion: 0.13
Nodes (22): baselineCmd(), baselinePath(), checkCmd(), main(), printUsage(), resetCmd(), showCmd(), BenchmarkResult (+14 more)
...
Cohesion: 0.1
Nodes (17): AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce(), TestAutoRestartEnabled(), TestDriftWatchOnceRestartHandoff() (+9 more)
...
Cohesion: 0.16
Nodes (6): ExperienceBank, acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), cappedCells()
...
Cohesion: 0.2
Nodes (19): NewAuctioneer(), newDeadlineProbeTransport(), TestCollectBids_AppliesDefaultDeadlineWhenAnnouncementHasNone(), TestCollectBids_DerivesPerCandidateDeadlineFromAnnouncement(), TestCollectBids_SurvivesPanickingCandidate(), bidJSON(), newFakeTransport(), TestAuctionDelegate_WinnerCircuitBreakerSurvivesAcrossCallsAndRestarts() (+11 more)
...
Cohesion: 0.18
Nodes (22): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionNoopPatchStreak(), goapFusionRepeatedHashBypassed(), init() (+14 more)
...
Cohesion: 0.14
Nodes (12): NewNSGAIIPopulation(), NewNSGAIISorter(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic(), TestNSGAII_FastNonDominatedSort() (+4 more)
...
Cohesion: 0.11
Nodes (18): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), Outcome, Record, FilterByTreeName() (+10 more)
...
Cohesion: 0.14
Nodes (9): NewFallbackLLM(), TestFallbackLLM_GenerateAllPanicReturnsAggregatedError(), TestFallbackLLM_GenerateRecoversPanicAndTriesNextModel(), TestFallbackLLM_GenerateReturnsAllFailures(), TestFallbackLLM_GenerateUsesNextModelAfterPrimaryFailure(), TestNewProvider_BuildsFallbackChainFromConfiguredModels(), FallbackLLM, NamedLLM (+1 more)
...
Cohesion: 0.13
Nodes (13): NewDocPlanner(), fakeBlackboard, TestValidatePlan(), NewBlackboardBridge(), TestBlackboardBridgeHandlesNilChainStateAndFailure(), TestBlackboardBridgeSyncAndPlanSuccess(), TestBuildGoalFromTaskMultipleKeywordsAndTruncation(), TestDocPlannerAlreadyCompleteReturnsEmptyPlan() (+5 more)

### Community 188 - "Community 188"
Cohesion: 0.12
Nodes (19): collectDiscoverIDs(), TestDiscoverRelated_Bidirectional(), TestDiscoverRelated_ConnectedFrom(), TestDiscoverRelated_ConnectedTo(), TestDiscoverRelated_Deduplicates(), TestDiscoverRelated_EmptyGraph(), TestDiscoverRelated_NonExistentTree(), TestDiscoverRelated_SelfLoopEdge() (+11 more)

### Community 189 - "Community 189"
Cohesion: 0.17
Nodes (19): containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest(), TestRunTask_KnowledgeGap_RoutesToKnowledgePath() (+11 more)
...
Cohesion: 0.13
Nodes (17): claudeBackoffWindow(), TestClaudeBackoffWindow_EnvOverride(), ClaudeRunner, CommandResult, CommandRunner, execClaudeRunner, execCommandRunner, getenvDefault() (+9 more)
...
Cohesion: 0.21
Nodes (17): recordUserFeedback(), registerFeedbackTools(), newFeedbackDeps(), TestBTFeedbackRegistered(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), TestRecordUserFeedback_FeedsSatisfactionAndFlags(), TestRecordUserFeedback_RejectsBadInput(), TestRecordUserFeedback_TrimsUserAndTreeID() (+9 more)
...
Cohesion: 0.15
Nodes (11): main(), NewPageAgent(), TestAgentLLMGeneration(), TestAgentMockFallback(), TestBubbleRecommendation(), NewHandler(), TestHandleBookmark(), TestHandleIntent() (+3 more)
...
Cohesion: 0.18
Nodes (13): Embedding, EmbeddingClient, CosineSimilarity(), TestBuildIndex_PanicRecovered(), TestCosineSimilarity_BothZero(), TestCosineSimilarity_DifferentLengths(), TestCosineSimilarity_Empty(), TestCosineSimilarity_Identical() (+5 more)
...
Cohesion: 0.14
Nodes (17): TestGetStringSlice_Existing(), TestGetStringSlice_MissingKey(), TestGetStringSlice_NilMap(), TestGetStringSlice_WrongType(), TestPlanStepsToStrings(), TestPlanStepsToStrings_Empty(), TestStringField_Exists(), TestStringField_Missing() (+9 more)
...
Cohesion: 0.21
Nodes (13): TestRunOnce_EmitsRunRootSpan(), TestNestedActionSpansParentCorrectly(), TestPanickingActionRestoresTraceContextAndEndsSpan(), TestRegisteredActionEmitsSpan(), TestRegisteredConditionEmitsSpan(), withRecordingGlobalTracer(), NewTracedLLM(), NewTracedLLMWithParent() (+5 more)

### Community 384 - "Community 384"
Cohesion: 0.12
Nodes (9): A2AHandoffBlock(), builtinBlocks(), EvolveOnFailureBlock(), HumanGateBlock(), MemoryLoadBlock(), MemoryWriteBlock(), PlanBlock(), RAGGateBlock() (+1 more)
...
Cohesion: 0.16
Nodes (8): addUniqueError(), sideEffectClass(), walkValidate(), EdgeType, ValidateEdge(), NodeValidationInfo, SerializableNode, TypedEdge
...
Cohesion: 0.14
Nodes (4): GardenerRecommendTool, GardenerRunCycleTool, GardenerStatusTool, truncateStr()
...
Cohesion: 0.22
Nodes (3): Task, NewTaskStore(), TaskStore
...
Cohesion: 0.33
Nodes (7): TestMetricsTracker_CyclesForTree(), TestMetricsTracker_RecordAndSummary(), TestMetricsTracker_SaveAggregatesCrisisAndLastRun(), TestMetricsTracker_SaveIncludesDashboardAggregateFields(), TestRegistry_Count(), TestRegistry_List_AllDomains(), TestRegistry_SaveAndReload()
...
Cohesion: 0.33
Nodes (6): handleAgentExecute(), handleAgentRun(), DefaultAgentTask(), TestDefaultAgentTask(), NewAgentExecutor(), ResolveAgentName()
...
Cohesion: 0.33
Nodes (6): stripInlineComment(), TestStripInlineComment_AlternatingQuotes(), TestStripInlineComment_DoubleQuotedHash(), TestStripInlineComment_NoHash(), TestStripInlineComment_SingleQuotedHash(), TestStripInlineComment_UnquotedHash()
...
Cohesion: 0.7
Nodes (4): bbError(), bbManager(), parseBBScope(), registerBlackboardTools()
...
## Knowledge Gaps
- **6983 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6978 more)
...
- **Why does `Append()` connect `Community 14` to `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 27`, `Community 30`, `Community 33`, `Community 35`, `Community 36`, `Community 37`, `Community 550`, `Community 39`, `Community 40`, `Community 41`, `Community 42`, `Community 547`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 49`, `Community 51`, `Community 52`, `Community 566`, `Community 54`, `Community 569`, `Community 58`, `Community 59`, `Community 57`, `Community 60`, `Community 62`, `Community 575`, `Community 63`, `Community 576`, `Community 66`, `Community 65`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 75`, `Community 76`, `Community 77`, `Community 79`, `Community 80`, `Community 82`, `Community 85`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 100`, `Community 103`, `Community 104`, `Community 107`, `Community 108`, `Community 110`, `Community 112`, `Community 113`, `Community 121`, `Community 122`, `Community 123`, `Community 125`, `Community 128`, `Community 133`, `Community 135`, `Community 137`, `Community 139`, `Community 147`, `Community 152`, `Community 154`, `Community 156`, `Community 164`, `Community 169`, `Community 170`, `Community 173`, `Community 174`, `Community 175`, `Community 179`, `Community 182`, `Community 184`, `Community 185`, `Community 186`, `Community 187`, `Community 190`, `Community 193`, `Community 198`, `Community 200`, `Community 202`, `Community 204`, `Community 207`, `Community 208`, `Community 212`, `Community 215`, `Community 730`, `Community 731`, `Community 225`, `Community 226`, `Community 753`, `Community 755`, `Community 772`, `Community 775`, `Community 781`, `Community 792`, `Community 801`, `Community 825`, `Community 365`, `Community 367`, `Community 368`, `Community 370`, `Community 371`, `Community 380`, `Community 381`, `Community 384`, `Community 385`, `Community 386`, `Community 387`, `Community 395`, `Community 398`, `Community 403`, `Community 405`, `Community 406`, `Community 995`, `Community 1000`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 55` to `Community 130`, `Community 771`, `Community 131`, `Community 5`, `Community 2`, `Community 7`, `Community 9`, `Community 11`, `Community 15`, `Community 18`, `Community 20`, `Community 21`, `Community 150`, `Community 22`, `Community 153`, `Community 33`, `Community 162`, `Community 35`, `Community 164`, `Community 34`, `Community 40`, `Community 50`, `Community 51`, `Community 53`, `Community 183`, `Community 184`, `Community 189`, `Community 203`, `Community 81`, `Community 210`, `Community 86`, `Community 91`, `Community 748`, `Community 109`, `Community 369`, `Community 378`, `Community 126`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 33` to `Community 2`, `Community 5`, `Community 1032`, `Community 9`, `Community 10`, `Community 11`, `Community 138`, `Community 14`, `Community 20`, `Community 406`, `Community 158`, `Community 35`, `Community 36`, `Community 37`, `Community 168`, `Community 173`, `Community 560`, `Community 49`, `Community 50`, `Community 51`, `Community 54`, `Community 55`, `Community 56`, `Community 62`, `Community 71`, `Community 204`, `Community 1100`, `Community 80`, `Community 209`, `Community 210`, `Community 211`, `Community 722`, `Community 91`, `Community 100`, `Community 108`, `Community 109`, `Community 112`?**
...
- **Are the 132 inferred relationships involving `DefaultTree()` (e.g. with `TestFullTreeIntegration_RunsAllTreesWithRealLLM()` and `TestDomainTree_Registration()`) actually correct?**
  _`DefaultTree()` has 132 INFERRED edges - model-reasoned connections that need verification._
- **Are the 125 inferred relationships involving `NewRequest()` (e.g. with `TestHITLHandlers_PendingApproveReject()` and `WorkflowApprovalWait()`) actually correct?**
  _`NewRequest()` has 125 INFERRED edges - model-reasoned connections that need verification._