# Graph Report - superpowers-20260715T103226-9a21d49e-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-15)

## Corpus Check
- 858 files · ~1,020,947 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22710 nodes · 34528 edges · 1836 communities (1485 shown, 351 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8669 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c953ca9b`
...
1. `Append()` - 392 edges
2. `DefaultTree()` - 145 edges
3. `NewRequest()` - 134 edges
4. `NewKnowledgeGraph()` - 130 edges
5. `registerMCPTools()` - 116 edges
6. `BuildTree()` - 111 edges
7. `arc42 Section 9 — Architecture Decisions` - 110 edges
...
## Communities (1836 total, 351 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (163): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+155 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (163): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+155 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (125): main(), TestBlackboard_AllFields(), TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails(), TestRunTask_KnowledgeGap_RoutesToKnowledgePath(), TestRunTask_Success(), TestIntegration_ReflectionAndPersistence(), reflectOnOutcomeAction() (+117 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (102): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+94 more)
...
Cohesion: 0.03
Nodes (113): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+105 more)
...
Cohesion: 0.02
Nodes (110): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+102 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (39): AgentMetric, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON() (+31 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (100): TestEndpointsFromCardsSingleNodeYieldsNoPeers(), TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailure_BackwardCompat(), TestCircuitBreaker_RecordFailureWithCategory(), TestDeadLetterQueue_AutoClassify() (+92 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (89): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_New(), TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents(), TestBuildFromArchetype() (+81 more)
...
Cohesion: 0.05
Nodes (88): truncateGoap(), arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), collapseToSingleLine() (+80 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (72): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle(), ComposePreset() (+64 more)

### Community 16 - "Community 16"
Cohesion: 0.08
Nodes (80): AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks(), section12Glossary() (+72 more)
...
Cohesion: 0.05
Nodes (72): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes() (+64 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (78): TestDeprecatedHandler_NoSunset(), TestDeprecatedHandler_WithSunsetDate(), DeprecatedHandler(), TestDeprecatedHandler_WithoutSunset(), TestDeprecatedHandler_WithSunset(), handleLogin(), handleLogout(), NewRequest() (+70 more)
...
Cohesion: 0.06
Nodes (70): Duration(), TestDuration(), TestIntegration_AllChainTypes(), TestIntegration_EdgeCases(), TestIntegration_MutationOperators(), TestIntegration_PanicRecovery(), TestIntegration_QualityGatesFullFlow(), TestTranspositionTable_SaveLoadRoundTrip() (+62 more)
...
Cohesion: 0.07
Nodes (44): isolateGoapProgramStore(), TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath(), TestDiscardWorktree_RemovesWorktreeAndDeletesBranch(), TestPushBranchAndCreatePR_InvokesGitPushAndGhPr(), withSwappedSuperpowersRunners() (+36 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (41): Blackboard, ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+33 more)
...
Cohesion: 0.15
Nodes (44): TestDomainTree_Registration(), TestFullTreeIntegration_RunsAllTreesWithRealLLM(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Finance() (+36 more)

### Community 53 - "Community 53"
Cohesion: 0.08
Nodes (42): ArraySchema(), BoolSchema(), IntSchema(), ObjectSchema(), TestConvenienceSchemaConstructors(), TestRouteBuilder_FluentAPI(), findResponse(), ResponseValidator() (+34 more)
...
Cohesion: 0.08
Nodes (44): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), TestIsGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation() (+36 more)
...
Cohesion: 0.08
Nodes (32): growthFitness(), FitnessDimension, MultiFitness, MultiIndividual, cappedIndividuals(), clampScore(), countActions(), countConditions() (+24 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (31): ApplyJitter(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), FullJitter(), TestApplyJitter_AllStrategiesDeterministicRange(), TestApplyJitter_Decorrelated(), TestApplyJitter_EqualJitter() (+23 more)
...
Cohesion: 0.07
Nodes (33): TestOutcomeErrorDetail(), FeedbackFile(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath() (+25 more)
...
Cohesion: 0.1
Nodes (37): containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest(), truncate() (+29 more)
...
Cohesion: 0.1
Nodes (35): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir(), MemoryDir() (+27 more)

### Community 65 - "Community 65"
Cohesion: 0.09
Nodes (38): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad() (+30 more)
...
Cohesion: 0.11
Nodes (42): TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestRouteBuilder_Build(), TestRouteBuilder_SunsetDate(), TestSchemaToMap_Format(), NewOpenAPIGenerator() (+34 more)
...
Cohesion: 0.06
Nodes (24): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, TestHasChildNamed_DeepNested(), TestHasChildNamed_Found() (+16 more)
...
Cohesion: 0.07
Nodes (29): Block, TestComposeAndExpand(), Category, ComposeSpec, TestExpand_BlockMetadata(), Expand(), expandNode(), HasSubTreeRefs() (+21 more)
...
Cohesion: 0.07
Nodes (32): GetErrorContext(), NewErrorContext(), TestErrorContext_Concurrent(), TestErrorContext_Error(), TestErrorContext_Error_Minimal(), TestErrorContext_Integration_RetryPolicy(), TestErrorContext_Summary_Full(), TestErrorContext_Summary_NoOperation() (+24 more)
...
Cohesion: 0.08
Nodes (26): main(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, NewRateLimiter() (+18 more)
...
Cohesion: 0.12
Nodes (30): TestConsoleTracer_ExporterReceivesCompletedSpan(), TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest(), TestTracingMiddleware_StatusCodes() (+22 more)
...
Cohesion: 0.09
Nodes (23): TestMatchBlockPattern(), AntiPattern, DesignPattern, TestExpert_MatchPattern(), BlockIDFromRef(), containsStr(), coreHeuristics(), hasNodeMatching() (+15 more)
...
Cohesion: 0.13
Nodes (30): NewAgent(), TestAutomationActions_ReachTaskAutomated(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory(), TestAgentNoPlan() (+22 more)
...
Cohesion: 0.1
Nodes (18): TestGardenerRollbackTool_CallRestoresSnapshot(), GateResult, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree() (+10 more)

### Community 129 - "Community 129"
Cohesion: 0.13
Nodes (14): extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), collectNodeNames(), containsCrisisReason(), Crossover(), ExperienceRetrievalHits() (+6 more)
...
Cohesion: 0.1
Nodes (29): fakeTracer, AlwaysSample(), hashTraceID(), NeverSample(), NewRatioSampler(), TestAlwaysSample(), TestConsoleTracer_ChildSpansNotSampled(), TestConsoleTracer_EndIdempotency() (+21 more)
...
Cohesion: 0.13
Nodes (21): collectSelectorNames(), SelectorStatsFile(), TestLocalSearcher_New(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb() (+13 more)
...
Cohesion: 0.09
Nodes (26): Binaries, code:go (type Counter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), code:go (type AgentCard struct { Name, Description, URL string }), code:go (type PlatformEvalResult struct { ... }), code:go (type BaselineStore struct { ... }) (+18 more)
...
Cohesion: 0.08
Nodes (7): EvolveTool, FitnessTool, GetReflectionsTool, GetTreeTool, ReflectTool, RunTaskTool, truncateStr()
...
Cohesion: 0.09
Nodes (13): builtinBlocks(), DelegateBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), HumanReviewBlock(), HITLTieredBlock(), MemoryLoadBlock() (+5 more)

### Community 174 - "Community 174"
Cohesion: 0.15
Nodes (18): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), wireSelectorOrdering(), routerChildNames(), seedSelectorStats() (+10 more)
...
Cohesion: 0.09
Nodes (7): GardenerDeactivateAllTool, GardenerRecommendTool, GardenerRollbackTool, GardenerRunCycleTool, GardenerStatusTool, newGardenerRunCycleTool(), truncateStr()
...
Cohesion: 0.15
Nodes (7): DashboardRoutes(), TestDashboardRoutes_AgentsExecuteHasRequestBody(), TestDashboardRoutes_AllHaveOperationIDs(), TestDashboardRoutes_AllRoutesBuildWithoutPanic(), TestDashboardRoutes_AuthConsistency(), TestDashboardRoutes_GeneratesValidSpec(), RouteBuilder
...
Cohesion: 0.18
Nodes (16): NewEvolvedAgent(), TestCreateAgentTool_Call_NilFactory(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestGetTreeTool_Call_NoTree(), TestGetTreeTool_Call_WithTree(), TestNewEvolvedAgent_MinimalConfig(), TestNewEvolvedAgent_NilBlackboard() (+8 more)
...
Cohesion: 0.22
Nodes (16): saveRecordWithDelay(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolveTool_Call_NotEnoughFailures(), TestEvolveTool_Call_NoTree(), TestEvolveTool_Call_Success(), TestFitnessTool_Call(), TestFitnessTool_Call_NoData(), TestGetReflectionsTool_Call_NoRecords() (+8 more)
...
Cohesion: 0.14
Nodes (14): code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), Package: evaluator (+6 more)
...
Cohesion: 0.25
Nodes (6): TestConfig_AllFields(), TestEvolvedAgent_StructFields(), TestNewEvolvedAgent_AllToolsRegistered(), newConfig(), TestNewEvolvedAgent(), mockModel
...
## Knowledge Gaps
- **8089 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8084 more)
...
- **Why does `Append()` connect `Community 9` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 10`, `Community 12`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 25`, `Community 26`, `Community 28`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 39`, `Community 41`, `Community 44`, `Community 45`, `Community 50`, `Community 51`, `Community 52`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 1085`, `Community 61`, `Community 64`, `Community 1090`, `Community 67`, `Community 66`, `Community 68`, `Community 70`, `Community 71`, `Community 75`, `Community 76`, `Community 77`, `Community 79`, `Community 80`, `Community 593`, `Community 81`, `Community 595`, `Community 84`, `Community 85`, `Community 86`, `Community 82`, `Community 88`, `Community 89`, `Community 594`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 602`, `Community 608`, `Community 96`, `Community 609`, `Community 98`, `Community 604`, `Community 605`, `Community 616`, `Community 106`, `Community 107`, `Community 108`, `Community 110`, `Community 111`, `Community 114`, `Community 629`, `Community 117`, `Community 119`, `Community 632`, `Community 121`, `Community 122`, `Community 638`, `Community 129`, `Community 132`, `Community 135`, `Community 137`, `Community 139`, `Community 142`, `Community 143`, `Community 145`, `Community 157`, `Community 158`, `Community 159`, `Community 160`, `Community 161`, `Community 172`, `Community 173`, `Community 176`, `Community 177`, `Community 178`, `Community 179`, `Community 186`, `Community 187`, `Community 190`, `Community 191`, `Community 192`, `Community 196`, `Community 197`, `Community 198`, `Community 200`, `Community 202`, `Community 203`, `Community 204`, `Community 207`, `Community 208`, `Community 210`, `Community 217`, `Community 219`, `Community 805`, `Community 814`, `Community 850`, `Community 856`, `Community 857`, `Community 864`, `Community 876`, `Community 385`, `Community 386`, `Community 388`, `Community 389`, `Community 390`, `Community 396`, `Community 400`, `Community 402`, `Community 403`, `Community 410`, `Community 418`, `Community 427`, `Community 87`, `Community 601`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 20` to `Community 129`, `Community 3`, `Community 4`, `Community 132`, `Community 391`, `Community 9`, `Community 138`, `Community 11`, `Community 15`, `Community 16`, `Community 404`, `Community 23`, `Community 152`, `Community 25`, `Community 39`, `Community 1191`, `Community 45`, `Community 52`, `Community 56`, `Community 57`, `Community 184`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 189`, `Community 70`, `Community 212`, `Community 213`, `Community 102`, `Community 119`, `Community 122`, `Community 636`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 60` to `Community 2`, `Community 3`, `Community 133`, `Community 392`, `Community 10`, `Community 11`, `Community 15`, `Community 16`, `Community 17`, `Community 20`, `Community 23`, `Community 25`, `Community 155`, `Community 415`, `Community 32`, `Community 39`, `Community 40`, `Community 41`, `Community 42`, `Community 56`, `Community 58`, `Community 62`, `Community 64`, `Community 65`, `Community 193`, `Community 199`, `Community 200`, `Community 73`, `Community 204`, `Community 849`, `Community 212`, `Community 101`, `Community 111`, `Community 891`?**
...
- **Are the 144 inferred relationships involving `DefaultTree()` (e.g. with `TestFullTreeIntegration_RunsAllTreesWithRealLLM()` and `TestDomainTree_Registration()`) actually correct?**
  _`DefaultTree()` has 144 INFERRED edges - model-reasoned connections that need verification._
