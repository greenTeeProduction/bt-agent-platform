# Graph Report - superpowers-20260717T165040-51bce651-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-17)

## Corpus Check
- 895 files · ~1,147,005 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25958 nodes · 38684 edges · 2028 communities (1666 shown, 362 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9253 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ff77d7aa`
...
## Communities (2028 total, 362 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (203): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+195 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (203): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+195 more)
...
Cohesion: 0.03
Nodes (117): TestComputeAnalytics_BottleneckCarriesStructuredFailure(), TestComputeAnalytics_Bottlenecks(), TestComputeAnalytics_BottleneckWithoutTraceHasEmptyFailure(), TestComputeAnalytics_BottleneckWithTrace(), TestComputeAnalytics_Centrality(), TestComputeAnalytics_CoverageGapsUseExpectedDomains(), TestComputeAnalytics_EmptyGraph(), TestComputeAnalytics_ExtendedEdges() (+109 more)
...
Cohesion: 0.03
Nodes (111): TestCheckConfidence_ConditionExists(), TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch() (+103 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (97): expandChainStateTemplates(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM(), TestChainAction_Agent_NoTools() (+89 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (107): LoadPipeline(), RunPipeline(), RunPipelineWithID(), blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu() (+99 more)
...
Cohesion: 0.04
Nodes (97): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard() (+89 more)
...
Cohesion: 0.04
Nodes (82): OpenAPIGenerator, Append(), mockTTOrch, brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID() (+74 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (97): handleLogin(), handleLogout(), DefaultPanicHandler(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter (+89 more)

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (87): AlertRouterTree(), Arc42DocsyncTree(), TestArc42DocsyncTreeRegistered(), TestArc42DocsyncTreeShape(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain() (+79 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (68): TestRunPipelineWithID_RecordsAgentMetrics(), newAgentExecutor(), agentExecuteResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute() (+60 more)
...
Cohesion: 0.05
Nodes (88): Duration(), TestTranspositionTable_SaveLoadRoundTrip(), TestTranspositionTable_Store_EvictionPreservesLowestAmongSurvivors(), TestTranspositionTable_Store_EvictsLowestValueDeterministically(), TestTranspositionTable_Store_EvictsLowestValueRepeated(), TestTranspositionTable_StoreProbeMiss(), TestTranspositionTable_StoreProbeRoundTrip(), countTreeNodes() (+80 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (84): arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), completeGoapProgramMilestone(), extractGoapProgram() (+76 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (85): DefaultLLM(), RealLLM(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), EvaluateBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic() (+77 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (75): alwaysSampler, Attr, ConsoleTracer, TestConsoleTracer_ExporterReceivesCompletedSpan(), fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport() (+67 more)
...
Cohesion: 0.05
Nodes (83): TestEndpointsFromCardsSingleNodeYieldsNoPeers(), TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestMultiNode_ScalabilityStatusRouterReporting(), NewAgentRouter(), NewDeadLetterQueue(), NewLocalExecutor(), NewRouterFromEndpoints() (+75 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (68): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), Category, composeOrderedWithMiddle() (+60 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (62): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), ComposeTaskTreeAgentic() (+54 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (62): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+54 more)
...
Cohesion: 0.04
Nodes (51): TestOutcomeErrorDetail(), RunDeps, applyOutcomeRefinement(), IsHealthyOutcome(), OutcomeErrorDetail(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome(), RunOptions (+43 more)
...
Cohesion: 0.07
Nodes (65): buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), registerSuperpowersProductionActions(), titleSuperpowersVerb() (+57 more)
...
Cohesion: 0.05
Nodes (35): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports(), TestValidateQualitySpec_BlockedPattern() (+27 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (58): AgentBus, AgentEvent, InitAgentBus(), PublishHealthAlert(), PublishServiceDown(), TestAgentBus_AllSubscribersReceiveAll(), TestAgentBus_CloseSubscriberChannelsClosed(), TestAgentBus_ConcurrentPublish() (+50 more)
...
Cohesion: 0.06
Nodes (52): TestCompiledPlanTree_ValidatesAndRuns(), NewAgent(), NewDocPlanner(), TestAutomationActions_ReachTaskAutomated(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState() (+44 more)
...
Cohesion: 0.05
Nodes (36): main(), main(), attachLogHandler(), buildBaseHandler(), buildLogger(), Debug(), envLogLevel(), Error() (+28 more)
...
Cohesion: 0.07
Nodes (49): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), saveNlmQuotaExhausted(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField() (+41 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (41): BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir() (+33 more)
...
Cohesion: 0.07
Nodes (33): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, Histogram, LabeledCounter, LabeledGauge (+25 more)
...
Cohesion: 0.06
Nodes (34): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), ApplyHITLPolicy(), countTreeNodes(), TestSuperpowersPipelineSimulation() (+26 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (26): References, goapFusionImplementationGateWired(), goapFusionPreflightWired(), PrependGoapFusionImplementationGate(), PrependGoapFusionPreflight(), spliceGoapFusionStateHashProducer(), WireGoapFusionLoopTree(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedDelegatesOnBareRepo() (+18 more)
...
Cohesion: 0.06
Nodes (29): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), BuildCircuitBreaker(), BuildInverter(), BuildRepeater() (+21 more)
...
Cohesion: 0.11
Nodes (36): gitOutput(), TestNoCommittedRootBinaries(), isGoapNotebookLMFailure(), recentImplementedGoals(), TestRecentImplementedGoalsReadsStore(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor() (+28 more)
...
Cohesion: 0.17
Nodes (33): NewConfigWatcher(), TestConfigWatcher_BackwardCompatibleNoDotEnv(), TestConfigWatcher_ConfigChangeWithDotEnv(), TestConfigWatcher_DotEnvChangeDoesNotTriggerOnNoChange(), TestConfigWatcher_DotEnvFileDisappears(), TestConfigWatcher_DotEnvHotReload(), TestConfigWatcher_DotEnvPriorityChain(), TestConfigWatcher_FileAppears() (+25 more)
...
Cohesion: 0.1
Nodes (24): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), TestFusionAnalysis_RateLimitCarryoverNotConflatedAsDegradation(), scopeGoapGoalLine(), TestCurrentSuperpowersRunRefusesFinishedRun(), TestScopeGoapGoalLineAppendsGrepMatches() (+16 more)
...
Cohesion: 0.13
Nodes (29): growthFitness(), FitnessDimension, TestNSGAII_Evolve_Basic(), MultiIndividual, clampScore(), countActions(), countConditions(), NewMultiFitness() (+21 more)
...
Cohesion: 0.13
Nodes (25): buildRunActivitySummary(), fencedItems(), isFactLine(), joinCapped(), salientOutputLines(), TestBuildRunActivitySummaryCapsLongFencedLists(), TestBuildRunActivitySummaryEmptyEverything(), TestBuildRunActivitySummaryFailureLeadsWithReason() (+17 more)

### Community 148 - "Community 148"
Cohesion: 0.12
Nodes (19): Warn(), biasCandidatesWithExperience(), cloneMetadataForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask(), TestExtractDomain(), TestHashTreeForGardener() (+11 more)
...
Cohesion: 0.07
Nodes (7): TestActionForName_BulkCoverage(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), Recover(), TestRecover_CatchesPanic(), TestRecover_NoPanic(), PanicHandler
...
Cohesion: 0.14
Nodes (20): convertGoapChildren(), FromGoapNode(), GOAPDevOpsTree(), GOAPPlanningTree(), GOAPResearchTree(), Blackboard, BlackboardBridge, BTNodeType (+12 more)
...
Cohesion: 0.15
Nodes (23): TestMutation_TargetNotFound(), TestMutation_WrapRetry(), applyAddAfter(), applyAddBefore(), applyAddFallback(), applyAddTool(), applyImprovePrompt(), applyIncreaseIterations() (+15 more)
...
Cohesion: 0.12
Nodes (23): handleAgentsList(), AgentHistoryEntry, AgentInfo, agentStatus(), CreateAgent(), DefaultAgentTask(), ListAgents(), ListAgentsWithCB() (+15 more)
...
Cohesion: 0.09
Nodes (13): A2AHandoffBlock(), builtinBlocks(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), HumanGateBlock() (+5 more)
...
Cohesion: 0.26
Nodes (22): TestClaudeErrorHandler_DoesNotClobberExistingCategory(), requestErrorHandlerProposal(), swapErrorHandlerRunner(), TestRequestErrorHandlerProposal_RespectsCallerContext(), TestRequestErrorHandlerProposal_StampsLedgerOnEveryOutcome(), ehTestHandlerNode(), ehTestProposalJSON(), runHandler() (+14 more)

### Community 203 - "Community 203"
Cohesion: 0.16
Nodes (17): toast(), apiFetch(), getCookie(), approveHITL(), approveTask(), executeSprint(), pollSprintStatus(), refreshHITL() (+9 more)
...
Cohesion: 0.16
Nodes (19): IsKnownChainKind(), parseChainConfig(), TestChainAction_ParseConfig(), TestIsKnownChainKind(), asFloat(), compiledGoapActionFor(), compiledGoapConditionFor(), goapValuesEqual() (+11 more)
...
Cohesion: 0.12
Nodes (16): code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {) (+8 more)
...
Cohesion: 0.24
Nodes (11): Alert, Alert, cbIcon(), createAgent(), deleteAgent(), loadAgents(), populateTreeDropdown(), renderAgents() (+3 more)
...
## Knowledge Gaps
- **10047 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+10042 more)
...
- **Why does `Append()` connect `Community 14` to `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 33`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 51`, `Community 55`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 70`, `Community 71`, `Community 73`, `Community 76`, `Community 77`, `Community 79`, `Community 80`, `Community 82`, `Community 85`, `Community 87`, `Community 88`, `Community 89`, `Community 92`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 99`, `Community 100`, `Community 102`, `Community 105`, `Community 106`, `Community 108`, `Community 109`, `Community 111`, `Community 113`, `Community 120`, `Community 127`, `Community 128`, `Community 129`, `Community 131`, `Community 133`, `Community 137`, `Community 138`, `Community 144`, `Community 146`, `Community 147`, `Community 148`, `Community 149`, `Community 154`, `Community 156`, `Community 672`, `Community 673`, `Community 161`, `Community 165`, `Community 677`, `Community 167`, `Community 168`, `Community 681`, `Community 170`, `Community 173`, `Community 175`, `Community 176`, `Community 689`, `Community 178`, `Community 179`, `Community 692`, `Community 688`, `Community 184`, `Community 696`, `Community 702`, `Community 193`, `Community 194`, `Community 705`, `Community 199`, `Community 201`, `Community 205`, `Community 207`, `Community 208`, `Community 210`, `Community 211`, `Community 215`, `Community 216`, `Community 217`, `Community 219`, `Community 221`, `Community 1281`, `Community 917`, `Community 927`, `Community 426`, `Community 939`, `Community 938`, `Community 941`, `Community 430`, `Community 431`, `Community 441`, `Community 443`, `Community 444`, `Community 446`, `Community 447`, `Community 453`, `Community 966`, `Community 455`, `Community 968`, `Community 965`, `Community 457`, `Community 967`, `Community 974`, `Community 975`, `Community 465`, `Community 986`, `Community 1006`, `Community 1010`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 31` to `Community 3`, `Community 7`, `Community 8`, `Community 13`, `Community 16`, `Community 17`, `Community 19`, `Community 148`, `Community 20`, `Community 23`, `Community 25`, `Community 27`, `Community 28`, `Community 42`, `Community 428`, `Community 44`, `Community 47`, `Community 943`, `Community 55`, `Community 183`, `Community 57`, `Community 56`, `Community 59`, `Community 62`, `Community 446`, `Community 66`, `Community 68`, `Community 205`, `Community 207`, `Community 83`, `Community 86`, `Community 101`, `Community 1009`, `Community 115`, `Community 121`, `Community 126`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 17` to `Community 129`, `Community 130`, `Community 3`, `Community 132`, `Community 13`, `Community 143`, `Community 15`, `Community 148`, `Community 23`, `Community 25`, `Community 27`, `Community 36`, `Community 38`, `Community 169`, `Community 42`, `Community 176`, `Community 178`, `Community 55`, `Community 183`, `Community 61`, `Community 62`, `Community 446`, `Community 66`, `Community 68`, `Community 205`, `Community 82`, `Community 101`, `Community 103`, `Community 105`, `Community 115`?**
