# Graph Report - superpowers-20260718T112447-2cd90354-goap-fusion-loop-runner-blackboard-conte  (2026-07-18)

## Corpus Check
- 918 files · ~1,204,764 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27224 nodes · 40361 edges · 2138 communities (1777 shown, 361 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9535 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cffdc02d`
...
## Communities (2138 total, 361 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (220): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+212 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (220): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+212 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (166): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+158 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (119): main(), TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch() (+111 more)
...
Cohesion: 0.03
Nodes (91): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+83 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (101): NewStore(), TestRecord_JSONRoundTrip(), TestStore_AutoTaskID(), TestStore_CountFailures_Empty(), TestStore_MultipleRecords(), TestStore_NonExistentDir(), TestStore_RecentFailures(), TestStore_SaveAndLoad() (+93 more)
...
Cohesion: 0.03
Nodes (29): AgentMetric, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON() (+21 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (85): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Block, TestComposeAndExpand(), Category, Compose(), ComposeFromRefs(), ComposeTaskTree() (+77 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (91): main(), run(), evidenceVerificationReport, defaultStorageDir(), encodeJSON(), main(), run(), contains() (+83 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (95): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), buildClaudeReviewPrompt() (+87 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (88): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42DocsyncTree(), TestArc42DocsyncTreeRegistered(), TestArc42DocsyncTreeShape(), Arc42SeederTree(), Arc42Trees(), assembleDoc() (+80 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (90): ctxAwareBlockingRunner, classifyErrorHandlerFailure(), goapFailureCategory(), isGoapFusionCycle(), init(), TestClassifyErrorHandlerFailure(), TestClassifyReliabilityFallback(), TestClaudeErrorHandler_ClassifiesUnclassifiedFailure() (+82 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (88): handleLogin(), handleLogout(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey (+80 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (85): arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), collapseToSingleLine(), completeGoapProgramMilestone() (+77 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (70): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+62 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (87): TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip(), TestDeadLetterQueue_PreserveCategory() (+79 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (81): TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestBuildChainActionFn_LlmCallNilLLM(), TestBuildChainActionFn_UnknownChainType(), TestComputeSubtreeMetrics_MixedChildren(), TestComputeSubtreeMetrics_NilInput() (+73 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (79): DefaultLLM(), RealLLM(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), EvaluateBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic() (+71 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (80): dataFileMetrics(), extractExistingDataPath(), init(), inspectDataSource(), registerDomainActions(), ChainConfig, availableToolNames(), bbRunID() (+72 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (75): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+67 more)
...
Cohesion: 0.06
Nodes (76): TestScoreChild_GoalAlignmentBranch(), TestScoreChild_NilChainState(), TestScoreChildren_BasicRanking(), ParallelMode, intSliceFromInterface(), BuildReactiveParallel(), childPanicHandler(), forkBlackboard() (+68 more)
...
Cohesion: 0.06
Nodes (69): echoTaskLeaf, islandArchivePath(), persistEvolvedWinner(), registerMCPTools(), assertExpertArchiveFedFromRun(), injectSelectorProbeTree(), seedSelectorProbeStats(), TestBTDelegateToTreeHoldsBBMu() (+61 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (45): newAgentExecutor(), agentExecuteResult(), dashboardLocalAgentResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute() (+37 more)
...
Cohesion: 0.03
Nodes (38): cacheCheckAction(), cacheResultAction(), execLLMCallAction(), execRefineAction(), generatePlanAction(), NewEngine(), RegisterProviders(), TestCacheCheckAction_Empty() (+30 more)
...
Cohesion: 0.04
Nodes (57): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+49 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (41): Config, TestBaseNodeCount(), TestGetRetryCount(), TestIsNodeWrapped(), CycleMetrics, cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain() (+33 more)
...
Cohesion: 0.04
Nodes (22): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, ConcurrencyLimiter, DeadLetterEntry, DeadLetterQueue, executorFailureState (+14 more)
...
Cohesion: 0.06
Nodes (52): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, scriptedClaudeRunner, scriptedSuperpowersRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo() (+44 more)
...
Cohesion: 0.06
Nodes (55): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_New(), TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents(), TestBuildFromArchetype() (+47 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (35): TestGoalFactory(), errTest, errToString(), NewHealthMonitor(), TestHealthMonitorDegradationError(), TestHealthMonitorNilSafety(), TestHealthMonitorProbe(), TestHealthMonitorProbeFailure() (+27 more)
...
Cohesion: 0.05
Nodes (46): NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation(), TestCrisisDetector_DetectPopulation_DiversityCollapse() (+38 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (47): ConnPool, NewConnPool(), NewSharedConnPool(), TestAgentRouter_PooledExecutors_LeastConnections(), TestAgentRouter_WithSharedPool(), TestConnPool_Close(), TestConnPool_CloseIdleConnections(), TestConnPool_CustomConfig() (+39 more)
...
Cohesion: 0.04
Nodes (27): findChildByName(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords(), TestContainsAnyLower_NoKeywords(), TestContainsAnyLower_NoMatch(), TestContainsAnyLower_Substring() (+19 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (45): ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure(), TestValidateOutputQualityRejectsRefusals() (+37 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (36): TestBuildPlannerNode_ChainStateGoals(), TestReadGoals_ChainStateFallback(), TestReadGoals_InvalidItemInList(), TestReadGoals_NonListMetadata(), TestReadGoals_Preconditions(), GoalDefinition, GOAPAction, GOAPGoal (+28 more)
...
Cohesion: 0.06
Nodes (31): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_FeedbackPersistenceArmed(), TestBuildGardenerConfig_KnowledgeGraphWired(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired() (+23 more)
...
Cohesion: 0.07
Nodes (41): handleFellows(), handleWorkflowRunFullPipeline(), TestHandleWorkflowRunFullPipeline_PersistsWorkflowAndTasks(), NewMockLLM(), NewDefaultCompany(), CompanyState, Decision, QuarterResult (+33 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (40): min(), brokenTool, ChainKind, BuildChainAction(), buildChainActionFn(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState() (+32 more)

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (36): Config, Duration(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes() (+28 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (35): convertGoapChildren(), FromGoapNode(), GOAPDevOpsTree(), GOAPPlanningTree(), GOAPResearchTree(), Blackboard, BlackboardBridge, BTNodeType (+27 more)
...
Cohesion: 0.05
Nodes (36): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), BuildCircuitBreaker(), BuildInverter(), BuildRepeater() (+28 more)
...
Cohesion: 0.16
Nodes (43): TestDomainTree_Registration(), TestFullTreeIntegration_RunsAllTreesWithRealLLM(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Research() (+35 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (41): ArraySchema(), BoolSchema(), IntSchema(), ObjectSchema(), TestConvenienceSchemaConstructors(), findResponse(), ResponseValidator(), TestResponseValidator_DriftLogging() (+33 more)

### Community 63 - "Community 63"
Cohesion: 0.09
Nodes (44): CompressionMiddleware(), gzipDecompress(), TestCompressionMiddleware_AlreadyCompressed(), TestCompressionMiddleware_BinaryContentType(), TestCompressionMiddleware_EmptyBody(), TestCompressionMiddleware_GzipRequest(), TestCompressionMiddleware_HTMLContentType(), TestCompressionMiddleware_LargeJSONResponse() (+36 more)
...
Cohesion: 0.1
Nodes (36): newThrottleTestServer(), taskCompleteEvent(), TestFailureAndDegradedOutcomesNeverThrottled(), TestRoutineNoChangeHeartbeatAfterQuietDay(), TestRoutineNoChangeNotificationsThrottledAfterBaseline(), TestThrottleStatePersistsAcrossPublisherRestarts(), panickyPayload, throttleTestServer (+28 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (39): EvolveTool, TestCheckConfidence_ConditionExists(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure() (+31 more)
...
Cohesion: 0.07
Nodes (37): Analysis, Contradiction, CoveragePoint, fakeCaller, fakeTool, flakyCaller, TestJudge_ParsesStructuredJSON(), TestJudge_RejectsInvalidJSON() (+29 more)

### Community 70 - "Community 70"
Cohesion: 0.07
Nodes (35): containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest(), TestRunTask_CacheHit() (+27 more)
...
Cohesion: 0.07
Nodes (23): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), pipelineMockLLM, ApplyHITLPolicy(), countTreeNodes() (+15 more)

### Community 75 - "Community 75"
Cohesion: 0.08
Nodes (37): distributedDispatch, appendDispatchErr(), driveDistributedDispatch(), main(), parseNodes(), run(), multiNodeReport, TestMultiNode_ProbeFailsOnEmptyNodeURL() (+29 more)

### Community 76 - "Community 76"
Cohesion: 0.1
Nodes (40): growthFitness(), FitnessDimension, makeTestTree(), NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance() (+32 more)

### Community 77 - "Community 77"
Cohesion: 0.08
Nodes (26): BTOptimizer, TestBTOptimizer_New(), collectSelectorChildConditions(), collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestExtractCondition() (+18 more)

### Community 79 - "Community 79"
Cohesion: 0.06
Nodes (34): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM() (+26 more)
...
Cohesion: 0.1
Nodes (25): AuctionDelegate(), cardWithURL(), newAuctionTransport(), newDeadlineProbeTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_DispatchRetryExhaustedFallsBack(), TestAuctionDelegate_NoCandidatesFallsBack() (+17 more)
...
Cohesion: 0.09
Nodes (34): ShellExec(), splitPipeline(), TestFileRead_EmptyFile(), TestFileRead_Success(), TestFileRead_Truncated(), TestShellExec_Failure(), TestShellExec_NoOutput(), TestShellExec_StderrOnly() (+26 more)

### Community 97 - "Community 97"
Cohesion: 0.06
Nodes (20): builtinBlocks(), TestBuiltinBlocks_Count(), TestBuiltinBlocks_UniqueNonEmptyIDs(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock() (+12 more)

### Community 98 - "Community 98"
Cohesion: 0.07
Nodes (25): BuildTaskFromInputs(), ParseInputParams(), TestBuildTaskFromInputs(), TestParseInputParams(), TestValidateInputs_Default(), TestValidateInputs_File(), TestValidateInputs_JSON(), TestValidateInputs_Required() (+17 more)
...
Cohesion: 0.1
Nodes (28): GateResult, TestQualityGateFloorOn100Scale(), ListRevisions(), loadSnapshotIndex(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass() (+20 more)
...
Cohesion: 0.1
Nodes (34): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionNoopPatchStreak(), goapFusionPreflightWired() (+26 more)

### Community 111 - "Community 111"
Cohesion: 0.08
Nodes (24): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce() (+16 more)
...
Cohesion: 0.08
Nodes (34): Binaries, code:go (type Counter struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string) (+26 more)
...
Cohesion: 0.14
Nodes (30): ScoreAnnouncement(), cardResponder, rpcRequest, rpcResponse, RespondToAnnouncement(), SetTreeResolver(), bidArtifact(), drainExecute() (+22 more)

### Community 123 - "Community 123"
Cohesion: 0.1
Nodes (21): AgentMetrics, AgentStats, BuildIdentity, Counter, HealthResponse, LabeledGauge, formatPromLabels(), init() (+13 more)
...
Cohesion: 0.1
Nodes (25): UsersDir(), TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), automationApproved(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser() (+17 more)
...
Cohesion: 0.09
Nodes (27): applyDotEnvFiles(), applyDotEnvToConfig(), applyEnvOverrides(), diffSecretField(), Load(), LoadFile(), LoadFileWithDotEnv(), parseBool() (+19 more)
...
Cohesion: 0.16
Nodes (29): isGoapNotebookLMFailure(), deriveNotebookLMResearchQuery(), isBoilerplateResearchTopic(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery(), nlmIsResearchImport() (+21 more)
...
Cohesion: 0.12
Nodes (25): ApplyParameters(), cholesky(), collectParams(), ExtractParameters(), invertCholesky(), itoa(), multiplyCholesky(), navigateToPath() (+17 more)
...
Cohesion: 0.12
Nodes (16): TestPromoteSubtree(), ApplyBlockMutations(), blockIDFromOp(), collectNames(), evolutionApplyAddAfter(), evolutionApplyAddBefore(), extractSubtree(), pickInsertOp() (+8 more)

### Community 152 - "Community 152"
Cohesion: 0.15
Nodes (28): NewKeyRing(), NewKeyRotationScheduler(), TestExpireKey_NotFound(), TestExpireKey_Success(), TestExpiringKeys_EmptyRing(), TestExpiringKeys_OnlyPermanent(), TestExpiringKeys_OutsideWindow(), TestExpiringKeys_WithinWindow() (+20 more)
...
Cohesion: 0.1
Nodes (4): agentTestMockLLM, chainMockLLM, countedErrorMockLLM, indexedErrorMockLLM
...
Cohesion: 0.12
Nodes (21): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), DefaultManager(), TestHandle_RunScope(), TestHandle_SessionScope() (+13 more)

### Community 169 - "Community 169"
Cohesion: 0.12
Nodes (3): sha256Hex(), KeyRing, SessionStore
...
Cohesion: 0.11
Nodes (22): AllTools(), DevTools(), DiskUsage(), HTTPGet(), MemoryUsage(), MonitorTools(), ProcessCheck(), SandboxedShell() (+14 more)
...
Cohesion: 0.14
Nodes (15): init(), RegisterBlockMutations(), RegisterBlockRandomMutator(), tryApplyBlockMutations(), tryBlockRandomMutation(), TestLocalSearchMutableParamsAndTabu(), randomMutation(), extractMutableParams() (+7 more)
...
Cohesion: 0.14
Nodes (7): acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), cappedCells(), cappedIndividuals(), TrackRecord
...
Cohesion: 0.18
Nodes (22): buildGrillRound1Query(), arc42GoalsPromptBlock(), arc42ResearchTopics(), loadArc42QualityGoals(), TestArc42GoalsPromptBlockContainsEveryGoal(), TestArc42GoalsPromptBlockEmptyWhenDocMissing(), TestArc42ResearchTopicsAnchoredToGoals(), TestBuildClaudeReviewPromptIncludesArc42Goals() (+14 more)
...
Cohesion: 0.13
Nodes (23): AllTools(), DevTools(), DiskUsage(), FileRead(), HTTPGet(), MemoryUsage(), MonitorTools(), ProcessCheck() (+15 more)
...
Cohesion: 0.15
Nodes (19): NewDTAnalyzer(), pathStat(), TestBTOptimizer_ReorderSelectors(), TestConditionOverlap(), TestDTAnalyzer_BestSplit(), TestDTAnalyzer_EmptyStatsNoOp(), TestDTAnalyzer_Entropy(), TestDTAnalyzer_Gini() (+11 more)
...
Cohesion: 0.14
Nodes (18): claudeBackoffWindow(), TestClaudeBackoffWindow_EnvOverride(), ClaudeRunner, CommandResult, CommandRunner, execClaudeRunner, execCommandRunner, claudeBackoffWindow() (+10 more)
...
Cohesion: 0.18
Nodes (17): NewAuctioneer(), TestAuctioneer_RunAuction_AppliesDefaultDispatchDeadline(), TestAuctioneer_RunAuction_BoundsWinnerDispatchWithAnnouncementDeadline(), TestCollectBids_SurvivesPanickingCandidate(), newFakeTransport(), TestAuctioneer_AttributesBidToAnnouncedCandidate(), TestAuctioneer_CollectsValidBids(), TestAuctioneer_DropsInvalidAndForeignBids() (+9 more)
...
Cohesion: 0.16
Nodes (19): CosineSimilarity(), hammerRegister(), TestBuildIndex_ConcurrentRegisterNoRace(), TestBuildIndex_PanicRecovered(), TestCosineSimilarity_BothZero(), TestCosineSimilarity_DifferentLengths(), TestCosineSimilarity_Empty(), TestCosineSimilarity_Identical() (+11 more)

### Community 215 - "Community 215"
Cohesion: 0.18
Nodes (19): TestLocalSearcher_New(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing() (+11 more)

### Community 216 - "Community 216"
Cohesion: 0.11
Nodes (7): Embedding, EmbeddingClient, CategorizedError, ErrorContext, TestJitterStrategy_String(), TruncateForError(), JitterStrategy
...
Cohesion: 0.17
Nodes (17): registerA2ANodes(), TestDelegateToA2A_ContextPropagates(), TestDelegateToA2A_FnNotConfigured(), TestDelegateToA2A_FnReturnsError(), TestDelegateToA2A_MissingTaskEmptyChainState(), TestDelegateToA2A_MissingURL(), TestDelegateToA2A_RateLimitCarryoverPropagates(), TestDelegateToA2A_Success() (+9 more)
...
Cohesion: 0.16
Nodes (5): Manager, isPersistentScope(), loadScopeFile(), safeFilename(), scopeFile
...
Cohesion: 0.16
Nodes (12): HabitMiner, cosine(), jaccard(), keywordSet(), NewHabitMiner(), sortedByCount(), minerInput(), TestHabitMiner_BelowThresholdYieldsNothing() (+4 more)
...
Cohesion: 0.13
Nodes (18): TestGetStringSlice_Existing(), TestGetStringSlice_MissingKey(), TestGetStringSlice_NilMap(), TestGetStringSlice_WrongType(), TestPlanStepsToStrings(), TestPlanStepsToStrings_Empty(), TestStringField_Exists(), TestStringField_Missing() (+10 more)

### Community 237 - "Community 237"
Cohesion: 0.16
Nodes (13): banditChildKey(), banditLockFor(), banditStatsDir(), banditStatsPath(), banditUCB1Order(), BuildBanditSelector(), recordBanditOutcome(), saveBanditStats() (+5 more)
...
Cohesion: 0.11
Nodes (17): arc42 Docs Consolidation & Per-Section Sync Nodes — Implementation Plan, Canonical section layout (used by merge tasks, Go manifest, and drift script — keep all three in lockstep), code:bash (grep -F '## 10.1 Quality Tree' docs/arc42/10-quality.md && g), code:bash (git rm docs/arc42/go-bt-evolve-arc42.md docs/arc42/09-test-s), code:bash (grep -rn 'docs/adr' README.md docs/*.md | grep -v 'docs/plan), code:bash (# ----- 5. arc42 section files validation -----), code:bash (bash scripts/check-doc-drift.sh; echo "exit=$?"), code:bash (for f in 02-constraints 03-context-scope 04-solution-strateg) (+9 more)
...
Cohesion: 0.13
Nodes (8): Histogram, HistogramSnap, LabeledCounter, LabeledHistogram, bucketForStatus(), labelKey(), MetricsMiddleware(), RecordTask()
...
Cohesion: 0.15
Nodes (14): Outcome, Record, FilterByTreeName(), NewRegistryWithUsers(), TestRegistry_Rescan_PicksUpTreeAddedAfterConstruction(), recordsForEntry(), TestBankFor_NoUserRootFallsBackToShared(), TestBankFor_PersonalTreesGetPerUserBank() (+6 more)
...
Cohesion: 0.13
Nodes (14): buildDashboardKnowledgeGraph(), TestBuildDashboardKnowledgeGraph_LoadsFeedbackFitness(), TestKnowledgeGraphRegistersAllDomainTrees(), TestConnect_GlobalGraph(), TestDiscover_GlobalGraphVariety(), TestKnowledgeGraph_GlobalConsistency(), TestListByCategory_All(), TestListByCategory_NonExistent() (+6 more)
...
Cohesion: 0.17
Nodes (11): TestPathHelpers(), WorkflowsDir(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree() (+3 more)
...
Cohesion: 0.23
Nodes (13): mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu() (+5 more)
...
Cohesion: 0.17
Nodes (11): TestCreateAgentTool_Call_NilFactory(), TestReflectTool_Call_NoLLM(), TestReflectTool_Call_WithLLM(), TestRunTaskTool_Call(), TestToolNames_And_Descriptions(), NewCreateAgentTool(), NewFitnessTool(), NewGetTreeTool() (+3 more)
...
Cohesion: 0.2
Nodes (10): ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestWrapReliable_HasTimeoutAndFallbacks(), act(), ApplyReliability(), cond(), seqFallback() (+2 more)

### Community 753 - "Community 753"
Cohesion: 0.22
Nodes (5): apiKey, KeyHash(), TestKeyHash_Deterministic(), APIKeyInfo, KeyRotationScheduler
...
Cohesion: 0.21
Nodes (8): collectSelectorNames(), DecisionTreeStatsFile(), SelectorStatsFile(), selectorTelemetryPath(), TestRunOnceFlushesDecisionTreeTelemetry(), TestRunOnceFlushesSelectorTelemetry(), TestSelectorStatsFileSanitizesTreeID(), TestPackageTestsIsolateHomeDir()
...
Cohesion: 0.32
Nodes (4): newScopedStore(), normalizeKey(), truncateSummary(), scopedStore
...
Cohesion: 0.21
Nodes (7): agentNameInterceptor, agentNameKey, BTAgentExecutor, failureEventMessage(), NewServer(), parseAnnouncement(), TestFailureEventMessage_CarryoverKeepsSentinel()

### Community 779 - "Community 779"
Cohesion: 0.17
Nodes (12): TestGetEmbedding_5xxIsRetriedThenSucceeds(), TestGetEmbedding_EmptyEmbeddingOn200IsError(), TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailureWithCategory(), TestIntegration_CircuitBreakerAndDLQ(), NewCircuitBreaker(), TestCircuitBreaker_Closed() (+4 more)
...
Cohesion: 0.25
Nodes (3): fanoutHandler, traceContextHandler, SpanContextFrom()
...
Cohesion: 0.2
Nodes (9): stringsContainsFold(), superpowersModeFromTask(), TestSuperpowersModeFromTask(), TestSuperpowersRunState(), SuperpowersMode, SuperpowersPhase, SuperpowersRun, SuperpowersTask (+1 more)
...
Cohesion: 0.18
Nodes (11): code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), Package: evaluator, Package: factory, Package: llm (+3 more)
...
Cohesion: 0.2
Nodes (10): code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), Package: api, Package: benchmark, Package: knowledge (+2 more)
...
Cohesion: 0.32
Nodes (4): eventDataString(), newRoutineThrottle(), routineThrottle, throttleEntry
...
Cohesion: 0.33
Nodes (6): IsKnownChainKind(), parseChainConfig(), TestChainAction_ParseConfig(), TestIsKnownChainKind(), findGuardedConditions(), validateNode()
...
Cohesion: 0.29
Nodes (7): code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), Package: gardener, Package: goap, Package: langagent
...
Cohesion: 0.5
Nodes (3): Session, SessionInfo, SessionStoreConfig
...
## Knowledge Gaps
- **10772 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+10767 more)
...
- **Why does `Append()` connect `Community 9` to `Community 513`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 1033`, `Community 10`, `Community 11`, `Community 15`, `Community 1041`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 18`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 1063`, `Community 1064`, `Community 41`, `Community 43`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 56`, `Community 1080`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 57`, `Community 64`, `Community 65`, `Community 67`, `Community 69`, `Community 71`, `Community 73`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 1105`, `Community 82`, `Community 83`, `Community 85`, `Community 86`, `Community 1114`, `Community 91`, `Community 1115`, `Community 93`, `Community 94`, `Community 95`, `Community 90`, `Community 97`, `Community 98`, `Community 99`, `Community 101`, `Community 104`, `Community 106`, `Community 109`, `Community 117`, `Community 118`, `Community 123`, `Community 126`, `Community 127`, `Community 138`, `Community 140`, `Community 143`, `Community 144`, `Community 146`, `Community 148`, `Community 149`, `Community 150`, `Community 151`, `Community 153`, `Community 158`, `Community 159`, `Community 164`, `Community 169`, `Community 170`, `Community 174`, `Community 175`, `Community 176`, `Community 177`, `Community 180`, `Community 181`, `Community 184`, `Community 187`, `Community 197`, `Community 205`, `Community 206`, `Community 208`, `Community 211`, `Community 219`, `Community 220`, `Community 224`, `Community 227`, `Community 228`, `Community 232`, `Community 233`, `Community 744`, `Community 236`, `Community 749`, `Community 238`, `Community 239`, `Community 240`, `Community 753`, `Community 763`, `Community 767`, `Community 775`, `Community 780`, `Community 1361`, `Community 1362`, `Community 463`, `Community 467`, `Community 468`, `Community 469`, `Community 470`, `Community 481`, `Community 483`, `Community 484`, `Community 486`, `Community 487`, `Community 488`, `Community 489`, `Community 1009`, `Community 499`, `Community 500`, `Community 1013`, `Community 501`, `Community 1020`, `Community 511`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 26` to `Community 3`, `Community 131`, `Community 133`, `Community 6`, `Community 7`, `Community 10`, `Community 1034`, `Community 13`, `Community 17`, `Community 18`, `Community 25`, `Community 27`, `Community 38`, `Community 40`, `Community 41`, `Community 45`, `Community 173`, `Community 51`, `Community 56`, `Community 1084`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 68`, `Community 70`, `Community 200`, `Community 1097`, `Community 74`, `Community 205`, `Community 481`, `Community 100`, `Community 485`, `Community 495`, `Community 111`, `Community 116`, `Community 117`, `Community 122`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 27` to `Community 3`, `Community 6`, `Community 136`, `Community 9`, `Community 10`, `Community 13`, `Community 145`, `Community 146`, `Community 20`, `Community 26`, `Community 32`, `Community 36`, `Community 39`, `Community 40`, `Community 45`, `Community 51`, `Community 54`, `Community 55`, `Community 60`, `Community 61`, `Community 64`, `Community 65`, `Community 67`, `Community 72`, `Community 200`, `Community 76`, `Community 81`, `Community 82`, `Community 467`, `Community 215`, `Community 1496`, `Community 473`, `Community 118`, `Community 504`, `Community 505`, `Community 123`, `Community 124`?**
