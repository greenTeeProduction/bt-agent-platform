# Graph Report - superpowers-20260718T103508-7dfaeb70-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-18)

## Corpus Check
- 918 files · ~1,201,511 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27150 nodes · 40256 edges · 2107 communities (1761 shown, 346 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9517 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dda28fa2`
...
1. `Append()` - 392 edges
2. `9. Architecture Decisions` - 172 edges
...
Cohesion: 0.03
Nodes (114): TestCheckConfidence_ConditionExists(), TestIntegration_MutationOperators(), TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord() (+106 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (122): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+114 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (115): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), buildClaudeReviewPrompt() (+107 more)
...
Cohesion: 0.03
Nodes (93): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+85 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (101): main(), TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), perTreeStats(), setupGardener(), TestEvolveTree_BloatGuard() (+93 more)
...
Cohesion: 0.03
Nodes (96): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath() (+88 more)
...
Cohesion: 0.03
Nodes (23): History, splitLines(), RunRecord, RunStats, Append(), Registry, cloneTree(), NewRegistry() (+15 more)
...
Cohesion: 0.04
Nodes (71): main(), BTStudioCompany(), requireOllamaFinanceTest(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis(), TestTeslaMarket(), TestTeslaModel() (+63 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (82): mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu() (+74 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (57): newAgentExecutor(), agentExecuteResult(), buildDashboardKnowledgeGraph(), dashboardLocalAgentResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete() (+49 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (63): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), ComposeTaskTreeWithHITL() (+55 more)
...
Cohesion: 0.05
Nodes (82): TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestMultiNode_ScalabilityStatusRouterReporting(), NewAgentRouter(), NewDeadLetterQueue(), NewLocalExecutor(), NewRouterFromEndpoints(), NewSchedulerState() (+74 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (78): Duration(), TestTranspositionTable_SaveLoadRoundTrip(), TestTranspositionTable_Store_EvictionPreservesLowestAmongSurvivors(), TestTranspositionTable_Store_EvictsLowestValueDeterministically(), TestTranspositionTable_Store_EvictsLowestValueRepeated(), TestTranspositionTable_StoreProbeMiss(), TestTranspositionTable_StoreProbeRoundTrip(), countTreeNodes() (+70 more)
...
Cohesion: 0.04
Nodes (73): brokenTool, ChainConfig, ChainKind, bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction(), buildChainActionFn() (+65 more)
...
Cohesion: 0.06
Nodes (54): HTTPMethod, ArraySchema(), IntSchema(), ObjectSchema(), collectViolations(), fieldPath(), findResponse(), NewRouteIndex() (+46 more)
...
Cohesion: 0.05
Nodes (46): TestOutcomeErrorDetail(), FeedbackFile(), OutcomeErrorDetail(), TestLocalAgentResultNilResultAndSuccessPathsUnchanged(), TestLocalAgentResultPreservesOutcomeOnError(), attemptOutcomeError(), buildSchedulerConfig(), dlqReplayOutcomeError() (+38 more)
...
Cohesion: 0.05
Nodes (47): NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation(), TestCrisisDetector_DetectPopulation_DiversityCollapse() (+39 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (50): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), Category, composeOrderedWithMiddle() (+42 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (48): Blackboard, ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+40 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (35): AgentRunner, TestIsBreakerSuccess(), Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports() (+27 more)
...
Cohesion: 0.07
Nodes (50): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo(), assertNoForcedMasterWrite(), bareTestRun() (+42 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (42): GateResult, TestQualityGateFloorOn100Scale(), ListRevisions(), loadSnapshotIndex(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass() (+34 more)
...
Cohesion: 0.07
Nodes (33): TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), pipelineMockLLM, TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait() (+25 more)
...
Cohesion: 0.08
Nodes (39): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir(), MemoryDir() (+31 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (25): TestGoalFactory(), handlePipelines(), Debug(), errTest, errToString(), NewHealthMonitor(), TestHealthMonitorDegradationError(), TestHealthMonitorNilSafety() (+17 more)

### Community 62 - "Community 62"
Cohesion: 0.13
Nodes (39): TestDomainTree_Registration(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute(), TestIntegration_AllTreesExecute() (+31 more)
...
Cohesion: 0.1
Nodes (40): arc42SyncRunner, partialLandingRunner, syncArc42Docs(), arc42TestRun(), TestArc42SyncNoImpactIsClean(), TestArc42SyncSkipsDryRunAndMainRepoModes(), TestArc42SyncSkipsWithoutProductionChanges(), TestArc42SyncUpdatesDocAndChangedFiles() (+32 more)
...
Cohesion: 0.12
Nodes (36): TestRunSuiteIsSandboxed(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled(), TestBanditSelector_DisabledMatchesSelectorSemantics() (+28 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (33): BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), BuildCircuitBreaker(), BuildInverter(), BuildRepeater(), BuildRunner(), BuildSucceeder() (+25 more)
...
Cohesion: 0.06
Nodes (24): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_FeedbackPersistenceArmed(), TestBuildGardenerConfig_KnowledgeGraphWired(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired() (+16 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (29): BuildTaskFromInputs(), ParseInputParams(), TestBuildTaskFromInputs(), TestParseInputParams(), TestValidateInputs_Default(), TestValidateInputs_File(), TestValidateInputs_JSON(), TestValidateInputs_Required() (+21 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (16): Embedding, EmbeddingClient, DeepSeekClient, OpenAICompatClient, OpenAICompatConfig, openAICompatMessage, openAICompatRequest, openAICompatResponse (+8 more)
...
Cohesion: 0.08
Nodes (30): containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest(), TestRunTask_CacheHit() (+22 more)
...
Cohesion: 0.06
Nodes (21): builtinBlocks(), TestBuiltinBlocks_Count(), TestBuiltinBlocks_UniqueNonEmptyIDs(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock() (+13 more)
...
Cohesion: 0.1
Nodes (33): NewWorkflow(), TestApproval_Fields(), TestApproveTask(), TestExecuteSprint(), TestExecuteSprint_ApprovedToCompleted(), TestExecuteSprint_NoApprovedTasks(), TestExecuteSprint_SetsGoal(), TestGetApprovedTasks() (+25 more)
...
Cohesion: 0.08
Nodes (31): applyDotEnvFiles(), applyDotEnvToConfig(), applyEnvOverrides(), Load(), LoadDotEnv(), LoadFileWithDotEnv(), parseBool(), stripInlineComment() (+23 more)
...
Cohesion: 0.1
Nodes (22): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, LabeledGauge, LabeledHistogram, formatPromLabels() (+14 more)
...
Cohesion: 0.11
Nodes (31): TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter(), TestMutation_AddBefore(), TestMutation_AddFallback(), TestMutation_IncreaseRetries(), TestMutation_PruneNode(), TestMutation_TargetNotFound() (+23 more)
...
Cohesion: 0.11
Nodes (32): handleAlerts(), AgentMetric, AlertReport, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON(), evaluateGlobalAlerts(), evaluateHTTPAlerts() (+24 more)
...
Cohesion: 0.07
Nodes (12): TestFullTreeIntegration_SmokeCheck(), TestActionForName_BulkCoverage(), TestSuperpowersTaskVerifyRed_NoTestsFailsWithoutPanic(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), namedTree, sprintRecover(), TestStress_ConcurrentExecution() (+4 more)
...
Cohesion: 0.19
Nodes (30): TestRequestErrorHandlerProposal_RespectsCallerContext(), TestRequestErrorHandlerProposal_StampsLedgerOnEveryOutcome(), acquireErrorHandlerClaudeLock(), acquireErrorHandlerFileLock(), acquireErrorHandlerStoreLock(), activeErrorHandlerExtensions(), appendErrorHandlerExtension(), errorHandlerDir() (+22 more)
...
Cohesion: 0.16
Nodes (26): saveRecordWithDelay(), TestCreateAgentTool_Call_NilFactory(), TestEvolveTool_Call_NotEnoughFailures(), TestEvolveTool_Call_NoTree(), TestEvolveTool_Call_Success(), TestFitnessTool_Call(), TestFitnessTool_Call_NoData(), TestGetReflectionsTool_Call_NoRecords() (+18 more)
...
Cohesion: 0.1
Nodes (28): goapFusionNoopPatchStreak(), defaultNlmGrillAuthGuard(), nlmGrillAnswerer(), nlmGrillUnavailable(), parseNumberedAnswers(), runGrillAuthGuardAction(), TestGoapFusionNoopPatchStreak_DurableAcrossCronTicks(), TestGoapFusionNoopPatchStreak_IncrementsOnNoopResetsOnChange() (+20 more)
...
Cohesion: 0.13
Nodes (29): growthFitness(), FitnessDimension, MultiIndividual, clampScore(), countActions(), countConditions(), materializeMutationOp(), NewMultiFitness() (+21 more)
...
Cohesion: 0.1
Nodes (19): main(), attachLogHandler(), buildBaseHandler(), buildLogger(), envLogLevel(), Error(), Init(), L() (+11 more)
...
Cohesion: 0.12
Nodes (27): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionPreflightWired(), goapFusionRepeatedHashBypassed() (+19 more)

### Community 164 - "Community 164"
Cohesion: 0.08
Nodes (6): TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionCircuitBreakerHalts(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionCircuitBreakerHaltsOnConsecutiveNoopPatches(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionLoopHaltsOnConsecutiveNoopPatches(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionLoopRunner(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPublishesStateHash(), withNoActiveProgram()
...
Cohesion: 0.15
Nodes (21): DiversityMetrics, EvolutionParameters, FitnessMetrics, BuildPopulationState(), BuildPopulationStateWithGrid(), clamp01(), clampMutationRate(), DefaultPhaseRanges() (+13 more)
...
Cohesion: 0.12
Nodes (22): AntiPattern, DesignPattern, BlockIDFromRef(), coreHeuristics(), knownAntiPatterns(), MatchBlockPattern(), NewExpertKnowledge(), provenPatterns() (+14 more)
...
Cohesion: 0.17
Nodes (23): buildGrillRound1Query(), arc42GoalsPromptBlock(), arc42ResearchTopics(), loadArc42QualityGoals(), TestArc42GoalsPromptBlockContainsEveryGoal(), TestArc42GoalsPromptBlockEmptyWhenDocMissing(), TestArc42ResearchTopicsAnchoredToGoals(), TestBuildClaudeReviewPromptIncludesArc42Goals() (+15 more)

### Community 183 - "Community 183"
Cohesion: 0.12
Nodes (23): availableToolNames(), buildToolList(), execAgent(), executeAgentTool(), hasRealTools(), incompleteInvestigationNote(), TestChainAction_Agent_ToolExecution(), TestIncompleteInvestigationNote_StopReasons() (+15 more)
...
Cohesion: 0.08
Nodes (7): CreateAgentTool, EvolveTool, GetReflectionsTool, GetTreeTool, ReflectTool, RunTaskTool, truncateStr()

### Community 187 - "Community 187"
Cohesion: 0.12
Nodes (12): TestNumberSchema(), BoolSchema(), DashboardRoutes(), NumberSchema(), TestConvenienceSchemaConstructors(), TestDashboardRoutes_AgentsExecuteHasRequestBody(), TestDashboardRoutes_AllHaveOperationIDs(), TestDashboardRoutes_Completeness() (+4 more)
...
Cohesion: 0.21
Nodes (24): TestConsoleTracer_ExporterReceivesCompletedSpan(), TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest(), TestTracingMiddleware_StatusCodes() (+16 more)
...
Cohesion: 0.1
Nodes (16): TestGetEmbedding_5xxIsRetriedThenSucceeds(), TestGetEmbedding_EmptyEmbeddingOn200IsError(), FallbackLLM, NamedLLM, TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailure_BackwardCompat(), TestCircuitBreaker_RecordFailureWithCategory() (+8 more)
...
Cohesion: 0.15
Nodes (20): toast(), apiFetch(), approveHITL(), approveTask(), executeSprint(), pollSprintStatus(), refreshHITL(), refreshTasks() (+12 more)
...
Cohesion: 0.14
Nodes (18): cleanupAppliedSuperpowersWorktree(), cleanupSuperpowersWorktree(), createSuperpowersWorktree(), isBareGitRepo(), reapOrphanedSuperpowersBranches(), superpowersWorktreeBranches(), TestCleanupAppliedSuperpowersWorktreeNoOpsOnDryRun(), TestCleanupAppliedSuperpowersWorktreeRemovesWorktreeAndMergedBranch() (+10 more)
...
Cohesion: 0.13
Nodes (22): handleAgentsList(), AgentHistoryEntry, AgentInfo, agentStatus(), DefaultAgentTask(), ListAgents(), ListAgentsWithCB(), listRegistryAgents() (+14 more)
...
Cohesion: 0.12
Nodes (19): handlePipelineRun(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus(), pipelineRunRecord (+11 more)
...
Cohesion: 0.11
Nodes (10): Approval, sortTasks(), TestSortTasks(), TestSortTasks_StableOrder(), TestTaskStatus_String(), truncate(), Priority, Task (+2 more)
...
Cohesion: 0.15
Nodes (11): priorityWeight(), summarizeOutput(), TestPriorityWeight(), TestSummarizeOutput(), truncate(), MemoryEntry, MemoryStore, init() (+3 more)
...
Cohesion: 0.14
Nodes (21): AllTools(), DevTools(), DiskUsage(), HTTPGet(), MemoryUsage(), MonitorTools(), ProcessCheck(), SandboxedShell() (+13 more)
...
Cohesion: 0.16
Nodes (14): NewEvolvedAgent(), TestConfig_AllFields(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestMockModel_SatisfiesInterface(), TestNewEvolvedAgent_AllToolsRegistered() (+6 more)
...
Cohesion: 0.25
Nodes (19): TestClaudeErrorHandler_DoesNotClobberExistingCategory(), swapErrorHandlerRunner(), ehTestHandlerNode(), ehTestProposalJSON(), init(), runHandler(), TestClaudeErrorHandler_BuildSwitchAndValidation(), TestClaudeErrorHandler_CapReachedSkipsClaude() (+11 more)
...
Cohesion: 0.18
Nodes (18): TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing(), TestLocalSearch_TabuSearch() (+10 more)
...
Cohesion: 0.17
Nodes (13): Alert, esc(), getCookie(), Alert, cbIcon(), createAgent(), deleteAgent(), loadAgents() (+5 more)
...
Cohesion: 0.14
Nodes (8): DLQEscalateBlock(), FitnessProbeBlock(), AuditLogBlock(), TraceCheckpointBlock(), TestAuditLogAction(), TestFitnessProbeAction(), TestMatchBlockPattern(), TestPushToDLQAction()
...
Cohesion: 0.34
Nodes (13): NewMockLLM(), NewDefaultCompany(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary(), testLLM(), TestRunQuarter_MetricsValid() (+5 more)
...
Cohesion: 0.14
Nodes (13): code:text (docs/superpowers/runs/<run-id>/), code:go (sel("Phase1_Design",), code:markdown (### Task N: Title), code:text (ApproveSuperpowersPRPush (HumanApprovalGate, side_effect_cla), code:go (func SuperpowersPipelineTree() *evolution.SerializableNode {), Current Stub Surface To Replace, Done Definition, Production Acceptance Criteria (+5 more)
...
Cohesion: 0.26
Nodes (11): NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic(), TestNSGAII_FrontRank(), TestNSGAIIPopulation_Load_MergeKeepsFitterCopy() (+3 more)
...
Cohesion: 0.15
Nodes (13): code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), Package: langagent (+5 more)
...
Cohesion: 0.2
Nodes (10): LoadFile(), TestLoadFile_Basic(), TestLoadFile_BooleanExplicitFalse(), TestLoadFile_EmptyFile(), TestLoadFile_EnvOverridesFile(), TestLoadFile_InvalidJSON(), TestLoadFile_MissingFile(), TestSaveFile_Roundtrip() (+2 more)
...
Cohesion: 0.31
Nodes (9): AgentMetric, AlertReport, MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON(), evaluateGlobalAlerts(), evaluateHTTPAlerts() (+1 more)
...
Cohesion: 0.2
Nodes (10): code:bash (cd ~/go-bt-evolve && PATH="/usr/local/go/bin:$PATH" go build), Implementation Tasks, Task 14: Agent YAML, Task 15: Domain Registration, Task 16: Action Registration, Task 17: Agent Registration, Task 23: Build + Deploy Binary, Task 24: Performance Test (+2 more)
...
Cohesion: 0.28
Nodes (6): fakeSuperpowersReviewRunner, fixedDiffRunner, TestParseSuperpowersReviewVerdict(), TestSuperpowersTaskGreenAction_InjectsReviewFeedbackWhenPresent(), TestSuperpowersTaskGreenAction_NoFeedback_PromptUnchanged(), TestSuperpowersTaskReviewAction_SetsChainStateFromVerdict()
...
Cohesion: 0.43
Nodes (5): newCatchupFixture(), TestSchedule_PreservesCrashRecoveryImmediateRun(), TestSchedule_PreservesMissedNextRunForCatchUp(), TestSchedule_RecomputesNextRunOnScheduleChange(), testError
...
## Knowledge Gaps
- **10731 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+10726 more)
...
- **Why does `Append()` connect `Community 16` to `Community 509`, `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 13`, `Community 15`, `Community 1039`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 32`, `Community 34`, `Community 35`, `Community 36`, `Community 1059`, `Community 38`, `Community 42`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 50`, `Community 52`, `Community 53`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 74`, `Community 76`, `Community 79`, `Community 81`, `Community 83`, `Community 84`, `Community 85`, `Community 87`, `Community 90`, `Community 91`, `Community 92`, `Community 94`, `Community 95`, `Community 96`, `Community 99`, `Community 100`, `Community 101`, `Community 104`, `Community 106`, `Community 107`, `Community 108`, `Community 112`, `Community 113`, `Community 115`, `Community 118`, `Community 120`, `Community 121`, `Community 122`, `Community 126`, `Community 129`, `Community 132`, `Community 134`, `Community 135`, `Community 136`, `Community 140`, `Community 142`, `Community 143`, `Community 146`, `Community 147`, `Community 151`, `Community 153`, `Community 155`, `Community 157`, `Community 158`, `Community 159`, `Community 165`, `Community 167`, `Community 169`, `Community 173`, `Community 177`, `Community 180`, `Community 181`, `Community 183`, `Community 184`, `Community 187`, `Community 192`, `Community 193`, `Community 194`, `Community 203`, `Community 207`, `Community 208`, `Community 209`, `Community 214`, `Community 216`, `Community 219`, `Community 220`, `Community 736`, `Community 224`, `Community 229`, `Community 230`, `Community 233`, `Community 234`, `Community 749`, `Community 242`, `Community 244`, `Community 246`, `Community 761`, `Community 1328`, `Community 469`, `Community 470`, `Community 471`, `Community 989`, `Community 481`, `Community 995`, `Community 484`, `Community 485`, `Community 495`, `Community 496`, `Community 500`, `Community 507`, `Community 508`, `Community 1021`, `Community 511`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 43` to `Community 131`, `Community 133`, `Community 8`, `Community 9`, `Community 10`, `Community 14`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 150`, `Community 23`, `Community 152`, `Community 24`, `Community 27`, `Community 30`, `Community 1055`, `Community 161`, `Community 37`, `Community 38`, `Community 39`, `Community 42`, `Community 49`, `Community 53`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 191`, `Community 1091`, `Community 207`, `Community 209`, `Community 89`, `Community 93`, `Community 483`, `Community 238`, `Community 1008`, `Community 119`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 19` to `Community 131`, `Community 5`, `Community 9`, `Community 14`, `Community 142`, `Community 16`, `Community 146`, `Community 147`, `Community 21`, `Community 22`, `Community 24`, `Community 156`, `Community 30`, `Community 160`, `Community 37`, `Community 41`, `Community 170`, `Community 43`, `Community 176`, `Community 1461`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 202`, `Community 75`, `Community 80`, `Community 81`, `Community 473`, `Community 224`, `Community 740`, `Community 100`, `Community 235`, `Community 238`, `Community 754`, `Community 118`, `Community 246`, `Community 122`?**
