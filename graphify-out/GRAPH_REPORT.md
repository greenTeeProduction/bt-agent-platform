# Graph Report - superpowers-20260715T202738-9a21d49e-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-15)

## Corpus Check
- 875 files · ~1,053,800 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23406 nodes · 35404 edges · 1883 communities (1530 shown, 353 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8803 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9baeb5c9`
...
5. `registerMCPTools()` - 128 edges
6. `arc42 Section 9 — Architecture Decisions` - 122 edges
...
## Communities (1883 total, 353 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (173): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+165 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (173): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+165 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (102): expandChainStateTemplates(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM(), TestChainAction_Agent_NoTools() (+94 more)
...
Cohesion: 0.02
Nodes (122): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+114 more)
...
Cohesion: 0.05
Nodes (102): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+94 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (89): main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+81 more)
...
Cohesion: 0.07
Nodes (89): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+81 more)
...
Cohesion: 0.03
Nodes (27): Server, AgentMetric, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts() (+19 more)
...
Cohesion: 0.04
Nodes (80): alwaysSampler, Attr, captureExporter, NewOTLPHTTPExporter(), TestConfigureOTLPFromEnv(), TestConfigureOTLPFromEnv_DisabledWithoutEndpoint(), TestConsoleTracer_ExporterErrorDoesNotBreakEnd(), TestConsoleTracer_ExporterReceivesCompletedSpan() (+72 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (80): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree() (+72 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (63): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewGoTestTool_Structure() (+55 more)
...
Cohesion: 0.06
Nodes (72): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+64 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (60): main(), BTStudioCompany(), requireOllamaFinanceTest(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis(), TestTeslaMarket(), TestTeslaModel() (+52 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (75): TestScoreChild_GoalAlignmentBranch(), TestScoreChildren_BasicRanking(), ParallelMode, intSliceFromInterface(), BuildReactiveParallel(), childPanicHandler(), forkBlackboard(), intSliceFromInterface() (+67 more)
...
Cohesion: 0.06
Nodes (60): AgentBus, AgentEvent, InitAgentBus(), PublishHealthAlert(), PublishServiceDown(), TestAgentBus_AllSubscribersReceiveAll(), TestAgentBus_CloseSubscriberChannelsClosed(), TestAgentBus_ConcurrentPublish() (+52 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (71): ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction(), buildChainActionFn() (+63 more)
...
Cohesion: 0.04
Nodes (48): AutoRebuildEnabled(), StartDriftWatcher(), TestOutcomeErrorDetail(), FeedbackFile(), DashboardRebuildTargets(), DefaultRebuildTargets(), NewRebuildBackoff(), OutcomeErrorDetail() (+40 more)
...
Cohesion: 0.05
Nodes (35): WorkflowsDir(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep() (+27 more)

### Community 39 - "Community 39"
Cohesion: 0.07
Nodes (60): Duration(), TestDuration(), TestTranspositionTable_SaveLoadRoundTrip(), TestTranspositionTable_Store_EvictionPreservesLowestAmongSurvivors(), TestTranspositionTable_Store_EvictsLowestValueDeterministically(), TestTranspositionTable_Store_EvictsLowestValueRepeated(), TestTranspositionTable_StoreProbeMiss(), TestTranspositionTable_StoreProbeRoundTrip() (+52 more)
...
Cohesion: 0.06
Nodes (47): HTTPMethod, IntSchema(), collectViolations(), fieldPath(), findResponse(), NewRouteIndex(), pathOrRoot(), ResponseValidator() (+39 more)
...
Cohesion: 0.08
Nodes (48): NewAgent(), NewDocPlanner(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory(), TestAgentNoPlan() (+40 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (36): TestMatchBlockPattern(), AntiPattern, DesignPattern, BlockIDFromRef(), containsStr(), coreHeuristics(), hasNodeMatching(), hasNodeType() (+28 more)

### Community 45 - "Community 45"
Cohesion: 0.1
Nodes (48): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Finance(), TestRouting_Research(), TestTree_Research() (+40 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (46): ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestScoreChild_NilChainState(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+38 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (51): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), TestIsGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation() (+43 more)
...
Cohesion: 0.05
Nodes (43): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+35 more)
...
Cohesion: 0.07
Nodes (31): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait() (+23 more)

### Community 62 - "Community 62"
Cohesion: 0.09
Nodes (31): growthFitness(), FitnessDimension, MultiFitness, MultiIndividual, clampScore(), countActions(), countConditions(), NewMultiFitness() (+23 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (29): UsersDir(), TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree() (+21 more)
...
Cohesion: 0.1
Nodes (15): extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), containsCrisisReason(), Crossover(), ExperienceRetrievalHits(), hashTree() (+7 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (32): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, ConcurrencyLimiter, DeadLetterEntry, TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty() (+24 more)
...
Cohesion: 0.13
Nodes (41): TestRouteBuilder_Build(), ArraySchema(), BoolSchema(), NewOpenAPIGenerator(), NewRoute(), ObjectSchema(), StringSchema(), mapKeys() (+33 more)
...
Cohesion: 0.11
Nodes (35): gitOutput(), TestNoCommittedRootBinaries(), recentImplementedGoals(), TestRecentImplementedGoalsReadsStore(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery() (+27 more)

### Community 88 - "Community 88"
Cohesion: 0.09
Nodes (27): TestCheckConfidence_ConditionExists(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter() (+19 more)
...
Cohesion: 0.09
Nodes (25): TestRunOnce_EmitsRunRootSpan(), TestRunJob_WebhookSpanJoinsRunTrace(), TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeSpan, fakeTracer, mockOllamaServer() (+17 more)
...
Cohesion: 0.08
Nodes (28): TestNewQTable(), TestNewReinforcementLearner(), TestQTableSelectUpdateBestAction(), TestQTableStateBucketsAndDepth(), TestReinforcementLearnerLearnAndSuggest(), NewQTable(), NewReinforcementLearner(), TestExpertKnowledge_SeedSpecialistsCarryProvenance() (+20 more)
...
Cohesion: 0.1
Nodes (27): TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves(), NewFileJobStore(), NewReadOnlyJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath() (+19 more)
...
Cohesion: 0.08
Nodes (22): BuildTaskFromInputs(), ParseInputParams(), TestBuildTaskFromInputs(), TestParseInputParams(), TestValidateInputs_Default(), TestValidateInputs_File(), TestValidateInputs_JSON(), TestValidateInputs_Required() (+14 more)
...
Cohesion: 0.09
Nodes (25): TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath(), TestDiscardWorktree_RemovesWorktreeAndDeletesBranch(), TestPushBranchAndCreatePR_InvokesGitPushAndGhPr(), withSwappedSuperpowersRunners(), TestSuperpowersTaskCommitAction_ExcludesGeneratedPaths() (+17 more)

### Community 122 - "Community 122"
Cohesion: 0.13
Nodes (29): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionNoopPatchStreak(), goapFusionRepeatedHashBypassed(), goapFusionStateHashes() (+21 more)
...
Cohesion: 0.12
Nodes (28): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestApplyJobScheduleRecomputesForNormalJob(), TestCrashedInFlightJobRunsImmediatelyAfterRestart(), TestRunJob_WarnsOnDeployDriftAtCycleComplete(), TestRunJob_WebhookIncludesBuildRevision(), TestRunJobStampsFailureOutcomeWhenRetryExhaustionLeavesItEmpty() (+20 more)

### Community 125 - "Community 125"
Cohesion: 0.11
Nodes (29): TestBTOptimizer_New(), TestDTAnalyzer_New(), collectSelectors(), conditionOverlap(), findMainSelector(), TestFindMainSelector(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras() (+21 more)
...
Cohesion: 0.09
Nodes (19): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce() (+11 more)
...
Cohesion: 0.13
Nodes (20): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote(), TestChargeGoapResearchGoalFailure_ChargesOncePerCycle() (+12 more)
...
Cohesion: 0.13
Nodes (9): acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), cappedCells(), cappedIndividuals(), mergeSelectorStatsMaps(), persistSelectorStats() (+1 more)
...
Cohesion: 0.1
Nodes (17): handleAnalyze(), handleWorkflowApprove(), handleWorkflowPending(), handleWorkflowReject(), handleWorkflowRunFullPipeline(), TestCurrentWorkflow_GuardedByMutex(), TestDashboardAPIRoutesHaveOpenAPICoverage(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses() (+9 more)

### Community 158 - "Community 158"
Cohesion: 0.15
Nodes (22): isolateGoapProgramStore(), init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), newGrillLoopTestRun(), TestGrillDesign_ApprovedWhenNoOpenCriticals(), TestGrillDesign_NeedsWorkWithFeedbackWhenCriticalsOpen(), TestGrillDesign_NoProgressBreakerFailsAfterTwoStaleRounds() (+14 more)
...
Cohesion: 0.16
Nodes (21): TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), metaValidatorWiringGardener(), TestEvolveTreeV2_DeepSearchMutationRejectedByMetaValidatorNotPersisted(), TestEvolveTreeV2_DeepSearchMutationRejectedByValidationGateNotPersisted() (+13 more)
...
Cohesion: 0.19
Nodes (14): ChildStats, NodeExecutionRecord, applyOrderToNode(), Entropy(), GiniImpurity(), InformationGain(), normalizedIG(), recordSelectorOutcomeInto() (+6 more)
...
Cohesion: 0.22
Nodes (4): app, normalizeFlagArgs(), parseIntent(), printUsage()
...
Cohesion: 0.13
Nodes (14): TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), TestStartDriftWatcher_KickTriggersImmediateCheck(), RegistryDir(), TestPathHelpers(), newCatchupFixture(), TestReconcileWithRegistry_EmptyRegistryPreservesJobs(), TestSchedule_PreservesCrashRecoveryImmediateRun() (+6 more)
...
Cohesion: 0.17
Nodes (13): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired(), wireSelectorOrdering(), routerChildNames() (+5 more)

### Community 396 - "Community 396"
Cohesion: 0.16
Nodes (10): buildStampLdflags(), copyFile(), defaultRebuildBuild(), RebuildBinaries(), resolveGoBinary(), TestBuildStampLdflagsInRepo(), TestBuildStampLdflagsNonGitDir(), TestRebuildBinaries() (+2 more)

### Community 397 - "Community 397"
Cohesion: 0.17
Nodes (13): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), LogsDir(), MemoryDir(), NotificationThrottleFile() (+5 more)

### Community 398 - "Community 398"
Cohesion: 0.14
Nodes (12): TestConfig_AllFields(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestMockModel_SatisfiesInterface(), TestNewEvolvedAgent_AllToolsRegistered(), TestNewEvolvedAgent_MinimalConfig() (+4 more)
...
Cohesion: 0.18
Nodes (4): Workflow, newTaskNonce(), TestPrioritizeGoapGoals_AffirmativeBlockerProducesEngineTestGoal(), TestPrioritizeGoapGoals_NoImportCycleFalseGoalFromResearchGap()
...
Cohesion: 0.12
Nodes (15): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestValidate_MemoryNodesDuplicateNames(), TestValidate_MemoryNodesRequireUniqueNames(), TestSuperpowersWorkflowTree_BuildsAndValidates() (+7 more)
...
Cohesion: 0.47
Nodes (9): NewEvolvedAgent(), TestToolNames_And_Descriptions(), NewCreateAgentTool(), NewEvolveTool(), NewFitnessTool(), NewGetReflectionsTool(), NewGetTreeTool(), NewReflectTool() (+1 more)
...
Cohesion: 0.47
Nodes (5): generator, buildGraph(), main(), newApp(), taskExecutor
...
## Knowledge Gaps
- **8494 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8489 more)
...
- **Why does `Append()` connect `Community 15` to `Community 2`, `Community 3`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 24`, `Community 27`, `Community 28`, `Community 29`, `Community 31`, `Community 32`, `Community 34`, `Community 37`, `Community 38`, `Community 41`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 52`, `Community 53`, `Community 56`, `Community 57`, `Community 58`, `Community 60`, `Community 62`, `Community 66`, `Community 67`, `Community 69`, `Community 71`, `Community 72`, `Community 73`, `Community 76`, `Community 77`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 88`, `Community 89`, `Community 91`, `Community 92`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 100`, `Community 102`, `Community 103`, `Community 616`, `Community 105`, `Community 617`, `Community 107`, `Community 620`, `Community 110`, `Community 1135`, `Community 112`, `Community 113`, `Community 626`, `Community 631`, `Community 123`, `Community 125`, `Community 126`, `Community 643`, `Community 644`, `Community 133`, `Community 646`, `Community 135`, `Community 136`, `Community 132`, `Community 134`, `Community 140`, `Community 145`, `Community 147`, `Community 150`, `Community 157`, `Community 161`, `Community 164`, `Community 167`, `Community 169`, `Community 172`, `Community 177`, `Community 184`, `Community 185`, `Community 186`, `Community 194`, `Community 195`, `Community 199`, `Community 200`, `Community 201`, `Community 204`, `Community 205`, `Community 212`, `Community 216`, `Community 217`, `Community 218`, `Community 219`, `Community 835`, `Community 837`, `Community 838`, `Community 851`, `Community 857`, `Community 859`, `Community 863`, `Community 879`, `Community 880`, `Community 885`, `Community 887`, `Community 889`, `Community 890`, `Community 393`, `Community 909`, `Community 399`, `Community 405`, `Community 407`, `Community 409`, `Community 410`, `Community 421`, `Community 422`, `Community 935`, `Community 424`, `Community 426`, `Community 428`, `Community 435`, `Community 436`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 18` to `Community 2`, `Community 131`, `Community 134`, `Community 12`, `Community 13`, `Community 140`, `Community 15`, `Community 16`, `Community 144`, `Community 400`, `Community 397`, `Community 25`, `Community 32`, `Community 38`, `Community 39`, `Community 168`, `Community 937`, `Community 44`, `Community 45`, `Community 428`, `Community 55`, `Community 56`, `Community 57`, `Community 189`, `Community 62`, `Community 65`, `Community 67`, `Community 196`, `Community 69`, `Community 208`, `Community 88`, `Community 90`, `Community 1242`, `Community 98`, `Community 112`, `Community 113`, `Community 119`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 32` to `Community 2`, `Community 132`, `Community 7`, `Community 394`, `Community 12`, `Community 13`, `Community 397`, `Community 141`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 921`, `Community 25`, `Community 27`, `Community 28`, `Community 38`, `Community 39`, `Community 42`, `Community 57`, `Community 59`, `Community 61`, `Community 63`, `Community 837`, `Community 74`, `Community 75`, `Community 77`, `Community 207`, `Community 208`, `Community 85`, `Community 853`, `Community 93`, `Community 879`, `Community 112`, `Community 119`, `Community 120`, `Community 124`?**
