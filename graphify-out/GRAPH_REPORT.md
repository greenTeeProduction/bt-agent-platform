# Graph Report - superpowers-20260713T010810-1d2ca422-goap-fusion-loop-runner-blackboard-conte  (2026-07-13)

## Corpus Check
- 830 files · ~916,845 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20121 nodes · 31267 edges · 1669 communities (1317 shown, 352 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8166 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bd59fe34`
...
## Communities (1669 total, 352 thin omitted)
...
Cohesion: 0.02
Nodes (126): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+118 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (126): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+118 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (98): main(), TestBlackboard_AllFields(), TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails(), TestRunTask_KnowledgeGap_RoutesToKnowledgePath(), TestRunTask_Success(), TestIntegration_ReflectionAndPersistence(), reflectOnOutcomeAction() (+90 more)
...
Cohesion: 0.03
Nodes (54): containsAnyStr(), findChildByName(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords(), TestContainsAnyLower_NoKeywords(), TestContainsAnyLower_NoMatch() (+46 more)
...
Cohesion: 0.06
Nodes (70): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), Entry, TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit() (+62 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (57): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), ListToolProfileBlocks(), ComposeTaskTreeWithHITL() (+49 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (45): DashboardRebuildTargets(), DefaultRebuildTargets(), main(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID() (+37 more)
...
Cohesion: 0.04
Nodes (57): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+49 more)
...
Cohesion: 0.05
Nodes (31): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogin() (+23 more)
...
Cohesion: 0.08
Nodes (20): TestPopulation_StatsAccessors(), extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), collectNodeNames(), containsCrisisReason(), Crossover() (+12 more)
...
Cohesion: 0.06
Nodes (30): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, TestHasChildNamed_DeepNested(), TestHasChildNamed_Found() (+22 more)
...
Cohesion: 0.06
Nodes (43): applyDotEnvFiles(), applyDotEnvToConfig(), applyEnvOverrides(), Load(), LoadDotEnv(), LoadFile(), LoadFileWithDotEnv(), parseBool() (+35 more)
...
Cohesion: 0.15
Nodes (33): DefaultTree(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes(), TestAddFromMutation_NoChange() (+25 more)
...
Cohesion: 0.15
Nodes (28): init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled(), TestBanditSelector_DisabledMatchesSelectorSemantics(), TestBanditSelector_DisabledRunningChildRestartsAtZero() (+20 more)
...
Cohesion: 0.07
Nodes (35): Binaries, code:go (type Counter struct { ... }), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }) (+27 more)
...
Cohesion: 0.1
Nodes (22): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), countTreeNodes(), TestSuperpowersPipelineSimulation(), TestHumanApprovalGate_AutoApprove() (+14 more)
...
Cohesion: 0.08
Nodes (21): AutoRebuildEnabled(), defaultDriftHead(), DriftStatus(), DriftWatchOnce(), scrubGitEnv(), StartDriftWatcher(), TestDriftStatus(), TestDriftWatchOnce() (+13 more)
...
Cohesion: 0.14
Nodes (21): assertInvalidContains(), buildDeepTree(), TestBuildTree_InvalidTreeReturnsFailureCommand(), TestValidateTree_CycleDeep(), TestValidateTree_CycleDetected(), TestValidateTree_NoCycle(), TestVerifierFull_AlwaysSucceedRejectsChildren(), TestVerifierFull_BackwardCompat() (+13 more)

### Community 190 - "Community 190"
Cohesion: 0.17
Nodes (20): TestSelectorOptimizer_New(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb() (+12 more)
...
Cohesion: 0.12
Nodes (6): Config, diffSecretField(), Duration(), TestDuration(), BuildCircuitBreaker(), BuildTimeout()
...
Cohesion: 0.15
Nodes (7): DashboardRoutes(), TestDashboardRoutes_AgentsExecuteHasRequestBody(), TestDashboardRoutes_AllHaveOperationIDs(), TestDashboardRoutes_AuthConsistency(), TestDashboardRoutes_Completeness(), TestDashboardRoutes_OperationIDUniqueness(), RouteBuilder
...
Cohesion: 0.4
Nodes (4): HITLConfig, Policy, ApplyConfig(), GetPolicy()
...
## Knowledge Gaps
- **6527 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6522 more)
...
- **Why does `Append()` connect `Community 8` to `Community 0`, `Community 513`, `Community 512`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 13`, `Community 14`, `Community 529`, `Community 18`, `Community 19`, `Community 20`, `Community 17`, `Community 22`, `Community 23`, `Community 24`, `Community 537`, `Community 26`, `Community 28`, `Community 540`, `Community 30`, `Community 31`, `Community 33`, `Community 35`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 42`, `Community 44`, `Community 46`, `Community 47`, `Community 48`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 73`, `Community 75`, `Community 78`, `Community 79`, `Community 81`, `Community 82`, `Community 83`, `Community 86`, `Community 87`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 94`, `Community 95`, `Community 98`, `Community 102`, `Community 103`, `Community 107`, `Community 116`, `Community 118`, `Community 120`, `Community 121`, `Community 127`, `Community 128`, `Community 129`, `Community 131`, `Community 133`, `Community 136`, `Community 138`, `Community 139`, `Community 143`, `Community 147`, `Community 152`, `Community 153`, `Community 154`, `Community 156`, `Community 668`, `Community 158`, `Community 162`, `Community 675`, `Community 165`, `Community 171`, `Community 172`, `Community 173`, `Community 174`, `Community 180`, `Community 181`, `Community 184`, `Community 697`, `Community 699`, `Community 187`, `Community 193`, `Community 197`, `Community 199`, `Community 200`, `Community 201`, `Community 718`, `Community 719`, `Community 723`, `Community 212`, `Community 211`, `Community 724`, `Community 744`, `Community 340`, `Community 341`, `Community 344`, `Community 345`, `Community 346`, `Community 351`, `Community 353`, `Community 354`, `Community 355`, `Community 362`, `Community 363`, `Community 364`, `Community 373`, `Community 376`, `Community 507`, `Community 508`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 65` to `Community 0`, `Community 3`, `Community 521`, `Community 12`, `Community 14`, `Community 16`, `Community 17`, `Community 22`, `Community 23`, `Community 24`, `Community 157`, `Community 31`, `Community 38`, `Community 40`, `Community 45`, `Community 54`, `Community 694`, `Community 184`, `Community 57`, `Community 193`, `Community 66`, `Community 199`, `Community 203`, `Community 80`, `Community 81`, `Community 85`, `Community 93`, `Community 352`, `Community 97`, `Community 96`, `Community 114`, `Community 116`, `Community 373`, `Community 119`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 38` to `Community 0`, `Community 1026`, `Community 8`, `Community 12`, `Community 13`, `Community 22`, `Community 23`, `Community 153`, `Community 160`, `Community 164`, `Community 36`, `Community 37`, `Community 39`, `Community 40`, `Community 165`, `Community 174`, `Community 52`, `Community 53`, `Community 182`, `Community 54`, `Community 57`, `Community 187`, `Community 190`, `Community 63`, `Community 959`, `Community 65`, `Community 66`, `Community 70`, `Community 203`, `Community 204`, `Community 89`, `Community 97`, `Community 745`, `Community 120`?**
