# Graph Report - superpowers-20260717T003243-b9065508-goap-fusion-loop-runner  (2026-07-17)

## Corpus Check
- 894 files · ~1,120,478 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24905 nodes · 37450 edges · 1961 communities (1614 shown, 347 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9148 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca2a152c`
...
5. `9. Architecture Decisions` - 137 edges
...
## Communities (1961 total, 347 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (186): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+178 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (186): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+178 more)
...
Cohesion: 0.03
Nodes (112): TestCheckConfidence_ConditionExists(), TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch() (+104 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (120): CompressionMiddleware(), gzipDecompress(), TestCompressionMiddleware_AlreadyCompressed(), TestCompressionMiddleware_BinaryContentType(), TestCompressionMiddleware_EmptyBody(), TestCompressionMiddleware_GzipRequest(), TestCompressionMiddleware_HTMLContentType(), TestCompressionMiddleware_LargeJSONResponse() (+112 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (130): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+122 more)
...
Cohesion: 0.03
Nodes (38): Server, AgentMetric, AlertReport, Catalog, extractYAMLField(), inferTree(), splitTags(), CatalogEntry (+30 more)
...
Cohesion: 0.04
Nodes (91): Duration(), TestDuration(), TestTranspositionTable_SaveLoadRoundTrip(), TestTranspositionTable_Store_EvictionPreservesLowestAmongSurvivors(), TestTranspositionTable_Store_EvictsLowestValueDeterministically(), TestTranspositionTable_Store_EvictsLowestValueRepeated(), TestTranspositionTable_StoreProbeMiss(), TestTranspositionTable_StoreProbeRoundTrip() (+83 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (86): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation() (+78 more)
...
Cohesion: 0.04
Nodes (71): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), composeOrderedWithMiddle(), ComposePreset(), ComposePresetWithTools(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ListToolProfileBlocks() (+63 more)
...
Cohesion: 0.05
Nodes (83): TestScoreChild_GoalAlignmentBranch(), TestScoreChild_NilChainState(), TestScoreChildren_BasicRanking(), okCommand, panicCommand, ParallelMode, intSliceFromInterface(), BuildReactiveParallel() (+75 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (55): stringContains(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_PlanGoapActions_WrongActionsType(), TestAction_ReflectGoapOutcome_NoResultsFallsBack(), cacheCheckAction(), cacheResultAction(), execLLMCallAction(), execRefineAction() (+47 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (54): agentExecuteResult(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleAnalyze() (+46 more)
...
Cohesion: 0.06
Nodes (73): clearSuperpowersPlanState(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), registerSuperpowersProductionActions(), titleSuperpowersVerb() (+65 more)
...
Cohesion: 0.05
Nodes (42): main(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep() (+34 more)
...
Cohesion: 0.05
Nodes (51): init(), registerGoDevActions(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+43 more)
...
Cohesion: 0.06
Nodes (63): TestConsoleTracer_ExporterReceivesCompletedSpan(), fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest() (+55 more)
...
Cohesion: 0.05
Nodes (47): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+39 more)

### Community 53 - "Community 53"
Cohesion: 0.11
Nodes (47): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+39 more)
...
Cohesion: 0.07
Nodes (42): BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir() (+34 more)
...
Cohesion: 0.07
Nodes (36): TestCompiledPlanTree_ValidatesAndRuns(), convertGoapChildren(), FromGoapNode(), GOAPDevOpsTree(), GOAPPlanningTree(), GOAPResearchTree(), Blackboard, BlackboardBridge (+28 more)
...
Cohesion: 0.08
Nodes (42): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves(), NewFileJobStore() (+34 more)
...
Cohesion: 0.05
Nodes (27): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, TestHasChildNamed_DeepNested(), TestHasChildNamed_Found() (+19 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (26): cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask(), serializeTreeForGardener(), TestCloneTreeForGardener_Basic(), TestCloneTreeForGardener_DoubleNested() (+18 more)
...
Cohesion: 0.11
Nodes (35): init(), registerStockfishActions(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled() (+27 more)

### Community 74 - "Community 74"
Cohesion: 0.07
Nodes (24): TestRunOnce_EmitsRunRootSpan(), tracingMiddleware(), fanoutHandler, traceContextHandler, NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent() (+16 more)
...
Cohesion: 0.08
Nodes (32): TestOutcomeErrorDetail(), OutcomeErrorDetail(), TestLocalAgentResultNilResultAndSuccessPathsUnchanged(), TestLocalAgentResultPreservesOutcomeOnError(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir() (+24 more)
...
Cohesion: 0.13
Nodes (33): TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), TestAction_PlanGoapActions_JSONActionsInvalidEntry(), TestAction_PlanGoapActions_NoPlanFound(), TestAction_PlanGoapActions_WithGoapConfig(), TestAction_PlanGoapActions_WorldStateFromTask() (+25 more)
...
Cohesion: 0.08
Nodes (29): main(), BTStudioCompany(), main(), TestClient_AnalyzeComplexity_FallbackOnError(), TestClient_Generate_ConnectionRefused(), TestClient_GeneratePlan_FallbackOnError(), TestClient_Reflect_FallbackOnError(), TestDeepSeekClient_AnalyzeComplexity() (+21 more)
...
Cohesion: 0.11
Nodes (32): growthFitness(), NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic(), TestNSGAII_FrontRank() (+24 more)
...
Cohesion: 0.08
Nodes (34): Binaries, code:go (type Counter struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }) (+26 more)
...
Cohesion: 0.11
Nodes (31): TestApplyMutations_DuplicateFallbackRejected(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter(), TestMutation_AddBefore(), TestMutation_AddFallback(), TestMutation_IncreaseRetries(), TestMutation_PruneNode() (+23 more)

### Community 123 - "Community 123"
Cohesion: 0.08
Nodes (30): applyDotEnvFiles(), applyDotEnvToConfig(), applyEnvOverrides(), hasExplicitField(), Load(), LoadFile(), LoadFileWithDotEnv(), mergeFileConfig() (+22 more)
...
Cohesion: 0.09
Nodes (25): circuitBreakerCmd, errorAwareCmd, init(), registerReliabilityNodes(), buildCircuitBreaker(), buildTimeout(), circuitBreakerFor(), cooldownFromNode() (+17 more)
...
Cohesion: 0.13
Nodes (23): registerA2ANodes(), TestDelegateToA2A_FnNotConfigured(), TestDelegateToA2A_FnReturnsError(), TestDelegateToA2A_MissingTaskEmptyChainState(), TestDelegateToA2A_MissingURL(), TestDelegateToA2A_Success(), TestDelegateToA2A_UsesTaskFromChainState(), TestHasA2ATarget_EmptyURL() (+15 more)
...
Cohesion: 0.1
Nodes (19): TestMatchBlockPattern(), AntiPattern, DesignPattern, BlockIDFromRef(), containsStr(), coreHeuristics(), hasNodeMatching(), hasNodeType() (+11 more)
...
Cohesion: 0.12
Nodes (21): collectSelectorNames(), SelectorStatsFile(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb() (+13 more)
...
Cohesion: 0.11
Nodes (18): TestDefaultRebuildTargets_PinsFullListIncludingMCPBinary(), buildStampLdflags(), copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), defaultRebuildMaterialize(), DefaultRebuildTargets(), NewRebuildBackoff() (+10 more)
...
Cohesion: 0.14
Nodes (12): NewMockLLM(), mockLLM, NewThinkTank(), TestFullAnalysis_MultipleTopics(), TestNewThinkTank(), TestOrchestrator_Debate(), TestOrchestrator_EmptyTopic(), TestOrchestrator_FullAnalysis() (+4 more)
...
Cohesion: 0.1
Nodes (19): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestSuperpowersWorkflowTree_BuildsAndValidates(), containsLeafChildrenMsg(), TestRunTask_BackstopsEmptyResultOnNonSuccess() (+11 more)
...
Cohesion: 0.15
Nodes (8): acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), mergeSelectorStatsMaps(), persistSelectorStats(), readSelectorStatsFile(), TrackRecord
...
Cohesion: 0.18
Nodes (16): EngineerTree(), MarketingTree(), SalesTree(), StartupTrees(), CEOTree(), CTOTree(), PMTree(), Roles() (+8 more)
...
Cohesion: 0.13
Nodes (13): AgentMetrics, AgentStats, BuildIdentity, HealthResponse, exposedBuildIdentity(), GetAgentMetrics(), init(), InstallBuildIdentity() (+5 more)
...
Cohesion: 0.13
Nodes (16): envBool(), TestEnvBool(), marshalConfig(), TestDiff_DifferentValues(), TestDiff_EmptyConfigs(), TestEnvBool_DefaultValue(), TestEnvBool_MixedCase(), TestEnvBool_UnknownValue() (+8 more)
...
Cohesion: 0.27
Nodes (3): MaxDepth(), MetaValidationReport, MetaValidator
...
Cohesion: 0.27
Nodes (14): NewDefaultCompany(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary(), testLLM(), TestNewDefaultCompany_Values(), TestRoles() (+6 more)
...
Cohesion: 0.16
Nodes (6): requireBuildIdentityWiring(), TestDaemonLogsBuildIdentityAtStartup(), TestDLQReplayScanSurvivesPanicAcrossTicks(), TestGardenerLogsBuildIdentityAtStartup(), TestSchedulerAttempt_RateLimitCarryoverRecordedAsDeferred(), TestSchedulerAttempt_SuccessAndFailureUnchanged()
...
Cohesion: 0.27
Nodes (10): formatPromLabels(), labeledSnapshotToMap(), labelString(), MetricsJSON(), parseLabelKey(), sortStrings(), splitOn(), withLeLabel() (+2 more)
...
Cohesion: 0.22
Nodes (6): Histogram, LabeledCounter, bucketForStatus(), labelKey(), MetricsMiddleware(), RecordTask()
...
Cohesion: 0.29
Nodes (9): classifyErrorHandlerFailure(), goapFailureCategory(), isGoapFusionCycle(), TestClassifyErrorHandlerFailure(), TestClassifyReliabilityFallback(), TestClaudeErrorHandler_ClassifiesUnclassifiedFailure(), TestClaudeErrorHandler_GoapFailureGetsGoapCategory(), TestGoapFailureCategory() (+1 more)
...
Cohesion: 0.4
Nodes (4): init(), registerFinanceActions(), init(), registerResearchActions()
...
Cohesion: 0.33
Nodes (5): hasExecutionPathFirst(), hasUnboundedRetry(), MetaValidationDecision, MetaValidationIssue, MetaValidatorConfig
...
## Knowledge Gaps
- **9365 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+9360 more)
...
- **Why does `Append()` connect `Community 9` to `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 31`, `Community 32`, `Community 36`, `Community 37`, `Community 38`, `Community 40`, `Community 41`, `Community 42`, `Community 44`, `Community 48`, `Community 49`, `Community 51`, `Community 52`, `Community 53`, `Community 55`, `Community 57`, `Community 58`, `Community 59`, `Community 61`, `Community 62`, `Community 64`, `Community 65`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 75`, `Community 77`, `Community 78`, `Community 80`, `Community 82`, `Community 83`, `Community 85`, `Community 87`, `Community 88`, `Community 89`, `Community 92`, `Community 94`, `Community 96`, `Community 97`, `Community 99`, `Community 100`, `Community 102`, `Community 104`, `Community 105`, `Community 112`, `Community 115`, `Community 117`, `Community 122`, `Community 123`, `Community 125`, `Community 129`, `Community 130`, `Community 134`, `Community 135`, `Community 136`, `Community 138`, `Community 651`, `Community 139`, `Community 652`, `Community 654`, `Community 142`, `Community 145`, `Community 658`, `Community 152`, `Community 665`, `Community 666`, `Community 155`, `Community 162`, `Community 164`, `Community 677`, `Community 679`, `Community 168`, `Community 169`, `Community 682`, `Community 171`, `Community 683`, `Community 172`, `Community 179`, `Community 180`, `Community 185`, `Community 190`, `Community 1215`, `Community 191`, `Community 194`, `Community 197`, `Community 203`, `Community 204`, `Community 207`, `Community 209`, `Community 210`, `Community 211`, `Community 214`, `Community 216`, `Community 217`, `Community 223`, `Community 224`, `Community 225`, `Community 873`, `Community 883`, `Community 884`, `Community 898`, `Community 904`, `Community 923`, `Community 924`, `Community 925`, `Community 413`, `Community 416`, `Community 929`, `Community 418`, `Community 419`, `Community 932`, `Community 420`, `Community 434`, `Community 437`, `Community 443`, `Community 448`, `Community 449`, `Community 455`, `Community 976`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 84` to `Community 2`, `Community 132`, `Community 7`, `Community 905`, `Community 13`, `Community 16`, `Community 17`, `Community 19`, `Community 21`, `Community 22`, `Community 30`, `Community 415`, `Community 31`, `Community 34`, `Community 38`, `Community 167`, `Community 40`, `Community 43`, `Community 50`, `Community 55`, `Community 190`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 964`, `Community 74`, `Community 207`, `Community 212`, `Community 224`, `Community 108`, `Community 111`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 21` to `Community 128`, `Community 130`, `Community 2`, `Community 4`, `Community 134`, `Community 9`, `Community 13`, `Community 17`, `Community 19`, `Community 20`, `Community 147`, `Community 150`, `Community 155`, `Community 30`, `Community 31`, `Community 159`, `Community 1311`, `Community 423`, `Community 174`, `Community 53`, `Community 55`, `Community 445`, `Community 193`, `Community 65`, `Community 68`, `Community 76`, `Community 78`, `Community 80`, `Community 84`, `Community 212`, `Community 217`, `Community 109`, `Community 112`, `Community 882`, `Community 117`?**
