# Graph Report - superpowers-20260712T224322-83eaaa9a-goap-fusion-loop-runner-blackboard-conte  (2026-07-12)

## Corpus Check
- 823 files · ~906,695 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19851 nodes · 30940 edges · 1672 communities (1312 shown, 360 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8122 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7216e18f`
...
## Communities (1672 total, 360 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (110): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+102 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (122): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+114 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (122): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+114 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (88): isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM() (+80 more)
...
Cohesion: 0.04
Nodes (102): TestDeprecatedHandler_NoSunset(), TestDeprecatedHandler_WithSunsetDate(), TestDeprecatedHandlerFunc(), DeprecatedHandler(), DeprecatedHandlerFunc(), TestDeprecatedHandler_WithoutSunset(), TestDeprecatedHandler_WithSunset(), TestDeprecatedHandlerFunc_WithSunset() (+94 more)
...
Cohesion: 0.05
Nodes (78): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure() (+70 more)
...
Cohesion: 0.04
Nodes (76): perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree() (+68 more)
...
Cohesion: 0.04
Nodes (58): init(), registerGoDevActions(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+50 more)
...
Cohesion: 0.05
Nodes (63): brokenTool, ChainConfig, ChainKind, bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction(), buildChainActionFn() (+55 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (62): Duration(), TestDuration(), TestCheckConfidence_ConditionExists(), countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New() (+54 more)
...
Cohesion: 0.06
Nodes (56): NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation(), TestCrisisDetector_DetectPopulation_DiversityCollapse() (+48 more)
...
Cohesion: 0.05
Nodes (30): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), CycleMetrics, Gardener, baseNodeCount(), CollectAgentSLOs() (+22 more)
...
Cohesion: 0.05
Nodes (32): AutoRebuildEnabled(), defaultDriftHead(), DriftStatus(), DriftWatchOnce(), scrubGitEnv(), StartDriftWatcher(), TestDriftStatus(), TestDriftWatchOnce() (+24 more)
...
Cohesion: 0.06
Nodes (37): TestRunOnce_EmitsRunRootSpan(), TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeSpan, fakeTracer, mockOllamaServer(), newTestClient() (+29 more)
...
Cohesion: 0.07
Nodes (34): WorkflowsDir(), handlePipelineRun(), handlePipelines(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), pipelineRunRecord (+26 more)
...
Cohesion: 0.07
Nodes (39): FileJobStore, NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), JobStore, NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath() (+31 more)
...
Cohesion: 0.07
Nodes (28): TestMatchBlockPattern(), AntiPattern, DesignPattern, TestExpert_MatchPattern(), BlockIDFromRef(), containsStr(), coreHeuristics(), hasNodeMatching() (+20 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (34): ClassifyError(), DefaultRetryPolicy(), TestClassifyError_Auth(), TestClassifyError_CaseInsensitive(), TestClassifyError_ClaudeUsageLimit(), TestClassifyError_LLM(), TestClassifyError_Network(), TestClassifyError_NoBareSubstringFalsePositives() (+26 more)
...
Cohesion: 0.04
Nodes (50): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+42 more)
...
Cohesion: 0.07
Nodes (25): handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleAnalyze(), handleDLQReplay(), handleLogin() (+17 more)
...
Cohesion: 0.08
Nodes (34): RegistryDir(), SchedulerJobsFile(), ResolvePipelineAgent(), TestRemoveAgentJobs(), TestResolvePipelineAgent_Aliases(), TestApplySchedule_PersistsRegistryAndJobs(), TestDeleteRegisteredAgent(), ApplySchedule() (+26 more)
...
Cohesion: 0.1
Nodes (12): envDefault(), main(), run(), AgentExecutor, PageAgent, init(), registerSuperpowersDebugActions(), superpowersDebugPhase() (+4 more)
...
Cohesion: 0.08
Nodes (32): Binaries, code:go (type Counter struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }) (+24 more)
...
Cohesion: 0.07
Nodes (11): TestActionForName_BulkCoverage(), TestSuperpowersTaskVerifyRed_NoTestsFailsWithoutPanic(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), namedTree, sprintRecover(), TestStress_ConcurrentExecution(), TestStress_EdgeInputs() (+3 more)
...
Cohesion: 0.1
Nodes (22): BuildCachedCondition(), parseChainConfig(), TestChainAction_ParseConfig(), BuildCircuitBreaker(), BuildInverter(), BuildRepeater(), BuildRunner(), BuildSucceeder() (+14 more)
...
Cohesion: 0.11
Nodes (24): dataFileMetrics(), extractExistingDataPath(), init(), inspectDataSource(), registerDomainActions(), availableToolNames(), buildToolList(), execAgent() (+16 more)

### Community 138 - "Community 138"
Cohesion: 0.1
Nodes (12): NewDocPlanner(), DocPlanner, DocPlannerWorldState, fakeBlackboard, TestBuildGoalFromTaskMultipleKeywordsAndTruncation(), TestDocPlannerAlreadyCompleteReturnsEmptyPlan(), TestDocPlannerWorldStateIgnoresWrongTypesAndMissingKeys(), TestDocPlannerWorldStateRoundTripAndCounts() (+4 more)

### Community 139 - "Community 139"
Cohesion: 0.19
Nodes (24): goalEntry, NewGoalQueue(), NewGoalQueueFrom(), names(), names2(), TestGoalIsSatisfied(), TestGoalQueueAddAndSelect(), TestGoalQueueAddReplace() (+16 more)
...
Cohesion: 0.14
Nodes (26): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionNoopPatchStreak(), goapFusionPreflightWired() (+18 more)
...
Cohesion: 0.09
Nodes (23): ApplyJitter(), contextDeadlineExceeded(), DecorrelatedJitter(), EqualJitter(), FullJitter(), isAuthError(), isLLMError(), isNetworkError() (+15 more)
...
Cohesion: 0.14
Nodes (19): TestClient_AnalyzeComplexity_FallbackOnError(), TestClient_Generate_ConnectionRefused(), TestClient_GeneratePlan_FallbackOnError(), TestClient_Reflect_FallbackOnError(), TestDeepSeekClient_AnalyzeComplexity(), TestDeepSeekClient_Generate_APIError(), TestDeepSeekClient_Generate_ConnectionRefused(), TestDeepSeekClient_Generate_EmptyChoices() (+11 more)

### Community 171 - "Community 171"
Cohesion: 0.09
Nodes (22): TestNumberSchema(), TestSchemaToMap_Format(), DeprecationHeader, httpStatusText(), NumberSchema(), schemaToMap(), TestHTTPStatusText(), TestSchemaToMap_Array() (+14 more)
...
Cohesion: 0.17
Nodes (9): TestCompiledPlanTree_ValidatesAndRuns(), TestAutomationActions_ReachTaskAutomated(), Planner, NewPlanner(), PlanMultiple(), ValidatePlan(), plannerNode, plannerNodeHeap (+1 more)
...
Cohesion: 0.18
Nodes (11): DefaultPanicHandler(), SafeGo(), TestRecover_CatchesPanic(), TestRecover_NoPanic(), TestRecover_ReturnsErrorWithContext(), TestSafeGo_HandlerPanicIsRecovered(), TestSafeGo_NormalExecution(), TestSafeGo_RecoversPanic() (+3 more)
...
Cohesion: 0.2
Nodes (4): registerGoapNodes(), Goal, Plan, WorldState
...
Cohesion: 0.24
Nodes (3): TestIsNodeWrapped(), isNodeWrapped(), Registry
...
Cohesion: 0.33
Nodes (6): code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), Package: llm, Package: monitoring, Package: thinktank
...
## Knowledge Gaps
- **6364 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6359 more)
...
- **Why does `Append()` connect `Community 57` to `Community 0`, `Community 513`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 13`, `Community 527`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 23`, `Community 535`, `Community 25`, `Community 26`, `Community 28`, `Community 540`, `Community 30`, `Community 543`, `Community 544`, `Community 33`, `Community 31`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 41`, `Community 44`, `Community 46`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 53`, `Community 54`, `Community 55`, `Community 59`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 89`, `Community 91`, `Community 93`, `Community 96`, `Community 97`, `Community 102`, `Community 105`, `Community 106`, `Community 111`, `Community 112`, `Community 114`, `Community 115`, `Community 118`, `Community 120`, `Community 122`, `Community 123`, `Community 129`, `Community 130`, `Community 131`, `Community 132`, `Community 135`, `Community 137`, `Community 138`, `Community 148`, `Community 149`, `Community 152`, `Community 153`, `Community 672`, `Community 164`, `Community 165`, `Community 678`, `Community 679`, `Community 680`, `Community 169`, `Community 173`, `Community 175`, `Community 176`, `Community 177`, `Community 178`, `Community 179`, `Community 182`, `Community 185`, `Community 186`, `Community 701`, `Community 190`, `Community 189`, `Community 704`, `Community 193`, `Community 194`, `Community 192`, `Community 195`, `Community 705`, `Community 706`, `Community 199`, `Community 200`, `Community 203`, `Community 205`, `Community 210`, `Community 723`, `Community 725`, `Community 729`, `Community 730`, `Community 748`, `Community 751`, `Community 777`, `Community 343`, `Community 344`, `Community 345`, `Community 346`, `Community 356`, `Community 357`, `Community 358`, `Community 359`, `Community 360`, `Community 361`, `Community 362`, `Community 363`, `Community 364`, `Community 370`, `Community 380`, `Community 381`, `Community 924`, `Community 510`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 60` to `Community 3`, `Community 520`, `Community 12`, `Community 17`, `Community 18`, `Community 27`, `Community 28`, `Community 30`, `Community 31`, `Community 672`, `Community 35`, `Community 36`, `Community 38`, `Community 39`, `Community 45`, `Community 47`, `Community 48`, `Community 52`, `Community 53`, `Community 55`, `Community 696`, `Community 193`, `Community 71`, `Community 76`, `Community 208`, `Community 341`, `Community 95`, `Community 96`, `Community 110`, `Community 125`, `Community 127`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 38` to `Community 3`, `Community 1031`, `Community 10`, `Community 12`, `Community 19`, `Community 148`, `Community 27`, `Community 28`, `Community 156`, `Community 31`, `Community 34`, `Community 172`, `Community 48`, `Community 178`, `Community 53`, `Community 54`, `Community 57`, `Community 60`, `Community 189`, `Community 63`, `Community 64`, `Community 961`, `Community 198`, `Community 71`, `Community 205`, `Community 207`, `Community 208`, `Community 210`, `Community 215`, `Community 97`, `Community 354`, `Community 105`, `Community 106`, `Community 110`, `Community 111`?**
