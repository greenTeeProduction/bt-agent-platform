...
## Corpus Check
- 364 files · ~437,479 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6363 nodes · 11891 edges · 306 communities (273 shown, 33 thin omitted)
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 3977 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `afa8cc33`
...
2. `DefaultTree()` - 94 edges
3. `sleep()` - 92 edges
4. `NewKnowledgeGraph()` - 77 edges
5. `newDefaultConfig()` - 75 edges
6. `GoDeveloperTree()` - 60 edges
7. `NewGoal()` - 55 edges
8. `condTest()` - 52 edges
9. `NewAgentRouter()` - 45 edges
10. `DefaultMock()` - 44 edges
...
## Communities (306 total, 33 thin omitted)
...
Cohesion: 0.05
Nodes (60): TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure(), TestNewGoVetTool_Structure() (+52 more)
...
Cohesion: 0.05
Nodes (57): DefaultLLM(), TestBuiltinSWELite_CoverageAndUniqueness(), TestBuiltinSWEVerifiedSample_CoverageAndUniqueness(), TestMax1(), benchmarkPlanTree(), benchmarkSuccessTree(), TestBFCLV3LoadErrorsAndEmptyEvaluation(), TestBFCLV3LoadFlattenAndEvaluate() (+49 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (36): BlockConfig, ChildStats, ApplyDiffMutation(), DefaultBlockConfig(), findBlockForNode(), NewMetaPromptEvolver(), NewMutationContext(), TestApplyDiffMutation() (+28 more)
...
Cohesion: 0.05
Nodes (17): execRefineAction(), NewEngine(), RegisterProviders(), TestEngine_GetAction(), TestEngine_GetCondition(), TestEngine_Independence(), TestExecRefineAction_EmptyResult(), TestExecRefineAction_NilLLM() (+9 more)
...
Cohesion: 0.12
Nodes (34): TestDomainTree_Registration(), TestFullTreeIntegration_RunsAllTreesWithRealLLM(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research() (+26 more)
...
Cohesion: 0.08
Nodes (28): TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestNumberValue_Float64(), TestNumberValue_Int(), TestNumberValue_Int64(), TestNumberValue_JSONNumber() (+20 more)

### Community 43 - "Community 43"
Cohesion: 0.09
Nodes (36): ContentTypeMiddleware(), CSRFMiddleware(), GenerateCSRFToken(), GenerateRequestID(), IPFilterMiddleware(), NewIPFilter(), TestContentTypeMiddleware_AllowsGETWithoutContentType(), TestContentTypeMiddleware_AllowsJSON() (+28 more)
...
Cohesion: 0.11
Nodes (14): AgentCircuitBreaker, AgentCircuitBreakerStore, CircuitBreakerOptions, CircuitState, CircuitSummary, reportAgentOutcome(), TestReportAgentOutcome_Failure(), TestReportAgentOutcome_NilStore() (+6 more)
...
Cohesion: 0.11
Nodes (25): AlwaysSample(), hashTraceID(), NeverSample(), NewRatioSampler(), TestAlwaysSample(), TestConsoleTracer_ChildSpansNotSampled(), TestConsoleTracer_ParentChild(), TestConsoleTracer_SamplerConcurrent() (+17 more)
...
Cohesion: 0.13
Nodes (23): TestScoreChild_GoalAlignmentBranch(), TestScoreChild_NilChainState(), TestScoreChildren_BasicRanking(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure(), errMockLLM, ScoringCriteria (+15 more)
...
Cohesion: 0.18
Nodes (22): NewHistory(), NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad(), TestScheduler_NoJobStore_NilSafe(), TestScheduler_PersistenceOnSchedule() (+14 more)

### Community 101 - "Community 101"
Cohesion: 0.13
Nodes (17): TestTreeMaxDepth_EmptyTree(), TestTreeMaxDepth_Nested(), DeepeningResult, FitnessScore, TestIterativeDeepening_Depth1_Applies(), TestIterativeDeepening_ScoreImprovement(), TestIterativeDeepening_TTHitViaMakeKey(), TestTranspositionTable_Save_EvictionThenSave() (+9 more)
...
Cohesion: 0.09
Nodes (17): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, Provider, execLLMCallAction(), generatePlanAction() (+9 more)
...
Cohesion: 0.19
Nodes (18): main(), TestEstimatePathCoverage_EmptyRecords(), TestEstimatePathCoverage_FewerThanTwoRecords(), TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune(), makeRecords() (+10 more)
...
Cohesion: 0.12
Nodes (11): main(), main(), BTStudioCompany(), main(), min(), main(), main(), TestDefaultConfig() (+3 more)
...
Cohesion: 0.17
Nodes (14): TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestRegisterAction_DuplicatePanics(), TestRegisterCondition_DuplicatePanics(), TestRegisterAction_And_GetAction(), TestRegisterCondition_And_GetCondition(), init(), RegisterAction() (+6 more)

### Community 153 - "Community 153"
Cohesion: 0.21
Nodes (16): TestTree_SerializeRoundtrip(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+8 more)
...
Cohesion: 0.19
Nodes (9): DefaultCircuitBreakerOptions(), TestDefaultCircuitBreakerOptions(), computeHMAC(), DefaultWebhookSecrets(), NewWebhookPublisher(), WebhookPublisher, WebhookSecrets, init() (+1 more)
...
Cohesion: 0.14
Nodes (10): init(), modal, num, renderTab(), state, TAB_KEYS, renderCompany(), renderTasks() (+2 more)
...
Cohesion: 0.22
Nodes (9): ParseBenchOutput(), TestParseBenchOutput_Empty(), TestParseBenchOutput_FailLine(), TestParseBenchOutput_MetadataSkipped(), TestParseBenchOutput_Microseconds(), TestParseBenchOutput_MultipleLines(), TestParseBenchOutput_NoAllocs(), TestParseBenchOutput_NoBPerOp() (+1 more)
...
Cohesion: 0.29
Nodes (12): baselineCmd(), baselinePath(), checkCmd(), main(), printUsage(), resetCmd(), showCmd(), NewBaselineStore() (+4 more)
...
Cohesion: 0.21
Nodes (9): TestNewGoTestTool_Structure(), TestNewGraphifyTool_Structure(), TestNewShellExecTool_Structure(), TestNewWebSearchTool_Structure(), TestRealTool_Call(), TestRealTool_NameAndDescription(), TestToolStub_CallReturnsEmpty(), TestToolStub_NameDescription() (+1 more)

### Community 188 - "Community 188"
Cohesion: 0.17
Nodes (12): stringContains(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), TestAction_PlanGoapActions_WrongActionsType(), TestAction_ExecuteGoapStep_PastEnd(), TestAction_GoapFallback(), TestAction_PlanGoapActions_EmptyActions(), TestAction_RouteToAllChannels() (+4 more)
...
Cohesion: 0.21
Nodes (8): TestNumberIn_InvalidNumberString(), TestNumberIn_Matching(), TestNumberIn_NotFound(), TestStringIn_Empty(), TestStringIn_Found(), TestStringIn_NotFound(), numberIn(), stringIn()
...
## Knowledge Gaps
- **566 isolated node(s):** `TauBenchEntry`, `TauBenchAction`, `TauBenchTool`, `TauBenchParam`, `TauBenchMetrics` (+561 more)
...
- **Why does `main()` connect `Community 159` to `Community 2`, `Community 5`, `Community 16`, `Community 145`, `Community 18`, `Community 146`, `Community 19`, `Community 20`, `Community 153`, `Community 34`, `Community 180`, `Community 52`, `Community 63`, `Community 66`, `Community 69`, `Community 203`, `Community 222`, `Community 97`, `Community 227`, `Community 100`, `Community 99`, `Community 104`?**
  _High betweenness centrality (0.205) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 71` to `Community 257`, `Community 132`, `Community 5`, `Community 6`, `Community 134`, `Community 149`, `Community 30`, `Community 165`, `Community 39`, `Community 43`, `Community 50`, `Community 180`, `Community 61`, `Community 63`, `Community 64`, `Community 66`, `Community 203`, `Community 81`, `Community 90`, `Community 95`, `Community 97`, `Community 104`, `Community 117`?**
  _High betweenness centrality (0.198) - this node is a cross-community bridge._
- **Why does `BuildTree()` connect `Community 2` to `Community 4`, `Community 132`, `Community 135`, `Community 10`, `Community 11`, `Community 16`, `Community 18`, `Community 23`, `Community 153`, `Community 157`, `Community 159`, `Community 34`, `Community 35`, `Community 163`, `Community 37`, `Community 45`, `Community 70`, `Community 217`, `Community 222`, `Community 102`, `Community 115`, `Community 249`?**
...
- **Are the 93 inferred relationships involving `DefaultTree()` (e.g. with `TestFullTreeIntegration_RunsAllTreesWithRealLLM()` and `TestDomainTree_Registration()`) actually correct?**
  _`DefaultTree()` has 93 INFERRED edges - model-reasoned connections that need verification._
- **Are the 90 inferred relationships involving `sleep()` (e.g. with `TestConfigWatcher_OnChange()` and `TestConfigWatcher_NoChangeNoCallback()`) actually correct?**
  _`sleep()` has 90 INFERRED edges - model-reasoned connections that need verification._
