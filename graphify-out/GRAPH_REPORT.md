# Graph Report - superpowers-20260713T212337-10851188-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-13)

## Corpus Check
- 843 files · ~962,850 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21452 nodes · 32878 edges · 1764 communities (1398 shown, 366 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8372 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9a204b7a`
...
## Communities (1764 total, 366 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (146): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+138 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (146): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+138 more)
...
Cohesion: 0.03
Nodes (102): ApplyJitter(), ClassifyError(), contextDeadlineExceeded(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), ExecuteWithPolicy(), FullJitter() (+94 more)
...
Cohesion: 0.04
Nodes (86): main(), TestBlackboard_AllFields(), TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails(), TestRunTask_Success(), TestIntegration_ReflectionAndPersistence(), reflectOnOutcomeAction(), TestReflectOnOutcomeAction_NilLLM() (+78 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (102): TestDeprecatedHandler_NoSunset(), TestDeprecatedHandler_WithSunsetDate(), DeprecatedHandler(), TestDeprecatedHandler_WithoutSunset(), TestDeprecatedHandler_WithSunset(), NewRequest(), DefaultPanicHandler(), auditKey (+94 more)
...
Cohesion: 0.03
Nodes (21): Server, History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), Registry (+13 more)
...
Cohesion: 0.05
Nodes (74): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+66 more)
...
Cohesion: 0.02
Nodes (86): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+78 more)
...
Cohesion: 0.04
Nodes (64): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+56 more)
...
Cohesion: 0.06
Nodes (56): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree() (+48 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (55): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, biasCandidatesWithExperience(), cloneMetadataForGardener() (+47 more)
...
Cohesion: 0.06
Nodes (62): LoadPipeline(), RunPipeline(), RunPipelineWithID(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), checkLLMHealth() (+54 more)
...
Cohesion: 0.04
Nodes (43): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogin() (+35 more)
...
Cohesion: 0.05
Nodes (64): ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction(), buildChainActionFn() (+56 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (55): AutoRebuildEnabled(), TestOutcomeErrorDetail(), DashboardRebuildTargets(), DefaultRebuildTargets(), OutcomeErrorDetail(), attemptOutcomeError(), endpointsFromCards(), experienceBankDir() (+47 more)
...
Cohesion: 0.07
Nodes (51): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), nlmQuotaExhausted(), nlmQuotaExhaustedUntil(), TestNlmQuotaState_EmptyAndGarbageNotExhausted(), TestNlmQuotaState_ExpiredWindowNotExhausted(), extractConversationID() (+43 more)
...
Cohesion: 0.06
Nodes (31): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), pipelineMockLLM, TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID() (+23 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (22): TestNewPopulation_Evolution(), TestPopulation_Diversity(), TestPopulation_StatsAccessors(), extractTreeType(), TestEvolveWithExperience_NilBankStillEvolves(), TestExtractTreeType(), Individual, cloneTree() (+14 more)
...
Cohesion: 0.05
Nodes (36): Blackboard, ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+28 more)
...
Cohesion: 0.09
Nodes (17): Info(), errTest, errToString(), NewHealthMonitor(), TestHealthMonitorDegradationError(), TestHealthMonitorNilSafety(), TestHealthMonitorProbe(), TestHealthMonitorProbeFailure() (+9 more)
...
Cohesion: 0.11
Nodes (36): jaccardSimilarity(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes(), TestAddFromMutation_NoChange() (+28 more)

### Community 83 - "Community 83"
Cohesion: 0.1
Nodes (11): ExperienceBank, acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), enforceIslandCap(), mergeIslandPopulation(), islandArchive (+3 more)
...
Cohesion: 0.08
Nodes (33): TestBuildPlannerNode_ChainStateGoals(), TestReadGoals_ChainStateFallback(), TestReadGoals_NonListMetadata(), TestReadGoals_Preconditions(), GoalDefinition, GOAPAction, GOAPGoal, Plan (+25 more)
...
Cohesion: 0.13
Nodes (32): isGoapNotebookLMFailure(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery(), nlmIsResearchImport(), nlmIsResearchStart(), nlmPacificDay() (+24 more)

### Community 103 - "Community 103"
Cohesion: 0.1
Nodes (29): NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad(), TestScheduler_NoJobStore_NilSafe(), TestScheduler_PersistenceOnSchedule(), TestScheduler_RestoreJobsOnStartup() (+21 more)
...
Cohesion: 0.09
Nodes (27): Binaries, code:go (type Counter struct { ... }), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }) (+19 more)
...
Cohesion: 0.15
Nodes (21): buildRunActivitySummary(), fencedItems(), isFactLine(), joinCapped(), salientOutputLines(), TestBuildRunActivitySummaryCapsLongFencedLists(), TestBuildRunActivitySummaryEmptyEverything(), TestBuildRunActivitySummaryFailureLeadsWithReason() (+13 more)
...
Cohesion: 0.13
Nodes (16): TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree(), TestWireSelectorReorderIsOptIn() (+8 more)
...
Cohesion: 0.17
Nodes (16): BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir() (+8 more)
...
Cohesion: 0.11
Nodes (10): ErrorCategory, sleepWithContext(), TestErrorCategory_String(), RateLimitError, Backoff(), RetryWithBackoff(), TestBackoff(), TestRetryWithBackoff_Exhausted() (+2 more)
...
Cohesion: 0.2
Nodes (15): goalError(), goalFactory(), goalTreeSlug(), personaStyleHints(), registerGoalTools(), userGoalStore(), injectPersonaContext(), mineUserPatterns() (+7 more)
...
Cohesion: 0.14
Nodes (9): builtinBlocks(), MergeResultsBlock(), ParallelFanoutBlock(), HumanReviewBlock(), MemoryLoadBlock(), MemoryWriteBlock(), QualityGateBlock(), RAGGateBlock() (+1 more)
...
Cohesion: 0.14
Nodes (13): code:go (sel("Phase1_Design",), code:markdown (### Task N: Title), code:go (evolution.SerializableNode{), code:yaml (name: superpowers-prod-runner), code:go (// Deprecated: use ExecuteSuperpowersTaskBatch.), Current Stub Surface To Replace, Done Definition, Migration / Cleanup Notes (+5 more)
...
Cohesion: 0.19
Nodes (12): collectSelectors(), conditionOverlap(), findMainSelector(), TestFindMainSelector(), TestSplitCamelCase(), splitCamelCase(), TestConditionOverlap(), wordSet() (+4 more)
...
Cohesion: 0.31
Nodes (7): foreachTaskLoop(), SuperpowersWorkflowTree(), systematicDebugging(), tddTask(), TestSuperpowersWorkflowTree_ValidatesAndCoversPhases(), withMatch(), TestSuperpowersWorkflowTree_BuildsAndValidates()
...
Cohesion: 0.39
Nodes (6): NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), GlobalTracer()
...
## Knowledge Gaps
- **7347 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7342 more)
...
- **Why does `Append()` connect `Community 10` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 20`, `Community 22`, `Community 23`, `Community 26`, `Community 27`, `Community 29`, `Community 542`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 547`, `Community 36`, `Community 37`, `Community 548`, `Community 39`, `Community 40`, `Community 35`, `Community 545`, `Community 43`, `Community 44`, `Community 45`, `Community 47`, `Community 48`, `Community 49`, `Community 52`, `Community 53`, `Community 564`, `Community 54`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 572`, `Community 571`, `Community 64`, `Community 65`, `Community 67`, `Community 68`, `Community 70`, `Community 71`, `Community 74`, `Community 75`, `Community 77`, `Community 78`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 93`, `Community 94`, `Community 96`, `Community 101`, `Community 103`, `Community 104`, `Community 107`, `Community 115`, `Community 117`, `Community 118`, `Community 120`, `Community 121`, `Community 126`, `Community 127`, `Community 130`, `Community 132`, `Community 134`, `Community 137`, `Community 142`, `Community 143`, `Community 144`, `Community 148`, `Community 151`, `Community 153`, `Community 154`, `Community 155`, `Community 158`, `Community 159`, `Community 162`, `Community 165`, `Community 166`, `Community 172`, `Community 174`, `Community 175`, `Community 176`, `Community 177`, `Community 185`, `Community 186`, `Community 193`, `Community 194`, `Community 199`, `Community 200`, `Community 209`, `Community 726`, `Community 735`, `Community 736`, `Community 737`, `Community 739`, `Community 756`, `Community 763`, `Community 766`, `Community 783`, `Community 784`, `Community 785`, `Community 791`, `Community 363`, `Community 365`, `Community 366`, `Community 367`, `Community 375`, `Community 376`, `Community 377`, `Community 383`, `Community 386`, `Community 392`, `Community 395`, `Community 1004`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 37` to `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 11`, `Community 15`, `Community 17`, `Community 24`, `Community 152`, `Community 26`, `Community 31`, `Community 160`, `Community 42`, `Community 43`, `Community 47`, `Community 176`, `Community 51`, `Community 179`, `Community 59`, `Community 190`, `Community 62`, `Community 63`, `Community 196`, `Community 69`, `Community 73`, `Community 202`, `Community 79`, `Community 210`, `Community 82`, `Community 99`, `Community 103`, `Community 756`, `Community 757`, `Community 121`, `Community 123`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 31` to `Community 2`, `Community 3`, `Community 138`, `Community 11`, `Community 139`, `Community 13`, `Community 395`, `Community 143`, `Community 144`, `Community 1039`, `Community 10`, `Community 23`, `Community 24`, `Community 153`, `Community 26`, `Community 544`, `Community 37`, `Community 166`, `Community 44`, `Community 49`, `Community 179`, `Community 52`, `Community 54`, `Community 183`, `Community 56`, `Community 59`, `Community 66`, `Community 67`, `Community 73`, `Community 202`, `Community 84`, `Community 87`, `Community 103`, `Community 104`, `Community 115`, `Community 118`, `Community 378`?**
...
- **Are the 129 inferred relationships involving `NewRequest()` (e.g. with `TestHITLHandlers_PendingApproveReject()` and `WorkflowApprovalWait()`) actually correct?**
  _`NewRequest()` has 129 INFERRED edges - model-reasoned connections that need verification._