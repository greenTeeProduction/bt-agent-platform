...
## Corpus Check
- 337 files · ~400,002 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5804 nodes · 10882 edges · 291 communities (257 shown, 34 thin omitted)
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 3562 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `62d84678`
...
2. `sleep()` - 84 edges
3. `DefaultTree()` - 77 edges
4. `newDefaultConfig()` - 67 edges
5. `GoDeveloperTree()` - 57 edges
6. `NewGoal()` - 55 edges
7. `condTest()` - 52 edges
8. `NewKnowledgeGraph()` - 48 edges
9. `NewAgentRouter()` - 45 edges
10. `DefaultMock()` - 43 edges
...
## Communities (291 total, 34 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.07
Nodes (96): TestBTPG_QualityMetrics_AllDomainTrees(), TestBFCL_AllDomainTrees_Accuracy(), AlertRouterTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+88 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (63): newDefaultConfig(), TestCheckRuntime_AllEmptyPaths(), TestCheckRuntime_AllOk(), TestCheckRuntime_ConfigFileNotFound(), TestCheckRuntime_CreatedDir_Valid(), TestCheckRuntime_DeepSeekEmptyHost(), TestCheckRuntime_DeepSeekNoOllamaCheck(), TestCheckRuntime_DeepSeekReachable() (+55 more)
...
Cohesion: 0.05
Nodes (47): Config, Duration(), AggregatedTrace, buildAggregatedTrace(), NewTraceReader(), parseRemaining(), ParseTraceEvent(), ParseTraceLine() (+39 more)
...
Cohesion: 0.04
Nodes (36): stringContains(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), execRefineAction(), generatePlanAction(), NewEngine(), RegisterProviders(), TestAction_ExecuteGoapStep_PastEnd(), TestAction_GoapFallback() (+28 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (53): baselineCmd(), baselinePath(), checkCmd(), main(), printUsage(), resetCmd(), showCmd(), BaselineStore (+45 more)
...
Cohesion: 0.06
Nodes (53): condCase, condTest(), TestCondFallback_HasModelToolIssues(), TestCondFallback_HasNewContent(), TestCondFallback_HasSkillGaps(), TestCondFallback_HasStackTrace(), TestCondFallback_HasWorkflowInefficiencies(), TestCondFallback_IsAmbiguousQuery() (+45 more)
...
Cohesion: 0.07
Nodes (50): main(), evidenceVerificationReport, defaultStorageDir(), encodeJSON(), main(), run(), contains(), mustParseTime() (+42 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (48): TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents(), TestBuildFromArchetype(), TestConnect_Duplicate(), TestConnect_MissingNodes() (+40 more)
...
Cohesion: 0.06
Nodes (49): TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure(), TestNewGoTestTool_Structure(), TestNewWebSearchTool_Structure(), TestStripHTML_Attributes(), TestStripHTML_Basic(), TestStripHTML_EmptyString() (+41 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (22): findChildByName(), TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_WithLLM(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords(), TestContainsAnyLower_NoKeywords() (+14 more)
...
Cohesion: 0.1
Nodes (43): main(), makeRecords(), TestCloneTree_Independent(), TestEvaluateTree_AllFailures(), TestEvaluateTree_EmptyRecords(), TestEvaluateTree_GoDevVsDefault(), TestEvaluateTree_Mixed(), TestEvaluateTree_NodeCountPenalty() (+35 more)

### Community 21 - "Community 21"
Cohesion: 0.1
Nodes (35): main(), NewTranspositionTable(), perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree() (+27 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (39): NewConnPool(), NewSharedConnPool(), TestAgentRouter_PooledExecutors_LeastConnections(), TestAgentRouter_WithSharedPool(), TestConnPool_Close(), TestConnPool_CloseIdleConnections(), TestConnPool_CustomConfig(), TestConnPool_DefaultConfig() (+31 more)
...
Cohesion: 0.07
Nodes (32): init(), ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, TestRegisterAction_And_GetAction(), TestRegisterCondition_And_GetCondition() (+24 more)

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (24): BTOptimizer, TestBTOptimizer_New(), TestDTAnalyzer_New(), collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), isDefaultPath() (+16 more)
...
Cohesion: 0.09
Nodes (23): findResponse(), NewRouteIndex(), ResponseValidator(), TestDashboardRoutes_AllIndexable(), TestNewRouteIndex(), TestNewRouteIndex_Empty(), TestResponseValidator_Enforcement_DisabledByDefault(), TestResponseValidator_Enforcement_EnforcesOnViolation() (+15 more)
...
Cohesion: 0.05
Nodes (36): Binaries, code:go (type Counter struct { ... }), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {) (+28 more)

### Community 33 - "Community 33"
Cohesion: 0.08
Nodes (30): handleScalability(), ConcurrencyLimiterStats, TestWorkerPool_PanicRecovery(), QueueStats, NewConcurrencyLimiter(), NewWorkerPool(), TestConcurrencyLimiter_AcquireRelease(), TestConcurrencyLimiter_Available() (+22 more)

### Community 34 - "Community 34"
Cohesion: 0.1
Nodes (35): ContentTypeMiddleware(), CSRFMiddleware(), GenerateCSRFToken(), IPFilterMiddleware(), NewIPFilter(), RequestTimeoutMiddleware(), TestContentTypeMiddleware_AllowsGETWithoutContentType(), TestContentTypeMiddleware_AllowsJSON() (+27 more)
...
Cohesion: 0.14
Nodes (34): cohensD(), DefaultMock(), fishersExact(), GoDevSuite(), minF(), QuickValidate(), RunABTest(), ScoreMutation() (+26 more)

### Community 37 - "Community 37"
Cohesion: 0.07
Nodes (28): handleLogin(), handleLogout(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey (+20 more)

### Community 38 - "Community 38"
Cohesion: 0.1
Nodes (32): AlwaysSample(), NeverSample(), NewRatioSampler(), StringAttr(), TestAlwaysSample(), TestConsoleTracer_BasicSpan(), TestConsoleTracer_ChildSpansNotSampled(), TestConsoleTracer_Concurrent() (+24 more)
...
Cohesion: 0.12
Nodes (33): ChainConfig, ChainKind, BuildChainAction(), buildChainActionFn(), buildToolList(), execAgent(), execConversation(), execLLMCall() (+25 more)
...
Cohesion: 0.08
Nodes (20): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, TestHasChildNamed_DeepNested(), TestHasChildNamed_Found() (+12 more)
...
Cohesion: 0.09
Nodes (30): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AnnotateMetrics(), BootstrapCI(), cloneTree(), CodeReviewSuite() (+22 more)
...
Cohesion: 0.1
Nodes (22): AntiPattern, countTreeNodes(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestPopulation_Evolve(), DesignPattern (+14 more)
...
Cohesion: 0.1
Nodes (25): applyDotEnvFiles(), applyDotEnvToConfig(), applyEnvOverrides(), envBool(), hasExplicitField(), Load(), LoadFile(), LoadFileWithDotEnv() (+17 more)

### Community 60 - "Community 60"
Cohesion: 0.1
Nodes (19): AgentDefinition, ContentType, Schema, MustParseAgentDefinition(), numberIn(), numberValue(), ParseAgentDefinition(), stringIn() (+11 more)
...
Cohesion: 0.1
Nodes (27): TestPriorityQueue_PersistAndReloadViaInterface(), TestPriorityTaskQueue_DequeueEmpty(), TestPriorityTaskQueue_EnqueueDequeue(), TestPriorityTaskQueue_Peek(), TestPriorityTaskQueue_PeekEmpty(), TestPriorityTaskQueue_PurgeViaInterface(), TestPriorityTaskQueue_SamePriorityFIFO(), TestPriorityTaskQueueInterfaceCompliance() (+19 more)
...
Cohesion: 0.09
Nodes (23): cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), TestCloneTreeForGardener_Basic(), TestCloneTreeForGardener_DoubleNested(), TestCloneTreeForGardener_Nil(), TestCloneTreeForGardener_NilMetadata() (+15 more)
...
Cohesion: 0.12
Nodes (27): ArraySchema(), BoolSchema(), IntSchema(), NumberSchema(), ObjectSchema(), TestConvenienceSchemaConstructors(), TestResponseValidator_DriftLogging(), TestResponseValidator_Passes() (+19 more)

### Community 70 - "Community 70"
Cohesion: 0.15
Nodes (26): containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest(), TestRunTask_CacheHit() (+18 more)
...
Cohesion: 0.09
Nodes (22): TestBuiltinSWELite_CoverageAndUniqueness(), TestDetectPath_FromCurrentPath(), TestDetectPath_FromVisitedPaths(), TestDetectPath_KeywordFallback(), TestMax1(), TestBuiltinBFCLSuitesHaveStableShape(), BFCLEntry, BFCLEvalResult (+14 more)
...
Cohesion: 0.13
Nodes (18): DeepeningResult, TestIterativeDeepening_PrunesExplodingTrees(), TestIterativeDeepening_TTHits(), FitnessScore, MutationCandidate, cloneTree(), containsWord(), estimatePathCoverage() (+10 more)

### Community 84 - "Community 84"
Cohesion: 0.09
Nodes (8): consoleSpan, ConsoleTracer, RatioSampler, hashTraceID(), TestHashTraceID_Basic(), TestHashTraceID_MixedCase(), TestHashTraceID_NonHexFallback(), TestHashTraceID_ShortInput()
...
Cohesion: 0.16
Nodes (20): benchmarkSuccessTree(), TestBFCLV3LoadErrorsAndEmptyEvaluation(), TestBFCLV3LoadFlattenAndEvaluate(), TestBuiltinBFCLV3StableShape(), TestIsToolMatchVariants(), TestLoadBFCLSuiteAndEvaluate(), TestLoadBFCLSuiteErrors(), BuiltinBFCLV3() (+12 more)
...
Cohesion: 0.14
Nodes (10): extractTreeType(), jaccardSimilarity(), parseFloat(), TestExtractTreeType(), TestJaccardSimilarity(), TestParseFloat(), TestTokenize(), tokenize() (+2 more)
...
Cohesion: 0.22
Nodes (5): trim(), TestTrim_SpaceVariants(), Factory, extractKeywords(), truncateTask()
...
Cohesion: 0.27
Nodes (18): handleTreeStructure(), TestIntegration_AllTreesExecute(), TestAllFinanceTrees(), TestEarningsReviewer(), TestGLReconciler(), TestKYCScreener(), TestPitchAgent_DCF(), AllFinanceTrees() (+10 more)
...
Cohesion: 0.16
Nodes (12): DefaultBlockConfig(), NewMetaPromptEvolver(), NewMutationContext(), TestApplyDiffMutation(), TestBlockConfig_FilterMutations(), TestBlockConfig_IsMutable(), TestDefaultBlockConfig(), TestMetaPromptEvolver_EvolveTemplates() (+4 more)

### Community 127 - "Community 127"
Cohesion: 0.15
Nodes (14): AgentScore, Runner, Suite, containsErrorPattern(), NewDefaultSuite(), ScoreAgent(), TestScoreAgent(), TestSuite_Failure() (+6 more)
...
Cohesion: 0.3
Nodes (14): extractBulletPoints(), extractFirstLine(), extractListSection(), extractSection(), findNextSection(), parseDebateTranscript(), parseProbability(), parseReport() (+6 more)

### Community 143 - "Community 143"
Cohesion: 0.12
Nodes (15): TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip(), TestDeadLetterQueue_PreserveCategory(), NewDeadLetterQueue(), NewSchedulerState() (+7 more)

### Community 144 - "Community 144"
Cohesion: 0.17
Nodes (12): TestActionForName_BulkCoverage(), Recover(), SafeGo(), TestRecover_CatchesPanic(), TestRecover_NoPanic(), TestRecover_ReturnsErrorWithContext(), TestSafeGo_HandlerPanicIsRecovered(), TestSafeGo_NormalExecution() (+4 more)
...
Cohesion: 0.17
Nodes (12): isKnownActionName(), isKnownConditionName(), TestSideEffectClassOfSubtree_DeepChild(), TestSideEffectClassOfSubtree_MultipleChildren(), TestSideEffectClassOfSubtree_NoSideEffect(), TestSideEffectClassOfSubtree_RootHasClass(), addUniqueError(), sideEffectClass() (+4 more)
...
Cohesion: 0.2
Nodes (8): Blackboard, parseChainConfig(), TestChainAction_ParseConfig(), toolStub, buildNode(), containsAny(), RunTask(), truncateStrForTree()
...
Cohesion: 0.24
Nodes (6): ThinkTankOrchestrator, DebateTree(), FellowResearchTree(), PeerReviewTree(), ReportGenerationTree(), SynthesisTree()
...
Cohesion: 0.19
Nodes (10): TestNewGoVetTool_Structure(), TestNewGraphifyTool_Structure(), TestNewShellExecTool_Structure(), TestRealTool_Call(), TestRealTool_NameAndDescription(), TestToolStub_CallReturnsEmpty(), TestToolStub_NameDescription(), mockAgentTool (+2 more)
...
Cohesion: 0.2
Nodes (11): TestBuiltinSWEVerifiedSample_CoverageAndUniqueness(), TestLoadSWEVerified_Errors(), TestLoadSWEVerifiedAndEvaluate(), minInt(), TestSWEVerified_Evaluation(), BuiltinSWEVerifiedSample(), EvaluateSWEVerified(), LoadSWEVerified() (+3 more)

### Community 176 - "Community 176"
Cohesion: 0.26
Nodes (11): DefaultLLM(), benchmarkPlanTree(), TestGAIABuiltinAndEvaluation(), BuiltinGAIADev(), EvaluateGAIA(), TestBFCL_CodeReview_Routing(), TestBFCL_Multiple_Routing(), TestBFCL_Relevance_NoFalsePositives() (+3 more)
...
Cohesion: 0.27
Nodes (6): computeHMAC(), DefaultWebhookSecrets(), NewWebhookPublisher(), WebhookPublisher, WebhookSecrets, main()
...
Cohesion: 0.22
Nodes (9): handleAgentExecute(), handleAgentRun(), handleAnalyze(), handleSprintExecute(), handleTaskCreate(), AgentExecutor, NewAgentExecutor(), PickTreeForTask() (+1 more)
...
Cohesion: 0.31
Nodes (8): TestRouting_Research(), TestTree_Research(), TestAllResearchTrees(), TestDeepResearch(), TestQuickResearch(), DeepResearchTree(), QuickResearchTree(), ResearchTrees()
...
Cohesion: 0.22
Nodes (9): LoadDotEnv(), TestLoadDotEnv_Basic(), TestLoadDotEnv_CommentsAndBlanks(), TestLoadDotEnv_EmptyFile(), TestLoadDotEnv_ExportPrefix(), TestLoadDotEnv_InlineComments(), TestLoadDotEnv_MissingFile(), TestLoadDotEnv_QuotedValues() (+1 more)
...
Cohesion: 0.36
Nodes (8): runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis(), TestTeslaMarket(), TestTeslaModel(), TestTeslaPitchAgent(), TestTeslaValuation(), trunc()
...
## Knowledge Gaps
- **555 isolated node(s):** `TauBenchEntry`, `TauBenchAction`, `TauBenchTool`, `TauBenchParam`, `TauBenchMetrics` (+550 more)
...
- **Why does `main()` connect `Community 185` to `Community 3`, `Community 10`, `Community 139`, `Community 13`, `Community 143`, `Community 16`, `Community 272`, `Community 18`, `Community 17`, `Community 20`, `Community 24`, `Community 27`, `Community 159`, `Community 165`, `Community 45`, `Community 61`, `Community 70`, `Community 208`, `Community 96`, `Community 108`, `Community 112`, `Community 123`, `Community 124`?**
  _High betweenness centrality (0.225) - this node is a cross-community bridge._
- **Why does `BuildTree()` connect `Community 10` to `Community 136`, `Community 8`, `Community 13`, `Community 272`, `Community 148`, `Community 24`, `Community 25`, `Community 155`, `Community 157`, `Community 162`, `Community 175`, `Community 176`, `Community 53`, `Community 185`, `Community 58`, `Community 198`, `Community 70`, `Community 203`, `Community 75`, `Community 79`, `Community 208`, `Community 87`, `Community 88`, `Community 217`, `Community 232`, `Community 111`, `Community 112`, `Community 113`, `Community 125`?**
  _High betweenness centrality (0.198) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 50` to `Community 3`, `Community 4`, `Community 136`, `Community 143`, `Community 272`, `Community 23`, `Community 30`, `Community 33`, `Community 34`, `Community 165`, `Community 37`, `Community 61`, `Community 63`, `Community 196`, `Community 94`, `Community 95`, `Community 96`, `Community 98`, `Community 109`, `Community 123`?**
...
- **Are the 82 inferred relationships involving `sleep()` (e.g. with `writeConfigFile()` and `TestConfigWatcher_OnChange()`) actually correct?**
  _`sleep()` has 82 INFERRED edges - model-reasoned connections that need verification._
- **Are the 76 inferred relationships involving `DefaultTree()` (e.g. with `TestTree_DefaultStructure()` and `TestOutcome_Success()`) actually correct?**
  _`DefaultTree()` has 76 INFERRED edges - model-reasoned connections that need verification._
- **Are the 63 inferred relationships involving `newDefaultConfig()` (e.g. with `TestSaveFile_Roundtrip()` and `TestValidate_OllamaProvider_NoHost()`) actually correct?**
  _`newDefaultConfig()` has 63 INFERRED edges - model-reasoned connections that need verification._