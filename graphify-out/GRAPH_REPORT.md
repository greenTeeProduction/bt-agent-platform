# Graph Report - superpowers-20260713T205534-1d2ca422-goap-fusion-loop-runner-blackboard-conte  (2026-07-13)

## Corpus Check
- 843 files · ~959,633 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21388 nodes · 32799 edges · 1776 communities (1410 shown, 366 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8360 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cec4804c`
...
3. `NewRequest()` - 128 edges
4. `NewKnowledgeGraph()` - 123 edges
5. `BuildTree()` - 111 edges
6. `registerMCPTools()` - 104 edges
7. `newDefaultConfig()` - 100 edges
8. `sleep()` - 95 edges
9. `arc42 Section 9 — Architecture Decisions` - 84 edges
10. `main()` - 78 edges
...
## Communities (1776 total, 366 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (145): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+137 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (145): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+137 more)
...
Cohesion: 0.04
Nodes (111): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+103 more)
...
Cohesion: 0.05
Nodes (71): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle() (+63 more)
...
Cohesion: 0.04
Nodes (85): main(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext() (+77 more)
...
Cohesion: 0.05
Nodes (82): DefaultLLM(), RealLLM(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic(), TestBFCLV3_MultiTurn_Composite() (+74 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (65): handleSprintExecute(), main(), main(), Info(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior() (+57 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (77): truncateGoap(), arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), collapseToSingleLine() (+69 more)
...
Cohesion: 0.03
Nodes (43): GateResult, Outcome, RestoreTree(), SnapshotTree(), TestSnapshotAndRestoreTree(), Record, FilterByTreeName(), Config (+35 more)
...
Cohesion: 0.02
Nodes (84): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+76 more)
...
Cohesion: 0.05
Nodes (58): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, fakeClaude, fakeCommitRunner, hookFailureClass, applySuperpowersRunFromBareRepo() (+50 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (65): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_New(), TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents(), TestBuildFromArchetype() (+57 more)
...
Cohesion: 0.05
Nodes (68): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+60 more)
...
Cohesion: 0.04
Nodes (54): ActionFunc, ActionProvider, init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), ConditionFunc, ConditionProvider, init() (+46 more)

### Community 29 - "Community 29"
Cohesion: 0.08
Nodes (64): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+56 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (57): countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New() (+49 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (59): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection() (+51 more)
...
Cohesion: 0.06
Nodes (58): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField() (+50 more)
...
Cohesion: 0.06
Nodes (51): perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree() (+43 more)
...
Cohesion: 0.15
Nodes (53): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+45 more)
...
Cohesion: 0.05
Nodes (53): DefaultMock(), TestRunSuiteIsSandboxed(), findNode(), resolverReachableExtraDomainTrees(), singleTaskSuite(), tasksForTree(), TestAgentMonitor(), TestAllDomainTreeConditionsHaveDescriptions() (+45 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (18): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, DeadLetterEntry, DeadLetterQueue, executorFailureState, ExecutorHealthDetail (+10 more)
...
Cohesion: 0.06
Nodes (35): TestReadGoals_ChainStateFallback(), TestReadGoals_InvalidItemInList(), TestReadGoals_NonListMetadata(), TestReadGoals_Preconditions(), GoalDefinition, GOAPAction, GOAPGoal, Plan (+27 more)

### Community 52 - "Community 52"
Cohesion: 0.15
Nodes (43): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Finance(), TestRouting_Research() (+35 more)
...
Cohesion: 0.09
Nodes (44): extractTaskID(), init(), nlmAuthNeedsRefresh(), nlmAuthUnhealthy(), registerNotebookLMActions(), writeString(), recentImplementedGoals(), superpowersPlanAlreadyImplemented() (+36 more)
...
Cohesion: 0.09
Nodes (41): NewAgent(), NewDocPlanner(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory(), TestAgentNoPlan() (+33 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (28): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogin() (+20 more)
...
Cohesion: 0.1
Nodes (36): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad() (+28 more)
...
Cohesion: 0.09
Nodes (30): RegistryDir(), SchedulerJobsFile(), TemplatesDir(), TestPathHelpers(), TestRemoveAgentJobs(), TestResolvePipelineAgent_Aliases(), TestApplySchedule_PersistsRegistryAndJobs(), TestDeleteRegisteredAgent() (+22 more)
...
Cohesion: 0.09
Nodes (37): biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), crisisMetricsGardener(), crisisV2Config() (+29 more)
...
Cohesion: 0.1
Nodes (34): mockOrch, NewWorkflow(), TestApproval_Fields(), TestApproveTask(), TestExecuteSprint(), TestExecuteSprint_ApprovedToCompleted(), TestExecuteSprint_NoApprovedTasks(), TestExecuteSprint_SetsGoal() (+26 more)
...
Cohesion: 0.07
Nodes (29): init(), TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure(), TestValidateOutputQualityRejectsRefusals(), collectNames() (+21 more)
...
Cohesion: 0.12
Nodes (26): TestCompiledPlanTree_ValidatesAndRuns(), registerGoapNodes(), convertGoapChildren(), FromGoapNode(), GOAPDevOpsTree(), GOAPPlanningTree(), GOAPResearchTree(), Blackboard (+18 more)
...
Cohesion: 0.07
Nodes (22): alwaysSampler, Attr, neverSampler, noopSpan, noopTracer, Sampler, Span, SpanContext (+14 more)
...
Cohesion: 0.14
Nodes (26): agentNameInterceptor, agentNameKey, ScoreAnnouncement(), BTAgentExecutor, cardResponder, NewServer(), parseAnnouncement(), RespondToAnnouncement() (+18 more)

### Community 121 - "Community 121"
Cohesion: 0.13
Nodes (23): TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), TestQualityGateConsecutiveFails(), TestQualityGateDisabledWithZeroThreshold(), TestQualityGateReset() (+15 more)
...
Cohesion: 0.17
Nodes (28): handleMetricsLive(), Collect(), indexOf(), GoapFusionPreflightNode(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionGatesClaudeImplementation(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionNotebookGuardsNonFatal(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesCircuitBreaker(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesCircuitPolicy() (+20 more)
...
Cohesion: 0.13
Nodes (9): errToString(), TestStatusString(), HealthMonitor, HealthState, HealthStatus, Debug(), Error(), L() (+1 more)
...
Cohesion: 0.14
Nodes (19): AgentMetrics, AgentStats, BuildIdentity, HealthResponse, LabeledGauge, exposedBuildIdentity(), formatPromLabels(), GetAgentMetrics() (+11 more)

### Community 156 - "Community 156"
Cohesion: 0.2
Nodes (22): GetSLOMetrics(), DefaultValidationGateConfig(), TestValidationGate_EvidenceForOtherTreeOnly_FailsClosed(), TestValidationGate_FileEvidence_AggregatesAcrossAgents(), TestValidationGate_FileEvidence_LowSuccessRate_Rejects(), TestValidationGate_FileEvidence_Passes(), TestValidationGate_NoMemoryNoFile_FailsClosed(), writeEvidenceFile() (+14 more)
...
Cohesion: 0.13
Nodes (17): injectPersonaContext(), mineUserPatterns(), personaEmbedder(), personaError(), recordPersonaInteraction(), registerPersonaTools(), NewHabitMiner(), NewLog() (+9 more)
...
Cohesion: 0.22
Nodes (17): NewBTAgentClient(), TestA2AServer_HandleAgentEndpoint_EmptyName(), TestA2AServer_HandleAgentEndpoint_UnknownAgent(), TestA2AServer_HandleHealth_Direct(), TestA2AServer_HandleWellKnown(), TestA2AServer_Stop(), TestBTAgentClient_DiscoverAgents_EmptyURL(), TestBTAgentClient_DiscoverAgents_NoServer() (+9 more)
...
Cohesion: 0.16
Nodes (6): Task, NewTaskStore(), priorityRank(), TestTaskStore_ApprovedOrdersByPriorityThenSprint(), TestTaskStore_ApproveRejectAuditPersistsAcrossSaveLoad(), TaskStore
...
Cohesion: 0.13
Nodes (6): AllSLOMetrics(), contains(), stringsContains(), TestAllSLOMetrics(), TestGetSLOMetrics_SameInstance(), TestSLOMetrics_Summary()
...
Cohesion: 0.2
Nodes (13): TestBuildIdentityStampedRevisionFallback(), BuildIdentityFromBuildInfo(), InstallBuildIdentity(), ReadBuildIdentity(), SetBuildIdentity(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered(), TestBlockDurationHistogramSeriesRendered() (+5 more)
...
Cohesion: 0.15
Nodes (13): code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), Package: evaluator (+5 more)
...
Cohesion: 0.21
Nodes (6): LoadSLOEvidence(), SaveSLOMetrics(), TestLoadSLOEvidence_MissingFile(), TestSaveSLOMetrics_AtomicNoTmpLeftBehind(), TestSaveSLOMetrics_LoadSLOEvidence_Roundtrip(), SLOSnapshot
...
Cohesion: 0.26
Nodes (10): WorkflowsDir(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep() (+2 more)
...
Cohesion: 0.28
Nodes (6): handleTaskCreate(), isAuctionShapedTask(), PickTreeForTask(), ResolveAgentName(), TestPickTreeForTask_NonAuctionTasksUnaffected(), TestPickTreeForTask_RoutesAuctionShapedTasksToAuctionDemo()
...
Cohesion: 0.25
Nodes (8): code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), Package: goap, Package: langagent, Package: reflection, Package: validate
...
## Knowledge Gaps
- **7306 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7301 more)
...
- **Why does `Append()` connect `Community 15` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 16`, `Community 18`, `Community 20`, `Community 24`, `Community 26`, `Community 28`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 39`, `Community 40`, `Community 556`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 559`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 565`, `Community 54`, `Community 57`, `Community 570`, `Community 58`, `Community 59`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 69`, `Community 583`, `Community 72`, `Community 73`, `Community 585`, `Community 75`, `Community 71`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 591`, `Community 83`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 593`, `Community 90`, `Community 91`, `Community 94`, `Community 96`, `Community 1120`, `Community 104`, `Community 106`, `Community 108`, `Community 114`, `Community 115`, `Community 116`, `Community 119`, `Community 125`, `Community 126`, `Community 128`, `Community 133`, `Community 135`, `Community 138`, `Community 139`, `Community 147`, `Community 151`, `Community 154`, `Community 155`, `Community 157`, `Community 159`, `Community 162`, `Community 169`, `Community 172`, `Community 173`, `Community 174`, `Community 175`, `Community 176`, `Community 185`, `Community 191`, `Community 192`, `Community 194`, `Community 197`, `Community 200`, `Community 202`, `Community 205`, `Community 206`, `Community 216`, `Community 218`, `Community 742`, `Community 751`, `Community 764`, `Community 770`, `Community 787`, `Community 788`, `Community 791`, `Community 792`, `Community 798`, `Community 799`, `Community 807`, `Community 365`, `Community 366`, `Community 368`, `Community 370`, `Community 371`, `Community 372`, `Community 378`, `Community 380`, `Community 383`, `Community 385`, `Community 386`, `Community 387`, `Community 392`, `Community 393`, `Community 394`, `Community 587`, `Community 397`, `Community 404`, `Community 405`, `Community 409`, `Community 1013`, `Community 1017`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 31` to `Community 2`, `Community 3`, `Community 134`, `Community 8`, `Community 137`, `Community 12`, `Community 13`, `Community 15`, `Community 149`, `Community 22`, `Community 155`, `Community 1051`, `Community 30`, `Community 160`, `Community 162`, `Community 41`, `Community 173`, `Community 48`, `Community 52`, `Community 182`, `Community 184`, `Community 57`, `Community 185`, `Community 60`, `Community 190`, `Community 65`, `Community 68`, `Community 201`, `Community 79`, `Community 86`, `Community 1121`, `Community 106`, `Community 110`, `Community 115`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 68` to `Community 2`, `Community 3`, `Community 771`, `Community 4`, `Community 8`, `Community 11`, `Community 13`, `Community 402`, `Community 147`, `Community 149`, `Community 22`, `Community 153`, `Community 156`, `Community 31`, `Community 160`, `Community 168`, `Community 41`, `Community 169`, `Community 42`, `Community 47`, `Community 48`, `Community 176`, `Community 55`, `Community 56`, `Community 67`, `Community 198`, `Community 200`, `Community 585`, `Community 74`, `Community 79`, `Community 209`, `Community 210`, `Community 84`, `Community 95`, `Community 110`, `Community 117`, `Community 120`, `Community 382`?**
...
- **Are the 127 inferred relationships involving `NewRequest()` (e.g. with `TestHITLHandlers_PendingApproveReject()` and `WorkflowApprovalWait()`) actually correct?**
  _`NewRequest()` has 127 INFERRED edges - model-reasoned connections that need verification._