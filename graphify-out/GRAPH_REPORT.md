# Graph Report - superpowers-20260719T033040-3ff33b8e-goap-fusion-loop-runner-blackboard-conte  (2026-07-19)

## Corpus Check
- 932 files · ~1,248,372 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27817 nodes · 41410 edges · 2161 communities (1803 shown, 358 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9834 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f20803dd`
...
1. `Append()` - 392 edges
2. `9. Architecture Decisions` - 180 edges
3. `NewKnowledgeGraph()` - 155 edges
4. `DefaultTree()` - 152 edges
5. `NewRequest()` - 148 edges
6. `registerMCPTools()` - 147 edges
...
- `TestSuperpowersRuntime_GoapFusionPreflightNodeComposesBuildTreeMaterializer()` --calls--> `References`  [INFERRED]
  internal/engine/superpowers_runtime_contract_test.go → docs/adr/ADR-008-composable-blocks.md
...
## Communities (2161 total, 358 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (226): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+218 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (226): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+218 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (173): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+165 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (20): agentTestMockLLM, chainMockLLM, countedErrorMockLLM, emptyDecomposeMockLLM, errorMockLLM, flakyDecomposeMockLLM, flakyOnceMockLLM, flakyRefineMockLLM (+12 more)
...
Cohesion: 0.02
Nodes (99): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+91 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (110): TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), perTreeStats(), setupGardener(), TestBenchmarkMockIntegration() (+102 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (86): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Block, TestComposeAndExpand(), Category, Compose(), ComposeFromRefs(), ComposeTaskTree() (+78 more)
...
Cohesion: 0.04
Nodes (97): TestArc42ReadGraphReport_UsesCanonicalGoapFusionReportPath(), init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), TestParseSplitOutput(), validateDesignAction(), validateDesignHeadings(), arc42SeedTargetGoal() (+89 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (94): auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext(), AuditMiddleware() (+86 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (92): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+84 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (83): registerSuperpowersProductionActions(), registerSuperpowersVerificationActions(), autofixScriptRunner, autofixScriptStep, TestCurrentSuperpowersRunRefusesFinishedRun(), killedClaudeRunner, scriptedClaudeRunner, scriptedSuperpowersRunner (+75 more)
...
Cohesion: 0.05
Nodes (79): Duration(), TestDuration(), countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype() (+71 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (79): DefaultLLM(), RealLLM(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic(), TestBFCLV3_MultiTurn_Composite() (+71 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (63): main(), BTStudioCompany(), requireOllamaFinanceTest(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis(), TestTeslaMarket(), TestTeslaModel() (+55 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (81): biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip(), TestDeadLetterQueue_PreserveCategory(), NewAgentRouter() (+73 more)
...
Cohesion: 0.05
Nodes (76): alwaysSampler, Attr, TestConsoleTracer_ExporterReceivesCompletedSpan(), fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200() (+68 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (74): brokenTool, ChainConfig, ChainKind, bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction(), buildChainActionFn() (+66 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (69): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+61 more)

### Community 23 - "Community 23"
Cohesion: 0.1
Nodes (64): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42DocsyncTree(), TestArc42DocsyncTreeRegistered(), TestArc42DocsyncTreeShape(), Arc42SeederTree(), Arc42Trees(), assembleDoc() (+56 more)
...
Cohesion: 0.06
Nodes (70): blockOnHeldServerLock(), echoTaskLeaf, islandArchivePath(), persistEvolvedWinner(), registerMCPTools(), assertExpertArchiveFedFromRun(), injectSelectorProbeTree(), seedSelectorProbeStats() (+62 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (41): cacheCheckAction(), cacheResultAction(), execLLMCallAction(), execRefineAction(), generatePlanAction(), knowledgeQueryAction(), NewEngine(), RegisterProviders() (+33 more)
...
Cohesion: 0.07
Nodes (58): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), stripGoapGoalTransientNotes(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget() (+50 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (52): main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+44 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (59): AgentDefinition, ContentType, TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestMustParseAgentDefinition_PanicsOnInvalid(), TestMustParseAgentDefinition_Valid() (+51 more)
...
Cohesion: 0.07
Nodes (53): TestRunSuiteIsSandboxed(), init(), registerStockfishActions(), TestNoNewGapsOrImplDegraded_IsFallbackEligibleGuard(), init(), banditChildKey(), banditLockFor(), banditStatsDir() (+45 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (56): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_New(), TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents(), TestBuildFromArchetype() (+48 more)
...
Cohesion: 0.04
Nodes (36): findChildByName(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords(), TestContainsAnyLower_NoKeywords(), TestContainsAnyLower_NoMatch(), TestContainsAnyLower_Substring() (+28 more)

### Community 36 - "Community 36"
Cohesion: 0.07
Nodes (57): AgentBus, AgentEvent, InitAgentBus(), PublishHealthAlert(), PublishServiceDown(), TestAgentBus_AllSubscribersReceiveAll(), TestAgentBus_CloseSubscriberChannelsClosed(), TestAgentBus_ConcurrentPublish() (+49 more)

### Community 37 - "Community 37"
Cohesion: 0.07
Nodes (61): buildGoapFusionNotebookLMQuery(), buildGrillRound1Query(), buildClaudeReviewPrompt(), TestBuildClaudeReviewPrompt_ContractMarkers(), implementedGoalsPromptBlock(), arc42GoalsPromptBlock(), arc42ResearchTopics(), loadArc42QualityGoals() (+53 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (35): AllSLOMetrics(), GetSLOMetrics(), contains(), stringsContains(), TestAllSLOMetrics(), TestGetSLOMetrics_SameInstance(), TestSLOMetrics_Summary(), LoadSLOEvidence() (+27 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (23): AgentMetric, Alert, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts() (+15 more)
...
Cohesion: 0.05
Nodes (44): TestOutcomeErrorDetail(), FeedbackFile(), OutcomeErrorDetail(), TestLocalAgentResultNilResultAndSuccessPathsUnchanged(), TestLocalAgentResultPreservesOutcomeOnError(), attemptOutcomeError(), buildSchedulerConfig(), dlqReplayOutcomeError() (+36 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (57): DefaultMock(), conditionDescriptionGaps(), findNode(), resolverReachableExtraDomainTrees(), singleTaskSuite(), tasksForTree(), TestAgentMonitor(), TestAllDomainTreeConditionsHaveDescriptions() (+49 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (42): newAgentExecutor(), agentExecuteResult(), dashboardLocalAgentResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute() (+34 more)
...
Cohesion: 0.07
Nodes (52): buildClaudeFusionPrompt(), changedGoapPackages(), nlmQuotaExhausted(), nlmQuotaExhaustedUntil(), TestNlmQuotaState_EmptyAndGarbageNotExhausted(), TestNlmQuotaState_ExpiredWindowNotExhausted(), extractConversationID(), extractGoapGoals() (+44 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (38): GateResult, ListRevisions(), loadSnapshotIndex(), RestoreTree(), RestoreTreeRevision(), saveSnapshotIndex(), snapshotIndexPath(), snapshotRevisionPath() (+30 more)
...
Cohesion: 0.06
Nodes (44): init(), registerSuperpowersDebugActions(), superpowersDebugPhase(), superpowersDebugPhaseAction(), TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath() (+36 more)

### Community 49 - "Community 49"
Cohesion: 0.07
Nodes (30): TestMatchBlockPattern(), AntiPattern, DesignPattern, BlockIDFromRef(), containsStr(), coreHeuristics(), hasNodeMatching(), hasNodeType() (+22 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (32): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_FeedbackPersistenceArmed(), TestBuildGardenerConfig_KnowledgeGraphWired(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired() (+24 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (39): CategorizedError, ErrorContext, ClassifyError(), contextDeadlineExceeded(), isAuthError(), isLLMError(), isNetworkError(), isRateLimitError() (+31 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (37): convertGoapChildren(), FromGoapNode(), GOAPDevOpsTree(), GOAPPlanningTree(), GOAPResearchTree(), Blackboard, BlackboardBridge, BTNodeType (+29 more)

### Community 53 - "Community 53"
Cohesion: 0.07
Nodes (45): AggregatedTrace, buildAggregatedTrace(), NewTraceReader(), parseRemaining(), ParseTraceEvent(), ParseTraceLine(), BenchmarkParseTraceLine(), BenchmarkTraceReader_ReadRecent() (+37 more)

### Community 54 - "Community 54"
Cohesion: 0.14
Nodes (44): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+36 more)

### Community 55 - "Community 55"
Cohesion: 0.08
Nodes (51): BuildEventDrivenAbort(), evaluateEventCondition(), evaluateEventPredicate(), evaluatePredicate(), eventMatches(), parseEventSources(), TestBuildEventDrivenAbort_BlackboardKeyCondition(), TestBuildEventDrivenAbort_BlackboardKeyNotPresent() (+43 more)
...
Cohesion: 0.05
Nodes (39): ActionFunc, ActionProvider, docChangeContextFromBlackboard(), init(), registerArc42SyncNode(), TestArc42DocsyncNodesRegistered(), TestDocChangeContextFromBlackboardFallsBackToGit(), ConditionFunc (+31 more)

### Community 58 - "Community 58"
Cohesion: 0.09
Nodes (20): extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), collectNodeNames(), containsCrisisReason(), Crossover(), ExperienceRetrievalHits() (+12 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (39): UsersDir(), TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), automationApproved(), AutomationBlocked(), init(), ReflectionsPath(), ResolveGeneratedTree() (+31 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (35): FileJobStore, JobStore, TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves(), NewFileJobStore(), NewReadOnlyJobStore() (+27 more)

### Community 61 - "Community 61"
Cohesion: 0.06
Nodes (27): cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask(), serializeTreeForGardener(), TestCloneTreeForGardener_Basic(), TestCloneTreeForGardener_DoubleNested() (+19 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (5): TestEndpointsFromCardsSingleNodeYieldsNoPeers(), AgentRouter, CircuitBreaker, LocalExecutor, NewRouterFromEndpoints()

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (38): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestRecordUserFeedback_FlaggedForReviewEscalatesAndPausesAutomation(), TestRecordUserFeedback_FlaggedForReviewNoAutomationTracked(), ApplyHITLPolicy() (+30 more)

### Community 64 - "Community 64"
Cohesion: 0.08
Nodes (26): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports(), RunContext (+18 more)

### Community 65 - "Community 65"
Cohesion: 0.08
Nodes (36): NewDefaultCompany(), CompanyOrchestrator, CompanyState, Decision, EngineerTree(), MarketingTree(), SalesTree(), StartupTrees() (+28 more)

### Community 66 - "Community 66"
Cohesion: 0.09
Nodes (42): okCommand, panicCommand, ParallelMode, intSliceFromInterface(), BuildReactiveParallel(), childPanicHandler(), forkBlackboard(), intSliceFromInterface() (+34 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (35): BuildBudget(), budgetCmd, BuildCachedCondition(), BuildCircuitBreaker(), BuildInverter(), BuildRepeater(), BuildRunner(), BuildSucceeder() (+27 more)

### Community 68 - "Community 68"
Cohesion: 0.09
Nodes (34): NewAgent(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory(), TestAgentNoPlan(), TestAgentSimpleExecution() (+26 more)
...
Cohesion: 0.09
Nodes (35): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, applySuperpowersRunToMainRepo(), assertNoForcedMasterWrite(), bareTestRun(), TestApplySuperpowersRunBareRepoDetachedHeadDoesNotRebase() (+27 more)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (37): ctxAwareBlockingRunner, buildErrorHandlerPrompt(), errorHandlerCooldown(), errorHandlerEnabled(), errorHandlerMaxNodes(), errorHandlerNodeDepth(), errorHandlerSignatureFromBB(), firstTickedLeaf() (+29 more)
...
Cohesion: 0.07
Nodes (26): TestIsBreakerSuccess(), exportMemoryCategory(), exportPreviousRuns(), ResolvePipelineAgent(), RunDeps, applyOutcomeRefinement(), IsHealthyOutcome(), IsRateLimitCarryover() (+18 more)

### Community 74 - "Community 74"
Cohesion: 0.1
Nodes (36): agentNameInterceptor, agentNameKey, ScoreAnnouncement(), BTAgentExecutor, cardResponder, rpcRequest, rpcResponse, failureEventMessage() (+28 more)

### Community 75 - "Community 75"
Cohesion: 0.08
Nodes (32): NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation(), TestCrisisDetector_DetectPopulation_DiversityCollapse() (+24 more)
...
Cohesion: 0.09
Nodes (42): callArc42Action(), isolateGoapFusionGraphReport(), TestArc42Action_CollectAllSections_NilChainState(), TestArc42Action_CollectAllSections_NoFiles(), TestArc42Action_DetectHardware(), TestArc42Action_DetectProcesses(), TestArc42Action_GenerateTOC(), TestArc42Action_GitHistory() (+34 more)

### Community 78 - "Community 78"
Cohesion: 0.07
Nodes (39): TestBuiltinSWELite_CoverageAndUniqueness(), TestMax1(), benchmarkPlanTree(), benchmarkSuccessTree(), TestBFCLV3LoadErrorsAndEmptyEvaluation(), TestBFCLV3LoadFlattenAndEvaluate(), TestBuiltinBFCLSuitesHaveStableShape(), TestBuiltinBFCLV3StableShape() (+31 more)

### Community 79 - "Community 79"
Cohesion: 0.08
Nodes (36): Analysis, Contradiction, CoveragePoint, fakeCaller, flakyCaller, TestJudge_ParsesStructuredJSON(), TestJudge_RejectsInvalidJSON(), TestJudge_RetriesTransientFailure() (+28 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (30): Blackboard, ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+22 more)

### Community 81 - "Community 81"
Cohesion: 0.08
Nodes (36): buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), defaultNlmGrillAuthGuard(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), markGoapFusionImplDegraded() (+28 more)

### Community 82 - "Community 82"
Cohesion: 0.09
Nodes (39): growthFitness(), FitnessDimension, NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic() (+31 more)

### Community 83 - "Community 83"
Cohesion: 0.1
Nodes (17): TestDetermineCategory(), TestExtractKeywords(), TestTruncateTask(), Factory, AutoCreateTree(), AutoCreateTreeWith(), containsAnyStr(), determineCategory() (+9 more)
...
Cohesion: 0.09
Nodes (32): TestNumberSchema(), ArraySchema(), BoolSchema(), IntSchema(), NumberSchema(), ObjectSchema(), TestConvenienceSchemaConstructors(), findResponse() (+24 more)

### Community 86 - "Community 86"
Cohesion: 0.12
Nodes (38): escalateFlaggedTreeForReview(), finalizeFeedbackEscalation(), recordUserFeedback(), registerFeedbackTools(), newFeedbackDeps(), TestBTFeedbackRegistered(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), TestRecordUserFeedback_FeedsSatisfactionAndFlags() (+30 more)
...
Cohesion: 0.07
Nodes (34): Embedding, EmbeddingClient, CosineSimilarity(), hammerRegister(), TestBuildIndex_ConcurrentRegisterNoRace(), TestBuildIndex_PanicRecovered(), TestCosineSimilarity_BothZero(), TestCosineSimilarity_DifferentLengths() (+26 more)

### Community 89 - "Community 89"
Cohesion: 0.13
Nodes (33): boolDetail(), containsExactOrKey(), errDetail(), flatten(), jobRuns(), jobRunsAll(), jobUsesOrRuns(), loadDependabotConfig() (+25 more)
...
Cohesion: 0.07
Nodes (35): stringContains(), TestBuildGoapStepPrompt(), TestPlanStepsToStrings(), TestPlanStepsToStrings_Empty(), TestWorldStateFromMap(), buildGoapStepPrompt(), getStepResults(), planStepsToStrings() (+27 more)

### Community 93 - "Community 93"
Cohesion: 0.1
Nodes (35): TestBuildGoalDrivenImplementationPlanIgnoresReuseNotePathsForFileScope(), TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull(), TestBrainstormRejectedWhenFilesNotGoPath(), TestBrainstormRejectedWhenMalformedOrProse(), TestBrainstormRejectedWhenNotDeeper(), TestBrainstormRejectedWhenRunOmitsShort(), withBrainstorm() (+27 more)

### Community 94 - "Community 94"
Cohesion: 0.09
Nodes (12): jaccardSimilarity(), TestJaccardSimilarity(), TestTokenize(), tokenize(), ExperienceBank, ExperienceEntry, acquireExperienceLock(), TestAcquireExperienceLockMissingDir() (+4 more)
...
Cohesion: 0.12
Nodes (37): buildSelfReviewPrompt(), canonicalSelfReviewSig(), defaultSelfReviewDeps(), extractSelfReviewFindingsArray(), filterAutonomousCommits(), init(), loadSelfReviewState(), normalizeSelfReviewTitle() (+29 more)
...
Cohesion: 0.07
Nodes (34): TestBuildPlannerNode_ChainStateGoals(), TestReadGoals_ChainStateFallback(), TestReadGoals_InvalidItemInList(), TestReadGoals_NonListMetadata(), TestReadGoals_Preconditions(), GoalDefinition, GOAPAction, GOAPGoal (+26 more)

### Community 101 - "Community 101"
Cohesion: 0.11
Nodes (37): TestWalkValidate_DepthLimitExceeded(), TestWalkValidate_DestroySideEffectNoGate(), TestWalkValidate_ExternalSideEffectNoGate(), TestWalkValidate_HumanApprovalGateSetsFlag(), TestWalkValidate_KnownNodeTypePasses(), TestWalkValidate_MaxRetriesLimitExceeded(), TestWalkValidate_NilNode(), TestWalkValidate_NodeCountLimitExceeded() (+29 more)

### Community 102 - "Community 102"
Cohesion: 0.09
Nodes (34): buildRunActivitySummary(), fencedItems(), isFactLine(), joinCapped(), salientOutputLines(), TestBuildRunActivitySummaryCapsLongFencedLists(), TestBuildRunActivitySummaryEmptyEverything(), TestBuildRunActivitySummaryFailureLeadsWithReason() (+26 more)
...
Cohesion: 0.08
Nodes (28): TraceParent, traceParentSpan, ContextWithTraceParent(), ExtractTraceParentFromRequest(), ExtractTraceStateFromRequest(), GenerateSpanID(), GenerateTraceID(), GenerateTraceParent() (+20 more)

### Community 106 - "Community 106"
Cohesion: 0.11
Nodes (30): TestDriftWatchOnce_SkipsRestartWhenJobStartedMidRebuild(), TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir() (+22 more)

### Community 107 - "Community 107"
Cohesion: 0.1
Nodes (28): handleAnalyze(), handleFellows(), handleWorkflowRunFullPipeline(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation(), TestHandleWorkflowRunFullPipeline_PersistsWorkflowAndTasks(), NewMockLLM(), DebateTurn (+20 more)

### Community 108 - "Community 108"
Cohesion: 0.1
Nodes (21): AuctionDelegate(), NewPersistentAuctioneer(), cardWithURL(), newAuctionTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_DispatchRetryExhaustedFallsBack(), TestAuctionDelegate_NoCandidatesFallsBack() (+13 more)

### Community 109 - "Community 109"
Cohesion: 0.13
Nodes (22): NewRedisPriorityQueue(), NewRedisPriorityQueueFromClient(), NewRedisQueue(), NewRedisQueueFromClient(), redisID(), testRedisAddr(), testRedisClient(), TestRedisPriorityQueue_DefaultKey() (+14 more)

### Community 110 - "Community 110"
Cohesion: 0.07
Nodes (15): References, TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedDelegatesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionCircuitBreakerHalts(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionCircuitBreakerHaltsOnConsecutiveNoopPatches(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionLoopHaltsOnConsecutiveNoopPatches(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionLoopRunner(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionNotebookGuardsNonFatal(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesLoopRunner() (+7 more)

### Community 111 - "Community 111"
Cohesion: 0.08
Nodes (23): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), DefaultManager(), TestHandle_RunScope(), TestHandle_SessionScope() (+15 more)
...
Cohesion: 0.09
Nodes (21): BTOptimizer, collectSelectorChildConditions(), collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestExtractCondition(), TestFindMainSelector() (+13 more)

### Community 114 - "Community 114"
Cohesion: 0.08
Nodes (24): TestRunOnce_EmitsRunRootSpan(), TestRunJob_WebhookSpanJoinsRunTrace(), tracingMiddleware(), TestTracedLLM_GenerateWithMaxTokens_ForwardsAndEmitsSpan(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent() (+16 more)
...
Cohesion: 0.1
Nodes (29): pendingPatchRecoveryAttempts(), orderingSweepRunner, archiveAndDeleteSuperpowersBranch(), cleanupAppliedSuperpowersWorktree(), cleanupSuperpowersWorktree(), createSuperpowersWorktree(), planSuperpowersWorktree(), reapOrphanedSuperpowersBranches() (+21 more)

### Community 118 - "Community 118"
Cohesion: 0.11
Nodes (32): TestDaemonConfiguresGoalPlanBrainstorm(), addFusionNewCount(), addFusionNewItems(), btFusionPatternQuestion(), btFusionResearchFindings(), fusionMarkdown(), fusionNewCount(), fusionTitle() (+24 more)
...
Cohesion: 0.11
Nodes (30): TestEligibleBidders(), TestEligibleBidders_NoRequiredTagsMatchesAll(), BuildCardRegistry(), cardCoversTags(), ConvertToAgentCard(), EligibleBidders(), TestBuildCardRegistry(), TestConvertToAgentCard_Basic() (+22 more)

### Community 124 - "Community 124"
Cohesion: 0.08
Nodes (21): auctionAnnouncement(), auctionCandidates(), betterBid(), candidateContext(), candidateOverride(), cardURL(), stateFloat(), stateString() (+13 more)

### Community 125 - "Community 125"
Cohesion: 0.09
Nodes (23): IsKnownChainKind(), parseChainConfig(), TestChainAction_ParseConfig(), TestIsKnownChainKind(), asFloat(), compiledGoapActionFor(), compiledGoapConditionFor(), goapValuesEqual() (+15 more)

### Community 126 - "Community 126"
Cohesion: 0.12
Nodes (31): BehavioralDescriptor, FeatureDimension, Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid(), NewMAPElitesPopulation(), cellFitnesses(), insertPersistNiche() (+23 more)

### Community 127 - "Community 127"
Cohesion: 0.11
Nodes (23): AgentMetrics, AgentStats, BuildIdentity, HealthResponse, Histogram, LabeledCounter, LabeledGauge, bucketForStatus() (+15 more)
...
Cohesion: 0.09
Nodes (28): ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), init(), ApplyBlockMutations(), blockIDFromOp() (+20 more)
...
Cohesion: 0.09
Nodes (27): HTTPMethod, collectViolations(), fieldPath(), NewRouteIndex(), pathOrRoot(), ResponseValidator(), routeKey(), TestDashboardRoutes_AllIndexable() (+19 more)
...
Cohesion: 0.06
Nodes (17): builtinBlocks(), TestBuiltinBlocks_Count(), TestBuiltinBlocks_UniqueNonEmptyIDs(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock() (+9 more)
...
Cohesion: 0.11
Nodes (13): handlePipelines(), Debug(), errToString(), TestStatusString(), HealthMonitor, HealthState, HealthStatus, Debug() (+5 more)

### Community 139 - "Community 139"
Cohesion: 0.12
Nodes (27): registerA2ANodes(), TestDelegateToA2A_ContextPropagates(), TestDelegateToA2A_FnNotConfigured(), TestDelegateToA2A_FnReturnsError(), TestDelegateToA2A_MissingTaskEmptyChainState(), TestDelegateToA2A_MissingURL(), TestDelegateToA2A_RateLimitCarryoverPropagates(), TestDelegateToA2A_Success() (+19 more)
...
Cohesion: 0.11
Nodes (31): TestHandleScalability_ReflectsInjectedQueueAndRouter(), TestPriorityQueue_PersistAndReloadViaInterface(), TestPriorityTaskQueue_DequeueEmpty(), TestPriorityTaskQueue_EnqueueDequeue(), TestPriorityTaskQueue_Peek(), TestPriorityTaskQueue_PeekEmpty(), TestPriorityTaskQueue_PurgeViaInterface(), TestPriorityTaskQueue_SamePriorityFIFO() (+23 more)

### Community 144 - "Community 144"
Cohesion: 0.13
Nodes (27): CompressionMiddleware(), isCompressibleContentType(), gzipDecompress(), TestCompressionMiddleware_AlreadyCompressed(), TestCompressionMiddleware_BinaryContentType(), TestCompressionMiddleware_EmptyBody(), TestCompressionMiddleware_GzipRequest(), TestCompressionMiddleware_HTMLContentType() (+19 more)

### Community 145 - "Community 145"
Cohesion: 0.11
Nodes (31): AgentMetric, AlertReport, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON(), evaluateGlobalAlerts(), evaluateHTTPAlerts(), ParseMetricsJSON() (+23 more)
...
Cohesion: 0.15
Nodes (17): ChildStats, NodeExecutionRecord, applyOrderToNode(), Entropy(), GiniImpurity(), InformationGain(), mergeSelectorStatsMaps(), normalizedIG() (+9 more)
...
Cohesion: 0.09
Nodes (24): defaultDriftHead(), TestDefaultRebuildTargets_PinsFullListIncludingMCPBinary(), scrubGitEnv(), buildStampLdflags(), copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), defaultRebuildMaterialize() (+16 more)

### Community 152 - "Community 152"
Cohesion: 0.09
Nodes (21): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce() (+13 more)
...
Cohesion: 0.09
Nodes (27): mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection(), expertArchivePath() (+19 more)

### Community 155 - "Community 155"
Cohesion: 0.11
Nodes (25): graphReportBuiltCommit(), arc42OutputDir(), countCPUCores(), execWithTimeout(), getBoolChainState(), init(), registerArc42Nodes(), sectionFileExists() (+17 more)

### Community 156 - "Community 156"
Cohesion: 0.11
Nodes (27): dataFileMetrics(), extractExistingDataPath(), init(), inspectDataSource(), registerDomainActions(), availableToolNames(), buildToolList(), execAgent() (+19 more)
...
Cohesion: 0.08
Nodes (30): Binaries, code:go (type Counter struct { ... }), code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }) (+22 more)
...
Cohesion: 0.12
Nodes (18): NewACPClient(), sameJSONID(), scanJSONLines(), startScanJSONLines(), countCrashInvocations(), TestACPClientCircuitBreakerShortCircuitsRepeatedSubprocessFailures(), TestACPClientGenerateCtx_StderrBufferRace(), TestACPClientGenerateReturnsErrorWhenSessionMissing() (+10 more)

### Community 162 - "Community 162"
Cohesion: 0.09
Nodes (28): TestBuildChainActionFn_LlmCallNilLLM(), TestBuildChainActionFn_UnknownChainType(), TestComputeSubtreeMetrics_MixedChildren(), TestComputeSubtreeMetrics_NilInput(), TestComputeSubtreeMetrics_UpdatesMaxValues(), TestComputeTreeMetrics_MaxRetriesAndTimeout(), TestComputeTreeMetrics_NestedChildren(), TestComputeTreeMetrics_ParallelWidth() (+20 more)
...
Cohesion: 0.14
Nodes (25): DefaultRegressionConfig(), HasRegressions(), HasWarnings(), NewComparator(), ParseBenchOutput(), TestComparator_CriticalRegression(), TestComparator_Improvement(), TestComparator_MinNsFilter() (+17 more)
...
Cohesion: 0.2
Nodes (27): readErrorHandlerJSONStrict(), acquireSelfFixStoreLock(), seedCodeFixProgram(), selfFixCooldown(), selfFixDir(), selfFixEnabled(), selfFixLedgerPath(), selfFixMaxOpen() (+19 more)
...
Cohesion: 0.11
Nodes (15): handleTrees(), setupHITLFinalizationTest(), TestDashboardAPIRoutesHaveOpenAPICoverage(), TestHandleHITL_ApproveActivatesAutomation(), TestHandleHITL_ApproveResumesFeedbackEscalation(), TestHandleHITL_RejectQuarantinesAutomationTree(), TestHandleTrees_DomainEntriesCarryDescription(), TestHandleTrees_IncludesFitnessAndLineage() (+7 more)
...
Cohesion: 0.12
Nodes (6): goalEntry, TestGoalQueue_DeadlineBreaksPriorityTies(), goalHeap, GoalQueue, entryLess(), NewGoalQueueFrom()
...
Cohesion: 0.18
Nodes (22): NewAuctioneer(), newDeadlineProbeTransport(), TestAuctioneer_RunAuction_AppliesDefaultDispatchDeadline(), TestAuctioneer_RunAuction_BoundsWinnerDispatchWithAnnouncementDeadline(), TestCollectBids_AppliesDefaultDeadlineWhenAnnouncementHasNone(), TestCollectBids_DerivesPerCandidateDeadlineFromAnnouncement(), TestCollectBids_SurvivesPanickingCandidate(), bidJSON() (+14 more)

### Community 180 - "Community 180"
Cohesion: 0.12
Nodes (17): injectPersonaContext(), injectPersonaContextLocked(), mineUserPatterns(), personaEmbedder(), personaError(), recordPersonaInteraction(), registerPersonaTools(), NewHabitMiner() (+9 more)

### Community 181 - "Community 181"
Cohesion: 0.09
Nodes (22): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestValidate_MemoryNodesDuplicateNames(), TestValidate_MemoryNodesRequireUniqueNames(), TestSuperpowersWorkflowTree_BuildsAndValidates() (+14 more)
...
Cohesion: 0.15
Nodes (20): DiversityMetrics, EvolutionParameters, FitnessMetrics, BuildPopulationStateWithGrid(), clamp01(), clampMutationRate(), DefaultPhaseRanges(), patternForState() (+12 more)
...
Cohesion: 0.24
Nodes (26): TestClaudeErrorHandler_DoesNotClobberExistingCategory(), swapErrorHandlerRunner(), TestRequestErrorHandlerProposal_RespectsCallerContext(), TestRequestErrorHandlerProposal_StampsLedgerOnEveryOutcome(), ehTestCodeFixJSON(), ehTestHandlerNode(), ehTestProposalJSON(), runHandler() (+18 more)
...
Cohesion: 0.11
Nodes (23): fakeGrillClaude, grillAnswerers, grillQuestion, grillResult, designBodyHash(), grillRoundHeading(), openCriticalDigest(), parseGrillQuestions() (+15 more)

### Community 190 - "Community 190"
Cohesion: 0.1
Nodes (18): init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init(), init(), init(), registerSuperpowersConditions(), TestRegisterCondition_DuplicatePanics() (+10 more)
...
Cohesion: 0.13
Nodes (19): ClaudeRunner, CommandResult, CommandRunner, execClaudeRunner, execCommandRunner, TestSuperpowersCommandTimeout_DefaultExceedsInnerTestTimeouts(), TestSuperpowersCommandTimeout_EnvOverride(), getenvDefault() (+11 more)

### Community 199 - "Community 199"
Cohesion: 0.15
Nodes (23): collectSystem(), BuildDecisionTree(), childMatchesDecision(), chooseDecisionBranch(), decisionKey(), decisionValue(), defaultDecisionBranch(), stringifyDecisionValue() (+15 more)
...
Cohesion: 0.26
Nodes (23): NewGoalQueue(), names(), names2(), TestGoalIsSatisfied(), TestGoalQueueAddAndSelect(), TestGoalQueueAddReplace(), TestGoalQueueAll(), TestGoalQueueAllSatisfied() (+15 more)
...
Cohesion: 0.09
Nodes (23): TestDeprecatedHandlerFunc(), TestSchemaToMap_Format(), DeprecationHeader, DeprecatedHandlerFunc(), httpStatusText(), schemaToMap(), TestDeprecatedHandlerFunc_WithSunset(), TestHTTPStatusText() (+15 more)
...
Cohesion: 0.11
Nodes (18): DefaultBlockConfig(), NewMetaPromptEvolver(), NewMutationContext(), TestBlockConfig_FilterMutations(), TestBlockConfig_IsMutable(), TestCrisisDetector_LastDiversity(), TestDefaultBlockConfig(), TestExpert_MatchPattern() (+10 more)
...
Cohesion: 0.14
Nodes (20): apiFetch(), esc(), getCookie(), Alert, cbIcon(), createAgent(), deleteAgent(), loadAgents() (+12 more)
...
Cohesion: 0.18
Nodes (18): baselineCmd(), baselinePath(), checkCmd(), main(), printUsage(), resetCmd(), run(), showCmd() (+10 more)

### Community 216 - "Community 216"
Cohesion: 0.21
Nodes (18): saveRecordWithDelay(), TestCreateAgentTool_Call_NilFactory(), TestEvolveTool_Call_NotEnoughFailures(), TestEvolveTool_Call_NoTree(), TestEvolveTool_Call_Success(), TestFitnessTool_Call(), TestFitnessTool_Call_NoData(), TestGetReflectionsTool_Call_NoRecords() (+10 more)
...
Cohesion: 0.13
Nodes (17): captureExporter, ExportedEvent, ExportedSpan, ConfigureOTLPFromEnv(), firstNonEmpty(), NewOTLPHTTPExporter(), otlpTracePayload(), parseOTLPHeaders() (+9 more)
...
Cohesion: 0.14
Nodes (8): Task, NewTaskStore(), priorityRank(), TestNewTaskStore_PanicsOnCorruptFile(), TestTaskStore_ApprovedOrdersByPriorityThenSprint(), TestTaskStore_ApproveRejectAuditPersistsAcrossSaveLoad(), TestTaskStore_SaveAtomicWriteLeavesOriginalIntactOnFailure(), TaskStore
...
Cohesion: 0.14
Nodes (11): eventDataString(), newRoutineThrottle(), routineThrottle, throttleEntry, computeHMAC(), TestComputeHMAC(), TestComputeHMAC_Deterministic(), TestComputeHMAC_DifferentKeys() (+3 more)

### Community 223 - "Community 223"
Cohesion: 0.17
Nodes (10): BlockConfig, ApplyDiffMutation(), findBlockForNode(), TestApplyDiffMutation(), DiffMutation, EvolveBlock, MetaPromptEvolver, MutationContext (+2 more)

### Community 224 - "Community 224"
Cohesion: 0.19
Nodes (17): FusionDeliberationTree(), collectFusionNames(), findFusionNode(), TestFusionDeliberationTree_HasFusionAndDirectPaths(), TestFusionDeliberationTree_UsesFusionChainAction(), NewAction(), NewAdapt(), NewChainAction() (+9 more)

### Community 225 - "Community 225"
Cohesion: 0.14
Nodes (10): Store, LoadJSON(), SaveJSONAtomic(), TestLoadJSON_CorruptFileErrors(), TestLoadJSON_MissingFileIsColdStart(), TestSaveJSONAtomic_CreatesParentDirs(), TestSaveJSONAtomic_NoLeftoverTmpFile(), TestSaveJSONAtomic_OverwritesExisting() (+2 more)
...
Cohesion: 0.15
Nodes (10): PatternSignature(), TestPatternSignature(), AutomationRecord, AutomationStore, HabitMiner, cosine(), jaccard(), keywordSet() (+2 more)
...
Cohesion: 0.16
Nodes (17): goapBacktickValueAfter(), goapFusionImplDegradedSection(), goapFusionMaterializerSnapshotsSection(), goapFusionParkedBranchesSection(), init(), loadGoapFusionReportedSnapshots(), markGoapFusionReportedSnapshots(), registerGoapFusionProductionAdditions() (+9 more)

### Community 232 - "Community 232"
Cohesion: 0.17
Nodes (17): TestBTOptimizer_New(), TestDTAnalyzer_New(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), NewBTOptimizer(), NewDTAnalyzer(), pathStat() (+9 more)
...
Cohesion: 0.12
Nodes (16): collectNames(), contains(), TestBuildTree_Minimal(), TestBuildTree_UnknownType(), TestOutcome_EmptyTaskFails(), TestOutcome_Success(), TestRouting_CodeReview(), TestRouting_Finance() (+8 more)
...
Cohesion: 0.17
Nodes (18): NewEventBus(), itoa(), TestEventBus_Close(), TestEventBus_CloseMultipleSubscribers(), TestEventBus_ConcurrentAccess(), TestEventBus_DropOnFullChannel(), TestEventBus_HasFired(), TestEventBus_HasFiredAfterReset() (+10 more)
...
Cohesion: 0.17
Nodes (6): NewNSGAIISorter(), TestNSGAII_FastNonDominatedSort(), NSGAIIFront, NSGAIIPopulation, NSGAIISorter, materializeMutationOp()
...
Cohesion: 0.15
Nodes (10): NewPageAgent(), TestAgentLLMGeneration(), TestAgentMockFallback(), TestBubbleRecommendation(), NewHandler(), TestHandleBookmark(), TestHandleIntent(), TestHandleProfile() (+2 more)
...
Cohesion: 0.18
Nodes (8): TreeStore, collect_issues(), fix_errcheck(), fix_unused_parameter(), load_lines(), main(), save_lines(), wrap_errcheck_line()
...
Cohesion: 0.17
Nodes (10): attachLogHandler(), buildBaseHandler(), buildLogger(), envLogLevel(), Error(), Init(), L(), SetAsDefault() (+2 more)
...
Cohesion: 0.22
Nodes (16): NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing(), TestLocalSearch_TabuSearch(), TestSelectorOptimizer_ApplyOrdering(), TestSelectorOptimizer_ConcurrentMergeSumsCounts() (+8 more)

### Community 490 - "Community 490"
Cohesion: 0.14
Nodes (15): Outcome, Record, FilterByTreeName(), NewRegistryWithUsers(), TestRegistry_Rescan_PicksUpTreeAddedAfterConstruction(), recordsForEntry(), TestBankFor_NoUserRootFallsBackToShared(), TestBankFor_PersonalTreesGetPerUserBank() (+7 more)
...
Cohesion: 0.11
Nodes (17): arc42 Docs Consolidation & Per-Section Sync Nodes — Implementation Plan, Canonical section layout (used by merge tasks, Go manifest, and drift script — keep all three in lockstep), code:bash (cd <repo-root>), code:bash (grep -F '## 10.1 Quality Tree' docs/arc42/10-quality.md && g), code:bash (git status --short          # expect: empty), code:bash (PATH=/usr/local/go/bin:$PATH make check-quick), code:bash (git add -A), code:bash (for f in 02-constraints 03-context-scope 04-solution-strateg) (+9 more)
...
Cohesion: 0.2
Nodes (13): NewEvolvedAgent(), TestConfig_AllFields(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestMockModel_SatisfiesInterface(), TestNewEvolvedAgent_AllToolsRegistered() (+5 more)

### Community 500 - "Community 500"
Cohesion: 0.12
Nodes (15): buildDashboardKnowledgeGraph(), TestBuildDashboardKnowledgeGraph_LoadsFeedbackFitness(), TestKnowledgeGraphRegistersAllDomainTrees(), TestAutoCreateTree_Existing(), TestConnect_GlobalGraph(), TestDiscover_GlobalGraphVariety(), TestKnowledgeGraph_GlobalConsistency(), TestListByCategory_All() (+7 more)
...
Cohesion: 0.18
Nodes (15): TestBuildIdentityStampedRevisionFallback(), BuildIdentityFromBuildInfo(), exposedBuildIdentity(), InstallBuildIdentity(), ReadBuildIdentity(), SetBuildIdentity(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered() (+7 more)
...
Cohesion: 0.14
Nodes (16): TestCheckConfidence_ConditionExists(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter() (+8 more)
...
Cohesion: 0.21
Nodes (13): ListToolProfileBlocks(), mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldBBMu(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu() (+5 more)

### Community 516 - "Community 516"
Cohesion: 0.15
Nodes (13): DiskInfo, GardenerMetrics, MemInfo, Metrics, loadGardenerMetrics(), rankTopWinners(), TestCollect_SurfacesTopEvolvedWinnersFromTrees(), TestLoadGardenerMetricsParsesAggregateDocument() (+5 more)

### Community 517 - "Community 517"
Cohesion: 0.19
Nodes (12): reportFusionCycleBaseChainState(), TestReportFusionCycleListsAgedUnmergedSuperpowersBranchesAsPendingPatch(), TestReportFusionCycleListsMaterializerSnapshotsFilenameSizeAndChangedCount(), TestVerifyGoapFusionEvidenceAcceptsDelegatedVerification(), TestVerifyGoapFusionEvidenceKeysOnNormalizedDelegationToken(), TestVerifyGoapFusionEvidenceRejectsBogusVerification(), writeGoapFusionCycleReport(), TestVerifyGoapFusionEvidenceClassifiesCommitted() (+4 more)
...
Cohesion: 0.22
Nodes (11): toast(), approveTask(), executeSprint(), pollSprintStatus(), refreshTasks(), rejectTask(), renderKanban(), renderTaskList() (+3 more)
...
Cohesion: 0.3
Nodes (14): saveRecordWithDelay(), TestEvolveTool_Call_NotEnoughFailures(), TestEvolveTool_Call_NoTree(), TestEvolveTool_Call_Success(), TestFitnessTool_Call(), TestFitnessTool_Call_NoData(), TestGetReflectionsTool_Call_NoRecords(), TestGetReflectionsTool_Call_Truncation() (+6 more)

### Community 764 - "Community 764"
Cohesion: 0.17
Nodes (11): TestCreateAgentTool_Call_NilFactory(), TestReflectTool_Call_NoLLM(), TestReflectTool_Call_WithLLM(), TestRunTaskTool_Call(), TestToolNames_And_Descriptions(), FitnessTool, NewCreateAgentTool(), NewFitnessTool() (+3 more)
...
Cohesion: 0.21
Nodes (12): isGoapPendingPatchFailure(), isGoapWorkingTreeDriftFailure(), classifyErrorHandlerFailure(), goapFailureCategory(), isGoapFusionCycle(), TestClassifyErrorHandlerFailure(), TestClassifyReliabilityFallback(), TestClaudeErrorHandler_ClassifiesUnclassifiedFailure() (+4 more)
...
Cohesion: 0.18
Nodes (7): BaselineStore, BenchmarkResult, pctChange(), TestPctChange(), Comparator, ComparisonResult, RegressionConfig
...
Cohesion: 0.15
Nodes (7): DLQEscalateBlock(), FitnessProbeBlock(), AuditLogBlock(), TraceCheckpointBlock(), TestAuditLogAction(), TestFitnessProbeAction(), TestPushToDLQAction()
...
Cohesion: 0.15
Nodes (13): code:go (// internal/engine/superpowers_grill_test.go), code:go (// internal/engine/superpowers_grill.go), code:bash (git add internal/engine/superpowers_grill.go internal/engine), code:bash (git add internal/engine/actions_superpowers_debug.go interna), code:bash (git add internal/engine/bandit_selector.go internal/engine/b), code:bash (git add docs/adr/ADR-010-superpowers-workflow-tree.md docs/a), Known deviations / follow-ups, Part E — Implementation Tasks (+5 more)
...
Cohesion: 0.17
Nodes (12): code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), Package: evaluator, Package: gardener (+4 more)
...
Cohesion: 0.27
Nodes (9): handlePipelineRun(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus(), pipelineRunRecord (+1 more)
...
Cohesion: 0.18
Nodes (11): code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), Package: a2a, Package: log, Package: persistence (+3 more)
...
Cohesion: 0.24
Nodes (5): EdgeType, maxTokensFromMetadata(), ValidateEdge(), SerializableNode, TypedEdge
...
Cohesion: 0.4
Nodes (9): dtRouterTree(), TestResolveTreeID_AppliesDTOptimizerOrdering(), TestResolveTreeID_AppliesLearnedSelectorOrdering(), TestResolveTreeID_ColdSelectorKeepsAuthoredOrder(), TestResolveTreeID_NoDTStatsLeavesTreeUnchanged(), TestResolveTreeID_PerTreeStatsFn(), triageSelectorTree(), writeDTStats() (+1 more)
...
Cohesion: 0.39
Nodes (8): TestToolNames_And_Descriptions(), NewCreateAgentTool(), NewEvolveTool(), NewFitnessTool(), NewGetReflectionsTool(), NewGetTreeTool(), NewReflectTool(), NewRunTaskTool()
...
Cohesion: 0.22
Nodes (9): code:go (type AgentCard struct { Name, Description, URL string }), code:go (type PlatformEvalResult struct { ... }), code:go (type BaselineStore struct { ... }), code:go (type WorkflowReport struct { ... }), code:go (type AgentInfo struct { Name, Status, Schedule string; Succe), Package: benchreg, Package: cicd, Package: eval (+1 more)
...
Cohesion: 0.39
Nodes (4): BTAgentClient, interpretSendResult(), safetyGetMessageText(), TestInterpretSendResult_HonestlyReportsFailureStates()
...
Cohesion: 0.33
Nodes (5): prepareTreeForBuild(), RegisterTreeExpander(), TestBuildAndValidate_SubTreeRefRequiresExpander(), TestPrepareTreeForBuild_NoRefs(), treeHasSubTreeRefs()

### Community 1127 - "Community 1127"
Cohesion: 0.43
Nodes (5): TestValidateQualitySpec_BlockedPattern(), TestValidateQualitySpec_MinLength(), TestValidateQualitySpec_NilSpecUsesHeuristic(), TestValidateQualitySpec_RequiredSections(), ValidateQualitySpec()
...
Cohesion: 0.4
Nodes (5): TestCleanupGraphifyOutRemovesUntrackedRegeneratedArtifacts(), runInDir(), TestScheduledGoapFusionBuildTreeMaterialized_HandlesDeletedTrackedFiles(), TestVerifyScheduledGoapFusionBuildTreeMaterialized_BareRepoCleanTreeReturnsWithoutMutation(), TestVerifyScheduledGoapFusionBuildTreeMaterialized_BareRepoSnapshotsDriftBeforeMaterializing()
...
Cohesion: 0.4
Nodes (5): NewBaselineStore(), TestBaselineStore_EmptyFile(), TestBaselineStore_InvalidJSON(), TestBaselineStore_SaveLoad(), TestBaselineStore_UpdateBaseline()
...
Cohesion: 0.5
Nodes (4): PreGateValidationOnly(), ToolProfileBlockID(), ToolProfileBlocks(), toolsProfileBlock()

### Community 1418 - "Community 1418"
Cohesion: 0.6
Nodes (3): TestContainsAnyStr(), TestItoa(), TestTruncate()
...
Cohesion: 0.6
Nodes (3): renderFellows(), renderThinkTank(), runThinkTank()
...
Cohesion: 0.83
Nodes (3): agentNameFromBB(), init(), registerDelegateNodes()
...
## Knowledge Gaps
- **11033 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+11028 more)
...
- **Why does `Append()` connect `Community 39` to `Community 512`, `Community 1027`, `Community 3`, `Community 4`, `Community 6`, `Community 519`, `Community 7`, `Community 8`, `Community 1034`, `Community 11`, `Community 1031`, `Community 1028`, `Community 14`, `Community 527`, `Community 16`, `Community 15`, `Community 526`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 1047`, `Community 1046`, `Community 24`, `Community 18`, `Community 25`, `Community 29`, `Community 30`, `Community 32`, `Community 1056`, `Community 36`, `Community 38`, `Community 44`, `Community 45`, `Community 46`, `Community 1072`, `Community 1073`, `Community 49`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 1078`, `Community 58`, `Community 60`, `Community 61`, `Community 62`, `Community 64`, `Community 65`, `Community 66`, `Community 1091`, `Community 67`, `Community 68`, `Community 73`, `Community 75`, `Community 78`, `Community 79`, `Community 82`, `Community 83`, `Community 84`, `Community 87`, `Community 89`, `Community 91`, `Community 92`, `Community 94`, `Community 95`, `Community 97`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 103`, `Community 1127`, `Community 105`, `Community 104`, `Community 106`, `Community 107`, `Community 112`, `Community 113`, `Community 115`, `Community 118`, `Community 123`, `Community 125`, `Community 126`, `Community 127`, `Community 130`, `Community 132`, `Community 134`, `Community 135`, `Community 138`, `Community 141`, `Community 146`, `Community 147`, `Community 148`, `Community 149`, `Community 155`, `Community 156`, `Community 158`, `Community 161`, `Community 162`, `Community 163`, `Community 164`, `Community 170`, `Community 171`, `Community 172`, `Community 173`, `Community 176`, `Community 183`, `Community 188`, `Community 192`, `Community 193`, `Community 194`, `Community 199`, `Community 200`, `Community 204`, `Community 215`, `Community 218`, `Community 219`, `Community 220`, `Community 223`, `Community 227`, `Community 228`, `Community 230`, `Community 237`, `Community 238`, `Community 240`, `Community 241`, `Community 246`, `Community 247`, `Community 761`, `Community 762`, `Community 250`, `Community 253`, `Community 765`, `Community 778`, `Community 789`, `Community 1378`, `Community 486`, `Community 488`, `Community 1512`, `Community 490`, `Community 497`, `Community 501`, `Community 503`, `Community 505`, `Community 1022`, `Community 1023`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 41` to `Community 6`, `Community 8`, `Community 138`, `Community 524`, `Community 142`, `Community 15`, `Community 18`, `Community 20`, `Community 22`, `Community 23`, `Community 152`, `Community 25`, `Community 151`, `Community 24`, `Community 28`, `Community 1052`, `Community 29`, `Community 158`, `Community 34`, `Community 36`, `Community 38`, `Community 47`, `Community 59`, `Community 60`, `Community 62`, `Community 63`, `Community 64`, `Community 74`, `Community 1103`, `Community 218`, `Community 1115`, `Community 480`, `Community 484`, `Community 485`, `Community 106`, `Community 114`, `Community 500`, `Community 245`, `Community 119`, `Community 504`, `Community 1022`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 25` to `Community 513`, `Community 515`, `Community 6`, `Community 8`, `Community 138`, `Community 524`, `Community 142`, `Community 15`, `Community 16`, `Community 148`, `Community 23`, `Community 154`, `Community 28`, `Community 33`, `Community 166`, `Community 39`, `Community 41`, `Community 47`, `Community 49`, `Community 180`, `Community 54`, `Community 58`, `Community 60`, `Community 64`, `Community 65`, `Community 76`, `Community 208`, `Community 82`, `Community 83`, `Community 86`, `Community 1503`, `Community 489`, `Community 250`, `Community 107`, `Community 106`, `Community 491`, `Community 236`, `Community 506`, `Community 126`, `Community 127`?**
...
- **Are the 153 inferred relationships involving `NewKnowledgeGraph()` (e.g. with `TestComputeAnalytics_EmptyGraph()` and `TestComputeAnalytics_Centrality()`) actually correct?**
  _`NewKnowledgeGraph()` has 153 INFERRED edges - model-reasoned connections that need verification._
