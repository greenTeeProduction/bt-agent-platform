# Graph Report - superpowers-20260717T143035-51bce651-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-17)

## Corpus Check
- 895 files · ~1,142,720 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25778 nodes · 38491 edges · 2036 communities (1686 shown, 350 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9244 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `93382e51`
...
1. `Append()` - 392 edges
2. `9. Architecture Decisions` - 153 edges
...
## Communities (2036 total, 350 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (200): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+192 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (200): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+192 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (136): wireSelectorOrdering(), main(), main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild() (+128 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (146): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+138 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (114): main(), TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch() (+106 more)
...
Cohesion: 0.03
Nodes (73): newDefaultConfig(), TestCheckRuntime_AllEmptyPaths(), TestCheckRuntime_AllOk(), TestCheckRuntime_ConfigFileNotFound(), TestCheckRuntime_CreatedDir_Valid(), TestCheckRuntime_DeepSeekEmptyHost(), TestCheckRuntime_DeepSeekNoOllamaCheck(), TestCheckRuntime_DeepSeekReachable() (+65 more)
...
Cohesion: 0.07
Nodes (90): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42DocsyncTree(), TestArc42DocsyncTreeRegistered(), TestArc42DocsyncTreeShape(), Arc42SeederTree(), Arc42Trees(), assembleDoc() (+82 more)
...
Cohesion: 0.04
Nodes (93): DefaultPanicHandler(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext() (+85 more)
...
Cohesion: 0.06
Nodes (88): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+80 more)
...
Cohesion: 0.05
Nodes (88): TestEndpointsFromCardsSingleNodeYieldsNoPeers(), TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip() (+80 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (68): main(), BTStudioCompany(), requireOllamaFinanceTest(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis(), TestTeslaMarket(), TestTeslaModel() (+60 more)
...
Cohesion: 0.06
Nodes (76): Duration(), satisfactionRecords(), TestEvaluateTree_EmptyRecordsSatisfactionUnknown(), TestEvaluateTree_FeedbackShiftsComposite(), TestEvaluateTree_NoFeedbackLeavesCompositeUnchanged(), countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New() (+68 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (54): DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM(), TestChainAction_Agent_NoTools(), TestChainAction_Agent_SummaryError(), TestChainAction_Agent_SummaryLLMError() (+46 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (78): TestScoreChild_GoalAlignmentBranch(), TestScoreChild_NilChainState(), TestScoreChildren_BasicRanking(), ParallelMode, intSliceFromInterface(), BuildReactiveParallel(), childPanicHandler(), forkBlackboard() (+70 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (68): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_Existing(), TestAutoCreateTree_New(), TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents() (+60 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (72): blockOnHeldBBMu(), TestBTBlocksComposeSaveGatesActivation(), echoTaskLeaf, islandArchivePath(), persistEvolvedWinner(), qtableArchivePath(), registerMCPTools(), assertExpertArchiveFedFromRun() (+64 more)
...
Cohesion: 0.05
Nodes (59): DefaultRetryPolicy(), GetCategory(), GetErrorContext(), NewCategorizedError(), NewErrorContext(), TestCategorizedError_Error(), TestCategorizedError_NilError(), TestCategorizedError_Unwrap() (+51 more)
...
Cohesion: 0.04
Nodes (51): TestOutcomeErrorDetail(), FeedbackFile(), applyOutcomeRefinement(), IsHealthyOutcome(), OutcomeErrorDetail(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome(), RunOptions (+43 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (51): growthFitness(), FitnessDimension, TestPopulationEvolve_ResurrectsExtinctSpecialist(), TestPopulationHealthSnapshot_DiversityCollapseRun(), TestMemeticEvolve_ResurrectsExtinctSpecialist(), NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists() (+43 more)
...
Cohesion: 0.05
Nodes (45): AgentMetrics, AgentStats, TestBuildIdentityStampedRevisionFallback(), BuildIdentity, Counter, Gauge, HealthResponse, Histogram (+37 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (59): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir(), MemoryDir() (+51 more)
...
Cohesion: 0.07
Nodes (60): buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), registerSuperpowersProductionActions(), titleSuperpowersVerb(), autofixScriptRunner (+52 more)
...
Cohesion: 0.05
Nodes (38): newAgentExecutor(), agentExecuteResult(), getDashCBStore(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules() (+30 more)

### Community 42 - "Community 42"
Cohesion: 0.07
Nodes (54): AgentBus, AgentEvent, InitAgentBus(), PublishHealthAlert(), PublishServiceDown(), TestAgentBus_AllSubscribersReceiveAll(), TestAgentBus_CloseSubscriberChannelsClosed(), TestAgentBus_ConcurrentPublish() (+46 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (31): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports(), RunContext (+23 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (59): ChainConfig, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), buildMapReduceFallback(), buildToolList(), chainContext() (+51 more)
...
Cohesion: 0.06
Nodes (53): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField(), extractNotebookLMAnswer() (+45 more)
...
Cohesion: 0.05
Nodes (12): History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), mockTTOrch, Workflow (+4 more)
...
Cohesion: 0.08
Nodes (43): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo(), assertNoForcedMasterWrite(), bareTestRun() (+35 more)
...
Cohesion: 0.06
Nodes (33): GateResult, TestQualityGateFloorOn100Scale(), ListRevisions(), loadSnapshotIndex(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass() (+25 more)
...
Cohesion: 0.05
Nodes (7): flakyDecomposeMockLLM, flakyOnceMockLLM, largeSubtaskMockLLM, rateLimitedDecomposeMockLLM, rateLimitedOnceMockLLM, rateLimitedRefineInitialMockLLM, windowingMockLLM
...
Cohesion: 0.07
Nodes (36): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+28 more)
...
Cohesion: 0.08
Nodes (22): WorkflowsDir(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep() (+14 more)

### Community 70 - "Community 70"
Cohesion: 0.08
Nodes (42): fakeTracer, AlwaysSample(), hashTraceID(), NeverSample(), NewConsoleTracer(), NewRatioSampler(), StringAttr(), TestAlwaysSample() (+34 more)

### Community 71 - "Community 71"
Cohesion: 0.1
Nodes (28): AllSLOMetrics(), GetSLOMetrics(), contains(), stringsContains(), TestAllSLOMetrics(), TestGetSLOMetrics_SameInstance(), TestSLOMetrics_Summary(), DefaultValidationGateConfig() (+20 more)
...
Cohesion: 0.14
Nodes (34): TestNoNewGapsOrImplDegraded_IsFallbackEligibleGuard(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled(), TestBanditSelector_DisabledMatchesSelectorSemantics() (+26 more)

### Community 74 - "Community 74"
Cohesion: 0.08
Nodes (6): agentTestMockLLM, chainMockLLM, countedErrorMockLLM, errorMockLLM, incompleteSynthMockLLM, indexedErrorMockLLM
...
Cohesion: 0.1
Nodes (16): TestDetermineCategory(), TestExtractKeywords(), TestTruncateTask(), Factory, AutoCreateTreeWith(), containsAnyStr(), determineCategory(), extractKeywords() (+8 more)
...
Cohesion: 0.08
Nodes (33): Analysis, Contradiction, CoveragePoint, fakeCaller, fakeTool, TestJudge_ParsesStructuredJSON(), TestJudge_RejectsInvalidJSON(), TestRunPanel_CircuitBreakerOpensAfterConsecutiveFailures() (+25 more)
...
Cohesion: 0.09
Nodes (23): BTOptimizer, TestBTOptimizer_New(), collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestExtractCondition(), TestFindMainSelector() (+15 more)
...
Cohesion: 0.05
Nodes (28): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, ConcurrencyLimiter, DeadLetterEntry, TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty() (+20 more)

### Community 93 - "Community 93"
Cohesion: 0.13
Nodes (30): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestRealToolFactory_DiscoveryAndFailClosed(), allRealToolNames() (+22 more)
...
Cohesion: 0.1
Nodes (38): TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestRouteBuilder_SunsetDate(), TestSchemaToMap_Format(), NewOpenAPIGenerator(), NewRoute() (+30 more)

### Community 96 - "Community 96"
Cohesion: 0.08
Nodes (33): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), asFloat(), compiledGoapActionFor(), compiledGoapConditionFor() (+25 more)
...
Cohesion: 0.07
Nodes (38): Binaries, code:go (type Counter struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }) (+30 more)
...
Cohesion: 0.08
Nodes (32): TestBuildPlannerNode_ChainStateGoals(), TestReadGoals_ChainStateFallback(), TestReadGoals_InvalidItemInList(), TestReadGoals_NonListMetadata(), TestReadGoals_Preconditions(), GoalDefinition, GOAPAction, GOAPGoal (+24 more)

### Community 104 - "Community 104"
Cohesion: 0.07
Nodes (23): BuildTaskFromInputs(), ParseInputParams(), TestBuildTaskFromInputs(), TestParseInputParams(), TestValidateInputs_Default(), TestValidateInputs_File(), TestValidateInputs_JSON(), TestValidateInputs_Required() (+15 more)

### Community 105 - "Community 105"
Cohesion: 0.08
Nodes (36): TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewWebSearchTool_Structure(), newFileReadTool(), newFileWriteTool(), newGoTestTool(), newShellExecTool(), newWebSearchTool() (+28 more)

### Community 106 - "Community 106"
Cohesion: 0.09
Nodes (30): init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), newGrillLoopTestRun(), TestGrillDesign_ApprovedWhenNoOpenCriticals(), TestGrillDesign_NeedsWorkWithFeedbackWhenCriticalsOpen(), TestGrillDesign_NoProgressBreakerFailsAfterTwoStaleRounds(), TestGrillDesign_RefusesRoundsBeyondBound() (+22 more)
...
Cohesion: 0.13
Nodes (29): agentNameInterceptor, agentNameKey, ScoreAnnouncement(), BTAgentExecutor, cardResponder, NewServer(), parseAnnouncement(), RespondToAnnouncement() (+21 more)

### Community 120 - "Community 120"
Cohesion: 0.12
Nodes (30): DefaultRegressionConfig(), HasRegressions(), HasWarnings(), NewBaselineStore(), NewComparator(), ParseBenchOutput(), TestBaselineStore_EmptyFile(), TestBaselineStore_InvalidJSON() (+22 more)
...
Cohesion: 0.08
Nodes (28): TestRunPipelineWithID_RecordsAgentMetrics(), handleAnalyze(), handleSprintExecute(), handleWorkflowRunFullPipeline(), syncWorkflowTaskStatus(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation(), TestHandleSprintExecute_UpdatesCurrentWorkflow() (+20 more)
...
Cohesion: 0.11
Nodes (26): isClaudeRateLimit(), fakeClaude, fakeCommitRunner, hookFailureClass, TestVerifyNotebookLMEvidenceAcceptsRealNotebookPayload(), TestVerifyNotebookLMEvidenceRejectsEmptyOrUngroundedSuccess(), TestVerifyNotebookLMEvidenceRejectsFabricatedOutput(), verifyNotebookLMEvidenceAction() (+18 more)

### Community 127 - "Community 127"
Cohesion: 0.17
Nodes (27): NewConfigWatcher(), TestConfigWatcher_BackwardCompatibleNoDotEnv(), TestConfigWatcher_ConfigChangeWithDotEnv(), TestConfigWatcher_DotEnvChangeDoesNotTriggerOnNoChange(), TestConfigWatcher_DotEnvFileDisappears(), TestConfigWatcher_DotEnvHotReload(), TestConfigWatcher_DotEnvPriorityChain(), TestConfigWatcher_FileAppears() (+19 more)
...
Cohesion: 0.06
Nodes (23): TestComputeAnalytics_BottleneckCarriesStructuredFailure(), TestComputeAnalytics_Bottlenecks(), TestComputeAnalytics_BottleneckWithoutTraceHasEmptyFailure(), TestComputeAnalytics_BottleneckWithTrace(), TestComputeAnalytics_Centrality(), TestComputeAnalytics_CoverageGapsUseExpectedDomains(), TestComputeAnalytics_EmptyGraph(), TestComputeAnalytics_ExtendedEdges() (+15 more)
...
Cohesion: 0.09
Nodes (26): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired(), NewMetaValidator(), hasMetaIssue() (+18 more)

### Community 133 - "Community 133"
Cohesion: 0.07
Nodes (14): GardenerDeactivateAllTool, GardenerRecommendTool, GardenerRollbackTool, GardenerRunCycleTool, GardenerStatusTool, newGardenerRunCycleTool(), routerChildNames(), seedSelectorStats() (+6 more)
...
Cohesion: 0.11
Nodes (27): ApplyParameters(), cholesky(), collectParams(), ExtractParameters(), invertCholesky(), itoa(), multiplyCholesky(), navigateToPath() (+19 more)
...
Cohesion: 0.11
Nodes (19): NewACPClient(), sameJSONID(), scanJSONLines(), startScanJSONLines(), countCrashInvocations(), TestACPClientCircuitBreakerShortCircuitsRepeatedSubprocessFailures(), TestACPClientGenerateCtx_StderrBufferRace(), TestACPClientGenerateReturnsErrorWhenSessionMissing() (+11 more)
...
Cohesion: 0.16
Nodes (21): NewRedisPriorityQueue(), NewRedisPriorityQueueFromClient(), NewRedisQueue(), NewRedisQueueFromClient(), redisID(), testRedisAddr(), testRedisClient(), TestRedisPriorityQueue_DefaultKey() (+13 more)
...
Cohesion: 0.12
Nodes (22): collectSelectorNames(), SelectorStatsFile(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing(), TestLocalSearch_TabuSearch() (+14 more)
...
Cohesion: 0.13
Nodes (7): apiKey, KeyHash(), sha256Hex(), TestKeyHash_Deterministic(), APIKeyInfo, KeyRing, KeyRotationScheduler
...
Cohesion: 0.17
Nodes (27): TestRouteBuilder_Build(), ArraySchema(), BoolSchema(), IntSchema(), ObjectSchema(), StringSchema(), TestConvenienceSchemaConstructors(), TestOpenAPIGenerator_ErrorResponses() (+19 more)
...
Cohesion: 0.12
Nodes (17): attachLogHandler(), buildBaseHandler(), buildLogger(), Debug(), envLogLevel(), Error(), Init(), L() (+9 more)
...
Cohesion: 0.21
Nodes (7): cloneTree(), containsCrisisReason(), Crossover(), hashTree(), BuildPopulationState(), NewLLMSupervisor(), Population
...
Cohesion: 0.13
Nodes (7): LoadSLOEvidence(), SaveSLOMetrics(), TestLoadSLOEvidence_MissingFile(), TestSaveSLOMetrics_AtomicNoTmpLeftBehind(), TestSaveSLOMetrics_LoadSLOEvidence_Roundtrip(), SLOMetrics, SLOSnapshot

### Community 200 - "Community 200"
Cohesion: 0.16
Nodes (16): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestHumanApprovalGate_AutoApprove(), TestHumanApprovalGate_ManualApprove(), TestHumanApprovalGate_PostPhase() (+8 more)
...
Cohesion: 0.13
Nodes (15): ErrorRecorder, NewOpenAICompatClient(), TestOpenAICompat_ErrorResponse(), TestOpenAICompat_GenerateWithModel_RetryPolicyByStatusCode(), TestOpenAICompat_GenerateWithModel_SendsChatCompletion(), rateLimitedServer(), TestDeepSeek_429ReturnsRateLimitError(), TestErrorRecorder_PrefersRateLimitError() (+7 more)
...
Cohesion: 0.13
Nodes (12): extractTreeType(), TestExtractTreeType(), Individual, collectNodeNames(), ExperienceRetrievalHits(), max(), maxTreeDepth(), randomNodeName() (+4 more)
...
Cohesion: 0.21
Nodes (11): TestLocalSearchMutableParamsAndTabu(), randomMutation(), extractMutableParams(), getFloatMeta(), NewLocalSearcher(), setFloatMeta(), toFloat64(), LocalSearcher (+3 more)
...
Cohesion: 0.11
Nodes (18): TestDeprecatedHandlerFunc(), TestNumberSchema(), DeprecationHeader, DeprecatedHandlerFunc(), httpStatusText(), NumberSchema(), TestDeprecatedHandlerFunc_WithSunset(), TestHTTPStatusText() (+10 more)
...
Cohesion: 0.19
Nodes (4): DashboardRoutes(), TestDashboardRoutes_AgentsExecuteHasRequestBody(), TestDashboardRoutes_AllHaveOperationIDs(), RouteBuilder
...
Cohesion: 0.32
Nodes (11): NewDTAnalyzer(), pathStat(), TestBTOptimizer_ReorderSelectors(), TestConditionOverlap(), TestDTAnalyzer_BestSplit(), TestDTAnalyzer_EmptyStatsNoOp(), TestDTAnalyzer_Entropy(), TestDTAnalyzer_Gini() (+3 more)

### Community 714 - "Community 714"
Cohesion: 0.26
Nodes (10): mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveHoldsBBMu(), TestBTBlocksComposeSaveHoldsServerLock(), TestBTHITLComposeTaskSaveHoldsBBMu() (+2 more)
...
Cohesion: 0.26
Nodes (9): TestRunOnce_EmitsRunRootSpan(), TestRunJob_WebhookSpanJoinsRunTrace(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), NewOTelTracer() (+1 more)
...
Cohesion: 0.24
Nodes (3): Bucket(), TestBucket(), MAPElitesGrid
...
Cohesion: 0.29
Nodes (8): newCatchupFixture(), TestCycleBreakerSuccess_HealthyOutcomesDoNotTripBreaker(), TestCycleBreakerSuccessTreatsRateLimitCarryoverAsHealthy(), TestSchedule_PreservesCrashRecoveryImmediateRun(), TestSchedule_PreservesMissedNextRunForCatchUp(), TestSchedule_RecomputesNextRunOnScheduleChange(), cycleBreakerSuccess(), testError
...
Cohesion: 0.33
Nodes (5): TestIntegration_AllChainTypes(), TestIntegration_EdgeCases(), TestIntegration_MutationOperators(), TestIntegration_PanicRecovery(), TestIntegration_QualityGatesFullFlow()
...
## Knowledge Gaps
- **9927 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+9922 more)
...
- **Why does `Append()` connect `Community 48` to `Community 2`, `Community 4`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 22`, `Community 24`, `Community 25`, `Community 27`, `Community 29`, `Community 31`, `Community 32`, `Community 33`, `Community 37`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 46`, `Community 47`, `Community 49`, `Community 51`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 60`, `Community 63`, `Community 64`, `Community 65`, `Community 67`, `Community 69`, `Community 70`, `Community 72`, `Community 73`, `Community 75`, `Community 77`, `Community 79`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 86`, `Community 87`, `Community 88`, `Community 90`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 98`, `Community 101`, `Community 102`, `Community 103`, `Community 104`, `Community 105`, `Community 107`, `Community 108`, `Community 110`, `Community 113`, `Community 115`, `Community 121`, `Community 122`, `Community 126`, `Community 132`, `Community 133`, `Community 134`, `Community 136`, `Community 138`, `Community 139`, `Community 141`, `Community 146`, `Community 150`, `Community 151`, `Community 152`, `Community 153`, `Community 158`, `Community 164`, `Community 167`, `Community 692`, `Community 181`, `Community 182`, `Community 183`, `Community 696`, `Community 184`, `Community 186`, `Community 697`, `Community 188`, `Community 189`, `Community 190`, `Community 709`, `Community 199`, `Community 205`, `Community 207`, `Community 209`, `Community 722`, `Community 723`, `Community 725`, `Community 214`, `Community 215`, `Community 729`, `Community 218`, `Community 219`, `Community 217`, `Community 227`, `Community 228`, `Community 231`, `Community 235`, `Community 236`, `Community 237`, `Community 1298`, `Community 936`, `Community 937`, `Community 938`, `Community 939`, `Community 438`, `Community 442`, `Community 444`, `Community 445`, `Community 960`, `Community 961`, `Community 456`, `Community 458`, `Community 459`, `Community 462`, `Community 463`, `Community 470`, `Community 985`, `Community 474`, `Community 475`, `Community 482`, `Community 483`, `Community 1021`, `Community 1023`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 28` to `Community 2`, `Community 131`, `Community 9`, `Community 10`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 31`, `Community 32`, `Community 42`, `Community 43`, `Community 45`, `Community 176`, `Community 50`, `Community 694`, `Community 955`, `Community 62`, `Community 447`, `Community 193`, `Community 69`, `Community 70`, `Community 71`, `Community 200`, `Community 201`, `Community 199`, `Community 455`, `Community 205`, `Community 211`, `Community 85`, `Community 93`, `Community 229`, `Community 109`, `Community 117`, `Community 119`, `Community 1017`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 22` to `Community 131`, `Community 136`, `Community 9`, `Community 10`, `Community 14`, `Community 18`, `Community 19`, `Community 21`, `Community 28`, `Community 29`, `Community 31`, `Community 159`, `Community 160`, `Community 161`, `Community 32`, `Community 168`, `Community 43`, `Community 48`, `Community 51`, `Community 437`, `Community 56`, `Community 58`, `Community 446`, `Community 68`, `Community 69`, `Community 714`, `Community 79`, `Community 209`, `Community 210`, `Community 217`, `Community 219`, `Community 97`, `Community 99`, `Community 229`, `Community 1388`, `Community 121`?**
