# Graph Report - superpowers-20260703T210354-8f8576fe-goap-fusion-loop-runner-blackboard-conte  (2026-07-03)

## Corpus Check
- 693 files · ~686,054 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14112 nodes · 23232 edges · 1342 communities (970 shown, 372 thin omitted)
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 6802 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7e94331d`
...
## Communities (1342 total, 372 thin omitted)
...
Cohesion: 0.04
Nodes (69): GardenerRunCycleTool, reflectOnOutcomeAction(), TestReflectOnOutcomeAction_NilLLM(), TestReflectOnOutcomeAction_WithMockLLM(), TestStore_CountFailures_MixedRecords(), TestStore_CountFailures_NoFailures(), TestStore_LoadAll_WithSubdirs(), TestStore_NewStore_MkdirAllError() (+61 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (58): init(), registerGoDevActions(), containsAnyStr(), findChildByName(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords() (+50 more)
...
Cohesion: 0.08
Nodes (60): ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree(), handleTreeStructure(), TestResolveTreeID_FusionAliases(), HermesSelfEvolutionTree(), HermesObsidianOptimizerTree(), KanbanAutoPilotTree() (+52 more)
...
Cohesion: 0.04
Nodes (14): Server, OpenAPIGenerator, Append(), mockTTOrch, Workflow, parseChainConfig(), EventBus, Outcome (+6 more)
...
Cohesion: 0.06
Nodes (57): TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents(), TestBuildFromArchetype(), TestConnect_Duplicate(), TestConnect_MissingNodes() (+49 more)
...
Cohesion: 0.05
Nodes (41): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, init(), init(), init(), registerSuperpowersConditions() (+33 more)
...
Cohesion: 0.08
Nodes (45): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), saveNlmQuotaExhausted(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation() (+37 more)
...
Cohesion: 0.06
Nodes (7): agentTestMockLLM, chainMockLLM, countedErrorMockLLM, errorMockLLM, incompleteSynthMockLLM, indexedErrorMockLLM, summaryWindowMockLLM
...
Cohesion: 0.04
Nodes (46): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+38 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (46): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+38 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (45): Binaries, code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type KnowledgeGraph struct { ... }), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }) (+37 more)
...
Cohesion: 0.08
Nodes (37): goapBacktickValueAfter(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildDeterministicImplementationPlan(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup() (+29 more)
...
Cohesion: 0.09
Nodes (30): getHomeDir(), init(), main(), handlePipelineRun(), handlePipelines(), newPipelineRunner(), newRunID(), resolveTree() (+22 more)
...
Cohesion: 0.08
Nodes (20): GardenerRecommendTool, GardenerStatusTool, main(), truncateStr(), attachLogHandler(), buildBaseHandler(), buildLogger(), Debug() (+12 more)
...
Cohesion: 0.09
Nodes (23): perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_NilTree(), TestMetricsTracker_BestFitnessTracking(), TestMetricsTracker_ImprovementRate(), TestMetricsTracker_LastFitnessTracking(), TestMetricsTracker_RecordAndCyclesForTree() (+15 more)
...
Cohesion: 0.08
Nodes (26): NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), alwaysSampler, Attr, neverSampler (+18 more)

### Community 91 - "Community 91"
Cohesion: 0.14
Nodes (31): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewGoBuildTool_Structure(), TestNewGoVetTool_Structure(), TestRealToolFactory_DiscoveryAndFailClosed() (+23 more)
...
Cohesion: 0.16
Nodes (21): goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionImplementationGateWired(), goapFusionNoopPatchStreak(), goapFusionPreflightWired(), goapFusionStateHashes(), init() (+13 more)
...
Cohesion: 0.16
Nodes (13): Entry, TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), Limits, NewManager() (+5 more)
...
Cohesion: 0.5
Nodes (3): TestRealTool_Call(), TestToolStub_CallReturnsEmpty(), TestToolStub_CallReturnsError()
...
## Knowledge Gaps
- **3235 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+3230 more)
...
- **Why does `Append()` connect `Community 13` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 14`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 32`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 42`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 52`, `Community 53`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 61`, `Community 62`, `Community 64`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 586`, `Community 75`, `Community 74`, `Community 76`, `Community 77`, `Community 81`, `Community 85`, `Community 86`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 100`, `Community 102`, `Community 103`, `Community 106`, `Community 110`, `Community 111`, `Community 112`, `Community 113`, `Community 117`, `Community 120`, `Community 121`, `Community 123`, `Community 126`, `Community 128`, `Community 129`, `Community 130`, `Community 132`, `Community 133`, `Community 134`, `Community 140`, `Community 141`, `Community 142`, `Community 143`, `Community 145`, `Community 146`, `Community 147`, `Community 152`, `Community 154`, `Community 155`, `Community 158`, `Community 159`, `Community 163`, `Community 164`, `Community 167`, `Community 169`, `Community 171`, `Community 174`, `Community 175`, `Community 177`, `Community 178`, `Community 182`, `Community 185`, `Community 240`, `Community 243`, `Community 244`, `Community 245`, `Community 252`, `Community 253`, `Community 254`, `Community 255`, `Community 256`, `Community 259`, `Community 260`, `Community 269`, `Community 276`, `Community 278`, `Community 329`, `Community 334`, `Community 335`, `Community 337`, `Community 347`, `Community 349`, `Community 350`, `Community 357`, `Community 358`, `Community 363`, `Community 364`, `Community 366`, `Community 417`, `Community 418`, `Community 419`, `Community 420`, `Community 422`, `Community 432`, `Community 435`, `Community 437`, `Community 453`, `Community 454`, `Community 457`, `Community 462`, `Community 474`, `Community 483`, `Community 503`, `Community 509`?**
  _High betweenness centrality (0.212) - this node is a cross-community bridge._
- **Why does `sleep()` connect `Community 127` to `Community 266`, `Community 272`, `Community 20`, `Community 26`, `Community 27`, `Community 33`, `Community 34`, `Community 165`, `Community 47`, `Community 176`, `Community 179`, `Community 183`, `Community 63`, `Community 71`, `Community 72`, `Community 80`, `Community 81`, `Community 83`, `Community 86`, `Community 91`, `Community 113`, `Community 114`, `Community 501`, `Community 124`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 52` to `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 272`, `Community 144`, `Community 18`, `Community 19`, `Community 146`, `Community 20`, `Community 25`, `Community 29`, `Community 32`, `Community 33`, `Community 34`, `Community 165`, `Community 167`, `Community 58`, `Community 63`, `Community 67`, `Community 72`, `Community 77`, `Community 78`, `Community 346`, `Community 113`, `Community 245`?**
