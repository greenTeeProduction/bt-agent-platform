# Graph Report - superpowers-20260715T090055-9a21d49e-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-15)

## Corpus Check
- 860 files · ~1,015,418 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22584 nodes · 34361 edges · 1848 communities (1478 shown, 370 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8639 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1c738d58`
...
4. `NewKnowledgeGraph()` - 129 edges
5. `registerMCPTools()` - 113 edges
6. `BuildTree()` - 111 edges
7. `arc42 Section 9 — Architecture Decisions` - 107 edges
...
## Communities (1848 total, 370 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (161): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+153 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (161): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+153 more)
...
Cohesion: 0.04
Nodes (102): main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+94 more)
...
Cohesion: 0.04
Nodes (83): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle() (+75 more)
...
Cohesion: 0.04
Nodes (98): TestDeprecatedHandler_NoSunset(), TestDeprecatedHandler_WithSunsetDate(), DeprecatedHandler(), TestDeprecatedHandler_WithoutSunset(), TestDeprecatedHandler_WithSunset(), NewRequest(), auditKey, bearerPrincipalKey (+90 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (107): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+99 more)
...
Cohesion: 0.04
Nodes (52): agentExecuteResult(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleAnalyze(), handleDLQReplay() (+44 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (55): DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM(), TestChainAction_Agent_NoTools(), TestChainAction_Agent_SummaryError(), TestChainAction_Agent_SummaryLLMError() (+47 more)
...
Cohesion: 0.08
Nodes (63): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+55 more)
...
Cohesion: 0.05
Nodes (56): isClaudeRateLimit(), applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, fakeClaude, fakeCommitRunner, hookFailureClass (+48 more)
...
Cohesion: 0.06
Nodes (65): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree() (+57 more)
...
Cohesion: 0.05
Nodes (17): History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), mockTTOrch, Workflow (+9 more)
...
Cohesion: 0.07
Nodes (52): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField(), extractNotebookLMAnswer() (+44 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (54): TestNewReinforcementLearner(), NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation() (+46 more)
...
Cohesion: 0.09
Nodes (49): Duration(), TestDuration(), TestCloneTree_Independent(), TestHashTree_Deterministic(), TestHashTree_DifferentTrees(), TestNewPopulation_Evolution(), TestPopulation_Diversity(), DefaultTree() (+41 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (26): main(), attachLogHandler(), buildBaseHandler(), buildLogger(), Debug(), envLogLevel(), Error(), Info() (+18 more)
...
Cohesion: 0.06
Nodes (34): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), ApplyHITLPolicy(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID() (+26 more)
...
Cohesion: 0.05
Nodes (38): init(), TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure(), TestValidateOutputQualityRejectsRefusals(), collectNames() (+30 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (43): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionNoopPatchStreak(), goapFusionPreflightWired() (+35 more)
...
Cohesion: 0.08
Nodes (23): TestRunOnce_EmitsRunRootSpan(), tracingMiddleware(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), ContextWithTraceParentHeader() (+15 more)
...
Cohesion: 0.08
Nodes (28): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+20 more)
...
Cohesion: 0.15
Nodes (29): TestConsoleTracer_ExporterReceivesCompletedSpan(), TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest(), TestTracingMiddleware_StatusCodes() (+21 more)
...
Cohesion: 0.12
Nodes (23): nlmGrillAnswerer(), nlmGrillUnavailable(), parseNumberedAnswers(), TestNlmGrillAnswerer_AuthGuardFailureIsUnavailable(), TestNlmGrillAnswerer_EmptyOutputIsUnavailable(), TestNlmGrillAnswerer_NoAnswerMarkersIsUnavailable(), TestNlmGrillAnswerer_QuotaErrorIsUnavailable(), TestNlmGrillAnswerer_ValidOutputReturnsMap() (+15 more)
...
Cohesion: 0.11
Nodes (17): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), TestChainAction_Agent_Parse(), TestExpandChainStateTemplates_Basic(), TestExpandChainStateTemplates_MissingKey(), TestExpandChainStateTemplates_MultipleSubstitutions() (+9 more)
...
Cohesion: 0.14
Nodes (9): builtinBlocks(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), MemoryLoadBlock(), MemoryWriteBlock(), PlanBlock() (+1 more)
...
Cohesion: 0.24
Nodes (7): ChildTick, childTickLog, toolStub, isStructuredOutput(), resolvedResult(), RunTask(), truncateStrForTree()
...
## Knowledge Gaps
- **8008 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8003 more)
...
- **Why does `Append()` connect `Community 38` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 24`, `Community 27`, `Community 28`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 36`, `Community 39`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 47`, `Community 49`, `Community 51`, `Community 52`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 65`, `Community 66`, `Community 68`, `Community 69`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 75`, `Community 590`, `Community 78`, `Community 80`, `Community 591`, `Community 593`, `Community 83`, `Community 82`, `Community 86`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 98`, `Community 101`, `Community 614`, `Community 103`, `Community 616`, `Community 613`, `Community 106`, `Community 619`, `Community 110`, `Community 119`, `Community 121`, `Community 124`, `Community 127`, `Community 131`, `Community 134`, `Community 135`, `Community 136`, `Community 137`, `Community 139`, `Community 145`, `Community 147`, `Community 155`, `Community 157`, `Community 158`, `Community 160`, `Community 165`, `Community 169`, `Community 173`, `Community 175`, `Community 177`, `Community 180`, `Community 183`, `Community 185`, `Community 189`, `Community 191`, `Community 192`, `Community 197`, `Community 198`, `Community 199`, `Community 200`, `Community 202`, `Community 203`, `Community 205`, `Community 206`, `Community 213`, `Community 791`, `Community 796`, `Community 799`, `Community 817`, `Community 822`, `Community 823`, `Community 824`, `Community 827`, `Community 842`, `Community 844`, `Community 845`, `Community 846`, `Community 851`, `Community 376`, `Community 890`, `Community 382`, `Community 383`, `Community 385`, `Community 388`, `Community 901`, `Community 389`, `Community 397`, `Community 398`, `Community 399`, `Community 400`, `Community 401`, `Community 408`, `Community 411`, `Community 415`, `Community 418`, `Community 422`, `Community 423`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 28` to `Community 389`, `Community 6`, `Community 134`, `Community 11`, `Community 14`, `Community 143`, `Community 19`, `Community 148`, `Community 23`, `Community 24`, `Community 159`, `Community 38`, `Community 43`, `Community 172`, `Community 1196`, `Community 47`, `Community 48`, `Community 180`, `Community 56`, `Community 58`, `Community 59`, `Community 190`, `Community 65`, `Community 193`, `Community 67`, `Community 68`, `Community 70`, `Community 72`, `Community 74`, `Community 202`, `Community 210`, `Community 87`, `Community 88`, `Community 106`, `Community 116`, `Community 120`, `Community 380`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 67` to `Community 3`, `Community 387`, `Community 132`, `Community 6`, `Community 4`, `Community 136`, `Community 389`, `Community 11`, `Community 16`, `Community 19`, `Community 23`, `Community 407`, `Community 154`, `Community 28`, `Community 33`, `Community 40`, `Community 172`, `Community 44`, `Community 47`, `Community 48`, `Community 817`, `Community 177`, `Community 818`, `Community 53`, `Community 58`, `Community 64`, `Community 72`, `Community 201`, `Community 203`, `Community 211`, `Community 105`, `Community 109`, `Community 883`, `Community 120`, `Community 378`?**
