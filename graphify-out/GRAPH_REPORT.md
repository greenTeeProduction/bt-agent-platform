...
## Corpus Check
- 355 files · ~424,108 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6164 nodes · 11498 edges · 301 communities (267 shown, 34 thin omitted)
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 3788 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8733f62f`
...
## Communities (301 total, 34 thin omitted)
...
Cohesion: 0.03
Nodes (43): stringContains(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), execLLMCallAction(), execRefineAction(), generatePlanAction(), NewEngine(), reflectOnOutcomeAction() (+35 more)
...
Cohesion: 0.05
Nodes (59): parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM(), TestChainAction_Agent_NoTools(), TestChainAction_Agent_Parse() (+51 more)
...
Cohesion: 0.05
Nodes (55): TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure(), TestNewGoTestTool_Structure(), TestNewGoVetTool_Structure(), TestNewGraphifyTool_Structure(), TestNewShellExecTool_Structure(), TestNewWebSearchTool_Structure() (+47 more)
...
Cohesion: 0.09
Nodes (44): cloneTree(), CodeReviewSuite(), cohensD(), DefaultMock(), fishersExact(), GoDevSuite(), QuickValidate(), RunABTest() (+36 more)
...
Cohesion: 0.09
Nodes (38): AlwaysSample(), hashTraceID(), NeverSample(), NewConsoleTracer(), NewRatioSampler(), StringAttr(), TestAlwaysSample(), TestConsoleTracer_BasicSpan() (+30 more)
...
Cohesion: 0.05
Nodes (36): Binaries, code:go (type Counter struct { ... }), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }) (+28 more)
...
Cohesion: 0.1
Nodes (18): TestCheckConfidence_ConditionExists(), TestCrossover_Single(), TestPopulation_Diversity(), TestPopulation_StatsAccessors(), TestApplyMutations_Batch(), Individual, cloneTree(), collectNodeNames() (+10 more)
...
Cohesion: 0.09
Nodes (28): applyDotEnvFiles(), applyDotEnvToConfig(), applyEnvOverrides(), envBool(), hasExplicitField(), Load(), LoadFile(), LoadFileWithDotEnv() (+20 more)
...
Cohesion: 0.1
Nodes (23): AntiPattern, countTreeNodes(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestNewPopulation_Evolution(), TestPopulation_Evolve() (+15 more)

### Community 56 - "Community 56"
Cohesion: 0.09
Nodes (29): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AnnotateMetrics(), BootstrapCI(), containsStr(), DevOpsSuite() (+21 more)
...
Cohesion: 0.08
Nodes (22): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, Provider, cacheCheckAction(), cacheResultAction() (+14 more)
...
Cohesion: 0.19
Nodes (24): setupGardener(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestRunCycle_MetricsSave(), DefaultEvolveV2Config(), TestEvolveTreeV2_BloatGuard() (+16 more)
...
Cohesion: 0.35
Nodes (22): TestBTPG_QualityMetrics_AllDomainTrees(), TestBFCL_AllDomainTrees_Accuracy(), AlertRouterTree(), AgentMonitorTree(), AllDomainTrees(), chainAgent(), CodeReviewTree(), CrashInvestigatorTree() (+14 more)
...
Cohesion: 0.24
Nodes (21): handleTreeStructure(), TestIntegration_AllTreesExecute(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis(), TestTeslaMarket(), TestTeslaModel(), TestTeslaPitchAgent() (+13 more)
...
Cohesion: 0.21
Nodes (18): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+10 more)
...
Cohesion: 0.21
Nodes (16): main(), TestProbeDashboard_CSRFProtection(), TestProbeDashboard_FailsMissingHardeningHeaders(), TestProbeDashboard_PassesHardenedStack(), TestProbeDashboard_RequiresTargetURL(), TestProbeDashboard_WithAPIKey(), CrossOriginMiddleware(), DefaultSecurityHeaders() (+8 more)
...
- **Why does `main()` connect `Community 176` to `Community 130`, `Community 4`, `Community 5`, `Community 134`, `Community 133`, `Community 136`, `Community 17`, `Community 18`, `Community 19`, `Community 148`, `Community 28`, `Community 30`, `Community 160`, `Community 168`, `Community 173`, `Community 45`, `Community 61`, `Community 203`, `Community 81`, `Community 87`, `Community 222`, `Community 104`, `Community 117`?**
  _High betweenness centrality (0.190) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 137` to `Community 256`, `Community 4`, `Community 133`, `Community 6`, `Community 135`, `Community 136`, `Community 150`, `Community 25`, `Community 30`, `Community 32`, `Community 35`, `Community 166`, `Community 41`, `Community 173`, `Community 58`, `Community 69`, `Community 203`, `Community 90`, `Community 101`, `Community 104`, `Community 107`, `Community 116`?**
  _High betweenness centrality (0.187) - this node is a cross-community bridge._
- **Why does `BuildTree()` connect `Community 5` to `Community 1`, `Community 130`, `Community 135`, `Community 10`, `Community 17`, `Community 22`, `Community 28`, `Community 161`, `Community 34`, `Community 36`, `Community 172`, `Community 176`, `Community 184`, `Community 57`, `Community 56`, `Community 192`, `Community 213`, `Community 218`, `Community 91`, `Community 93`, `Community 222`, `Community 95`, `Community 96`, `Community 111`, `Community 244`, `Community 117`?**
...
- **Are the 89 inferred relationships involving `sleep()` (e.g. with `TestConfigWatcher_OnChange()` and `TestConfigWatcher_NoChangeNoCallback()`) actually correct?**
  _`sleep()` has 89 INFERRED edges - model-reasoned connections that need verification._
