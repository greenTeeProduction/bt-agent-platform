...
## Corpus Check
- 355 files · ~425,075 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6176 nodes · 11517 edges · 290 communities (260 shown, 30 thin omitted)
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 3795 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a5e9ba3b`
...
Cohesion: 0.04
Nodes (65): parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM(), TestChainAction_Agent_NoTools(), TestChainAction_Agent_Parse() (+57 more)
...
Cohesion: 0.06
Nodes (56): brokenTool, ChainConfig, ChainKind, BuildChainAction(), buildChainActionFn(), buildToolList(), execAgent(), execConversation() (+48 more)
...
Cohesion: 0.04
Nodes (32): execLLMCallAction(), execRefineAction(), generatePlanAction(), NewEngine(), reflectOnOutcomeAction(), RegisterProviders(), TestCondition_HasGoapGoal_ConfigureTask(), TestCondition_HasGoapGoal_EmptyTask() (+24 more)
...
Cohesion: 0.09
Nodes (42): main(), DeepeningResult, makeRecords(), TestEvaluateTree_AllFailures(), TestEvaluateTree_EmptyRecords(), TestEvaluateTree_GoDevVsDefault(), TestEvaluateTree_Mixed(), TestEvaluateTree_NodeCountPenalty() (+34 more)
...
Cohesion: 0.08
Nodes (27): perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestMetricsTracker_BestFitnessTracking(), TestMetricsTracker_ImprovementRate() (+19 more)
...
Cohesion: 0.07
Nodes (31): TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure(), collectNames(), contains(), TestBuildTree_Minimal() (+23 more)
...
Cohesion: 0.05
Nodes (36): Binaries, code:go (type Counter struct { ... }), code:go (type Tracer interface {), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }) (+28 more)
...
Cohesion: 0.09
Nodes (27): TestCheckConfidence_ConditionExists(), TestGoDevTree_RetryBehavior(), TestApplyMutations_Batch(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter(), TestMutation_AddBefore(), TestMutation_AddFallback() (+19 more)
...
Cohesion: 0.08
Nodes (23): DeprecationHeader, DeprecatedHandlerFunc(), httpStatusText(), NumberSchema(), schemaToMap(), TestDeprecatedHandlerFunc_WithSunset(), TestHTTPStatusText(), TestSchemaToMap_Array() (+15 more)

### Community 54 - "Community 54"
Cohesion: 0.1
Nodes (17): DefaultRetryPolicy(), TestRetryPolicy_AuthFailsFast(), TestRetryPolicy_DeprecatedInheritsContext(), TestRetryPolicy_EventualSuccess(), TestRetryPolicy_ExecuteContext_Exhaustion(), TestRetryPolicy_ExecuteContext_Success(), TestRetryPolicy_LLMRetries(), TestRetryPolicy_NetworkRetries() (+9 more)
...
Cohesion: 0.16
Nodes (28): DeprecatedHandler(), NewOpenAPIGenerator(), NewRoute(), mapKeys(), TestDashboardRoutes_AllRoutesBuildWithoutPanic(), TestDashboardRoutes_AuthConsistency(), TestDashboardRoutes_GeneratesValidSpec(), TestDeprecatedHandler_WithoutSunset() (+20 more)
...
Cohesion: 0.08
Nodes (26): NewErrorContext(), TestCircuitBreaker_RecordFailure_BackwardCompat(), TestErrorContext_Concurrent(), TestErrorContext_Error(), TestErrorContext_Error_Minimal(), TestErrorContext_Summary_Full(), TestErrorContext_Summary_NoOperation(), TestErrorContext_Summary_TruncatesLong() (+18 more)
...
Cohesion: 0.15
Nodes (28): ArraySchema(), BoolSchema(), IntSchema(), ObjectSchema(), StringSchema(), TestConvenienceSchemaConstructors(), TestOpenAPIGenerator_Parameters(), TestOpenAPIGenerator_ReusableSchemas() (+20 more)
...
Cohesion: 0.16
Nodes (24): TestBlackboard_AllFields(), TestTree_SerializeRoundtrip(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+16 more)
...
Cohesion: 0.14
Nodes (7): BehavioralDescriptor, FeatureDimension, Bucket(), TestBucket(), MAPElitesGrid, MAPElitesPopulation, MAPElitesStats
...
Cohesion: 0.26
Nodes (17): Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid(), NewMAPElitesPopulation(), countCondsActs(), makeDeepTree(), makeTestTree(), StructuralQuickEval() (+9 more)

### Community 136 - "Community 136"
Cohesion: 0.24
Nodes (15): DefaultMock(), TestMockLLM_GenerateCtx(), singleTaskSuite(), tasksForTree(), TestAgentMonitor(), TestAllDomainTrees(), TestCodeReviewTree(), TestCrashInvestigator() (+7 more)
...
Cohesion: 0.2
Nodes (12): TestRegisterAction_DuplicatePanics(), TestRegisterCondition_DuplicatePanics(), TestRegisterAction_And_GetAction(), TestRegisterCondition_And_GetCondition(), init(), RegisterAction(), registerAlertRouterNodes(), RegisterCondition() (+4 more)
...
Cohesion: 0.18
Nodes (11): stringContains(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), TestAction_PlanGoapActions_WrongActionsType(), TestAction_ExecuteGoapStep_PastEnd(), TestAction_GoapFallback(), TestAction_PlanGoapActions_EmptyActions(), TestAction_RouteToAllChannels(), TestAction_RouteToDefaultChannel() (+3 more)
...
Cohesion: 0.2
Nodes (10): TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailureWithCategory(), TestIntegration_CircuitBreakerAndDLQ(), NewCircuitBreaker(), TestCircuitBreaker_Closed(), TestCircuitBreaker_FailsInHalfOpen(), TestCircuitBreaker_HalfOpen() (+2 more)
...
- **Why does `main()` connect `Community 158` to `Community 2`, `Community 5`, `Community 134`, `Community 133`, `Community 144`, `Community 272`, `Community 146`, `Community 18`, `Community 21`, `Community 23`, `Community 153`, `Community 30`, `Community 171`, `Community 44`, `Community 173`, `Community 54`, `Community 55`, `Community 215`, `Community 89`, `Community 91`, `Community 93`, `Community 104`?**
  _High betweenness centrality (0.215) - this node is a cross-community bridge._
- **Why does `BuildTree()` connect `Community 2` to `Community 0`, `Community 3`, `Community 136`, `Community 9`, `Community 14`, `Community 272`, `Community 145`, `Community 18`, `Community 21`, `Community 25`, `Community 30`, `Community 31`, `Community 158`, `Community 165`, `Community 48`, `Community 49`, `Community 180`, `Community 61`, `Community 205`, `Community 206`, `Community 215`, `Community 89`, `Community 94`, `Community 95`, `Community 99`, `Community 109`, `Community 114`?**
  _High betweenness centrality (0.194) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 64` to `Community 133`, `Community 5`, `Community 6`, `Community 272`, `Community 145`, `Community 20`, `Community 149`, `Community 153`, `Community 28`, `Community 33`, `Community 35`, `Community 167`, `Community 173`, `Community 55`, `Community 56`, `Community 92`, `Community 100`, `Community 101`, `Community 102`, `Community 104`, `Community 115`, `Community 245`?**
