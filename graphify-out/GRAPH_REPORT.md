# Graph Report - superpowers-20260717T223827-cc81bd8d-goap-fusion-loop-runner-blackboard-conte  (2026-07-17)

## Corpus Check
- 910 files · ~1,178,950 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26306 nodes · 39224 edges · 2066 communities (1720 shown, 346 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9405 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ad6d8355`
...
1. `Append()` - 392 edges
2. `9. Architecture Decisions` - 158 edges
3. `DefaultTree()` - 152 edges
4. `NewKnowledgeGraph()` - 150 edges
5. `registerMCPTools()` - 147 edges
6. `NewRequest()` - 141 edges
7. `arc42 Section 9 — Architecture Decisions` - 135 edges
8. `BuildTree()` - 111 edges
9. `newDefaultConfig()` - 100 edges
10. `sleep()` - 95 edges

## Surprising Connections (you probably didn't know these)
- `buildSeedProgramPrompt` --references--> `arc42 §1.2 Quality Goals Table`  [INFERRED]
  internal/engine/goap_seed_program.go → docs/arc42/go-bt-evolve-arc42.md
- `TestAllSuites_Complete()` --calls--> `AllSuites()`  [INFERRED]
  internal/benchmark/benchmark_test.go → /home/nico/go-bt-evolve/internal/benchmark/eval_suites.go
- `Collect()` --calls--> `handleMetricsLive()`  [INFERRED]
  internal/dashboard/metrics.go → cmd/bt-dashboard/main.go
- `NewDefaultCompany()` --calls--> `TestNewDefaultCompany_Values()`  [INFERRED]
  /home/nico/go-bt-evolve/internal/startup/company.go → internal/startup/startup_test.go
- `resolveTreeForUser()` --calls--> `ResolveTreeIDForUser()`  [INFERRED]
  cmd/bt-agent/main.go → internal/domains/tree_resolver.go

## Hyperedges (group relationships)
- **Runaway-Backstop Deadlock Causal Chain** — research_process_overhaul_2026_07_08_commit_4ae9d61, actions_superpowers_publishgoapfusionstatehash, actions_superpowers_runscheduledgoapfusionloop, research_process_overhaul_2026_07_08_runaway_backstop_deadlock [EXTRACTED 1.00]
- **arc42-Anchored Research Lanes** — nlm_quota_derivenotebooklmresearchquery, actions_goap_fusion_claude_review_buildclaudereviewprompt, goap_seed_program_buildseedprogramprompt, actions_goap_fusion_buildgrillround1query, actions_btfusion_searchforbtpatterns [EXTRACTED 1.00]
- **NotebookLM Corpus Hygiene Effort** — research_process_overhaul_2026_07_08_corpus_pollution_loop, research_process_overhaul_2026_07_08_import_budget_gate, research_process_overhaul_2026_07_08_nlm_cli, research_process_overhaul_2026_07_08_notebooklm_py, research_process_overhaul_2026_07_08_vault_quarantine [EXTRACTED 1.00]

## Communities (2066 total, 346 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (206): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+198 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (206): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+198 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (151): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+143 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (108): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+100 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (118): main(), TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch() (+110 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (135): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+127 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (19): agentTestMockLLM, chainMockLLM, countedErrorMockLLM, emptyDecomposeMockLLM, errorMockLLM, flakyDecomposeMockLLM, flakyOnceMockLLM, flakyRefineMockLLM (+11 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (96): init(), registerFinanceActions(), init(), registerResearchActions(), init(), registerStockfishActions(), init(), banditChildKey() (+88 more)
...
Cohesion: 0.05
Nodes (89): main(), evidenceVerificationReport, defaultStorageDir(), encodeJSON(), main(), run(), contains(), mustParseTime() (+81 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (100): TestDeprecatedHandler_NoSunset(), TestDeprecatedHandler_WithSunsetDate(), DeprecatedHandler(), TestDeprecatedHandler_WithoutSunset(), TestDeprecatedHandler_WithSunset(), NewRequest(), auditKey, bearerPrincipalKey (+92 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (95): truncateGoap(), init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), TestParseSplitOutput(), validateDesignAction(), validateDesignHeadings(), arc42SeedTargetGoal() (+87 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (75): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle() (+67 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (88): Duration(), TestDuration(), TestCheckConfidence_ConditionExists(), countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+80 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (82): perTreeStats(), setupGardener(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree(), TestMetricsTracker_BestFitnessTracking() (+74 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (90): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+82 more)

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (82): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+74 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (68): AgentBus, AgentEvent, InitAgentBus(), PublishHealthAlert(), PublishServiceDown(), TestAgentBus_AllSubscribersReceiveAll(), TestAgentBus_CloseSubscriberChannelsClosed(), TestAgentBus_ConcurrentPublish() (+60 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (80): DefaultLLM(), RealLLM(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), EvaluateBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic() (+72 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (77): TestRunOnce_EmitsRunRootSpan(), TestRunJob_WebhookSpanJoinsRunTrace(), alwaysSampler, Attr, fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport() (+69 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (67): ApplyJitter(), DefaultRetryPolicy(), EqualJitter(), FullJitter(), GetErrorContext(), NewErrorContext(), TestApplyJitter_AllStrategiesDeterministicRange(), TestApplyJitter_Decorrelated() (+59 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (55): AllSuites(), CodeReview(), Cron(), DataPipeline(), DevOps(), Evolution(), Finance(), GoDev() (+47 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (28): AgentMetric, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON() (+20 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (71): blockOnHeldServerLock(), echoTaskLeaf, persistEvolvedWinner(), registerMCPTools(), assertExpertArchiveFedFromRun(), injectSelectorProbeTree(), seedSelectorProbeStats(), TestBTDelegateToTreeHoldsBBMu() (+63 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (73): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+65 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (75): TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestMultiNode_ScalabilityStatusRouterReporting(), NewAgentRouter(), NewDeadLetterQueue(), NewLocalExecutor(), TestAgentRouter_AllExecutorsFail(), TestAgentRouter_EmptyHealth() (+67 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (43): cacheCheckAction(), cacheResultAction(), execLLMCallAction(), execRefineAction(), generatePlanAction(), hasClearTaskCond(), knowledgeQueryAction(), NewEngine() (+35 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (47): newAgentExecutor(), agentExecuteResult(), dashboardLocalAgentResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute() (+39 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (52): init(), registerGoDevActions(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+44 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (56): baselineCmd(), baselinePath(), checkCmd(), main(), printUsage(), resetCmd(), run(), showCmd() (+48 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (69): NewEventBus(), itoa(), TestEventBus_Close(), TestEventBus_CloseMultipleSubscribers(), TestEventBus_ConcurrentAccess(), TestEventBus_DropOnFullChannel(), TestEventBus_HasFired(), TestEventBus_HasFiredAfterReset() (+61 more)
...
Cohesion: 0.06
Nodes (64): TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents(), TestBuildFromArchetype(), TestConnect_Duplicate(), TestConnect_MissingNodes() (+56 more)
...
Cohesion: 0.12
Nodes (58): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42DocsyncTree(), TestArc42DocsyncTreeRegistered(), TestArc42DocsyncTreeShape(), Arc42SeederTree(), Arc42Trees(), assembleDoc() (+50 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (49): AgentCircuitBreaker, AgentCircuitBreakerStore, circuitBreakerFileEntry, CircuitBreakerOptions, circuitBreakersFile, circuitBreakersFileForTest, CircuitState, CircuitSummary (+41 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (47): TestOutcomeErrorDetail(), FeedbackFile(), IsHealthyOutcome(), OutcomeErrorDetail(), TestLocalAgentResultNilResultAndSuccessPathsUnchanged(), TestLocalAgentResultPreservesOutcomeOnError(), attemptOutcomeError(), buildSchedulerConfig() (+39 more)
...
Cohesion: 0.06
Nodes (58): AllTools(), DevTools(), DiskUsage(), FileRead(), HTTPGet(), MemoryUsage(), MonitorTools(), ProcessCheck() (+50 more)
...
Cohesion: 0.06
Nodes (53): AgentDefinition, ContentType, TestMustParseAgentDefinition_PanicsOnInvalid(), TestMustParseAgentDefinition_Valid(), TestNumberIn_InvalidNumberString(), TestNumberIn_Matching(), TestNumberIn_NotFound(), TestNumberValue_Float64() (+45 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (56): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup() (+48 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (57): DefaultMock(), TestRunSuiteIsSandboxed(), findNode(), resolverReachableExtraDomainTrees(), singleTaskSuite(), tasksForTree(), TestAgentMonitor(), TestAllDomainTreeConditionsHaveDescriptions() (+49 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (32): findChildByName(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords(), TestContainsAnyLower_NoKeywords(), TestContainsAnyLower_NoMatch(), TestContainsAnyLower_Substring() (+24 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (47): Blackboard, ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+39 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (48): init(), registerSuperpowersDebugActions(), superpowersDebugPhase(), superpowersDebugPhaseAction(), TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath() (+40 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (57): AllTools(), DevTools(), DiskUsage(), FileRead(), HTTPGet(), MemoryUsage(), MonitorTools(), ProcessCheck() (+49 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (33): AgentRunner, TestIsBreakerSuccess(), Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports() (+25 more)

### Community 49 - "Community 49"
Cohesion: 0.09
Nodes (52): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+44 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (38): AuctionDelegate(), NewAuctioneer(), cardWithURL(), newAuctionTransport(), newDeadlineProbeTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoCandidatesFallsBack() (+30 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (46): FileJobStore, NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), JobStore, TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess() (+38 more)

### Community 52 - "Community 52"
Cohesion: 0.12
Nodes (51): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+43 more)

### Community 53 - "Community 53"
Cohesion: 0.07
Nodes (45): ConnPool, NewConnPool(), NewSharedConnPool(), TestAgentRouter_PooledExecutors_LeastConnections(), TestAgentRouter_WithSharedPool(), TestConnPool_Close(), TestConnPool_CloseIdleConnections(), TestConnPool_CustomConfig() (+37 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (39): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), Entry, Limits, DefaultManager() (+31 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (34): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, Histogram, HistogramSnap, LabeledCounter (+26 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (40): NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation(), TestCrisisDetector_DetectPopulation_DiversityCollapse() (+32 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (44): ArraySchema(), BoolSchema(), IntSchema(), ObjectSchema(), TestConvenienceSchemaConstructors(), NewRouteIndex(), ResponseValidator(), TestDashboardRoutes_AllIndexable() (+36 more)

### Community 58 - "Community 58"
Cohesion: 0.07
Nodes (34): TestBuildPlannerNode_ChainStateGoals(), TestReadGoals_ChainStateFallback(), TestReadGoals_InvalidItemInList(), GoalDefinition, GOAPAction, GOAPGoal, Plan, boolConditions() (+26 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (46): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), TestIsGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation() (+38 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (28): A2AHandoffBlock(), builtinBlocks(), TestBuiltinBlocks_Count(), TestBuiltinBlocks_UniqueNonEmptyIDs(), DelegateBlock(), DLQEscalateBlock(), EvolveOnFailureBlock(), MergeResultsBlock() (+20 more)

### Community 61 - "Community 61"
Cohesion: 0.08
Nodes (31): AllSLOMetrics(), GetSLOMetrics(), TestAllSLOMetrics(), LoadSLOEvidence(), SaveSLOMetrics(), TestLoadSLOEvidence_MissingFile(), TestSaveSLOMetrics_AtomicNoTmpLeftBehind(), TestSaveSLOMetrics_LoadSLOEvidence_Roundtrip() (+23 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (30): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired(), wireSelectorOrdering(), GardenerDeactivateAllTool (+22 more)

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (46): Approval, mockOrch, NewWorkflow(), sortTasks(), TestApproval_Fields(), TestApproveTask(), TestExecuteSprint(), TestExecuteSprint_ApprovedToCompleted() (+38 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (30): Warn(), biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask(), serializeTreeForGardener() (+22 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (38): Analysis, Contradiction, CoveragePoint, fakeCaller, fakeTool, flakyCaller, TestJudge_ParsesStructuredJSON(), TestJudge_RejectsInvalidJSON() (+30 more)

### Community 66 - "Community 66"
Cohesion: 0.09
Nodes (37): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestAgentWithRealToolsBlocksFinalAnswerWithoutToolUse(), TestAgentWithRealToolsRejectsFinalAnswerWithoutToolUse() (+29 more)

### Community 67 - "Community 67"
Cohesion: 0.08
Nodes (44): AggregatedTrace, buildAggregatedTrace(), NewTraceReader(), parseRemaining(), ParseTraceEvent(), ParseTraceLine(), BenchmarkParseTraceLine(), BenchmarkTraceReader_ReadRecent() (+36 more)

### Community 68 - "Community 68"
Cohesion: 0.06
Nodes (5): AgentRouter, CircuitBreaker, NewRouterFromEndpoints(), TestNewRouterFromEndpoints_BuildsRemoteExecutorsWithLocalFallback(), TestNewRouterFromEndpoints_EmptyRoutesToLocal()

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (42): TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewWebSearchTool_Structure(), TestNewGraphifyTool_EmptyActionDefaultToQuery(), TestNewGraphifyTool_ErrorHandling(), TestNewShellExecTool_StderrCaptureOnlyFailure(), TestNewShellExecTool_TimeoutTruncation(), mockTool (+34 more)

### Community 70 - "Community 70"
Cohesion: 0.09
Nodes (41): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionNoopPatchStreak(), goapFusionPreflightWired() (+33 more)

### Community 71 - "Community 71"
Cohesion: 0.09
Nodes (37): cmdImpact(), impactedTestsForSource(), normalizeImpactSource(), TestImpactedTestsForSource_AbsoluteSourceUnderRoot(), TestNormalizeImpactSource_AbsoluteUnderRoot(), TestNormalizeImpactSource_RejectsOutsideRoot(), writeImpactCLIFixture(), impactTests() (+29 more)

### Community 72 - "Community 72"
Cohesion: 0.1
Nodes (19): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_Existing(), TestAutoCreateTree_New(), TestDetermineCategory(), TestExtractKeywords(), Factory, AutoCreateTree(), AutoCreateTreeWith() (+11 more)

### Community 73 - "Community 73"
Cohesion: 0.1
Nodes (37): TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull(), TestBrainstormRejectedWhenFilesNotGoPath(), TestBrainstormRejectedWhenMalformedOrProse(), TestBrainstormRejectedWhenNotDeeper(), TestBrainstormRejectedWhenRunOmitsShort(), withBrainstorm(), brainstormExpandPlan() (+29 more)

### Community 74 - "Community 74"
Cohesion: 0.08
Nodes (21): handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus() (+13 more)

### Community 75 - "Community 75"
Cohesion: 0.1
Nodes (39): growthFitness(), FitnessDimension, makeTestTree(), NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance() (+31 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (36): ClassifyError(), contextDeadlineExceeded(), DecorrelatedJitter(), isAuthError(), isLLMError(), isNetworkError(), isRateLimitError(), isResourceError() (+28 more)

### Community 77 - "Community 77"
Cohesion: 0.09
Nodes (36): distributedDispatch, appendDispatchErr(), driveDistributedDispatch(), main(), parseNodes(), run(), multiNodeReport, TestMultiNode_ProbeFailsOnEmptyNodeURL() (+28 more)

### Community 78 - "Community 78"
Cohesion: 0.11
Nodes (41): TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestRouteBuilder_Build(), TestRouteBuilder_SunsetDate(), TestSchemaToMap_Format(), NewOpenAPIGenerator() (+33 more)
...
Cohesion: 0.08
Nodes (5): DeadLetterQueue, PriorityQueue, acquireFileLock(), SchedulerState, TaskQueue

### Community 86 - "Community 86"
Cohesion: 0.09
Nodes (9): code:block1 (/usr/local/go/bin/go test ./internal/engine -count=1 -run Te), code:block2 (--- FAIL: TestSuperpowersRuntime_ActionsRegistered_Scheduled), code:block3 (FILES_CHANGED:), GREEN phase, RED phase, RED Phase Complete, RED Phase Report, RED Phase Result (+1 more)

### Community 87 - "Community 87"
Cohesion: 0.08
Nodes (29): TraceParent, traceParentSpan, ContextWithTraceParent(), ExtractTraceParentFromRequest(), ExtractTraceStateFromRequest(), GenerateSpanID(), GenerateTraceID(), GenerateTraceParent() (+21 more)

### Community 88 - "Community 88"
Cohesion: 0.07
Nodes (11): Capability, Edge, evolvedFitness(), blendedSelectionFitness(), coldStartConfidence(), coldStartWeightedFitness(), structuralGate(), KnowledgeGraph (+3 more)

### Community 89 - "Community 89"
Cohesion: 0.09
Nodes (38): TestScoreChild_GoalAlignmentBranch(), TestScoreChild_NilChainState(), TestScoreChildren_BasicRanking(), ScoringCriteria, BuildUtilitySelector(), DefaultScoringCriteria(), ScoreChild(), ScoreChildren() (+30 more)

### Community 90 - "Community 90"
Cohesion: 0.12
Nodes (37): ParallelMode, intSliceFromInterface(), BuildReactiveParallel(), childPanicHandler(), forkBlackboard(), intSliceFromInterface(), runReactiveParallel(), evaluateGuardCondition() (+29 more)

### Community 91 - "Community 91"
Cohesion: 0.08
Nodes (7): sha256Hex(), KeyRing, KeyRotationScheduler, Session, SessionInfo, SessionStore, SessionStoreConfig

### Community 92 - "Community 92"
Cohesion: 0.13
Nodes (35): recordUserFeedback(), registerFeedbackTools(), newFeedbackDeps(), TestBTFeedbackRegistered(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), TestRecordUserFeedback_FeedsSatisfactionAndFlags(), TestRecordUserFeedback_RejectsBadInput(), TestRecordUserFeedback_TrimsUserAndTreeID() (+27 more)

### Community 93 - "Community 93"
Cohesion: 0.08
Nodes (20): main(), attachLogHandler(), buildBaseHandler(), buildLogger(), envLogLevel(), Error(), Init(), L() (+12 more)

### Community 94 - "Community 94"
Cohesion: 0.08
Nodes (27): TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), TestStartDriftWatcher_KickTriggersImmediateCheck(), JobsDir(), RegistryDir(), SchedulerJobsFile(), TestRemoveAgentJobs(), TestResolvePipelineAgent_Aliases() (+19 more)

### Community 95 - "Community 95"
Cohesion: 0.08
Nodes (25): gitOutput(), TestNoCommittedRootBinaries(), extractTaskID(), init(), nlmAuthNeedsRefresh(), nlmAuthUnhealthy(), registerNotebookLMActions(), writeString() (+17 more)

### Community 96 - "Community 96"
Cohesion: 0.09
Nodes (29): ctxAwareBlockingRunner, TestErrorHandlerSignature_ClassifiedWithoutLastErrorIsStable(), buildErrorHandlerPrompt(), errorHandlerCooldown(), errorHandlerEnabled(), errorHandlerMaxNodes(), errorHandlerNodeDepth(), errorHandlerSignatureFromBB() (+21 more)

### Community 97 - "Community 97"
Cohesion: 0.07
Nodes (21): TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree(), TestWireSelectorReorderIsOptIn() (+13 more)

### Community 98 - "Community 98"
Cohesion: 0.13
Nodes (16): extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), collectNodeNames(), containsCrisisReason(), Crossover(), ExperienceRetrievalHits() (+8 more)

### Community 99 - "Community 99"
Cohesion: 0.08
Nodes (31): Embedding, EmbeddingClient, CosineSimilarity(), TestBuildIndex_PanicRecovered(), TestCosineSimilarity_BothZero(), TestCosineSimilarity_DifferentLengths(), TestCosineSimilarity_Empty(), TestCosineSimilarity_Identical() (+23 more)

### Community 100 - "Community 100"
Cohesion: 0.12
Nodes (31): agentNameInterceptor, agentNameKey, ScoreAnnouncement(), BTAgentExecutor, cardResponder, failureEventMessage(), parseAnnouncement(), RespondToAnnouncement() (+23 more)

### Community 101 - "Community 101"
Cohesion: 0.11
Nodes (31): Handler, NewSessionStore(), TestSessionCleanup_PanicRecovered(), TestSessionMiddleware_APIKeyFallback(), TestSessionMiddleware_CustomCheckFunc(), TestSessionMiddleware_ExpiredCookie(), TestSessionMiddleware_InvalidAPIKey(), TestSessionMiddleware_NoAPIKeyWhenEmpty() (+23 more)

### Community 102 - "Community 102"
Cohesion: 0.07
Nodes (28): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM() (+20 more)

### Community 103 - "Community 103"
Cohesion: 0.13
Nodes (31): bareApplyScriptRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo(), assertNoForcedMasterWrite(), bareTestRun(), TestApplySuperpowersRunBareRepoDetachedHeadDoesNotRebase(), TestApplySuperpowersRunBareRepoFfRebaseAttemptsBounded(), TestApplySuperpowersRunBareRepoRebaseConflictAbortsAndParks() (+23 more)
...
Cohesion: 0.07
Nodes (14): TestActionForName_BulkCoverage(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), Recover(), SafeGo(), TestRecover_CatchesPanic(), TestRecover_NoPanic(), TestRecover_ReturnsErrorWithContext() (+6 more)

### Community 108 - "Community 108"
Cohesion: 0.08
Nodes (22): auctionAnnouncement(), auctionCandidates(), betterBid(), candidateContext(), candidateOverride(), cardURL(), NewPersistentAuctioneer(), stateFloat() (+14 more)

### Community 109 - "Community 109"
Cohesion: 0.08
Nodes (24): BuildTaskFromInputs(), ParseInputParams(), TestBuildTaskFromInputs(), TestParseInputParams(), TestValidateInputs_Default(), TestValidateInputs_File(), TestValidateInputs_JSON(), TestValidateInputs_Required() (+16 more)

### Community 110 - "Community 110"
Cohesion: 0.1
Nodes (28): ConcurrencyLimiterStats, QueueStats, NewConcurrencyLimiter(), NewWorkerPool(), TestConcurrencyLimiter_AcquireRelease(), TestConcurrencyLimiter_Available(), TestConcurrencyLimiter_MultipleReleaseNoUnderflow(), TestConcurrencyLimiter_ReleaseWhenEmpty() (+20 more)
...
Cohesion: 0.13
Nodes (32): apiKey, KeyHash(), NewKeyRing(), NewKeyRotationScheduler(), TestExpireKey_NotFound(), TestExpireKey_Success(), TestExpiringKeys_EmptyRing(), TestExpiringKeys_OnlyPermanent() (+24 more)

### Community 113 - "Community 113"
Cohesion: 0.09
Nodes (23): TestNestedActionSpansParentCorrectly(), TestPanickingActionRestoresTraceContextAndEndsSpan(), TestRegisteredActionEmitsSpan(), TestRegisteredConditionEmitsSpan(), withRecordingGlobalTracer(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass() (+15 more)

### Community 114 - "Community 114"
Cohesion: 0.1
Nodes (33): handleAlerts(), AgentMetric, Alert, AlertReport, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON(), evaluateGlobalAlerts() (+25 more)
...
Cohesion: 0.08
Nodes (35): nlmFusionResearchRun, SearchForBTPatterns, buildGrillRound1Query, buildClaudeReviewPrompt, PublishGoapFusionStateHash, RunScheduledGoapFusionLoop, arc42GoalsPromptBlock, arc42ResearchTopics (+27 more)

### Community 117 - "Community 117"
Cohesion: 0.08
Nodes (23): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus() (+15 more)

### Community 118 - "Community 118"
Cohesion: 0.11
Nodes (30): BehavioralDescriptor, FeatureDimension, Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid(), NewMAPElitesPopulation(), cellFitnesses(), insertPersistNiche() (+22 more)
...
Cohesion: 0.1
Nodes (5): code:block1 (/usr/local/go/bin/go test ./internal/engine -count=1 -run Te), code:block2 (--- FAIL: TestSuperpowersRuntime_ActionsRegistered_Scheduled), RED Phase Complete, RED Phase Report, RED Phase Result
...
Cohesion: 0.09
Nodes (29): mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection(), expertArchivePath() (+21 more)

### Community 123 - "Community 123"
Cohesion: 0.12
Nodes (25): handleWorkflowRunFullPipeline(), TestHandleWorkflowRunFullPipeline_PersistsWorkflowAndTasks(), NewMockLLM(), NewDefaultCompany(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary() (+17 more)
...
Cohesion: 0.07
Nodes (10): References, TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedDelegatesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedMaterializesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionNotebookGuardsNonFatal(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesLoopRunner(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesRunsWritable(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightPrependsToLoopSequence(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightSchemaValid() (+2 more)

### Community 128 - "Community 128"
Cohesion: 0.11
Nodes (22): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), ApplyHITLPolicy(), countTreeNodes(), TestSuperpowersPipelineSimulation() (+14 more)

### Community 129 - "Community 129"
Cohesion: 0.09
Nodes (21): ChildTick, DecisionTrace, NewTraceStore(), TestExplainLastFailure_NoTrace(), TestExplainLastFailure_RendersPathFromChildTicks(), TestExplainLastFailure_TraceFound(), TestTraceStore_GetByTreeID(), TestTraceStore_GetEmpty() (+13 more)

### Community 130 - "Community 130"
Cohesion: 0.06
Nodes (21): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, ConcurrencyLimiter, DeadLetterEntry, executorFailureState, ExecutorHealthDetail (+13 more)
...
Cohesion: 0.08
Nodes (31): Binaries, code:go (type Counter struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }) (+23 more)
...
Cohesion: 0.14
Nodes (28): addFusionNewCount(), addFusionNewItems(), btFusionPatternQuestion(), btFusionResearchFindings(), fusionMarkdown(), fusionNewCount(), fusionTitle(), init() (+20 more)

### Community 135 - "Community 135"
Cohesion: 0.11
Nodes (28): main(), finishProbe(), headerEquals(), headerPresent(), probeCSRFCookie(), ProbeDashboard(), probeSessionCookies(), statusCheck() (+20 more)

### Community 136 - "Community 136"
Cohesion: 0.09
Nodes (26): stringContains(), TestBuildGoapStepPrompt(), buildGoapStepPrompt(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter() (+18 more)

### Community 137 - "Community 137"
Cohesion: 0.12
Nodes (26): ApplyParameters(), cholesky(), collectParams(), ExtractParameters(), invertCholesky(), itoa(), multiplyCholesky(), navigateToPath() (+18 more)

### Community 138 - "Community 138"
Cohesion: 0.12
Nodes (15): BTOptimizer, collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestSplitCamelCase(), isDefaultPath(), pathEntropy() (+7 more)

### Community 139 - "Community 139"
Cohesion: 0.13
Nodes (25): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), LogsDir(), MemoryDir(), NotificationThrottleFile() (+17 more)

### Community 140 - "Community 140"
Cohesion: 0.1
Nodes (22): TestMatchBlockPattern(), AntiPattern, DesignPattern, BlockIDFromRef(), containsStr(), coreHeuristics(), hasNodeMatching(), hasNodeType() (+14 more)

### Community 141 - "Community 141"
Cohesion: 0.13
Nodes (28): TestPriorityQueue_PersistAndReloadViaInterface(), TestPriorityTaskQueue_DequeueEmpty(), TestPriorityTaskQueue_EnqueueDequeue(), TestPriorityTaskQueue_Peek(), TestPriorityTaskQueue_PeekEmpty(), TestPriorityTaskQueue_PurgeViaInterface(), TestPriorityTaskQueue_SamePriorityFIFO(), TestPriorityTaskQueueInterfaceCompliance() (+20 more)
...
Cohesion: 0.1
Nodes (23): main(), TestClient_AnalyzeComplexity_FallbackOnError(), TestClient_Generate_ConnectionRefused(), TestClient_GeneratePlan_FallbackOnError(), TestClient_Reflect_FallbackOnError(), TestDeepSeekClient_AnalyzeComplexity(), TestDeepSeekClient_Generate_APIError(), TestDeepSeekClient_Generate_ConnectionRefused() (+15 more)

### Community 144 - "Community 144"
Cohesion: 0.13
Nodes (23): BTAgentClient, treeSkillName(), treeTags(), interpretSendResult(), NewBTAgentClient(), safetyGetMessageText(), TestInterpretSendResult_HonestlyReportsFailureStates(), TestA2AServer_HandleAgentEndpoint_EmptyName() (+15 more)
...
Cohesion: 0.12
Nodes (9): acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), cappedCells(), mergeSelectorStatsMaps(), persistSelectorStats(), readSelectorStatsFile() (+1 more)

### Community 147 - "Community 147"
Cohesion: 0.1
Nodes (22): TestDefaultRebuildTargets_PinsFullListIncludingMCPBinary(), buildStampLdflags(), copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), defaultRebuildMaterialize(), DefaultRebuildTargets(), GardenerRebuildTargets() (+14 more)

### Community 148 - "Community 148"
Cohesion: 0.14
Nodes (28): NewAgent(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory(), TestAgentNoPlan(), TestAgentSimpleExecution() (+20 more)

### Community 149 - "Community 149"
Cohesion: 0.11
Nodes (24): arc42OutputDir(), countCPUCores(), execWithTimeout(), getBoolChainState(), init(), registerArc42Nodes(), sectionFileExists(), setChainState() (+16 more)
...
Cohesion: 0.13
Nodes (20): CompanyOrchestrator, EngineerTree(), MarketingTree(), SalesTree(), StartupTrees(), clamp(), safeDiv(), checkTreeBasics() (+12 more)

### Community 152 - "Community 152"
Cohesion: 0.2
Nodes (27): acquireErrorHandlerClaudeLock(), acquireErrorHandlerFileLock(), acquireErrorHandlerStoreLock(), activeErrorHandlerExtensions(), appendErrorHandlerExtension(), errorHandlerDir(), errorHandlerExtensionsPath(), errorHandlerLedgerGet() (+19 more)
...
Cohesion: 0.1
Nodes (24): TestRunPipelineWithID_RecordsAgentMetrics(), handleSprintExecute(), syncWorkflowTaskStatus(), TestHandleSprintExecute_UpdatesCurrentWorkflow(), hermesOutcome(), isAuctionShapedTask(), NewAgentExecutor(), PickTreeForTask() (+16 more)

### Community 155 - "Community 155"
Cohesion: 0.11
Nodes (25): defaultNlmGrillAuthGuard(), nlmGrillAnswerer(), nlmGrillUnavailable(), parseNumberedAnswers(), runGrillAuthGuardAction(), TestNlmGrillAnswerer_AuthGuardFailureIsUnavailable(), TestNlmGrillAnswerer_EmptyOutputIsUnavailable(), TestNlmGrillAnswerer_NoAnswerMarkersIsUnavailable() (+17 more)

### Community 156 - "Community 156"
Cohesion: 0.11
Nodes (22): claudeBackoffWindow(), TestClaudeBackoffWindow_EnvOverride(), ClaudeRunner, CommandResult, CommandRunner, execClaudeRunner, execCommandRunner, claudeBackoffWindow() (+14 more)

### Community 158 - "Community 158"
Cohesion: 0.14
Nodes (22): isClaudeRateLimit(), fakeClaude, fakeCommitRunner, hookFailureClass, runVerificationPassed(), stageAndCommitSuperpowersRunInDir(), writeApplyCommitEvidence(), applyDeterministicCommitFixes() (+14 more)

### Community 159 - "Community 159"
Cohesion: 0.11
Nodes (23): Block, ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category, ComposeSpec (+15 more)

### Community 160 - "Community 160"
Cohesion: 0.11
Nodes (17): TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait(), ApprovalWaitResult, Pipeline, PipelineResult, Runner, Step (+9 more)
...
Cohesion: 0.25
Nodes (26): NewConfigWatcher(), TestConfigWatcher_BackwardCompatibleNoDotEnv(), TestConfigWatcher_ConfigChangeWithDotEnv(), TestConfigWatcher_DotEnvChangeDoesNotTriggerOnNoChange(), TestConfigWatcher_DotEnvFileDisappears(), TestConfigWatcher_DotEnvHotReload(), TestConfigWatcher_DotEnvPriorityChain(), TestConfigWatcher_FileAppears() (+18 more)

### Community 164 - "Community 164"
Cohesion: 0.16
Nodes (24): buildGrillRound1Query(), buildClaudeReviewPrompt(), TestBuildClaudeReviewPrompt_ContractMarkers(), arc42GoalsPromptBlock(), arc42ResearchTopics(), loadArc42QualityGoals(), TestArc42GoalsPromptBlockContainsEveryGoal(), TestArc42GoalsPromptBlockEmptyWhenDocMissing() (+16 more)

### Community 165 - "Community 165"
Cohesion: 0.14
Nodes (21): CompressionMiddleware(), isCompressibleContentType(), gzipDecompress(), TestCompressionMiddleware_AlreadyCompressed(), TestCompressionMiddleware_BinaryContentType(), TestCompressionMiddleware_EmptyBody(), TestCompressionMiddleware_GzipRequest(), TestCompressionMiddleware_HTMLContentType() (+13 more)

### Community 166 - "Community 166"
Cohesion: 0.18
Nodes (24): verifySuperpowersMainRepoRuntime(), safeSlug(), buildSuperpowersGreenPrompt(), buildSuperpowersRedPrompt(), buildSuperpowersTaskPrompt(), buildSuperpowersVerificationChecks(), buildVerifyLintFixPrompt(), changedFilesDeltaText() (+16 more)

### Community 167 - "Community 167"
Cohesion: 0.24
Nodes (24): NewGoalQueue(), NewGoalQueueFrom(), names(), names2(), TestGoalIsSatisfied(), TestGoalQueueAddAndSelect(), TestGoalQueueAddReplace(), TestGoalQueueAll() (+16 more)

### Community 168 - "Community 168"
Cohesion: 0.13
Nodes (18): fakeLLM, DefaultInitialState(), NewGoalFactory(), TestAutomationActions_ReachTaskAutomated(), TestGoalFactory_ArchetypeFallbackWhenLLMKeepsFailing(), TestGoalFactory_ArchetypeFallbackWithoutLLM(), TestGoalFactory_EmptyIntent(), TestGoalFactory_FromIntentLLM() (+10 more)

### Community 169 - "Community 169"
Cohesion: 0.08
Nodes (26): 5.0 Composable Blocks, 5.0 Composable building blocks (`internal/blocks`), 5.1 Whitebox Overall System, 5.2 Core Engine, 5.2 Level 2: Core Engine Whitebox, 5.3 Evolution Engine, 5.3 Level 2: Evolution Engine Whitebox, 5.4 Dashboard (+18 more)
...
Cohesion: 0.19
Nodes (22): saveRecordWithDelay(), TestEvolveTool_Call_NotEnoughFailures(), TestEvolveTool_Call_NoTree(), TestEvolveTool_Call_Success(), TestFitnessTool_Call(), TestFitnessTool_Call_NoData(), TestGetReflectionsTool_Call_NoRecords(), TestGetReflectionsTool_Call_Truncation() (+14 more)
...
Cohesion: 0.11
Nodes (11): NewPageAgent(), TestAgentLLMGeneration(), TestAgentMockFallback(), TestBubbleRecommendation(), NewHandler(), TestHandleBookmark(), TestHandleIntent(), TestHandleProfile() (+3 more)

### Community 174 - "Community 174"
Cohesion: 0.17
Nodes (17): extractBulletPoints(), extractFirstLine(), extractListSection(), extractSection(), findNextSection(), parseDebateTranscript(), parseProbability(), parseReport() (+9 more)

### Community 175 - "Community 175"
Cohesion: 0.17
Nodes (23): registerDecisionTreeAction(), TestDecisionTreeRoutesByChainStateMatch(), TestDecisionTreeUsesDefaultBranchWhenNoMatch(), TestDecisionTreeValidatesAsKnownNodeType(), RouteHistory(), modelRouterTree(), TestCollectBranchLabels_SkipsDefault(), TestModelRouting_HighConfidenceRoutesToModelLabel() (+15 more)

### Community 176 - "Community 176"
Cohesion: 0.18
Nodes (25): assertInvalidContains(), buildDeepTree(), TestBuildTree_InvalidTreeReturnsFailureCommand(), TestValidateTree_CycleDeep(), TestValidateTree_CycleDetected(), TestValidateTree_NoCycle(), TestVerifierFull_AlwaysSucceedRejectsChildren(), TestVerifierFull_BackwardCompat() (+17 more)

### Community 177 - "Community 177"
Cohesion: 0.18
Nodes (15): ChildStats, NodeExecutionRecord, applyOrderToNode(), Entropy(), GiniImpurity(), InformationGain(), isSelectorFallback(), normalizedIG() (+7 more)

### Community 178 - "Community 178"
Cohesion: 0.17
Nodes (21): NewMCTSMutator(), hasNodeWithPrefix(), mockFitnessEvaluator(), testBaseTree(), TestMCTSMutation_FitnessGap(), TestMCTSMutator_Backpropagate(), TestMCTSMutator_BuildMutationOps(), TestMCTSMutator_ExpandNode() (+13 more)

### Community 179 - "Community 179"
Cohesion: 0.12
Nodes (19): TestDataPipelineTreeNoSourceReportsBlockedNotFabricated(), TestDataPipelineTreeUsesObservedFileMetrics(), TestDomainTreeMonitoringRoutesThroughEngine(), TestNotebookLMTreePreGateDiscoversRealToolset(), NotebookLMTree(), findChildByName(), hasNode(), TestNotebookLMResearchPathUsesDeterministicToolsAndAntiFabricationGuard() (+11 more)

### Community 180 - "Community 180"
Cohesion: 0.13
Nodes (7): envDefault(), main(), run(), RedisPriorityQueue, RedisQueue, RemoteExecutor, RemoteExecutorConfig

### Community 181 - "Community 181"
Cohesion: 0.08
Nodes (7): CreateAgentTool, EvolveTool, FitnessTool, GetReflectionsTool, GetTreeTool, RunTaskTool, truncateStr()
...
Cohesion: 0.12
Nodes (11): handleAnalyze(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation(), Task, NewTaskStore(), priorityRank(), TestNewTaskStore_PanicsOnCorruptFile(), TestTaskStore_ApprovedOrdersByPriorityThenSprint() (+3 more)

### Community 184 - "Community 184"
Cohesion: 0.21
Nodes (25): Collect(), indexOf(), GoapFusionPreflightNode(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionGatesClaudeImplementation(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesCircuitBreaker(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesCircuitPolicy(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesGitRemote(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightComposesGitTool() (+17 more)

### Community 185 - "Community 185"
Cohesion: 0.1
Nodes (17): agentNameFromBB(), init(), registerDelegateNodes(), init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init(), init() (+9 more)
...
Cohesion: 0.13
Nodes (7): FitnessFunc, firstNodeNameByType(), firstOpName(), maxInt(), MCTSMetrics, MCTSMutator, MCTSNode
...
Cohesion: 0.17
Nodes (20): activateAutomation(), automationAgentName(), considerAutomation(), finalizeAutomationApproval(), proposeAutomation(), registerAutomationTools(), suggestSchedule(), newAutopilotDeps() (+12 more)

### Community 191 - "Community 191"
Cohesion: 0.12
Nodes (18): captureExporter, ExportedEvent, ExportedSpan, ConfigureOTLPFromEnv(), firstNonEmpty(), NewOTLPHTTPExporter(), otlpTracePayload(), parseOTLPHeaders() (+10 more)

### Community 192 - "Community 192"
Cohesion: 0.11
Nodes (12): tracingMiddleware(), ContentItem, InputSchema, sanitizeArg(), Message, Property, RPCError, Server (+4 more)

### Community 193 - "Community 193"
Cohesion: 0.14
Nodes (19): min(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section(), TestGenerateTemplateOutput_TruncatedCache(), TestGenerateTemplateOutput_Arc42Section(), TestGenerateTemplateOutput_Arc42TitleNoNewline() (+11 more)

### Community 194 - "Community 194"
Cohesion: 0.16
Nodes (22): BuildDecisionTree(), childMatchesDecision(), chooseDecisionBranch(), decisionKey(), decisionValue(), defaultDecisionBranch(), stringifyDecisionValue(), buildRoutePrompt() (+14 more)

### Community 195 - "Community 195"
Cohesion: 0.15
Nodes (18): cleanupAppliedSuperpowersWorktree(), cleanupSuperpowersWorktree(), createSuperpowersWorktree(), planSuperpowersWorktree(), reapOrphanedSuperpowersBranches(), superpowersWorktreeBranches(), TestCleanupAppliedSuperpowersWorktreeNoOpsOnDryRun(), TestCleanupAppliedSuperpowersWorktreeRemovesWorktreeAndMergedBranch() (+10 more)

### Community 196 - "Community 196"
Cohesion: 0.25
Nodes (23): TestClaudeErrorHandler_DoesNotClobberExistingCategory(), requestErrorHandlerProposal(), swapErrorHandlerRunner(), TestRequestErrorHandlerProposal_RespectsCallerContext(), TestRequestErrorHandlerProposal_StampsLedgerOnEveryOutcome(), ehTestHandlerNode(), ehTestProposalJSON(), init() (+15 more)
...
Cohesion: 0.12
Nodes (9): DeepSeekClient, OpenAICompatClient, OpenAICompatConfig, openAICompatMessage, openAICompatRequest, openAICompatResponse, checkRateLimit(), ParseRetryAfter() (+1 more)

### Community 199 - "Community 199"
Cohesion: 0.14
Nodes (15): TestRunOnceFlushesSelectorTelemetry(), TestSelectorStatsFileSanitizesTreeID(), GoalArchetype, GoalFactory, clamp01(), containsAny(), DetectArchetype(), extractJSONObject() (+7 more)
...
Cohesion: 0.08
Nodes (23): 10.1 Quality Tree, 10.2 Quality Scenarios, 1.1 Requirements Overview, 1.2 Quality Goals (Top 3), 1.3 Stakeholders, arc42 Architecture Documentation — go-bt-evolve, arc42 Section 10 — Quality Requirements, arc42 Section 11 — Risks and Technical Debt (+15 more)
...
Cohesion: 0.13
Nodes (10): DashboardRoutes(), TestDashboardRoutes_AgentsExecuteHasRequestBody(), TestDashboardRoutes_AllHaveOperationIDs(), TestDashboardRoutes_AllRoutesBuildWithoutPanic(), TestDashboardRoutes_AuthConsistency(), TestDashboardRoutes_Completeness(), TestDashboardRoutes_GeneratesValidSpec(), TestDashboardRoutes_OperationIDUniqueness() (+2 more)

### Community 204 - "Community 204"
Cohesion: 0.18
Nodes (21): TestMutation_TargetNotFound(), TestMutation_WrapRetry(), applyAddAfter(), applyAddBefore(), applyAddFallback(), applyAddTool(), applyImprovePrompt(), applyIncreaseIterations() (+13 more)

### Community 205 - "Community 205"
Cohesion: 0.15
Nodes (20): TestBTOptimizer_New(), TestDTAnalyzer_New(), TestExtractCondition(), TestFindMainSelector(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), NewBTOptimizer() (+12 more)
...
Cohesion: 0.09
Nodes (14): TestComputeAnalytics_BottleneckCarriesStructuredFailure(), TestComputeAnalytics_Bottlenecks(), TestComputeAnalytics_BottleneckWithoutTraceHasEmptyFailure(), TestComputeAnalytics_BottleneckWithTrace(), TestComputeAnalytics_Centrality(), TestComputeAnalytics_CoverageGapsUseExpectedDomains(), TestComputeAnalytics_EmptyGraph(), TestComputeAnalytics_ExtendedEdges() (+6 more)
...
Cohesion: 0.13
Nodes (13): NewDocPlanner(), fakeBlackboard, TestValidatePlan(), TestAgentFailurePathsAndSummary(), TestBlackboardBridgeHandlesNilChainStateAndFailure(), TestBuildGoalFromTaskMultipleKeywordsAndTruncation(), TestDocPlannerAlreadyCompleteReturnsEmptyPlan(), TestDocPlannerWorldStateIgnoresWrongTypesAndMissingKeys() (+5 more)
...
Cohesion: 0.17
Nodes (19): buildRunActivitySummary(), fencedItems(), isFactLine(), joinCapped(), salientOutputLines(), TestBuildRunActivitySummaryCapsLongFencedLists(), TestBuildRunActivitySummaryEmptyEverything(), TestBuildRunActivitySummaryFailureLeadsWithReason() (+11 more)

### Community 213 - "Community 213"
Cohesion: 0.13
Nodes (3): Request, Status, Store
...
Cohesion: 0.1
Nodes (6): EvolveTool, GetReflectionsTool, GetTreeTool, truncateStr(), ReflectTool, RunTaskTool

### Community 217 - "Community 217"
Cohesion: 0.15
Nodes (19): NewOpenAICompatClient(), TestOpenAICompat_ClientErrorsDoNotTripBreaker(), TestOpenAICompat_ErrorResponse(), TestOpenAICompat_GenerateWithModel_RetryPolicyByStatusCode(), TestOpenAICompat_GenerateWithModel_SendsChatCompletion(), TestOpenAICompat_NonJSONServerError_IsRetried(), TestOpenAICompat_NonRetryableProbeErrorDoesNotWedgeBreaker(), TestOpenAICompat_OpenBreakerRejectsWithoutRequest() (+11 more)

### Community 218 - "Community 218"
Cohesion: 0.12
Nodes (12): TestEligibleBidders(), TestEligibleBidders_NoRequiredTagsMatchesAll(), BuildCardRegistry(), cardCoversTags(), ConvertToAgentCard(), EligibleBidders(), TestBuildCardRegistry(), TestConvertToAgentCard_Basic() (+4 more)

### Community 219 - "Community 219"
Cohesion: 0.15
Nodes (15): injectPersonaContext(), injectPersonaContextLocked(), mineUserPatterns(), personaEmbedder(), personaError(), recordPersonaInteraction(), registerPersonaTools(), NewHabitMiner() (+7 more)
...
Cohesion: 0.12
Nodes (17): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestSuperpowersWorkflowTree_BuildsAndValidates(), TestValidateNode_SequenceSkip(), TestValidateNode_UnknownAction() (+9 more)

### Community 223 - "Community 223"
Cohesion: 0.13
Nodes (15): DefaultBlockConfig(), NewMetaPromptEvolver(), NewMutationContext(), TestBlockConfig_FilterMutations(), TestBlockConfig_IsMutable(), TestCrisisDetector_LastDiversity(), TestDefaultBlockConfig(), TestExpert_MatchPattern() (+7 more)

### Community 224 - "Community 224"
Cohesion: 0.17
Nodes (19): TestSelectorOptimizer_New(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing() (+11 more)

### Community 225 - "Community 225"
Cohesion: 0.17
Nodes (17): Alert, apiFetch(), esc(), getCookie(), cbIcon(), createAgent(), deleteAgent(), loadAgents() (+9 more)

### Community 226 - "Community 226"
Cohesion: 0.13
Nodes (20): 8.10 Autonomous Landing Pipeline, 8.11 Observability, 8.12 A2A Auction Task Allocation, 8.13 Leaf-Node Structural Validation, 8.14 Fleet-Wide Node Description Coverage, 8.15 Validation-Gated Composition Activation, 8.16 Self-Extending Claude Error Recovery, 8.17 Composable Blocks and Expand-at-Build (+12 more)
...
Cohesion: 0.14
Nodes (18): isKnownActionName(), isKnownConditionName(), TestBuildNode_AbortOnEvent(), TestBuildNode_PlannerNode(), TestBuildNode_ReactiveParallel(), TestBuildNode_UtilitySelector(), TestIsKnownActionName_BuiltinOnly(), TestIsKnownActionName_Empty() (+10 more)

### Community 229 - "Community 229"
Cohesion: 0.16
Nodes (16): CollectBlockIDs(), FitnessRanking(), RecordTaskBlockFitness(), ScoreFromBlackboard(), TestRecordTaskBlockFitness(), BlockFitnessRanking(), BlockFitnessSnapshot(), BlockMetricsSnapshot() (+8 more)

### Community 230 - "Community 230"
Cohesion: 0.17
Nodes (17): NewEvolvedAgent(), TestConfig_AllFields(), TestCreateAgentTool_Call_NilFactory(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestNewEvolvedAgent_AllToolsRegistered() (+9 more)

### Community 231 - "Community 231"
Cohesion: 0.18
Nodes (16): main(), min(), requireOllamaFinanceTest(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis(), TestTeslaMarket(), TestTeslaModel() (+8 more)

### Community 232 - "Community 232"
Cohesion: 0.1
Nodes (19): Agent Categories, Architecture, BT Agent Platform, code:block1 (Agent YAML → Registry → Scheduler → resolveTree() → BuildTre), code:bash (# Prerequisites: Go 1.26+, Ollama (optional for LLM agents)), code:block3 (┌─────────────────────────────────────────────────────────┐), code:block4 (cmd/                          # Entrypoints (7 binaries)), code:block5 (Sequence "Main") (+11 more)
...
Cohesion: 0.16
Nodes (16): TestAuctionDelegate_AuctionErrorFails(), TestAuctionDelegate_AuctionWinsReturnsWinnerResult(), TestAuctionDelegate_EmitsTracingSpan(), TestAuctionDelegate_HookNotConfiguredFails(), TestAuctionDelegate_MissingTaskFails(), TestAuctionDelegate_NoBiddersFallsBackToDelegateToTree(), TestAuctionDelegate_NoBiddersNoFallbackTargetFails(), TestConsiderTreeCompileAction() (+8 more)

### Community 236 - "Community 236"
Cohesion: 0.23
Nodes (15): bbTool, attachBlackboardTools(), bbToolAppend(), bbToolList(), bbToolRead(), bbToolRecent(), bbToolSessionAppend(), bbToolSessionList() (+7 more)

### Community 237 - "Community 237"
Cohesion: 0.2
Nodes (6): jaccardSimilarity(), TestJaccardSimilarity(), TestTokenize(), tokenize(), ExperienceBank, ExperienceEntry

### Community 238 - "Community 238"
Cohesion: 0.19
Nodes (4): MultiFitness, cappedIndividuals(), ParetoFront, ParetoPopulation

### Community 239 - "Community 239"
Cohesion: 0.15
Nodes (15): deepSearchGardener(), deepSearchV2Config(), TestEvolveTreeV2_DeepSearchMetrics_PopulatedWhenTTConfigured(), TestEvolveTreeV2_DeepSearchMetrics_ZeroWithoutTranspositionTable(), TestMetricsTracker_CyclesForTree(), TestMetricsTracker_RecordAndSummary(), TestMetricsTracker_SaveAggregatesCrisisAndLastRun(), TestMetricsTracker_SaveAggregatesDeepSearchCoverage() (+7 more)

### Community 240 - "Community 240"
Cohesion: 0.23
Nodes (10): TestLocalSearchMutableParamsAndTabu(), extractMutableParams(), getFloatMeta(), NewLocalSearcher(), setFloatMeta(), toFloat64(), LocalSearcher, LocalSearchStrategy (+2 more)
...
Cohesion: 0.25
Nodes (14): cardSignatureValid(), SignAgentCard(), TestAuctionCandidates_RejectsTamperedCardSignature(), TestConvertToAgentCard_AttachesSignature(), TestHandleGlobalAgentCard_ResponseIsSigned(), TestSignAgentCard(), TestSignAgentCard_Deterministic(), TestSignAgentCard_DifferentCards() (+6 more)

### Community 448 - "Community 448"
Cohesion: 0.11
Nodes (17): TestDeprecatedHandlerFunc(), TestNumberSchema(), DeprecationHeader, DeprecatedHandlerFunc(), httpStatusText(), NumberSchema(), TestDeprecatedHandlerFunc_WithSunset(), TestHTTPStatusText() (+9 more)
...
Cohesion: 0.2
Nodes (15): registerA2ANodes(), TestDelegateToA2A_FnNotConfigured(), TestDelegateToA2A_FnReturnsError(), TestDelegateToA2A_MissingTaskEmptyChainState(), TestDelegateToA2A_MissingURL(), TestDelegateToA2A_RateLimitCarryoverPropagates(), TestDelegateToA2A_Success(), TestDelegateToA2A_UsesTaskFromChainState() (+7 more)
...
Cohesion: 0.25
Nodes (17): saveRecordWithDelay(), TestEvolveTool_Call_NotEnoughFailures(), TestEvolveTool_Call_NoTree(), TestEvolveTool_Call_Success(), TestFitnessTool_Call(), TestFitnessTool_Call_NoData(), TestGetReflectionsTool_Call_NoRecords(), TestGetReflectionsTool_Call_Truncation() (+9 more)

### Community 458 - "Community 458"
Cohesion: 0.18
Nodes (5): NewNSGAIISorter(), TestNSGAII_FastNonDominatedSort(), NSGAIIFront, NSGAIIPopulation, NSGAIISorter

### Community 459 - "Community 459"
Cohesion: 0.17
Nodes (5): Bucket(), TestBucket(), MAPElitesGrid, MAPElitesPopulation, materializeMutationOp()

### Community 460 - "Community 460"
Cohesion: 0.2
Nodes (14): toast(), approveHITL(), approveTask(), executeSprint(), pollSprintStatus(), refreshHITL(), refreshTasks(), rejectHITL() (+6 more)
...
Cohesion: 0.14
Nodes (18): Added, Added, Added, Added, Added, Changed, Changelog, Chores (+10 more)
...
Cohesion: 0.19
Nodes (7): priorityWeight(), summarizeOutput(), TestPriorityWeight(), TestSummarizeOutput(), truncate(), MemoryEntry, MemoryStore

### Community 469 - "Community 469"
Cohesion: 0.14
Nodes (14): DiskInfo, GardenerMetrics, MemInfo, Metrics, collectSystem(), loadGardenerMetrics(), rankTopWinners(), TestCollect_SurfacesTopEvolvedWinnersFromTrees() (+6 more)

### Community 470 - "Community 470"
Cohesion: 0.2
Nodes (13): encodeJSON(), HandleHITL(), HandleHITLPending(), TestHITLHandlers_PendingApproveReject(), writeHITLResult(), TestApprove_FromEscalated(), TestApproveByTaskID_and_Escalate(), TestApproveByTaskID_FromEscalated() (+5 more)
...
Cohesion: 0.15
Nodes (13): TestComposeAndExpand(), TestExpand_BlockMetadata(), Expand(), expandNode(), HasSubTreeRefs(), init(), annotateBlockSource(), traceBlockOp() (+5 more)
...
Cohesion: 0.12
Nodes (17): 8.10 Autonomous Landing Pipeline, 8.11 Observability, 8.12 A2A Auction Task Allocation, 8.13 Leaf-Node Structural Validation, 8.14 Fleet-Wide Node Description Coverage, 8.15 Validation-Gated Composition Activation, 8.16 Self-Extending Claude Error Recovery, 8.1 Behavior Tree Execution Model (+9 more)

### Community 481 - "Community 481"
Cohesion: 0.23
Nodes (9): NewFallbackLLM(), TestFallbackLLM_CircuitBreakerSkipsPersistentlyFailingModel(), TestFallbackLLM_GenerateAllPanicReturnsAggregatedError(), TestFallbackLLM_GenerateRecoversPanicAndTriesNextModel(), TestFallbackLLM_GenerateReturnsAllFailures(), TestFallbackLLM_GenerateUsesNextModelAfterPrimaryFailure(), TestFallbackLLM_ValidationErrorsDoNotTripBreaker(), TestNewProvider_BuildsFallbackChainFromConfiguredModels() (+1 more)

### Community 482 - "Community 482"
Cohesion: 0.17
Nodes (14): TestDefaultDeepSeekConfig(), TestDefaultDeepSeekConfig_WithEnvKey(), DefaultDeepSeekConfig(), DeepSeekConfig, deepseekMsg, deepseekRequest, deepseekResponse, fallbackSpec (+6 more)

### Community 483 - "Community 483"
Cohesion: 0.17
Nodes (3): LLMInterface, MockLLM, retryMockLLM
...
Cohesion: 0.13
Nodes (9): applyScriptRunner, cleanApplyScriptRunner, scriptedClaudeRunner, scriptedSuperpowersRunner, TestApplySuperpowersRunToMainRepoAppliesVerifiesGraphifiesAndCommits(), TestApplySuperpowersRunToMainRepoSavesPendingPatchWhenMainRepoDirty(), TestHasBlockingMainRepoDirtyIgnoresGeneratedArtifacts(), readFileForTest() (+1 more)

### Community 486 - "Community 486"
Cohesion: 0.38
Nodes (14): autofixScriptRunner, autofixScriptStep, VerifySuperpowersRunRuntime(), autofixVerifyRun(), TestVerifyLintFixMaxAttemptsZeroDisablesClaude(), TestVerifySuperpowersRunAutofixesLintOnlyFailure(), TestVerifySuperpowersRunClaudeRepairStillFailsIsFinal(), TestVerifySuperpowersRunClaudeRepairsUnfixableLint() (+6 more)

### Community 487 - "Community 487"
Cohesion: 0.16
Nodes (13): Outcome, Record, FilterByTreeName(), NewRegistryWithUsers(), recordsForEntry(), TestBankFor_NoUserRootFallsBackToShared(), TestBankFor_PersonalTreesGetPerUserBank(), TestBankFor_TransientOpenErrorDoesNotPermanentlyCacheSharedBank() (+5 more)
...
Cohesion: 0.23
Nodes (12): mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldBBMu(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu(), TestBTBlocksComposeSaveHoldsServerLock() (+4 more)

### Community 493 - "Community 493"
Cohesion: 0.18
Nodes (11): TaskLogPath(), Entry, auditLogAction(), fitnessProbeAction(), fitnessScoreFromBB(), init(), pushToDLQAction(), registerOpsActions() (+3 more)
...
Cohesion: 0.43
Nodes (12): partialLandingRunner, greenFail(), greenPass(), partialLandingRun(), redFail(), TestBatchFirstTaskFailureStaysAllOrNothing(), TestBatchFullSuccessUnwrapsSnapshots(), TestBatchMidBatchSnapshotDegradeStillUnwraps() (+4 more)
...
Cohesion: 0.23
Nodes (7): BlockConfig, findBlockForNode(), DiffMutation, EvolveBlock, MetaPromptEvolver, MutationContext, MutationTemplate
...
Cohesion: 0.32
Nodes (13): computeLayout(), countNodes(), hideNodeDetail(), loadMindMap(), nodeColors, pushDescendantsDown(), renderMindMap(), renderTree() (+5 more)
...
Cohesion: 0.31
Nodes (12): TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeTracer, mockOllamaServer(), newTestClient(), TestClient_AnalyzeComplexity(), TestClient_Generate() (+4 more)

### Community 713 - "Community 713"
Cohesion: 0.23
Nodes (12): handleFellows(), DebateTurn, Fellow, DefaultFellows(), Report, ResearchFinding, ReviewComment, Scenario (+4 more)
...
Cohesion: 0.19
Nodes (13): TestPlanStepsToStrings(), TestPlanStepsToStrings_Empty(), TestStringField_Exists(), TestStringField_Missing(), TestStringField_WrongType(), TestWorldStateFromMap(), getStepResults(), planStepsToStrings() (+5 more)
...
Cohesion: 0.16
Nodes (4): contains(), stringsContains(), TestGetSLOMetrics_SameInstance(), TestSLOMetrics_Summary()

### Community 722 - "Community 722"
Cohesion: 0.16
Nodes (5): CategorizedError, ErrorContext, TestJitterStrategy_String(), TruncateForError(), JitterStrategy
...
Cohesion: 0.18
Nodes (14): Catalog, code:go (type Definition struct {), code:go (type Registry struct { ... }), code:go (type Catalog struct { ... }), code:go (type Scheduler struct { ... }), code:go (type History struct { ... }), History, Package: agent (+6 more)

### Community 725 - "Community 725"
Cohesion: 0.19
Nodes (13): 6.1 Task Execution Scenario, 6.2 Evolution Cycle, 6.3 Sprint Execution, 6.4 Error Recovery, 6.4 Self-Improvement Cycle (goap-fusion loop), 6.5 Error Recovery, 6. Runtime View, arc42 Section 6 — Runtime View (+5 more)

### Community 726 - "Community 726"
Cohesion: 0.16
Nodes (13): 7.1 Infrastructure Level 1, 7.2.1 Process Tree, 7.2.2 Storage Layout, 7.2.3 Network Topology, 7.2 Infrastructure Level 2, 7. Deployment View, arc42 Section 7 — Deployment View, code:block1 (systemd --user) (+5 more)

### Community 727 - "Community 727"
Cohesion: 0.14
Nodes (13): code:text (docs/superpowers/runs/<run-id>/), code:markdown (### Task N: Title), code:go (evolution.SerializableNode{), code:go (func SuperpowersPipelineTree() *evolution.SerializableNode {), code:yaml (name: superpowers-prod-runner), Current Stub Surface To Replace, Done Definition, Production Acceptance Criteria (+5 more)
...
Cohesion: 0.23
Nodes (11): NewACPClient(), countCrashInvocations(), TestACPClientCircuitBreakerShortCircuitsRepeatedSubprocessFailures(), TestACPClientGenerateCtx_StderrBufferRace(), TestACPClientGenerateReturnsErrorWhenSessionMissing(), TestACPClientGenerateTalksToACPServer(), TestACPClientGenerateTalksToHermesACP(), TestACPHelperProcess() (+3 more)

### Community 730 - "Community 730"
Cohesion: 0.23
Nodes (9): TestVerifyGoapFusionEvidenceAcceptsDelegatedVerification(), TestVerifyGoapFusionEvidenceKeysOnNormalizedDelegationToken(), TestVerifyGoapFusionEvidenceRejectsBogusVerification(), writeGoapFusionCycleReport(), TestVerifyGoapFusionEvidenceClassifiesCommitted(), TestVerifyGoapFusionEvidenceClassifiesDegraded(), TestVerifyGoapFusionEvidenceClassifiesNoChange(), TestVerifyGoapFusionEvidenceClassifiesRedPassAsNoChange() (+1 more)
...
Cohesion: 0.17
Nodes (4): DefaultGoalAttemptsPath(), TestDefaultGoalAttemptsPath(), GoalAttempt, GoalAttemptStore

### Community 743 - "Community 743"
Cohesion: 0.2
Nodes (8): docChangeContextFromBlackboard(), init(), registerArc42SyncNode(), TestArc42DocsyncNodesRegistered(), TestDocChangeContextFromBlackboardFallsBackToGit(), TestRegisteredNames_SortedAndComplete(), RegisteredActionNames(), RegisteredConditionNames()
...
Cohesion: 0.26
Nodes (10): classifyErrorHandlerFailure(), goapFailureCategory(), isGoapFusionCycle(), init(), TestClassifyErrorHandlerFailure(), TestClassifyReliabilityFallback(), TestClaudeErrorHandler_ClassifiesUnclassifiedFailure(), TestClaudeErrorHandler_GoapFailureGetsGoapCategory() (+2 more)

### Community 750 - "Community 750"
Cohesion: 0.26
Nodes (10): TestBuildIdentityStampedRevisionFallback(), BuildIdentityFromBuildInfo(), scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered(), TestBlockDurationHistogramSeriesRendered(), TestBuildIdentityFromBuildInfo(), TestKGAnalyticsGaugesRenderedAndUpdated(), TestNodeDurationHistogramSeriesRendered() (+2 more)

### Community 751 - "Community 751"
Cohesion: 0.2
Nodes (3): TestNewEvolvedAgent(), mockLLM, mockModel
...
Cohesion: 0.17
Nodes (12): code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), Package: api, Package: benchmark (+4 more)

### Community 893 - "Community 893"
Cohesion: 0.17
Nodes (12): code:go (type Tool struct { ... }), code:go (type AgentCard struct { Name, Description, URL string }), code:go (type PlatformEvalResult struct { ... }), code:go (type BaselineStore struct { ... }), code:go (type WorkflowReport struct { ... }), code:go (type AgentInfo struct { Name, Status, Schedule string; Succe), Package: a2a, Package: benchreg (+4 more)
...
Cohesion: 0.17
Nodes (12): 5.1 Whitebox Overall System, 5.2 Level 2: Core Engine Whitebox, 5.3 Level 2: Evolution Engine Whitebox, 5.4 Level 2: Dashboard Whitebox, 5.5 Level 3: Chain Types Detail, arc42 Section 5 — Building Block View, code:block2 (┌───────────────────────────────────────────────────────────), code:block3 (internal/engine/) (+4 more)
...
Cohesion: 0.17
Nodes (11): Blackboard State Schema, code:block1 (User says "build X"), code:block2 (SuperpowersPipeline (Sequence, timeout=60m)), code:go (type SuperpowersBlackboard struct {), code:block9 (┌──────────┐    ┌──────────┐    ┌──────────┐    ┌──────────┐), Complete Behavior Tree Structure, Decision Tree — Workflow Graph, Key Design Decisions (+3 more)
...
Cohesion: 0.29
Nodes (8): bareSyncRunner, TestSyncSuperpowersRepoBareRepoSurfacesFetchFailure(), TestBareSyncDivergedMasterFailsWithClearMessage(), TestBareSyncFetchFailureStillSurfaces(), TestBareSyncLocalAheadOfOriginProceedsWithoutRefUpdate(), TestBareSyncLocalBehindFastForwardsViaGuardedUpdateRef(), isBareGitRepo(), syncSuperpowersRepoForWorktree()
...
Cohesion: 0.29
Nodes (11): code:go (type Server struct { ... }), code:go (func NewServer(name, version string) *Server), Functions, Functions, Functions, Functions, Package: mcp, Types (+3 more)

### Community 973 - "Community 973"
Cohesion: 0.29
Nodes (11): code:go (type Config struct {), code:go (func Load() (*Config, error)                // priority: def), Functions, Functions, Functions, Functions, Package: config, Types (+3 more)
...
Cohesion: 0.18
Nodes (11): 6.1 Task Execution Scenario, 6.2 Evolution Cycle, 6.3 Sprint Execution, 6.4 Self-Improvement Cycle (goap-fusion loop), 6.5 Error Recovery, arc42 Section 6 — Runtime View, code:block10 (Any goroutine                   SafeGo wrapper              ), code:block6 (Hermes Agent                    bt-agent (MCP)              ) (+3 more)

### Community 977 - "Community 977"
Cohesion: 0.18
Nodes (11): 7.1 Infrastructure Level 1, 7.2.1 Process Tree, 7.2.2 Storage Layout, 7.2.3 Network Topology, 7.2 Infrastructure Level 2, arc42 Section 7 — Deployment View, code:block11 (systemd --user), code:block12 (~/.go-bt-evolve/) (+3 more)
...
Cohesion: 0.4
Nodes (8): TestValidate_OutputSchemaError(), floatPtr(), intPtr(), TestAgentDefinition_JSON_MarshalRoundtrip(), TestAgentDefinition_Validate_MissingFields(), TestAgentDefinition_Validate_Valid(), TestSchemaValidation(), TestValidateOutput()
...
Cohesion: 0.27
Nodes (6): TestExpertKnowledge_SeedSpecialistsCarryProvenance(), appendResurrectedTag(), firstSpecialistType(), itoa(), SpecialistArchetype, SpecialistRegistry
...
Cohesion: 0.24
Nodes (8): TestAnalyzeImprovementGaps_NoFabricatedEngineTestBlocker(), Analyzer, extractJSON(), truncate(), TestExtractJSON(), SkillSpec, TreeNode, TreeSpec

### Community 987 - "Community 987"
Cohesion: 0.36
Nodes (7): arc42SyncRunner, syncArc42Docs(), arc42TestRun(), TestArc42SyncNoImpactIsClean(), TestArc42SyncSkipsDryRunAndMainRepoModes(), TestArc42SyncSkipsWithoutProductionChanges(), TestArc42SyncUpdatesDocAndChangedFiles()

### Community 989 - "Community 989"
Cohesion: 0.24
Nodes (8): Config, EvolvedAgent, buildEvolvedPrompt(), toolDescriptions(), toolNames(), TestBuildEvolvedPrompt(), TestToolDescriptions(), TestToolNames()

### Community 990 - "Community 990"
Cohesion: 0.27
Nodes (8): assertNoExecutePlanStubs(), containsNodeName(), minStr(), TestGoapFusion_DeterministicActions(), TestGoapFusion_FullTree_Direct(), TestGoapFusion_Structure(), containsNodeType(), TestSuperpowersPipeline_ProductionContract_NoPlaceholderPath()

### Community 991 - "Community 991"
Cohesion: 0.4
Nodes (8): NotebookLMTree(), findChildByName(), TestNotebookLMResearchPathUsesCurrentNLMCLIAndAntiFabricationGuard(), TestNotebookLMResearchPathUsesDeterministicToolsAndAntiFabricationGuard(), TestNotebookLMTreeIncludesIdempotencyStateActions(), TestNotebookLMTreeRoutesResearchBeforeIngestAndQuery(), TestNotebookLMTreeUsesDeterministicEvidenceGateBeforeSuccess(), TestNotebookLMTreeUsesSetupNotebookLMToolsNotUniversal()

### Community 992 - "Community 992"
Cohesion: 0.24
Nodes (4): Outcome, Record, Store, FilterByTreeName()

### Community 993 - "Community 993"
Cohesion: 0.24
Nodes (6): collectSelectorNames(), SelectorStatsFile(), RecordSelectorChildOutcomes(), TestRecordSelectorChildOutcomes_SkipsEmptyAndMalformed(), TestRecordSelectorChildOutcomes_WritesAndAccumulates(), SelectorChildOutcome
...
Cohesion: 0.2
Nodes (9): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, arc42 Section 9 — Architecture Decisions (+1 more)
...
Cohesion: 0.39
Nodes (7): foreachTaskLoop(), SuperpowersWorkflowTree(), systematicDebugging(), tddTask(), TestSuperpowersWorkflowTree_GrillLoopShape(), TestSuperpowersWorkflowTree_ValidatesAndCoversPhases(), withMatch()
...
Cohesion: 0.28
Nodes (8): 3.1 Business Context, 3.2 Technical Context, 3. Context and Scope, arc42 Section 3 — Context and Scope, code:block1 (Hermes Agent ──(MCP tools via ─┐             ┌─(HTTP :9800)─), Communication Partners, External Interfaces, System Boundary
...
Cohesion: 0.31
Nodes (8): 1.1 Requirements Overview, 1.1a Target Vision — Personalized Self-Evolving Agents (Roadmap), 1.2 Quality Goals, 1.2 Quality Goals (Top 3), 1.2 Quality Goals (Top 4), 1.3 Stakeholders, 1. Introduction and Goals, arc42 Section 1 — Introduction and Goals

### Community 1025 - "Community 1025"
Cohesion: 0.22
Nodes (9): 1. Index-Based Sequence (IteratorNode), 2. RuleGate Node, 3. Spine Memory Context Slicer, 4. Reactive Selector, code:go (// internal/engine/iterator.go), code:go (// internal/engine/gating.go), code:go (// internal/engine/spine_memory.go), code:go (// internal/engine/reactive_selector.go) (+1 more)

### Community 1026 - "Community 1026"
Cohesion: 0.22
Nodes (8): Task 10: HITL Gate Actions, Task 11: Implementation Actions (Claude Code path), Task 12: Verification Actions, Task 13: Finishing Actions, Task 7: Brainstorming Actions, Task 8: Worktree Actions, Task 9: Planning Actions, Tier 2: Domain Tree + Actions

### Community 1028 - "Community 1028"
Cohesion: 0.25
Nodes (3): EdgeType, NodeValidationInfo, TypedEdge

### Community 1030 - "Community 1030"
Cohesion: 0.46
Nodes (6): fakeNlmAuth, runAuthAction(), TestNlmAuthExpiredRefreshesAndRecoversOnCleanRecheck(), TestNlmAuthHealthySkipsRefresh(), TestNlmAuthStillExpiredAfterRefreshFails(), withFakeNlmAuth()
...
Cohesion: 0.29
Nodes (5): observeNode(), TestBuildTree_ObservesNodes(), TestObserveNode_RecordsMetrics(), tickStatusLabel(), observedCommand

### Community 1033 - "Community 1033"
Cohesion: 0.29
Nodes (3): repeatChar(), TestHistoryQualityScore_UsesSpecWhenHigher(), TestIsRateLimitCarryover()

### Community 1034 - "Community 1034"
Cohesion: 0.5
Nodes (6): LoadMutatedTreeOverride(), mutatedTreesDir(), sanitizeTreeID(), SaveMutatedTree(), TestMutatedTreeFilenameSanitized(), TestMutatedTreeOverrideRoundTrip()
...
Cohesion: 0.25
Nodes (7): Before, GOAP Fusion Superpowers Implementation Plan, Improvement Gaps, NotebookLM Research, Prioritized Goals, Research/GAP Context, Vault Research Excerpt
...
Cohesion: 0.43
Nodes (5): NotebookLMFitness(), RegisterNotebookLMFitness(), TestRegisterNotebookLMFitness_DoesNotAffectOtherTrees(), TestRegisterNotebookLMFitness_WiresIntoKnowledgeGraph(), NotebookLMRunSummary

### Community 1062 - "Community 1062"
Cohesion: 0.57
Nodes (5): CEOTree(), CTOTree(), PMTree(), Roles(), TestRoles()
...
Cohesion: 0.29
Nodes (7): code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), Package: log, Package: persistence, Package: util
...
Cohesion: 0.29
Nodes (7): 3.1 Business Context, 3.2 Technical Context, arc42 Section 3 — Context and Scope, code:block1 (┌─────────────────────────────────────────────────────────┐), Communication Partners, External Interfaces, System Boundary

### Community 1288 - "Community 1288"
Cohesion: 0.29
Nodes (6): Acceptance Criteria, Architecture, Goal, Risks, Superpowers Design, Test Strategy
...
Cohesion: 0.33
Nodes (5): ADR-008: Composable Behavior-Tree Building Blocks, Consequences, Context, Decision, Status

### Community 1296 - "Community 1296"
Cohesion: 0.47
Nodes (5): IsKnownChainKind(), TestIsKnownChainKind(), addUniqueError(), sideEffectClass(), walkValidate()
...
Cohesion: 0.6
Nodes (4): addChatMsg(), agentNames, sendChat(), toggleChat()
...
Cohesion: 0.47
Nodes (5): 10.1 Quality Tree, 10.2 Quality Scenarios, 10. Quality Requirements, arc42 Section 10 — Quality Requirements, code:block1 (go-bt-evolve)

### Community 1304 - "Community 1304"
Cohesion: 0.53
Nodes (5): 2. Architecture Constraints, arc42 Section 2 — Architecture Constraints, Conventions, Organizational Constraints, Technical Constraints
...
Cohesion: 0.33
Nodes (5): ADR-009: Scoped Blackboard for Context Offloading, Consequences, Context, Decision, Related
...
Cohesion: 0.33
Nodes (6): Task 18: Unit Tests (all new actions), Task 19: Domain Tree Test, Task 20: Full Simulation, Task 21: Edge Case Simulation, Task 22: Failure Mode Simulation, Tier 4: Testing + Simulation

### Community 1326 - "Community 1326"
Cohesion: 0.33
Nodes (6): Task 1: IteratorNode (Index-Based Sequence), Task 2: RuleGate Node, Task 3: ReactiveSelector Node, Task 4: SpineMemoryManager, Task 5: Register New Nodes in Engine, Tier 1: Engine Extensions (blocking)

### Community 1327 - "Community 1327"
Cohesion: 0.27
Nodes (3): TestCreateAgentTool_Call_NilFactory(), ReflectTool, NewCreateAgentTool()

### Community 1328 - "Community 1328"
Cohesion: 0.6
Nodes (3): TestTaskStateBridge_A2AToBT(), TestTaskStateBridge_BTToA2A(), TestTaskStateBridge_IsTerminal()
...
Cohesion: 0.4
Nodes (3): ResetNodeCircuitBreakers(), TestBuildTree_WithTimeoutNode(), TestCircuitBreaker_OpensAfterFailures()

### Community 1333 - "Community 1333"
Cohesion: 0.6
Nodes (3): TestBuildPopulationStateWithGrid(), TestLLMSupervisor_ClassifyPhases(), TestLLMSupervisor_GuideRateWithinPhaseRange()
...
Cohesion: 0.6
Nodes (4): 4. Solution Strategy, arc42 Section 4 — Solution Strategy, Key Technology Decisions, Quality Goals → Solution Approaches

### Community 1352 - "Community 1352"
Cohesion: 0.6
Nodes (4): 11. Risks and Technical Debt, arc42 Section 11 — Risks and Technical Debt, Known Technical Debt, Prioritized Risk Table
...
Cohesion: 0.4
Nodes (5): Task 14: Agent YAML, Task 15: Domain Registration, Task 16: Action Registration, Task 17: Agent Registration, Tier 3: Agent YAML + Registration

### Community 1404 - "Community 1404"
Cohesion: 0.4
Nodes (5): code:bash (cd ~/go-bt-evolve && PATH="/usr/local/go/bin:$PATH" go build), Implementation Tasks, Task 23: Build + Deploy Binary, Task 24: Performance Test, Tier 5: Production Deployment
...
Cohesion: 0.83
Nodes (3): consumerChainPrompts(), TestNotebookLMConsumerTreeDoesNotWatchRetiredGlobOrOwnOutput(), TestNotebookLMConsumerTreeWatchesCurrentResearchNaming()
...
- `arc42 Goal Anchoring` → `Research Knowledge Store (knowledge.json)`  [AMBIGUOUS]
  docs/research-process-overhaul-2026-07-08.md · relation: conceptually_related_to

## Knowledge Gaps
- **10206 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+10201 more)
...
- **What is the exact relationship between `arc42 Goal Anchoring` and `Research Knowledge Store (knowledge.json)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Append()` connect `Community 22` to `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 29`, `Community 30`, `Community 38`, `Community 39`, `Community 41`, `Community 45`, `Community 48`, `Community 52`, `Community 55`, `Community 56`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 72`, `Community 74`, `Community 75`, `Community 77`, `Community 78`, `Community 79`, `Community 81`, `Community 83`, `Community 84`, `Community 85`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 94`, `Community 95`, `Community 98`, `Community 101`, `Community 102`, `Community 104`, `Community 109`, `Community 118`, `Community 125`, `Community 129`, `Community 134`, `Community 135`, `Community 137`, `Community 138`, `Community 139`, `Community 140`, `Community 144`, `Community 145`, `Community 149`, `Community 151`, `Community 154`, `Community 159`, `Community 160`, `Community 172`, `Community 173`, `Community 174`, `Community 176`, `Community 177`, `Community 178`, `Community 179`, `Community 183`, `Community 185`, `Community 187`, `Community 188`, `Community 191`, `Community 192`, `Community 194`, `Community 197`, `Community 711`, `Community 713`, `Community 203`, `Community 716`, `Community 715`, `Community 717`, `Community 204`, `Community 208`, `Community 718`, `Community 210`, `Community 213`, `Community 216`, `Community 729`, `Community 218`, `Community 221`, `Community 222`, `Community 227`, `Community 229`, `Community 230`, `Community 744`, `Community 745`, `Community 234`, `Community 746`, `Community 236`, `Community 237`, `Community 238`, `Community 240`, `Community 1296`, `Community 1297`, `Community 451`, `Community 452`, `Community 966`, `Community 455`, `Community 456`, `Community 969`, `Community 458`, `Community 459`, `Community 978`, `Community 979`, `Community 468`, `Community 983`, `Community 472`, `Community 985`, `Community 984`, `Community 474`, `Community 475`, `Community 471`, `Community 482`, `Community 487`, `Community 493`, `Community 497`, `Community 1011`, `Community 1013`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 36` to `Community 128`, `Community 3`, `Community 135`, `Community 1034`, `Community 139`, `Community 12`, `Community 13`, `Community 17`, `Community 147`, `Community 19`, `Community 20`, `Community 23`, `Community 25`, `Community 28`, `Community 34`, `Community 35`, `Community 1061`, `Community 49`, `Community 51`, `Community 180`, `Community 55`, `Community 61`, `Community 190`, `Community 191`, `Community 64`, `Community 192`, `Community 68`, `Community 453`, `Community 454`, `Community 74`, `Community 980`, `Community 470`, `Community 732`, `Community 93`, `Community 94`, `Community 482`, `Community 100`, `Community 107`, `Community 113`, `Community 117`, `Community 121`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 135` to `Community 128`, `Community 10`, `Community 12`, `Community 141`, `Community 143`, `Community 147`, `Community 19`, `Community 25`, `Community 27`, `Community 33`, `Community 163`, `Community 165`, `Community 173`, `Community 49`, `Community 180`, `Community 55`, `Community 57`, `Community 191`, `Community 192`, `Community 64`, `Community 67`, `Community 74`, `Community 203`, `Community 79`, `Community 470`, `Community 732`, `Community 93`, `Community 101`, `Community 231`, `Community 110`, `Community 113`, `Community 117`, `Community 126`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Are the 391 inferred relationships involving `Append()` (e.g. with `.Compare()` and `ParseBenchOutput()`) actually correct?**
  _`Append()` has 391 INFERRED edges - model-reasoned connections that need verification._
- **Are the 151 inferred relationships involving `DefaultTree()` (e.g. with `TestFullTreeIntegration_RunsAllTreesWithRealLLM()` and `TestDomainTree_Registration()`) actually correct?**
  _`DefaultTree()` has 151 INFERRED edges - model-reasoned connections that need verification._
- **Are the 148 inferred relationships involving `NewKnowledgeGraph()` (e.g. with `TestComputeAnalytics_EmptyGraph()` and `TestComputeAnalytics_Centrality()`) actually correct?**
  _`NewKnowledgeGraph()` has 148 INFERRED edges - model-reasoned connections that need verification._