# Graph Report - superpowers-20260713T043019-1d2ca422-goap-fusion-loop-runner-blackboard-conte  (2026-07-13)

## Corpus Check
- 830 files · ~923,842 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20321 nodes · 31505 edges · 1692 communities (1333 shown, 359 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8201 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fcb5eec8`
...
## Communities (1692 total, 359 thin omitted)
...
Cohesion: 0.02
Nodes (129): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+121 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (129): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+121 more)
...
Cohesion: 0.03
Nodes (47): Server, AgentMetric, Alert, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts() (+39 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (86): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), Entry, TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit() (+78 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (83): main(), main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview() (+75 more)
...
Cohesion: 0.04
Nodes (81): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure() (+73 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (72): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), Category, Compose() (+64 more)
...
Cohesion: 0.05
Nodes (71): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), buildChainActionFn() (+63 more)
...
Cohesion: 0.05
Nodes (34): extractJSONPayload(), TestValidateOutputs_Empty(), TestValidateOutputs_JSONDirect(), TestValidateOutputs_JSONFence(), TestValidateOutputs_JSONInvalid(), TestValidateOutputs_Markdown(), TestValidateOutputs_NoSpec(), validateOutputJSON() (+26 more)
...
Cohesion: 0.03
Nodes (42): findChildByName(), TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords() (+34 more)
...
Cohesion: 0.06
Nodes (68): TestScoreChild_GoalAlignmentBranch(), TestScoreChildren_BasicRanking(), ParallelMode, intSliceFromInterface(), BuildReactiveParallel(), childPanicHandler(), forkBlackboard(), intSliceFromInterface() (+60 more)
...
Cohesion: 0.07
Nodes (52): TestRunReactiveParallel_ParallelAll_AllSuccess(), TestRunReactiveParallel_ParallelAll_OneFails(), TestRunReactiveParallel_ParallelAny_FirstWins(), TestRunReactiveParallel_ParallelMonitor_OutOfBoundsIndex(), TestRunReactiveParallel_ParallelRace_TerminalReturned(), NewAgent(), NewDocPlanner(), assertError() (+44 more)
...
Cohesion: 0.08
Nodes (58): TestCheckConfidence_ConditionExists(), TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune(), makeRecords() (+50 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (62): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+54 more)
...
Cohesion: 0.06
Nodes (43): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, scriptedClaudeRunner, scriptedSuperpowersRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo() (+35 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (41): ActionFunc, ActionProvider, init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), ConditionFunc, ConditionProvider, init() (+33 more)
...
Cohesion: 0.07
Nodes (50): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), claudeBackoffWindow(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation() (+42 more)
...
Cohesion: 0.07
Nodes (23): TestNewPopulation_Evolution(), TestPopulation_Diversity(), extractTreeType(), TestEvolveWithExperience_NilBankStillEvolves(), TestExtractTreeType(), Individual, cloneTree(), collectNodeNames() (+15 more)
...
Cohesion: 0.06
Nodes (36): ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestScoreChild_NilChainState(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+28 more)
...
Cohesion: 0.11
Nodes (41): defaultGoapReviewDeps(), gatherFailureReviewBody(), gatherReviewContext(), init(), loadLastReviewedSHA(), nextNlmQuotaReset(), nlmQuotaExhausted(), nlmQuotaExhaustedUntil() (+33 more)
...
Cohesion: 0.07
Nodes (25): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleLogin(), handleLogout() (+17 more)
...
Cohesion: 0.08
Nodes (13): envDefault(), main(), run(), AgentExecutor, PageAgent, init(), registerSuperpowersDebugActions(), superpowersDebugPhase() (+5 more)
...
Cohesion: 0.11
Nodes (34): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir(), MemoryDir() (+26 more)
...
Cohesion: 0.07
Nodes (24): NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), alwaysSampler, Attr, neverSampler (+16 more)

### Community 92 - "Community 92"
Cohesion: 0.08
Nodes (25): AutoRebuildEnabled(), defaultDriftHead(), DriftStatus(), DriftWatchOnce(), scrubGitEnv(), StartDriftWatcher(), TestDriftStatus(), TestDriftWatchOnce() (+17 more)
...
Cohesion: 0.12
Nodes (32): captureExporter, NewOTLPHTTPExporter(), TestConfigureOTLPFromEnv(), TestConfigureOTLPFromEnv_DisabledWithoutEndpoint(), TestConsoleTracer_ExporterErrorDoesNotBreakEnd(), TestConsoleTracer_ExporterReceivesCompletedSpan(), TestOTLPHTTPExporter_Non2xx(), TestOTLPHTTPExporter_PostsOTLPJSON() (+24 more)
...
Cohesion: 0.08
Nodes (31): Binaries, code:go (type Counter struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }) (+23 more)
...
Cohesion: 0.14
Nodes (22): panickyPayload, computeHMAC(), DefaultWebhookSecrets(), NewWebhookPublisher(), TestComputeHMAC(), TestComputeHMAC_Deterministic(), TestComputeHMAC_DifferentKeys(), TestDefaultWebhookSecrets() (+14 more)

### Community 135 - "Community 135"
Cohesion: 0.13
Nodes (27): NewAgentCircuitBreaker(), NewAgentCircuitBreakerStore(), reportAgentOutcome(), TestAgentCircuitBreaker_Allow_Closed(), TestAgentCircuitBreaker_Allow_HalfOpen_SecondCall(), TestAgentCircuitBreaker_Allow_Open_Expired(), TestAgentCircuitBreaker_Allow_Open_NotExpired(), TestAgentCircuitBreaker_FailureCount() (+19 more)
...
Cohesion: 0.12
Nodes (20): main(), BTStudioCompany(), TestClient_AnalyzeComplexity_FallbackOnError(), TestClient_Generate_ConnectionRefused(), TestClient_GeneratePlan_FallbackOnError(), TestClient_Reflect_FallbackOnError(), TestDeepSeekClient_AnalyzeComplexity(), TestDeepSeekClient_Generate_APIError() (+12 more)
...
Cohesion: 0.11
Nodes (11): AgentCircuitBreaker, AgentCircuitBreakerStore, CircuitBreakerOptions, CircuitState, CircuitSummary, DefaultCircuitBreakerOptions(), TestDefaultCircuitBreakerOptions(), TestValidateAgentRun_Allowed() (+3 more)
...
Cohesion: 0.13
Nodes (18): extractTaskID(), init(), nlmAuthNeedsRefresh(), nlmAuthUnhealthy(), registerNotebookLMActions(), writeString(), recentImplementedGoals(), superpowersPlanAlreadyImplemented() (+10 more)
...
Cohesion: 0.12
Nodes (22): handleAgentsList(), AgentHistoryEntry, AgentInfo, agentStatus(), CreateAgent(), ListAgents(), ListAgentsWithCB(), listRegistryAgents() (+14 more)
...
Cohesion: 0.1
Nodes (12): builtinBlocks(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), HumanGateBlock(), HITLTieredBlock() (+4 more)
...
Cohesion: 0.13
Nodes (14): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestSuperpowersWorkflowTree_BuildsAndValidates(), containsLeafChildrenMsg(), TestRunTask_BackstopsEmptyResultOnNonSuccess() (+6 more)
...
Cohesion: 0.17
Nodes (12): code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), Package: evaluator, Package: factory (+4 more)
...
Cohesion: 0.28
Nodes (4): RunDeps, RunOptions, RunResult, TreeResolver
...
## Knowledge Gaps
- **6650 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6645 more)
...
- **Why does `Append()` connect `Community 7` to `Community 0`, `Community 513`, `Community 3`, `Community 5`, `Community 6`, `Community 520`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 526`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 534`, `Community 23`, `Community 24`, `Community 27`, `Community 540`, `Community 28`, `Community 31`, `Community 32`, `Community 543`, `Community 34`, `Community 35`, `Community 33`, `Community 38`, `Community 39`, `Community 40`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 64`, `Community 66`, `Community 67`, `Community 68`, `Community 71`, `Community 73`, `Community 74`, `Community 76`, `Community 77`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 86`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 94`, `Community 95`, `Community 96`, `Community 98`, `Community 99`, `Community 100`, `Community 101`, `Community 103`, `Community 110`, `Community 113`, `Community 117`, `Community 119`, `Community 123`, `Community 128`, `Community 132`, `Community 136`, `Community 137`, `Community 138`, `Community 140`, `Community 141`, `Community 142`, `Community 149`, `Community 151`, `Community 154`, `Community 155`, `Community 156`, `Community 159`, `Community 164`, `Community 678`, `Community 680`, `Community 168`, `Community 170`, `Community 172`, `Community 685`, `Community 174`, `Community 175`, `Community 176`, `Community 177`, `Community 182`, `Community 697`, `Community 192`, `Community 193`, `Community 194`, `Community 197`, `Community 198`, `Community 201`, `Community 203`, `Community 722`, `Community 726`, `Community 734`, `Community 743`, `Community 744`, `Community 783`, `Community 344`, `Community 345`, `Community 346`, `Community 353`, `Community 355`, `Community 358`, `Community 373`, `Community 376`, `Community 378`, `Community 510`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 65` to `Community 3`, `Community 134`, `Community 135`, `Community 9`, `Community 11`, `Community 14`, `Community 20`, `Community 21`, `Community 32`, `Community 165`, `Community 38`, `Community 40`, `Community 680`, `Community 43`, `Community 44`, `Community 52`, `Community 56`, `Community 59`, `Community 700`, `Community 61`, `Community 194`, `Community 67`, `Community 69`, `Community 74`, `Community 77`, `Community 78`, `Community 81`, `Community 725`, `Community 92`, `Community 352`, `Community 98`, `Community 106`, `Community 113`, `Community 121`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 44` to `Community 3`, `Community 516`, `Community 7`, `Community 13`, `Community 14`, `Community 16`, `Community 20`, `Community 151`, `Community 1047`, `Community 157`, `Community 32`, `Community 164`, `Community 38`, `Community 39`, `Community 40`, `Community 168`, `Community 42`, `Community 43`, `Community 52`, `Community 53`, `Community 55`, `Community 183`, `Community 59`, `Community 64`, `Community 65`, `Community 203`, `Community 205`, `Community 81`, `Community 978`, `Community 86`, `Community 89`, `Community 347`, `Community 103`, `Community 117`, `Community 761`, `Community 121`?**
