# Graph Report - superpowers-20260717T232832-cc81bd8d-goap-fusion-loop-runner-blackboard-conte  (2026-07-17)

## Corpus Check
- 911 files · ~1,182,725 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26428 nodes · 39368 edges · 2068 communities (1717 shown, 351 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9424 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dc7cb464`
...
1. `Append()` - 392 edges
2. `9. Architecture Decisions` - 160 edges
...
Cohesion: 0.03
Nodes (108): ApplyJitter(), ClassifyError(), contextDeadlineExceeded(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), FullJitter(), GetCategory() (+100 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (112): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+104 more)
...
Cohesion: 0.04
Nodes (81): alwaysSampler, Attr, captureExporter, TestConfigureOTLPFromEnv(), TestConfigureOTLPFromEnv_DisabledWithoutEndpoint(), TestConsoleTracer_ExporterErrorDoesNotBreakEnd(), TestConsoleTracer_ExporterReceivesCompletedSpan(), fakeTracer (+73 more)
...
Cohesion: 0.04
Nodes (86): auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext(), AuditMiddleware() (+78 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (68): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle() (+60 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (54): stringContains(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_ReflectGoapOutcome_NoResultsFallsBack(), cacheCheckAction(), cacheResultAction(), execLLMCallAction(), execRefineAction(), generatePlanAction() (+46 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (82): TestEndpointsFromCardsSingleNodeYieldsNoPeers(), TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, NewAgentRouter(), NewDeadLetterQueue(), NewLocalExecutor(), NewRouterFromEndpoints(), NewSchedulerState() (+74 more)
...
Cohesion: 0.04
Nodes (52): newAgentExecutor(), agentExecuteResult(), dashboardLocalAgentResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute() (+44 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (68): TestKnowledgeGraphRegistersAllDomainTrees(), TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_Existing(), TestAutoCreateTree_New(), TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents() (+60 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (56): TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir() (+48 more)
...
Cohesion: 0.04
Nodes (62): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+54 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (65): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), ensureSuperpowersForEachTaskSetup(), init() (+57 more)
...
Cohesion: 0.06
Nodes (62): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestArc42SectionsAgainstRealRepoDocs(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+54 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (53): containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest(), TestRunTask_CacheHit() (+45 more)
...
Cohesion: 0.06
Nodes (47): NewAgent(), NewDocPlanner(), fakeBlackboard, assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory() (+39 more)
...
Cohesion: 0.09
Nodes (57): main(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune(), TestTranspositionTable_Load_ExistingFile(), TestTranspositionTable_Load_NonExistent() (+49 more)
...
Cohesion: 0.07
Nodes (24): TestCheckConfidence_ConditionExists(), extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), collectNodeNames(), containsCrisisReason(), Crossover() (+16 more)
...
Cohesion: 0.07
Nodes (59): ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction(), buildChainActionFn() (+51 more)
...
Cohesion: 0.05
Nodes (32): routineThrottle, Warn(), Config, TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, biasCandidatesWithExperience() (+24 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (49): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField(), extractNotebookLMAnswer() (+41 more)
...
Cohesion: 0.07
Nodes (44): TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath(), TestDiscardWorktree_RemovesWorktreeAndDeletesBranch(), TestPushBranchAndCreatePR_InvokesGitPushAndGhPr(), withSwappedSuperpowersRunners(), init() (+36 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (40): min(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), brokenTool, generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState() (+32 more)

### Community 56 - "Community 56"
Cohesion: 0.14
Nodes (45): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Finance(), TestRouting_Research() (+37 more)
...
Cohesion: 0.06
Nodes (30): TestRunOnce_EmitsRunRootSpan(), main(), fanoutHandler, InitLogExport(), logExportTarget(), newTraceContextHandler(), TestInitLogExport_Idempotent(), TestLogExportTarget() (+22 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (37): perTreeStats(), setupGardener(), TestBaseNodeCount(), TestEvolveTree_WithRealTree(), TestMetricsTracker_BestFitnessTracking(), TestMetricsTracker_ImprovementRate(), TestMetricsTracker_LastFitnessTracking(), TestMetricsTracker_RecordAndCyclesForTree() (+29 more)
...
Cohesion: 0.09
Nodes (39): init(), registerFinanceActions(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled() (+31 more)
...
Cohesion: 0.07
Nodes (27): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports(), RunContext (+19 more)
...
Cohesion: 0.07
Nodes (48): cloneTreeForGardener(), DefaultEvolveV2Config(), serializeTreeForGardener(), crisisMetricsGardener(), crisisV2Config(), experienceRecordingGardener(), experienceReuseCount(), knowledgeRecordingGardener() (+40 more)
...
Cohesion: 0.06
Nodes (38): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+30 more)
...
Cohesion: 0.09
Nodes (42): FitnessDimension, makeTestTree(), NewNSGAIIPopulation(), NewNSGAIISorter(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance() (+34 more)

### Community 72 - "Community 72"
Cohesion: 0.08
Nodes (33): BehavioralDescriptor, FeatureDimension, Bucket(), Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid(), NewMAPElitesPopulation(), cellFitnesses() (+25 more)
...
Cohesion: 0.1
Nodes (40): Duration(), TestDuration(), jaccardSimilarity(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), growthFitness() (+32 more)
...
Cohesion: 0.08
Nodes (11): apiKey, KeyHash(), sha256Hex(), TestKeyHash_Deterministic(), APIKeyInfo, KeyRing, KeyRotationScheduler, Session (+3 more)
...
Cohesion: 0.07
Nodes (32): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+24 more)
...
Cohesion: 0.12
Nodes (34): TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), TestAction_PlanGoapActions_JSONActionsInvalidEntry(), TestAction_PlanGoapActions_NoPlanFound(), TestAction_PlanGoapActions_WithGoapConfig(), TestAction_PlanGoapActions_WorldStateFromTask() (+26 more)
...
Cohesion: 0.1
Nodes (25): AuctionDelegate(), cardWithURL(), newAuctionTransport(), newDeadlineProbeTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoCandidatesFallsBack(), TestAuctionDelegate_NoEligibleBidsFallsBack() (+17 more)
...
Cohesion: 0.07
Nodes (32): Embedding, EmbeddingClient, CosineSimilarity(), TestBuildIndex_PanicRecovered(), TestCosineSimilarity_BothZero(), TestCosineSimilarity_DifferentLengths(), TestCosineSimilarity_Empty(), TestCosineSimilarity_Identical() (+24 more)
...
Cohesion: 0.08
Nodes (34): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), IsKnownChainKind(), TestIsKnownChainKind(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), asFloat() (+26 more)
...
Cohesion: 0.1
Nodes (29): handleWorkflowRunFullPipeline(), TestHandleWorkflowRunFullPipeline_PersistsWorkflowAndTasks(), NewMockLLM(), NewDefaultCompany(), CompanyState, Decision, QuarterResult, companySummary() (+21 more)
...
Cohesion: 0.09
Nodes (22): attachLogHandler(), buildBaseHandler(), buildLogger(), envLogLevel(), Error(), Init(), L(), SetAsDefault() (+14 more)
...
Cohesion: 0.08
Nodes (12): DeepSeekClient, OpenAICompatClient, OpenAICompatConfig, openAICompatMessage, openAICompatRequest, openAICompatResponse, checkRateLimit(), CategorizedError (+4 more)
...
Cohesion: 0.13
Nodes (29): TestEvolveTreeV2_WithRealTree(), metaValidatorWiringGardener(), TestEvolveTreeV2_DeepSearchMutationRejectedByMetaValidatorNotPersisted(), TestEvolveTreeV2_DeepSearchMutationRejectedByValidationGateNotPersisted(), TestEvolveTreeV2_DeepSearchResultAppliedWhenGreedyLoopFindsNothing(), runFailClosedArm(), TestAcceptance_FailClosed_NoMutationsPersisted(), NewGardener() (+21 more)
...
Cohesion: 0.1
Nodes (21): TestIsBreakerSuccess(), applyOutcomeRefinement(), IsHealthyOutcome(), IsRateLimitCarryover(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome(), RunOptions, RunResult (+13 more)
...
Cohesion: 0.1
Nodes (27): TestNewPopulation_Evolution(), TestNewQTable(), TestNewReinforcementLearner(), TestPopulation_StatsAccessors(), TestEvolveWithExperience_NilBankStillEvolves(), TestEvolveWithExperience_RecordsImprovingMutations(), TestEvolveWithExperience_WarmStartConsultsBankHints(), TestQTableSelectUpdateBestAction() (+19 more)
...
Cohesion: 0.1
Nodes (19): TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree(), TestWireSelectorReorderIsOptIn() (+11 more)
...
Cohesion: 0.16
Nodes (15): degeneratePopulation(), runWithoutPanic(), TestEvolve_DegeneratePopulations(), TestEvolveWithExperience_DegeneratePopulations(), TestMemeticEvolve_DegeneratePopulations(), TestLocalSearchMutableParamsAndTabu(), extractMutableParams(), getFloatMeta() (+7 more)
...
Cohesion: 0.2
Nodes (23): ScoreAnnouncement(), SetTreeResolver(), bidArtifact(), drainExecute(), eventKinds(), executorForAgent(), skillCard(), terminalState() (+15 more)
...
Cohesion: 0.18
Nodes (18): TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), ApplyHITLPolicy(), TestHumanApprovalGate_AutoApprove(), TestHumanApprovalGate_ManualApprove(), TestHumanApprovalGate_PostPhase() (+10 more)

### Community 215 - "Community 215"
Cohesion: 0.12
Nodes (15): TestEvolveWithExperience_ResurrectsExtinctSpecialist(), TestExpertKnowledge_SeedSpecialistsCarryProvenance(), TestPopulationEvolve_ResurrectsExtinctSpecialist(), TestPopulationHealthSnapshot_DiversityCollapseRun(), TestMemeticEvolve_ResurrectsExtinctSpecialist(), TestNSGAIIPopulation_Evolve_ResurrectsExtinctSpecialist(), appendResurrectedTag(), firstSpecialistType() (+7 more)
...
Cohesion: 0.11
Nodes (10): agentNameInterceptor, agentNameKey, BTAgentExecutor, cardResponder, Server, failureEventMessage(), NewServer(), parseAnnouncement() (+2 more)
...
Cohesion: 0.11
Nodes (17): arc42 Docs Consolidation & Per-Section Sync Nodes — Implementation Plan, Canonical section layout (used by merge tasks, Go manifest, and drift script — keep all three in lockstep), code:bash (cd <repo-root>), code:bash (grep -F '## 10.1 Quality Tree' docs/arc42/10-quality.md && g), code:bash (git rm docs/arc42/go-bt-evolve-arc42.md docs/arc42/09-test-s), code:bash (grep -rn 'docs/adr' README.md docs/*.md | grep -v 'docs/plan), code:bash (git status --short          # expect: empty), code:bash (for f in 02-constraints 03-context-scope 04-solution-strateg) (+9 more)
...
Cohesion: 0.18
Nodes (12): TestAgentWithRealToolsBlocksFinalAnswerWithoutToolUse(), TestAgentWithRealToolsRejectsFinalAnswerWithoutToolUse(), TestDataPipelineTree_NoSourceReportsBlockedNotFabricated(), TestDataPipelineTree_UsesObservedFileMetrics(), TestEnsureTaskToolsCreatesRequestedTools(), TestNotebookLMTree_PreGateDiscoversRealToolset(), TestRealToolFactory_DiscoveryAndFailClosed(), TestSetupDefaultToolsRegistersRealTools() (+4 more)
...
Cohesion: 0.3
Nodes (13): TemplatesDir(), cmdCreate(), cmdDelete(), cmdInstallTemplates(), cmdList(), cmdLogs(), cmdRun(), cmdTemplates() (+5 more)
...
Cohesion: 0.13
Nodes (15): code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string) (+7 more)
...
Cohesion: 0.19
Nodes (10): TestNewGoBuildTool_Structure(), TestNewGoTestTool_Structure(), TestNewGoVetTool_Structure(), TestNewShellExecTool_Structure(), TestRealTool_Call(), TestRealTool_NameAndDescription(), TestToolStub_CallReturnsEmpty(), TestToolStub_CallReturnsError() (+2 more)
...
Cohesion: 0.42
Nodes (8): NewMetaValidator(), hasMetaIssue(), TestMetaValidator_AcceptsDefaultTree(), TestMetaValidator_RejectsBrokenStructure(), TestMetaValidator_RejectsFitnessRegression(), TestMetaValidator_RejectsNilTree(), TestMetaValidator_WarnsOnArchetypeMismatch(), TestEvolveTreeV2_MetaValidatorRejectsStructurallyBrokenMutation()

### Community 989 - "Community 989"
Cohesion: 0.33
Nodes (8): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_FeedbackPersistenceArmed(), TestBuildGardenerConfig_KnowledgeGraphWired(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired()
...
## Knowledge Gaps
- **10286 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+10281 more)
...
- **Why does `Append()` connect `Community 74` to `Community 1025`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 31`, `Community 32`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 56`, `Community 57`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 76`, `Community 77`, `Community 78`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 86`, `Community 87`, `Community 89`, `Community 90`, `Community 91`, `Community 94`, `Community 97`, `Community 98`, `Community 100`, `Community 101`, `Community 104`, `Community 105`, `Community 106`, `Community 111`, `Community 112`, `Community 114`, `Community 116`, `Community 117`, `Community 121`, `Community 124`, `Community 126`, `Community 131`, `Community 132`, `Community 136`, `Community 137`, `Community 140`, `Community 142`, `Community 144`, `Community 148`, `Community 149`, `Community 150`, `Community 151`, `Community 152`, `Community 160`, `Community 166`, `Community 181`, `Community 182`, `Community 183`, `Community 184`, `Community 186`, `Community 187`, `Community 189`, `Community 191`, `Community 192`, `Community 705`, `Community 193`, `Community 706`, `Community 199`, `Community 200`, `Community 712`, `Community 204`, `Community 205`, `Community 721`, `Community 209`, `Community 722`, `Community 212`, `Community 213`, `Community 215`, `Community 728`, `Community 217`, `Community 218`, `Community 730`, `Community 220`, `Community 224`, `Community 737`, `Community 225`, `Community 227`, `Community 741`, `Community 232`, `Community 233`, `Community 237`, `Community 1286`, `Community 952`, `Community 953`, `Community 452`, `Community 964`, `Community 461`, `Community 464`, `Community 977`, `Community 979`, `Community 467`, `Community 985`, `Community 474`, `Community 475`, `Community 480`, `Community 486`, `Community 488`, `Community 490`, `Community 491`, `Community 1005`, `Community 1006`, `Community 1013`, `Community 1014`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 24` to `Community 5`, `Community 6`, `Community 1034`, `Community 11`, `Community 12`, `Community 141`, `Community 16`, `Community 18`, `Community 19`, `Community 148`, `Community 23`, `Community 26`, `Community 155`, `Community 31`, `Community 32`, `Community 35`, `Community 1064`, `Community 42`, `Community 44`, `Community 51`, `Community 53`, `Community 58`, `Community 188`, `Community 62`, `Community 66`, `Community 451`, `Community 68`, `Community 69`, `Community 199`, `Community 204`, `Community 78`, `Community 81`, `Community 980`, `Community 213`, `Community 214`, `Community 475`, `Community 230`, `Community 107`, `Community 117`, `Community 118`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `DefaultTree()` connect `Community 44` to `Community 5`, `Community 14`, `Community 16`, `Community 21`, `Community 152`, `Community 24`, `Community 26`, `Community 27`, `Community 156`, `Community 153`, `Community 32`, `Community 166`, `Community 45`, `Community 51`, `Community 180`, `Community 183`, `Community 56`, `Community 58`, `Community 67`, `Community 71`, `Community 72`, `Community 76`, `Community 77`, `Community 78`, `Community 207`, `Community 208`, `Community 463`, `Community 82`, `Community 215`, `Community 988`, `Community 98`, `Community 106`?**
