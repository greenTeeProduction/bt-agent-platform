# Graph Report - superpowers-20260716T153525-c1dd1087-goap-fusion-loop-runner-blackboard-conte  (2026-07-16)

## Corpus Check
- 896 files · ~1,093,620 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24305 nodes · 36703 edges · 1921 communities (1574 shown, 347 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 9081 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d054fa22`
...
6. `arc42 Section 9 — Architecture Decisions` - 135 edges
...
## Communities (1921 total, 347 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (184): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+176 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (184): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+176 more)
...
Cohesion: 0.03
Nodes (90): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Block, TestComposeAndExpand(), Category, Compose(), ComposeFromRefs(), ComposeTaskTree() (+82 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (87): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+79 more)
...
Cohesion: 0.03
Nodes (89): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+81 more)
...
Cohesion: 0.04
Nodes (87): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), saveNlmQuotaExhausted(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField() (+79 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (83): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard() (+75 more)
...
Cohesion: 0.04
Nodes (71): docgenState, allSections(), buildSectionMap(), contains(), fileHash(), hashSectionSources(), isSectionDone(), main() (+63 more)
...
Cohesion: 0.05
Nodes (77): clearSuperpowersPlanState(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), registerSuperpowersProductionActions() (+69 more)
...
Cohesion: 0.04
Nodes (51): agentExecuteResult(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleAnalyze(), handleDLQReplay() (+43 more)
...
Cohesion: 0.05
Nodes (70): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+62 more)
...
Cohesion: 0.05
Nodes (41): handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus() (+33 more)
...
Cohesion: 0.06
Nodes (46): ConnPool, NewConnPool(), NewSharedConnPool(), TestAgentRouter_PooledExecutors_LeastConnections(), TestAgentRouter_WithSharedPool(), TestConnPool_Close(), TestConnPool_CloseIdleConnections(), TestConnPool_CustomConfig() (+38 more)
...
Cohesion: 0.05
Nodes (23): WebhookPublisher, TestActionForName_BulkCoverage(), TestSuperpowersTaskVerifyRed_NoTestsFailsWithoutPanic(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), namedTree, sprintRecover(), TestStress_ConcurrentExecution() (+15 more)
...
Cohesion: 0.1
Nodes (37): init(), registerFinanceActions(), init(), registerGoDevActions(), init(), registerResearchActions(), init(), loadBanditStats() (+29 more)
...
Cohesion: 0.07
Nodes (28): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), pipelineMockLLM, ApplyHITLPolicy(), countTreeNodes() (+20 more)

### Community 67 - "Community 67"
Cohesion: 0.08
Nodes (34): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), TestApplyJobScheduleRecomputesForNormalJob(), TestCrashedInFlightJobRunsImmediatelyAfterRestart() (+26 more)
...
Cohesion: 0.08
Nodes (41): TestCheckConfidence_ConditionExists(), TestIntegration_AllChainTypes(), TestIntegration_EdgeCases(), TestIntegration_MutationOperators(), TestIntegration_PanicRecovery(), TestIntegration_QualityGatesFullFlow(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected() (+33 more)
...
Cohesion: 0.08
Nodes (37): distributedDispatch, appendDispatchErr(), driveDistributedDispatch(), main(), parseNodes(), run(), multiNodeReport, TestMultiNode_ConcurrentAgentExecution() (+29 more)
...
Cohesion: 0.07
Nodes (31): TestNewReinforcementLearner(), TestQTableSelectUpdateBestAction(), TestQTableStateBucketsAndDepth(), TestReinforcementLearnerLearnAndSuggest(), NewQTable(), NewReinforcementLearner(), contextsOf(), TestExpertKnowledge_ObservesLearnedPatternFromQLearning() (+23 more)
...
Cohesion: 0.11
Nodes (15): TestDetermineCategory(), TestExtractKeywords(), Factory, AutoCreateTreeWith(), containsAnyStr(), determineCategory(), extractKeywords(), extractSubtree() (+7 more)
...
Cohesion: 0.09
Nodes (30): TestOutcomeErrorDetail(), FeedbackFile(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath() (+22 more)
...
Cohesion: 0.07
Nodes (36): Binaries, code:go (type Counter struct { ... }), code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Agent struct { ... }) (+28 more)
...
Cohesion: 0.07
Nodes (19): A2AHandoffBlock(), builtinBlocks(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), HumanGateBlock() (+11 more)
...
Cohesion: 0.09
Nodes (27): TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection() (+19 more)
...
Cohesion: 0.09
Nodes (20): NewRunDeps(), TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree() (+12 more)
...
Cohesion: 0.16
Nodes (24): buildGrillRound1Query(), buildClaudeReviewPrompt(), arc42GoalsPromptBlock(), arc42ResearchTopics(), loadArc42QualityGoals(), TestArc42GoalsPromptBlockContainsEveryGoal(), TestArc42GoalsPromptBlockEmptyWhenDocMissing(), TestArc42ResearchTopicsAnchoredToGoals() (+16 more)
...
Cohesion: 0.13
Nodes (23): mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu() (+15 more)
...
Cohesion: 0.14
Nodes (24): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionPreflightWired(), goapFusionRepeatedHashBypassed() (+16 more)
...
Cohesion: 0.14
Nodes (16): AgentMetrics, AgentStats, BuildIdentity, HealthResponse, formatPromLabels(), GetAgentMetrics(), labeledSnapshotToMap(), labelString() (+8 more)
...
Cohesion: 0.21
Nodes (18): saveRecordWithDelay(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolveTool_Call_NotEnoughFailures(), TestEvolveTool_Call_NoTree(), TestEvolveTool_Call_Success(), TestFitnessTool_Call(), TestFitnessTool_Call_NoData(), TestGetReflectionsTool_Call_NoRecords() (+10 more)
...
Cohesion: 0.13
Nodes (14): buildStampLdflags(), copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), defaultRebuildMaterialize(), DefaultRebuildTargets(), NewRebuildBackoff(), RebuildBinaries() (+6 more)
...
Cohesion: 0.18
Nodes (13): TestRunOnce_EmitsRunRootSpan(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), NewOTelTracer(), TestEndToEndOTLPExport() (+5 more)
...
Cohesion: 0.13
Nodes (15): code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) () (+7 more)
...
Cohesion: 0.24
Nodes (13): TestPromoteSubtree(), ApplyBlockMutations(), blockIDFromOp(), collectNames(), evolutionApplyAddAfter(), evolutionApplyAddBefore(), extractSubtree(), pickInsertOp() (+5 more)
...
Cohesion: 0.14
Nodes (13): code:text (docs/superpowers/runs/<run-id>/), code:go (sel("Phase1_Design",), code:markdown (### Task N: Title), code:go (evolution.SerializableNode{), code:go (// Deprecated: use ExecuteSuperpowersTaskBatch.), Current Stub Surface To Replace, Done Definition, Migration / Cleanup Notes (+5 more)
...
Cohesion: 0.21
Nodes (4): exportMemoryCategory(), exportPreviousRuns(), ResolvePipelineAgent(), RunDeps
...
Cohesion: 0.22
Nodes (8): applyOutcomeRefinement(), IsHealthyOutcome(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome(), RunOptions, RunResult, TreeResolver, UserTreeResolver
...
Cohesion: 0.22
Nodes (9): TestCreateAgentTool_Call_NilFactory(), TestReflectTool_Call_NoLLM(), TestReflectTool_Call_WithLLM(), TestRunTaskTool_Call(), TestToolNames_And_Descriptions(), NewCreateAgentTool(), NewFitnessTool(), NewReflectTool() (+1 more)
...
Cohesion: 0.33
Nodes (4): ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestWrapReliable_HasTimeoutAndFallbacks()
...
## Knowledge Gaps
- **8980 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8975 more)
...
- **Why does `Append()` connect `Community 24` to `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 31`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 39`, `Community 43`, `Community 45`, `Community 46`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 60`, `Community 61`, `Community 65`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 74`, `Community 76`, `Community 77`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 100`, `Community 101`, `Community 108`, `Community 110`, `Community 113`, `Community 114`, `Community 115`, `Community 119`, `Community 122`, `Community 124`, `Community 125`, `Community 126`, `Community 127`, `Community 130`, `Community 643`, `Community 132`, `Community 646`, `Community 136`, `Community 650`, `Community 139`, `Community 141`, `Community 653`, `Community 147`, `Community 659`, `Community 154`, `Community 157`, `Community 160`, `Community 161`, `Community 675`, `Community 678`, `Community 167`, `Community 681`, `Community 170`, `Community 169`, `Community 172`, `Community 173`, `Community 682`, `Community 175`, `Community 171`, `Community 179`, `Community 188`, `Community 204`, `Community 207`, `Community 208`, `Community 209`, `Community 213`, `Community 215`, `Community 217`, `Community 219`, `Community 221`, `Community 222`, `Community 223`, `Community 224`, `Community 823`, `Community 876`, `Community 892`, `Community 897`, `Community 898`, `Community 910`, `Community 921`, `Community 411`, `Community 412`, `Community 413`, `Community 926`, `Community 414`, `Community 927`, `Community 933`, `Community 424`, `Community 425`, `Community 939`, `Community 430`, `Community 437`, `Community 442`, `Community 443`, `Community 445`, `Community 447`, `Community 452`, `Community 455`, `Community 975`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 91` to `Community 129`, `Community 899`, `Community 5`, `Community 6`, `Community 8`, `Community 910`, `Community 15`, `Community 17`, `Community 18`, `Community 23`, `Community 409`, `Community 26`, `Community 27`, `Community 925`, `Community 30`, `Community 31`, `Community 35`, `Community 166`, `Community 44`, `Community 53`, `Community 185`, `Community 186`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 66`, `Community 67`, `Community 201`, `Community 205`, `Community 977`, `Community 213`, `Community 109`, `Community 115`, `Community 121`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 35` to `Community 645`, `Community 5`, `Community 8`, `Community 1290`, `Community 140`, `Community 15`, `Community 19`, `Community 23`, `Community 152`, `Community 24`, `Community 27`, `Community 31`, `Community 417`, `Community 166`, `Community 170`, `Community 428`, `Community 45`, `Community 51`, `Community 52`, `Community 182`, `Community 55`, `Community 185`, `Community 59`, `Community 61`, `Community 65`, `Community 195`, `Community 69`, `Community 73`, `Community 207`, `Community 81`, `Community 211`, `Community 88`, `Community 91`, `Community 105`, `Community 873`, `Community 115`, `Community 121`, `Community 125`?**
