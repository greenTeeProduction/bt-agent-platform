# Graph Report - superpowers-20260715T131301-9a21d49e-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-15)

## Corpus Check
- 866 files · ~1,031,341 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22881 nodes · 34769 edges · 1846 communities (1488 shown, 358 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8724 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `345e4658`
...
5. `registerMCPTools()` - 118 edges
6. `arc42 Section 9 — Architecture Decisions` - 112 edges
...
## Communities (1846 total, 358 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (165): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+157 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (165): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+157 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (103): main(), TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch() (+95 more)
...
Cohesion: 0.04
Nodes (87): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), TestComposeAndExpand(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), composeOrderedWithMiddle() (+79 more)
...
Cohesion: 0.02
Nodes (112): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+104 more)
...
Cohesion: 0.05
Nodes (87): arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), completeGoapProgramMilestone(), extractGoapProgram() (+79 more)
...
Cohesion: 0.04
Nodes (74): docgenState, allSections(), buildSectionMap(), contains(), fileHash(), hashSectionSources(), isSectionDone(), main() (+66 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (81): DefaultLLM(), RealLLM(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), EvaluateBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic() (+73 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (71): TestTranspositionTable_DifferentTree_DifferentKey(), TestTranspositionTable_Eviction(), TestTranspositionTable_ProbeMiss(), TestTranspositionTable_StoreAndProbe(), TestTT_NonExistentDir(), TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact() (+63 more)
...
Cohesion: 0.05
Nodes (74): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes() (+66 more)
...
Cohesion: 0.05
Nodes (56): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo(), bareTestRun(), TestApplySuperpowersRunBareRepoRefusedFastForwardParksPendingPatch() (+48 more)
...
Cohesion: 0.04
Nodes (63): DefaultMock(), TestBuiltinSWELite_CoverageAndUniqueness(), TestMax1(), benchmarkPlanTree(), benchmarkSuccessTree(), TestBFCLV3LoadErrorsAndEmptyEvaluation(), TestBFCLV3LoadFlattenAndEvaluate(), TestBuiltinBFCLSuitesHaveStableShape() (+55 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (61): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+53 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (62): brokenTool, ChainConfig, ChainKind, bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction(), buildChainActionFn() (+54 more)
...
Cohesion: 0.05
Nodes (44): AgentMetrics, AgentStats, TestBuildIdentityStampedRevisionFallback(), BuildIdentity, Counter, Gauge, HealthResponse, Histogram (+36 more)
...
Cohesion: 0.07
Nodes (61): Duration(), TestDuration(), TestTranspositionTable_SaveLoadRoundTrip(), TestTranspositionTable_Store_EvictionPreservesLowestAmongSurvivors(), TestTranspositionTable_Store_EvictsLowestValueDeterministically(), TestTranspositionTable_Store_EvictsLowestValueRepeated(), TestTranspositionTable_StoreProbeMiss(), TestTranspositionTable_StoreProbeRoundTrip() (+53 more)
...
Cohesion: 0.06
Nodes (41): init(), registerGoDevActions(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+33 more)
...
Cohesion: 0.08
Nodes (41): biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), crisisMetricsGardener(), crisisV2Config() (+33 more)
...
Cohesion: 0.09
Nodes (35): TestDriftWatchOnce_SkipsRestartWhenJobStartedMidRebuild(), TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir() (+27 more)
...
Cohesion: 0.08
Nodes (25): main(), Analyzer, extractJSON(), NewAnalyzer(), truncate(), NewAgentFactory(), TestFactory_RejectsInvalidGeneratedTreeBeforePersisting(), TestGenerator_CompilesSkillActionsToChainActions() (+17 more)
...
Cohesion: 0.1
Nodes (15): AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce(), TestStartDriftWatcher_KickTriggersImmediateCheck(), TestAutoRestartEnabled(), TestDriftWatchOnceRestartHandoff() (+7 more)
...
Cohesion: 0.1
Nodes (11): A2AHandoffBlock(), builtinBlocks(), DelegateBlock(), EvolveOnFailureBlock(), HumanGateBlock(), HumanReviewBlock(), HITLTieredBlock(), MemoryLoadBlock() (+3 more)
...
## Knowledge Gaps
- **8169 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8164 more)
...
- **Why does `Append()` connect `Community 35` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 27`, `Community 28`, `Community 30`, `Community 32`, `Community 33`, `Community 34`, `Community 36`, `Community 37`, `Community 41`, `Community 42`, `Community 44`, `Community 47`, `Community 48`, `Community 50`, `Community 51`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 59`, `Community 61`, `Community 62`, `Community 64`, `Community 66`, `Community 68`, `Community 69`, `Community 70`, `Community 1095`, `Community 71`, `Community 72`, `Community 74`, `Community 1099`, `Community 76`, `Community 77`, `Community 78`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 86`, `Community 88`, `Community 89`, `Community 602`, `Community 603`, `Community 91`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 607`, `Community 90`, `Community 99`, `Community 604`, `Community 97`, `Community 103`, `Community 616`, `Community 615`, `Community 109`, `Community 110`, `Community 111`, `Community 115`, `Community 628`, `Community 118`, `Community 120`, `Community 122`, `Community 124`, `Community 125`, `Community 128`, `Community 131`, `Community 137`, `Community 139`, `Community 140`, `Community 144`, `Community 146`, `Community 149`, `Community 152`, `Community 160`, `Community 165`, `Community 167`, `Community 172`, `Community 180`, `Community 1205`, `Community 186`, `Community 191`, `Community 193`, `Community 195`, `Community 200`, `Community 201`, `Community 203`, `Community 204`, `Community 206`, `Community 207`, `Community 208`, `Community 211`, `Community 212`, `Community 214`, `Community 218`, `Community 221`, `Community 802`, `Community 813`, `Community 825`, `Community 826`, `Community 837`, `Community 847`, `Community 848`, `Community 853`, `Community 854`, `Community 858`, `Community 865`, `Community 389`, `Community 390`, `Community 397`, `Community 399`, `Community 404`, `Community 406`, `Community 412`, `Community 413`, `Community 414`, `Community 420`, `Community 421`, `Community 425`, `Community 426`, `Community 427`, `Community 431`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 22` to `Community 131`, `Community 4`, `Community 135`, `Community 8`, `Community 393`, `Community 12`, `Community 143`, `Community 17`, `Community 24`, `Community 33`, `Community 162`, `Community 35`, `Community 164`, `Community 38`, `Community 44`, `Community 1200`, `Community 181`, `Community 55`, `Community 56`, `Community 59`, `Community 60`, `Community 190`, `Community 64`, `Community 66`, `Community 67`, `Community 69`, `Community 70`, `Community 71`, `Community 74`, `Community 76`, `Community 207`, `Community 208`, `Community 213`, `Community 100`, `Community 123`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 60` to `Community 3`, `Community 4`, `Community 8`, `Community 12`, `Community 398`, `Community 15`, `Community 16`, `Community 19`, `Community 147`, `Community 22`, `Community 24`, `Community 158`, `Community 33`, `Community 37`, `Community 38`, `Community 42`, `Community 43`, `Community 45`, `Community 173`, `Community 175`, `Community 50`, `Community 182`, `Community 59`, `Community 63`, `Community 832`, `Community 66`, `Community 194`, `Community 195`, `Community 70`, `Community 74`, `Community 213`, `Community 101`, `Community 105`, `Community 109`, `Community 115`, `Community 123`, `Community 892`, `Community 126`?**
