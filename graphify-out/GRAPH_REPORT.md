# Graph Report - superpowers-20260715T053508-d423f5f5-goap-fusion-loop-runner-blackboard-conte  (2026-07-15)

## Corpus Check
- 853 files · ~999,768 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22431 nodes · 34147 edges · 1815 communities (1466 shown, 349 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8590 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4fe9caf7`
...
7. `arc42 Section 9 — Architecture Decisions` - 103 edges
...
## Communities (1815 total, 349 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (160): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+152 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (160): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+152 more)
...
Cohesion: 0.02
Nodes (103): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+95 more)
...
Cohesion: 0.04
Nodes (84): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure() (+76 more)
...
Cohesion: 0.08
Nodes (80): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+72 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (76): buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), markGoapFusionImplDegraded(), registerSuperpowersProductionActions() (+68 more)
...
Cohesion: 0.04
Nodes (27): AgentMetric, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON() (+19 more)
...
Cohesion: 0.04
Nodes (61): TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest() (+53 more)
...
Cohesion: 0.06
Nodes (68): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes() (+60 more)
...
Cohesion: 0.04
Nodes (44): agentExecuteResult(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleMetricsLive() (+36 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (54): perTreeStats(), setupGardener(), TestBaseNodeCount(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree() (+46 more)
...
Cohesion: 0.05
Nodes (58): TestNewReinforcementLearner(), NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation() (+50 more)
...
Cohesion: 0.05
Nodes (35): FilterByTreeName(), Config, TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, biasCandidatesWithExperience(), Gardener (+27 more)
...
Cohesion: 0.05
Nodes (40): Blackboard, ChildTick, childTickLog, TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure(), TestValidateOutputQualityRejectsRefusals(), collectNames() (+32 more)
...
Cohesion: 0.08
Nodes (46): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad() (+38 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (35): BTOptimizer, TestBTOptimizer_New(), TestDTAnalyzer_New(), collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestExtractCondition() (+27 more)
...
Cohesion: 0.07
Nodes (49): TestValidate_BanditSelectorRequiresUniqueName(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestValidate_MemoryNodesRequireUniqueNames(), TestSuperpowersWorkflowTree_BuildsAndValidates(), TestSideEffectClassOfSubtree_DeepChild(), TestSideEffectClassOfSubtree_MultipleChildren(), TestSideEffectClassOfSubtree_NoSideEffect() (+41 more)
...
Cohesion: 0.06
Nodes (38): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), Category, ComposeSpec (+30 more)
...
Cohesion: 0.07
Nodes (24): handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus() (+16 more)
...
Cohesion: 0.07
Nodes (15): Capability, Edge, templateFitness(), templateRunCount(), templateSelectionWeight(), templateStructuralFitness(), evolvedFitness(), blendedSelectionFitness() (+7 more)
...
Cohesion: 0.1
Nodes (16): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_Existing(), TestAutoCreateTree_New(), TestDetermineCategory(), TestExtractKeywords(), TestTruncateTask(), Factory, AutoCreateTree() (+8 more)
...
Cohesion: 0.08
Nodes (38): cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), crisisMetricsGardener(), crisisV2Config(), experienceRecordingGardener() (+30 more)
...
Cohesion: 0.13
Nodes (34): recordUserFeedback(), registerFeedbackTools(), newFeedbackDeps(), TestBTFeedbackRegistered(), TestRecordUserFeedback_FeedsSatisfactionAndFlags(), TestRecordUserFeedback_RejectsBadInput(), TestRecordUserFeedback_TrimsUserAndTreeID(), TestSeedCompileReflection_WritesOnceAndOverwrites() (+26 more)
...
Cohesion: 0.13
Nodes (33): recentImplementedGoals(), TestRecentImplementedGoalsReadsStore(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery(), nlmIsResearchImport(), nlmIsResearchStart() (+25 more)
...
Cohesion: 0.12
Nodes (30): superpowersPlanAlreadyImplemented(), TestSuperpowersPlanAlreadyImplementedRequiresAllTasks(), TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull(), TestBrainstormRejectedWhenFilesNotGoPath(), TestBrainstormRejectedWhenMalformedOrProse(), TestBrainstormRejectedWhenNotDeeper(), TestBrainstormRejectedWhenRunOmitsShort() (+22 more)

### Community 113 - "Community 113"
Cohesion: 0.12
Nodes (28): init(), registerFinanceActions(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled() (+20 more)

### Community 114 - "Community 114"
Cohesion: 0.14
Nodes (32): Duration(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes(), TestAddFromMutation_NoChange() (+24 more)
...
Cohesion: 0.11
Nodes (23): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+15 more)
...
Cohesion: 0.14
Nodes (25): BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir(), MemoryDir() (+17 more)

### Community 132 - "Community 132"
Cohesion: 0.12
Nodes (26): NewDefaultCompany(), clamp(), safeDiv(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary(), testLLM() (+18 more)
...
Cohesion: 0.1
Nodes (25): countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestNewPopulation_Evolution(), TestNewQTable() (+17 more)
...
Cohesion: 0.11
Nodes (15): AgentMetrics, AgentStats, BuildIdentity, HealthResponse, exposedBuildIdentity(), GetAgentMetrics(), init(), InstallBuildIdentity() (+7 more)
...
Cohesion: 0.17
Nodes (12): code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), Package: goap, Package: langagent (+4 more)
...
Cohesion: 0.22
Nodes (9): code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), Package: evaluator, Package: gardener, Package: startup (+1 more)
...
Cohesion: 0.4
Nodes (4): init(), registerGoDevActions(), init(), registerStockfishActions()
...
## Knowledge Gaps
- **7929 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7924 more)
...
- **Why does `Append()` connect `Community 18` to `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 13`, `Community 14`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 42`, `Community 44`, `Community 45`, `Community 46`, `Community 1071`, `Community 47`, `Community 49`, `Community 50`, `Community 48`, `Community 51`, `Community 52`, `Community 54`, `Community 53`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 65`, `Community 67`, `Community 68`, `Community 69`, `Community 71`, `Community 584`, `Community 72`, `Community 74`, `Community 587`, `Community 588`, `Community 76`, `Community 78`, `Community 79`, `Community 80`, `Community 589`, `Community 591`, `Community 77`, `Community 84`, `Community 85`, `Community 87`, `Community 89`, `Community 90`, `Community 604`, `Community 92`, `Community 93`, `Community 95`, `Community 96`, `Community 97`, `Community 94`, `Community 611`, `Community 99`, `Community 615`, `Community 104`, `Community 105`, `Community 619`, `Community 108`, `Community 109`, `Community 111`, `Community 117`, `Community 122`, `Community 123`, `Community 127`, `Community 129`, `Community 130`, `Community 131`, `Community 133`, `Community 134`, `Community 135`, `Community 138`, `Community 145`, `Community 146`, `Community 153`, `Community 157`, `Community 158`, `Community 161`, `Community 177`, `Community 178`, `Community 179`, `Community 180`, `Community 185`, `Community 186`, `Community 187`, `Community 188`, `Community 192`, `Community 194`, `Community 196`, `Community 198`, `Community 200`, `Community 202`, `Community 206`, `Community 208`, `Community 209`, `Community 210`, `Community 211`, `Community 218`, `Community 219`, `Community 221`, `Community 797`, `Community 799`, `Community 800`, `Community 814`, `Community 816`, `Community 821`, `Community 838`, `Community 843`, `Community 845`, `Community 876`, `Community 585`, `Community 388`, `Community 390`, `Community 391`, `Community 401`, `Community 402`, `Community 403`, `Community 404`, `Community 414`, `Community 420`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 66` to `Community 2`, `Community 131`, `Community 3`, `Community 389`, `Community 133`, `Community 9`, `Community 15`, `Community 17`, `Community 20`, `Community 24`, `Community 152`, `Community 25`, `Community 162`, `Community 36`, `Community 165`, `Community 42`, `Community 43`, `Community 44`, `Community 173`, `Community 175`, `Community 818`, `Community 51`, `Community 184`, `Community 60`, `Community 191`, `Community 64`, `Community 65`, `Community 194`, `Community 192`, `Community 200`, `Community 203`, `Community 207`, `Community 82`, `Community 101`, `Community 104`, `Community 877`, `Community 114`, `Community 119`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `sleep()` connect `Community 150` to `Community 129`, `Community 3`, `Community 389`, `Community 392`, `Community 10`, `Community 13`, `Community 17`, `Community 163`, `Community 37`, `Community 165`, `Community 43`, `Community 51`, `Community 77`, `Community 212`, `Community 217`, `Community 96`, `Community 101`, `Community 103`, `Community 106`, `Community 110`, `Community 878`, `Community 119`, `Community 125`?**
