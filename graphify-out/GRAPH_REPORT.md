# Graph Report - superpowers-20260715T042711-d423f5f5-goap-fusion-loop-runner-blackboard-conte  (2026-07-15)

## Corpus Check
- 852 files · ~995,494 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22303 nodes · 34009 edges · 1824 communities (1472 shown, 352 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8580 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `071cffa4`
...
1. `Append()` - 392 edges
2. `DefaultTree()` - 141 edges
3. `NewRequest()` - 134 edges
4. `NewKnowledgeGraph()` - 124 edges
5. `registerMCPTools()` - 113 edges
6. `BuildTree()` - 111 edges
7. `newDefaultConfig()` - 100 edges
8. `arc42 Section 9 — Architecture Decisions` - 100 edges
9. `sleep()` - 95 edges
10. `main()` - 78 edges
...
- `TestDefaultConfig()` --calls--> `DefaultConfig()`  [INFERRED]
  internal/llm/coverage_test.go → /home/nico/go-bt-evolve/internal/llm/ollama.go
...
## Communities (1824 total, 352 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (158): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+150 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (158): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+150 more)
...
Cohesion: 0.03
Nodes (108): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+100 more)
...
Cohesion: 0.02
Nodes (100): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+92 more)
...
Cohesion: 0.05
Nodes (90): TestBTDLQToolsListAndReplay(), TestDLQReplayWaitReportsFailureOutcome(), TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory() (+82 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (84): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), buildClaudeReviewPrompt() (+76 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (81): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+73 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (81): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+73 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (77): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), ClearGoapFusionStateHashes(), init(), buildDeterministicDesign() (+69 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (20): History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), Registry, cloneTree() (+12 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (64): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree(), resolveTreeForUser() (+56 more)
...
Cohesion: 0.05
Nodes (74): main(), alwaysSampler, Attr, TestConsoleTracer_ExporterReceivesCompletedSpan(), fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport() (+66 more)
...
Cohesion: 0.04
Nodes (60): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+52 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (42): findChildByName(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords(), TestContainsAnyLower_NoKeywords(), TestContainsAnyLower_NoMatch(), TestContainsAnyLower_Substring() (+34 more)
...
Cohesion: 0.06
Nodes (59): main(), TestRunTask_CacheHit(), TestRunTask_Success(), reflectOnOutcomeAction(), TestReflectOnOutcomeAction_NilLLM(), TestReflectOnOutcomeAction_WithMockLLM(), NewStore(), TestRecord_JSONRoundTrip() (+51 more)
...
Cohesion: 0.06
Nodes (63): LoadPipeline(), RunPipeline(), RunPipelineWithID(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner() (+55 more)
...
Cohesion: 0.04
Nodes (46): ActionFunc, ActionProvider, init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), ConditionFunc, ConditionProvider, init() (+38 more)
...
Cohesion: 0.08
Nodes (50): TestCompiledPlanTree_ValidatesAndRuns(), NewAgent(), NewDocPlanner(), fakeBlackboard, TestAutomationActions_ReachTaskAutomated(), assertError(), TestAgentActionFails(), TestAgentCallbacks() (+42 more)

### Community 38 - "Community 38"
Cohesion: 0.07
Nodes (50): AgentBus, AgentEvent, InitAgentBus(), PublishHealthAlert(), PublishServiceDown(), TestAgentBus_AllSubscribersReceiveAll(), TestAgentBus_CloseSubscriberChannelsClosed(), TestAgentBus_ConcurrentPublish() (+42 more)
...
Cohesion: 0.07
Nodes (50): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField() (+42 more)
...
Cohesion: 0.07
Nodes (43): CompressionMiddleware(), isCompressibleContentType(), gzipDecompress(), TestCompressionMiddleware_AlreadyCompressed(), TestCompressionMiddleware_BinaryContentType(), TestCompressionMiddleware_EmptyBody(), TestCompressionMiddleware_GzipRequest(), TestCompressionMiddleware_HTMLContentType() (+35 more)
...
Cohesion: 0.06
Nodes (46): FileJobStore, JobStore, NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad(), TestScheduler_NoJobStore_NilSafe() (+38 more)
...
Cohesion: 0.08
Nodes (50): main(), TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_PruningOnNodeExplosion(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune() (+42 more)
...
Cohesion: 0.07
Nodes (50): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestSuperpowersWorkflowTree_BuildsAndValidates(), TestSideEffectClassOfSubtree_DeepChild(), TestSideEffectClassOfSubtree_MultipleChildren() (+42 more)
...
Cohesion: 0.07
Nodes (38): bareApplyScriptRunner, bareSyncRunner, bareTestRun(), TestApplySuperpowersRunBareRepoRefusedFastForwardParksPendingPatch(), TestApplySuperpowersRunBareRepoVerifiesCommitsInWorktreeThenFastForwardsMaster(), TestSyncSuperpowersRepoBareRepoFastForwardsMasterViaFetch(), TestSyncSuperpowersRepoBareRepoFetchesOriginTipBare(), TestSyncSuperpowersRepoBareRepoSurfacesFetchFailure() (+30 more)

### Community 56 - "Community 56"
Cohesion: 0.09
Nodes (27): goalEntry, goalHeap, GoalQueue, entryLess(), NewGoalQueue(), NewGoalQueueFrom(), names(), names2() (+19 more)
...
Cohesion: 0.06
Nodes (39): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestEstimatePathCoverage_EmptyRecords() (+31 more)
...
Cohesion: 0.07
Nodes (37): EvolveTool, TestCheckConfidence_ConditionExists(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure() (+29 more)

### Community 61 - "Community 61"
Cohesion: 0.11
Nodes (37): defaultNlmGrillAuthGuard(), runGrillAuthGuardAction(), TestRunGrillAuthGuardAction_PreservesBlackboardResultAndOutcome(), TestRunGrillAuthGuardAction_SuccessReturnsNilAndPreservesBlackboard(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce() (+29 more)

### Community 62 - "Community 62"
Cohesion: 0.06
Nodes (28): AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce(), TestAutoRestartEnabled(), TestDriftWatchOnceRestartHandoff() (+20 more)
...
Cohesion: 0.07
Nodes (25): TestRunOnce_EmitsRunRootSpan(), tracingMiddleware(), fanoutHandler, InitLogExport(), logExportTarget(), newTraceContextHandler(), TestInitLogExport_Idempotent(), TestLogExportTarget() (+17 more)
...
Cohesion: 0.09
Nodes (28): FitnessDimension, MultiFitness, MultiIndividual, clampScore(), countActions(), countConditions(), NewMultiFitness(), NewParetoFront() (+20 more)
...
Cohesion: 0.09
Nodes (37): TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir() (+29 more)
...
Cohesion: 0.08
Nodes (38): goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionNoopPatchStreak(), goapFusionPreflightWired(), goapFusionRepeatedHashBypassed() (+30 more)

### Community 76 - "Community 76"
Cohesion: 0.13
Nodes (38): Duration(), TestDuration(), TestNewPopulation_Evolution(), TestPopulation_Diversity(), DefaultTree(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation() (+30 more)
...
Cohesion: 0.1
Nodes (30): TestGardenerRollbackTool_CallRestoresSnapshot(), GateResult, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree() (+22 more)
...
Cohesion: 0.07
Nodes (28): Blackboard, ChildTick, childTickLog, init(), TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern() (+20 more)

### Community 88 - "Community 88"
Cohesion: 0.09
Nodes (37): cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), crisisMetricsGardener(), crisisV2Config(), experienceRecordingGardener() (+29 more)
...
Cohesion: 0.08
Nodes (29): TestNewReinforcementLearner(), TestQTableSelectUpdateBestAction(), TestQTableStateBucketsAndDepth(), TestReinforcementLearnerLearnAndSuggest(), NewQTable(), NewReinforcementLearner(), TestExpertKnowledge_ObservesLearnedPatternFromQLearning(), TestExpertKnowledge_SeedSpecialistsCarryProvenance() (+21 more)
...
Cohesion: 0.08
Nodes (34): TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoTestTool_Structure(), TestNewWebSearchTool_Structure(), newFileReadTool(), newFileWriteTool(), newGoTestTool(), newShellExecTool() (+26 more)

### Community 100 - "Community 100"
Cohesion: 0.07
Nodes (19): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, baseNodeCount(), CollectAgentSLOs() (+11 more)
...
Cohesion: 0.09
Nodes (31): TestBTEvolveBottlenecksPersistsEvolvedWinnerTree(), TestBTEvolveGeneticPersistsEvolvedWinnerTree(), TestBTEvolveSelectionPressurePersistsEvolvedWinnerTree(), TestPersistEvolvedWinner_AtomicWithFailedDiskWrite(), TestPersistEvolvedWinner_SkipsOverwriteWhenFitnessDoesNotImprove(), init(), registerGoDevActions(), containsAnyStr() (+23 more)
...
Cohesion: 0.15
Nodes (27): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestRealToolFactory_DiscoveryAndFailClosed(), realTool, allRealToolNames() (+19 more)
...
Cohesion: 0.1
Nodes (23): TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeSpan, fakeTracer, mockOllamaServer(), newTestClient(), TestClient_AnalyzeComplexity() (+15 more)
...
Cohesion: 0.11
Nodes (25): TestCountSelectors_Nested(), TestCountSelectors_NilChildren(), DeepeningResult, FitnessScore, MutationCandidate, chainHasTool(), cloneTree(), countSelectors() (+17 more)
...
Cohesion: 0.11
Nodes (18): asFloat(), compiledGoapActionFor(), compiledGoapConditionFor(), goapValuesEqual(), goapWorldStateFrom(), isCompiledGoapAction(), isCompiledGoapCondition(), parseGoapPairs() (+10 more)
...
Cohesion: 0.11
Nodes (24): min(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section(), TestGenerateTemplateOutput_TruncatedCache(), TestNewGraphifyTool_Structure(), TestGenerateTemplateOutput_Arc42Section() (+16 more)
...
Cohesion: 0.15
Nodes (19): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), wireSelectorOrdering(), routerChildNames(), seedSelectorStats() (+11 more)
...
Cohesion: 0.13
Nodes (6): FitnessFunc, firstNodeNameByType(), maxInt(), MCTSMetrics, MCTSMutator, MCTSNode
...
Cohesion: 0.11
Nodes (20): collectDiscoverIDs(), TestDiscover_RegisterNotStarvedBySlowEmbeddingCall(), TestDiscoverRelated_Bidirectional(), TestDiscoverRelated_ConnectedFrom(), TestDiscoverRelated_ConnectedTo(), TestDiscoverRelated_Deduplicates(), TestDiscoverRelated_EmptyGraph(), TestDiscoverRelated_NonExistentTree() (+12 more)

### Community 182 - "Community 182"
Cohesion: 0.21
Nodes (21): ScoreAnnouncement(), cardResponder, RespondToAnnouncement(), SetTreeResolver(), bidArtifact(), drainExecute(), eventKinds(), executorForAgent() (+13 more)
...
Cohesion: 0.17
Nodes (19): NewEvolvedAgent(), TestConfig_AllFields(), TestCreateAgentTool_Call_NilFactory(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestNewEvolvedAgent_AllToolsRegistered() (+11 more)
...
Cohesion: 0.16
Nodes (6): BTOptimizer, extractCondition(), TestExtractCondition(), isDefaultPath(), DTAnalyzer, isSelectorFallback()
...
Cohesion: 0.15
Nodes (18): NewACPClient(), countCrashInvocations(), TestACPClientCircuitBreakerShortCircuitsRepeatedSubprocessFailures(), TestACPClientGenerateReturnsErrorWhenSessionMissing(), TestACPClientGenerateTalksToACPServer(), TestACPClientGenerateTalksToHermesACP(), TestACPHelperProcess(), TestNewProviderCreatesACPClient() (+10 more)
...
Cohesion: 0.13
Nodes (20): TestBuildChainActionFn_LlmCallNilLLM(), TestBuildChainActionFn_UnknownChainType(), TestComputeSubtreeMetrics_MixedChildren(), TestComputeSubtreeMetrics_NilInput(), TestComputeSubtreeMetrics_UpdatesMaxValues(), TestComputeTreeMetrics_MaxRetriesAndTimeout(), TestComputeTreeMetrics_NestedChildren(), TestComputeTreeMetrics_ParallelWidth() (+12 more)
...
Cohesion: 0.14
Nodes (18): TestBTOptimizer_New(), collectSelectors(), conditionOverlap(), findMainSelector(), TestFindMainSelector(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths() (+10 more)

### Community 209 - "Community 209"
Cohesion: 0.16
Nodes (14): injectPersonaContext(), mineUserPatterns(), personaEmbedder(), personaError(), recordPersonaInteraction(), registerPersonaTools(), NewHabitMiner(), NewLog() (+6 more)
...
Cohesion: 0.15
Nodes (12): handleAnalyze(), handleWorkflowApprove(), handleWorkflowPending(), handleWorkflowReject(), TestCurrentWorkflow_GuardedByMutex(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation(), TestHandleWorkflowApprovalEndpoints() (+4 more)

### Community 213 - "Community 213"
Cohesion: 0.12
Nodes (6): GetReflectionsTool, GetTreeTool, NewGetTreeTool(), truncateStr(), ReflectTool, RunTaskTool
...
Cohesion: 0.15
Nodes (16): fakeGrillClaude, grillAnswerers, grillQuestion, grillResult, parseGrillQuestions(), resolveGrillQuestions(), setupGrillRun(), TestGrillDesign_FailsOnOpenCriticalWhenAllAnswerersDown() (+8 more)

### Community 217 - "Community 217"
Cohesion: 0.11
Nodes (6): GardenerRecommendTool, GardenerRollbackTool, GardenerRunCycleTool, GardenerStatusTool, newGardenerRunCycleTool(), truncateStr()
...
Cohesion: 0.11
Nodes (18): 10.1 Quality Tree, 10.2 Quality Scenarios, 1.1 Requirements Overview, 1.2 Quality Goals (Top 3), 1.3 Stakeholders, arc42 Architecture Documentation — go-bt-evolve, arc42 Section 10 — Quality Requirements, arc42 Section 12 — Glossary (+10 more)
...
Cohesion: 0.18
Nodes (16): extractTaskID(), init(), nlmAuthNeedsRefresh(), nlmAuthUnhealthy(), registerNotebookLMActions(), writeString(), recentImplementedGoals(), superpowersPlanAlreadyImplemented() (+8 more)
...
Cohesion: 0.28
Nodes (6): sameJSONID(), scanJSONLines(), startScanJSONLines(), writeACPMessage(), ACPClient, ACPConfig
...
Cohesion: 0.23
Nodes (11): deepSearchGardener(), deepSearchV2Config(), TestEvolveTreeV2_DeepSearchMetrics_PopulatedWhenTTConfigured(), TestEvolveTreeV2_DeepSearchMetrics_ZeroWithoutTranspositionTable(), TestMetricsTracker_CyclesForTree(), TestMetricsTracker_RecordAndSummary(), TestMetricsTracker_SaveAggregatesCrisisAndLastRun(), TestMetricsTracker_SaveIncludesDashboardAggregateFields() (+3 more)
...
Cohesion: 0.15
Nodes (12): TestAutoCreateTree_Existing(), TestConnect_GlobalGraph(), TestDiscover_GlobalGraphVariety(), TestKnowledgeGraph_GlobalConsistency(), TestListByCategory_All(), TestListByCategory_NonExistent(), TestQuery_ByAction(), TestQuery_ByDomain() (+4 more)

### Community 604 - "Community 604"
Cohesion: 0.26
Nodes (11): Capability, Edge, templateRunCount(), templateSelectionWeight(), templateStructuralFitness(), blendedSelectionFitness(), coldStartConfidence(), coldStartWeightedFitness() (+3 more)

### Community 605 - "Community 605"
Cohesion: 0.33
Nodes (11): isGoapInfraCycleFailure(), refundGoapMilestoneAttemptForInfraFailure(), refundProbeHeadMilestone(), seedRefundProgram(), TestIsGoapInfraCycleFailure(), TestIsGoapInfraCycleFailure_OwnCodeGateFailureCharges(), TestPrioritizeGoapGoals_StampsChargedMilestone(), TestRefundGoapMilestoneAttempt_HeadRefFallbackAndNoop() (+3 more)
...
Cohesion: 0.17
Nodes (10): DiskInfo, GardenerMetrics, MemInfo, Metrics, collectSystem(), loadGardenerMetrics(), TestLoadGardenerMetricsParsesAggregateDocument(), writeGardenerFixture() (+2 more)
...
Cohesion: 0.21
Nodes (9): handleSprintExecute(), handleTaskCreate(), syncWorkflowTaskStatus(), TestHandleSprintExecute_UpdatesCurrentWorkflow(), isAuctionShapedTask(), PickTreeForTask(), ResolveAgentName(), TestPickTreeForTask_NonAuctionTasksUnaffected() (+1 more)
...
Cohesion: 0.18
Nodes (11): code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), Package: evaluator, Package: gardener (+3 more)
...
Cohesion: 0.29
Nodes (9): TestCreateAgentTool_Call_NilFactory(), TestReflectTool_Call_NoLLM(), TestReflectTool_Call_WithLLM(), TestToolNames_And_Descriptions(), NewCreateAgentTool(), NewFitnessTool(), NewGetTreeTool(), NewReflectTool() (+1 more)
...
Cohesion: 0.43
Nodes (6): foreachTaskLoop(), SuperpowersWorkflowTree(), systematicDebugging(), tddTask(), TestSuperpowersWorkflowTree_ValidatesAndCoversPhases(), withMatch()
...
Cohesion: 0.4
Nodes (5): hasToolEdge(), TestFeedbackFlush_ForceOnShutdown(), TestFeedbackFlush_ThrottlesWrites(), TestLoadFeedback_MissingFileNoError(), TestSaveLoadFeedback_RoundTrip()
...
Cohesion: 0.5
Nodes (4): containsLeafChildrenMsg(), TestRunTask_BackstopsEmptyResultOnNonSuccess(), TestRunTask_PreservesPendingApprovalOutcome(), TestValidateTree_LeafTypesRejectChildren()

### Community 1109 - "Community 1109"
Cohesion: 0.6
Nodes (4): satisfactionRecords(), TestEvaluateTree_EmptyRecordsSatisfactionUnknown(), TestEvaluateTree_FeedbackShiftsComposite(), TestEvaluateTree_NoFeedbackLeavesCompositeUnchanged()
...
Cohesion: 0.4
Nodes (5): arc42 Section 11 — Risks and Technical Debt, Known Technical Debt, New Risks (2026-07-04), New Risks (2026-07-08), Prioritized Risk Table
...
## Knowledge Gaps
- **7847 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7842 more)
...
- **Why does `Append()` connect `Community 17` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 14`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 26`, `Community 27`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 35`, `Community 37`, `Community 38`, `Community 40`, `Community 41`, `Community 42`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 1075`, `Community 52`, `Community 53`, `Community 1077`, `Community 54`, `Community 56`, `Community 57`, `Community 58`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 67`, `Community 68`, `Community 70`, `Community 71`, `Community 73`, `Community 586`, `Community 587`, `Community 74`, `Community 77`, `Community 590`, `Community 589`, `Community 80`, `Community 81`, `Community 82`, `Community 85`, `Community 86`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 97`, `Community 609`, `Community 99`, `Community 100`, `Community 101`, `Community 106`, `Community 623`, `Community 113`, `Community 627`, `Community 116`, `Community 628`, `Community 115`, `Community 117`, `Community 118`, `Community 121`, `Community 122`, `Community 127`, `Community 128`, `Community 130`, `Community 132`, `Community 133`, `Community 134`, `Community 135`, `Community 138`, `Community 142`, `Community 153`, `Community 155`, `Community 156`, `Community 158`, `Community 162`, `Community 169`, `Community 171`, `Community 173`, `Community 174`, `Community 175`, `Community 184`, `Community 187`, `Community 189`, `Community 190`, `Community 194`, `Community 196`, `Community 197`, `Community 199`, `Community 200`, `Community 201`, `Community 202`, `Community 204`, `Community 205`, `Community 206`, `Community 207`, `Community 208`, `Community 212`, `Community 213`, `Community 217`, `Community 218`, `Community 219`, `Community 796`, `Community 797`, `Community 800`, `Community 801`, `Community 802`, `Community 822`, `Community 829`, `Community 843`, `Community 380`, `Community 383`, `Community 384`, `Community 393`, `Community 394`, `Community 397`, `Community 408`, `Community 416`, `Community 417`, `Community 418`, `Community 420`, `Community 421`, `Community 423`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 29` to `Community 2`, `Community 387`, `Community 134`, `Community 135`, `Community 11`, `Community 12`, `Community 15`, `Community 143`, `Community 144`, `Community 18`, `Community 17`, `Community 23`, `Community 799`, `Community 36`, `Community 40`, `Community 46`, `Community 50`, `Community 52`, `Community 54`, `Community 188`, `Community 189`, `Community 60`, `Community 63`, `Community 64`, `Community 68`, `Community 69`, `Community 70`, `Community 199`, `Community 72`, `Community 200`, `Community 76`, `Community 209`, `Community 210`, `Community 91`, `Community 93`, `Community 95`, `Community 108`, `Community 113`, `Community 117`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 72` to `Community 385`, `Community 130`, `Community 2`, `Community 4`, `Community 137`, `Community 12`, `Community 15`, `Community 18`, `Community 20`, `Community 27`, `Community 29`, `Community 162`, `Community 38`, `Community 39`, `Community 171`, `Community 44`, `Community 46`, `Community 50`, `Community 818`, `Community 52`, `Community 54`, `Community 182`, `Community 59`, `Community 187`, `Community 62`, `Community 63`, `Community 193`, `Community 66`, `Community 196`, `Community 76`, `Community 210`, `Community 603`, `Community 219`, `Community 101`, `Community 104`, `Community 108`?**
...
- **Are the 140 inferred relationships involving `DefaultTree()` (e.g. with `TestFullTreeIntegration_RunsAllTreesWithRealLLM()` and `TestDomainTree_Registration()`) actually correct?**
  _`DefaultTree()` has 140 INFERRED edges - model-reasoned connections that need verification._
