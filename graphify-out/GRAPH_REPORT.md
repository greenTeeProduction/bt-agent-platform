# Graph Report - superpowers-20260713T173737-10851188-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-13)

## Corpus Check
- 842 files · ~950,630 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21138 nodes · 32506 edges · 1749 communities (1388 shown, 361 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8328 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `459d3128`
...
4. `NewKnowledgeGraph()` - 122 edges
5. `BuildTree()` - 111 edges
6. `registerMCPTools()` - 102 edges
7. `newDefaultConfig()` - 100 edges
8. `sleep()` - 95 edges
9. `main()` - 77 edges
10. `arc42 Section 9 — Architecture Decisions` - 77 edges
...
## Communities (1749 total, 361 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (141): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+133 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (141): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+133 more)
...
Cohesion: 0.04
Nodes (100): main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+92 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (101): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+93 more)
...
Cohesion: 0.03
Nodes (86): docgenState, allSections(), buildSectionMap(), contains(), fileHash(), hashSectionSources(), isSectionDone(), main() (+78 more)
...
Cohesion: 0.04
Nodes (72): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+64 more)
...
Cohesion: 0.03
Nodes (77): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+69 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (54): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree(), resolveTreeForUser(), agentTemplateYAML, TestResolveTreeID_FusionAliases() (+46 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (66): Duration(), TestDuration(), TestIntegration_MutationOperators(), TestEvaluateTree_StructuralQualityRewardsUsefulContentMutations(), TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), satisfactionRecords() (+58 more)
...
Cohesion: 0.06
Nodes (66): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), TestNlmQuotaState_PersistsAcrossRuns() (+58 more)
...
Cohesion: 0.04
Nodes (28): findChildByName(), TestCheckConfidence_ConditionExists(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords(), TestContainsAnyLower_NoKeywords(), TestContainsAnyLower_NoMatch() (+20 more)
...
Cohesion: 0.05
Nodes (48): countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestNewQTable(), TestNewReinforcementLearner() (+40 more)
...
Cohesion: 0.05
Nodes (33): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogin() (+25 more)
...
Cohesion: 0.12
Nodes (43): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+35 more)
...
Cohesion: 0.05
Nodes (38): GateResult, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree(), SnapshotTree() (+30 more)
...
Cohesion: 0.06
Nodes (37): WorkflowsDir(), handleSprintExecute(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree() (+29 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (39): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, scriptedClaudeRunner, scriptedSuperpowersRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo() (+31 more)
...
Cohesion: 0.06
Nodes (45): TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoTestTool_Structure(), TestNewGraphifyTool_Structure(), TestNewShellExecTool_Structure(), TestNewWebSearchTool_Structure(), TestRealTool_NameAndDescription(), TestToolStub_NameDescription() (+37 more)
...
Cohesion: 0.08
Nodes (41): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewGoBuildTool_Structure(), TestNewGoVetTool_Structure(), TestAgentWithRealToolsBlocksFinalAnswerWithoutToolUse() (+33 more)
...
Cohesion: 0.1
Nodes (34): superpowersPlanAlreadyImplemented(), TestChangedPackagesLintCommandMirrorsHookGate(), TestReportSuperpowersImplementationCarriesContinueMarker(), TestResumeSkipsAlreadyImplementedPlan(), TestSuperpowersPlanAlreadyImplementedRequiresAllTasks(), TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull(), TestBrainstormRejectedWhenFilesNotGoPath() (+26 more)
...
Cohesion: 0.12
Nodes (36): defaultGoapReviewDeps(), gatherFailureReviewBody(), gatherReviewContext(), init(), loadLastReviewedSHA(), nextNlmQuotaReset(), nlmQuotaExhausted(), nlmQuotaExhaustedUntil() (+28 more)
...
Cohesion: 0.11
Nodes (26): NewMockLLM(), main(), NewDefaultCompany(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary(), testLLM() (+18 more)
...
Cohesion: 0.09
Nodes (33): fakeTracer, AlwaysSample(), hashTraceID(), NeverSample(), NewRatioSampler(), TestAlwaysSample(), TestConsoleTracer_ChildSpansNotSampled(), TestConsoleTracer_Concurrent() (+25 more)
...
Cohesion: 0.15
Nodes (25): BehavioralDescriptor, FeatureDimension, Bucket(), Descriptor(), maxTreeDepthEvo(), NewMAPElitesGrid(), NewMAPElitesPopulation(), countCondsActs() (+17 more)
...
Cohesion: 0.15
Nodes (26): NewAgent(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory(), TestAgentNoPlan(), TestAgentSimpleExecution() (+18 more)
...
Cohesion: 0.1
Nodes (16): AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce(), TestAutoRestartEnabled(), TestDriftWatchOnceRestartHandoff() (+8 more)
...
Cohesion: 0.1
Nodes (12): A2AHandoffBlock(), builtinBlocks(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), HumanReviewBlock(), HITLTieredBlock(), MemoryLoadBlock() (+4 more)
...
Cohesion: 0.14
Nodes (11): NewDocPlanner(), fakeBlackboard, TestAgentFailurePathsAndSummary(), TestBlackboardBridgeHandlesNilChainStateAndFailure(), TestBlackboardBridgeSyncAndPlanSuccess(), TestBuildGoalFromTaskMultipleKeywordsAndTruncation(), TestDocPlannerAlreadyCompleteReturnsEmptyPlan(), TestDocPlannerWorldStateIgnoresWrongTypesAndMissingKeys() (+3 more)
...
Cohesion: 0.17
Nodes (9): TestPlanMultiple(), TestValidatePlan(), Planner, NewPlanner(), PlanMultiple(), ValidatePlan(), plannerNode, plannerNodeHeap (+1 more)
...
Cohesion: 0.2
Nodes (14): apiFetch(), getCookie(), Alert, cbIcon(), createAgent(), deleteAgent(), loadAgents(), runAgent() (+6 more)
...
Cohesion: 0.22
Nodes (10): TestRunOnce_EmitsRunRootSpan(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), NewOTelTracer(), TestEndToEndOTLPExport() (+2 more)
...
## Knowledge Gaps
- **7143 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7138 more)
...
- **Why does `Append()` connect `Community 53` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 21`, `Community 22`, `Community 26`, `Community 28`, `Community 29`, `Community 33`, `Community 36`, `Community 37`, `Community 550`, `Community 39`, `Community 552`, `Community 41`, `Community 549`, `Community 43`, `Community 45`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 571`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 65`, `Community 577`, `Community 578`, `Community 68`, `Community 66`, `Community 70`, `Community 71`, `Community 69`, `Community 72`, `Community 74`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 82`, `Community 84`, `Community 85`, `Community 88`, `Community 89`, `Community 90`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 99`, `Community 103`, `Community 104`, `Community 109`, `Community 113`, `Community 114`, `Community 115`, `Community 116`, `Community 120`, `Community 121`, `Community 126`, `Community 127`, `Community 128`, `Community 130`, `Community 131`, `Community 133`, `Community 134`, `Community 135`, `Community 137`, `Community 141`, `Community 144`, `Community 149`, `Community 150`, `Community 156`, `Community 159`, `Community 160`, `Community 165`, `Community 175`, `Community 176`, `Community 183`, `Community 184`, `Community 185`, `Community 186`, `Community 189`, `Community 191`, `Community 193`, `Community 195`, `Community 196`, `Community 197`, `Community 198`, `Community 200`, `Community 201`, `Community 202`, `Community 207`, `Community 209`, `Community 211`, `Community 217`, `Community 729`, `Community 731`, `Community 220`, `Community 730`, `Community 222`, `Community 753`, `Community 756`, `Community 757`, `Community 758`, `Community 760`, `Community 775`, `Community 778`, `Community 780`, `Community 782`, `Community 801`, `Community 572`, `Community 365`, `Community 368`, `Community 370`, `Community 377`, `Community 380`, `Community 381`, `Community 382`, `Community 383`, `Community 393`, `Community 394`, `Community 399`, `Community 402`, `Community 403`, `Community 999`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 67` to `Community 130`, `Community 3`, `Community 388`, `Community 2`, `Community 8`, `Community 11`, `Community 140`, `Community 16`, `Community 18`, `Community 19`, `Community 148`, `Community 28`, `Community 158`, `Community 33`, `Community 34`, `Community 36`, `Community 38`, `Community 39`, `Community 562`, `Community 51`, `Community 178`, `Community 54`, `Community 58`, `Community 187`, `Community 193`, `Community 66`, `Community 204`, `Community 79`, `Community 208`, `Community 91`, `Community 96`, `Community 98`, `Community 746`, `Community 367`, `Community 117`, `Community 120`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 33` to `Community 130`, `Community 2`, `Community 1029`, `Community 137`, `Community 11`, `Community 12`, `Community 14`, `Community 18`, `Community 19`, `Community 146`, `Community 149`, `Community 32`, `Community 161`, `Community 37`, `Community 45`, `Community 51`, `Community 53`, `Community 186`, `Community 58`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 73`, `Community 203`, `Community 204`, `Community 205`, `Community 1100`, `Community 96`, `Community 107`, `Community 114`, `Community 117`?**
