# Graph Report - superpowers-20260716T031258-c1dd1087-goap-fusion-loop-runner-blackboard-conte  (2026-07-16)

## Corpus Check
- 879 files · ~1,060,647 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23568 nodes · 35660 edges · 1906 communities (1543 shown, 363 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8859 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fb920362`
...
5. `registerMCPTools()` - 132 edges
6. `arc42 Section 9 — Architecture Decisions` - 125 edges
...
## Communities (1906 total, 363 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (175): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+167 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (175): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+167 more)
...
Cohesion: 0.03
Nodes (110): ApplyJitter(), ClassifyError(), contextDeadlineExceeded(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), FullJitter(), GetCategory() (+102 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (96): expandChainStateTemplates(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM(), TestChainAction_Agent_NoTools() (+88 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (125): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+117 more)
...
Cohesion: 0.04
Nodes (96): TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), perTreeStats(), setupGardener(), TestEvolveTree_BloatGuard() (+88 more)
...
Cohesion: 0.04
Nodes (76): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewGoTestTool_Structure() (+68 more)
...
Cohesion: 0.05
Nodes (88): TestEndpointsFromCardsSingleNodeYieldsNoPeers(), TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PreserveCategory(), NewAgentRouter() (+80 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (78): echoTaskLeaf, mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection() (+70 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (56): agentExecuteResult(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay() (+48 more)
...
Cohesion: 0.05
Nodes (79): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+71 more)
...
Cohesion: 0.06
Nodes (54): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree(), resolveTreeForUser() (+46 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (16): Server, History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), mockTTOrch (+8 more)
...
Cohesion: 0.05
Nodes (36): handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus() (+28 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (54): TestRunSuiteIsSandboxed(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled(), TestBanditSelector_DisabledMatchesSelectorSemantics() (+46 more)
...
Cohesion: 0.05
Nodes (35): Warn(), FilterByTreeName(), Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics (+27 more)

### Community 37 - "Community 37"
Cohesion: 0.08
Nodes (56): Duration(), countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestLocalSearcher_New() (+48 more)
...
Cohesion: 0.09
Nodes (54): DefaultLLM(), RealLLM(), BuiltinBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic(), TestBFCLV3_MultiTurn_Composite(), TestDetectPath_DataPipelineKeywordFallback() (+46 more)
...
Cohesion: 0.07
Nodes (58): ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction(), buildChainActionFn() (+50 more)
...
Cohesion: 0.17
Nodes (48): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+40 more)
...
Cohesion: 0.09
Nodes (49): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+41 more)
...
Cohesion: 0.05
Nodes (32): TestStartDriftWatcher_KickTriggersImmediateCheck(), StartDriftWatcher(), buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired() (+24 more)

### Community 50 - "Community 50"
Cohesion: 0.09
Nodes (48): clearSuperpowersPlanState(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), markGoapFusionImplDegraded() (+40 more)
...
Cohesion: 0.06
Nodes (39): min(), handleAnalyze(), brokenTool, generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section(), TestGenerateTemplateOutput_TruncatedCache() (+31 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (30): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), pipelineMockLLM, TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID() (+22 more)
...
Cohesion: 0.07
Nodes (38): collectSelectorNames(), SelectorStatsFile(), TestSelectorOptimizer_New(), degeneratePopulation(), runWithoutPanic(), TestEvolve_DegeneratePopulations(), TestEvolveWithExperience_DegeneratePopulations(), TestMemeticEvolve_DegeneratePopulations() (+30 more)
...
Cohesion: 0.06
Nodes (38): BuildBudget(), budgetCmd, BuildCachedCondition(), parseChainConfig(), TestChainAction_ParseConfig(), BuildCircuitBreaker(), BuildInverter(), BuildRepeater() (+30 more)
...
Cohesion: 0.05
Nodes (36): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, init(), TestRegisterCondition_DuplicatePanics(), Engine, TestAssignComplexityAction_NoLLM_DefaultsMedium() (+28 more)
...
Cohesion: 0.08
Nodes (26): TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), RegistryDir(), SchedulerJobsFile(), TestRemoveAgentJobs(), TestResolvePipelineAgent_Aliases(), TestApplySchedule_PersistsRegistryAndJobs(), TestDeleteRegisteredAgent() (+18 more)
...
Cohesion: 0.07
Nodes (11): TestRunFullPipeline_NilSynthesis_NoPanic(), TestActionForName_BulkCoverage(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), namedTree, sprintRecover(), TestStress_ConcurrentExecution(), TestStress_EdgeInputs() (+3 more)
...
Cohesion: 0.1
Nodes (24): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), TestFusionAnalysis_RateLimitCarryoverNotConflatedAsDegradation(), TestCurrentSuperpowersRunRefusesFinishedRun(), resolveGraphifyBin(), TestResolveGraphifyBinErrorsWhenGenuinelyAbsent() (+16 more)
...
Cohesion: 0.08
Nodes (20): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus() (+12 more)
...
Cohesion: 0.14
Nodes (16): NewACPClient(), sameJSONID(), scanJSONLines(), startScanJSONLines(), countCrashInvocations(), TestACPClientCircuitBreakerShortCircuitsRepeatedSubprocessFailures(), TestACPClientGenerateReturnsErrorWhenSessionMissing(), TestACPClientGenerateTalksToACPServer() (+8 more)
...
Cohesion: 0.1
Nodes (25): Binaries, code:go (type Counter struct { ... }), code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }) (+17 more)
...
Cohesion: 0.09
Nodes (16): init(), modal, num, renderTab(), state, TAB_KEYS, renderCompany(), renderDoormate() (+8 more)
...
Cohesion: 0.13
Nodes (17): TestCheckConfidence_ConditionExists(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter() (+9 more)
...
Cohesion: 0.16
Nodes (14): NewMockLLM(), main(), NewThinkTank(), TestDefaultFellows(), TestFellowConfidence(), TestFullAnalysis_MultipleTopics(), TestNewThinkTank(), TestOrchestrator_Debate() (+6 more)
...
Cohesion: 0.13
Nodes (12): NewDocPlanner(), fakeBlackboard, TestValidatePlan(), TestAgentFailurePathsAndSummary(), TestBlackboardBridgeSyncAndPlanSuccess(), TestBuildGoalFromTaskMultipleKeywordsAndTruncation(), TestDocPlannerAlreadyCompleteReturnsEmptyPlan(), TestDocPlannerWorldStateIgnoresWrongTypesAndMissingKeys() (+4 more)
...
Cohesion: 0.17
Nodes (6): BTOptimizer, extractCondition(), TestExtractCondition(), isDefaultPath(), pathEntropy(), DTAnalyzer
...
Cohesion: 0.15
Nodes (8): fanoutHandler, logExportTarget(), newTraceContextHandler(), TestInitLogExport_Idempotent(), TestLogExportTarget(), TestTraceContextHandler_InjectsTraceIDs(), traceContextHandler, SpanContextFrom()
...
Cohesion: 0.12
Nodes (9): A2AHandoffBlock(), builtinBlocks(), DelegateBlock(), MemoryLoadBlock(), MemoryWriteBlock(), PlanBlock(), QualityGateBlock(), RAGGateBlock() (+1 more)
...
Cohesion: 0.22
Nodes (11): truncateGoap(), arc42SyncRunner, syncArc42Docs(), arc42TestRun(), TestArc42SyncNoImpactIsClean(), TestArc42SyncSkipsDryRunAndMainRepoModes(), TestArc42SyncSkipsWithoutProductionChanges(), TestArc42SyncUpdatesDocAndChangedFiles() (+3 more)
...
Cohesion: 0.29
Nodes (10): handleFellows(), DebateTurn, Fellow, DefaultFellows(), Report, ResearchFinding, ReviewComment, Scenario (+2 more)

### Community 666 - "Community 666"
Cohesion: 0.21
Nodes (10): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), persistEvolvedWinner(), TestPersistEvolvedWinner_AtomicWithFailedDiskWrite(), TestPersistEvolvedWinner_SkipsOverwriteWhenFitnessDoesNotImprove(), NewTreeStore(), TestTreeFileName_SanitizesUnsafeCharacters(), TestTreeStore_LoadNamed_MissingReturnsNil() (+2 more)
...
Cohesion: 0.32
Nodes (6): TestGoapFusionLoopSeedsBeforeResearch(), TestGoapFusionLoopTree_ClaudeReviewFallback(), GoapFusionLoopTree(), rawGoapFusionLoopTree(), TestGoapFusionLoopTreeAppliesInstalledWireHook(), TestGoapFusionLoopWireSeamDefaultsToIdentity()
...
## Knowledge Gaps
- **8575 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8570 more)
...
- **Why does `Append()` connect `Community 23` to `Community 2`, `Community 3`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 22`, `Community 24`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 33`, `Community 36`, `Community 38`, `Community 39`, `Community 41`, `Community 45`, `Community 47`, `Community 49`, `Community 51`, `Community 53`, `Community 55`, `Community 56`, `Community 58`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 74`, `Community 76`, `Community 77`, `Community 79`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 87`, `Community 88`, `Community 89`, `Community 91`, `Community 93`, `Community 94`, `Community 96`, `Community 97`, `Community 98`, `Community 102`, `Community 107`, `Community 112`, `Community 115`, `Community 118`, `Community 119`, `Community 121`, `Community 123`, `Community 635`, `Community 1149`, `Community 638`, `Community 127`, `Community 1152`, `Community 641`, `Community 128`, `Community 636`, `Community 132`, `Community 646`, `Community 135`, `Community 136`, `Community 137`, `Community 139`, `Community 148`, `Community 662`, `Community 663`, `Community 152`, `Community 665`, `Community 154`, `Community 155`, `Community 156`, `Community 159`, `Community 161`, `Community 163`, `Community 170`, `Community 171`, `Community 181`, `Community 182`, `Community 185`, `Community 187`, `Community 189`, `Community 190`, `Community 192`, `Community 195`, `Community 197`, `Community 204`, `Community 207`, `Community 208`, `Community 209`, `Community 212`, `Community 213`, `Community 214`, `Community 216`, `Community 218`, `Community 219`, `Community 220`, `Community 229`, `Community 230`, `Community 848`, `Community 857`, `Community 870`, `Community 871`, `Community 872`, `Community 873`, `Community 881`, `Community 885`, `Community 899`, `Community 900`, `Community 901`, `Community 903`, `Community 906`, `Community 405`, `Community 411`, `Community 413`, `Community 414`, `Community 415`, `Community 416`, `Community 417`, `Community 424`, `Community 425`, `Community 427`, `Community 429`, `Community 430`, `Community 437`, `Community 446`, `Community 448`, `Community 449`, `Community 452`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 15` to `Community 128`, `Community 4`, `Community 13`, `Community 142`, `Community 20`, `Community 22`, `Community 23`, `Community 409`, `Community 666`, `Community 28`, `Community 415`, `Community 162`, `Community 36`, `Community 37`, `Community 167`, `Community 39`, `Community 43`, `Community 45`, `Community 51`, `Community 52`, `Community 53`, `Community 56`, `Community 60`, `Community 191`, `Community 192`, `Community 65`, `Community 64`, `Community 68`, `Community 69`, `Community 70`, `Community 199`, `Community 82`, `Community 86`, `Community 89`, `Community 225`, `Community 1250`, `Community 107`, `Community 127`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 52` to `Community 3`, `Community 4`, `Community 901`, `Community 133`, `Community 11`, `Community 14`, `Community 15`, `Community 16`, `Community 20`, `Community 21`, `Community 22`, `Community 408`, `Community 666`, `Community 412`, `Community 28`, `Community 30`, `Community 34`, `Community 36`, `Community 37`, `Community 167`, `Community 43`, `Community 940`, `Community 173`, `Community 49`, `Community 51`, `Community 54`, `Community 60`, `Community 62`, `Community 196`, `Community 197`, `Community 200`, `Community 215`, `Community 89`, `Community 875`, `Community 111`, `Community 112`, `Community 882`, `Community 122`?**
