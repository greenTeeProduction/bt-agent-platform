# Graph Report - superpowers-20260713T014345-10851188-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-13)

## Corpus Check
- 828 files · ~919,571 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20190 nodes · 31348 edges · 1713 communities (1338 shown, 375 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8176 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7084c5db`
...
## Communities (1713 total, 375 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (111): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+103 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (106): main(), main(), TestBlackboard_AllFields(), TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails(), TestRunTask_Success(), TestIntegration_ReflectionAndPersistence(), reflectOnOutcomeAction() (+98 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (127): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+119 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (127): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+119 more)
...
Cohesion: 0.05
Nodes (99): Duration(), TestDuration(), TestCheckConfidence_ConditionExists(), TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_PruningOnNodeExplosion(), TestIterativeDeepening_TTHitDuringSearch() (+91 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (78): OpenAPIGenerator, Append(), mockTTOrch, brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID() (+70 more)
...
Cohesion: 0.03
Nodes (63): containsAnyStr(), findChildByName(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords(), TestContainsAnyLower_NoKeywords(), TestContainsAnyLower_NoMatch() (+55 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (87): handleLogin(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext() (+79 more)
...
Cohesion: 0.05
Nodes (71): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileWriteTool_Structure(), TestNewGoTestTool_Structure() (+63 more)
...
Cohesion: 0.05
Nodes (59): DefaultRetryPolicy(), GetErrorContext(), NewCategorizedError(), NewErrorContext(), TestCategorizedError_Error(), TestCategorizedError_NilError(), TestCategorizedError_Unwrap(), TestClassifyError_CategorizedChain() (+51 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (56): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), ListToolProfileBlocks(), ComposeTaskTreeWithHITL() (+48 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (50): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), GateResult, Outcome, TestQualityGateFloorOn100Scale() (+42 more)
...
Cohesion: 0.05
Nodes (47): copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), DefaultRebuildTargets(), NewRebuildBackoff(), RebuildBinaries(), resolveGoBinary(), TestRebuildBinaries() (+39 more)
...
Cohesion: 0.03
Nodes (60): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+52 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (40): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), readPostconditions(), BuildCircuitBreaker(), BuildInverter() (+32 more)
...
Cohesion: 0.07
Nodes (47): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+39 more)
...
Cohesion: 0.05
Nodes (36): Blackboard, ChildTick, childTickLog, init(), TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern() (+28 more)
...
Cohesion: 0.07
Nodes (34): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), countTreeNodes(), TestSuperpowersPipelineSimulation(), TestHumanApprovalGate_AutoApprove() (+26 more)
...
Cohesion: 0.06
Nodes (31): CategorizedError, ErrorContext, ClassifyError(), contextDeadlineExceeded(), GetCategory(), isAuthError(), isLLMError(), isNetworkError() (+23 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (32): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM() (+24 more)
...
Cohesion: 0.07
Nodes (28): cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), TestCloneTreeForGardener_Basic(), TestCloneTreeForGardener_DoubleNested(), TestCloneTreeForGardener_Nil() (+20 more)
...
Cohesion: 0.11
Nodes (38): ParallelMode, intSliceFromInterface(), BuildReactiveParallel(), childPanicHandler(), forkBlackboard(), intSliceFromInterface(), runReactiveParallel(), evaluateGuardCondition() (+30 more)
...
Cohesion: 0.12
Nodes (33): captureExporter, NewOTLPHTTPExporter(), TestConfigureOTLPFromEnv(), TestConfigureOTLPFromEnv_DisabledWithoutEndpoint(), TestConsoleTracer_ExporterErrorDoesNotBreakEnd(), TestConsoleTracer_ExporterReceivesCompletedSpan(), TestOTLPHTTPExporter_Non2xx(), TestOTLPHTTPExporter_PostsOTLPJSON() (+25 more)
...
Cohesion: 0.14
Nodes (31): partialLandingRunner, TestChangedPackagesLintCommandMirrorsHookGate(), greenFail(), greenPass(), partialLandingRun(), redFail(), TestBatchFirstTaskFailureStaysAllOrNothing(), TestBatchFullSuccessUnwrapsSnapshots() (+23 more)
...
Cohesion: 0.11
Nodes (32): tryApplyBlockMutations(), TestApplyMutations_Batch(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter(), TestMutation_AddBefore(), TestMutation_AddFallback(), TestMutation_IncreaseRetries() (+24 more)
...
Cohesion: 0.14
Nodes (27): TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull(), TestBrainstormRejectedWhenFilesNotGoPath(), TestBrainstormRejectedWhenMalformedOrProse(), TestBrainstormRejectedWhenNotDeeper(), TestBrainstormRejectedWhenRunOmitsShort(), withBrainstorm(), brainstormExpandPlan() (+19 more)
...
Cohesion: 0.11
Nodes (17): handleFellows(), NewMockLLM(), main(), mockLLM, DefaultFellows(), NewThinkTank(), TestDefaultFellows(), TestFellowConfidence() (+9 more)
...
Cohesion: 0.2
Nodes (26): goalEntry, TestGoalQueue_DeadlineBreaksPriorityTies(), NewGoalQueue(), NewGoalQueueFrom(), names(), names2(), TestGoalIsSatisfied(), TestGoalQueueAddAndSelect() (+18 more)
...
Cohesion: 0.11
Nodes (22): ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), init(), ApplyBlockMutations(), blockIDFromOp() (+14 more)
...
Cohesion: 0.1
Nodes (17): BuildTaskFromInputs(), ParseInputParams(), TestBuildTaskFromInputs(), TestParseInputParams(), TestValidateInputs_Default(), TestValidateInputs_File(), TestValidateInputs_JSON(), TestValidateInputs_Required() (+9 more)
...
Cohesion: 0.11
Nodes (16): agentNameFromBB(), init(), registerDelegateNodes(), init(), init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init() (+8 more)
...
Cohesion: 0.16
Nodes (21): TestLocalSearcher_New(), TestSelectorOptimizer_New(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain() (+13 more)
...
Cohesion: 0.2
Nodes (10): code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), code:go (type AgentCard struct { Name, Description, URL string }), Package: a2a, Package: eval, Package: persistence (+2 more)
...
Cohesion: 0.29
Nodes (7): code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), Package: log, Package: reflection, Package: validate, Package: workflow
...
## Knowledge Gaps
- **6570 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6565 more)
...
- **Why does `Append()` connect `Community 8` to `Community 0`, `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 525`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 529`, `Community 20`, `Community 21`, `Community 19`, `Community 528`, `Community 24`, `Community 536`, `Community 27`, `Community 28`, `Community 541`, `Community 30`, `Community 31`, `Community 33`, `Community 34`, `Community 547`, `Community 546`, `Community 37`, `Community 39`, `Community 552`, `Community 42`, `Community 43`, `Community 45`, `Community 46`, `Community 48`, `Community 49`, `Community 50`, `Community 52`, `Community 53`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 61`, `Community 63`, `Community 64`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 75`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 90`, `Community 92`, `Community 93`, `Community 95`, `Community 96`, `Community 99`, `Community 100`, `Community 106`, `Community 110`, `Community 111`, `Community 112`, `Community 113`, `Community 119`, `Community 121`, `Community 124`, `Community 127`, `Community 128`, `Community 132`, `Community 133`, `Community 136`, `Community 137`, `Community 139`, `Community 141`, `Community 149`, `Community 152`, `Community 154`, `Community 155`, `Community 159`, `Community 162`, `Community 164`, `Community 169`, `Community 170`, `Community 171`, `Community 172`, `Community 688`, `Community 177`, `Community 690`, `Community 179`, `Community 180`, `Community 693`, `Community 694`, `Community 695`, `Community 689`, `Community 182`, `Community 184`, `Community 193`, `Community 194`, `Community 197`, `Community 198`, `Community 202`, `Community 203`, `Community 716`, `Community 205`, `Community 719`, `Community 720`, `Community 721`, `Community 212`, `Community 215`, `Community 221`, `Community 739`, `Community 742`, `Community 743`, `Community 752`, `Community 761`, `Community 762`, `Community 765`, `Community 791`, `Community 798`, `Community 805`, `Community 350`, `Community 352`, `Community 353`, `Community 354`, `Community 355`, `Community 361`, `Community 365`, `Community 367`, `Community 368`, `Community 369`, `Community 370`, `Community 375`, `Community 379`, `Community 385`, `Community 387`, `Community 388`, `Community 389`, `Community 960`, `Community 962`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 62` to `Community 128`, `Community 1`, `Community 0`, `Community 7`, `Community 520`, `Community 10`, `Community 13`, `Community 14`, `Community 16`, `Community 19`, `Community 20`, `Community 22`, `Community 28`, `Community 30`, `Community 31`, `Community 41`, `Community 46`, `Community 47`, `Community 52`, `Community 180`, `Community 694`, `Community 58`, `Community 194`, `Community 67`, `Community 711`, `Community 80`, `Community 209`, `Community 83`, `Community 356`, `Community 740`, `Community 107`, `Community 111`, `Community 117`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 30` to `Community 768`, `Community 128`, `Community 0`, `Community 7`, `Community 8`, `Community 12`, `Community 13`, `Community 20`, `Community 22`, `Community 28`, `Community 156`, `Community 157`, `Community 159`, `Community 34`, `Community 163`, `Community 164`, `Community 162`, `Community 39`, `Community 46`, `Community 1074`, `Community 52`, `Community 181`, `Community 182`, `Community 183`, `Community 57`, `Community 62`, `Community 72`, `Community 208`, `Community 209`, `Community 95`, `Community 1002`, `Community 111`, `Community 112`, `Community 121`?**
