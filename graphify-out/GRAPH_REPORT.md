...
## Corpus Check
- 337 files · ~402,394 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5812 nodes · 10891 edges · 288 communities (255 shown, 33 thin omitted)
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 3563 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `851d6016`
...
## Communities (288 total, 33 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (117): TestBTPG_QualityMetrics_AllDomainTrees(), TestBFCL_AllDomainTrees_Accuracy(), handleTreeStructure(), AlertRouterTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality() (+109 more)
...
Cohesion: 0.04
Nodes (36): stringContains(), TestAction_PlanGoapActions_NoPlanFound(), execRefineAction(), generatePlanAction(), NewEngine(), RegisterProviders(), TestAction_ExecuteGoapStep_PastEnd(), TestAction_GoapFallback() (+28 more)
...
Cohesion: 0.06
Nodes (49): Blackboard, TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure(), TestNewGoTestTool_Structure(), TestNewGoVetTool_Structure(), TestNewGraphifyTool_Structure(), TestNewShellExecTool_Structure() (+41 more)
...
Cohesion: 0.1
Nodes (34): main(), DeepeningResult, makeRecords(), TestEvaluateTree_AllFailures(), TestEvaluateTree_EmptyRecords(), TestEvaluateTree_GoDevVsDefault(), TestEvaluateTree_Mixed(), TestEvaluateTree_NodeCountPenalty() (+26 more)
...
Cohesion: 0.09
Nodes (39): ContentTypeMiddleware(), CSRFMiddleware(), GenerateCSRFToken(), GenerateRequestID(), IPFilterMiddleware(), NewIPFilter(), RequestTimeoutMiddleware(), TestContentTypeMiddleware_AllowsGETWithoutContentType() (+31 more)
...
Cohesion: 0.07
Nodes (32): handleLogin(), handleLogout(), main(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter (+24 more)
...
Cohesion: 0.05
Nodes (36): Binaries, code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }) (+28 more)
...
Cohesion: 0.09
Nodes (35): TestTranspositionTable_DifferentTree_DifferentKey(), TestTranspositionTable_Eviction(), TestTranspositionTable_Persistence(), TestTranspositionTable_ProbeMiss(), TestTranspositionTable_StoreAndProbe(), TestTT_NonExistentDir(), NewTranspositionTable(), cloneTreeForGardener() (+27 more)
...
Cohesion: 0.09
Nodes (23): TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter(), TestMutation_AddBefore(), TestMutation_AddFallback(), TestMutation_IncreaseRetries(), TestMutation_PruneNode(), TestMutation_TargetNotFound() (+15 more)
...
Cohesion: 0.11
Nodes (16): TestCrossover_Single(), TestPopulation_Diversity(), TestPopulation_StatsAccessors(), Individual, cloneTree(), collectNodeNames(), Crossover(), hashTree() (+8 more)

### Community 57 - "Community 57"
Cohesion: 0.14
Nodes (30): ArraySchema(), BoolSchema(), IntSchema(), ObjectSchema(), StringSchema(), TestConvenienceSchemaConstructors(), TestOpenAPIGenerator_ReusableSchemas(), TestRouteBuilder_FluentAPI() (+22 more)
...
Cohesion: 0.14
Nodes (13): BTOptimizer, collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), isDefaultPath(), pathEntropy(), splitCamelCase() (+5 more)
...
Cohesion: 0.12
Nodes (14): TestCheckConfidence_ConditionExists(), TestApplyMutations_Batch(), TestLocalSearchMutableParamsAndTabu(), extractMutableParams(), getFloatMeta(), setFloatMeta(), toFloat64(), LocalSearcher (+6 more)
...
Cohesion: 0.14
Nodes (22): benchmarkPlanTree(), benchmarkSuccessTree(), TestBFCLV3LoadErrorsAndEmptyEvaluation(), TestBFCLV3LoadFlattenAndEvaluate(), TestBuiltinBFCLV3StableShape(), TestGAIABuiltinAndEvaluation(), TestIsToolMatchVariants(), TestLoadBFCLSuiteAndEvaluate() (+14 more)
...
Cohesion: 0.14
Nodes (17): AntiPattern, countTreeNodes(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype(), TestNewPopulation_Evolution(), TestPopulation_Evolve() (+9 more)
...
Cohesion: 0.17
Nodes (11): DefaultBlockConfig(), NewMetaPromptEvolver(), NewMutationContext(), TestBlockConfig_FilterMutations(), TestBlockConfig_IsMutable(), TestDefaultBlockConfig(), TestMetaPromptEvolver_EvolveTemplates(), TestMetaPromptEvolver_RecordFeedback() (+3 more)
...
Cohesion: 0.2
Nodes (7): parseChainConfig(), TestChainAction_ParseConfig(), toolStub, buildNode(), containsAny(), RunTask(), truncateStrForTree()
...
Cohesion: 0.24
Nodes (11): TestBTOptimizer_New(), TestDTAnalyzer_New(), NewBTOptimizer(), NewDTAnalyzer(), TestBTOptimizer_ReorderSelectors(), TestConditionOverlap(), TestDTAnalyzer_BestSplit(), TestDTAnalyzer_Entropy() (+3 more)

### Community 175 - "Community 175"
Cohesion: 0.27
Nodes (9): TestBFCLV3_LongContext(), TestRouting_Research(), TestTree_Research(), TestAllResearchTrees(), TestDeepResearch(), TestQuickResearch(), DeepResearchTree(), QuickResearchTree() (+1 more)
...
Cohesion: 0.39
Nodes (8): TestRecord_JSONRoundTrip(), TestStore_AutoTaskID(), TestStore_CountFailures_Empty(), TestStore_MultipleRecords(), TestStore_NonExistentDir(), TestStore_RecentFailures(), TestStore_SaveAndLoad(), NewStore()
...
- **Why does `main()` connect `Community 180` to `Community 5`, `Community 134`, `Community 136`, `Community 11`, `Community 268`, `Community 144`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 152`, `Community 27`, `Community 157`, `Community 45`, `Community 185`, `Community 60`, `Community 63`, `Community 67`, `Community 203`, `Community 208`, `Community 86`, `Community 96`, `Community 122`, `Community 123`?**
  _High betweenness centrality (0.227) - this node is a cross-community bridge._
- **Why does `BuildTree()` connect `Community 11` to `Community 0`, `Community 2`, `Community 4`, `Community 133`, `Community 10`, `Community 268`, `Community 16`, `Community 144`, `Community 20`, `Community 149`, `Community 27`, `Community 156`, `Community 30`, `Community 35`, `Community 170`, `Community 175`, `Community 180`, `Community 54`, `Community 198`, `Community 75`, `Community 203`, `Community 84`, `Community 93`, `Community 224`, `Community 99`, `Community 106`?**
  _High betweenness centrality (0.186) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 32` to `Community 5`, `Community 133`, `Community 6`, `Community 268`, `Community 22`, `Community 29`, `Community 157`, `Community 37`, `Community 50`, `Community 185`, `Community 59`, `Community 63`, `Community 65`, `Community 81`, `Community 92`, `Community 94`, `Community 96`, `Community 234`, `Community 108`, `Community 118`, `Community 122`?**
