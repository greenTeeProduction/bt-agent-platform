...
## Corpus Check
- 355 files · ~427,399 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6191 nodes · 11544 edges · 304 communities (268 shown, 36 thin omitted)
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 3795 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3a41e07a`
...
## Communities (304 total, 36 thin omitted)
...
Cohesion: 0.11
Nodes (33): TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions(), TestAction_PlanGoapActions_JSONActionsInvalidEntry(), TestAction_PlanGoapActions_NoPlanFound(), TestAction_PlanGoapActions_WithGoapConfig(), TestAction_PlanGoapActions_WorldStateFromTask(), TestAction_PlanGoapActions_WrongActionsType() (+25 more)
...
Cohesion: 0.05
Nodes (37): Binaries, code:go (type Counter struct { ... }), code:go (type Tracer interface {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type ThinkTank struct { ... }) (+29 more)
...
Cohesion: 0.09
Nodes (29): applyDotEnvFiles(), applyDotEnvToConfig(), applyEnvOverrides(), envBool(), hasExplicitField(), Load(), LoadFile(), LoadFileWithDotEnv() (+21 more)
...
Cohesion: 0.11
Nodes (30): TestTT_NonExistentDir(), NewTranspositionTable(), cloneTreeForGardener(), DefaultEvolveV2Config(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), TestCloneTreeForGardener_Basic() (+22 more)
...
Cohesion: 0.15
Nodes (30): main(), TestConsoleTracer_ExporterReceivesCompletedSpan(), TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest() (+22 more)
...
Cohesion: 0.12
Nodes (25): TestDetectPath_FromCurrentPath(), TestDetectPath_FromVisitedPaths(), TestDetectPath_KeywordFallback(), avgBranchingFactor(), BTPGQualityScore(), BTPGTreeSummary(), BuiltinBTPGTasks(), EvaluateBTPG() (+17 more)
...
Cohesion: 0.1
Nodes (15): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, baseNodeCount(), getRetryCount() (+7 more)

### Community 71 - "Community 71"
Cohesion: 0.11
Nodes (25): AlwaysSample(), hashTraceID(), NeverSample(), NewRatioSampler(), TestAlwaysSample(), TestConsoleTracer_ChildSpansNotSampled(), TestConsoleTracer_NoopWhenEnded(), TestConsoleTracer_SamplerConcurrent() (+17 more)
...
Cohesion: 0.11
Nodes (22): countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_New(), TestExpertKnowledge_ValidateArchetype(), TestNewPopulation_Evolution(), TestNewQTable(), TestNewReinforcementLearner(), TestPopulation_Diversity() (+14 more)
...
Cohesion: 0.09
Nodes (20): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, TestBuildPlannerNode_AllFail(), TestRegisterAction_DuplicatePanics(), TestRegisterCondition_DuplicatePanics(), Engine (+12 more)
...
Cohesion: 0.16
Nodes (25): TestBlackboard_AllFields(), TestTree_SerializeRoundtrip(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+17 more)
...
Cohesion: 0.15
Nodes (22): ContentTypeMiddleware(), CSRFMiddleware(), GenerateRequestID(), TestContentTypeMiddleware_AllowsGETWithoutContentType(), TestContentTypeMiddleware_AllowsJSON(), TestContentTypeMiddleware_AllowsJSONWithCharset(), TestContentTypeMiddleware_CustomAllowedTypes(), TestContentTypeMiddleware_CustomMethods() (+14 more)
...
Cohesion: 0.13
Nodes (17): AntiPattern, TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_RecommendMutations(), DesignPattern, containsStr(), coreHeuristics(), hasNodeMatching(), hasNodeType() (+9 more)
...
Cohesion: 0.25
Nodes (20): handleTreeStructure(), TestIntegration_AllTreesExecute(), runTeslaTree(), TestTeslaEarnings(), TestTeslaMarket(), TestTeslaModel(), TestTeslaPitchAgent(), TestTeslaValuation() (+12 more)
...
Cohesion: 0.14
Nodes (20): isKnownActionName(), isKnownConditionName(), parseChainConfig(), TestChainAction_ParseConfig(), TestBuildNode_AbortOnEvent(), TestBuildNode_PlannerNode(), TestBuildNode_ReactiveParallel(), TestBuildNode_UtilitySelector() (+12 more)

### Community 107 - "Community 107"
Cohesion: 0.14
Nodes (7): TestCheckConfidence_ConditionExists(), max(), randomMutation(), LocalSearcher, ApplyMutations(), Population, EvolveTool
...
Cohesion: 0.44
Nodes (17): Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks(), section12Glossary(), section1IntroGoals(), section2Constraints() (+9 more)
...
Cohesion: 0.17
Nodes (12): stringContains(), TestBuildGoapStepPrompt(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), TestAction_ExecuteGoapStep_PastEnd(), TestAction_GoapFallback(), TestAction_PlanGoapActions_EmptyActions(), TestAction_RouteToAllChannels() (+4 more)
...
Cohesion: 0.3
Nodes (9): escHTML(), formatDuration(), refreshTraces(), renderRecentSpans(), renderSpanTree(), renderTraceDetail(), renderTraceList(), startTracesPolling() (+1 more)
...
Cohesion: 0.2
Nodes (6): apiFetch(), loadAgents(), renderAgents(), loadEvolutionData(), renderEvolution(), selectTrace()
...
Cohesion: 0.43
Nodes (5): Debug(), Error(), Info(), L(), Warn()
...
- **Why does `main()` connect `Community 177` to `Community 1`, `Community 4`, `Community 136`, `Community 15`, `Community 18`, `Community 19`, `Community 20`, `Community 149`, `Community 150`, `Community 283`, `Community 30`, `Community 172`, `Community 46`, `Community 175`, `Community 59`, `Community 203`, `Community 84`, `Community 90`, `Community 220`, `Community 232`, `Community 113`, `Community 119`?**
  _High betweenness centrality (0.228) - this node is a cross-community bridge._
- **Why does `BuildTree()` connect `Community 1` to `Community 3`, `Community 8`, `Community 138`, `Community 15`, `Community 22`, `Community 25`, `Community 283`, `Community 30`, `Community 158`, `Community 32`, `Community 38`, `Community 167`, `Community 177`, `Community 61`, `Community 64`, `Community 65`, `Community 193`, `Community 209`, `Community 210`, `Community 84`, `Community 216`, `Community 220`, `Community 101`, `Community 106`, `Community 109`, `Community 119`?**
  _High betweenness centrality (0.203) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 59` to `Community 4`, `Community 5`, `Community 138`, `Community 283`, `Community 28`, `Community 36`, `Community 169`, `Community 44`, `Community 175`, `Community 54`, `Community 60`, `Community 66`, `Community 203`, `Community 94`, `Community 102`, `Community 103`, `Community 104`, `Community 232`, `Community 112`, `Community 113`, `Community 120`, `Community 252`?**
