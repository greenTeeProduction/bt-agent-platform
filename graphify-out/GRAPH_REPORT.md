# Graph Report - superpowers-20260712T230752-8d421b65-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-12)

## Corpus Check
- 824 files · ~909,528 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19917 nodes · 31021 edges · 1693 communities (1330 shown, 363 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8137 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b39c13b7`
...
## Communities (1693 total, 363 thin omitted)
...
Cohesion: 0.02
Nodes (123): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+115 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (123): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+115 more)
...
Cohesion: 0.04
Nodes (75): alwaysSampler, Attr, fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe() (+67 more)
...
Cohesion: 0.05
Nodes (83): DefaultLLM(), RealLLM(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), EvaluateBFCLV3(), minInt(), TestBFCLV3_LongContext(), TestBFCLV3_MultiTurn_Basic() (+75 more)
...
Cohesion: 0.04
Nodes (66): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+58 more)
...
Cohesion: 0.06
Nodes (67): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+59 more)
...
Cohesion: 0.08
Nodes (67): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+59 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (63): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+55 more)
...
Cohesion: 0.05
Nodes (56): AgentDefinition, ContentType, TestContentResponse_200(), TestContentResponse_Non200(), TestMustParseAgentDefinition_PanicsOnInvalid(), TestMustParseAgentDefinition_Valid(), TestNumberIn_InvalidNumberString(), TestNumberIn_Matching() (+48 more)
...
Cohesion: 0.05
Nodes (29): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, Gardener, baseNodeCount() (+21 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (44): containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest(), TestRunTask_KnowledgeGap_RoutesToKnowledgePath() (+36 more)
...
Cohesion: 0.06
Nodes (19): Server, AgentMetric, AlertReport, MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON(), evaluateGlobalAlerts() (+11 more)
...
Cohesion: 0.1
Nodes (53): TestAddTag(), TestAddTag_EmptyDescription(), TestRouteBuilder_Build(), TestSchemaToMap_Format(), ArraySchema(), IntSchema(), NewOpenAPIGenerator(), NewRoute() (+45 more)
...
Cohesion: 0.06
Nodes (31): TestRunOnce_EmitsRunRootSpan(), tracingMiddleware(), fanoutHandler, InitLogExport(), logExportTarget(), newTraceContextHandler(), TestInitLogExport_Idempotent(), TestLogExportTarget() (+23 more)

### Community 48 - "Community 48"
Cohesion: 0.09
Nodes (47): main(), Duration(), TestDuration(), TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails(), TestRunTask_Success(), TestSaveTo_PersistsCorrectly(), TestTreeRoundTrip() (+39 more)
...
Cohesion: 0.08
Nodes (39): perTreeStats(), setupGardener(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree(), TestMetricsTracker_BestFitnessTracking() (+31 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (28): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports(), TestValidateQualitySpec_BlockedPattern() (+20 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (52): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+44 more)
...
Cohesion: 0.07
Nodes (38): copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), DefaultRebuildTargets(), NewRebuildBackoff(), RebuildBinaries(), resolveGoBinary(), TestRebuildBinaries() (+30 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (29): TestPromoteRunToAgentScope(), TestSeedMemoryToBlackboard_HistoryOffloaded(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), Entry, Limits (+21 more)
...
Cohesion: 0.09
Nodes (21): handleSprintExecute(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep() (+13 more)
...
Cohesion: 0.08
Nodes (31): TestOutcomeErrorDetail(), FeedbackFile(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath() (+23 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (24): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogin() (+16 more)
...
Cohesion: 0.05
Nodes (31): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, DeadLetterEntry, TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailure_BackwardCompat() (+23 more)
...
Cohesion: 0.09
Nodes (34): biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), experienceRecordingGardener(), experienceReuseCount() (+26 more)
...
Cohesion: 0.12
Nodes (17): extractTreeType(), TestEvolveWithExperience_NilBankStillEvolves(), TestExtractTreeType(), Individual, cloneTree(), collectNodeNames(), containsCrisisReason(), Crossover() (+9 more)
...
Cohesion: 0.11
Nodes (21): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), countTreeNodes(), TestSuperpowersPipelineSimulation(), TestHumanApprovalGate_AutoApprove() (+13 more)
...
Cohesion: 0.14
Nodes (25): agentNameInterceptor, agentNameKey, ScoreAnnouncement(), BTAgentExecutor, cardResponder, NewServer(), parseAnnouncement(), RespondToAnnouncement() (+17 more)
...
Cohesion: 0.12
Nodes (22): main(), TestClient_AnalyzeComplexity_FallbackOnError(), TestClient_Generate_ConnectionRefused(), TestClient_GeneratePlan_FallbackOnError(), TestClient_Reflect_FallbackOnError(), TestDeepSeekClient_AnalyzeComplexity(), TestDeepSeekClient_Generate_APIError(), TestDeepSeekClient_Generate_ConnectionRefused() (+14 more)
...
Cohesion: 0.13
Nodes (12): BTOptimizer, collectSelectors(), extractCondition(), findMainSelector(), TestFindMainSelector(), isDefaultPath(), pathEntropy(), DTAnalyzer (+4 more)

### Community 148 - "Community 148"
Cohesion: 0.18
Nodes (5): TestTruncateTask(), Factory, extractKeywords(), truncateTask(), Truncate()
...
Cohesion: 0.16
Nodes (19): BTAgentClient, NewBTAgentClient(), safetyGetMessageText(), TestA2AServer_HandleAgentEndpoint_EmptyName(), TestA2AServer_HandleAgentEndpoint_UnknownAgent(), TestA2AServer_HandleHealth_Direct(), TestA2AServer_HandleWellKnown(), TestA2AServer_Stop() (+11 more)
...
Cohesion: 0.14
Nodes (22): TestBTOptimizer_New(), conditionOverlap(), TestExtractCondition(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), TestSplitCamelCase(), NewBTOptimizer() (+14 more)
...
Cohesion: 0.26
Nodes (19): GetSLOMetrics(), DefaultValidationGateConfig(), TestValidationGate_EvidenceForOtherTreeOnly_FailsClosed(), TestValidationGate_FileEvidence_AggregatesAcrossAgents(), TestValidationGate_FileEvidence_LowSuccessRate_Rejects(), TestValidationGate_FileEvidence_Passes(), TestValidationGate_NoMemoryNoFile_FailsClosed(), writeEvidenceFile() (+11 more)
...
Cohesion: 0.14
Nodes (14): DefaultBlockConfig(), NewMetaPromptEvolver(), NewMutationContext(), TestBlockConfig_FilterMutations(), TestBlockConfig_IsMutable(), TestCrisisDetector_LastDiversity(), TestDefaultBlockConfig(), TestMetaPromptEvolver_EvolveTemplates() (+6 more)
...
Cohesion: 0.16
Nodes (6): DashboardRoutes(), TestDashboardRoutes_AgentsExecuteHasRequestBody(), TestDashboardRoutes_AllHaveOperationIDs(), TestDashboardRoutes_OperationIDUniqueness(), TestDashboardRoutes_SwaggerRoute(), RouteBuilder
...
Cohesion: 0.18
Nodes (8): acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), cappedCells(), mergeSelectorStatsMaps(), persistSelectorStats(), readSelectorStatsFile()
...
Cohesion: 0.11
Nodes (17): TestNumberSchema(), DeprecationHeader, BoolSchema(), httpStatusText(), NumberSchema(), TestHTTPStatusText(), toAnySlice(), OpenAPIComponents (+9 more)
...
Cohesion: 0.16
Nodes (9): LoadSLOEvidence(), SaveSLOMetrics(), TestLoadSLOEvidence_MissingFile(), TestSaveSLOMetrics_AtomicNoTmpLeftBehind(), TestSaveSLOMetrics_LoadSLOEvidence_Roundtrip(), SLOSnapshot, evidenceTreeNames(), loadTreeEvidence() (+1 more)
...
Cohesion: 0.15
Nodes (7): exportMemoryCategory(), exportPreviousRuns(), ResolvePipelineAgent(), RunDeps, RunOptions, RunResult, TreeResolver
...
Cohesion: 0.29
Nodes (3): TestErrorRecorder_PrefersRateLimitError(), TracedLLM, RetryAfterFromError()
...
Cohesion: 0.33
Nodes (8): NewOpenAICompatClient(), TestOpenAICompat_ErrorResponse(), TestOpenAICompat_GenerateWithModel_SendsChatCompletion(), rateLimitedServer(), TestDeepSeek_429ReturnsRateLimitError(), TestOpenAICompat_429NonJSONBody(), TestOpenAICompat_429ReturnsRateLimitError(), TestOpenAICompat_429WithoutRetryAfterHeader()
...
Cohesion: 0.31
Nodes (3): ErrorRecorder, TestErrorRecorder_RecordsLastError(), NewErrorRecorder()
...
Cohesion: 0.33
Nodes (3): handleScalability(), TestHandleDLQReplay_RequeuesInsteadOfDropping(), TestHandleScalability_ReflectsInjectedQueueAndRouter()
...
## Knowledge Gaps
- **6405 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6400 more)
...
- **Why does `Append()` connect `Community 39` to `Community 0`, `Community 1`, `Community 514`, `Community 515`, `Community 4`, `Community 517`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 525`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 13`, `Community 20`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 540`, `Community 541`, `Community 30`, `Community 31`, `Community 32`, `Community 34`, `Community 35`, `Community 36`, `Community 546`, `Community 37`, `Community 551`, `Community 41`, `Community 42`, `Community 44`, `Community 45`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 54`, `Community 56`, `Community 57`, `Community 59`, `Community 60`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 67`, `Community 68`, `Community 70`, `Community 71`, `Community 72`, `Community 74`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 84`, `Community 86`, `Community 88`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 98`, `Community 101`, `Community 105`, `Community 107`, `Community 111`, `Community 112`, `Community 114`, `Community 123`, `Community 126`, `Community 127`, `Community 131`, `Community 133`, `Community 134`, `Community 135`, `Community 144`, `Community 146`, `Community 147`, `Community 148`, `Community 149`, `Community 151`, `Community 155`, `Community 156`, `Community 157`, `Community 163`, `Community 678`, `Community 167`, `Community 166`, `Community 169`, `Community 170`, `Community 168`, `Community 686`, `Community 175`, `Community 176`, `Community 177`, `Community 178`, `Community 185`, `Community 698`, `Community 699`, `Community 188`, `Community 700`, `Community 194`, `Community 199`, `Community 200`, `Community 202`, `Community 715`, `Community 204`, `Community 205`, `Community 730`, `Community 731`, `Community 733`, `Community 741`, `Community 747`, `Community 760`, `Community 336`, `Community 337`, `Community 341`, `Community 342`, `Community 345`, `Community 351`, `Community 355`, `Community 356`, `Community 357`, `Community 358`, `Community 363`, `Community 364`, `Community 365`, `Community 370`, `Community 371`, `Community 372`, `Community 377`, `Community 927`, `Community 935`, `Community 938`, `Community 943`, `Community 506`, `Community 507`, `Community 510`, `Community 511`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 66` to `Community 1`, `Community 518`, `Community 9`, `Community 10`, `Community 13`, `Community 526`, `Community 17`, `Community 24`, `Community 32`, `Community 35`, `Community 549`, `Community 37`, `Community 166`, `Community 42`, `Community 46`, `Community 47`, `Community 48`, `Community 52`, `Community 182`, `Community 55`, `Community 57`, `Community 60`, `Community 192`, `Community 704`, `Community 339`, `Community 340`, `Community 85`, `Community 86`, `Community 354`, `Community 105`, `Community 365`, `Community 112`, `Community 113`, `Community 372`, `Community 118`, `Community 124`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 37` to `Community 1`, `Community 131`, `Community 9`, `Community 12`, `Community 1039`, `Community 144`, `Community 15`, `Community 24`, `Community 152`, `Community 155`, `Community 30`, `Community 33`, `Community 36`, `Community 39`, `Community 48`, `Community 177`, `Community 52`, `Community 55`, `Community 60`, `Community 191`, `Community 192`, `Community 65`, `Community 66`, `Community 199`, `Community 973`, `Community 344`, `Community 90`, `Community 101`, `Community 105`, `Community 107`, `Community 112`, `Community 113`, `Community 114`, `Community 122`?**
