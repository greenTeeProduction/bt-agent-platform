# Graph Report - superpowers-20260717T085739-51bce651-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-17)

## Corpus Check
- 895 files · ~1,131,476 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25355 nodes · 37990 edges · 2017 communities (1657 shown, 360 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9182 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b22137b7`
...
3. `9. Architecture Decisions` - 145 edges
4. `NewKnowledgeGraph()` - 144 edges
5. `registerMCPTools()` - 143 edges
6. `NewRequest()` - 138 edges
...
## Communities (2017 total, 360 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (193): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+185 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (193): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+185 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (122): TestCheckConfidence_ConditionExists(), TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch() (+114 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (138): 9. Architecture Decisions, ADR-008: Auction-Based A2A Task Allocation, ADR-009: Deterministic, LLM-Free Evolution MCP Tools, ADR-010: Non-Wedging Self-Halting Circuit Gates for the GOAP Fusion Loop, ADR-011: Adopting the Horizontal-Scaling Substrate (RemoteExecutor + AgentRouter), ADR-012: Wiring the Scalability Substrate into the Dashboard Endpoint and Probe (Milestones 3–4), ADR-013: Making the Production Superpowers Pipeline Tree Operator-Selectable and Guarded, ADR-014: Mandatory Descriptions for Every Node Class in Curated Domain Trees (+130 more)
...
Cohesion: 0.03
Nodes (87): containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge(), TestGoDevTree_RoutesToTest(), TestRunTask_CacheHit() (+79 more)
...
Cohesion: 0.04
Nodes (92): init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), TestParseSplitOutput(), validateDesignAction(), validateDesignHeadings(), arc42SeedTargetGoal(), buildArc42SeedPrompt() (+84 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (80): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+72 more)
...
Cohesion: 0.04
Nodes (86): handleLogin(), handleLogout(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey (+78 more)
...
Cohesion: 0.04
Nodes (59): newAgentExecutor(), agentExecuteResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun() (+51 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (79): goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup() (+71 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (54): stringContains(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_PlanGoapActions_NoPlanFound(), cacheCheckAction(), cacheResultAction(), execLLMCallAction(), execRefineAction(), generatePlanAction() (+46 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (83): TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip(), TestDeadLetterQueue_PreserveCategory() (+75 more)
...
Cohesion: 0.03
Nodes (50): findChildByName(), TestBuildGoapStepPrompt(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords(), TestContainsAnyLower_NoKeywords(), TestContainsAnyLower_NoMatch() (+42 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (77): TestScoreChild_GoalAlignmentBranch(), TestScoreChild_NilChainState(), TestScoreChildren_BasicRanking(), ParallelMode, intSliceFromInterface(), BuildReactiveParallel(), childPanicHandler(), forkBlackboard() (+69 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (59): NewCatalog(), TestCatalog_Export(), TestCatalog_ListInstalled(), TestCatalog_ListTemplates(), TestCatalog_Search(), TestCatalog_SkillToAgent(), TestInferTree(), FileJobStore (+51 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (50): DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM(), TestChainAction_Agent_NoTools(), TestChainAction_Agent_SummaryError(), TestChainAction_Agent_SummaryLLMError() (+42 more)
...
Cohesion: 0.06
Nodes (55): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeWithHITL(), resolveTree(), resolveTreeForUser(), agentTemplateYAML, TestAllDomainTreesWrappedInClaudeErrorHandler() (+47 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (50): TestOutcomeErrorDetail(), FeedbackFile(), RunDeps, applyOutcomeRefinement(), IsHealthyOutcome(), OutcomeErrorDetail(), TestApplyOutcomeRefinement(), TestIsHealthyOutcome() (+42 more)
...
Cohesion: 0.04
Nodes (36): FilterByTreeName(), Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, biasCandidatesWithExperience() (+28 more)
...
Cohesion: 0.07
Nodes (65): Duration(), countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype() (+57 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (63): echoTaskLeaf, islandArchivePath(), newProductionPopulation(), qtableArchivePath(), registerMCPTools(), assertExpertArchiveFedFromRun(), injectSelectorProbeTree(), seedSelectorProbeStats() (+55 more)

### Community 34 - "Community 34"
Cohesion: 0.09
Nodes (53): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Research(), TestTree_Research() (+45 more)
...
Cohesion: 0.04
Nodes (10): emptyDecomposeMockLLM, flakyDecomposeMockLLM, flakySubtaskMockLLM, incompleteSynthMockLLM, largeSubtaskMockLLM, nudgeRecoveryMockLLM, promptRecordingMockLLM, rateLimitedRefineInitialMockLLM (+2 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (18): History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), mockTTOrch, EventBus (+10 more)
...
Cohesion: 0.05
Nodes (49): DefaultRetryPolicy(), GetErrorContext(), NewErrorContext(), TestErrorContext_Concurrent(), TestErrorContext_Error(), TestErrorContext_Error_Minimal(), TestErrorContext_Integration_RetryPolicy(), TestErrorContext_Summary_Full() (+41 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (56): AgentBus, AgentEvent, InitAgentBus(), PublishHealthAlert(), PublishServiceDown(), TestAgentBus_AllSubscribersReceiveAll(), TestAgentBus_CloseSubscriberChannelsClosed(), TestAgentBus_ConcurrentPublish() (+48 more)
...
Cohesion: 0.06
Nodes (49): HTTPMethod, IntSchema(), collectViolations(), fieldPath(), findResponse(), NewRouteIndex(), pathOrRoot(), ResponseValidator() (+41 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (34): handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep(), TestHandlePipelineRun_PanicRecoveredAsFailedStatus() (+26 more)
...
Cohesion: 0.07
Nodes (59): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewWebSearchTool_Structure() (+51 more)
...
Cohesion: 0.06
Nodes (53): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), TestIsGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation() (+45 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (39): References, Collect(), indexOf(), GoapFusionPreflightNode(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionCircuitBreakerHalts(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionCircuitBreakerHaltsOnConsecutiveNoopPatches(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionGatesClaudeImplementation(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionLoopHaltsOnConsecutiveNoopPatches() (+31 more)

### Community 52 - "Community 52"
Cohesion: 0.08
Nodes (60): TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestNumberSchema(), TestRouteBuilder_Build(), TestRouteBuilder_SunsetDate(), TestSchemaToMap_Format() (+52 more)

### Community 53 - "Community 53"
Cohesion: 0.07
Nodes (56): cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask(), serializeTreeForGardener(), crisisMetricsGardener(), crisisV2Config() (+48 more)
...
Cohesion: 0.05
Nodes (43): ActionFunc, ActionProvider, init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), ConditionFunc, ConditionProvider, init() (+35 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (45): TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath(), TestDiscardWorktree_RemovesWorktreeAndDeletesBranch(), TestPushBranchAndCreatePR_InvokesGitPushAndGhPr(), withSwappedSuperpowersRunners(), newGrillLoopTestRun() (+37 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (39): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus() (+31 more)

### Community 58 - "Community 58"
Cohesion: 0.07
Nodes (55): ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), buildMapReduceFallback(), buildToolList() (+47 more)
...
Cohesion: 0.07
Nodes (31): AgentRunner, Checkpoint, extractCycleFacts(), TestExtractCycleFacts(), truncateForLog(), TestEstimateQualityPenalizesGenericShortSuccess(), TestEstimateQualityScoresEvidenceRichDeterministicReports(), TestValidateQualitySpec_BlockedPattern() (+23 more)
...
Cohesion: 0.07
Nodes (24): Manager, newScopedStore(), normalizeKey(), truncateSummary(), isPersistentScope(), loadScopeFile(), safeFilename(), scopedStore (+16 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (29): AgentMetrics, AgentStats, BuildIdentity, Counter, Gauge, HealthResponse, Histogram, LabeledCounter (+21 more)

### Community 66 - "Community 66"
Cohesion: 0.07
Nodes (38): min(), brokenTool, buildChainActionFn(), execLLMCall(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section() (+30 more)
...
Cohesion: 0.06
Nodes (37): BuildBudget(), budgetCmd, BuildCachedCondition(), BuildChainAction(), TestBuildChainAction_ReturnsNonNil(), BuildCircuitBreaker(), BuildInverter(), BuildRepeater() (+29 more)
...
Cohesion: 0.08
Nodes (40): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionNoopPatchStreak(), goapFusionPreflightWired() (+32 more)

### Community 73 - "Community 73"
Cohesion: 0.07
Nodes (27): TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree(), TestWireSelectorReorderIsOptIn() (+19 more)

### Community 74 - "Community 74"
Cohesion: 0.05
Nodes (34): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, ConcurrencyLimiter, DeadLetterEntry, TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty() (+26 more)
...
Cohesion: 0.06
Nodes (30): Blackboard, ChildTick, childTickLog, init(), TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern() (+22 more)

### Community 80 - "Community 80"
Cohesion: 0.14
Nodes (34): init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled(), TestBanditSelector_DisabledMatchesSelectorSemantics(), TestBanditSelector_DisabledRunningChildRestartsAtZero() (+26 more)

### Community 81 - "Community 81"
Cohesion: 0.07
Nodes (24): tracingMiddleware(), fanoutHandler, InitLogExport(), logExportTarget(), newTraceContextHandler(), TestInitLogExport_Idempotent(), TestLogExportTarget(), TestTraceContextHandler_InjectsTraceIDs() (+16 more)
...
Cohesion: 0.12
Nodes (37): recordUserFeedback(), registerFeedbackTools(), newFeedbackDeps(), TestBTFeedbackRegistered(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), TestRecordUserFeedback_FeedsSatisfactionAndFlags(), TestRecordUserFeedback_RejectsBadInput(), TestRecordUserFeedback_TrimsUserAndTreeID() (+29 more)
...
Cohesion: 0.12
Nodes (34): TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), TestAction_PlanGoapActions_JSONActionsInvalidEntry(), TestAction_PlanGoapActions_WithGoapConfig(), TestAction_PlanGoapActions_WorldStateFromTask(), TestAction_PlanGoapActions_WrongActionsType() (+26 more)
...
Cohesion: 0.09
Nodes (30): ctxAwareBlockingRunner, buildErrorHandlerPrompt(), errorHandlerCooldown(), errorHandlerEnabled(), errorHandlerMaxNodes(), errorHandlerNodeDepth(), errorHandlerSignatureFromBB(), firstTickedLeaf() (+22 more)
...
Cohesion: 0.07
Nodes (28): ErrorCategory, ApplyJitter(), contextDeadlineExceeded(), DecorrelatedJitter(), EqualJitter(), ExecuteWithPolicy(), FullJitter(), isAuthError() (+20 more)
...
Cohesion: 0.07
Nodes (26): TestRunOnce_EmitsRunRootSpan(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), alwaysSampler, Attr (+18 more)

### Community 115 - "Community 115"
Cohesion: 0.08
Nodes (5): agentTestMockLLM, chainMockLLM, countedErrorMockLLM, errorMockLLM, indexedErrorMockLLM
...
Cohesion: 0.13
Nodes (19): ChildStats, TestNormalizedIG(), NodeExecutionRecord, applyOrderToNode(), Entropy(), GiniImpurity(), InformationGain(), isSelectorFallback() (+11 more)
...
Cohesion: 0.13
Nodes (33): CompressionMiddleware(), gzipDecompress(), TestCompressionMiddleware_AlreadyCompressed(), TestCompressionMiddleware_BinaryContentType(), TestCompressionMiddleware_EmptyBody(), TestCompressionMiddleware_GzipRequest(), TestCompressionMiddleware_HTMLContentType(), TestCompressionMiddleware_LargeJSONResponse() (+25 more)
...
Cohesion: 0.09
Nodes (26): TestNewReinforcementLearner(), TestQTableSelectUpdateBestAction(), TestQTableStateBucketsAndDepth(), TestReinforcementLearnerLearnAndSuggest(), NewQTable(), NewReinforcementLearner(), contextsOf(), TestExpertKnowledge_ObservesLearnedPatternFromQLearning() (+18 more)
...
Cohesion: 0.09
Nodes (17): TestDeprecatedHandlerFunc(), DeprecationHeader, DashboardRoutes(), DeprecatedHandlerFunc(), httpStatusText(), TestDeprecatedHandlerFunc_WithSunset(), TestHTTPStatusText(), OpenAPIComponents (+9 more)
...
Cohesion: 0.1
Nodes (29): fakeTracer, AlwaysSample(), hashTraceID(), NeverSample(), NewRatioSampler(), TestAlwaysSample(), TestConsoleTracer_ChildSpansNotSampled(), TestConsoleTracer_MultipleChildren() (+21 more)

### Community 139 - "Community 139"
Cohesion: 0.17
Nodes (27): isGoapNotebookLMFailure(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery(), nlmIsResearchImport(), nlmIsResearchStart(), nlmPacificDay() (+19 more)
...
Cohesion: 0.13
Nodes (24): registerA2ANodes(), TestDelegateToA2A_FnNotConfigured(), TestDelegateToA2A_FnReturnsError(), TestDelegateToA2A_MissingTaskEmptyChainState(), TestDelegateToA2A_MissingURL(), TestDelegateToA2A_Success(), TestDelegateToA2A_UsesTaskFromChainState(), TestHasA2ATarget_EmptyURL() (+16 more)
...
Cohesion: 0.1
Nodes (22): main(), BTStudioCompany(), main(), TestClient_AnalyzeComplexity_FallbackOnError(), TestClient_Generate_ConnectionRefused(), TestClient_GeneratePlan_FallbackOnError(), TestClient_Reflect_FallbackOnError(), TestDeepSeekClient_AnalyzeComplexity() (+14 more)

### Community 145 - "Community 145"
Cohesion: 0.08
Nodes (26): ClassifyError(), isNetworkError(), isTypedNetworkError(), TestClassifyError_Auth(), TestClassifyError_CaseInsensitive(), TestClassifyError_ClaudeUsageLimit(), TestClassifyError_LLM(), TestClassifyError_Network() (+18 more)
...
Cohesion: 0.14
Nodes (28): growthFitness(), FitnessDimension, MultiIndividual, clampScore(), countActions(), countConditions(), NewMultiFitness(), NewParetoFront() (+20 more)

### Community 149 - "Community 149"
Cohesion: 0.09
Nodes (29): Binaries, code:go (type Counter struct { ... }), code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }) (+21 more)
...
Cohesion: 0.16
Nodes (28): TestConsoleTracer_ExporterReceivesCompletedSpan(), TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest(), TestTracingMiddleware_StatusCodes() (+20 more)

### Community 153 - "Community 153"
Cohesion: 0.11
Nodes (24): TestMatchBlockPattern(), AntiPattern, DesignPattern, BlockIDFromRef(), coreHeuristics(), knownAntiPatterns(), MatchBlockPattern(), NewExpertKnowledge() (+16 more)
...
Cohesion: 0.13
Nodes (21): toast(), apiFetch(), getCookie(), approveHITL(), approveTask(), executeSprint(), pollSprintStatus(), refreshHITL() (+13 more)
...
Cohesion: 0.12
Nodes (23): defaultNlmGrillAuthGuard(), nlmGrillAnswerer(), nlmGrillUnavailable(), parseNumberedAnswers(), runGrillAuthGuardAction(), TestNlmGrillAnswerer_AuthGuardFailureIsUnavailable(), TestNlmGrillAnswerer_EmptyOutputIsUnavailable(), TestNlmGrillAnswerer_NoAnswerMarkersIsUnavailable() (+15 more)
...
Cohesion: 0.13
Nodes (23): blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu(), TestBTBlocksComposeSaveHoldsServerLock(), TestBTHITLComposeTaskSaveHoldsBBMu(), TestBTHITLComposeTaskSaveHoldsServerLock() (+15 more)
...
Cohesion: 0.15
Nodes (20): NewDefaultCompany(), clamp(), safeDiv(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary(), testLLM() (+12 more)
...
Cohesion: 0.1
Nodes (15): init(), modal, num, renderTab(), state, TAB_KEYS, renderCompany(), loadScalability() (+7 more)
...
Cohesion: 0.15
Nodes (16): CompanyOrchestrator, EngineerTree(), MarketingTree(), SalesTree(), CEOTree(), CTOTree(), PMTree(), Roles() (+8 more)
...
Cohesion: 0.16
Nodes (15): handleFellows(), NewMockLLM(), DefaultFellows(), NewThinkTank(), TestDefaultFellows(), TestFellowConfidence(), TestFullAnalysis_MultipleTopics(), TestNewThinkTank() (+7 more)

### Community 208 - "Community 208"
Cohesion: 0.16
Nodes (19): TestBTOptimizer_New(), TestExtractCondition(), TestFindMainSelector(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), NewBTOptimizer(), NewDTAnalyzer() (+11 more)
...
Cohesion: 0.1
Nodes (6): EvolveTool, FitnessTool, GetReflectionsTool, ReflectTool, RunTaskTool, truncateStr()
...
Cohesion: 0.11
Nodes (17): collectNames(), contains(), TestBlackboard_AllFields(), TestBuildTree_Minimal(), TestBuildTree_UnknownType(), TestOutcome_EmptyTaskFails(), TestOutcome_Success(), TestRouting_CodeReview() (+9 more)
...
Cohesion: 0.2
Nodes (17): TestSelectorOptimizer_KillerChild(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing(), TestLocalSearch_TabuSearch(), TestSelectorOptimizer_ApplyOrdering() (+9 more)
...
Cohesion: 0.18
Nodes (13): Init(), CleanupOldLogs(), NewRotatingWriter(), TestCleanupOldLogs(), TestCleanupOldLogs_NoBackups(), TestNewRotatingWriter_AppendToExisting(), TestNewRotatingWriter_CreatesFile(), TestRotatingWriter_Close() (+5 more)
...
Cohesion: 0.2
Nodes (11): TestEligibleBidders(), TestEligibleBidders_NoRequiredTagsMatchesAll(), BuildCardRegistry(), cardCoversTags(), ConvertToAgentCard(), EligibleBidders(), TestBuildCardRegistry(), TestConvertToAgentCard_Basic() (+3 more)
...
Cohesion: 0.18
Nodes (11): TestNewGoBuildTool_Structure(), TestNewGoTestTool_Structure(), TestNewGoVetTool_Structure(), TestNewGraphifyTool_Structure(), TestNewShellExecTool_Structure(), TestRealTool_Call(), TestRealTool_NameAndDescription(), TestToolStub_CallReturnsEmpty() (+3 more)
...
Cohesion: 0.23
Nodes (12): NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic(), TestNSGAII_FrontRank(), TestNSGAIIPopulation_Evolve_ResurrectsExtinctSpecialist() (+4 more)
...
Cohesion: 0.15
Nodes (13): code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), Package: evaluator (+5 more)
...
Cohesion: 0.26
Nodes (10): classifyErrorHandlerFailure(), goapFailureCategory(), isGoapFusionCycle(), TestClassifyErrorHandlerFailure(), TestClassifyReliabilityFallback(), TestClaudeErrorHandler_ClassifiesUnclassifiedFailure(), TestClaudeErrorHandler_GoapFailureGetsGoapCategory(), TestErrorHandlerSignature_ClassifiedWithoutLastErrorIsStable() (+2 more)
...
Cohesion: 0.18
Nodes (11): isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), TestChainAction_Agent_Parse(), TestParseAgentAction_MultiLineInput(), TestParseAgentAction_StopsAtNextSection(), TestParseFinalAnswer_MidResponse(), TestParseFinalAnswer_MidResponseWithRest() (+3 more)
...
Cohesion: 0.36
Nodes (3): containsStr(), hasNodeType(), ExpertKnowledge
...
Cohesion: 0.32
Nodes (5): docChangeContextFromBlackboard(), init(), registerArc42SyncNode(), TestArc42DocsyncNodesRegistered(), TestDocChangeContextFromBlackboardFallsBackToGit()
...
Cohesion: 0.48
Nodes (5): ActionFunc, ActionRegistry, AgentCallbacks, AgentRun, AgentState
...
Cohesion: 0.33
Nodes (6): namedTree, sprintRecover(), TestStress_ConcurrentExecution(), TestStress_EdgeInputs(), TestStress_Idempotency(), TestStress_MaxTicksSafetyLimit()

### Community 1011 - "Community 1011"
Cohesion: 0.29
Nodes (6): TestIntegration_AllChainTypes(), TestIntegration_EdgeCases(), TestIntegration_MutationOperators(), TestIntegration_PanicRecovery(), TestIntegration_QualityGatesFullFlow(), TestIntegration_ReflectionAndPersistence()
...
Cohesion: 0.33
Nodes (6): expandChainStateTemplates(), TestExpandChainStateTemplates_Basic(), TestExpandChainStateTemplates_MissingKey(), TestExpandChainStateTemplates_MultipleSubstitutions(), TestExpandChainStateTemplates_NilChainState(), TestExpandChainStateTemplates_EmptyState()
...
Cohesion: 0.5
Nodes (3): TestRunPipelineWithID_RecordsAgentMetrics(), TestRunTaskResult_RecordsTaskMetric(), GetAgentMetrics()
...
## Knowledge Gaps
- **9646 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+9641 more)
...
- **Why does `Append()` connect `Community 37` to `Community 2`, `Community 5`, `Community 7`, `Community 8`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 26`, `Community 29`, `Community 30`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 39`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 45`, `Community 46`, `Community 49`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 58`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 75`, `Community 76`, `Community 80`, `Community 82`, `Community 83`, `Community 84`, `Community 86`, `Community 89`, `Community 91`, `Community 93`, `Community 94`, `Community 95`, `Community 97`, `Community 98`, `Community 100`, `Community 101`, `Community 102`, `Community 103`, `Community 105`, `Community 109`, `Community 113`, `Community 114`, `Community 117`, `Community 120`, `Community 121`, `Community 122`, `Community 127`, `Community 131`, `Community 132`, `Community 135`, `Community 136`, `Community 137`, `Community 141`, `Community 143`, `Community 146`, `Community 148`, `Community 152`, `Community 157`, `Community 158`, `Community 160`, `Community 674`, `Community 678`, `Community 168`, `Community 173`, `Community 174`, `Community 687`, `Community 175`, `Community 176`, `Community 690`, `Community 184`, `Community 185`, `Community 700`, `Community 703`, `Community 199`, `Community 200`, `Community 201`, `Community 203`, `Community 205`, `Community 206`, `Community 207`, `Community 210`, `Community 212`, `Community 214`, `Community 216`, `Community 222`, `Community 223`, `Community 227`, `Community 229`, `Community 230`, `Community 233`, `Community 1354`, `Community 1356`, `Community 909`, `Community 910`, `Community 911`, `Community 914`, `Community 928`, `Community 929`, `Community 930`, `Community 939`, `Community 427`, `Community 431`, `Community 433`, `Community 443`, `Community 444`, `Community 957`, `Community 446`, `Community 955`, `Community 960`, `Community 456`, `Community 457`, `Community 458`, `Community 459`, `Community 466`, `Community 467`, `Community 468`, `Community 978`, `Community 469`, `Community 1009`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 27` to `Community 130`, `Community 5`, `Community 12`, `Community 18`, `Community 20`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 152`, `Community 158`, `Community 32`, `Community 929`, `Community 33`, `Community 676`, `Community 932`, `Community 39`, `Community 40`, `Community 41`, `Community 43`, `Community 47`, `Community 432`, `Community 177`, `Community 441`, `Community 57`, `Community 61`, `Community 193`, `Community 195`, `Community 70`, `Community 200`, `Community 81`, `Community 995`, `Community 231`, `Community 107`, `Community 114`, `Community 126`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 33` to `Community 2`, `Community 131`, `Community 132`, `Community 11`, `Community 12`, `Community 14`, `Community 148`, `Community 20`, `Community 23`, `Community 24`, `Community 153`, `Community 26`, `Community 27`, `Community 154`, `Community 25`, `Community 32`, `Community 34`, `Community 37`, `Community 679`, `Community 169`, `Community 170`, `Community 43`, `Community 177`, `Community 434`, `Community 181`, `Community 61`, `Community 65`, `Community 66`, `Community 195`, `Community 77`, `Community 207`, `Community 83`, `Community 87`, `Community 1367`, `Community 228`, `Community 229`, `Community 103`, `Community 117`, `Community 126`?**
