# Graph Report - superpowers-20260713T182602-1d2ca422-goap-fusion-loop-runner-blackboard-conte  (2026-07-13)

## Corpus Check
- 844 files · ~952,766 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21199 nodes · 32573 edges · 1739 communities (1385 shown, 354 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8331 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `48ecfaa3`
...
8. `sleep()` - 95 edges
9. `arc42 Section 9 — Architecture Decisions` - 79 edges
10. `main()` - 78 edges
...
## Communities (1739 total, 354 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (100): main(), main(), containsAnyStr(), findChildByName(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords() (+92 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (142): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+134 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (142): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+134 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (109): TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch(), TestCountSelectors_Nested() (+101 more)
...
Cohesion: 0.04
Nodes (87): TestRunOnce_EmitsRunRootSpan(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), alwaysSampler, Attr (+79 more)
...
Cohesion: 0.05
Nodes (87): DefaultLLM(), RealLLM(), TestTauBenchBuiltinRetailAndDefaultEntries(), TestIsToolMatchVariants(), BuiltinBFCLV3(), EvaluateBFCLV3(), isToolMatch(), minInt() (+79 more)
...
Cohesion: 0.03
Nodes (79): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+71 more)
...
Cohesion: 0.06
Nodes (68): TestCheckConfidence_ConditionExists(), TestDefaultTree_NodeCount(), TestEvaluateTree_StructuralQualityRewardsUsefulContentMutations(), countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New() (+60 more)
...
Cohesion: 0.06
Nodes (53): perTreeStats(), setupGardener(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree(), TestEvolveTreeV2_WithRealTree(), TestMetricsTracker_BestFitnessTracking() (+45 more)
...
Cohesion: 0.07
Nodes (62): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), saveNlmQuotaExhausted() (+54 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (59): DefaultMock(), TestBuiltinSWELite_CoverageAndUniqueness(), TestMax1(), benchmarkPlanTree(), benchmarkSuccessTree(), TestBFCLV3LoadErrorsAndEmptyEvaluation(), TestBFCLV3LoadFlattenAndEvaluate(), TestBuiltinBFCLSuitesHaveStableShape() (+51 more)
...
Cohesion: 0.04
Nodes (35): cacheCheckAction(), cacheResultAction(), execRefineAction(), generatePlanAction(), NewEngine(), RegisterProviders(), TestCacheCheckAction_Empty(), TestCacheCheckAction_NoCachedData() (+27 more)
...
Cohesion: 0.06
Nodes (57): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection() (+49 more)
...
Cohesion: 0.05
Nodes (52): TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure(), TestNewGoTestTool_Structure(), TestNewGoVetTool_Structure(), TestNewGraphifyTool_Structure(), TestNewShellExecTool_Structure(), TestNewWebSearchTool_Structure() (+44 more)
...
Cohesion: 0.06
Nodes (14): Server, OpenAPIGenerator, Append(), mockTTOrch, Workflow, ValidateEdge(), SerializableNode, appendResurrectedTag() (+6 more)
...
Cohesion: 0.08
Nodes (42): init(), registerFinanceActions(), init(), registerGoDevActions(), init(), registerResearchActions(), init(), registerStockfishActions() (+34 more)
...
Cohesion: 0.07
Nodes (36): main(), NewPageAgent(), TestAgentLLMGeneration(), TestAgentMockFallback(), TestBubbleRecommendation(), NewHandler(), TestHandleBookmark(), TestHandleIntent() (+28 more)
...
Cohesion: 0.07
Nodes (25): TestRunJob_WebhookSpanJoinsRunTrace(), tracingMiddleware(), fanoutHandler, InitLogExport(), logExportTarget(), newTraceContextHandler(), TestInitLogExport_Idempotent(), TestLogExportTarget() (+17 more)
...
Cohesion: 0.11
Nodes (35): buildDeterministicImplementationPlan(), TestRunSuperpowersRuntime_NonRateLimitFailureSetsImplDegraded(), superpowersPlanAlreadyImplemented(), TestChangedPackagesLintCommandMirrorsHookGate(), TestResumeSkipsAlreadyImplementedPlan(), TestSuperpowersPlanAlreadyImplementedRequiresAllTasks(), TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull() (+27 more)
...
Cohesion: 0.08
Nodes (28): main(), BTStudioCompany(), main(), TestClient_AnalyzeComplexity_FallbackOnError(), TestClient_Generate_ConnectionRefused(), TestClient_GeneratePlan_FallbackOnError(), TestClient_Reflect_FallbackOnError(), TestDeepSeekClient_AnalyzeComplexity() (+20 more)
...
Cohesion: 0.1
Nodes (31): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionNoopPatchStreak(), goapFusionRepeatedHashBypassed(), init() (+23 more)
...
Cohesion: 0.08
Nodes (16): handleAgentCreate(), handleAgentDelete(), handleAlertRules(), handleLogin(), handleLogout(), handleMetricsLive(), handleOpenAPI(), handleScalability() (+8 more)
...
Cohesion: 0.08
Nodes (30): Binaries, code:go (type Counter struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }) (+22 more)

### Community 131 - "Community 131"
Cohesion: 0.09
Nodes (27): applyDotEnvFiles(), applyDotEnvToConfig(), applyEnvOverrides(), ApplyHITLPolicy(), Load(), LoadFile(), LoadFileWithDotEnv(), parseBool() (+19 more)
...
Cohesion: 0.11
Nodes (21): min(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), handleAnalyze(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState() (+13 more)
...
Cohesion: 0.16
Nodes (19): TestLocalSearcher_New(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing(), TestLocalSearch_TabuSearch() (+11 more)
...
Cohesion: 0.11
Nodes (14): init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), init(), init(), init(), registerSuperpowersConditions(), TestRegisterCondition_DuplicatePanics() (+6 more)
...
Cohesion: 0.17
Nodes (6): acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), cappedCells(), QTable
...
Cohesion: 0.15
Nodes (14): ExportedEvent, ExportedSpan, ConfigureOTLPFromEnv(), firstNonEmpty(), NewOTLPHTTPExporter(), otlpTracePayload(), parseOTLPHeaders(), stableHexID() (+6 more)
...
Cohesion: 0.2
Nodes (11): handleAgentExecute(), handleAgentRun(), handleSprintExecute(), handleTaskCreate(), DefaultAgentTask(), isAuctionShapedTask(), NewAgentExecutor(), PickTreeForTask() (+3 more)
...
Cohesion: 0.25
Nodes (8): code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), Package: evaluator, Package: monitoring, Package: startup, Package: thinktank
...
Cohesion: 0.33
Nodes (5): getHomeDir(), init(), NewTaskStore(), TestTaskStore_ApprovedOrdersByPriorityThenSprint(), TestTaskStore_ApproveRejectAuditPersistsAcrossSaveLoad()
...
## Knowledge Gaps
- **7184 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7179 more)
...
- **Why does `Append()` connect `Community 49` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 18`, `Community 21`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 543`, `Community 32`, `Community 544`, `Community 34`, `Community 547`, `Community 35`, `Community 549`, `Community 33`, `Community 39`, `Community 545`, `Community 38`, `Community 42`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 51`, `Community 52`, `Community 53`, `Community 566`, `Community 55`, `Community 56`, `Community 567`, `Community 58`, `Community 60`, `Community 62`, `Community 63`, `Community 64`, `Community 66`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 73`, `Community 74`, `Community 75`, `Community 77`, `Community 79`, `Community 80`, `Community 81`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 91`, `Community 92`, `Community 95`, `Community 101`, `Community 102`, `Community 104`, `Community 106`, `Community 108`, `Community 112`, `Community 114`, `Community 116`, `Community 117`, `Community 118`, `Community 119`, `Community 120`, `Community 125`, `Community 128`, `Community 131`, `Community 133`, `Community 141`, `Community 144`, `Community 146`, `Community 147`, `Community 153`, `Community 154`, `Community 155`, `Community 156`, `Community 159`, `Community 161`, `Community 173`, `Community 174`, `Community 175`, `Community 177`, `Community 178`, `Community 183`, `Community 187`, `Community 188`, `Community 189`, `Community 190`, `Community 191`, `Community 193`, `Community 198`, `Community 718`, `Community 206`, `Community 722`, `Community 723`, `Community 724`, `Community 213`, `Community 214`, `Community 743`, `Community 744`, `Community 745`, `Community 749`, `Community 769`, `Community 770`, `Community 772`, `Community 810`, `Community 360`, `Community 362`, `Community 364`, `Community 369`, `Community 370`, `Community 371`, `Community 373`, `Community 374`, `Community 375`, `Community 376`, `Community 377`, `Community 387`, `Community 391`, `Community 392`, `Community 393`, `Community 395`, `Community 990`, `Community 991`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 65` to `Community 0`, `Community 131`, `Community 4`, `Community 5`, `Community 8`, `Community 137`, `Community 14`, `Community 16`, `Community 19`, `Community 21`, `Community 22`, `Community 27`, `Community 38`, `Community 39`, `Community 40`, `Community 44`, `Community 47`, `Community 48`, `Community 51`, `Community 53`, `Community 57`, `Community 59`, `Community 61`, `Community 63`, `Community 193`, `Community 66`, `Community 67`, `Community 71`, `Community 201`, `Community 97`, `Community 104`, `Community 747`, `Community 369`, `Community 378`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 38` to `Community 4`, `Community 12`, `Community 140`, `Community 14`, `Community 15`, `Community 144`, `Community 19`, `Community 21`, `Community 22`, `Community 27`, `Community 35`, `Community 164`, `Community 42`, `Community 49`, `Community 179`, `Community 53`, `Community 183`, `Community 184`, `Community 188`, `Community 63`, `Community 65`, `Community 66`, `Community 1089`, `Community 71`, `Community 72`, `Community 200`, `Community 202`, `Community 201`, `Community 73`, `Community 88`, `Community 114`, `Community 120`, `Community 1022`?**
