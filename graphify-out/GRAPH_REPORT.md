# Graph Report - superpowers-20260718T064016-2cd90354-goap-fusion-loop-runner-blackboard-conte  (2026-07-18)

## Corpus Check
- 914 files · ~1,193,278 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26819 nodes · 39850 edges · 2078 communities (1714 shown, 364 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 9493 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `46202253`
...
1. `Append()` - 392 edges
2. `9. Architecture Decisions` - 166 edges
...
Cohesion: 0.02
Nodes (97): expandChainStateTemplates(), generateTemplateOutput(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError() (+89 more)
...
Cohesion: 0.04
Nodes (105): LoadPipeline(), RunPipeline(), RunPipelineWithID(), blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu() (+97 more)
...
Cohesion: 0.03
Nodes (34): AgentMetric, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts(), EvaluateAlerts(), EvaluateFromJSON() (+26 more)
...
Cohesion: 0.03
Nodes (106): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+98 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (93): dataFileMetrics(), extractExistingDataPath(), init(), inspectDataSource(), registerDomainActions(), brokenTool, ChainConfig, ChainKind (+85 more)
...
Cohesion: 0.05
Nodes (89): truncateGoap(), arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), collapseToSingleLine() (+81 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (82): TestRunOnce_EmitsRunRootSpan(), main(), alwaysSampler, Attr, TestConsoleTracer_ExporterReceivesCompletedSpan(), fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods() (+74 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (85): newProductionPopulation(), TestNewProductionPopulationAttachesSpecialists(), Duration(), TestDuration(), countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New() (+77 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (63): newAgentExecutor(), agentExecuteResult(), buildDashboardKnowledgeGraph(), dashboardLocalAgentResult(), getDashCBStore(), getHomeDir(), handleAgentCreate(), handleAgentDelete() (+55 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (73): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), Category, Compose() (+65 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (69): main(), BTStudioCompany(), requireOllamaFinanceTest(), runTeslaTree(), TestTeslaEarnings(), TestTeslaFullAnalysis(), TestTeslaMarket(), TestTeslaModel() (+61 more)
...
Cohesion: 0.03
Nodes (52): stringContains(), cacheCheckAction(), cacheResultAction(), execLLMCallAction(), execRefineAction(), generatePlanAction(), hasClearTaskCond(), knowledgeQueryAction() (+44 more)
...
Cohesion: 0.05
Nodes (80): TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip(), TestDeadLetterQueue_PreserveCategory() (+72 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (78): TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestBuildChainActionFn_LlmCallNilLLM(), TestBuildChainActionFn_UnknownChainType(), TestComputeSubtreeMetrics_MixedChildren(), TestComputeSubtreeMetrics_NilInput() (+70 more)
...
Cohesion: 0.06
Nodes (69): clearSuperpowersPlanState(), buildDeterministicDesign(), buildSuperpowersFinishReport(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), markGoapFusionImplDegraded(), registerSuperpowersProductionActions() (+61 more)
...
Cohesion: 0.07
Nodes (59): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+51 more)
...
Cohesion: 0.05
Nodes (44): TestOutcomeErrorDetail(), IsHealthyOutcome(), OutcomeErrorDetail(), TestLocalAgentResultNilResultAndSuccessPathsUnchanged(), TestLocalAgentResultPreservesOutcomeOnError(), attemptOutcomeError(), buildSchedulerConfig(), dlqReplayOutcomeError() (+36 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (46): Outcome, Record, FilterByTreeName(), Config, TestBaseNodeCount(), TestGetRetryCount(), TestIsNodeWrapped(), CycleMetrics (+38 more)
...
Cohesion: 0.05
Nodes (43): Blackboard, ChildTick, childTickLog, TestValidateOutputQuality_BlankResult(), TestValidateOutputQualityRejectsRefusals(), collectNames(), contains(), TestBlackboard_AllFields() (+35 more)

### Community 60 - "Community 60"
Cohesion: 0.06
Nodes (35): TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure(), TestBuildPlannerNode_ChainStateGoals(), errMockLLM, GoalDefinition, GOAPAction (+27 more)
...
Cohesion: 0.05
Nodes (38): CategorizedError, ErrorContext, ClassifyError(), contextDeadlineExceeded(), isAuthError(), isLLMError(), isNetworkError(), isRateLimitError() (+30 more)

### Community 66 - "Community 66"
Cohesion: 0.07
Nodes (42): UsersDir(), TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), automationApproved(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser() (+34 more)
...
Cohesion: 0.07
Nodes (45): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), TestIsGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation() (+37 more)
...
Cohesion: 0.1
Nodes (36): escalateFlaggedTreeForReview(), recordUserFeedback(), registerFeedbackTools(), newFeedbackDeps(), TestBTFeedbackRegistered(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), TestRecordUserFeedback_FeedsSatisfactionAndFlags(), TestRecordUserFeedback_RejectsBadInput() (+28 more)
...
Cohesion: 0.08
Nodes (29): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, Histogram, LabeledCounter, LabeledGauge (+21 more)
...
Cohesion: 0.12
Nodes (35): TestAction_ExecuteGoapStep_NoLLM(), TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), TestAction_PlanGoapActions_JSONActionsInvalidEntry(), TestAction_PlanGoapActions_NoPlanFound(), TestAction_PlanGoapActions_WithGoapConfig() (+27 more)

### Community 92 - "Community 92"
Cohesion: 0.09
Nodes (32): TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath(), TestDiscardWorktree_RemovesWorktreeAndDeletesBranch(), TestPushBranchAndCreatePR_InvokesGitPushAndGhPr(), withSwappedSuperpowersRunners(), newGrillLoopTestRun() (+24 more)
...
Cohesion: 0.08
Nodes (38): loadSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), saveSuperpowersPlanState(), buildDeterministicImplementationPlan(), defaultNlmGrillAuthGuard() (+30 more)
...
Cohesion: 0.09
Nodes (14): jaccardSimilarity(), TestJaccardSimilarity(), TestTokenize(), tokenize(), ExperienceBank, ExperienceEntry, containsStr(), hasNodeType() (+6 more)

### Community 101 - "Community 101"
Cohesion: 0.07
Nodes (33): Embedding, EmbeddingClient, CosineSimilarity(), TestBuildIndex_PanicRecovered(), TestCosineSimilarity_BothZero(), TestCosineSimilarity_DifferentLengths(), TestCosineSimilarity_Empty(), TestCosineSimilarity_Identical() (+25 more)
...
Cohesion: 0.15
Nodes (30): init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes(), TestBanditSelector_ConcurrentTicksNoLostOutcomesEnabled(), TestBanditSelector_DisabledMatchesSelectorSemantics(), TestBanditSelector_DisabledRunningChildRestartsAtZero() (+22 more)
...
Cohesion: 0.08
Nodes (19): attachLogHandler(), buildBaseHandler(), buildLogger(), envLogLevel(), Error(), Init(), L(), SetAsDefault() (+11 more)
...
Cohesion: 0.08
Nodes (31): init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), TestParseSplitOutput(), validateDesignAction(), validateDesignHeadings(), fakeGrillClaude, grillAnswerers (+23 more)
...
Cohesion: 0.09
Nodes (22): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, Provider, actionStatusString(), complexityRank() (+14 more)
...
Cohesion: 0.09
Nodes (28): Binaries, code:go (type Counter struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), code:go (type AgentCard struct { Name, Description, URL string }), code:go (type PlatformEvalResult struct { ... }) (+20 more)
...
Cohesion: 0.11
Nodes (14): TestClient_AnalyzeComplexity_High(), TestClient_Reflect_FallbackSections(), TestClient_Reflect_OnlyWentWell(), fakeSpan, fakeTracer, mockOllamaServer(), newTestClient(), TestClient_AnalyzeComplexity() (+6 more)
...
Cohesion: 0.09
Nodes (23): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), IsKnownChainKind(), parseChainConfig(), TestChainAction_ParseConfig(), TestIsKnownChainKind(), TestValidateTree_NestedChildren() (+15 more)
...
Cohesion: 0.13
Nodes (16): TestMatchBlockPattern(), AntiPattern, DesignPattern, BlockIDFromRef(), coreHeuristics(), knownAntiPatterns(), MatchBlockPattern(), NewExpertKnowledge() (+8 more)

### Community 216 - "Community 216"
Cohesion: 0.14
Nodes (11): NewServer(), NewPageAgent(), TestAgentLLMGeneration(), TestAgentMockFallback(), TestBubbleRecommendation(), NewHandler(), TestHandleBookmark(), TestHandleIntent() (+3 more)

### Community 217 - "Community 217"
Cohesion: 0.17
Nodes (15): min(), treeDiversityScore(), TestGenerateTemplateOutput_Arc42Section(), TestGenerateTemplateOutput_Arc42TitleNoNewline(), TestGenerateTemplateOutput_LongChainStateValue(), TestGenerateTemplateOutput_WithChainState(), TestNewGraphifyTool_UpdateWithArg(), TestNewGraphifyTool_UpdateDefault() (+7 more)
...
Cohesion: 0.18
Nodes (13): NewEvolvedAgent(), TestConfig_AllFields(), TestCreateAgentTool_Call_NilFactory(), TestEvolvedAgent_Run(), TestEvolvedAgent_Run_Error(), TestEvolvedAgent_Run_WithAutoEvolve(), TestEvolvedAgent_StructFields(), TestNewEvolvedAgent_AllToolsRegistered() (+5 more)
...
Cohesion: 0.15
Nodes (11): TestRecordUserFeedback_FlaggedForReviewEscalatesAndPausesAutomation(), TestRecordUserFeedback_FlaggedForReviewNoAutomationTracked(), ApplyHITLPolicy(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait(), stepContext(), HITLConfig (+3 more)
...
Cohesion: 0.17
Nodes (12): code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), Package: evaluator, Package: gardener (+4 more)
...
Cohesion: 0.29
Nodes (9): TestReflectTool_Call_NoLLM(), TestReflectTool_Call_WithLLM(), TestRunTaskTool_Call(), TestToolNames_And_Descriptions(), NewCreateAgentTool(), NewFitnessTool(), NewGetTreeTool(), NewReflectTool() (+1 more)
...
Cohesion: 0.22
Nodes (9): goapFusionImplementationGateWired(), goapFusionPreflightWired(), PrependGoapFusionPreflight(), spliceGoapFusionStateHashProducer(), WireGoapFusionLoopTree(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionPreflightPrependsToLoopSequence(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionWiresLoopTree(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionWiresLoopTreeIsIdempotent() (+1 more)
...
Cohesion: 0.29
Nodes (7): code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), code:go (type Workflow struct { ... }), Package: reflection, Package: validate, Package: workflow
...
## Knowledge Gaps
- **10528 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+10523 more)
...
- **Why does `Append()` connect `Community 10` to `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 1048`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 34`, `Community 36`, `Community 41`, `Community 42`, `Community 45`, `Community 46`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 56`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 67`, `Community 68`, `Community 69`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 76`, `Community 78`, `Community 79`, `Community 81`, `Community 82`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 89`, `Community 90`, `Community 93`, `Community 94`, `Community 99`, `Community 100`, `Community 102`, `Community 103`, `Community 105`, `Community 107`, `Community 108`, `Community 109`, `Community 112`, `Community 115`, `Community 116`, `Community 120`, `Community 125`, `Community 127`, `Community 128`, `Community 136`, `Community 137`, `Community 138`, `Community 139`, `Community 140`, `Community 144`, `Community 145`, `Community 149`, `Community 150`, `Community 151`, `Community 152`, `Community 153`, `Community 159`, `Community 160`, `Community 161`, `Community 165`, `Community 171`, `Community 172`, `Community 173`, `Community 177`, `Community 178`, `Community 179`, `Community 181`, `Community 186`, `Community 190`, `Community 194`, `Community 708`, `Community 712`, `Community 201`, `Community 202`, `Community 203`, `Community 204`, `Community 209`, `Community 210`, `Community 211`, `Community 213`, `Community 214`, `Community 729`, `Community 732`, `Community 220`, `Community 222`, `Community 1303`, `Community 444`, `Community 445`, `Community 959`, `Community 447`, `Community 448`, `Community 449`, `Community 459`, `Community 460`, `Community 462`, `Community 975`, `Community 980`, `Community 981`, `Community 472`, `Community 479`, `Community 998`, `Community 1002`, `Community 1004`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 49` to `Community 3`, `Community 1027`, `Community 6`, `Community 8`, `Community 141`, `Community 14`, `Community 17`, `Community 18`, `Community 147`, `Community 21`, `Community 23`, `Community 27`, `Community 29`, `Community 32`, `Community 38`, `Community 39`, `Community 42`, `Community 1067`, `Community 43`, `Community 45`, `Community 54`, `Community 56`, `Community 446`, `Community 66`, `Community 67`, `Community 71`, `Community 73`, `Community 75`, `Community 972`, `Community 204`, `Community 464`, `Community 81`, `Community 85`, `Community 473`, `Community 221`, `Community 98`, `Community 113`, `Community 119`, `Community 122`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 8` to `Community 3`, `Community 6`, `Community 10`, `Community 14`, `Community 18`, `Community 20`, `Community 152`, `Community 26`, `Community 27`, `Community 155`, `Community 157`, `Community 38`, `Community 167`, `Community 44`, `Community 49`, `Community 51`, `Community 56`, `Community 186`, `Community 192`, `Community 66`, `Community 195`, `Community 452`, `Community 71`, `Community 72`, `Community 73`, `Community 77`, `Community 78`, `Community 81`, `Community 83`, `Community 85`, `Community 215`, `Community 217`, `Community 94`, `Community 109`, `Community 127`?**
