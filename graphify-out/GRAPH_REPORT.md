# Graph Report - superpowers-20260715T174754-9a21d49e-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-15)

## Corpus Check
- 874 files · ~1,043,169 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23157 nodes · 35118 edges · 1874 communities (1519 shown, 355 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8773 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dc7fc205`
...
1. `Append()` - 392 edges
2. `DefaultTree()` - 149 edges
3. `NewRequest()` - 134 edges
4. `NewKnowledgeGraph()` - 131 edges
5. `registerMCPTools()` - 121 edges
6. `arc42 Section 9 — Architecture Decisions` - 117 edges
...
- `Append()` --calls--> `handleTrees()`  [INFERRED]
  internal/audit/audit.go → cmd/bt-dashboard/main.go
...
## Communities (1874 total, 355 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (169): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+161 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (169): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+161 more)
...
Cohesion: 0.03
Nodes (99): ApplyJitter(), ClassifyError(), contextDeadlineExceeded(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), FullJitter(), GetCategory() (+91 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (117): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+109 more)
...
Cohesion: 0.06
Nodes (92): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), buildClaudeReviewPrompt() (+84 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (90): handleLogin(), DefaultPanicHandler(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey (+82 more)
...
Cohesion: 0.08
Nodes (82): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+74 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (69): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewGoTestTool_Structure() (+61 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (78): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard() (+70 more)
...
Cohesion: 0.05
Nodes (77): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes() (+69 more)
...
Cohesion: 0.04
Nodes (20): History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), mockTTOrch, Workflow (+12 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (59): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, fakeClaude, fakeCommitRunner, hookFailureClass, applySuperpowersRunFromBareRepo() (+51 more)
...
Cohesion: 0.05
Nodes (67): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+59 more)
...
Cohesion: 0.05
Nodes (56): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+48 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (61): buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), registerSuperpowersProductionActions(), titleSuperpowersVerb() (+53 more)
...
Cohesion: 0.06
Nodes (51): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree() (+43 more)
...
Cohesion: 0.05
Nodes (46): GateResult, TestQualityGateFloorOn100Scale(), ListRevisions(), loadSnapshotIndex(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass() (+38 more)
...
Cohesion: 0.07
Nodes (53): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField() (+45 more)
...
Cohesion: 0.06
Nodes (42): DashboardRebuildTargets(), DefaultRebuildTargets(), main(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID() (+34 more)
...
Cohesion: 0.05
Nodes (34): agentExecuteResult(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay() (+26 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (41): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), parseChainConfig(), TestChainAction_ParseConfig(), readPostconditions() (+33 more)
...
Cohesion: 0.08
Nodes (18): extractTreeType(), TestExtractTreeType(), Individual, cloneTree(), containsCrisisReason(), Crossover(), ExperienceRetrievalHits(), hashTree() (+10 more)

### Community 48 - "Community 48"
Cohesion: 0.14
Nodes (44): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Research(), TestTree_Research() (+36 more)
...
Cohesion: 0.09
Nodes (48): TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback(), TestOrderMutations_LargeNodeCount_RecommendsPrune(), makeRecords(), TestCloneTree_Independent() (+40 more)
...
Cohesion: 0.07
Nodes (44): Approval, mockOrch, NewWorkflow(), sortTasks(), TestApproval_Fields(), TestApproveTask(), TestExecuteSprint(), TestExecuteSprint_ApprovedToCompleted() (+36 more)

### Community 53 - "Community 53"
Cohesion: 0.09
Nodes (43): NewAgent(), NewDocPlanner(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory(), TestAgentNoPlan() (+35 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (36): TestFileJobStore_AllowsEmptySaveOnFreshStore(), TestFileJobStore_AllowsLegitimateEmptyAfterOwnership(), TestFileJobStore_RefusesEmptyOverwriteFromBlindProcess(), TestReadOnlyJobStore_LoadsButNeverSaves(), NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath() (+28 more)
...
Cohesion: 0.08
Nodes (34): TestDriftWatchOnce_SkipsRestartWhenJobStartedMidRebuild(), TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestApplyJobScheduleRecomputesForNormalJob(), TestCrashedInFlightJobRunsImmediatelyAfterRestart() (+26 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (24): TestStartDriftWatcher_KickTriggersImmediateCheck(), StartDriftWatcher(), buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired() (+16 more)

### Community 60 - "Community 60"
Cohesion: 0.07
Nodes (30): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), ApplyHITLPolicy(), countTreeNodes(), TestSuperpowersPipelineSimulation() (+22 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (33): AntiPattern, countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype() (+25 more)
...
Cohesion: 0.09
Nodes (39): FitnessDimension, NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance(), TestNSGAII_Evolve_Basic(), TestNSGAII_FrontRank() (+31 more)

### Community 65 - "Community 65"
Cohesion: 0.11
Nodes (41): Duration(), TestDuration(), TestNewPopulation_Evolution(), TestPopulation_StatsAccessors(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve() (+33 more)
...
Cohesion: 0.08
Nodes (24): BlockConfig, ApplyDiffMutation(), DefaultBlockConfig(), findBlockForNode(), NewMetaPromptEvolver(), NewMutationContext(), TestApplyDiffMutation(), TestBlockConfig_FilterMutations() (+16 more)
...
Cohesion: 0.09
Nodes (40): fakeTracer, AlwaysSample(), hashTraceID(), NeverSample(), NewRatioSampler(), StringAttr(), TestAlwaysSample(), TestConsoleTracer_BasicSpan() (+32 more)
...
Cohesion: 0.12
Nodes (34): TestWalkValidate_DepthLimitExceeded(), TestWalkValidate_DestroySideEffectNoGate(), TestWalkValidate_ExternalSideEffectNoGate(), TestWalkValidate_HumanApprovalGateSetsFlag(), TestWalkValidate_KnownNodeTypePasses(), TestWalkValidate_MaxRetriesLimitExceeded(), TestWalkValidate_NilNode(), TestWalkValidate_NodeCountLimitExceeded() (+26 more)
...
Cohesion: 0.11
Nodes (24): CompanyOrchestrator, EngineerTree(), MarketingTree(), SalesTree(), StartupTrees(), clamp(), safeDiv(), CEOTree() (+16 more)
...
Cohesion: 0.09
Nodes (26): biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), TestBiasCandidatesWithExperience_NilOrEmptyBankKeepsOrder(), TestCloneTreeForGardener_Basic() (+18 more)
...
Cohesion: 0.11
Nodes (24): chargeGoapResearchGoalFailure(), goapAbandonedResearchGoal(), goapGoalFailureNote(), goapResearchGoalKey(), isolateGoapProgramStore(), reloadGoalBudget(), seedGoalBudget(), TestBuildGoalDrivenPlan_InjectsPreviousFailureNote() (+16 more)

### Community 111 - "Community 111"
Cohesion: 0.13
Nodes (29): TestBrainstormExpansionAcceptedWhenDeeper(), TestBrainstormNotCalledWhenPlanAlreadyFull(), TestBrainstormRejectedWhenFilesNotGoPath(), TestBrainstormRejectedWhenMalformedOrProse(), TestBrainstormRejectedWhenNotDeeper(), TestBrainstormRejectedWhenRunOmitsShort(), withBrainstorm(), brainstormExpandPlan() (+21 more)
...
Cohesion: 0.1
Nodes (28): TraceParent, ContextWithTraceParent(), ExtractTraceParentFromRequest(), ExtractTraceStateFromRequest(), GenerateSpanID(), GenerateTraceID(), GenerateTraceParent(), isHex() (+20 more)

### Community 115 - "Community 115"
Cohesion: 0.08
Nodes (25): TestRunOnce_EmitsRunRootSpan(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan(), alwaysSampler, Attr (+17 more)
...
Cohesion: 0.13
Nodes (15): MaxDepth(), hasExecutionPathFirst(), hasUnboundedRetry(), NewMetaValidator(), hasMetaIssue(), TestMetaValidator_AcceptsDefaultTree(), TestMetaValidator_RejectsBrokenStructure(), TestMetaValidator_RejectsFitnessRegression() (+7 more)
...
Cohesion: 0.11
Nodes (25): NewCatalog(), TestCatalog_Export(), TestCatalog_ListInstalled(), TestCatalog_ListTemplates(), TestCatalog_Search(), TestCatalog_SkillToAgent(), TestInferTree(), TestCatalog_EmptyTemplates() (+17 more)
...
Cohesion: 0.13
Nodes (24): NewMockLLM(), NewDefaultCompany(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary(), testLLM(), TestNewDefaultCompany_Values() (+16 more)

### Community 130 - "Community 130"
Cohesion: 0.08
Nodes (31): Binaries, code:go (type Counter struct { ... }), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) () (+23 more)
...
Cohesion: 0.11
Nodes (23): TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath(), TestDiscardWorktree_RemovesWorktreeAndDeletesBranch(), TestPushBranchAndCreatePR_InvokesGitPushAndGhPr(), withSwappedSuperpowersRunners(), TestRunSuperpowersRuntime_NonRateLimitFailureSetsImplDegraded() (+15 more)

### Community 139 - "Community 139"
Cohesion: 0.15
Nodes (29): CompressionMiddleware(), gzipDecompress(), TestCompressionMiddleware_AlreadyCompressed(), TestCompressionMiddleware_BinaryContentType(), TestCompressionMiddleware_EmptyBody(), TestCompressionMiddleware_GzipRequest(), TestCompressionMiddleware_HTMLContentType(), TestCompressionMiddleware_LargeJSONResponse() (+21 more)
...
Cohesion: 0.09
Nodes (19): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus() (+11 more)

### Community 143 - "Community 143"
Cohesion: 0.1
Nodes (25): TestNewReinforcementLearner(), TestEvolveWithExperience_ResurrectsExtinctSpecialist(), TestQTableSelectUpdateBestAction(), TestQTableStateBucketsAndDepth(), TestReinforcementLearnerLearnAndSuggest(), NewQTable(), NewReinforcementLearner(), TestExpertKnowledge_ObservesLearnedPatternFromQLearning() (+17 more)
...
Cohesion: 0.12
Nodes (19): AgentMetrics, AgentStats, BuildIdentity, Gauge, HealthResponse, LabeledGauge, formatPromLabels(), GetAgentMetrics() (+11 more)
...
Cohesion: 0.11
Nodes (21): min(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section() (+13 more)
...
Cohesion: 0.12
Nodes (16): injectPersonaContext(), mineUserPatterns(), personaEmbedder(), personaError(), recordPersonaInteraction(), registerPersonaTools(), NewHabitMiner(), Interaction (+8 more)
...
Cohesion: 0.18
Nodes (19): TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing() (+11 more)
...
Cohesion: 0.1
Nodes (12): ErrorCategory, ExecuteWithPolicy(), sleepWithContext(), TestErrorCategory_String(), TestRetryPolicy_ExecuteWithPolicy(), RateLimitError, Backoff(), RetryWithBackoff() (+4 more)
...
Cohesion: 0.19
Nodes (6): acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), cappedCells(), cappedIndividuals()
...
Cohesion: 0.15
Nodes (11): buildStampLdflags(), copyFile(), defaultRebuildBuild(), NewRebuildBackoff(), RebuildBinaries(), resolveGoBinary(), TestBuildStampLdflagsInRepo(), TestBuildStampLdflagsNonGitDir() (+3 more)
...
Cohesion: 0.16
Nodes (14): ClaudeRunner, CommandResult, CommandRunner, execClaudeRunner, execCommandRunner, resolvedSuperpowersClaudeModel(), captureExecClaudeArgs(), captureRunnerClaudeArgs() (+6 more)
...
Cohesion: 0.12
Nodes (17): code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), code:go (type Tool struct { ... }), code:go (type AgentCard struct { Name, Description, URL string }), code:go (type PlatformEvalResult struct { ... }), code:go (type BaselineStore struct { ... }), code:go (type WorkflowReport struct { ... }) (+9 more)
...
Cohesion: 0.12
Nodes (16): 8.10 Autonomous Landing Pipeline, 8.11 Observability, 8.12 A2A Auction Task Allocation, 8.13 Leaf-Node Structural Validation, 8.14 Fleet-Wide Node Description Coverage, 8.15 Validation-Gated Composition Activation, 8.1 Behavior Tree Execution Model, 8.2 ChainAction Nodes (+8 more)
...
Cohesion: 0.14
Nodes (13): code:go (sel("Phase1_Design",), code:markdown (### Task N: Title), code:go (func SuperpowersPipelineTree() *evolution.SerializableNode {), code:yaml (name: superpowers-prod-runner), code:go (// Deprecated: use ExecuteSuperpowersTaskBatch.), Current Stub Surface To Replace, Done Definition, Migration / Cleanup Notes (+5 more)
...
Cohesion: 0.2
Nodes (10): TestExtractDuckDuckGoResults_EmptyHTML(), TestExtractDuckDuckGoResults_FallbackToLinks(), TestExtractDuckDuckGoResults_NoResults(), TestExtractDuckDuckGoResults_ValidHTML(), TestExtractDuckDuckGoResults_FallbackResultA(), TestExtractDuckDuckGoResults_ManyResults(), TestExtractDuckDuckGoResults_MultipleResults(), TestExtractDuckDuckGoResults_NoMatches() (+2 more)
...
Cohesion: 0.22
Nodes (4): FileJobStore, JobStore, NewReadOnlyJobStore(), ReadOnlyJobStore
...
## Knowledge Gaps
- **8332 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8327 more)
...
- **Why does `Append()` connect `Community 20` to `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 25`, `Community 26`, `Community 28`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 39`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 46`, `Community 47`, `Community 48`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 59`, `Community 61`, `Community 62`, `Community 64`, `Community 67`, `Community 68`, `Community 69`, `Community 71`, `Community 72`, `Community 74`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 94`, `Community 96`, `Community 102`, `Community 103`, `Community 105`, `Community 620`, `Community 109`, `Community 112`, `Community 114`, `Community 115`, `Community 626`, `Community 628`, `Community 118`, `Community 119`, `Community 120`, `Community 121`, `Community 629`, `Community 123`, `Community 125`, `Community 126`, `Community 128`, `Community 1154`, `Community 644`, `Community 646`, `Community 137`, `Community 653`, `Community 141`, `Community 143`, `Community 145`, `Community 149`, `Community 153`, `Community 154`, `Community 157`, `Community 158`, `Community 159`, `Community 167`, `Community 168`, `Community 170`, `Community 171`, `Community 173`, `Community 178`, `Community 183`, `Community 188`, `Community 191`, `Community 198`, `Community 200`, `Community 207`, `Community 208`, `Community 209`, `Community 210`, `Community 218`, `Community 219`, `Community 222`, `Community 223`, `Community 226`, `Community 834`, `Community 835`, `Community 836`, `Community 838`, `Community 859`, `Community 861`, `Community 878`, `Community 883`, `Community 885`, `Community 888`, `Community 399`, `Community 400`, `Community 401`, `Community 405`, `Community 407`, `Community 408`, `Community 409`, `Community 419`, `Community 421`, `Community 423`, `Community 424`, `Community 425`, `Community 433`, `Community 435`, `Community 436`, `Community 437`, `Community 444`, `Community 445`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 18` to `Community 128`, `Community 129`, `Community 2`, `Community 12`, `Community 13`, `Community 143`, `Community 145`, `Community 20`, `Community 150`, `Community 23`, `Community 410`, `Community 28`, `Community 161`, `Community 34`, `Community 41`, `Community 47`, `Community 176`, `Community 49`, `Community 50`, `Community 51`, `Community 48`, `Community 54`, `Community 56`, `Community 61`, `Community 63`, `Community 64`, `Community 65`, `Community 68`, `Community 1229`, `Community 206`, `Community 85`, `Community 220`, `Community 100`, `Community 122`, `Community 126`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 49` to `Community 2`, `Community 132`, `Community 4`, `Community 13`, `Community 142`, `Community 14`, `Community 16`, `Community 18`, `Community 404`, `Community 148`, `Community 406`, `Community 23`, `Community 918`, `Community 27`, `Community 415`, `Community 34`, `Community 35`, `Community 38`, `Community 41`, `Community 432`, `Community 50`, `Community 51`, `Community 54`, `Community 58`, `Community 187`, `Community 60`, `Community 59`, `Community 191`, `Community 65`, `Community 70`, `Community 80`, `Community 852`, `Community 219`, `Community 220`, `Community 98`, `Community 227`, `Community 122`?**
...
- **Are the 148 inferred relationships involving `DefaultTree()` (e.g. with `TestFullTreeIntegration_RunsAllTreesWithRealLLM()` and `TestDomainTree_Registration()`) actually correct?**
  _`DefaultTree()` has 148 INFERRED edges - model-reasoned connections that need verification._
- **Are the 133 inferred relationships involving `NewRequest()` (e.g. with `TestHITLHandlers_PendingApproveReject()` and `WorkflowApprovalWait()`) actually correct?**
  _`NewRequest()` has 133 INFERRED edges - model-reasoned connections that need verification._