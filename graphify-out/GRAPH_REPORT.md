# Graph Report - superpowers-20260716T133616-c1dd1087-goap-fusion-loop-runner-blackboard-conte  (2026-07-16)

## Corpus Check
- 893 files · ~1,090,928 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24170 nodes · 36539 edges · 1925 communities (1569 shown, 356 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 9052 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `19bbae6c`
...
6. `arc42 Section 9 — Architecture Decisions` - 133 edges
...
## Communities (1925 total, 356 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (182): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+174 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (182): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+174 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (112): TestComputeAnalytics_BottleneckCarriesStructuredFailure(), TestComputeAnalytics_Bottlenecks(), TestComputeAnalytics_BottleneckWithoutTraceHasEmptyFailure(), TestComputeAnalytics_BottleneckWithTrace(), TestComputeAnalytics_Centrality(), TestComputeAnalytics_CoverageGapsUseExpectedDomains(), TestComputeAnalytics_EmptyGraph(), TestComputeAnalytics_ExtendedEdges() (+104 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (106): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+98 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (133): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+125 more)
...
Cohesion: 0.04
Nodes (103): TestDeprecatedHandler_NoSunset(), TestDeprecatedHandler_WithSunsetDate(), DeprecatedHandler(), TestDeprecatedHandler_WithoutSunset(), TestDeprecatedHandler_WithSunset(), NewRequest(), auditKey, bearerPrincipalKey (+95 more)
...
Cohesion: 0.04
Nodes (91): saveGoapFusionStateHashes(), TestRunScheduledGoapFusionLoop_RunawayBackstopIsHalfOpen(), arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), newLoopBB(), TestClearGoapFusionStateHashes() (+83 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (93): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+85 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (97): ABDelta, ABTest, absDiff(), AgentMonitorSuite(), AlertRouterSuite(), AnnotateMetrics(), Arc42Suite(), BootstrapCI() (+89 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (91): echoTaskLeaf, mcpDeps, addFailureContext(), benchmarkGateEvolvedWinner(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree(), evolveHealthProjection() (+83 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (86): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard() (+78 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (75): ApplyJitter(), DecorrelatedJitter(), DefaultRetryPolicy(), EqualJitter(), FullJitter(), GetCategory(), GetErrorContext(), NewCategorizedError() (+67 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (88): handleScalability(), TestHandleScalability_ReflectsInjectedQueueAndRouter(), biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip() (+80 more)
...
Cohesion: 0.03
Nodes (54): stringContains(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_PlanGoapActions_WrongActionsType(), cacheCheckAction(), cacheResultAction(), execLLMCallAction(), execRefineAction(), generatePlanAction() (+46 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (77): Duration(), TestTranspositionTable_SaveLoadRoundTrip(), TestTranspositionTable_Store_EvictionPreservesLowestAmongSurvivors(), TestTranspositionTable_Store_EvictsLowestValueDeterministically(), TestTranspositionTable_Store_EvictsLowestValueRepeated(), TestTranspositionTable_StoreProbeMiss(), TestTranspositionTable_StoreProbeRoundTrip(), countTreeNodes() (+69 more)
...
Cohesion: 0.05
Nodes (63): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+55 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (58): main(), main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview() (+50 more)
...
Cohesion: 0.06
Nodes (66): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+58 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (54): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), ComposeTaskTreeAgentic() (+46 more)
...
Cohesion: 0.05
Nodes (59): init(), parseSplitOutput(), registerSuperpowersDesignLoopActions(), newGrillLoopTestRun(), TestGrillDesign_ApprovedWhenNoOpenCriticals(), TestGrillDesign_NeedsWorkWithFeedbackWhenCriticalsOpen(), TestGrillDesign_NoProgressBreakerFailsAfterTwoStaleRounds(), TestGrillDesign_RefusesRoundsBeyondBound() (+51 more)
...
Cohesion: 0.07
Nodes (61): TestConsoleTracer_ExporterReceivesCompletedSpan(), fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest() (+53 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (36): WorkflowsDir(), TestGoalFactory(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree() (+28 more)
...
Cohesion: 0.09
Nodes (56): DefaultLLM(), RealLLM(), TestDetectPath_FromCurrentPath(), TestDetectPath_FromVisitedPaths(), TestDetectPath_KeywordFallback(), BuiltinBFCLV3(), EvaluateBFCLV3(), minInt() (+48 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (42): CategorizedError, ErrorCategory, ErrorContext, ClassifyError(), contextDeadlineExceeded(), ExecuteWithPolicy(), isAuthError(), isLLMError() (+34 more)

### Community 48 - "Community 48"
Cohesion: 0.16
Nodes (51): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+43 more)

### Community 49 - "Community 49"
Cohesion: 0.12
Nodes (47): TestDomainTree_Registration(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), HermesSelfEvolutionTree(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+39 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (36): NewAuctioneer(), cardWithURL(), newAuctionTransport(), newDeadlineProbeTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoCandidatesFallsBack(), TestAuctionDelegate_NoEligibleBidsFallsBack() (+28 more)
...
Cohesion: 0.06
Nodes (40): GateResult, TestQualityGateFloorOn100Scale(), ListRevisions(), loadSnapshotIndex(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass() (+32 more)
...
Cohesion: 0.06
Nodes (36): TestOutcomeErrorDetail(), FeedbackFile(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath() (+28 more)
...
Cohesion: 0.07
Nodes (37): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, applySuperpowersRunFromBareRepo(), applySuperpowersRunToMainRepo(), bareTestRun(), TestApplySuperpowersRunBareRepoRefusedFastForwardParksPendingPatch() (+29 more)
...
Cohesion: 0.08
Nodes (36): NewAgent(), TestAutomationActions_ReachTaskAutomated(), assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory(), TestAgentNoPlan() (+28 more)
...
Cohesion: 0.06
Nodes (30): ActionFunc, ActionProvider, ConditionFunc, ConditionProvider, Engine, TestVerifyNotebookLMEvidenceAcceptsRealNotebookPayload(), TestVerifyNotebookLMEvidenceRejectsEmptyOrUngroundedSuccess(), TestVerifyNotebookLMEvidenceRejectsFabricatedOutput() (+22 more)
...
Cohesion: 0.11
Nodes (35): TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), TestAction_PlanGoapActions_JSONActionsInvalidEntry(), TestAction_PlanGoapActions_NoPlanFound(), TestAction_PlanGoapActions_WithGoapConfig(), TestAction_PlanGoapActions_WorldStateFromTask() (+27 more)
...
Cohesion: 0.06
Nodes (22): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), TestBuildGardenerConfig_TranspositionTableWired(), wireSelectorOrdering(), GardenerDeactivateAllTool (+14 more)
...
Cohesion: 0.07
Nodes (24): exportMemoryCategory(), exportPreviousRuns(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), HistoryDir(), HomeDir(), JobsDir() (+16 more)
...
Cohesion: 0.08
Nodes (32): resolverReachableExtraDomainTrees(), singleTaskSuite(), tasksForTree(), TestAgentMonitor(), TestAllDomainTreeConditionsHaveDescriptions(), TestAllDomainTreeNodesHaveDescriptions(), TestAllDomainTrees(), TestAllDomainTreeSelectorsHaveDescriptions() (+24 more)

### Community 96 - "Community 96"
Cohesion: 0.06
Nodes (15): alwaysSampler, Attr, ConsoleTracer, neverSampler, noopSpan, noopTracer, RatioSampler, Sampler (+7 more)
...
Cohesion: 0.09
Nodes (29): ptr(), TestBlockMutationsInsert(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), init(), ApplyBlockMutations(), blockIDFromOp() (+21 more)
...
Cohesion: 0.08
Nodes (26): Block, TestComposeAndExpand(), Category, composeOrderedWithMiddle(), ComposePreset(), ComposePresetWithTools(), ListToolProfileBlocks(), PipelineWithToolsProfile() (+18 more)
...
Cohesion: 0.11
Nodes (27): NewHistory(), TestScheduler_RemoveNonexistent(), TestScheduler_UnknownAgent(), TestRunJob_WarnsOnDeployDriftAtCycleComplete(), TestRunJob_WebhookIncludesBuildRevision(), TestRunJobStampsFailureOutcomeWhenRetryExhaustionLeavesItEmpty(), NewScheduler(), decodeRunCount() (+19 more)
...
Cohesion: 0.09
Nodes (18): UsersDir(), TestResolveGeneratedTree_EndToEnd(), TestResolveGeneratedTree_UserWorkspaceFallback(), init(), ReflectionsPath(), ResolveGeneratedTree(), ResolveGeneratedTreeForUser(), resolveUserTree() (+10 more)

### Community 120 - "Community 120"
Cohesion: 0.1
Nodes (24): TestCheckConfidence_ConditionExists(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure(), TestMutation_AddAfter() (+16 more)
...
Cohesion: 0.11
Nodes (17): BTOptimizer, collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestExtractCondition(), TestSplitCamelCase(), isDefaultPath() (+9 more)
...
Cohesion: 0.1
Nodes (29): goapFusionNoopPatchStreak(), defaultNlmGrillAuthGuard(), nlmGrillAnswerer(), nlmGrillUnavailable(), parseNumberedAnswers(), runGrillAuthGuardAction(), TestGoapFusionNoopPatchStreak_DurableAcrossCronTicks(), TestGoapFusionNoopPatchStreak_IncrementsOnNoopResetsOnChange() (+21 more)
...
Cohesion: 0.11
Nodes (23): min(), minInt(), TestExportPreviousRuns(), TestSeedMemoryToBlackboard_HistoryOffloaded(), treeDiversityScore(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState() (+15 more)
...
Cohesion: 0.09
Nodes (19): TestAdoptDriftOnIdle_AdoptsSynchronously(), TestAdoptDriftOnIdle_SwallowsErrors(), AdoptDriftOnIdle(), AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce() (+11 more)
...
Cohesion: 0.11
Nodes (12): main(), NewPageAgent(), TestAgentLLMGeneration(), TestAgentMockFallback(), TestBubbleRecommendation(), NewHandler(), TestHandleBookmark(), TestHandleIntent() (+4 more)
...
Cohesion: 0.15
Nodes (21): fakeClaude, fakeCommitRunner, hookFailureClass, runVerificationPassed(), stageAndCommitSuperpowersRunInDir(), writeApplyCommitEvidence(), applyDeterministicCommitFixes(), buildCommitFixPrompt() (+13 more)
...
Cohesion: 0.13
Nodes (14): handleWorkflowRunFullPipeline(), TestHandleWorkflowRunFullPipeline_PersistsWorkflowAndTasks(), NewMockLLM(), mockLLM, NewThinkTank(), TestFullAnalysis_MultipleTopics(), TestNewThinkTank(), TestOrchestrator_Debate() (+6 more)
...
Cohesion: 0.12
Nodes (20): Warn(), biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), lastFailureTask(), serializeTreeForGardener() (+12 more)
...
Cohesion: 0.14
Nodes (21): TestSelectorOptimizer_New(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb() (+13 more)
...
Cohesion: 0.12
Nodes (21): circuitBreakerCmd, errorAwareCmd, init(), registerReliabilityNodes(), buildCircuitBreaker(), buildTimeout(), circuitBreakerFor(), cooldownFromNode() (+13 more)
...
Cohesion: 0.14
Nodes (22): TestTauBenchBuiltinRetailAndDefaultEntries(), airlineTools(), buildTauBenchTask(), BuiltinTauBenchAirline(), BuiltinTauBenchRetail(), DefaultTauBenchEntries(), LoadTauBenchTasks(), matchActions() (+14 more)
...
Cohesion: 0.16
Nodes (19): TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), ApplyHITLPolicy(), TestHumanApprovalGate_AutoApprove(), TestHumanApprovalGate_ManualApprove(), TestHumanApprovalGate_PostPhase() (+11 more)
...
Cohesion: 0.12
Nodes (16): defaultDriftHead(), scrubGitEnv(), buildStampLdflags(), copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), defaultRebuildMaterialize(), DefaultRebuildTargets() (+8 more)
...
Cohesion: 0.23
Nodes (20): ScoreAnnouncement(), SetTreeResolver(), bidArtifact(), drainExecute(), eventKinds(), executorForAgent(), skillCard(), terminalState() (+12 more)
...
Cohesion: 0.28
Nodes (21): swapErrorHandlerRunner(), TestRequestErrorHandlerProposal_RespectsCallerContext(), TestRequestErrorHandlerProposal_StampsLedgerOnEveryOutcome(), ehTestHandlerNode(), ehTestProposalJSON(), init(), runHandler(), TestClaudeErrorHandler_BuildSwitchAndValidation() (+13 more)
...
Cohesion: 0.18
Nodes (18): TestBTOptimizer_New(), TestFindMainSelector(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), NewBTOptimizer(), NewDTAnalyzer(), pathStat() (+10 more)
...
Cohesion: 0.12
Nodes (8): agentNameInterceptor, agentNameKey, BTAgentExecutor, cardResponder, Server, NewServer(), parseAnnouncement(), RespondToAnnouncement()
...
Cohesion: 0.13
Nodes (13): TestRunJob_KicksOnCycleIdleWhenQueueEmpty(), TestRunJob_NoIdleKickWhileAnotherJobInFlight(), RegistryDir(), TestPathHelpers(), newCatchupFixture(), TestReconcileWithRegistry_EmptyRegistryPreservesJobs(), TestSchedule_PreservesCrashRecoveryImmediateRun(), TestSchedule_PreservesMissedNextRunForCatchUp() (+5 more)
...
Cohesion: 0.19
Nodes (13): NewOpenAICompatClient(), TestOpenAICompat_ErrorResponse(), TestOpenAICompat_GenerateWithModel_SendsChatCompletion(), rateLimitedServer(), TestDeepSeek_429ReturnsRateLimitError(), TestErrorRecorder_PrefersRateLimitError(), TestErrorRecorder_RecordsLastError(), TestFallbackLLM_PreservesRateLimitErrorChain() (+5 more)
...
Cohesion: 0.13
Nodes (9): handleAnalyze(), handleTrees(), TestCurrentWorkflow_GuardedByMutex(), TestDashboardAPIRoutesHaveOpenAPICoverage(), TestHandleAgentExecute_SetsQualityScoreFromRunResult(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation(), TestHandleDLQReplay_RequeuesInsteadOfDropping() (+1 more)
...
Cohesion: 0.26
Nodes (11): BuiltinToolBench(), EvaluateToolBench(), formatAvailableAPIs(), TestToolBench_APISelection(), TestToolBench_EmptyEntries(), TestToolBench_IndividualEntries(), ToolBenchAPI, ToolBenchEntry (+3 more)

### Community 643 - "Community 643"
Cohesion: 0.25
Nodes (12): mcpErr(), registerBlockTools(), resolveStrategyTree(), blockOnHeldBBMu(), blockOnHeldServerLock(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestBTBlocksComposeSaveHoldsBBMu() (+4 more)
...
Cohesion: 0.27
Nodes (6): NewFallbackLLM(), TestFallbackLLM_GenerateAllPanicReturnsAggregatedError(), TestFallbackLLM_GenerateRecoversPanicAndTriesNextModel(), TestFallbackLLM_GenerateReturnsAllFailures(), TestFallbackLLM_GenerateUsesNextModelAfterPrimaryFailure(), stubLLM
...
Cohesion: 0.25
Nodes (3): TestBuildDelegateBlockTree(), countTreeNodes(), TestSuperpowersPipelineSimulation()
...
Cohesion: 0.53
Nodes (5): EngineerTree(), MarketingTree(), SalesTree(), StartupTrees(), TestStartupTrees()
...
Cohesion: 0.5
Nodes (4): agentTemplateYAML, findRepoTemplatesDir(), TestAllTemplatesResolveTree(), TestResolveTreeID_SuperpowersPipeline()
...
## Knowledge Gaps
- **8900 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+8895 more)
...
- **Why does `Append()` connect `Community 32` to `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 30`, `Community 33`, `Community 36`, `Community 37`, `Community 39`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 46`, `Community 49`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 60`, `Community 62`, `Community 63`, `Community 64`, `Community 65`, `Community 68`, `Community 70`, `Community 72`, `Community 73`, `Community 74`, `Community 76`, `Community 78`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 85`, `Community 87`, `Community 88`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 102`, `Community 103`, `Community 109`, `Community 110`, `Community 116`, `Community 117`, `Community 120`, `Community 124`, `Community 125`, `Community 126`, `Community 640`, `Community 641`, `Community 129`, `Community 644`, `Community 134`, `Community 648`, `Community 650`, `Community 138`, `Community 142`, `Community 148`, `Community 662`, `Community 663`, `Community 154`, `Community 669`, `Community 670`, `Community 159`, `Community 162`, `Community 164`, `Community 166`, `Community 169`, `Community 170`, `Community 173`, `Community 174`, `Community 180`, `Community 187`, `Community 191`, `Community 193`, `Community 198`, `Community 200`, `Community 202`, `Community 204`, `Community 210`, `Community 211`, `Community 212`, `Community 214`, `Community 216`, `Community 218`, `Community 219`, `Community 220`, `Community 221`, `Community 222`, `Community 224`, `Community 863`, `Community 870`, `Community 887`, `Community 888`, `Community 902`, `Community 916`, `Community 918`, `Community 412`, `Community 413`, `Community 414`, `Community 924`, `Community 415`, `Community 423`, `Community 424`, `Community 426`, `Community 437`, `Community 439`, `Community 440`, `Community 441`, `Community 443`, `Community 445`, `Community 448`, `Community 449`, `Community 451`, `Community 964`, `Community 453`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 58` to `Community 128`, `Community 2`, `Community 3`, `Community 141`, `Community 13`, `Community 15`, `Community 16`, `Community 19`, `Community 22`, `Community 23`, `Community 25`, `Community 28`, `Community 168`, `Community 169`, `Community 42`, `Community 41`, `Community 45`, `Community 48`, `Community 183`, `Community 184`, `Community 442`, `Community 187`, `Community 956`, `Community 188`, `Community 62`, `Community 193`, `Community 71`, `Community 200`, `Community 201`, `Community 77`, `Community 206`, `Community 90`, `Community 223`, `Community 105`, `Community 112`, `Community 118`, `Community 119`, `Community 890`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 154` to `Community 2`, `Community 130`, `Community 900`, `Community 7`, `Community 136`, `Community 137`, `Community 141`, `Community 16`, `Community 148`, `Community 22`, `Community 23`, `Community 155`, `Community 28`, `Community 31`, `Community 160`, `Community 165`, `Community 168`, `Community 169`, `Community 42`, `Community 41`, `Community 173`, `Community 52`, `Community 183`, `Community 184`, `Community 442`, `Community 59`, `Community 188`, `Community 193`, `Community 66`, `Community 76`, `Community 214`, `Community 97`, `Community 108`, `Community 118`?**
