# Graph Report - superpowers-20260713T114224-10851188-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-13)

## Corpus Check
- 838 files · ~940,698 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20702 nodes · 32033 edges · 1707 communities (1345 shown, 362 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8298 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `14417eb1`
...
## Communities (1707 total, 362 thin omitted)
...
Cohesion: 0.01
Nodes (134): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+126 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (134): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+126 more)
...
Cohesion: 0.03
Nodes (76): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+68 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (83): TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestScoreChild_GoalAlignmentBranch(), TestScoreChild_NilChainState(), TestScoreChildren_BasicRanking(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure() (+75 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (82): main(), main(), TestBlackboard_AllFields(), TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails(), TestRunTask_Success(), TestIntegration_ReflectionAndPersistence(), reflectOnOutcomeAction() (+74 more)
...
Cohesion: 0.05
Nodes (82): biddingExecutor, TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip(), TestDeadLetterQueue_PreserveCategory(), NewAgentRouter() (+74 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (52): findChildByName(), TestAssignComplexityAction_NoLLM_DefaultsMedium(), TestAssignComplexityAction_NoLLM_HeuristicHigh(), TestAssignComplexityAction_WithLLM(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords() (+44 more)
...
Cohesion: 0.05
Nodes (50): Config, diffSecretField(), Duration(), TestDuration(), TestStoreSaveCompactsTerminalRecords(), AggregatedTrace, buildAggregatedTrace(), NewTraceReader() (+42 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (54): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), registerHITLTools(), resolveTree(), agentTemplateYAML (+46 more)
...
Cohesion: 0.07
Nodes (63): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), TestNlmQuotaState_PersistsAcrossRuns() (+55 more)
...
Cohesion: 0.03
Nodes (69): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+61 more)
...
Cohesion: 0.07
Nodes (60): fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest(), TestTracingMiddleware_StatusCodes() (+52 more)

### Community 41 - "Community 41"
Cohesion: 0.07
Nodes (40): References, handleMetricsLive(), Collect(), indexOf(), GoapFusionPreflightNode(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedDelegatesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionBuildTreeMaterializedMaterializesOnBareRepo(), TestSuperpowersRuntime_ActionsRegistered_ScheduledGoapFusionCircuitBreakerHalts() (+32 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (37): TestMatchBlockPattern(), AntiPattern, TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_ValidateArchetype(), DesignPattern, BlockIDFromRef(), containsStr() (+29 more)
...
Cohesion: 0.06
Nodes (37): AgentMetrics, AgentStats, TestBuildIdentityStampedRevisionFallback(), BuildIdentity, Gauge, HealthResponse, Histogram, LabeledCounter (+29 more)
...
Cohesion: 0.05
Nodes (41): countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_RecommendMutations(), TestNewPopulation_Evolution(), TestNewQTable(), TestNewReinforcementLearner(), TestPopulation_Diversity(), TestPopulation_Evolve() (+33 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (43): FileJobStore, JobStore, NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad(), TestScheduler_NoJobStore_NilSafe() (+35 more)
...
Cohesion: 0.09
Nodes (43): NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes(), TestAddFromMutation_NoChange(), TestAddFromMutation_NoLLM() (+35 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (33): Config, perTreeStats(), TestBaseNodeCount(), TestBenchmarkMockIntegration(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), TestMetricsTracker_BestFitnessTracking() (+25 more)

### Community 61 - "Community 61"
Cohesion: 0.12
Nodes (38): TestRunSuiteIsSandboxed(), defaultNlmGrillAuthGuard(), runGrillAuthGuardAction(), TestNoNewGapsOrImplDegraded_IsFallbackEligibleGuard(), TestRunGrillAuthGuardAction_PreservesBlackboardResultAndOutcome(), TestRunGrillAuthGuardAction_SuccessReturnsNilAndPreservesBlackboard(), init(), loadBanditStats() (+30 more)
...
Cohesion: 0.08
Nodes (23): handleSprintExecute(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep() (+15 more)
...
Cohesion: 0.08
Nodes (31): TestOutcomeErrorDetail(), OutcomeErrorDetail(), attemptOutcomeError(), buildSchedulerConfig(), endpointsFromCards(), experienceBankDir(), feedbackSnapshotPath(), hostURLOf() (+23 more)
...
Cohesion: 0.07
Nodes (30): BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), BuildChainAction(), parseChainConfig(), TestChainAction_ParseConfig(), BuildCircuitBreaker(), BuildInverter() (+22 more)
...
Cohesion: 0.06
Nodes (30): Blackboard, ChildTick, childTickLog, collectNames(), contains(), TestBuildTree_Minimal(), TestBuildTree_UnknownType(), TestOutcome_EmptyTaskFails() (+22 more)
...
Cohesion: 0.07
Nodes (21): GateResult, Outcome, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree() (+13 more)
...
Cohesion: 0.12
Nodes (28): BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir() (+20 more)
...
Cohesion: 0.07
Nodes (8): CreateAgentTool, EvolveTool, FitnessTool, GetReflectionsTool, GetTreeTool, ReflectTool, RunTaskTool, truncateStr()
...
Cohesion: 0.17
Nodes (19): activateAutomation(), considerAutomation(), finalizeAutomationApproval(), registerAutomationTools(), suggestSchedule(), newAutopilotDeps(), seedRecurringTask(), TestBTAutomationProposeRegistered() (+11 more)
...
Cohesion: 0.19
Nodes (19): proposeAutomation(), recordUserFeedback(), registerFeedbackTools(), newFeedbackDeps(), TestBTFeedbackRegistered(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), TestRecordUserFeedback_FeedsSatisfactionAndFlags(), TestRecordUserFeedback_RejectsBadInput() (+11 more)
...
Cohesion: 0.18
Nodes (19): TestLocalSearcher_New(), TestSelectorOptimizer_New(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb(), TestLocalSearch_SimulatedAnnealing() (+11 more)
...
Cohesion: 0.52
Nodes (6): scrapeMetrics(), TestAgentTaskDurationHistogramSeriesRendered(), TestBlockDurationHistogramSeriesRendered(), TestKGAnalyticsGaugesRenderedAndUpdated(), TestNodeDurationHistogramSeriesRendered(), TestPrometheusBuildInfoGaugeRenderedAndReplaced()
...
## Knowledge Gaps
- **6862 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6857 more)
...
- **Why does `Append()` connect `Community 11` to `Community 0`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 532`, `Community 20`, `Community 22`, `Community 21`, `Community 23`, `Community 25`, `Community 26`, `Community 539`, `Community 28`, `Community 31`, `Community 545`, `Community 34`, `Community 33`, `Community 35`, `Community 38`, `Community 551`, `Community 40`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 52`, `Community 53`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 60`, `Community 61`, `Community 62`, `Community 64`, `Community 65`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 73`, `Community 74`, `Community 76`, `Community 77`, `Community 80`, `Community 83`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 88`, `Community 90`, `Community 91`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 99`, `Community 100`, `Community 103`, `Community 530`, `Community 109`, `Community 113`, `Community 116`, `Community 117`, `Community 119`, `Community 120`, `Community 125`, `Community 126`, `Community 128`, `Community 132`, `Community 135`, `Community 136`, `Community 138`, `Community 139`, `Community 142`, `Community 144`, `Community 145`, `Community 146`, `Community 148`, `Community 156`, `Community 159`, `Community 160`, `Community 163`, `Community 164`, `Community 165`, `Community 168`, `Community 173`, `Community 174`, `Community 177`, `Community 180`, `Community 693`, `Community 182`, `Community 699`, `Community 187`, `Community 189`, `Community 702`, `Community 701`, `Community 194`, `Community 196`, `Community 199`, `Community 715`, `Community 205`, `Community 209`, `Community 211`, `Community 735`, `Community 744`, `Community 761`, `Community 781`, `Community 795`, `Community 351`, `Community 353`, `Community 360`, `Community 362`, `Community 363`, `Community 371`, `Community 375`, `Community 380`, `Community 381`, `Community 384`, `Community 385`, `Community 387`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 44` to `Community 0`, `Community 6`, `Community 11`, `Community 12`, `Community 17`, `Community 150`, `Community 24`, `Community 26`, `Community 162`, `Community 38`, `Community 168`, `Community 1065`, `Community 42`, `Community 47`, `Community 48`, `Community 50`, `Community 52`, `Community 181`, `Community 180`, `Community 53`, `Community 56`, `Community 187`, `Community 188`, `Community 59`, `Community 64`, `Community 192`, `Community 67`, `Community 68`, `Community 71`, `Community 72`, `Community 999`, `Community 109`, `Community 117`, `Community 374`, `Community 120`, `Community 763`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 72` to `Community 0`, `Community 132`, `Community 133`, `Community 6`, `Community 9`, `Community 525`, `Community 14`, `Community 16`, `Community 18`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 34`, `Community 38`, `Community 39`, `Community 40`, `Community 44`, `Community 46`, `Community 47`, `Community 177`, `Community 50`, `Community 181`, `Community 53`, `Community 56`, `Community 59`, `Community 63`, `Community 64`, `Community 191`, `Community 67`, `Community 75`, `Community 716`, `Community 206`, `Community 92`, `Community 93`, `Community 98`, `Community 361`, `Community 109`, `Community 122`?**
