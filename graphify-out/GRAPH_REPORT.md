# Graph Report - superpowers-20260715T015715-b231e80a-goap-fusion-loop-runner  (2026-07-15)

## Corpus Check
- 851 files · ~987,196 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22054 nodes · 33712 edges · 1790 communities (1428 shown, 362 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8543 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `30cda8fc`
...
8. `arc42 Section 9 — Architecture Decisions` - 96 edges
9. `sleep()` - 95 edges
10. `main()` - 78 edges
...
## Communities (1790 total, 362 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (154): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+146 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (154): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+146 more)
...
Cohesion: 0.03
Nodes (104): cloneTree(), CodeReviewSuite(), cohensD(), DefaultMock(), fishersExact(), GoDevSuite(), minF(), QuickValidate() (+96 more)
...
Cohesion: 0.04
Nodes (95): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+87 more)
...
Cohesion: 0.02
Nodes (69): stringContains(), TestBuildGoapStepPrompt(), buildGoapStepPrompt(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter() (+61 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (95): handleLogin(), auditKey, bearerPrincipalKey, IPFilter, IPFilterMode, RateLimiter, requestIDKey, AuditContext() (+87 more)
...
Cohesion: 0.02
Nodes (96): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+88 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (85): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), buildClaudeReviewPrompt() (+77 more)
...
Cohesion: 0.05
Nodes (63): NewRunDeps(), TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposePreset(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), TestComposePreset_Agentic() (+55 more)
...
Cohesion: 0.04
Nodes (67): Config, perTreeStats(), setupGardener(), TestBaseNodeCount(), TestEvolveTree_BloatGuard(), TestEvolveTree_MultipleTrees(), TestEvolveTree_NilTree(), TestEvolveTree_WithRealTree() (+59 more)
...
Cohesion: 0.04
Nodes (67): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), TestWrapReliable_HasTimeoutAndFallbacks(), Category (+59 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (69): AgentExecutor, appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure() (+61 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (57): main(), main(), SetAsDefault(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview() (+49 more)
...
Cohesion: 0.04
Nodes (20): History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), blockIDFromOp(), Registry (+12 more)
...
Cohesion: 0.06
Nodes (65): TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext(), checkLLMHealth(), countTypes(), detectAntiPatternsInTree() (+57 more)
...
Cohesion: 0.14
Nodes (55): TestBTPG_QualityMetrics_AllDomainTrees(), AlertRouterTree(), Arc42SeederTree(), Arc42Trees(), assembleDoc(), chain(), section10Quality(), section11Risks() (+47 more)
...
Cohesion: 0.05
Nodes (39): agentExecuteResult(), getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay() (+31 more)
...
Cohesion: 0.08
Nodes (54): satisfactionRecords(), TestEvaluateTree_EmptyRecordsSatisfactionUnknown(), TestEvaluateTree_FeedbackShiftsComposite(), TestEvaluateTree_NoFeedbackLeavesCompositeUnchanged(), countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns() (+46 more)
...
Cohesion: 0.08
Nodes (36): AuctionDelegate(), NewAuctioneer(), cardWithURL(), newAuctionTransport(), newDeadlineProbeTransport(), TestAuctionDelegate_AwardsWinnerFromCardRegistry(), TestAuctionDelegate_ChainStateCandidateOverride(), TestAuctionDelegate_NoCandidatesFallsBack() (+28 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (31): AgentMetrics, AgentStats, BuildIdentity, Counter, Gauge, HealthResponse, Histogram, HistogramSnap (+23 more)
...
Cohesion: 0.11
Nodes (38): init(), registerFinanceActions(), init(), registerResearchActions(), init(), registerStockfishActions(), init(), loadBanditStats() (+30 more)
...
Cohesion: 0.06
Nodes (31): AutoRebuildEnabled(), AutoRestartEnabled(), defaultDriftHead(), defaultDriftSmokeTest(), DriftStatus(), DriftWatchOnce(), TestAutoRestartEnabled(), TestDriftWatchOnceRestartHandoff() (+23 more)

### Community 62 - "Community 62"
Cohesion: 0.07
Nodes (43): Approval, mockOrch, NewWorkflow(), sortTasks(), TestApproval_Fields(), TestApproveTask(), TestExecuteSprint(), TestExecuteSprint_ApprovedToCompleted() (+35 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (17): Gardener, CollectAgentSLOs(), maxInt(), MetricsTracker, BuildMutationPrompt(), DefaultResearchHints(), NewModelEnsemble(), EnsembleConfig (+9 more)

### Community 64 - "Community 64"
Cohesion: 0.08
Nodes (38): TestOutcomeErrorDetail(), BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir() (+30 more)
...
Cohesion: 0.06
Nodes (32): banditChildKey(), banditLockFor(), banditStatsDir(), banditStatsPath(), banditUCB1Order(), BuildBanditSelector(), recordBanditOutcome(), saveBanditStats() (+24 more)
...
Cohesion: 0.09
Nodes (32): NewDefaultCompany(), CompanyOrchestrator, EngineerTree(), MarketingTree(), SalesTree(), StartupTrees(), clamp(), safeDiv() (+24 more)
...
Cohesion: 0.12
Nodes (34): isGoapNotebookLMFailure(), recentImplementedGoals(), TestRecentImplementedGoalsReadsStore(), loadNlmQueryCache(), loadNlmUsage(), nlmBudgetFor(), nlmExtractQuery(), nlmIsResearchImport() (+26 more)
...
Cohesion: 0.11
Nodes (26): handleAnalyze(), handleFellows(), TestHandleAnalyze_TaskIDsUniqueAcrossAnalyses(), TestHandleAnalyze_UsesWorkflowForTaskDerivation(), NewMockLLM(), DebateTurn, Fellow, DefaultFellows() (+18 more)
...
Cohesion: 0.14
Nodes (31): TestRouteBuilder_Build(), ArraySchema(), BoolSchema(), IntSchema(), ObjectSchema(), StringSchema(), TestConvenienceSchemaConstructors(), TestOpenAPIGenerator_ErrorResponses() (+23 more)
...
Cohesion: 0.1
Nodes (22): Analyzer, extractJSON(), NewAnalyzer(), truncate(), NewAgentFactory(), TestAnalyzer_EmptyResponse_Error(), TestAnalyzer_NoStrategyPath_Error(), TestAnalyzer_ParsesTreeSpec() (+14 more)
...
Cohesion: 0.15
Nodes (25): buildGrillRound1Query(), arc42GoalsPromptBlock(), arc42ResearchTopics(), loadArc42QualityGoals(), TestArc42GoalsPromptBlockContainsEveryGoal(), TestArc42GoalsPromptBlockEmptyWhenDocMissing(), TestArc42ResearchTopicsAnchoredToGoals(), TestBuildClaudeReviewPromptIncludesArc42Goals() (+17 more)
...
Cohesion: 0.17
Nodes (16): ChildStats, TestNormalizedIG(), NodeExecutionRecord, applyOrderToNode(), Entropy(), GiniImpurity(), InformationGain(), isSelectorFallback() (+8 more)
...
Cohesion: 0.11
Nodes (18): ADR-008: Composable Behavior-Tree Building Blocks, Consequences, Context, Decision, References, Status, goapFusionImplementationGateWired(), goapFusionPreflightWired() (+10 more)
...
Cohesion: 0.22
Nodes (13): ApplyParameters(), cholesky(), collectParams(), invertCholesky(), itoa(), multiplyCholesky(), navigateToPath(), parseInt() (+5 more)
...
Cohesion: 0.14
Nodes (3): CreateAgentTool, EvolveTool, FitnessTool
...
Cohesion: 0.32
Nodes (6): hasAnySetupTools(), hasExecutionPathFirst(), hasUnboundedRetry(), MetaValidationDecision, MetaValidationIssue, MetaValidatorConfig
...
Cohesion: 0.25
Nodes (8): code:go (type Workflow struct { ... }), code:go (type RotatingWriter struct { ... }), code:go (type Store struct { ... }), code:go (func Itoa(i int) string), Package: log, Package: persistence, Package: util, Package: workflow
...
Cohesion: 0.38
Nodes (4): sampleStdNormal(), TestSampleStdNormal(), CMAESOptimizer, TestMCTSNode_UCB1_Visited()
...
## Knowledge Gaps
- **7686 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7681 more)
...
- **Why does `Append()` connect `Community 26` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 10`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 29`, `Community 30`, `Community 32`, `Community 33`, `Community 34`, `Community 38`, `Community 40`, `Community 42`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 51`, `Community 53`, `Community 56`, `Community 57`, `Community 58`, `Community 571`, `Community 568`, `Community 62`, `Community 63`, `Community 65`, `Community 66`, `Community 68`, `Community 69`, `Community 71`, `Community 72`, `Community 74`, `Community 75`, `Community 76`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 594`, `Community 595`, `Community 84`, `Community 86`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 94`, `Community 95`, `Community 96`, `Community 99`, `Community 100`, `Community 102`, `Community 111`, `Community 113`, `Community 114`, `Community 119`, `Community 121`, `Community 124`, `Community 1149`, `Community 125`, `Community 127`, `Community 129`, `Community 131`, `Community 134`, `Community 136`, `Community 138`, `Community 140`, `Community 143`, `Community 144`, `Community 146`, `Community 149`, `Community 157`, `Community 158`, `Community 159`, `Community 161`, `Community 163`, `Community 172`, `Community 173`, `Community 174`, `Community 182`, `Community 184`, `Community 185`, `Community 188`, `Community 190`, `Community 191`, `Community 192`, `Community 194`, `Community 196`, `Community 204`, `Community 205`, `Community 206`, `Community 756`, `Community 760`, `Community 767`, `Community 768`, `Community 769`, `Community 770`, `Community 786`, `Community 792`, `Community 794`, `Community 808`, `Community 810`, `Community 812`, `Community 815`, `Community 856`, `Community 867`, `Community 368`, `Community 369`, `Community 370`, `Community 371`, `Community 372`, `Community 380`, `Community 381`, `Community 382`, `Community 383`, `Community 384`, `Community 391`, `Community 392`, `Community 393`, `Community 394`, `Community 395`, `Community 402`, `Community 404`, `Community 406`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 30` to `Community 1152`, `Community 2`, `Community 16`, `Community 18`, `Community 150`, `Community 407`, `Community 406`, `Community 22`, `Community 26`, `Community 37`, `Community 39`, `Community 42`, `Community 44`, `Community 177`, `Community 49`, `Community 51`, `Community 181`, `Community 58`, `Community 59`, `Community 64`, `Community 192`, `Community 70`, `Community 72`, `Community 74`, `Community 75`, `Community 591`, `Community 82`, `Community 89`, `Community 90`, `Community 95`, `Community 375`, `Community 107`, `Community 113`, `Community 114`, `Community 373`, `Community 119`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 64` to `Community 129`, `Community 2`, `Community 4`, `Community 133`, `Community 390`, `Community 135`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 788`, `Community 23`, `Community 24`, `Community 30`, `Community 33`, `Community 37`, `Community 41`, `Community 42`, `Community 44`, `Community 47`, `Community 177`, `Community 185`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 832`, `Community 196`, `Community 73`, `Community 74`, `Community 590`, `Community 85`, `Community 95`, `Community 365`, `Community 109`?**
