# Graph Report - superpowers-20260713T055741-10851188-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-13)

## Corpus Check
- 830 files · ~930,222 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20460 nodes · 31681 edges · 1697 communities (1341 shown, 356 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8223 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2612ddc1`
...
## Communities (1697 total, 356 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (131): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+123 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (131): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+123 more)
...
Cohesion: 0.04
Nodes (83): GardenerRecommendTool, GardenerRunCycleTool, main(), truncateStr(), main(), TestBlackboard_AllFields(), TestRunTask_CacheHit(), TestRunTask_EmptyInput_Fails() (+75 more)
...
Cohesion: 0.05
Nodes (58): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposeTaskTreeWithHITL(), HumanGateBlock(), registerHITLTools(), resolveTree(), agentTemplateYAML, TestResolveTreeID_FusionAliases() (+50 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (70): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure() (+62 more)
...
Cohesion: 0.04
Nodes (41): Outcome, Record, FilterByTreeName(), Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped() (+33 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (11): agentTestMockLLM, chainMockLLM, countedErrorMockLLM, errorMockLLM, flakyDecomposeMockLLM, flakyRefineMockLLM, flakySubtaskMockLLM, incompleteSynthMockLLM (+3 more)
...
Cohesion: 0.06
Nodes (56): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit() (+48 more)
...
Cohesion: 0.05
Nodes (55): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), Category, Compose(), ComposeFromRefs() (+47 more)
...
Cohesion: 0.09
Nodes (62): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+54 more)
...
Cohesion: 0.06
Nodes (50): HTTPMethod, IntSchema(), collectViolations(), fieldPath(), findResponse(), NewRouteIndex(), pathOrRoot(), ResponseValidator() (+42 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (58): LoadPipeline(), RunPipeline(), RunPipelineWithID(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), checkLLMHealth() (+50 more)
...
Cohesion: 0.03
Nodes (66): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+58 more)
...
Cohesion: 0.06
Nodes (51): AgentDefinition, ContentType, TestMustParseAgentDefinition_PanicsOnInvalid(), TestMustParseAgentDefinition_Valid(), TestNumberIn_InvalidNumberString(), TestNumberIn_Matching(), TestNumberIn_NotFound(), TestNumberValue_Float64() (+43 more)
...
Cohesion: 0.06
Nodes (33): NewACPClient(), sameJSONID(), scanJSONLines(), startScanJSONLines(), countCrashInvocations(), TestACPClientCircuitBreakerShortCircuitsRepeatedSubprocessFailures(), TestACPClientGenerateReturnsErrorWhenSessionMissing(), TestACPClientGenerateTalksToACPServer() (+25 more)

### Community 42 - "Community 42"
Cohesion: 0.07
Nodes (51): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), isGoapNotebookLMQuotaError(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField() (+43 more)
...
Cohesion: 0.07
Nodes (37): BuildBudget(), budgetCmd, BuildCachedCondition(), chainStateInt(), readPostconditions(), BuildCircuitBreaker(), BuildInverter(), BuildRepeater() (+29 more)

### Community 50 - "Community 50"
Cohesion: 0.1
Nodes (50): TestAddTag(), TestAddTag_EmptyDescription(), TestContentResponse_200(), TestContentResponse_Non200(), TestNumberSchema(), TestRouteBuilder_Build(), TestRouteBuilder_SunsetDate(), ArraySchema() (+42 more)
...
Cohesion: 0.06
Nodes (35): AutoRebuildEnabled(), defaultDriftHead(), DriftStatus(), DriftWatchOnce(), scrubGitEnv(), StartDriftWatcher(), TestDriftStatus(), TestDriftWatchOnce() (+27 more)
...
Cohesion: 0.05
Nodes (34): ActionFunc, ActionProvider, init(), registerAuctionDelegateNode(), registerIsAuctionTaskCondition(), TestCachedCondition_CachesWithinTTLAndExpires(), ConditionFunc, ConditionProvider (+26 more)
...
Cohesion: 0.07
Nodes (25): WorkflowsDir(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep() (+17 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (26): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleMetricsLive() (+18 more)
...
Cohesion: 0.07
Nodes (31): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), init(), InitRegistry(), countTreeNodes(), TestSuperpowersPipelineSimulation() (+23 more)
...
Cohesion: 0.06
Nodes (17): WebhookPublisher, TestActionForName_BulkCoverage(), TestSuperpowersTaskVerifyRed_NoTestsFailsWithoutPanic(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), DefaultPanicHandler(), Recover(), SafeGo() (+9 more)
...
Cohesion: 0.08
Nodes (27): TestOutcomeErrorDetail(), OutcomeErrorDetail(), attemptOutcomeError(), endpointsFromCards(), experienceBankDir(), hostURLOf(), init(), logA2AServeError() (+19 more)
...
Cohesion: 0.1
Nodes (28): TestDebugPhase_DryRunSkipsClaudeAndWritesMarker(), TestDebugPhases_WriteEvidenceFiles(), TestDiscardWorktree_RefusesEmptyPath(), TestDiscardWorktree_RefusesMainRepoPath(), TestDiscardWorktree_RemovesWorktreeAndDeletesBranch(), TestPushBranchAndCreatePR_InvokesGitPushAndGhPr(), withSwappedSuperpowersRunners(), TestSuperpowersTaskCommitAction_ExcludesGeneratedPaths() (+20 more)

### Community 89 - "Community 89"
Cohesion: 0.1
Nodes (34): loadSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), saveSuperpowersPlanState(), buildDeterministicImplementationPlan(), nlmGrillAnswerer() (+26 more)

### Community 90 - "Community 90"
Cohesion: 0.08
Nodes (30): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations(), TestExpertKnowledge_ValidateArchetype() (+22 more)
...
Cohesion: 0.1
Nodes (29): BlackboardDir(), CircuitBreakersFile(), DLQFile(), FeedbackFile(), HistoryDir(), HomeDir(), JobsDir(), LogsDir() (+21 more)

### Community 96 - "Community 96"
Cohesion: 0.12
Nodes (34): TestBTEvolveIslandAdoptsLegacyGlobalArchiveOnce(), TestPopulation_StatsAccessors(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry(), TestAddFromMutation_MultipleTreeTypes() (+26 more)
...
Cohesion: 0.12
Nodes (28): TestRunSuiteIsSandboxed(), init(), registerGoDevActions(), init(), loadBanditStats(), TestBanditSelector_CachesStatsAcrossTicksNoPerTickReload(), TestBanditSelector_ColdStartTriesEveryArmOnce(), TestBanditSelector_ConcurrentTicksNoLostOutcomes() (+20 more)

### Community 101 - "Community 101"
Cohesion: 0.09
Nodes (13): envDefault(), main(), run(), AgentExecutor, init(), registerSuperpowersDebugActions(), superpowersDebugPhase(), superpowersDebugPhaseAction() (+5 more)
...
Cohesion: 0.1
Nodes (30): TestMultiNode_ConcurrentAgentExecution(), TestMultiNode_ProbeFailsOnEmptyNodeURL(), TestMultiNode_ProbeFailsOnLessThanTwoNodes(), TestMultiNodeExecutionPipeline(), MultiNodeProbeConfig, MultiNodeProbeReport, NodeProbeStatus, panicOnHostRoundTripper (+22 more)
...
Cohesion: 0.09
Nodes (20): alwaysSampler, Attr, neverSampler, noopTracer, Sampler, Span, SpanContext, spanContextKey (+12 more)
...
Cohesion: 0.12
Nodes (15): BuildTaskFromInputs(), ParseInputParams(), TestBuildTaskFromInputs(), TestParseInputParams(), TestValidateInputs_Default(), TestValidateInputs_File(), TestValidateInputs_JSON(), TestValidateInputs_Required() (+7 more)
...
Cohesion: 0.25
Nodes (21): TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200(), TestTracingMiddleware_NoopTracerSafe(), TestTracingMiddleware_SlowRequest(), TestTracingMiddleware_StatusCodes(), TestTracingMiddleware_WroteHeaderGuard() (+13 more)
...
Cohesion: 0.1
Nodes (11): A2AHandoffBlock(), builtinBlocks(), DelegateBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), HumanReviewBlock(), PlanBlock() (+3 more)
...
Cohesion: 0.19
Nodes (14): TestRunOnce_EmitsRunRootSpan(), TestNestedActionSpansParentCorrectly(), TestPanickingActionRestoresTraceContextAndEndsSpan(), TestRegisteredActionEmitsSpan(), TestRegisteredConditionEmitsSpan(), withRecordingGlobalTracer(), NewTracedLLM(), NewTracedLLMWithParent() (+6 more)
...
Cohesion: 0.15
Nodes (13): collectNames(), contains(), TestBuildTree_Minimal(), TestBuildTree_UnknownType(), TestOutcome_EmptyTaskFails(), TestOutcome_Success(), TestRouting_CodeReview(), TestRouting_Finance() (+5 more)
...
Cohesion: 0.19
Nodes (10): TestNewGoTestTool_Structure(), TestNewGraphifyTool_Structure(), TestNewShellExecTool_Structure(), TestNewWebSearchTool_Structure(), TestRealTool_Call(), TestRealTool_NameAndDescription(), TestToolStub_CallReturnsEmpty(), TestToolStub_CallReturnsError() (+2 more)
...
## Knowledge Gaps
- **6735 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6730 more)
...
- **Why does `Append()` connect `Community 44` to `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 14`, `Community 15`, `Community 17`, `Community 19`, `Community 20`, `Community 532`, `Community 533`, `Community 23`, `Community 25`, `Community 538`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 539`, `Community 31`, `Community 34`, `Community 546`, `Community 548`, `Community 35`, `Community 38`, `Community 41`, `Community 42`, `Community 43`, `Community 556`, `Community 45`, `Community 46`, `Community 559`, `Community 560`, `Community 49`, `Community 50`, `Community 48`, `Community 558`, `Community 53`, `Community 51`, `Community 55`, `Community 56`, `Community 54`, `Community 58`, `Community 59`, `Community 57`, `Community 61`, `Community 62`, `Community 63`, `Community 65`, `Community 66`, `Community 68`, `Community 69`, `Community 72`, `Community 73`, `Community 75`, `Community 76`, `Community 78`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 86`, `Community 90`, `Community 91`, `Community 93`, `Community 94`, `Community 95`, `Community 99`, `Community 101`, `Community 102`, `Community 103`, `Community 104`, `Community 105`, `Community 106`, `Community 113`, `Community 116`, `Community 118`, `Community 119`, `Community 121`, `Community 122`, `Community 126`, `Community 130`, `Community 132`, `Community 135`, `Community 136`, `Community 139`, `Community 140`, `Community 141`, `Community 146`, `Community 148`, `Community 155`, `Community 156`, `Community 157`, `Community 158`, `Community 163`, `Community 164`, `Community 170`, `Community 171`, `Community 177`, `Community 180`, `Community 182`, `Community 183`, `Community 188`, `Community 702`, `Community 193`, `Community 705`, `Community 197`, `Community 198`, `Community 202`, `Community 205`, `Community 721`, `Community 723`, `Community 216`, `Community 219`, `Community 220`, `Community 746`, `Community 748`, `Community 772`, `Community 353`, `Community 355`, `Community 357`, `Community 359`, `Community 366`, `Community 367`, `Community 369`, `Community 370`, `Community 375`, `Community 377`, `Community 378`, `Community 383`, `Community 390`, `Community 391`, `Community 392`, `Community 393`, `Community 395`, `Community 951`?**
  _High betweenness centrality (0.150) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 31` to `Community 129`, `Community 2`, `Community 7`, `Community 9`, `Community 10`, `Community 395`, `Community 14`, `Community 16`, `Community 146`, `Community 147`, `Community 25`, `Community 27`, `Community 29`, `Community 160`, `Community 35`, `Community 166`, `Community 170`, `Community 43`, `Community 171`, `Community 44`, `Community 48`, `Community 51`, `Community 57`, `Community 62`, `Community 190`, `Community 68`, `Community 207`, `Community 208`, `Community 80`, `Community 85`, `Community 86`, `Community 90`, `Community 986`, `Community 95`, `Community 96`, `Community 119`, `Community 765`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 85` to `Community 2`, `Community 5`, `Community 390`, `Community 7`, `Community 10`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 29`, `Community 31`, `Community 162`, `Community 167`, `Community 40`, `Community 41`, `Community 39`, `Community 43`, `Community 45`, `Community 46`, `Community 48`, `Community 53`, `Community 57`, `Community 185`, `Community 60`, `Community 64`, `Community 196`, `Community 75`, `Community 79`, `Community 207`, `Community 724`, `Community 95`, `Community 96`, `Community 101`, `Community 365`, `Community 115`?**
