# Graph Report - superpowers-20260715T022646-9a21d49e-scheduled-goap-fusion-cycle-read-vault-r  (2026-07-15)

## Corpus Check
- 852 files · ~990,372 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22124 nodes · 33811 edges · 1804 communities (1445 shown, 359 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 8565 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9ad1e517`
...
8. `arc42 Section 9 — Architecture Decisions` - 97 edges
9. `sleep()` - 95 edges
10. `main()` - 78 edges
...
## Communities (1804 total, 359 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (155): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+147 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (155): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+147 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (110): GardenerRecommendTool, GardenerRunCycleTool, main(), newGardenerRunCycleTool(), truncateStr(), main(), TestBlackboard_AllFields(), containsAnyStr() (+102 more)
...
Cohesion: 0.03
Nodes (90): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), Category (+82 more)
...
Cohesion: 0.03
Nodes (84): expandChainStateTemplates(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM(), TestChainAction_Agent_NoTools() (+76 more)
...
Cohesion: 0.04
Nodes (102): TestDeprecatedHandler_NoSunset(), TestDeprecatedHandler_WithSunsetDate(), DeprecatedHandler(), TestDeprecatedHandler_WithoutSunset(), TestDeprecatedHandler_WithSunset(), handleLogin(), NewRequest(), DefaultPanicHandler() (+94 more)
...
Cohesion: 0.05
Nodes (88): DefaultLLM(), RealLLM(), TestDetectPath_FromCurrentPath(), TestDetectPath_FromVisitedPaths(), TestDetectPath_KeywordFallback(), TestTauBenchBuiltinRetailAndDefaultEntries(), BuiltinBFCLV3(), minInt() (+80 more)
...
Cohesion: 0.02
Nodes (97): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+89 more)
...
Cohesion: 0.07
Nodes (77): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewManager(), defaultGoapReviewDeps(), gatherFailureReviewBody() (+69 more)
...
Cohesion: 0.06
Nodes (72): main(), TestCheckConfidence_ConditionExists(), TestEvaluateTree_NegativeDuration(), TestEvaluateTree_SingleRecord(), TestIterativeDeepening_MultipleDepths(), TestIterativeDeepening_PruningOnNodeExplosion(), TestIterativeDeepening_TTHitDuringSearch(), TestOrderMutations_FewSelectors_RecommendsFallback() (+64 more)
...
Cohesion: 0.06
Nodes (66): LoadPipeline(), RunPipeline(), RunPipelineWithID(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), mcpDeps, addFailureContext() (+58 more)
...
Cohesion: 0.06
Nodes (61): clearSuperpowersPlanState(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask(), ensureSuperpowersForEachTaskSetup(), init(), isClaudeRateLimit(), registerSuperpowersProductionActions() (+53 more)
...
Cohesion: 0.06
Nodes (59): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), nlmQuotaExhausted(), TestNlmQuotaState_EmptyAndGarbageNotExhausted(), TestNlmQuotaState_ExpiredWindowNotExhausted(), extractConversationID(), extractGoapGoals() (+51 more)
...
Cohesion: 0.06
Nodes (58): TestValidate_BanditSelectorRequiresUniqueName(), TestCachedCondition_RefusesHITLConditions(), TestCachedCondition_RefusesNestedHITLConditions(), TestValidateTree_NestedChildren(), TestValidateTree_ValidTree(), TestSuperpowersWorkflowTree_BuildsAndValidates(), containsLeafChildrenMsg(), TestRunTask_BackstopsEmptyResultOnNonSuccess() (+50 more)
...
Cohesion: 0.1
Nodes (55): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Research(), TestTree_Research(), TestIntegration_AllTreesExecute() (+47 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (46): TestNewReinforcementLearner(), NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation() (+38 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (37): TestGardenerRollbackTool_CallRestoresSnapshot(), GateResult, Outcome, RestoreTree(), SnapshotTree(), Record, FilterByTreeName(), Config (+29 more)
...
Cohesion: 0.05
Nodes (19): History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), mockTTOrch, TestExpertKnowledge_SeedSpecialistsCarryProvenance() (+11 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (44): min(), brokenTool, ChainKind, BuildChainAction(), buildChainActionFn(), execLLMCall(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic() (+36 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (38): TestBuildDelegateBlockTree(), TestComposedTaskTree_BuildExpand_EmptyTaskFails(), TestComposedTaskTree_BuildExpand_ValidTaskRuns(), TestComposedTaskTreeAgentic_SetsPlan(), InitRegistry(), TestWorkflowApprovalWait_EscalatedIsNotApproved(), WorkflowApprovalTaskID(), WorkflowApprovalWait() (+30 more)
...
Cohesion: 0.06
Nodes (54): ChainConfig, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), buildMapReduceFallback(), buildToolList(), execAgent() (+46 more)
...
Cohesion: 0.08
Nodes (34): Config, Duration(), TestDuration(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation(), BenchmarkRetrieve(), mkExperienceEntry() (+26 more)
...
Cohesion: 0.06
Nodes (45): TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewGoBuildTool_Structure(), TestNewGoTestTool_Structure(), TestNewGoVetTool_Structure(), TestNewGraphifyTool_Structure(), TestNewShellExecTool_Structure(), TestNewWebSearchTool_Structure() (+37 more)

### Community 61 - "Community 61"
Cohesion: 0.08
Nodes (43): FitnessDimension, TestPopulationEvolve_ResurrectsExtinctSpecialist(), TestPopulationHealthSnapshot_DiversityCollapseRun(), NewNSGAIIPopulation(), TestNewNSGAIIPopulation(), TestNewNSGAIIPopulation_SeedsSpecialists(), TestNSGAII_CrowdedComparison(), TestNSGAII_CrowdingDistance() (+35 more)

### Community 62 - "Community 62"
Cohesion: 0.09
Nodes (43): isGoapNotebookLMFailure(), extractTaskID(), init(), nlmAuthNeedsRefresh(), nlmAuthUnhealthy(), registerNotebookLMActions(), writeString(), recentImplementedGoals() (+35 more)

### Community 63 - "Community 63"
Cohesion: 0.08
Nodes (41): ClearGoapFusionStateHashes(), goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionNoopPatchStreak(), goapFusionRepeatedHashBypassed(), goapFusionStateHashes() (+33 more)
...
Cohesion: 0.1
Nodes (32): ExperienceRetrievalHits(), RetrieveExperienceHints(), TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), TestQualityGateConsecutiveFails() (+24 more)
...
Cohesion: 0.1
Nodes (12): Individual, cloneTree(), containsCrisisReason(), Crossover(), hashTree(), max(), maxTreeDepth(), BuildPopulationState() (+4 more)
...
Cohesion: 0.06
Nodes (16): runDLQReplayScanOnce(), TestDLQReplayScanSurvivesPanicAcrossTicks(), TestActionForName_BulkCoverage(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), Recover(), SafeGo(), TestRecover_CatchesPanic() (+8 more)

### Community 98 - "Community 98"
Cohesion: 0.09
Nodes (33): DashboardRebuildTargets(), DefaultRebuildTargets(), main(), envDefault(), main(), run(), ApplyHITLPolicy(), ApplyConfig() (+25 more)
...
Cohesion: 0.08
Nodes (23): TestRunOnce_EmitsRunRootSpan(), TestRunJob_WebhookSpanJoinsRunTrace(), tracingMiddleware(), NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan() (+15 more)
...
Cohesion: 0.06
Nodes (27): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, DeadLetterEntry, TestCircuitBreaker_CategoryFailureCounts_Concurrent(), TestCircuitBreaker_CategoryFailureCounts_Empty(), TestCircuitBreaker_RecordFailure_BackwardCompat() (+19 more)
...
Cohesion: 0.13
Nodes (19): CompanyOrchestrator, EngineerTree(), MarketingTree(), SalesTree(), StartupTrees(), clamp(), safeDiv(), checkTreeBasics() (+11 more)
...
Cohesion: 0.12
Nodes (24): TestLocalSearcher_New(), TestSelectorOptimizer_KillerChild(), TestSelectorOptimizer_ShouldPrune(), NewLocalSearcher(), NewSelectorOptimizer(), TestGiniImpurity(), TestInformationGain(), TestLocalSearch_HillClimb() (+16 more)
...
Cohesion: 0.1
Nodes (12): A2AHandoffBlock(), builtinBlocks(), DelegateBlock(), EvolveOnFailureBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), HITLTieredBlock() (+4 more)
...
## Knowledge Gaps
- **7726 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7721 more)
...
- **Why does `Append()` connect `Community 46` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 1055`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 47`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 574`, `Community 62`, `Community 64`, `Community 575`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 578`, `Community 71`, `Community 72`, `Community 584`, `Community 76`, `Community 77`, `Community 78`, `Community 81`, `Community 83`, `Community 598`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 98`, `Community 99`, `Community 612`, `Community 613`, `Community 101`, `Community 103`, `Community 614`, `Community 109`, `Community 120`, `Community 122`, `Community 123`, `Community 125`, `Community 127`, `Community 130`, `Community 131`, `Community 138`, `Community 143`, `Community 145`, `Community 147`, `Community 151`, `Community 163`, `Community 164`, `Community 167`, `Community 168`, `Community 180`, `Community 182`, `Community 183`, `Community 190`, `Community 191`, `Community 192`, `Community 193`, `Community 196`, `Community 197`, `Community 198`, `Community 199`, `Community 200`, `Community 201`, `Community 205`, `Community 206`, `Community 208`, `Community 209`, `Community 211`, `Community 212`, `Community 216`, `Community 217`, `Community 781`, `Community 782`, `Community 794`, `Community 801`, `Community 808`, `Community 809`, `Community 824`, `Community 825`, `Community 829`, `Community 838`, `Community 376`, `Community 377`, `Community 378`, `Community 383`, `Community 385`, `Community 386`, `Community 389`, `Community 390`, `Community 398`, `Community 402`, `Community 403`, `Community 404`, `Community 405`, `Community 411`, `Community 414`, `Community 415`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 20` to `Community 4`, `Community 6`, `Community 10`, `Community 395`, `Community 17`, `Community 149`, `Community 152`, `Community 26`, `Community 412`, `Community 33`, `Community 35`, `Community 41`, `Community 42`, `Community 46`, `Community 47`, `Community 176`, `Community 58`, `Community 61`, `Community 64`, `Community 69`, `Community 198`, `Community 70`, `Community 71`, `Community 74`, `Community 85`, `Community 94`, `Community 375`, `Community 106`, `Community 119`, `Community 123`, `Community 124`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 74` to `Community 129`, `Community 2`, `Community 130`, `Community 4`, `Community 6`, `Community 13`, `Community 15`, `Community 17`, `Community 19`, `Community 20`, `Community 26`, `Community 800`, `Community 33`, `Community 38`, `Community 39`, `Community 40`, `Community 48`, `Community 49`, `Community 176`, `Community 52`, `Community 56`, `Community 64`, `Community 65`, `Community 193`, `Community 198`, `Community 71`, `Community 205`, `Community 589`, `Community 80`, `Community 84`, `Community 97`, `Community 98`, `Community 104`, `Community 112`, `Community 119`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
...
- **Are the 138 inferred relationships involving `DefaultTree()` (e.g. with `TestFullTreeIntegration_RunsAllTreesWithRealLLM()` and `TestDomainTree_Registration()`) actually correct?**
  _`DefaultTree()` has 138 INFERRED edges - model-reasoned connections that need verification._
