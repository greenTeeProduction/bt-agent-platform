# Graph Report - superpowers-20260713T075607-1d2ca422-goap-fusion-loop-runner-blackboard-conte  (2026-07-13)

## Corpus Check
- 830 files · ~933,372 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20532 nodes · 31774 edges · 1695 communities (1340 shown, 355 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8233 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `148d5f05`
...
## Communities (1695 total, 355 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (132): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+124 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (132): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+124 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (105): main(), TestContainsWord_EmptySource(), TestContainsWord_EmptyWord(), TestContainsWord_ExactMatch(), TestContainsWord_NoMatch(), TestContainsWord_PrefixMatch(), TestContainsWord_ShorterThanWord(), TestContainsWord_SuffixMatch() (+97 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (96): isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries(), TestChainAction_Agent_NilLLM() (+88 more)
...
Cohesion: 0.04
Nodes (75): appendMissingRealTools(), inferToolsForTask(), init(), registerSetupActions(), uniqueStrings(), TestNewFileReadTool_Structure(), TestNewFileWriteTool_Structure(), TestNewWebSearchTool_Structure() (+67 more)
...
Cohesion: 0.04
Nodes (78): brokenTool, ChainConfig, ChainKind, availableToolNames(), bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction() (+70 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (62): main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+54 more)
...
Cohesion: 0.05
Nodes (62): GateResult, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree(), SnapshotTree() (+54 more)
...
Cohesion: 0.04
Nodes (44): findChildByName(), TestBuildGoapStepPrompt(), TestContainsAnyLower_BasicMatch(), TestContainsAnyLower_CaseInsensitive(), TestContainsAnyLower_EmptyInput(), TestContainsAnyLower_MultipleKeywords(), TestContainsAnyLower_NoKeywords(), TestContainsAnyLower_NoMatch() (+36 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (66): Duration(), TestDuration(), satisfactionRecords(), TestEvaluateTree_EmptyRecordsSatisfactionUnknown(), TestEvaluateTree_FeedbackShiftsComposite(), TestEvaluateTree_NoFeedbackLeavesCompositeUnchanged(), countTreeNodes(), TestCrossover_Single() (+58 more)
...
Cohesion: 0.06
Nodes (64): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), buildDeterministicDesign(), buildSuperpowersFinishReport(), currentSuperpowersForEachTask() (+56 more)
...
Cohesion: 0.08
Nodes (63): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), defaultGoapReviewDeps() (+55 more)
...
Cohesion: 0.05
Nodes (59): TestNewReinforcementLearner(), NewCrisisDetector(), containsReason(), TestCrisisDetector_Detect_DiversityCollapse(), TestCrisisDetector_Detect_DiversityZero(), TestCrisisDetector_Detect_ImprovementResetsStagnation(), TestCrisisDetector_Detect_NoCrisis(), TestCrisisDetector_Detect_Stagnation() (+51 more)
...
Cohesion: 0.03
Nodes (67): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+59 more)
...
Cohesion: 0.07
Nodes (54): TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), completeGoapProgramMilestone(), extractGoapResearchGoals(), fallbackGoapGoal(), goapFusionNotebookLMGoalsFromGaps(), goapResearchGapLines(), goapResearchGoalLines() (+46 more)
...
Cohesion: 0.06
Nodes (36): AgentMetrics, AgentStats, BuildIdentity, Counter, Gauge, HealthResponse, Histogram, LabeledCounter (+28 more)
...
Cohesion: 0.07
Nodes (44): biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), DefaultEvolveV2Config(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), crisisMetricsGardener() (+36 more)
...
Cohesion: 0.09
Nodes (38): truncateGoap(), arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), extractGoapProgram(), persistGoapProgram(), TestExtractGoapProgramParsesMilestones() (+30 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (25): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogout() (+17 more)
...
Cohesion: 0.06
Nodes (33): TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern(), TestValidateOutputQuality_MarkdownStructure(), TestValidateOutputQualityRejectsRefusals(), collectNames(), contains() (+25 more)
...
Cohesion: 0.07
Nodes (24): copyFile(), DashboardRebuildTargets(), defaultRebuildBuild(), defaultRebuildMaterialize(), DefaultRebuildTargets(), NewRebuildBackoff(), RebuildBinaries(), resolveGoBinary() (+16 more)
...
Cohesion: 0.09
Nodes (25): stringContains(), TestAction_ExecuteGoapStep_AccumulatesAndSynthesizes(), TestAction_ExecuteGoapStep_NoLLM(), TestAction_ExecuteGoapStep_WithLLM(), TestAction_PlanGoapActions_CustomGoal(), TestAction_PlanGoapActions_JSONActions(), TestAction_PlanGoapActions_JSONActionsEmptyAfterFilter(), TestAction_PlanGoapActions_JSONActionsInvalidEntry() (+17 more)
...
Cohesion: 0.08
Nodes (18): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, baseNodeCount(), CollectAgentSLOs() (+10 more)

### Community 144 - "Community 144"
Cohesion: 0.13
Nodes (24): TestPromoteSubtree(), Compose(), ComposeFromRefs(), ComposeTaskTree(), composeWithMiddle(), ListToolProfileBlocks(), ApplyBlockMutations(), blockIDFromOp() (+16 more)
...
Cohesion: 0.17
Nodes (22): TestIntegration_EdgeCases(), TestHashTree_DifferentTrees(), TestTranspositionTable_DifferentTree_DifferentKey(), FusionDeliberationTree(), collectFusionNames(), findFusionNode(), TestFusionDeliberationTree_HasFusionAndDirectPaths(), TestFusionDeliberationTree_UsesFusionChainAction() (+14 more)
...
Cohesion: 0.11
Nodes (19): Block, Category, composeOrderedWithMiddle(), ComposePreset(), ComposePresetWithTools(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), PipelineWithToolsProfile() (+11 more)

### Community 160 - "Community 160"
Cohesion: 0.13
Nodes (21): CollectBlockIDs(), FitnessRanking(), RecordTaskBlockFitness(), ScoreFromBlackboard(), TestRecordTaskBlockFitness(), BlockFitnessRanking(), BlockFitnessSnapshot(), BlockMetricsSnapshot() (+13 more)
...
Cohesion: 0.15
Nodes (14): BTOptimizer, collectSelectors(), conditionOverlap(), extractCondition(), findMainSelector(), TestFindMainSelector(), TestSplitCamelCase(), isDefaultPath() (+6 more)
...
Cohesion: 0.14
Nodes (15): TestMatchBlockPattern(), AntiPattern, DesignPattern, BlockIDFromRef(), containsStr(), coreHeuristics(), hasNodeMatching(), hasNodeType() (+7 more)

### Community 195 - "Community 195"
Cohesion: 0.13
Nodes (15): DefaultBlockConfig(), NewMetaPromptEvolver(), NewMutationContext(), TestBlockConfig_FilterMutations(), TestBlockConfig_IsMutable(), TestCrisisDetector_LastDiversity(), TestDefaultBlockConfig(), TestFindBlockForNode() (+7 more)
...
Cohesion: 0.16
Nodes (7): pathEntropy(), DTAnalyzer, acquireExperienceLock(), TestAcquireExperienceLockMissingDir(), TestAcquireExperienceLockMutualExclusion(), TestAcquireExperienceLockReleaseIdempotent(), cappedCells()
...
Cohesion: 0.16
Nodes (11): TestToolNames_And_Descriptions(), GetReflectionsTool, RunTaskTool, NewCreateAgentTool(), NewEvolveTool(), NewFitnessTool(), NewGetReflectionsTool(), NewGetTreeTool() (+3 more)
...
Cohesion: 0.13
Nodes (9): Blackboard, ChildTick, childTickLog, tracedCondition(), toolStub, containsAny(), RunTask(), truncateStrForTree() (+1 more)
...
## Knowledge Gaps
- **6777 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6772 more)
...
- **Why does `Append()` connect `Community 11` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 532`, `Community 21`, `Community 533`, `Community 24`, `Community 536`, `Community 1050`, `Community 27`, `Community 28`, `Community 29`, `Community 32`, `Community 545`, `Community 33`, `Community 34`, `Community 36`, `Community 37`, `Community 40`, `Community 554`, `Community 42`, `Community 556`, `Community 45`, `Community 44`, `Community 559`, `Community 48`, `Community 49`, `Community 560`, `Community 51`, `Community 46`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 61`, `Community 63`, `Community 65`, `Community 66`, `Community 68`, `Community 70`, `Community 71`, `Community 72`, `Community 76`, `Community 77`, `Community 80`, `Community 82`, `Community 83`, `Community 86`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 94`, `Community 95`, `Community 102`, `Community 104`, `Community 108`, `Community 110`, `Community 111`, `Community 112`, `Community 113`, `Community 116`, `Community 118`, `Community 121`, `Community 122`, `Community 126`, `Community 128`, `Community 131`, `Community 133`, `Community 134`, `Community 136`, `Community 138`, `Community 143`, `Community 144`, `Community 145`, `Community 149`, `Community 153`, `Community 154`, `Community 157`, `Community 159`, `Community 160`, `Community 163`, `Community 172`, `Community 173`, `Community 174`, `Community 175`, `Community 177`, `Community 179`, `Community 181`, `Community 182`, `Community 183`, `Community 186`, `Community 189`, `Community 192`, `Community 193`, `Community 706`, `Community 707`, `Community 194`, `Community 198`, `Community 199`, `Community 202`, `Community 203`, `Community 212`, `Community 726`, `Community 216`, `Community 218`, `Community 731`, `Community 743`, `Community 744`, `Community 746`, `Community 352`, `Community 354`, `Community 355`, `Community 356`, `Community 357`, `Community 364`, `Community 369`, `Community 372`, `Community 373`, `Community 374`, `Community 375`, `Community 381`, `Community 383`, `Community 385`, `Community 386`, `Community 390`, `Community 391`, `Community 393`, `Community 394`, `Community 395`, `Community 949`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 46` to `Community 128`, `Community 3`, `Community 136`, `Community 11`, `Community 140`, `Community 144`, `Community 18`, `Community 20`, `Community 149`, `Community 151`, `Community 1048`, `Community 28`, `Community 29`, `Community 156`, `Community 31`, `Community 33`, `Community 162`, `Community 49`, `Community 181`, `Community 55`, `Community 57`, `Community 186`, `Community 58`, `Community 61`, `Community 193`, `Community 68`, `Community 71`, `Community 200`, `Community 73`, `Community 208`, `Community 981`, `Community 86`, `Community 110`, `Community 111`, `Community 112`, `Community 765`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 73` to `Community 130`, `Community 3`, `Community 4`, `Community 10`, `Community 12`, `Community 14`, `Community 18`, `Community 20`, `Community 28`, `Community 31`, `Community 32`, `Community 37`, `Community 40`, `Community 41`, `Community 46`, `Community 49`, `Community 55`, `Community 183`, `Community 57`, `Community 58`, `Community 64`, `Community 67`, `Community 68`, `Community 199`, `Community 200`, `Community 74`, `Community 78`, `Community 723`, `Community 84`, `Community 217`, `Community 99`, `Community 110`, `Community 111`, `Community 370`, `Community 371`?**
