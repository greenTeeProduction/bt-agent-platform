# Graph Report - superpowers-20260712T193025-83eaaa9a-goap-fusion-loop-runner-blackboard-conte  (2026-07-12)

## Corpus Check
- 823 files · ~900,204 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19591 nodes · 30647 edges · 1658 communities (1295 shown, 363 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8095 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3cd05fcf`
...
## Communities (1658 total, 363 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (94): expandChainStateTemplates(), isReActSectionMarker(), parseAgentAction(), parseFinalAnswer(), DemoChainTree(), TestChainAction_Agent_DirectAnswer(), TestChainAction_Agent_LLMError(), TestChainAction_Agent_MaxIterBoundaries() (+86 more)
...
Cohesion: 0.02
Nodes (118): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+110 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (118): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+110 more)
...
Cohesion: 0.04
Nodes (89): truncateGoap(), arc42SeedTargetGoal(), buildArc42SeedPrompt(), init(), programNamesGoal(), TestNoopPatchStreakStillHaltsUnderBypass(), appendGoapResearchGoals(), completeGoapProgramMilestone() (+81 more)
...
Cohesion: 0.05
Nodes (84): clearSuperpowersPlanState(), goapBacktickValueAfter(), goapFusionImplDegradedSection(), init(), registerGoapFusionProductionAdditions(), ClearGoapFusionStateHashes(), init(), buildDeterministicDesign() (+76 more)
...
Cohesion: 0.04
Nodes (79): TestRunOnce_EmitsRunRootSpan(), alwaysSampler, Attr, fakeTracer, TestTracingMiddleware_BasicSpan(), TestTracingMiddleware_DifferentMethods(), TestTracingMiddleware_FlushSupport(), TestTracingMiddleware_Implicit200() (+71 more)
...
Cohesion: 0.06
Nodes (65): TestNewTranspositionTable_MkdirError(), TestTranspositionTable_Load_JSONError(), TestTranspositionTable_Load_TrimOverflowExact(), NewTranspositionTable(), perTreeStats(), setupGardener(), TestBenchmarkMockIntegration(), TestEvolveTree_BloatGuard() (+57 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (75): TestScoreChild_GoalAlignmentBranch(), TestScoreChild_NilChainState(), TestScoreChildren_BasicRanking(), ParallelMode, intSliceFromInterface(), BuildReactiveParallel(), forkBlackboard(), intSliceFromInterface() (+67 more)
...
Cohesion: 0.06
Nodes (67): TestPromoteRunToAgentScope(), TestEngineBlackboardAppendTool(), TestEngineBlackboardToolsRoundTrip(), TestEngineExpandBBTemplate_InLLMCall(), TestEnginePrepareBlackboard_Idempotent(), TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit() (+59 more)
...
Cohesion: 0.05
Nodes (41): handleSprintExecute(), main(), handlePipelineRun(), handlePipelines(), newPipelineRunner(), newRunID(), resolveTree(), runPipelineAgentStep() (+33 more)
...
Cohesion: 0.05
Nodes (61): brokenTool, ChainConfig, ChainKind, bbRunID(), bbTemplateDisplay(), bbTemplateValue(), BuildChainAction(), buildChainActionFn() (+53 more)
...
Cohesion: 0.06
Nodes (36): TestCheckConfidence_ConditionExists(), TestPopulation_StatsAccessors(), TestApplyMutations_Batch(), TestApplyMutations_DuplicateFallbackRejected(), TestApplyMutations_NoOpDoesNotCountAsApplied(), TestApplyMutations_PromptToolIterationMutationsAreBounded(), TestCountNodes(), TestDefaultTree_Structure() (+28 more)
...
Cohesion: 0.07
Nodes (52): TestAutoCreateTree_ConfidenceThreshold(), TestAutoCreateTree_New(), TestBreed(), TestBreed_FromArchetype(), TestBreed_FromArchetype_Fallback(), TestBreed_NoParents(), TestBreed_TooFewParents(), TestBuildFromArchetype() (+44 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (14): Server, History, splitLines(), RunRecord, RunStats, OpenAPIGenerator, Append(), mockTTOrch (+6 more)
...
Cohesion: 0.06
Nodes (40): HTTPMethod, collectViolations(), fieldPath(), findResponse(), NewRouteIndex(), pathOrRoot(), ResponseValidator(), routeKey() (+32 more)
...
Cohesion: 0.06
Nodes (40): applyScriptRunner, bareApplyScriptRunner, bareSyncRunner, cleanApplyScriptRunner, applySuperpowersRunToMainRepo(), bareTestRun(), TestApplySuperpowersRunBareRepoRefusedFastForwardParksPendingPatch(), TestApplySuperpowersRunBareRepoVerifiesCommitsInWorktreeThenFastForwardsMaster() (+32 more)
...
Cohesion: 0.06
Nodes (24): tracingMiddleware(), fanoutHandler, traceContextHandler, NewTracedLLM(), NewTracedLLMWithParent(), TestTracedLLM_EmitsSpanWithErrorClass(), TestTracedLLM_NestsUnderProvidedParent(), TestTracedLLM_SuccessSpan() (+16 more)

### Community 49 - "Community 49"
Cohesion: 0.08
Nodes (39): NewAgent(), NewDocPlanner(), fakeBlackboard, assertError(), TestAgentActionFails(), TestAgentCallbacks(), TestAgentGetSetState(), TestAgentHistory() (+31 more)
...
Cohesion: 0.08
Nodes (43): buildClaudeFusionPrompt(), buildGoapFusionNotebookLMQuery(), changedGoapPackages(), claudeBackoffWindow(), extractConversationID(), extractGoapGoals(), extractGoapNotebookLMRecommendation(), extractJSONStringField() (+35 more)
...
Cohesion: 0.11
Nodes (48): TestRouteBuilder_Build(), ArraySchema(), BoolSchema(), IntSchema(), NewOpenAPIGenerator(), NewRoute(), ObjectSchema(), StringSchema() (+40 more)
...
Cohesion: 0.04
Nodes (46): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+38 more)

### Community 56 - "Community 56"
Cohesion: 0.11
Nodes (41): defaultGoapReviewDeps(), gatherFailureReviewBody(), gatherReviewContext(), init(), isGoapNotebookLMQuotaError(), loadLastReviewedSHA(), nextNlmQuotaReset(), nlmQuotaExhausted() (+33 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (25): Config, TestBaseNodeCount(), TestGetRetryCount(), TestHasNodeNamed(), TestIsNodeWrapped(), CycleMetrics, TestHasChildNamed_DeepNested(), TestHasChildNamed_Found() (+17 more)
...
Cohesion: 0.07
Nodes (39): TestHandleDLQReplay_RequeuesInsteadOfDropping(), TestDeadLetterQueue_AutoClassify(), TestDeadLetterQueue_CategoryCounts(), TestDeadLetterQueue_CategoryCounts_Empty(), TestDeadLetterQueue_EmptyErrorNoCategory(), TestDeadLetterQueue_PersistenceRoundtrip(), TestDeadLetterQueue_PreserveCategory(), NewConcurrencyLimiter() (+31 more)
...
Cohesion: 0.12
Nodes (37): satisfactionRecords(), TestEvaluateTree_EmptyRecordsSatisfactionUnknown(), TestEvaluateTree_FeedbackShiftsComposite(), TestEvaluateTree_NoFeedbackLeavesCompositeUnchanged(), DefaultTree(), NewExperienceBank(), bankHasEntry(), BenchmarkAddFromMutation() (+29 more)
...
Cohesion: 0.09
Nodes (35): distributedDispatch, appendDispatchErr(), driveDistributedDispatch(), main(), parseNodes(), run(), multiNodeReport, TestMultiNode_ProbeFailsOnEmptyNodeURL() (+27 more)
...
Cohesion: 0.07
Nodes (22): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleMetricsLive() (+14 more)
...
Cohesion: 0.09
Nodes (28): FilterByTreeName(), biasCandidatesWithExperience(), cloneMetadataForGardener(), cloneTreeForGardener(), extractDomain(), hashTreeForGardener(), serializeTreeForGardener(), TestBiasCandidatesWithExperience_NilOrEmptyBankKeepsOrder() (+20 more)
...
Cohesion: 0.07
Nodes (17): AgentEndpoint, AgentExecutor, AgentResult, CircuitState, ConcurrencyLimiter, DeadLetterEntry, executorFailureState, ExecutorHealthDetail (+9 more)
...
Cohesion: 0.22
Nodes (25): TestGoalQueue_DeadlineBreaksPriorityTies(), NewGoalQueue(), NewGoalQueueFrom(), names(), names2(), TestGoalIsSatisfied(), TestGoalQueueAddAndSelect(), TestGoalQueueAddReplace() (+17 more)
...
Cohesion: 0.11
Nodes (23): dataFileMetrics(), extractExistingDataPath(), init(), inspectDataSource(), registerDomainActions(), availableToolNames(), buildToolList(), execAgent() (+15 more)
...
Cohesion: 0.09
Nodes (17): BuildCachedCondition(), chainStateInt(), TestChainStateInt_ReadsIntAndFloat64(), parseChainConfig(), TestChainAction_ParseConfig(), BuildInverter(), BuildRepeater(), BuildRunner() (+9 more)
...
Cohesion: 0.13
Nodes (21): min(), handleAnalyze(), execLLMCall(), generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section(), TestGenerateTemplateOutput_TruncatedCache() (+13 more)
...
Cohesion: 0.11
Nodes (21): TestActionForName_BulkCoverage(), TestSuperpowersTaskVerifyRed_NoTestsFailsWithoutPanic(), TestRegisterAction_DuplicatePanics(), TestInitAction_HealthCheckAgent(), TestInitAction_MetricsCollectionAgent(), TestNestedActionSpansParentCorrectly(), TestPanickingActionRestoresTraceContextAndEndsSpan(), TestRegisteredActionEmitsSpan() (+13 more)
...
Cohesion: 0.1
Nodes (19): BuildBudget(), budgetCmd, BuildMonitor(), TestBuildBudget_MaxTicks(), TestBuildInverter(), TestBuildMonitor_IncrementsCounter(), TestBuildParallel_AllMustSucceed(), TestBuildParallel_OneSuccess() (+11 more)
...
Cohesion: 0.12
Nodes (23): goapFusionCircuitBreakerVerdict(), goapFusionCircuitBreakerWindow(), goapFusionCircuitPolicyVerdict(), goapFusionCircuitPolicyVerdictWithBypass(), goapFusionImplementationGateWired(), goapFusionPreflightWired(), goapFusionRepeatedHashBypassed(), loadLastHashedMilestone() (+15 more)
...
Cohesion: 0.17
Nodes (19): recordUserFeedback(), registerFeedbackTools(), newFeedbackDeps(), TestBTFeedbackRegistered(), TestPersistGeneratedTreeForUser_UserWorkspaceAndFallback(), TestRecordUserFeedback_FeedsSatisfactionAndFlags(), TestRecordUserFeedback_RejectsBadInput(), TestRecordUserFeedback_TrimsUserAndTreeID() (+11 more)
...
Cohesion: 0.12
Nodes (18): AutoRebuildEnabled(), defaultDriftHead(), DriftStatus(), DriftWatchOnce(), scrubGitEnv(), StartDriftWatcher(), TestDriftStatus(), TestDriftWatchOnce() (+10 more)
...
Cohesion: 0.14
Nodes (7): NewFallbackLLM(), TestFallbackLLM_GenerateReturnsAllFailures(), TestFallbackLLM_GenerateUsesNextModelAfterPrimaryFailure(), TestNewProvider_BuildsFallbackChainFromConfiguredModels(), FallbackLLM, NamedLLM, stubLLM
...
Cohesion: 0.18
Nodes (17): TestBTOptimizer_New(), TestFindMainSelector(), TestMergeOverlappingPaths_MergeNode(), TestPathHitRatioExtras(), TestPruneDeadPaths(), NewBTOptimizer(), NewDTAnalyzer(), pathStat() (+9 more)
...
Cohesion: 0.14
Nodes (14): code:go (type CompanyState struct {), code:go (type Evaluator struct { ... }), code:go (type Gardener struct { ... }), code:go (type Planner interface { Plan(world WorldState, goal Goal) (), code:go (type Agent struct { ... }), code:go (type Store struct { ... }), code:go (type TestSuite struct { ... }), Package: evaluator (+6 more)
...
Cohesion: 0.17
Nodes (12): code:go (type ContentType string), code:go (type KnowledgeGraph struct { ... }), code:go (type Analyzer struct { ... }), code:go (type LLM interface {), code:go (type Alert struct {), code:go (type ThinkTank struct { ... }), Package: api, Package: factory (+4 more)
...
Cohesion: 0.33
Nodes (6): code:go (type Store struct { ... }                                // ), code:go (type Tracer interface {), code:go (type Suite struct {), Package: benchmark, Package: persona, Package: tracing
...
## Knowledge Gaps
- **6204 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+6199 more)
...
- **Why does `Append()` connect `Community 39` to `Community 0`, `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 522`, `Community 11`, `Community 12`, `Community 523`, `Community 521`, `Community 15`, `Community 528`, `Community 17`, `Community 18`, `Community 19`, `Community 16`, `Community 535`, `Community 536`, `Community 25`, `Community 23`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 37`, `Community 40`, `Community 41`, `Community 42`, `Community 44`, `Community 46`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 63`, `Community 65`, `Community 67`, `Community 68`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 87`, `Community 88`, `Community 91`, `Community 92`, `Community 95`, `Community 99`, `Community 100`, `Community 101`, `Community 106`, `Community 107`, `Community 109`, `Community 111`, `Community 112`, `Community 117`, `Community 118`, `Community 119`, `Community 127`, `Community 130`, `Community 136`, `Community 137`, `Community 138`, `Community 140`, `Community 141`, `Community 143`, `Community 146`, `Community 150`, `Community 152`, `Community 153`, `Community 664`, `Community 665`, `Community 156`, `Community 163`, `Community 164`, `Community 165`, `Community 166`, `Community 167`, `Community 168`, `Community 174`, `Community 175`, `Community 177`, `Community 178`, `Community 691`, `Community 692`, `Community 693`, `Community 183`, `Community 187`, `Community 191`, `Community 194`, `Community 707`, `Community 196`, `Community 197`, `Community 712`, `Community 202`, `Community 714`, `Community 207`, `Community 732`, `Community 335`, `Community 336`, `Community 337`, `Community 339`, `Community 340`, `Community 352`, `Community 353`, `Community 359`, `Community 360`, `Community 362`, `Community 371`, `Community 372`, `Community 904`, `Community 906`, `Community 1005`, `Community 497`, `Community 499`, `Community 501`, `Community 506`, `Community 507`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 40` to `Community 128`, `Community 0`, `Community 12`, `Community 14`, `Community 15`, `Community 143`, `Community 148`, `Community 23`, `Community 28`, `Community 30`, `Community 31`, `Community 33`, `Community 38`, `Community 39`, `Community 171`, `Community 175`, `Community 50`, `Community 179`, `Community 52`, `Community 948`, `Community 60`, `Community 65`, `Community 66`, `Community 72`, `Community 211`, `Community 91`, `Community 92`, `Community 351`, `Community 100`, `Community 107`, `Community 114`, `Community 376`, `Community 1018`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 128` to `Community 0`, `Community 515`, `Community 11`, `Community 14`, `Community 16`, `Community 530`, `Community 20`, `Community 23`, `Community 28`, `Community 31`, `Community 159`, `Community 32`, `Community 37`, `Community 165`, `Community 40`, `Community 682`, `Community 171`, `Community 46`, `Community 47`, `Community 48`, `Community 52`, `Community 182`, `Community 183`, `Community 60`, `Community 189`, `Community 62`, `Community 66`, `Community 333`, `Community 92`, `Community 100`, `Community 359`, `Community 363`, `Community 110`, `Community 123`, `Community 126`?**
