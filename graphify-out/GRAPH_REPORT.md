# Graph Report - superpowers-20260713T201536-1d2ca422-goap-fusion-loop-runner-blackboard-conte  (2026-07-13)

## Corpus Check
- 843 files · ~958,032 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21328 nodes · 32732 edges · 1764 communities (1393 shown, 371 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 8355 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `28e4ee68`
...
## Communities (1764 total, 371 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (144): { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig }, { defineConfig } (+136 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (144): { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium }, { chromium } (+136 more)
...
Cohesion: 0.04
Nodes (91): main(), TestBlackboard_AllFields(), containsAnyStr(), TestGoDevTree_NonGoTask_Rejected(), TestGoDevTree_RetryBehavior(), TestGoDevTree_RoutesToBuild(), TestGoDevTree_RoutesToCodeReview(), TestGoDevTree_RoutesToGoKnowledge() (+83 more)
...
Cohesion: 0.04
Nodes (87): TestRunOnce_EmitsRunRootSpan(), alwaysSampler, Attr, captureExporter, NewOTLPHTTPExporter(), TestConfigureOTLPFromEnv(), TestConfigureOTLPFromEnv_DisabledWithoutEndpoint(), TestConsoleTracer_ExporterErrorDoesNotBreakEnd() (+79 more)
...
Cohesion: 0.06
Nodes (59): TestGoapFusionLoopTreeIsProductionWired(), treeContainsNode(), ComposePreset(), ComposeTaskTreeAgentic(), ComposeTaskTreeFull(), ComposeTaskTreeWithHITL(), TestComposePreset_Agentic(), TestComposeTaskTreeAgentic_WithStrategyMiddle() (+51 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (24): Server, AgentMetric, Alert, AlertReport, History, splitLines(), MetricsJSON, evaluateAgentAlerts() (+16 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (83): ADR-001: Behavior Trees as Core Execution Model, ADR-002: MCP as External Interface, ADR-003: File-Based Persistence over SQL, ADR-004: YAML-Defined Agent Platform, ADR-005: Stockfish-Adapted Evolution Engine, ADR-006: ChainAction — LLM Integration via BT Nodes, ADR-007: Reliability Architecture — Circuit Breakers, Retry, DLQ, ADR-008: Auction-Based A2A Task Allocation (+75 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (75): TestScoreChild_GoalAlignmentBranch(), TestScoreChild_NilChainState(), ParallelMode, intSliceFromInterface(), BuildReactiveParallel(), childPanicHandler(), forkBlackboard(), intSliceFromInterface() (+67 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (52): Config, diffSecretField(), Duration(), TestDuration(), BuildCircuitBreaker(), BuildTimeout(), TestStoreSaveCompactsTerminalRecords(), AggregatedTrace (+44 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (70): TestSet_ByteLimitTooLargeStillErrors(), TestSet_EvictsOldestOnEntryLimit(), TestSet_EvictsOnByteLimit(), TestSet_NoEvictKeepsStrictLimit(), TestSet_UpdateDoesNotEvictAtEntryLimit(), NewHandle(), NewManager(), saveNlmQuotaExhausted() (+62 more)
...
Cohesion: 0.05
Nodes (43): handleSprintExecute(), main(), handlePipelineRun(), handlePipelines(), handlePipelineStatus(), newPipelineRunner(), newRunID(), resolveTree() (+35 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (66): TestDomainTree_Registration(), TestFullTreeIntegration_SmokeCheck(), TestSuiteForTree_CoversAllRegisteredTrees(), TestTreeLoadFromDisk_NodeCount(), handleTreeStructure(), TestRouting_Finance(), TestRouting_Research(), TestTree_Research() (+58 more)
...
Cohesion: 0.05
Nodes (46): GateResult, TestQualityGateFloorOn100Scale(), NewQualityGate(), TestQualityGateGlobalStreakDisablesAllTrees(), TestQualityGatePerTreeIsolation(), TestQualityGatePerTreeResetOnPass(), RestoreTree(), SnapshotTree() (+38 more)
...
Cohesion: 0.06
Nodes (60): LoadPipeline(), RunPipeline(), RunPipelineWithID(), TestBTBlocksComposeRejectsUnknownStrategyTree(), TestBTBlocksComposeSaveGatesActivation(), mcpDeps, addFailureContext(), checkLLMHealth() (+52 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (53): Block, ptr(), TestBlockMutationsInsert(), TestComposeAndExpand(), TestComposeTaskTreeWithStrategy(), TestPromoteSubtree(), Category, Compose() (+45 more)
...
Cohesion: 0.06
Nodes (41): min(), handleAnalyze(), brokenTool, generateTemplateOutput(), TestGenerateTemplateOutput_Basic(), TestGenerateTemplateOutput_NilChainState(), TestGenerateTemplateOutput_NoArc42Section(), TestGenerateTemplateOutput_TruncatedCache() (+33 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (43): TestMatchBlockPattern(), AntiPattern, countTreeNodes(), TestCrossover_Single(), TestDTAnalyzer_New(), TestExpertKnowledge_DetectAntiPatterns(), TestExpertKnowledge_New(), TestExpertKnowledge_RecommendMutations() (+35 more)
...
Cohesion: 0.05
Nodes (37): Blackboard, ChildTick, childTickLog, TestBuildPlannerNode_AllFail(), TestBuildPlannerNode_FailThenSuccess(), TestScoreChildren_BasicRanking(), TestValidateOutputQuality_BlankResult(), TestValidateOutputQuality_ErrorPattern() (+29 more)
...
Cohesion: 0.07
Nodes (30): TestOutcomeErrorDetail(), OutcomeErrorDetail(), attemptOutcomeError(), endpointsFromCards(), experienceBankDir(), hostURLOf(), init(), logA2AServeError() (+22 more)
...
Cohesion: 0.07
Nodes (23): getHomeDir(), handleAgentCreate(), handleAgentDelete(), handleAgentExecute(), handleAgentRun(), handleAlertRules(), handleDLQReplay(), handleLogout() (+15 more)
...
Cohesion: 0.1
Nodes (28): NewFileJobStore(), TestFileJobStore_Concurrent(), TestFileJobStore_EmptyPath(), TestFileJobStore_NonExistentPath(), TestFileJobStore_SaveLoad(), TestScheduler_NoJobStore_NilSafe(), TestScheduler_PersistenceOnSchedule(), TestScheduler_RestoreJobsOnStartup() (+20 more)
...
Cohesion: 0.09
Nodes (16): buildGardenerConfig(), experienceBankDir(), TestBuildGardenerConfig_ExperienceBankSharedWithDaemon(), TestBuildGardenerConfig_SafetyComponentsWired(), TestBuildGardenerConfig_SnapshotDirCreated(), wireSelectorOrdering(), GardenerRecommendTool, GardenerRunCycleTool (+8 more)
...
Cohesion: 0.1
Nodes (14): isCompressibleContentType(), TestIsCompressibleContentType(), compressionResponseWriter, gzipResponseWriter, NewPageAgent(), TestAgentLLMGeneration(), TestAgentMockFallback(), TestBubbleRecommendation() (+6 more)
...
Cohesion: 0.13
Nodes (15): handleFellows(), main(), DefaultFellows(), NewThinkTank(), TestDefaultFellows(), TestFellowConfidence(), TestFullAnalysis_MultipleTopics(), TestNewThinkTank() (+7 more)
...
Cohesion: 0.1
Nodes (12): A2AHandoffBlock(), builtinBlocks(), DelegateBlock(), MergeResultsBlock(), ParallelFanoutBlock(), HITLEscalateBlock(), HumanGateBlock(), MemoryLoadBlock() (+4 more)
...
Cohesion: 0.11
Nodes (13): init(), modal, num, renderTab(), state, TAB_KEYS, renderCompany(), renderDoormate() (+5 more)
...
Cohesion: 0.14
Nodes (14): AgentMetrics, AgentStats, BuildIdentity, HealthResponse, exposedBuildIdentity(), GetAgentMetrics(), init(), InstallBuildIdentity() (+6 more)
...
Cohesion: 0.27
Nodes (16): NewMockLLM(), NewDefaultCompany(), companySummary(), TestCompanySimulation_Quarter(), TestCompanySimulation_Sprint(), TestCompanySimulation_Summary(), testLLM(), TestNewDefaultCompany_Values() (+8 more)
...
Cohesion: 0.2
Nodes (4): TestHandleAnalyze_UsesWorkflowForTaskDerivation(), NewTaskStore(), TestTaskStore_ApprovedOrdersByPriorityThenSprint(), TestTaskStore_ApproveRejectAuditPersistsAcrossSaveLoad()
...
## Knowledge Gaps
- **7266 isolated node(s):** `{ defineConfig }`, `{ chromium }`, `BenchmarkResult`, `ComparisonResult`, `RegressionConfig` (+7261 more)
...
- **Why does `Append()` connect `Community 20` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 22`, `Community 23`, `Community 26`, `Community 27`, `Community 30`, `Community 31`, `Community 542`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 546`, `Community 551`, `Community 552`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 46`, `Community 47`, `Community 49`, `Community 562`, `Community 50`, `Community 51`, `Community 53`, `Community 54`, `Community 55`, `Community 57`, `Community 58`, `Community 572`, `Community 60`, `Community 62`, `Community 63`, `Community 61`, `Community 575`, `Community 64`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 579`, `Community 72`, `Community 73`, `Community 75`, `Community 76`, `Community 77`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 84`, `Community 85`, `Community 86`, `Community 87`, `Community 89`, `Community 90`, `Community 92`, `Community 94`, `Community 96`, `Community 99`, `Community 103`, `Community 104`, `Community 110`, `Community 113`, `Community 114`, `Community 117`, `Community 119`, `Community 122`, `Community 124`, `Community 126`, `Community 129`, `Community 132`, `Community 133`, `Community 134`, `Community 135`, `Community 137`, `Community 141`, `Community 145`, `Community 149`, `Community 154`, `Community 155`, `Community 156`, `Community 167`, `Community 169`, `Community 170`, `Community 171`, `Community 178`, `Community 179`, `Community 180`, `Community 181`, `Community 183`, `Community 186`, `Community 187`, `Community 193`, `Community 194`, `Community 197`, `Community 201`, `Community 726`, `Community 735`, `Community 736`, `Community 740`, `Community 759`, `Community 764`, `Community 765`, `Community 781`, `Community 782`, `Community 787`, `Community 835`, `Community 840`, `Community 352`, `Community 354`, `Community 355`, `Community 356`, `Community 358`, `Community 365`, `Community 367`, `Community 369`, `Community 370`, `Community 377`, `Community 378`, `Community 381`, `Community 382`, `Community 383`, `Community 389`, `Community 390`, `Community 393`, `Community 394`, `Community 1012`, `Community 1016`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `registerMCPTools()` connect `Community 33` to `Community 2`, `Community 4`, `Community 140`, `Community 14`, `Community 15`, `Community 19`, `Community 20`, `Community 152`, `Community 1048`, `Community 26`, `Community 27`, `Community 25`, `Community 34`, `Community 49`, `Community 178`, `Community 50`, `Community 179`, `Community 57`, `Community 189`, `Community 190`, `Community 63`, `Community 191`, `Community 65`, `Community 66`, `Community 61`, `Community 69`, `Community 84`, `Community 96`, `Community 739`, `Community 359`, `Community 103`, `Community 110`, `Community 368`, `Community 115`, `Community 117`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 66` to `Community 128`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 11`, `Community 15`, `Community 16`, `Community 19`, `Community 23`, `Community 25`, `Community 26`, `Community 33`, `Community 35`, `Community 41`, `Community 42`, `Community 45`, `Community 52`, `Community 56`, `Community 59`, `Community 187`, `Community 189`, `Community 63`, `Community 88`, `Community 736`, `Community 355`, `Community 103`, `Community 109`, `Community 110`, `Community 366`, `Community 753`, `Community 115`, `Community 116`?**
...
- **Are the 126 inferred relationships involving `NewRequest()` (e.g. with `TestHITLHandlers_PendingApproveReject()` and `WorkflowApprovalWait()`) actually correct?**
  _`NewRequest()` has 126 INFERRED edges - model-reasoned connections that need verification._