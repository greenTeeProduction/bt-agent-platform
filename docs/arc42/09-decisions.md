...
## Newer ADRs (see `docs/adr/INDEX.md`)

| ADR | Title | Status |
|---|---|---|
| [ADR-008](../adr/ADR-008-composable-blocks.md) | Composable Blocks | Accepted (2026-06-04) |
| [ADR-009](../adr/ADR-009-blackboard-context-offloading.md) | Scoped Blackboard for Context Offloading | Accepted (2026-06-14) |
| [ADR-010](../adr/ADR-010-personalized-self-evolving-agents.md) | Personalized Self-Evolving Agents — persona layer, goal factory, plan→BT compiler, dynamic resolver, HITL automation policy, feedback-as-fitness | Proposed (2026-07-08) |
