...
- ⚠️ `bt_evolve_qlearning` does not set `Cap` on the `QTable` it constructs — the durable archive is unbounded in production today, unlike the island archive which ADR-040 already bounded end to end
