...
- ⚠️ Per-tree archives remain uncapped (ADR-033's open item; boundedness is a later milestone of this program), and the fleet's total archive footprint now scales with the number of distinct base trees evolved
