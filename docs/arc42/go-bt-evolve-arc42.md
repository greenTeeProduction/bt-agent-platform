...
**Decision (milestones 1–3 of 4):** Give `IslandModel` two independent, opt-in bounds and wire them into the one production caller.
...
**Status:** Accepted (2026-07-12) — milestones 1, 2, and 3 of 4 landed. Milestone 4 of this program has not landed.
