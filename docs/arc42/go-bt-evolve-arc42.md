...
~/.go-bt-gardener/           — gardener-metrics.json (aggregate cycle-history
                               ...
                               slo-metrics.json, snapshots/, selector-stats.json
