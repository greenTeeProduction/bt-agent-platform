	...
	return &evolution.SerializableNode{
		...
		Children: []evolution.SerializableNode{
			...
			{Type: "Selector", Name: "OutcomeSelector", Description: "Confirm success or fall through to LLM failure diagnosis", Children: []evolution.SerializableNode{
				...
				{Type: "ChainAction", Name: "llm_call:Vault operation failed. Diagnose: file permissions, vault path, missing source material. Retry with corrected approach.", Description: "Diagnose why the vault operation failed and retry", Metadata: map[string]any{"max_tokens": float64(4)}},
			}},
		},
	}
}
