// Package tools provides built-in tool implementations for BT agent chains.
// Each tool implements Name(), Description(), and Call(string)string
// for use with ChainTools on the engine blackboard.
package tools
