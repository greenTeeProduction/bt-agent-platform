	...
	return &SerializableNode{
		...
		Children: []SerializableNode{
			...
			{Type: "Selector", Name: "OutcomeSelector", Children: []SerializableNode{
				...
				{Type: "ChainAction", Name: "agent:Research cycle partially failed. Diagnose: NotebookLM quota exhausted? Git conflict? Test failure? Rollback any partial changes. Log the failure in /mnt/ssd/clawd/wiki/bt-research/errors.md. Retry next cycle.", Metadata: map[string]any{"max_tokens": float64(400)}},
			}},
		},
	}
}
