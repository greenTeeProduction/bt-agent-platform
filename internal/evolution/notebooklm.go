		...
		Children: []SerializableNode{
			...
			// Auth check
			{
				...
				Children: []SerializableNode{
					{
						Type: "ChainAction",
						Name: "llm_call:Check NotebookLM authentication status. If not authenticated, guide the user: 'Use nlm login --manual -f cookies.json on your laptop to export Google cookies, then copy them to the Jetson. Or use nlm login on a machine with a display and sync the config.' If authenticated, proceed.",
