...
func TestPriority_String(t *testing.T) {
	tests := []struct {
		...
		{WorkflowPriority(99), "backlog"}, // unknown → default
	}
...
func TestTaskStatus_String(t *testing.T) {
	tests := []struct {
		...
		{WorkflowTaskStatus(99), "blocked"}, // unknown → default
	}
	for _, tt := range tests {
		got := tt.s.String()
		if got != tt.want {
...
func TestPrioritize(t *testing.T) {
	...
	// WorkflowPriority first, then sprint target
	expected := []string{
...
func TestExecuteSprint(t *testing.T) {
	...
	// WorkflowTask in other sprint should be unaffected
...
func TestExecuteSprint_NoApprovedTasks(t *testing.T) {
	...
	// WorkflowTask should NOT be completed (was pending, not approved)
...
func TestApproval_Fields(t *testing.T) {
	...
	wf.Tasks = append(wf.Tasks, WorkflowTask{ID: "task-2", Status: StatusPending})
...
func TestWorkflow_StatusTransitions(t *testing.T) {
	...
	wf.Tasks = []WorkflowTask{{ID: "t1", Status: StatusPending}}
...
// ─── WorkflowTask source field verification ───
