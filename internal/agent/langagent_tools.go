...
func NewFitnessTool(refStore *evolution.Store, treeStore *evolution.TreeStore) *FitnessTool {
...
func NewEvolveTool(refStore *evolution.Store, treeStore *evolution.TreeStore) *EvolveTool {
...
func (t *CreateAgentTool) Call(_ context.Context, input string) (string, error) {
	if t.factory == nil {
...
func NewGetReflectionsTool(refStore *evolution.Store) *GetReflectionsTool {
